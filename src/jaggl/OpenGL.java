...
public class OpenGL {
	...
	public static int o = 5121;
	public static int s = 5122;
	public static int f = 5123;
	public static int z = 5124;
	public static int w = 5125;
	public static int n = 5126;
	...
	public static int c = 5888;
	public static int a = 5889;
	public static int e = 5890;
	public static int m = 2832;
	public static int t = 2834;
	public static int h = 6913;
	public static int y = 6914;
	public static int v = 1028;
	public static int ay = 1029;
	public static int ac = 2884;
	public static int al = 4864;
	public static int at = 515;
	public static int aw = 516;
	public static int ap = 2929;
	public static int ai = 6402;
	public static int as = 2896;
	public static int aj = 16384;
	public static int ax = 16385;
	public static int ad = 16386;
	public static int an = 4615;
	public static int af = 4616;
	public static int aq = 4617;
	public static int aa = 4608;
	public static int ab = 4609;
	public static int ak = 4611;
	public static int ag = 5634;
	public static int az = 2899;
	public static int ah = 1032;
	public static int av = 7425;
	public static int ar = 2903;
	public static int am = 260;
	public static int au = 3008;
	public static int ae = 3042;
	public static int ao = 0;
	public static int bg = 1;
	public static int bs = 768;
	public static int bo = 769;
	public static int bt = 770;
	public static int bc = 771;
	public static int bf = 774;
	public static int bl = 2912;
	public static int bk = 2917;
	public static int br = 2914;
	public static int bi = 2918;
	public static int bz = 2915;
	public static int be = 2916;
	public static int by = 9729;
	public static int bp = 7681;
	public static int bx = 6406;
	public static int ba = 6409;
	public static int bm = 6410;
	public static int bq = 6144;
	public static int bn = 6407;
	public static int bu = 6408;
	public static int bv = 2982;
	public static int bw = 3156;
	public static int bj = 4353;
	public static int bh = 3089;
	public static int bd = 3348;
	public static int bb = 3349;
	public static int ch = 3352;
	public static int ce = 3353;
	public static int cz = 3354;
	public static int cj = 3355;
	public static int cy = 3317;
	public static int cb = 3314;
	public static int ct = 8960;
	public static int cd = 8704;
	public static int cn = 3552;
	public static int co = 3553;
	public static int cm = 10242;
	public static int cw = 10243;
	public static int cq = 10240;
	public static int ci = 10241;
	public static int cs = 8705;
	public static int cr = 3168;
	public static int cv = 3169;
	public static int ck = 9472;
	public static int cl = 9984;
	public static int cp = 9987;
	public static int cf = 9217;
	public static int cu = 9473;
	public static int ca = 9216;
	public static int cg = 9474;
	public static int cx = 8448;
	public static int cc = 9728;
	public static int db = 10497;
	public static int ds = 8192;
	public static int dg = 8193;
	public static int dz = 8194;
	public static int dr = 8195;
	public static int do1 = 3170;
	public static int da = 3171;
	public static int dh = 7936;
	public static int dt = 7937;
	public static int dq = 7938;
	private static int dv = 7939;
	public static int dc = 256;
	public static int dj = 1024;
	public static int dl = 2048;
	public static int dm = 16384;
	public static int du = 32830;
	public static int df = 32834;
	public static int dy = 32852;
	public static int dx = 32859;
	public static int dd = 32884;
	public static int de = 32885;
	public static int dn = 32886;
	public static int di = 32888;
	public static int dk = 32879;
	public static int dw = 33639;
	public static int dp = 32993;
	public static int ed = 33071;
	public static int ea = 33984;
	public static int ej = 33985;
	public static int ew = 34018;
	public static int el = 32925;
	public static int em = 34065;
	public static int eh = 34066;
	public static int ei = 34067;
	public static int er = 34069;
	public static int en = 34070;
	public static int ee = 34071;
	public static int ez = 34072;
	public static int ex = 34073;
	public static int ev = 34074;
	public static int ep = 34160;
	public static int ec = 34161;
	public static int et = 34162;
	public static int ey = 34176;
	public static int eq = 34178;
	public static int ek = 34184;
	public static int eb = 34186;
	public static int eg = 34192;
	public static int eo = 34200;
	public static int ef = 34163;
	public static int eu = 34165;
	public static int es = 34023;
	public static int fu = 34166;
	public static int ft = 34167;
	public static int fm = 34168;
	public static int fr = 34479;
	public static int fs = 33189;
	public static int fk = 33190;
	public static int fo = 34895;
	public static int fj = 35001;
	public static int fa = 34929;
	public static int fz = 34930;
	public static int fc = 35632;
	public static int fg = 35633;
	public static int fy = 34336;
	public static int fe = 34379;
	public static int fh = 34933;
	public static int fl = 34820;
	public static int fv = 34962;
	public static int ff = 34963;
	public static int fi = 35040;
	public static int fn = 35044;
	public static int fq = 35713;
	public static int fd = 35714;
	public static int fx = 35716;
	public static int fw = 35633;
	public static int fp = 35632;
	public static int fb = 34037;
	public static int gb = 5131;
	public static int gn = 34836;
	public static int gd = 34837;
	public static int gx = 34838;
	public static int ga = 34840;
	public static int gj = 34841;
	public static int gl = 34842;
	public static int gz = 34843;
	public static int gr = 34844;
	public static int gk = 34846;
	public static int gw = 34847;
	public static int ge = 33777;
	public static int gh = 33779;
	public static int gq = 36053;
	public static int gu = 36064;
	public static int gf = 36096;
	public static int gg = 36160;
	public static int gy = 36161;
	public static int gv = 36008;
	public static int gi = 36219;
	...
	public boolean r(String string) {
		if (null == r) {
			r = new Hashtable();
			...
			for (;;) {
				...
				if (string_7_.length() != 0)
					r.put(string_7_, string_7_);
				i = i_6_ + 1;
			}
			String string_8_ = string_5_.substring(i).trim();
			if (string_8_.length() != 0)
				r.put(string_8_, string_8_);
		}
		return r.containsKey(string);
	}

	public synchronized boolean j() {
		Thread thread = Thread.currentThread();
		if (attachPeer()) {
			OpenGL opengl_9_ = (OpenGL) i.put(thread, this);
			if (null != opengl_9_)
				opengl_9_.j = null;
			j = thread;
			return true;
	...
	public synchronized boolean f() {
		Thread thread = Thread.currentThread();
		if (attachPeer()) {
			OpenGL opengl_367_ = (OpenGL) i.put(thread, this);
			if (null != opengl_367_)
				opengl_367_.j = null;
			j = thread;
			return true;
	...
	public synchronized boolean z() {
		Thread thread = Thread.currentThread();
		if (attachPeer()) {
			OpenGL opengl_368_ = (OpenGL) i.put(thread, this);
			if (null != opengl_368_)
				opengl_368_.j = null;
			j = thread;
			return true;
