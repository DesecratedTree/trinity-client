...
public class Class442 {
	...
	static final void method5873(ClientScript2 class403, byte i) {
		try {
			...
			if (null != Class301_Sub1.aClass437_7637) {
				Class298 class298 = Class301_Sub1.aClass437_7637.method5812((long) i_0_);
	...
	static final void method5876(ClientScript2 class403, int i) {
		try {
			...
			if (null == class352.areaName)
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
			else
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = class352.areaName;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method5878(ClientScript2 class403, int i) {
		try {
			...
			int mode = Class190.getDisplayMode((byte) -52);
			
		/*	if (mode >= 2 && Settings.ENABLE_OSRS_GAMEFRAME
					&& (
							class403.scriptID == 173))
				mode = 1;
			System.out.println(class403.scriptID);*/
	...
	static final void method5879(int i) {
		try {
			...
			ConfigFile.aClass487_1463.method6163(5, -718074838);
