...
public class Class298 {
	public Class298 last;
	public long aLong3188;
	public Class298 first;
	...
	static final void method2841(ClientScript2 class403, int i) {
		try {
			...
			ItemContainerConfig class298_sub37_sub10 = (Class300.aClass518_3217.method6311((((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239]), 894186762));
			int i_0_ = (((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239 + 1]);
			int i_1_ = -1;
			for (int i_2_ = 0; i_2_ < -408056823 * class298_sub37_sub10.size; i_2_++) {
				if (i_0_ == class298_sub37_sub10.ids[i_2_]) {
					i_1_ = class298_sub37_sub10.amounts[i_2_];
					break;
				}
			}
	...
	static final void method2843(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub25_7569.method5716((byte) 23);
		} catch (RuntimeException runtimeexception) {
