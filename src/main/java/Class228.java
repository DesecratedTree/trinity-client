...
public class Class228 {
	...
	public static void method2117(int i) {
		try {
			...
			Class87.aClass453_799.clear((byte) 1);
	...
	static final void method2118(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_1_, (byte) 116);
	...
	public static void method2119(AnimationConfig class391, int i, int i_2_) {
		try {
			if (Class300.anInt3213 * -991384187 < 50 && (null != class391 && class391.anIntArrayArray4187 != null && i < class391.anIntArrayArray4187.length && null != class391.anIntArrayArray4187[i])) {
				...
				if (null != class391.anIntArray4183 && class391.anIntArray4190 != null)
					i_7_ = AnimationConfig.method4888(class391.anIntArray4183[i], class391.anIntArray4190[i], 1444813491);
		...
		try {
			...
			while (i_17_ != i_16_) {
				...
				if (class336.method4090(2, i_10_, i_11_, class289, -16711936)) {
					...
					Class163.anInt1684 = -575994451 * i_11_;
					return true;
				}
	...
	static int method2121(String string, byte[] is, int i, byte i_21_) {
		try {
			...
			for (int i_24_ = 0; i_24_ < i_23_; i_24_ += 4) {
				int i_25_ = Class163.method1773(string.charAt(i_24_), -40024446);
				int i_26_ = (i_24_ + 1 < i_23_ ? Class163.method1773(string.charAt(1 + i_24_), 1761771208) : -1);
				int i_27_ = (2 + i_24_ < i_23_ ? Class163.method1773(string.charAt(2 + i_24_), 623747518) : -1);
				int i_28_ = (i_24_ + 3 < i_23_ ? Class163.method1773(string.charAt(i_24_ + 3), 1229588136) : -1);
