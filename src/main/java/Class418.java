...
public final class Class418 {
	...
	static final void method5596(ClientScript2 class403, byte i) {
		try {
			WidgetConfig class105 = Class50.getIComponentDefinitions((((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]), (byte) -64);
	...
	static void method5598(byte i) {
		try {
			...
			if (null != client.aByteArray8843) {
				...
				Class360.usernameL = (class298_sub53.readLong((short) 16837) * -2742373017286080113L);
				Class360.aLong3911 = (class298_sub53.readLong((short) 3310) * 3207425516430892907L);
			}
			if (Class360.usernameL * 122690138525332847L < 0L)
				Class78.method845(35, 1368689895);
			else
				Class460.method5981(false, true, "", "", Class360.usernameL * 122690138525332847L);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method5599(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_2_, (byte) 84);
