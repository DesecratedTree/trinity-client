...
public class Class422_Sub23 extends Preference {
	...
	public Class422_Sub23(int i, Preferences class298_sub48) {
	...
	public Class422_Sub23(Preferences class298_sub48) {
	...
	static final void method5710(int i) {
		try {
			if (Class422_Sub25.preferences.aClass422_Sub17_7565.method5689(-2013953489) == 2) {
				...
				if (Class99.anInt952 * 1855729883 != 3) {
					...
					while_15_: do {
						if (Class298_Sub1.cameraType * -863531439 == 4 || Class100.anInt1081 * 1329981847 != -1) {
							if (-863531439 * Class298_Sub1.cameraType != 4) {
								i_7_ = 1329981847 * Class100.anInt1081;
								i_8_ = Class418.anInt5339 * -1106950801;
							}
							if (((class244.terrainSettings[1855729883 * Class99.anInt952][i_7_ >> 9][i_8_ >> 9]) & 0x4) != 0)
								...
								if (i_13_ > i_14_) {
									...
									for (;;) {
										...
										if (i_9_ < i_11_)
											...
											i_9_--;
										if (((class244.terrainSettings[1855729883 * Class99.anInt952][i_9_][i_10_]) & 0x4) != 0) {
										...
										if (i_16_ >= 65536) {
											...
											if (i_10_ < i_12_)
												...
												i_10_--;
											if (0 != ((class244.terrainSettings[(1855729883 * Class99.anInt952)][i_9_][i_10_]) & 0x4))
												break;
										}
									}
									Class143.method1577(class331.aClass326ArrayArrayArray3516, 1, i_9_, i_10_, false, -777988087);
									...
									for (;;) {
										...
										if (i_10_ < i_12_)
											...
											i_10_--;
										if (0 != ((class244.terrainSettings[(Class99.anInt952 * 1855729883)][i_9_][i_10_]) & 0x4)) {
											Class143.method1577((class331.aClass326ArrayArrayArray3516), 1, i_9_, i_10_, false, -777988087);
											break while_15_;
										}
										i_18_ += i_17_;
							...
							int i_19_ = (Class356.getPlayerHeight(Class367.anInt4000 * -1740717447, Class146.anInt1575 * -299812095, Class99.anInt952 * 1855729883, -1780642340));
							if (i_19_ - Class110.anInt6403 * 1449634147 < 3200 && ((class244.terrainSettings[Class99.anInt952 * 1855729883][Class367.anInt4000 * -1740717447 >> 9][-299812095 * Class146.anInt1575 >> 9]) & 0x4) != 0)
	...
	public static void method5711(String string, short i) {
		try {
			GrabFolder.method2282(0, 0, "", "", "", string, -1848058692);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("aeg.f(").append(')').toString());
		}
	}
