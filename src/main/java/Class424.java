...
public class Class424 implements Interface21 {
	...
	public int method244() {
		return -1976050083 * anInt6613;
	}

	Class424(int i, int i_0_) {
		anInt6613 = -1456740875 * i;
	...
	static final void method5735(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = 367592105 * Class344.anInt3688;
		} catch (RuntimeException runtimeexception) {
