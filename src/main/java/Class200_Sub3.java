...
public class Class200_Sub3 extends Class200 implements Interface9_Impl2 {
	...
	Class200_Sub3(DirectXToolkit class_ra_sub3_sub2, int i, int i_0_, boolean bool, int[] is, int i_1_, int i_2_) {
		super(class_ra_sub3_sub2, Class55.aClass55_557, Class77.aClass77_717, bool && ((DirectXToolkit) class_ra_sub3_sub2).aBoolean9846, i * i_0_);
		if (!((DirectXToolkit) ((Class200_Sub3) this).aClass_ra_Sub3_Sub2_6410).aBoolean9865) {
		...
		if (bool)
			((Class200_Sub3) this).aLong6407 = (IDirect3DDevice.CreateTexture((((DirectXToolkit) ((Class200_Sub3) this).aClass_ra_Sub3_Sub2_6410).deviceContext), ((Class200_Sub3) this).anInt8629, ((Class200_Sub3) this).anInt8630, 0, 1024, 21, 1));
		else
			((Class200_Sub3) this).aLong6407 = (IDirect3DDevice.CreateTexture((((DirectXToolkit) ((Class200_Sub3) this).aClass_ra_Sub3_Sub2_6410).deviceContext), ((Class200_Sub3) this).anInt8629, ((Class200_Sub3) this).anInt8630, 1, 0, 21, 1));
		if (i_2_ == 0)
			i_2_ = i;
	...
	Class200_Sub3(DirectXToolkit class_ra_sub3_sub2, Class55 class55, int i, int i_3_, boolean bool, byte[] is, int i_4_, int i_5_) {
		super(class_ra_sub3_sub2, class55, Class77.aClass77_717, bool && ((DirectXToolkit) class_ra_sub3_sub2).aBoolean9846, i * i_3_);
		if (!((DirectXToolkit) ((Class200_Sub3) this).aClass_ra_Sub3_Sub2_6410).aBoolean9865) {
			((Class200_Sub3) this).anInt8629 = Class416.method5590(i, (byte) 16);
		...
		if (bool)
			((Class200_Sub3) this).aLong6407 = (IDirect3DDevice.CreateTexture((((DirectXToolkit) ((Class200_Sub3) this).aClass_ra_Sub3_Sub2_6410).deviceContext), ((Class200_Sub3) this).anInt8629, ((Class200_Sub3) this).anInt8630, 0, 1024, DirectXToolkit.method5546((((Class200_Sub3) this).aClass55_6409), Class77.aClass77_717), 1));
		else
			((Class200_Sub3) this).aLong6407 = (IDirect3DDevice.CreateTexture((((DirectXToolkit) ((Class200_Sub3) this).aClass_ra_Sub3_Sub2_6410).deviceContext), ((Class200_Sub3) this).anInt8629, ((Class200_Sub3) this).anInt8630, 1, 0, DirectXToolkit.method5546((((Class200_Sub3) this).aClass55_6409), Class77.aClass77_717), 1));
		if (i_5_ == 0)
			i_5_ = i;
		ByteBuffer bytebuffer = ((Class200_Sub3) this).aClass_ra_Sub3_Sub2_6410.aByteBuffer8216;
		bytebuffer.clear();
	...
	Class200_Sub3(DirectXToolkit class_ra_sub3_sub2, Class55 class55, int i, int i_8_, boolean bool, float[] fs, int i_9_, int i_10_) {
		super(class_ra_sub3_sub2, class55, Class77.aClass77_717, bool && ((DirectXToolkit) class_ra_sub3_sub2).aBoolean9846, i * i_8_);
		if (!((DirectXToolkit) ((Class200_Sub3) this).aClass_ra_Sub3_Sub2_6410).aBoolean9865) {
			((Class200_Sub3) this).anInt8629 = Class416.method5590(i, (byte) 16);
		...
		if (bool)
			((Class200_Sub3) this).aLong6407 = (IDirect3DDevice.CreateTexture((((DirectXToolkit) ((Class200_Sub3) this).aClass_ra_Sub3_Sub2_6410).deviceContext), ((Class200_Sub3) this).anInt8629, ((Class200_Sub3) this).anInt8630, 0, 1024, DirectXToolkit.method5546((((Class200_Sub3) this).aClass55_6409), Class77.aClass77_721), 1));
		else
			((Class200_Sub3) this).aLong6407 = (IDirect3DDevice.CreateTexture((((DirectXToolkit) ((Class200_Sub3) this).aClass_ra_Sub3_Sub2_6410).deviceContext), ((Class200_Sub3) this).anInt8629, ((Class200_Sub3) this).anInt8630, 1, 0, DirectXToolkit.method5546((((Class200_Sub3) this).aClass55_6409), Class77.aClass77_721), 1));
		if (i_10_ == 0)
			i_10_ = i;
		ByteBuffer bytebuffer = ((Class200_Sub3) this).aClass_ra_Sub3_Sub2_6410.aByteBuffer8216;
		bytebuffer.clear();
	...
	Class200_Sub3(DirectXToolkit class_ra_sub3_sub2, Class55 class55, Class77 class77, int i, int i_38_) {
	...
	Class200_Sub3(DirectXToolkit class_ra_sub3_sub2, Class55 class55, Class77 class77, int i, int i_54_, int i_55_, int i_56_) {
		...
		((Class200_Sub3) this).aLong6407 = (IDirect3DDevice.CreateTexture(((DirectXToolkit) ((Class200_Sub3) this).aClass_ra_Sub3_Sub2_6410).deviceContext, i, i_54_, 0, i_55_, DirectXToolkit.method5546((((Class200_Sub3) this).aClass55_6409), (((Class200_Sub3) this).aClass77_6408)), i_56_));
	}
