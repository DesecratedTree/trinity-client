...
public class Class380 {
	...
	public static Class380 LOGIN_MUSIC_ARCHIVE;
	...
	static {
		...
		LOGIN_MUSIC_ARCHIVE = new Class380(4);
	...
	static final void method4677(ClientScript2 class403, int i) {
		try {
			int mode = Class422_Sub25.preferences.graphicsMode.method5677(-706712654);
			if (mode == 5)
				mode = 1;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = mode;
		} catch (RuntimeException runtimeexception) {
	...
	static void method4679(WidgetConfig class105, WidgetConfig class105_3_, int i) {
		try {
			Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.SWITCH_INTERFACE_ITEM_PACKET, client.aClass25_8711.aClass449_330, (byte) 44);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE128(class105_3_.anInt1280 * -1232467723);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeIntV1(class105.uid * -440872681, (byte) -22);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(class105_3_.uid * -440872681, -855626208);
	...
	static final void method4680(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub7_7581.method5648(1496111936) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("pu.ane(").append(')').toString());
		}
	}

	static final void method4681(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static String method4682(WidgetConfig class105, int i, byte i_4_) {
		try {
			if (!client.method2801(class105).method3498(i, (byte) -47) && class105.anObjectArray1264 == null)
				return null;
			if (null == class105.options || class105.options.length <= i || null == class105.options[i] || class105.options[i].trim().length() == 0) {
				if (client.SHOW_HIDDEN_OPTIONS)
					return new StringBuilder().append("Hidden-").append(i).toString();
				return null;
			}
			return class105.options[i];
		} catch (RuntimeException runtimeexception) {
