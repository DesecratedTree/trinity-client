...
public class Class_ta_Sub1 extends Class_ta {
	...
	static Class_ta_Sub1 method5999(OpenGLLegacyToolkit class_ra_sub2, int i, int i_0_, int[] is, int[] is_1_) {
	...
	Class_ta_Sub1(OpenGLLegacyToolkit class_ra_sub2, int i, int i_6_, byte[] is) {
