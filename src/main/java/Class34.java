...
public class Class34 {
	...
	void method436(OpenGLLegacyToolkit class_ra_sub2, Class69 class69) {
		if (((OpenGLLegacyToolkit) class_ra_sub2).aClass233_8110 != null) {
			method438(class_ra_sub2);
			float f = (((OpenGLLegacyToolkit) class_ra_sub2).aClass233_8110.aFloatArray2594[2]);
			float f_0_ = (((OpenGLLegacyToolkit) class_ra_sub2).aClass233_8110.aFloatArray2594[6]);
			float f_1_ = (((OpenGLLegacyToolkit) class_ra_sub2).aClass233_8110.aFloatArray2594[10]);
			float f_2_ = (((OpenGLLegacyToolkit) class_ra_sub2).aClass233_8110.aFloatArray2594[14]);
			try {
				int i = 0;
				int i_3_ = 2147483647;
				int i_4_ = 0;
				...
				while (class302_sub3_9_ != class302_sub3) {
					...
					if (bool && (((OpenGLLegacyToolkit) class_ra_sub2).aFloat8130 != aFloat402))
						class_ra_sub2.IA(aFloat402);
					else if (((OpenGLLegacyToolkit) class_ra_sub2).aFloat8130 != 1.0F)
	...
	void method437(OpenGLLegacyToolkit class_ra_sub2, int i) {
		...
		if (((OpenGLLegacyToolkit) class_ra_sub2).aBoolean8143) {
	...
	void method438(OpenGLLegacyToolkit class_ra_sub2) {
		aFloat402 = ((OpenGLLegacyToolkit) class_ra_sub2).aFloat8130;
	...
	void method439(OpenGLLegacyToolkit class_ra_sub2) {
	...
	void method440(OpenGLLegacyToolkit class_ra_sub2) {
		class_ra_sub2.method5281(true);
		OpenGL.glEnable(16384);
		OpenGL.glEnable(16385);
		if (((OpenGLLegacyToolkit) class_ra_sub2).aFloat8130 != aFloat402)
			class_ra_sub2.IA(aFloat402);
	}
}
