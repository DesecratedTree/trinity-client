...
public class Class143 {
	...
	static final void method1574(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_1_, (byte) -78);
	...
	static final boolean method1577(Class326[][][] class326s, int i, int i_2_, int i_3_, boolean bool, int i_4_) {
		try {
			...
			if (((class244.terrainSettings[Class99.anInt952 * 1855729883][i_2_][i_3_]) & 0x4) == 0)
				return false;
			int i_6_ = 0;
			int i_7_ = 0;
			...
			while (i_7_ != i_6_) {
				...
				if (((class244.terrainSettings[1855729883 * Class99.anInt952][i_8_][i_11_]) & 0x4) == 0)
					bool_13_ = true;
				...
				if (null != class326s) {
					...
					while_63_: for (/**/; i_15_ <= 3; i_15_++) {
						...
						} else if (((class244.terrainSettings[i_15_][i_8_][i_11_]) & 0x8) == 0) {
				...
				if (bool_13_) {
					...
					if (++i_11_ < client.aClass283_8716.method2630(-1603394405)) {
						if (i_8_ - 1 >= 0 && i_5_ != (is[Class99.anInt952 * 1855729883][i_8_ - 1][i_11_]) && 0 == ((class244.terrainSettings[1855729883 * Class99.anInt952][i_8_][i_11_]) & 0x4) && 0 == ((class244.terrainSettings[Class99.anInt952 * 1855729883][i_8_ - 1][i_11_ - 1]) & 0x4)) {
						...
						if ((1 + i_8_ < client.aClass283_8716.method2629(-1968040539)) && i_5_ != (is[Class99.anInt952 * 1855729883][1 + i_8_][i_11_]) && ((class244.terrainSettings[1855729883 * Class99.anInt952][i_8_][i_11_]) & 0x4) == 0 && ((class244.terrainSettings[1855729883 * Class99.anInt952][1 + i_8_][i_11_ - 1]) & 0x4) == 0) {
					...
					if (--i_11_ >= 0) {
						if (i_8_ - 1 >= 0 && i_5_ != (is[1855729883 * Class99.anInt952][i_8_ - 1][i_11_]) && ((class244.terrainSettings[1855729883 * Class99.anInt952][i_8_][i_11_]) & 0x4) == 0 && ((class244.terrainSettings[1855729883 * Class99.anInt952][i_8_ - 1][1 + i_11_]) & 0x4) == 0) {
						...
						if ((1 + i_8_ < client.aClass283_8716.method2629(-1909288528)) && (is[1855729883 * Class99.anInt952][i_8_ + 1][i_11_]) != i_5_ && ((class244.terrainSettings[Class99.anInt952 * 1855729883][i_8_][i_11_]) & 0x4) == 0 && ((class244.terrainSettings[Class99.anInt952 * 1855729883][i_8_ + 1][i_11_ + 1]) & 0x4) == 0) {
