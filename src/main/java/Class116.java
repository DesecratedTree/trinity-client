...
public class Class116 {
	...
	LinkedArrayList aClass437_1392;

	public Class298_Sub31 method1263(String string, int i) {
		try {
			long l = ((Class116) this).anInterface4_1391.method47(string, (byte) 93);
			for (Class298_Sub31 class298_sub31 = ((Class298_Sub31) ((Class116) this).aClass437_1392.method5812(l)); null != class298_sub31; class298_sub31 = (Class298_Sub31) ((Class116) this).aClass437_1392.method5813(-1712985598)) {
	...
	void method1264(int i, int i_0_) {
		try {
			...
			if (class298_sub31 != null) {
				class298_sub31.remove(-1460969981);
	...
	public void method1265(int i, String string, Class298_Sub31 class298_sub31, int i_1_) {
		try {
			...
			if (i >= ((Class116) this).aClass298_Sub31Array1390.length) {
				...
				((Class116) this).aClass437_1392 = new LinkedArrayList(i_3_);
	...
	public Class116(int i, Interface4 interface4) {
		...
		((Class116) this).aClass437_1392 = new LinkedArrayList(i_7_);
	...
	public static void method1268(Class95 class95, int i, byte i_9_) {
		try {
			i = i * Class422_Sub25.preferences.aClass422_Sub29_7584.method5726(-2144031703) >> 8;
			if (null == class95)
	...
	static final void getWidgetText(ClientScript2 class403, int i) {
		try {
			Class390 class390 = (((ClientScript2) class403).aBoolean5261 ? ((ClientScript2) class403).aClass390_5247 : ((ClientScript2) class403).aClass390_5246);
			WidgetConfig class105 = ((Class390) class390).aClass105_4168;
			((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393 - 1)] = class105.text;
		} catch (RuntimeException runtimeexception) {
				...
				for (int i_10_ = 0; i_10_ < class365_sub1_sub1_sub2.anIntArray10092.length; i_10_++) {
					...
					if (-1 == i_11_) {
						...
						if (-1073741824 == (i_11_ & ~0x3fffffff)) {
							...
							i_14_ = ((int) class217.x - (256 + 512 * (i_17_ - (class341.gameSceneBaseX * -1760580017))));
							i_15_ = ((int) class217.y - (256 + ((i_18_ - 283514611 * class341.gameSceneBaseY) * 512)));
							...
							if (null != class365_sub1_sub1_sub2_sub2) {
								...
								i_15_ = ((int) class217.y - (int) class217_20_.y);
							} else {
								class365_sub1_sub1_sub2.method4417(i_10_, -1, (byte) 16);
								continue;
							}
						} else {
							ObjectValue class298_sub29 = ((ObjectValue) client.aClass437_8696.method5812((long) i_11_));
							if (null != class298_sub29) {
								...
								i_15_ = ((int) class217.y - (int) class217_21_.y);
							} else {
	...
	static final void method1271(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anInt5239 -= -1567522756;
			class105.x = (((ClientScript2) class403).anIntArray5244[((ClientScript2) class403).anInt5239 * 681479919]) * 2145953887;
			class105.y = (1215865909 * (((ClientScript2) class403).anIntArray5244[1 + 681479919 * ((ClientScript2) class403).anInt5239]));
			...
			if (i_23_ < 0)
				...
				i_23_ = 5;
			class105.xPositionMode = (byte) i_22_;
			class105.yPositionMode = (byte) i_23_;
			...
			if (class105.anInt1154 * -1309843523 == -1 && !class119.aBoolean1403)
				Class288.method2729(class105.uid * -440872681, 1058352947);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("es.cy(").append(')').toString());
		}
	}

	public static void setVeryHighPreferences(int i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub17_7564, 2, 1364189431);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub17_7565, 2, 1428932926);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub2_7547, 1, -398332874);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub28_7573, 1, 401268670);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub25_7569, 1, -225463890);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub9_7555, 1, -1836206886);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub18_7561, 1, 370627212);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub16_7557, 1, -408534755);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub7_7581, 2, 902985868);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub15_7560, 1, -598361107);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub5_7572, 2, -1383392801);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub3_7556, 1, -906948807);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub13_7549, 0, -33681458);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.antialiasing, 2, 1421186288);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub4_7563, 2, 540542372);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub11_7558, -160182505 * Class115.aClass115_1383.anInt1387, -1761179616);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub6_7551, 0, -224292435);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub19_7567, 1, -1095753213);
			Class490.method6170(1113089752);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub8_7566, 0, -255450456); //screen size
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub23_7576, 4, -1503000193);
	...
	public static void setHighPreferences(int i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub17_7564, 2, 1364189431);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub17_7565, 2, 1428932926);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub2_7547, 1, -398332874);
			...
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub3_7556, 1, -906948807);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub13_7549, 0, -33681458);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.antialiasing, 0, 1421186288);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub4_7563, 2, 540542372);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub11_7558, -160182505 * Class115.aClass115_1383.anInt1387, -1761179616);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub6_7551, 0, -224292435);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub19_7567, 1, -1095753213);
