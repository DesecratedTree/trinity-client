...
public class Class131 {
	...
	public Class125 method1467(int i, int i_0_) {
		try {
			Class125 class125;
			synchronized (((Class131) this).aClass348_1496) {
				class125 = (Class125) ((Class131) this).aClass348_1496.get((long) i);
			}
			if (class125 != null)
				return class125;
			byte[] is;
			synchronized (((Class131) this).aClass243_1497) {
				is = (((Class131) this).aClass243_1497.getFileFromArchive(ConfigFile.aClass120_1417.anInt1460 * -1006924897, i, (byte) -82));
			}
	...
	public Class131(Class411 class411, Class429 class429, CacheIndex class243) {
		...
		((Class131) this).aClass243_1497.method2316((ConfigFile.aClass120_1417.anInt1460) * -1006924897, -1961959383);
	}
	...
	static void method1470(Class119 class119, WidgetConfig class105, int i) {
		try {
			if (class105 != null) {
				if (class105.anInt1154 * -1309843523 != -1) {
					WidgetConfig class105_2_ = class119.method1297(1573706803 * class105.parentUID, (short) 26063);
					if (class105_2_ != null) {
						if (class105_2_.aClass105Array1293 == class105_2_.aClass105Array1292) {
							class105_2_.aClass105Array1293 = (new WidgetConfig[class105_2_.aClass105Array1292.length]);
					...
					WidgetConfig[] class105s = class119.method1296((byte) 61);
					int i_4_;
