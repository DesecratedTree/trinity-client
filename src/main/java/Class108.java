...
public class Class108 {
	...
	static final void method1148(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_4_, (byte) 70);
	...
	public static boolean hasCentralInterface() {
	...
	public static boolean isInterfaceOpen(int id) {
		for (Interface class298_sub51 = ((Interface) client.aClass437_8841.method5816(1892786919)); null != class298_sub51; class298_sub51 = ((Interface) client.aClass437_8841.method5815((byte) -93))) {
			if (!class298_sub51.method2840(-629325116)) {
				class298_sub51 = ((Interface) client.aClass437_8841.method5816(1676096674));
				if (class298_sub51 == null) 
			...
			if (id == class298_sub51.interfaceId * -1617025021 )
				return true;
		}
		return false;
	}
	
	public static final void closeInterface(boolean closeTabs, byte i) {
		try {
			Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.CLOSE_INTERFACE_PACKET, client.aClass25_8711.aClass449_330, (byte) 111);
			...
			for (Interface class298_sub51 = ((Interface) client.aClass437_8841.method5816(1892786919)); null != class298_sub51; class298_sub51 = ((Interface) client.aClass437_8841.method5815((byte) -93))) {
				...
				if (0 == class298_sub51.clipped * 27137839)
					Class173.method1821(class298_sub51, true, closeTabs, -113822480);
			}
