...
public class Class331 {
	...
	public boolean method4022(Class365_Sub1_Sub1 class365_sub1_sub1, boolean bool, byte i) {
		try {
			...
			if (bool) {
				...
				class365_sub1_sub1.setPosition(class217);
				class217.method2006();
			}
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	public Class331(GraphicsToolkit class_ra, int i, int i_69_, int i_70_, int i_71_, int i_72_, boolean bool, boolean bool_73_) {
		...
		((Class331) this).renderDistance = i_72_ * 1571198643;
		...
		((Class331) this).aClass365_Sub1Array3515 = new Class365_Sub1[12000];
		...
		((Class331) this).anInt3541 = 0;
		((Class331) this).aBooleanArrayArray3563 = (new boolean[(((Class331) this).renderDistance * 583010427 + ((Class331) this).renderDistance * 583010427 + 1)][(((Class331) this).renderDistance * 583010427 + ((Class331) this).renderDistance * 583010427 + 1)]);
		((Class331) this).aBooleanArrayArray3561 = (new boolean[2 + (583010427 * ((Class331) this).renderDistance + ((Class331) this).renderDistance * 583010427)][(583010427 * ((Class331) this).renderDistance + 583010427 * ((Class331) this).renderDistance + 2)]);
		((Class331) this).anIntArray3562 = new int[2 + (583010427 * ((Class331) this).renderDistance + ((Class331) this).renderDistance * 583010427)];
	...
	public void method4040(int i, int i_124_, int i_125_, int i_126_, byte[][][] is, int[] is_127_, int[] is_128_, int[] is_129_, int[] is_130_, int[] is_131_, int i_132_, byte i_133_, int i_134_, int i_135_, boolean bool, boolean bool_136_, int i_137_, boolean bool_138_) {
		...
		((Class331) this).anInt3533 = (1283818765 * ((Class331) this).anInt3553 - render * -1864237879);
		...
		((Class331) this).anInt3551 = (((Class331) this).anInt3513 * 1233371147 - render * -678030197);
		...
		((Class331) this).anInt3550 = (-1827235035 * ((Class331) this).anInt3553 + render * -679030015);
		if (((Class331) this).anInt3550 * 945006459 > anInt3514 * 1988988347)
			((Class331) this).anInt3550 = anInt3514 * -1126318399;
		((Class331) this).anInt3552 = render * -1363529219 + ((Class331) this).anInt3513 * -690201987;
		...
		if (((Class331) this).aBoolean3511) {
			for (int i_140_ = 0; i_140_ < (583010427 * render + render * 583010427 + 2); i_140_++) {
				int i_141_ = 0;
				int i_142_ = 0;
				for (int i_143_ = 0; i_143_ < (583010427 * render + render * 583010427 + 2); i_143_++) {
					if (i_143_ > 1)
						((Class331) this).anIntArray3562[i_143_ - 2] = i_141_;
					i_141_ = i_142_;
					int i_144_ = (((Class331) this).anInt3553 * -804213305 - 583010427 * render + i_140_);
					int i_145_ = (465603579 * ((Class331) this).anInt3513 - render * 583010427 + i_143_);
				...
				((Class331) this).anIntArray3562[(583010427 * render + render * 583010427)] = i_141_;
				((Class331) this).anIntArray3562[1 + (583010427 * render + 583010427 * render)] = i_142_;
			}
			if (!bool_138_)
			...
			if (null == ((Class331) this).aBooleanArrayArray3564)
				((Class331) this).aBooleanArrayArray3564 = (new boolean[(((Class331) this).renderDistance * 583010427 + 583010427 * ((Class331) this).renderDistance + 2)][(583010427 * ((Class331) this).renderDistance + 583010427 * ((Class331) this).renderDistance + 2)]);
		...
		if (0 == (i_155_ & 0x2)) {
			for (int i_159_ = 0; i_159_ < anInt3548 * 1678382205; i_159_++) {
				if (i_159_ >= i && null != is) {
					...
					//fix roofs here
					int roofDistance = (((Class331) this).renderDistance * 583010427);
					/*if (roofDistance == 161)
						roofDistance = 33;*/
					aClass_xaArray3517[i_159_].method6338(-804213305 * ((Class331) this).anInt3553, ((Class331) this).anInt3513 * 465603579, roofDistance, ((Class331) this).aBooleanArrayArray3561, false, i_155_);
				} else {
					...
					aClass_xaArray3517[i_159_].method6338(((Class331) this).anInt3553 * -804213305, ((Class331) this).anInt3513 * 465603579, 583010427 * ((Class331) this).renderDistance, ((Class331) this).aBooleanArrayArray3561, true, i_155_);
				}
			}
		}
	...
	void method4042(Class365_Sub1 class365_sub1, int i) {
		try {
			...
			((Class331) this).aClass_ra3508.method5060((float) (int) class217.x, (float) ((int) class217.aFloat2455 + (class365_sub1.method4361(1951240662) >> 1)), (float) (int) class217.y, ((Class331) this).aFloatArray3505);
	...
	boolean method4045(Class365_Sub1 class365_sub1, boolean bool, byte[][][] is, int i, byte i_185_) {
		...
		SceneObjectPosition class217 = class365_sub1.method4337().aClass217_2599;
		int i_192_ = (int) class217.x >> anInt3504 * -1688804109;
		int i_193_ = (int) class217.y >> -1688804109 * anInt3504;
	...
	void method4046(Class365_Sub1 class365_sub1, Class298_Sub10[] class298_sub10s) {
		...
		if (aClass_xaArray3517 == aClass_xaArray3521) {
			...
			if (class365_sub1 instanceof Class365_Sub1_Sub1) {
				...
				i = (int) class217.x >> anInt3504 * -1688804109;
				i_195_ = (int) class217.y >> anInt3504 * -1688804109;
			}
			...
			((Class331) this).aClass_ra3508.method5058(aClass_xaArray3519[0].method6340((int) class217.x, (int) class217.y, -1986155301), class78);
		}
		Class335 class335 = class365_sub1.drawFloor(((Class331) this).aClass_ra3508, -461368503);
		if (null != class335) {
	...
	public void method4052(boolean bool, int i) {
		try {
			...
			anInt3548 = (aClass326ArrayArrayArray3516 == null ? 0 : aClass326ArrayArrayArray3516.length) * 1634141397;
		} catch (RuntimeException runtimeexception) {
	...
	public void method4053(int i, int i_257_, int i_258_, int i_259_, Class365_Sub1_Sub4 class365_sub1_sub4, int i_260_) {
		try {
			...
			if (null != class326) {
				class365_sub1_sub4.setPosition(new SceneObjectPosition((float) ((i_257_ << anInt3504 * -1688804109) + (394962841 * ((Class331) this).anInt3546)), (float) i_259_, (float) ((i_258_ << -1688804109 * anInt3504) + 394962841 * (((Class331) this).anInt3546))));
	...
	static final void method4062(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1045422783 * class105.textColor;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("nu.pc(").append(')').toString());
		}
	}

	static WidgetConfig method4063(WidgetConfig class105, byte i) {
		try {
			WidgetConfig class105_291_ = client.method2808(class105);
