...
public class Class48 {
	...
	OpenGLLegacyToolkit aClass_ra_Sub2_495;
	static int[] anIntArray496 = new int[2];

	Class48(OpenGLLegacyToolkit class_ra_sub2, int i, int i_0_) {
		((Class48) this).aClass_ra_Sub2_495 = class_ra_sub2;
		((Class48) this).anInt492 = i;
	}

	static Class48 method526(OpenGLLegacyToolkit class_ra_sub2, int i, String string) {
