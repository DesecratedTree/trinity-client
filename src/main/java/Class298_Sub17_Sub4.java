...
public class Class298_Sub17_Sub4 extends Class298_Sub17 {
	...
	static final void method2925(ClientScript2 class403, int i) {
		try {
			...
			WorldMapArea class298_sub37_sub13 = WorldMap.method3705(i_0_);
		...
		try {
			if (client.aClass105_8850 == null) {
				if (!Class436.aBoolean5478) {
					...
					int i_1_ = Class165.aClass319_6366.method3894((byte) -81);
					int i_2_ = Class165.aClass319_6366.method3883((byte) -7);
					if (!Class436.aBoolean5471) {
						if (i_1_ > Class88.anInt806 * -1347746885 && i_1_ < (608683427 * Class134.anInt6343 + Class88.anInt806 * -1347746885)) {
							...
							for (int i_4_ = 0; i_4_ < Class436.anInt5506 * -278777595; i_4_++) {
								if (Class436.aBoolean5496) {
									int i_5_ = ((-411680299 * Class436.anInt5467 * (-278777595 * Class436.anInt5506 - 1 - i_4_)) + (1 + ((class505.anInt6202 * 1110385787) + (20 + (GroundMessage.anInt7658 * 1089948687)))));
									if (i_2_ > i_5_ - (class505.anInt6202 * 1110385787) - 1 && i_2_ < (class505.anInt6197 * -1883958527) + i_5_)
										i_3_ = i_4_;
								} else {
									int i_6_ = (((Class436.anInt5506 * -278777595 - 1 - i_4_) * (Class436.anInt5467 * -411680299)) + ((1089948687 * GroundMessage.anInt7658) + 31));
						...
						for (int i_9_ = 0; i_9_ < 1592446965 * Class436.anInt5479; i_9_++) {
							if (Class436.aBoolean5496) {
								int i_10_ = (i_9_ * (Class436.anInt5467 * -411680299) + (1 + ((GroundMessage.anInt7658 * 1089948687) + 20 + (class505.anInt6202 * 1110385787))));
								if (i_2_ > (i_10_ - class505.anInt6202 * 1110385787 - 1) && i_2_ < (class505.anInt6197 * -1883958527 + i_10_))
									i_8_ = i_9_;
							} else {
								int i_11_ = (GroundMessage.anInt7658 * 1089948687 + 31 + i_9_ * (-411680299 * Class436.anInt5467));
