...
public abstract class Class343 {
	...
	static final void method4160(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub29_7582.method5726(-2143352335);
		} catch (RuntimeException runtimeexception) {
	...
	static boolean method4162(int i) {
		...
		//	System.out.println("interface packet received "+client.anInt8713);
