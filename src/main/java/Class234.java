...
public class Class234 {
	...
	public static void method2175(int i) {
		try {
			if (Class230.loadingInterfaces != null) {
				Interface12[] interface12s = Class230.loadingInterfaces;
	...
	static final void method2176(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_10_, (byte) 60);
	...
	static final void method2180(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub29_7553.method5726(-2145285486);
		} catch (RuntimeException runtimeexception) {
	...
	public static void method2181(RsBitsBuffer class298_sub53_sub2, int i) {
		try {
			...
			if (null != class298_sub47) {
				...
				class298_sub47.remove(-1460969981);
			}
		} catch (RuntimeException runtimeexception) {
	...
	static Class298_Sub32 method2182(int i, byte i_21_) {
		try {
			...
			case 39:
				return new SpriteTextureConfig();
			case 1:
	...
	static final void method2184(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
			boolean bool = ((((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]) == 1);
			
			if (class105.getID() == 751 && class105.getComponentID() == 4 && Settings.ENABLE_OSRS_GAMEFRAME
					&& Class190.getDisplayMode((byte) -125) >= 2)
				bool = true;
			...
			if (-1 == -1309843523 * class105.anInt1154 && !class119.aBoolean1403)
				Class413.method5583(-440872681 * class105.uid, (short) 945);
		} catch (RuntimeException runtimeexception) {
