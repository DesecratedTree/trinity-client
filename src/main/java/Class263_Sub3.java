...
public class Class263_Sub3 extends Class263 implements Interface9_Impl1 {
	...
	Class263_Sub3(OpenGLToolkit class_ra_sub3_sub1, int i, boolean bool, int[][] is) {
		...
		if (bool) {
			...
			for (int i_1_ = 0; i_1_ < 6; i_1_++)
				OpenGL.glTexImage2Di(34069 + i_1_, 0, OpenGLToolkit.method5533((((Class263_Sub3) this).aClass55_6419), (((Class263_Sub3) this).aClass77_6420)), i, i, 0, OpenGLToolkit.method5532(((Class263_Sub3) this).aClass55_6419), (((OpenGLToolkit) ((Class263_Sub3) this).aClass_ra_Sub3_Sub1_6422).anInt9841), is[i_1_], 0);
		}
	}
