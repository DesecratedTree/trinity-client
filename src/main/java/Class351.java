...
public class Class351 {
	...
	List<Class342> aList3766;
	int anInt3767;
	List<Class298_Sub45> aList3768;
	int anInt3769;
	...
	Class351(int i, boolean bool) {
		...
		((Class351) this).aList3766 = new LinkedList<Class342>();
		((Class351) this).anInt3760 = 0;
		((Class351) this).aList3768 = new LinkedList<Class298_Sub45>();
	...
	boolean method4222(GraphicsToolkit class_ra, long l) {
		...
		if (((Class351) this).aBoolean3770) {
			Iterator<Class342> iterator = ((Class351) this).aList3766.iterator();
			while (iterator.hasNext()) {
				Class342 class342 = iterator.next();
	...
	void method4223() {
		aBoolean3772 = true;
		Iterator<Class298_Sub45> iterator = ((Class351) this).aList3768.iterator();
		while (iterator.hasNext()) {
			Class298_Sub45 class298_sub45 = iterator.next();
			if ((((Class298_Sub45) class298_sub45).aClass190_7514.anInt1940 * -1955592777) == 1)
				class298_sub45.remove(-1460969981);
		}
