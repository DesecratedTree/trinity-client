...
public class Class190 {
	...
	public static LinkedArrayList aClass437_1928;
	...
	static {
		aClass437_1928 = new LinkedArrayList(16);
	...
	static final void method1856(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_4_, (byte) 2);
	...
	static final void method1858(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub4_7563.method5612(i_6_, 1352882135);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("hy.aos(").append(')').toString());
		}
	}

	public static int getDisplayMode(byte i) {
		try {
			if (Class452.fullScreen && null != Class231.fullScreenFrame)
				return 3;
