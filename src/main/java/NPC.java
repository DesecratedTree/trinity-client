...
public class NPC extends Entity {
	...
	void method4453(int i) {
		try {
			...
			if (Class422_Sub25.preferences.aClass422_Sub16_7557.method5687(2100839354) == 1)
	...
	void method4373(GraphicsToolkit class_ra) {
		if (config != null && (((NPC) this).aBoolean10128 || method4454(class_ra, 0, 498700808))) {
	...
	Class335 drawFloor(GraphicsToolkit class_ra, int i) {
		try {
			if (config == null || !method4454(class_ra, 526336, -1241441124))
				return null;
			...
			Class326 class326 = (aClass331_7722.aClass326ArrayArrayArray3516[plane][(int) class235.aClass217_2599.x >> 9][(int) class235.aClass217_2599.y >> 9]);
			...
			StanceConfig class350 = getStanceConfig(1744135386);
			NPCConfig class503 = (config.anIntArray6188 != null ? config.method6240(Class128.aClass148_6331, 1631739764) : config);
			((NPC) this).aBoolean10129 = false;
			Class335 class335 = null;
			if (Class422_Sub25.preferences.aClass422_Sub18_7561.method5693(-1104068428) == 1 && class503.opcode111V && class350.aBoolean3756) {
				...
				Class387 class387 = (Class283.method2678(class_ra, i_3_, (((NPC) this).anInt10097 * -155466425), (-197572281 * ((NPC) this).anInt10073), (-104151209 * ((NPC) this).anInt10074), -2095128707 * config.anInt6187, aClass387Array10082[0], config.aShort6191 & 0xffff, config.aShort6153 & 0xffff, config.aByte6168 & 0xff, config.aByte6152 & 0xff, null != class438_5_ ? class438_5_ : class438, 1812843484));
				if (null != class387) {
					...
					class_ra.RA(false);
					class387.drawModel(class222_2_, (aClass302_Sub1Array7726[aClass387Array10082.length]), 0);
					class_ra.RA(true);
				}
			}
			...
			for (int i_6_ = 0; i_6_ < aClass387Array10082.length; i_6_++) {
				if (aClass387Array10082[i_6_] != null) {
					...
					aClass387Array10082[i_6_].drawModel(class222_2_, aClass302_Sub1Array7726[i_6_], 0);
				}
			}
	...
	boolean method4454(GraphicsToolkit class_ra, int i, int i_8_) {
		try {
			int i_9_ = i;
			StanceConfig class350 = getStanceConfig(979705538);
			...
			Class387 class387 = (aClass387Array10082[0] = config.method6236(class_ra, i, Class94.aClass349_913, Class128.aClass148_6331, class438, class438_10_, aClass438_Sub2_Sub1Array10112, anIntArray10085, i_13_, aClass498_10181, getStanceID(-1491129226), false, -679459424));
			if (null == class387)
				return false;
	...
	void method4357(GraphicsToolkit class_ra, int i) {
		try {
			if (config != null && (((NPC) this).aBoolean10128 || method4454(class_ra, 0, -1205291751))) {
				Class222 class222 = class_ra.method5178();
				class222.method2070(method4347());
				class222.method2064(0.0F, -5.0F, 0.0F);
	...
	public final void method4455(Class274 class274, int i, short i_15_) {
		try {
			...
			if (aClass438_10078.method5819((byte) -128) && (aClass438_10078.method5820(1057375366).resetOnMovement * -882531177) == 1) {
			...
			for (int i_18_ = 0; i_18_ < currentGraphics.length; i_18_++) {
				if (currentGraphics[i_18_].id * -967533709 != -1) {
					GraphicsConfig class398 = (Class158_Sub1.aClass389_8568.method4857(-967533709 * currentGraphics[i_18_].id, -1708083255));
					if (class398.aBoolean5215 && class398.animation * 1505778629 != -1 && (Class501.aClass395_6122.method4903(class398.animation * 1505778629, (byte) -23).resetOnMovement) * -882531177 == 1) {
	...
	public void method4456(int i, int i_20_, int i_21_, boolean bool, int i_22_, byte i_23_) {
		try {
			...
			if (client.aClass283_8716.method2654(1132456995).method2320(i_20_, i_21_, 1587070733))
				aByte7724++;
			if (aClass438_10078.method5819((byte) -33) && (aClass438_10078.method5820(1592092831).resetOnMovement * -882531177) == 1) {
				anIntArray10093 = null;
			...
			for (int i_24_ = 0; i_24_ < currentGraphics.length; i_24_++) {
				if (-1 != currentGraphics[i_24_].id * -967533709) {
					GraphicsConfig class398 = (Class158_Sub1.aClass389_8568.method4857(-967533709 * currentGraphics[i_24_].id, -1738473272));
					if (class398.aBoolean5215 && -1 != 1505778629 * class398.animation && (Class501.aClass395_6122.method4903(class398.animation * 1505778629, (byte) 83).resetOnMovement) * -882531177 == 1) {
			...
			class217.y = (float) ((scenePositionYQueue[0] << 9) + (i_22_ << 8));
			setPosition(class217);
			class217.method2006();
			if (((NPC) this).aClass351_10067 != null)
	...
	int getStanceID(int i) {
		try {
			if (-1 != -1317338937 * anInt10184)
				return anInt10184 * -1317338937;
			if (null != config.anIntArray6188) {
				NPCConfig class503 = config.method6240(Class128.aClass148_6331, 1794284929);
				if (class503 != null && 525312939 * class503.stanceID != -1)
					return 525312939 * class503.stanceID;
			}
			return config.stanceID * 525312939;
		} catch (RuntimeException runtimeexception) {
	...
	public int method4427(byte i) {
		try {
			if (null != config.anIntArray6188) {
				NPCConfig class503 = config.method6240(Class128.aClass148_6331, 1605369279);
				if (class503 != null && -1 != 363729791 * class503.anInt6178)
					return 363729791 * class503.anInt6178;
			}
			return 363729791 * config.anInt6178;
		} catch (RuntimeException runtimeexception) {
	...
	int method4458() {
		if (config == null)
			return 0;
		return config.anInt6192 * -226722581;
	}
	...
	boolean method4350(GraphicsToolkit class_ra, int i, int i_28_, byte i_29_) {
		try {
			if (config == null || !method4454(class_ra, 131072, -1046532898))
				return false;
			Class222 class222 = method4347();
			boolean bool = false;
			for (int i_30_ = 0; i_30_ < aClass387Array10082.length; i_30_++) {
				if (null != aClass387Array10082[i_30_]) {
					...
					while_55_: do {
						do {
							if (-226722581 * config.anInt6192 <= 0) {
								if (286060383 * config.anInt6189 == -1) {
									if (1 != (config.anInt6187 * -2095128707))
										break;
									if (i_29_ != 1)
										throw new IllegalStateException();
								} else if (1 != (config.anInt6189 * 286060383))
									break;
							}
							bool_31_ = true;
							break while_55_;
					...
					boolean bool_33_ = (aClass387Array10082[i_30_].method4787(i, i_28_, class222, bool_32_, config.anInt6192 * -226722581));
					if (bool_33_) {
						bool = true;
						break;
					}
	...
	public boolean method4429(byte i) {
		try {
			return LinkedArrayList.WIDGET_DETAILS.aBoolean4041;
		} catch (RuntimeException runtimeexception) {
	...
	public void method4461(String string, int i, int i_38_, int i_39_) {
		try {
			int i_40_ = (Class82_Sub5.method883((byte) 6) * (LinkedArrayList.WIDGET_DETAILS.anInt4036 * -478874963));
	...
	public int method4435() {
		if (config.anIntArray6188 != null) {
			NPCConfig class503 = config.method6240(Class128.aClass148_6331, 1815832117);
			if (null != class503 && class503.anInt6143 * -1575020259 != -1)
				return class503.anInt6143 * -1575020259;
		}
		return (-1575020259 * config.anInt6143 != -1 ? -1575020259 * config.anInt6143 : super.method4363((byte) -104));
	}

	public int method4436() {
		if (config.anIntArray6188 != null) {
			NPCConfig class503 = config.method6240(Class128.aClass148_6331, 1928445532);
			if (null != class503 && class503.anInt6143 * -1575020259 != -1)
				return class503.anInt6143 * -1575020259;
		}
		return (-1575020259 * config.anInt6143 != -1 ? -1575020259 * config.anInt6143 : super.method4363((byte) -11));
	}

	Class335 method4370(GraphicsToolkit class_ra) {
		if (config == null || !method4454(class_ra, 526336, -1153791486))
			return null;
		Class222 class222 = method4347();
		Class235 class235 = method4337();
		...
		StanceConfig class350 = getStanceConfig(1676580874);
		NPCConfig class503 = (config.anIntArray6188 != null ? config.method6240(Class128.aClass148_6331, 1779938932) : config);
		((NPC) this).aBoolean10129 = false;
		Class335 class335 = null;
		if (Class422_Sub25.preferences.aClass422_Sub18_7561.method5693(-1718454976) == 1 && class503.opcode111V && class350.aBoolean3756) {
			...
			Class387 class387 = (Class283.method2678(class_ra, i, (((NPC) this).anInt10097 * -155466425), (-197572281 * ((NPC) this).anInt10073), (-104151209 * ((NPC) this).anInt10074), -2095128707 * config.anInt6187, aClass387Array10082[0], config.aShort6191 & 0xffff, config.aShort6153 & 0xffff, config.aByte6168 & 0xff, config.aByte6152 & 0xff, null != class438_43_ ? class438_43_ : class438, 1812843484));
			if (null != class387) {
				if (null == aClass302_Sub1Array7726 || (aClass302_Sub1Array7726.length < aClass387Array10082.length + 1))
				...
				((NPC) this).aBoolean10129 = true;
				class_ra.RA(false);
				class387.drawModel(class222_41_, (aClass302_Sub1Array7726[aClass387Array10082.length]), 0);
				class_ra.RA(true);
			}
		}
		if (null == aClass302_Sub1Array7726 || aClass302_Sub1Array7726.length < aClass387Array10082.length)
		...
		for (int i_44_ = 0; i_44_ < aClass387Array10082.length; i_44_++) {
			if (aClass387Array10082[i_44_] != null) {
				...
				aClass387Array10082[i_44_].drawModel(class222_41_, (aClass302_Sub1Array7726[i_44_]), 0);
			}
		}
		if (((NPC) this).aClass351_10067 != null) {
			Class69 class69 = ((NPC) this).aClass351_10067.method4229();
	...
	void method4371(GraphicsToolkit class_ra) {
		if (config != null && (((NPC) this).aBoolean10128 || method4454(class_ra, 0, -1590633829))) {
			Class222 class222 = class_ra.method5178();
			class222.method2070(method4347());
			class222.method2064(0.0F, -5.0F, 0.0F);
	...
	boolean method4372(GraphicsToolkit class_ra, int i, int i_46_) {
		if (config == null || !method4454(class_ra, 131072, 1720809223))
			return false;
		Class222 class222 = method4347();
		boolean bool = false;
		for (int i_47_ = 0; i_47_ < aClass387Array10082.length; i_47_++) {
			if (null != aClass387Array10082[i_47_]) {
				...
				boolean bool_50_ = aClass387Array10082[i_47_].method4787(i, i_46_, class222, bool_49_, ((config.anInt6192) * -226722581));
				if (bool_50_) {
					bool = true;
					break;
				}
	...
	boolean method4385(GraphicsToolkit class_ra, int i, int i_52_) {
		if (config == null || !method4454(class_ra, 131072, -1030471484))
			return false;
		Class222 class222 = method4347();
		boolean bool = false;
		for (int i_53_ = 0; i_53_ < aClass387Array10082.length; i_53_++) {
			if (null != aClass387Array10082[i_53_]) {
				...
				boolean bool_56_ = aClass387Array10082[i_53_].method4787(i, i_52_, class222, bool_55_, ((config.anInt6192) * -226722581));
				if (bool_56_) {
					bool = true;
					break;
				}
	...
	int method4447() {
		if (-1 != -1317338937 * anInt10184)
			return anInt10184 * -1317338937;
		if (null != config.anIntArray6188) {
			NPCConfig class503 = config.method6240(Class128.aClass148_6331, 1618298715);
			if (class503 != null && 525312939 * class503.stanceID != -1)
				return 525312939 * class503.stanceID;
		}
		return config.stanceID * 525312939;
	...
	int method4446() {
		if (-1 != -1317338937 * anInt10184)
			return anInt10184 * -1317338937;
		if (null != config.anIntArray6188) {
			NPCConfig class503 = config.method6240(Class128.aClass148_6331, 1807692721);
			if (class503 != null && 525312939 * class503.stanceID != -1)
				return 525312939 * class503.stanceID;
		}
		return config.stanceID * 525312939;
	...
	int method4438() {
		if (-1 != -1317338937 * anInt10184)
			return anInt10184 * -1317338937;
		if (null != config.anIntArray6188) {
			NPCConfig class503 = config.method6240(Class128.aClass148_6331, 1685758496);
			if (class503 != null && 525312939 * class503.stanceID != -1)
				return 525312939 * class503.stanceID;
		}
		return config.stanceID * 525312939;
	...
	int method4448() {
		if (-1 != -1317338937 * anInt10184)
			return anInt10184 * -1317338937;
		if (null != config.anIntArray6188) {
			NPCConfig class503 = config.method6240(Class128.aClass148_6331, 1859138308);
			if (class503 != null && 525312939 * class503.stanceID != -1)
				return 525312939 * class503.stanceID;
		}
		return config.stanceID * 525312939;
	...
	public int method4449() {
		if (null != config.anIntArray6188) {
			NPCConfig class503 = config.method6240(Class128.aClass148_6331, 1923690826);
			if (class503 != null && -1 != 363729791 * class503.anInt6178)
				return 363729791 * class503.anInt6178;
		}
		return 363729791 * config.anInt6178;
	...
	public int method4363(byte i) {
		try {
			if (config.anIntArray6188 != null) {
				NPCConfig class503 = config.method6240(Class128.aClass148_6331, 1652651645);
				if (null != class503 && class503.anInt6143 * -1575020259 != -1)
					return class503.anInt6143 * -1575020259;
			}
			return (-1575020259 * config.anInt6143 != -1 ? -1575020259 * config.anInt6143 : super.method4363((byte) 61));
		} catch (RuntimeException runtimeexception) {
	...
	public void setConfig(NPCConfig class503, int i) {
		try {
			if (class503 != config && Class436.aBoolean5478 && Class518.method6313(anInt10064 * 1888274983, 351851633))
				Class194.method1868(2025307040);
			config = class503;
			if (config != null) {
				aString10186 = config.name;
				combatLevel = config.combatLevel * 1520279523;
			}
			if (((NPC) this).aClass351_10067 != null)
				((NPC) this).aClass351_10067.method4220();
		} catch (RuntimeException runtimeexception) {
	...
	boolean method4352(GraphicsToolkit class_ra, int i, int i_65_) {
		if (config == null || !method4454(class_ra, 131072, 76578294))
			return false;
		Class222 class222 = method4347();
		boolean bool = false;
		for (int i_66_ = 0; i_66_ < aClass387Array10082.length; i_66_++) {
			if (null != aClass387Array10082[i_66_]) {
				...
				boolean bool_69_ = aClass387Array10082[i_66_].method4787(i, i_65_, class222, bool_68_, ((config.anInt6192) * -226722581));
				if (bool_69_) {
					bool = true;
					break;
				}
