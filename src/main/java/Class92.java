...
public final class Class92 {
	static java.util.Map<Class429, ConcurrentLinkedQueue<?>> aMap901;
	public static long aLong902 = 1000L;
	static HashMap<String, TimeZone> aHashMap903 = new HashMap<String, TimeZone>();
	...
	static String method1004(Date date, String string, TimeZone timezone, Class429 class429, int i) {
		try {
			if (null == aMap901) {
				aMap901 = new HashMap<Class429, ConcurrentLinkedQueue<?>>(6);
				...
				for (int i_0_ = 0; i_0_ < class429s.length; i_0_++) {
					...
					aMap901.put(class429_1_, new ConcurrentLinkedQueue<Object>());
				}
			}
			@SuppressWarnings("unchecked")
			ConcurrentLinkedQueue<SimpleDateFormat> concurrentlinkedqueue = (ConcurrentLinkedQueue<SimpleDateFormat>) aMap901.get(class429);
