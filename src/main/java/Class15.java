...
public class Class15 {
	...
	SafemodeToolkit aClass_ra_Sub1_182;
	float aFloat183;
	int anInt184;
	int anInt185;
	boolean aBoolean186;
	...
	Matrix aClass233_190;
	float aFloat191;
	Class2 aClass2_192;
	float aFloat193;
	Matrix aClass233_194;
	Matrix aClass233_195;
	int anInt196;
	...
	Class15(SafemodeToolkit class_ra_sub1) {
		...
		((Class15) this).aClass233_190 = new Matrix();
		((Class15) this).aClass222_219 = new Class222();
		((Class15) this).aClass222_189 = new Class222();
		((Class15) this).aClass233_194 = new Matrix();
		((Class15) this).aClass233_195 = new Matrix();
	...
	static final void method349(ClientScript2 class403, int i) {
		try {
			...
			ItemConfig class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_0_);
			if (-1673957995 * class468.certTemplate == -1 && 809765849 * class468.cert >= 0)
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 809765849 * class468.cert;
			else
