...
public abstract class Class247 {
	Class461 nonPriorityArchives2;
	static int anInt2733 = 512;
	static int anInt2734 = 20;
	public volatile int anInt2735;
	Class461 priorityArchives = new Class461();
	RsByteBuffer stream;
	Class461 nonPriorityArchives;
	...
	Class298_Sub37_Sub16_Sub1 requestArchive(int i, int i_0_, byte i_1_, boolean priority, int i_2_) {
		try {
			...
			((Class298_Sub37_Sub16_Sub1) class298_sub37_sub16_sub1).headerSize = i_1_;
			((Class298_Sub37_Sub16_Sub1) class298_sub37_sub16_sub1).priority = priority;
			if (priority) {
				if (method2348(2080324549) >= 50)
					throw new RuntimeException();
				((Class247) this).priorityArchives.method5982(class298_sub37_sub16_sub1, (byte) -14);
			} else {
				if (method2341(144457290) >= 20)
					throw new RuntimeException();
				((Class247) this).nonPriorityArchives.method5982(class298_sub37_sub16_sub1, (byte) -22);
			}
	...
	int method2341(int i) {
		try {
			return (((Class247) this).nonPriorityArchives.method5986((short) -13891) + ((Class247) this).nonPriorityArchives2.method5986((short) -16314));
		} catch (RuntimeException runtimeexception) {
	...
	Class247() {
		((Class247) this).nonPriorityArchives = new Class461();
		((Class247) this).nonPriorityArchives2 = new Class461();
		((Class247) this).aClass298_Sub53_2744 = new RsByteBuffer(6);
		((Class247) this).aByte2743 = (byte) 0;
		anInt2735 = 0;
		anInt2745 = 0;
		((Class247) this).stream = new RsByteBuffer(10);
	}
	...
	public int method2348(int i) {
		try {
			return (((Class247) this).priorityArchives.method5986((short) -18478) + ((Class247) this).aClass461_2742.method5986((short) -10486));
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2363(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			class105.flippedHorizontally = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) == 1;
	...
	static final void method2364(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_4_, (byte) 36);
	...
	public static int method2366(Class298_Sub37_Sub15 class298_sub37_sub15, byte i) {
		try {
			...
			if (Class214.method1993(i_5_, 1867074090))
				return 1;
			if (GraphicsConfig.method4920(i_5_, (short) 300))
				return 2;
	...
	static final void method2367(ClientScript2 class403, int i) {
		try {
			...
			if (null == class298_sub52) {
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = -530122905 * class298_sub52.mapAreaID;
				int i_6_ = (-1740053407 * class298_sub52.anInt7605 << 28 | (2122110429 * class298_sub52.x + WorldMap.baseX) << 14 | (WorldMap.baseY + -372920341 * class298_sub52.y));
	...
	public static void method2371(byte i) {
		try {
			...
			if (client.aBoolean8763 && ClientScriptsExecutor.anInt4120 * -2116412357 <= 0) {
				...
				Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.MOVE_CAMERA_PACKET, client.aClass25_8711.aClass449_330, (byte) 50);
			...
			if (!client.sentPreferences) {
				Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2003, client.aClass25_8711.aClass449_330, (byte) 9);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(0);
				int i_10_ = (385051775 * class298_sub36.aClass298_Sub53_Sub2_7396.index);
				RsByteBuffer class298_sub53 = Class422_Sub25.preferences.encode(-49990428);
	...
	static void method2372(GraphicsToolkit class_ra, int i, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_) {
		try {
			if ((null == Class486.aClass57_6062 || null == Class501.aClass57_6123 || Class367.aClass57_4001 == null) && Class158.aClass243_6364.method2310(Class162.anInt1680 * 1049272911, -457216440) && Class158.aClass243_6364.method2310(Class361.anInt3914 * -745532315, -457216440) && Class158.aClass243_6364.method2310((-684155443 * Class260.anInt2820), -457216440)) {
				Class89 class89 = Class89.getSprite(Class158.aClass243_6364, -745532315 * Class361.anInt3914, 0);
				Class501.aClass57_6123 = class_ra.method5125(class89, true);
				class89.rotateLeft();
				Class82_Sub8.aClass57_6855 = class_ra.method5125(class89, true);
				Class486.aClass57_6062 = (class_ra.method5125(Class89.getSprite(Class158.aClass243_6364, 1049272911 * Class162.anInt1680, 0), true));
				Class89 class89_16_ = Class89.getSprite(Class158.aClass243_6364, Class260.anInt2820 * -684155443, 0);
				Class367.aClass57_4001 = class_ra.method5125(class89_16_, true);
				class89_16_.rotateLeft();
				FloorOverlay.aClass57_4070 = class_ra.method5125(class89_16_, true);
			}
			if (null != Class486.aClass57_6062 && Class501.aClass57_6123 != null && Class367.aClass57_4001 != null) {
				...
				for (int i_18_ = 0; i_18_ < i_17_; i_18_++)
					Class486.aClass57_6062.drawSprite((i + Class367.aClass57_4001.method623() + i_18_ * Class486.aClass57_6062.method623()), i_11_ + i_13_ - Class486.aClass57_6062.method625());
				int i_19_ = ((i_13_ - i_14_ - Class367.aClass57_4001.method625()) / Class501.aClass57_6123.method625());
				for (int i_20_ = 0; i_20_ < i_19_; i_20_++) {
					Class501.aClass57_6123.drawSprite(i, (i_14_ + i_11_ + i_20_ * Class501.aClass57_6123.method625()));
					Class82_Sub8.aClass57_6855.drawSprite(i_12_ + i - Class82_Sub8.aClass57_6855.method623(), (i_14_ + i_11_ + i_20_ * Class501.aClass57_6123.method625()));
				}
				Class367.aClass57_4001.drawSprite(i, (i_13_ + i_11_ - Class367.aClass57_4001.method625()));
				FloorOverlay.aClass57_4070.drawSprite(i_12_ + i - Class367.aClass57_4001.method623(), i_11_ + i_13_ - Class367.aClass57_4001.method625());
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2373(ClientScript2 class403, byte i) {
		try {
			...
			Class461 class461 = WorldMap.method3693(i_21_ >> 14 & 0x3fff, i_21_ & 0x3fff);
			boolean bool = false;
			for (WorldMapArea class298_sub37_sub13 = (WorldMapArea) class461.method5984(1544902477); class298_sub37_sub13 != null; class298_sub37_sub13 = ((WorldMapArea) class461.method5985(1578702645))) {
				if (-947282109 * class298_sub37_sub13.id == i_22_) {
					bool = true;
					break;
				}
			}
	...
	static final void method2374(ClientScript2 class403, int i) {
		try {
			...
			int i_24_ = Class422_Sub25.preferences.aClass422_Sub29_7587.method5726(-2143149199);
			if (i_23_ != i_24_ && (Class300.LOGIN_MUSIC * 782166935 == Class300.musicID * -1256171511)) {
				if (!Class435.method5804(client.anInt8752 * -1233866115, (byte) 33)) {
					if (0 == i_24_) {
						Class477.method6096(Class374_Sub1.MUSIC, -1256171511 * Class300.musicID, 0, i_23_, false, -2072200222);
				...
				Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub29_7587, i_23_, -1422708524);
