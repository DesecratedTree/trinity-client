...
public class RsByteBuffer extends Class298 {
	...
	public void write5Bytes(long l) {
		try {
	...
	public void readBytes(byte[] is, int i, int i_17_, int i_18_) {
		try {
			for (int i_19_ = i; i_19_ < i + i_17_; i_19_++)
				is[i_19_] = buffer[(index += 116413311) * 385051775 - 1];
		} catch (RuntimeException runtimeexception) {
	...
	public void applyRsa(BigInteger biginteger, BigInteger biginteger_66_, int i) {
		try {
			...
			BigInteger biginteger_69_ = Settings.DISABLE_RSA ? biginteger_68_ : biginteger_68_.modPow(biginteger, biginteger_66_);
    ...
    public int readSmartShortMinusOne() {
        int i_118_ = buffer[385051775 * index] & 0xff;
        if (i_118_ < 128)
	...
	static final void method3654(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_89_, (byte) 28);
			Class119 class119 = Class389.aClass119Array4165[i_89_ >> 16];
			AnimationConfig.method4887(class105, class119, class403, (byte) -121);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method3655(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class422_Sub25.preferences.aClass422_Sub13_7549.method5674(-484902399) && FloorOverlay.graphics.method5032()) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
