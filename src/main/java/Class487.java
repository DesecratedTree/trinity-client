...
public class Class487 {
	...
	public Class496 method6159(int i, int i_0_) {
		try {
			...
			synchronized (((Class487) this).aClass243_6067) {
				is = (((Class487) this).aClass243_6067.getFileFromArchive(ConfigFile.aClass120_1419.anInt1460 * -1006924897, i, (byte) -51));
			}
	...
	public Class487(Class411 class411, Class429 class429, CacheIndex class243, CacheIndex class243_3_) {
		...
		((Class487) this).aClass243_6067.method2316((ConfigFile.aClass120_1419.anInt1460) * -1006924897, 1339445894);
		Math.random();
		Math.random();
		Math.random();
		Math.random();
