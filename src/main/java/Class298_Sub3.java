...
public class Class298_Sub3 extends Class298 {
	...
	int anInt7171;
	int anInt7172;
	OpenGLLegacyToolkit aClass_ra_Sub2_7173;
	...
	void method2851(short i) {
		if (((OpenGLLegacyToolkit) ((Class298_Sub3) this).aClass_ra_Sub2_7173).aBoolean8143)
	...
	void method2853(int i, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
		...
		if ((i_9_ & 0x7f) == 0 || (i_10_ & 0x7f) == 0) {
			...
			Class298 class298 = ((Class298_Sub3) this).aClass440_7186.method5852(l);
			if (class298 != null) {
	...
	Class298_Sub3(OpenGLLegacyToolkit class_ra_sub2, Class_xa_Sub3 class_xa_sub3, Class298_Sub10 class298_sub10, int[] is) {
