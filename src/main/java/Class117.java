...
public class Class117 {
	...
	static boolean method1275(byte i) {
		try {
			return Class492.hasPressed(Class144.aClass381_1563.aClass355_4116, -1677177503);
		} catch (RuntimeException runtimeexception) {
	...
	public static final void method1279(int i) {
		try {
			String string = (null != Class486.aString6063 ? Class486.aString6063 : ClientScriptMap.recoverPassLink((byte) -3));
			Class346.method4172(string, false, Class422_Sub25.preferences.graphicsMode.method5677(-2014540467) == 5, client.aBoolean8867, client.aBoolean8651, (byte) 37);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("et.fb(").append(')').toString());
		}
	}

	public static void method1280(int interfaceHash, int i_11_, int i_12_) {
		try {
			...
			class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(interfaceHash, -1769259974);
	...
	static void method1282(WidgetConfig[] class105s, WidgetConfig class105, boolean bool, short i) {
		try {
			int i_13_ = (0 != 1867913305 * class105.scrollWidth ? 1867913305 * class105.scrollWidth : -2093041337 * class105.anInt1156);
			int i_14_ = (0 != 2053897963 * class105.scrollHeight ? class105.scrollHeight * 2053897963 : 457937409 * class105.anInt1162);
			Class372.method4591(class105s, -440872681 * class105.uid, i_13_, i_14_, bool, (short) 17804);
			if (null != class105.aClass105Array1293)
				Class372.method4591(class105.aClass105Array1293, -440872681 * class105.uid, i_13_, i_14_, bool, (short) -9832);
			...
			if (class105 == client.aClass105_8819) {
				...
				for (int i_17_ = 0; i_17_ < client.anInt8703 * -1230451913; i_17_++) {
					...
					ObjectValue class298_sub29 = ((ObjectValue) client.aClass437_8696.method5812((long) i_18_));
					if (null != class298_sub29)
						((Entity) class298_sub29.value).method4442(i_13_, i_14_, bool, 1554634008);
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1284(ClientScript2 class403, int i) {
		try {
			...
			if (null == Class389.aClass119Array4165[i_19_])
				...
				String string = (Class389.aClass119Array4165[i_19_].components[i_20_].name);
				if (string == null)
					((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
				else
