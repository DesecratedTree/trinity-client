...
public class Class151 implements Interface5 {
	...
	public static Class182 method1643(int i, int i_9_) {
		try {
			...
			int dataFile = i > 1000 ? i - 1000 : i;
			byte[] is = Class182.aClass243_1821.getFileFromArchive(0, dataFile, (byte) -125);
			class182 = new Class182();
			if (null != is)
				class182.method1843(new RsByteBuffer(is), (byte) 20);
			if (i == 1404) {
				class182.anInt1834 = new Color(255, 0, 0, 128).getRGB() * -1365954181;
				class182.anInt1835 = new Color(128, 0, 0, 64).getRGB() * 902519911;
	...
	static boolean method1644(int i) {
		try {
			return Class492.hasPressed(Class144.aClass381_1563.aClass355_4114, -1572506836);
		} catch (RuntimeException runtimeexception) {
