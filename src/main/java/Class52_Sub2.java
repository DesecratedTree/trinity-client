...
public abstract class Class52_Sub2 extends Class52 {
	...
	static final void method588(ClientScript2 class403, short i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_7_, (byte) 56);
	...
	public static void method589(int i) {
		try {
			...
			try {
				class476 = Class86.getPreferences("2", client.aClass411_8944.aString5317, true, -1804643872);
