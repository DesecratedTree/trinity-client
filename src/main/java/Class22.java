...
public class Class22 {
	public static short[][][] appearenceColors;
	...
	static final void method373(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			class105.options = null;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method374(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub3_7556.method5633(-863865720) == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
