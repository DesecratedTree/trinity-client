...
public class Class298_Sub5 extends Class298 {
	...
	float aFloat7196;
	OpenGLLegacyToolkit aClass_ra_Sub2_7197;
	...
	void method2857(int i, int i_2_, int i_3_, float f) {
		if (((Class298_Sub5) this).anInt7199 != -1) {
			TextureConfig class53 = ((Class298_Sub5) this).aClass_ra_Sub2_7197.anInterface_ma5299.method174(((Class298_Sub5) this).anInt7199, 1908731420);
	...
	void method2859(int i) {
		((Class298_Sub5) this).aNativeHeapBuffer7195 = ((OpenGLLegacyToolkit) ((Class298_Sub5) this).aClass_ra_Sub2_7197).aNativeHeap8181.f(i * 4, true);
	...
	void method2861(int[] is, int i) {
		int i_16_ = 0;
		RsFloatBuffer class298_sub53_sub1 = (((OpenGLLegacyToolkit) ((Class298_Sub5) this).aClass_ra_Sub2_7197).aClass298_Sub53_Sub1_8197);
		class298_sub53_sub1.index = 0;
		if (((OpenGLLegacyToolkit) ((Class298_Sub5) this).aClass_ra_Sub2_7197).aBoolean8143) {
		...
		if (i_16_ > 0) {
			...
			if (((OpenGLLegacyToolkit) ((Class298_Sub5) this).aClass_ra_Sub2_7197).aBoolean8146)
