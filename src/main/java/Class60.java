...
public class Class60 {
	...
	final Class387 method700(GraphicsToolkit class_ra, int i, boolean bool, boolean bool_1_, byte i_2_) {
		try {
			ObjectConfig class432 = (((Class60) this).aClass433_585.getObjectDefinitions(1686561661 * ((Class60) this).anInt601));
			...
			if (bool_1_)
				bool_1_ = bool_1_ & (((Class60) this).aBoolean598 & !((Class60) this).aBoolean600 & Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(-896655100) != 0);
			if (bool && !bool_1_) {
			...
			if (bool_1_) {
				class331.method4047(((Class60) this).aClass_na599, ((Class60) this).aByte588, (int) class217.x, (int) class217.y, ((Class60) this).aBooleanArray596, 528677416);
				((Class60) this).aBoolean600 = false;
			}
			...
			if (((Class60) this).aClass438_593.method5819((byte) -82)) {
				...
				if (null != class387) {
					if (bool_1_) {
						...
						class331.method4055(((Class60) this).aClass_na599, ((Class60) this).aByte588, (int) class217.x, (int) class217.y, ((Class60) this).aBooleanArray596, -1719073428);
				...
				if (class454 != null) {
					...
					if (bool_1_) {
						...
						((Class60) this).aBooleanArray596 = null;
						class331.method4055(((Class60) this).aClass_na599, ((Class60) this).aByte588, (int) class217.x, (int) class217.y, null, -1920595487);
						((Class60) this).aBoolean600 = true;
					}
					((Class60) this).anInt586 = class387.YA() * -1931353415;
					class387.n();
	...
	void method701(GraphicsToolkit class_ra, Class387 class387, Class222 class222, int i, int i_4_, int i_5_, int i_6_, boolean bool, int i_7_) {
		try {
	...
	Class60(GraphicsToolkit class_ra, Class433 class433, ObjectConfig class432, int i, int i_8_, int i_9_, int i_10_, Class365_Sub1 class365_sub1, boolean bool, int i_11_) {
		((Class60) this).anInt586 = 0;
		...
		((Class60) this).aBoolean598 = (class_ra.method5082() && class432.scenaryShadows && !((Class60) this).aBoolean591);
		...
		try {
			if (((Class60) this).aClass438_593.method5819((byte) -77)) {
				if (((Class60) this).aClass438_593.method5822((client.anInt8884 * 443738891 - -735091231 * ((Class60) this).anInt594), 1976097000)) {
					if (Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(-184271029) == 2)
						((Class60) this).aBoolean600 = false;
	...
	void method704(boolean bool, int i, int i_12_, int i_13_) {
		try {
			...
			if (i_14_ == -1) {
				ObjectConfig class432 = (((Class60) this).aClass433_585.getObjectDefinitions(((Class60) this).anInt601 * 1686561661));
				ObjectConfig class432_16_ = class432;
				if (class432.toObjectIDs != null)
	...
	void method707(GraphicsToolkit class_ra, int i) {
		try {
			if (null != ((Class60) this).aClass_na599) {
				SceneObjectPosition class217 = (((Class60) this).aClass365_Sub1_587.method4337().aClass217_2599);
				client.aClass283_8716.method2675(-1611682495).method4047(((Class60) this).aClass_na599, ((Class60) this).aByte588, (int) class217.x, (int) class217.y, ((Class60) this).aBooleanArray596, 677085165);
				((Class60) this).aBooleanArray596 = null;
				((Class60) this).aClass_na599 = null;
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method711(ClientScript2 class403, int i) {
		try {
			...
			CacheIndexIndicator.method1235(class105, class403, (byte) 0);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method714(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
			...
			if (i_22_ >= 0 && i_22_ < 5) {
				...
				if (class105.anInt1154 * -1309843523 == -1 && !class119.aBoolean1403)
					Class440.method5862(class105.uid * -440872681, i_22_, 227307662);
			}
		} catch (RuntimeException runtimeexception) {
