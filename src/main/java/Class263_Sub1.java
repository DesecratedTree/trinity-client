...
public class Class263_Sub1 extends Class263 implements Interface9_Impl2_Impl1 {
	...
	Class263_Sub1(OpenGLToolkit class_ra_sub3_sub1, int i, int i_0_, boolean bool, int[] is, int i_1_, int i_2_) {
		...
		if (!bool || i_2_ != 0 || i_1_ != 0) {
			...
			OpenGL.glTexImage2Di(((Class263_Sub1) this).anInt6415, 0, 6408, ((Class263_Sub1) this).anInt9952, ((Class263_Sub1) this).anInt9951, 0, 32993, ((OpenGLToolkit) (((Class263_Sub1) this).aClass_ra_Sub3_Sub1_6422)).anInt9841, is, i_1_ * 4);
			OpenGL.glPixelStorei(3314, 0);
		} else
			method2468(((Class263_Sub1) this).anInt6415, i, i_0_, is);
	}

	Class263_Sub1(OpenGLToolkit class_ra_sub3_sub1, Class55 class55, int i, int i_3_, boolean bool, byte[] is, int i_4_, int i_5_) {
		...
		if (!bool || i_5_ != 0 || i_4_ != 0) {
			...
			if (class55_6_ == Class55.aClass55_564)
				...
				if (class55_7_ == Class55.aClass55_558)
					...
					OpenGL.glTexImage2Dub(((Class263_Sub1) this).anInt6415, 0, OpenGLToolkit.method5533((((Class263_Sub1) this).aClass55_6419), (((Class263_Sub1) this).aClass77_6420)), i, i_3_, 0, OpenGLToolkit.method5532(((Class263_Sub1) this).aClass55_6419), 5121, is, i_4_);
			}
			OpenGL.glPixelStorei(3314, 0);
		} else
	...
	public void method104(int i, int i_8_, int i_9_, int i_10_, byte[] is, Class55 class55, int i_11_, int i_12_) {
		...
		OpenGL.glTexSubImage2Dub(((Class263_Sub1) this).anInt6415, 0, i, i_8_, i_9_, i_10_, OpenGLToolkit.method5532(class55), 5121, is, i_11_);
		OpenGL.glPixelStorei(3314, 0);
		OpenGL.glPixelStorei(3317, 4);
	}
	...
	public void method82(int i, int i_13_, int i_14_, int i_15_, byte[] is, Class55 class55, int i_16_, int i_17_) {
		...
		OpenGL.glTexSubImage2Dub(((Class263_Sub1) this).anInt6415, 0, i, i_13_, i_14_, i_15_, OpenGLToolkit.method5532(class55), 5121, is, i_16_);
		OpenGL.glPixelStorei(3314, 0);
		OpenGL.glPixelStorei(3317, 4);
	}
	...
	public void method81(int i, int i_18_, int i_19_, int i_20_, int[] is, int i_21_, int i_22_) {
		...
		OpenGL.glTexSubImage2Di(((Class263_Sub1) this).anInt6415, 0, i, i_18_, i_19_, i_20_, 32993, ((OpenGLToolkit) (((Class263_Sub1) this).aClass_ra_Sub3_Sub1_6422)).anInt9841, is, i_21_);
		OpenGL.glPixelStorei(3314, 0);
	}
	...
	public void method102(int i, int i_35_, int i_36_, int i_37_, int[] is, int i_38_, int i_39_) {
		...
		OpenGL.glTexSubImage2Di(((Class263_Sub1) this).anInt6415, 0, i, i_35_, i_36_, i_37_, 32993, ((OpenGLToolkit) (((Class263_Sub1) this).aClass_ra_Sub3_Sub1_6422)).anInt9841, is, i_38_);
		OpenGL.glPixelStorei(3314, 0);
	}
	...
	public void method101(int i, int i_45_, int i_46_, int i_47_, int[] is, int i_48_, int i_49_) {
		...
		OpenGL.glTexSubImage2Di(((Class263_Sub1) this).anInt6415, 0, i, i_45_, i_46_, i_47_, 32993, ((OpenGLToolkit) (((Class263_Sub1) this).aClass_ra_Sub3_Sub1_6422)).anInt9841, is, i_48_);
		OpenGL.glPixelStorei(3314, 0);
	}
	...
	Class263_Sub1(OpenGLToolkit class_ra_sub3_sub1, Class55 class55, Class77 class77, int i, int i_50_) {
		super(class_ra_sub3_sub1, 3553, class55, class77, i * i_50_, false);
		((Class263_Sub1) this).anInt9952 = i;
		((Class263_Sub1) this).anInt9951 = i_50_;
		((Class263_Sub1) this).aClass_ra_Sub3_Sub1_6422.method5358(this);
		OpenGL.glTexImage2Dub(((Class263_Sub1) this).anInt6415, 0, OpenGLToolkit.method5533((((Class263_Sub1) this).aClass55_6419), (((Class263_Sub1) this).aClass77_6420)), i, i_50_, 0, OpenGLToolkit.method5532(((Class263_Sub1) this).aClass55_6419), OpenGLToolkit.method5537(((Class263_Sub1) this).aClass77_6420), null, 0);
	}
	...
	public void method87(int i, int i_51_, int i_52_, int i_53_, byte[] is, Class55 class55, int i_54_, int i_55_) {
		...
		OpenGL.glTexSubImage2Dub(((Class263_Sub1) this).anInt6415, 0, i, i_51_, i_52_, i_53_, OpenGLToolkit.method5532(class55), 5121, is, i_54_);
		OpenGL.glPixelStorei(3314, 0);
		OpenGL.glPixelStorei(3317, 4);
	}
	...
	void method2473(int i, int i_63_, int i_64_, int i_65_, float[] fs, Class55 class55, int i_66_, int i_67_) {
		...
		OpenGL.glTexSubImage2Df(((Class263_Sub1) this).anInt6415, 0, i, i_63_, i_64_, i_65_, OpenGLToolkit.method5532(class55), 5121, fs, i_66_);
		OpenGL.glPixelStorei(3314, 0);
	}
	...
	public void method100(int i, int i_68_, int i_69_, int i_70_, byte[] is, Class55 class55, int i_71_, int i_72_) {
		...
		OpenGL.glTexSubImage2Dub(((Class263_Sub1) this).anInt6415, 0, i, i_68_, i_69_, i_70_, OpenGLToolkit.method5532(class55), 5121, is, i_71_);
		OpenGL.glPixelStorei(3314, 0);
		OpenGL.glPixelStorei(3317, 4);
	}
	...
	Class263_Sub1(OpenGLToolkit class_ra_sub3_sub1, Class55 class55, int i, int i_73_, boolean bool, float[] fs, int i_74_, int i_75_) {
		...
		if (!bool || i_75_ != 0 || i_74_ != 0) {
			...
			OpenGL.glTexImage2Df(((Class263_Sub1) this).anInt6415, 0, (OpenGLToolkit.method5533(((Class263_Sub1) this).aClass55_6419, ((Class263_Sub1) this).aClass77_6420)), i, i_73_, 0, OpenGLToolkit.method5532(((Class263_Sub1) this).aClass55_6419), 5126, fs, i_74_ * 4);
			OpenGL.glPixelStorei(3314, 0);
		} else
