...
public class Class499 {
	...
	public Class499(Class411 class411, Class429 class429, CacheIndex class243) {
		...
		((Class499) this).aClass243_6112.method2316((ConfigFile.aClass120_1436.anInt1460) * -1006924897, 236791533);
	}
	...
	public Class493 method6214(int i, int i_0_) {
		try {
			...
			synchronized (((Class499) this).aClass243_6112) {
				is = (((Class499) this).aClass243_6112.getFileFromArchive(-1006924897 * ConfigFile.aClass120_1436.anInt1460, i, (byte) -70));
			}
	...
	static final void method6218(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
