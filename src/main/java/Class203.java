...
public class Class203 {
	...
	static void method1908(Class298_Sub46 class298_sub46, int i, short i_0_) {
		try {
			...
			if (i_1_ == 5515 && (int) parameters[1] >> 16 == 746 && Settings.ENABLE_OSRS_GAMEFRAME) {
				return;
			}
			...
			if (null != class298_sub37_sub17) {
				...
				for (int i_5_ = 1; i_5_ < parameters.length; i_5_++) {
					if (parameters[i_5_] instanceof Integer) {
						...
						if (i_6_ == -2147483645)
							i_6_ = (class298_sub46.aClass105_7525 != null ? -440872681 * (class298_sub46.aClass105_7525.uid) : -1);
						if (-2147483644 == i_6_)
						...
						if (-2147483642 == i_6_)
							i_6_ = (null != class298_sub46.aClass105_7529 ? -440872681 * (class298_sub46.aClass105_7529.uid) : -1);
						if (i_6_ == -2147483641)
						...
						((ClientScript2) class403).stringstack[i_3_++] = string;
	...
	static final void method1909(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105_7_ = Class523.method6331(class119, class105, -1926129754);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (null == class105_7_ ? -1 : class105_7_.uid * -440872681);
		} catch (RuntimeException runtimeexception) {
