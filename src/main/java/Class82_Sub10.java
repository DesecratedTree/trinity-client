	...
	static final void method903(int i, int i_0_, int i_1_) {
		try {
			if (Class378.method4671(i, null, -1864950961))
				Class170.method1812((Class389.aClass119Array4165[i].components), i_0_, (byte) 65);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("xv.lv(").append(')').toString());
		}
	}

	static void method904(WidgetConfig class105, int i, int i_2_, boolean bool, byte i_3_) {
		try {
			int i_4_ = -2093041337 * class105.anInt1156;
			int i_5_ = class105.anInt1162 * 457937409;
			if (class105.widthMode == 0)
				class105.anInt1156 = class105.width * -86683899;
			else if (1 == class105.widthMode)
				class105.anInt1156 = -614915977 * (i - 1769572195 * class105.width);
			else if (2 == class105.widthMode)
				class105.anInt1156 = -614915977 * (i * (1769572195 * class105.width) >> 14);
			if (0 == class105.heightMode)
				class105.anInt1162 = -472364941 * class105.height;
			else if (1 == class105.heightMode)
				class105.anInt1162 = (i_2_ - class105.height * -1747263885) * -67604991;
			else if (class105.heightMode == 2)
				class105.anInt1162 = -67604991 * (i_2_ * (-1747263885 * class105.height) >> 14);
			if (class105.widthMode == 4)
				class105.anInt1156 = -614915977 * (class105.anInt1158 * 1183580231 * (class105.anInt1162 * 457937409) / (class105.anInt1242 * 1289873889));
			if (class105.heightMode == 4)
				class105.anInt1162 = -67604991 * (-2093041337 * class105.anInt1156 * (1289873889 * class105.anInt1242) / (1183580231 * class105.anInt1158));
			if (client.SHOW_HIDDEN_OPTIONS && (client.method2801(class105).anInt7416 * -1266165749 != 0 || class105.type * -1215239439 == 0)) {
			...
			if (class105.anInt1145 * 907611645 == WidgetConfig.anInt1269 * -451364727)
			...
			if (bool && class105.anObjectArray1164 != null && (i_4_ != class105.anInt1156 * -2093041337 || 457937409 * class105.anInt1162 != i_5_)) {
				...
				client.aClass453_8893.add(class298_sub46, 528123519);
			}
		} catch (RuntimeException runtimeexception) {
