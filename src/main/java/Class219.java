...
public class Class219 implements Runnable {
	...
	public int method2041(byte i) {
		try {
			if (null == ((Class219) this).aClass227_2465)
				return 0;
			int i_0_ = -861845079 * ((Class219) this).aClass227_2465.folder;
	...
	public void run() {
		try {
			while (!((Class219) this).aBoolean2464 || System.currentTimeMillis() < Class224.time) {
				long l = Class122.method1319((byte) 1);
				synchronized (this) {
					try {
						((Class219) this).anInt2469 += -1941002967;
						if (((Class219) this).anInterface12_2466 instanceof Class224) { //load here
							((Class219) this).anInterface12_2466.method160(((Class219) this).aBoolean2473, 2139338781);
						} else {
						//	System.out.println("old");
							long l_1_ = Class122.method1319((byte) 1);
							if (FloorOverlay.graphics != null && null != ((Class219) this).anInterface12_2467 && ((Class219) this).anInterface12_2467.method151(73548607) != 0 && ((6015775630087136145L * ((Class219) this).aLong2468) >= l_1_ - (long) (((Class219) this).anInterface12_2467.method151(-462627527)))) {
								...
								Class57 class57 = (FloorOverlay.graphics.method5046(-2110394505 * Class462.screenWidth, (-1111710645 * Class298_Sub40_Sub9.screenHeight), true, -34894995));
								Class52_Sub1 class52_sub1 = FloorOverlay.graphics.method5094();
								class52_sub1.method563(0, class57.method627());
								FloorOverlay.graphics.method5143(class52_sub1, (byte) 28);
								((Class219) this).anInterface12_2467.method160(true, 2128455067);
								FloorOverlay.graphics.method5005(class52_sub1, (byte) 8);
								class57.drawSprite(0, 0, 0, i_2_, 1);
								FloorOverlay.graphics.method5143(class52_sub1, (byte) -59);
								FloorOverlay.graphics.ba(1, 0);
								((Class219) this).anInterface12_2466.method160(true, 2141475636);
								FloorOverlay.graphics.method5005(class52_sub1, (byte) -56);
								class57.drawSprite(0, 0, 0, i, 1);
							} else {
								...
								((Class219) this).anInterface12_2466.method160((((Class219) this).aBoolean2473 || (FloorOverlay.graphics != null && FloorOverlay.graphics.method5074())), 2145176958);
							}
							try {
								if (null != FloorOverlay.graphics && !(((Class219) this).anInterface12_2466 instanceof Class224))
									FloorOverlay.graphics.swapBuffers((byte) 101);
							} catch (Exception_Sub1 exception_sub1) {
								IPAddress.method6062(new StringBuilder().append(exception_sub1.getMessage()).append(Atmosphere.aClient4141.method2761((byte) 1)).toString(), exception_sub1, (short) 3171);
								Class370.method4578(0, true, 622850291);
							}
						}
						((Class219) this).aBoolean2473 = false;
						if (null != FloorOverlay.graphics && !(((Class219) this).anInterface12_2466 instanceof Class224) && ((((Class219) this).aClass227_2465.folder * -861845079) < (-861845079 * Class227.aClass227_2545.folder)))
	...
	public static Class387 method2044(GraphicsToolkit class_ra, int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
		try {
			long l = (long) i_8_;
			Class387 class387 = (Class387) HintIcon.aClass348_264.get(l);
			int i_10_ = 2055;
			if (null == class387) {
				Model class64 = Model.loadModel(Map.aClass243_3646, i_8_, 0);
				if (class64 == null)
					return null;
				if (class64.protocol < 13)
					class64.resize(2);
				class387 = class_ra.method5037(class64, i_10_, -203714349 * Class481.anInt6035, 64, 768);
				HintIcon.aClass348_264.method4194(class387, l);
			}
	...
	static final void method2046(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1508815983 * class105.fontID;
		} catch (RuntimeException runtimeexception) {
	...
	static final void getWidgetText(ClientScript2 class403, byte i) {
		try {
			int i_14_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_14_, (byte) -71);
