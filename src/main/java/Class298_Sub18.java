...
public class Class298_Sub18 extends Class298 {
	...
	ModernToolkit aClass_ra_Sub3_7309;
	...
	void method2927(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, ByteBuffer bytebuffer, ByteBuffer bytebuffer_5_) {
		...
		if ((i_3_ & 0x7f) == 0 || (i_4_ & 0x7f) == 0) {
			...
			Class298 class298 = ((Class298_Sub18) this).aClass440_7299.method5852(l);
			if (class298 != null) {
		...
		if ((((ModernToolkit) ((Class298_Sub18) this).aClass_ra_Sub3_7309).anInt8346) == 0) {
	...
	Class298_Sub18(ModernToolkit class_ra_sub3, Class_xa_Sub1 class_xa_sub1, Class298_Sub10 class298_sub10, int[] is) {
