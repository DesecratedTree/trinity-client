...
public class Class109 {
	...
	static final void method1155(ClientScript2 class403, int i) {
		try {
			...
			boolean bool = Atmosphere.aClient4141.method2754(new File(string), -714101418);
	...
	static final void method1156(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub19_7567.method5695(-1741518508);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1157(ClientScript2 class403, int i) {
		try {
			...
			int i_5_ = (((int) class217.x >> 9) + -1760580017 * class341.gameSceneBaseX);
			int i_6_ = (((int) class217.y >> 9) + 283514611 * class341.gameSceneBaseY);
