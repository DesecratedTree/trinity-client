...
public abstract class Class_v extends Class298 {
	...
	static final void method3669(ClientScript2 class403, int i) {
		try {
			int i_0_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			if (i_0_ >= 1 && i_0_ <= 2)
				Class357.method4276(i_0_, -1, -1, false, 2079536098);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("v.aff(").append(')').toString());
		}
	}
	...
	public static void method3670(Player class365_sub1_sub1_sub2_sub2, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("v.d(").append(')').toString());
		}
	}

	static final void method3671(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).aClass365_Sub1_Sub1_Sub2_5242.method4431((((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]), 449530626);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("v.aoi(").append(')').toString());
		}
	}
	...
	static void method3672(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("v.t(").append(')').toString());
		}
	}
	...
	static void method3673(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("v.p(").append(')').toString());
		}
	}
}
