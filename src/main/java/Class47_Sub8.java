...
public class Class47_Sub8 extends Class47 {
	...
	void method505(boolean bool) {
		if (((Class47_Sub8) this).aClass28_6805 != null) {
			...
			((Class47_Sub8) this).aClass_ra_Sub2_491.method5255(1);
			OpenGL.glMatrixMode(5890);
			OpenGL.glLoadMatrixf((((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).aClass233_8089.aFloatArray2594), 0);
			OpenGL.glMatrixMode(5888);
			((Class47_Sub8) this).aClass_ra_Sub2_491.method5255(0);
			if (((Class47_Sub8) this).anInt6799 != (((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).anInt8062)) {
				int i = (((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).anInt8062 % 5000 * 128 / 5000);
				...
				if (((Class45) ((Class47_Sub8) this).aClass45_6806).aBoolean480)
					((Class47_Sub8) this).aFloat6798 = (float) ((((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).anInt8062) % 4000) / 4000.0F;
				else
					OpenGL.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
				((Class47_Sub8) this).anInt6799 = ((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).anInt8062;
			}
		}
	}
	...
	void method503(int i, int i_1_) {
		if (((Class47_Sub8) this).aClass28_6805 != null) {
			...
			if ((i & 0x80) == 0) {
				if ((i_1_ & 0x1) == 1) {
					if (!((Class45) ((Class47_Sub8) this).aClass45_6806).aBoolean480) {
						int i_2_ = ((((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).anInt8062) % 4000 * 16 / 4000);
			...
			((Class47_Sub8) this).aClass_ra_Sub2_491.method5255(0);
			if ((i & 0x40) == 0) {
				aFloatArray6807[0] = (((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).aFloat8130 * ((OpenGLLegacyToolkit) (((Class47_Sub8) this).aClass_ra_Sub2_491)).aFloat8125);
				aFloatArray6807[1] = (((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).aFloat8130 * ((OpenGLLegacyToolkit) (((Class47_Sub8) this).aClass_ra_Sub2_491)).aFloat8128);
				aFloatArray6807[2] = (((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).aFloat8130 * ((OpenGLLegacyToolkit) (((Class47_Sub8) this).aClass_ra_Sub2_491)).aFloat8191);
	...
	void method502(int i, int i_4_) {
		if (((Class47_Sub8) this).aClass28_6805 != null) {
			...
			if ((i & 0x80) == 0) {
				if ((i_4_ & 0x1) == 1) {
					if (!((Class45) ((Class47_Sub8) this).aClass45_6806).aBoolean480) {
						int i_5_ = ((((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).anInt8062) % 4000 * 16 / 4000);
	...
	void method513(int i, int i_7_) {
		if (((Class47_Sub8) this).aClass28_6805 != null) {
			...
			if ((i & 0x80) == 0) {
				if ((i_7_ & 0x1) == 1) {
					if (!((Class45) ((Class47_Sub8) this).aClass45_6806).aBoolean480) {
						int i_8_ = ((((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).anInt8062) % 4000 * 16 / 4000);
	...
	Class47_Sub8(OpenGLLegacyToolkit class_ra_sub2, Class45 class45) {
		super(class_ra_sub2);
		((Class47_Sub8) this).aClass45_6806 = class45;
		if ((((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).aBoolean8039) && (((OpenGLLegacyToolkit) ((Class47_Sub8) this).aClass_ra_Sub2_491).anInt8165) >= 2) {
			((Class47_Sub8) this).aClass39_6802 = (Class39.method477(((Class47_Sub8) this).aClass_ra_Sub2_491, 34336, "!!ARBvp1.0\nOPTION  ARB_position_invariant;\nATTRIB  iPos         = vertex.position;\nATTRIB  iColour      = vertex.color;\nATTRIB  iTexCoord    = vertex.texcoord[0];\nOUTPUT  oColour      = result.color;\nOUTPUT  oTexCoord0   = result.texcoord[0];\nOUTPUT  oTexCoord1   = result.texcoord[1];\nOUTPUT  oFogCoord    = result.fogcoord;\nPARAM   time         = program.local[65];\nPARAM   turbulence   = program.local[64];\nPARAM   lightAmbient = program.local[66]; \nPARAM   pMatrix[4]   = { state.matrix.projection };\nPARAM   mvMatrix[4]  = { state.matrix.modelview };\nPARAM   ivMatrix[4]  = { state.matrix.texture[1] };\nPARAM   texMatrix[4]  = { state.matrix.texture[0] };\nPARAM   fNoise[64]   = { program.local[0..63] };\nTEMP    noise, viewPos, worldPos, texCoord;\nADDRESS noiseAddr;\nDP4   viewPos.x, mvMatrix[0], iPos;\nDP4   viewPos.y, mvMatrix[1], iPos;\nDP4   viewPos.z, mvMatrix[2], iPos;\nDP4   viewPos.w, mvMatrix[3], iPos;\nMOV   oFogCoord.x, viewPos.z;\nDP4   worldPos.x, ivMatrix[0], viewPos;\nDP4   worldPos.y, ivMatrix[1], viewPos;\nDP4   worldPos.z, ivMatrix[2], viewPos;\nDP4   worldPos.w, ivMatrix[3], viewPos;\nADD   noise.x, worldPos.x, worldPos.z;SUB   noise.y, worldPos.z, worldPos.x;MUL   noise, noise, 0.0001220703125;\nFRC   noise, noise;\nMUL   noise, noise, 64;\nARL   noiseAddr.x, noise.x;\nMOV   noise.x, fNoise[noiseAddr.x].x;\nARL   noiseAddr.x, noise.y;\nMOV   noise.y, fNoise[noiseAddr.x].y;\nMUL   noise, noise, turbulence.x;\nDP4   texCoord.x, texMatrix[0], iTexCoord;\nDP4   texCoord.y, texMatrix[1], iTexCoord;\nADD   oTexCoord0.xy, texCoord, noise;\nMOV   oTexCoord0.z, 0;\nMOV   oTexCoord0.w, 1;\nMUL   oTexCoord1.xy, texCoord, 0.125;\nMOV   oTexCoord1.zw, time.xxxw;\nMUL   oColour.xyz, iColour, lightAmbient;\nMOV   oColour.w, iColour.w;\nEND"));
	...
	void method517(int i, int i_16_) {
		if (((Class47_Sub8) this).aClass28_6805 != null) {
			...
			if ((i & 0x80) == 0) {
				if ((i_16_ & 0x1) == 1) {
					if (!((Class45) ((Class47_Sub8) this).aClass45_6806).aBoolean480) {
						int i_17_ = ((((OpenGLLegacyToolkit) (((Class47_Sub8) this).aClass_ra_Sub2_491)).anInt8062) % 4000 * 16 / 4000);
	...
	void method515(int i, int i_19_) {
		if (((Class47_Sub8) this).aClass28_6805 != null) {
			...
			if ((i & 0x80) == 0) {
				if ((i_19_ & 0x1) == 1) {
					if (!((Class45) ((Class47_Sub8) this).aClass45_6806).aBoolean480) {
						int i_20_ = ((((OpenGLLegacyToolkit) (((Class47_Sub8) this).aClass_ra_Sub2_491)).anInt8062) % 4000 * 16 / 4000);
	...
	void method516(int i, int i_22_) {
		if (((Class47_Sub8) this).aClass28_6805 != null) {
			...
			if ((i & 0x80) == 0) {
				if ((i_22_ & 0x1) == 1) {
					if (!((Class45) ((Class47_Sub8) this).aClass45_6806).aBoolean480) {
						int i_23_ = ((((OpenGLLegacyToolkit) (((Class47_Sub8) this).aClass_ra_Sub2_491)).anInt8062) % 4000 * 16 / 4000);
