...
public class Class21 {
	...
	static final void method365(WidgetConfig class105, Class119 class119, boolean bool, int i, ClientScript2 class403, int i_3_) {
		try {
			...
			if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403) {
				Class298_Sub50.method3567(-440872681 * class105.uid, 1388671560);
				Class509.method6286(-440872681 * class105.uid, 106150101);
				Class70.method808(class105.uid * -440872681, 2057190103);
			}
			if (-1 == i_4_) {
				...
				ItemConfig class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_4_);
				class105.anInt1190 = class468.modelPitch * 1147619461;
				class105.anInt1262 = -953332053 * class468.modelRoll;
				class105.anInt1192 = 1018171305 * class468.offsetX;
				class105.anInt1297 = class468.modelTranslateX * 216639237;
				class105.anInt1248 = class468.modelTranslateY * 2135145581;
				class105.anInt1284 = class468.modelScale * -1056736627;
				...
				else if (1769572195 * class105.width > 0)
					class105.anInt1284 = (237251296 * class105.anInt1284 / (class105.width * 1769572195) * -1066050969);
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method366(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_6_, (byte) -54);
	...
	static final void method368(ClientScript2 class403, int i) {
		try {
			if (Class11.anInt156 * -1111444967 == 2)
				Class11.triedSoftware = true;
			else if (-1111444967 * Class11.anInt156 == 1)
				Class11.triedLegacyOpenGL = true;
			else if (Class11.anInt156 * -1111444967 == 3)
				Class11.triedDX = true;
			else if (Class11.anInt156 * -1111444967 == 5)
				Class11.triedModernOpenGL = true;
		} catch (RuntimeException runtimeexception) {
