...
public class ClientScriptEnum extends Class298_Sub37 {
	LinkedArrayList aClass437_9594;
	...
	public int method3425(int i, int defaultValue, short i_2_) {
		try {
			if (((ClientScriptEnum) this).aClass437_9594 == null)
				return defaultValue;
			IntegerValue class298_sub35 = (IntegerValue) ((ClientScriptEnum) this).aClass437_9594.method5812((long) i);
			if (null == class298_sub35)
				return defaultValue;
			int v = class298_sub35.intValue * -774922497;
			return v;
		} catch (RuntimeException runtimeexception) {
	 ...
	 * @param i
	 */
	public ClientScriptEnum(int i) {
		this.id = i;
	}
	
	public static void modify(ClientScriptEnum config) {
		//9999- custom
		if (config.id == 667) {
			config.aClass437_9594.clear((byte) 0);
			config.aClass437_9594.method5817(new ObjectValue("Level 55<br>Preserve<br>Boosted stats last 50% longer."), 734); //description
			config.aClass437_9594.method5817(new IntegerValue(Settings.OSRS_SPRITES_OFFSET + 947), 735); //prayer on
			config.aClass437_9594.method5817(new IntegerValue(Settings.OSRS_SPRITES_OFFSET + 951), 736); //prayer off
			config.aClass437_9594.method5817(new IntegerValue(55), 737); //level
			config.aClass437_9594.method5817(new ObjectValue("You need a Prayer level of at least 55 to use Preserve."), 734); //description
			config.aClass437_9594.method5817(new IntegerValue(1), 739); //book
		} else if (config.id == 979 //arcane neck
				|| config.id == 1030 //ring of vigour
				|| config.id == 1156  //demon horn neck
				|| config.id >= 991 && config.id <= 998) { //chaotics + shield
			//IntegerValue value = (IntegerValue) config.aClass437_9594.method5812(1072);
			//value.intValue *= 5;
			return;
		} else if (config.id == 1006) {
			ObjectValue value = (ObjectValue) config.aClass437_9594.method5812(734);
			value.value = "Level 77<br>Augury<br>Increases magical accuracy by 25% and Defence by 25%.";
		} else if (config.id == 1029) {
			ObjectValue value = (ObjectValue) config.aClass437_9594.method5812(734);
			value.value = "Level 74<br>Rigour<br>Increases your Ranged attack by 20%, and damage by 23% and your Defence by 25%.";
		}
	}
	...
	void method3426(RsByteBuffer class298_sub53, int i, int i_3_) {
		try {
			if (i == 249) {
				...
				if (null == ((ClientScriptEnum) this).aClass437_9594) {
					int i_5_ = Class416.method5590(i_4_, (byte) 16);
					((ClientScriptEnum) this).aClass437_9594 = new LinkedArrayList(i_5_);
				}
				for (int i_6_ = 0; i_6_ < i_4_; i_6_++) {
					...
					Class298 class298;
					if (bool)
						class298 = new ObjectValue(class298_sub53.readString(281550837));
					else
						class298 = new IntegerValue(class298_sub53.readInt((byte) -72));
					((ClientScriptEnum) this).aClass437_9594.method5817(class298, (long) i_7_);
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	public String method3427(int i, String string, byte i_8_) {
		try {
			if (((ClientScriptEnum) this).aClass437_9594 == null)
				return string;
			ObjectValue class298_sub29 = (ObjectValue) ((ClientScriptEnum) this).aClass437_9594.method5812((long) i);
			...
			for (int i_11_ = 0; i_11_ < is.length; i_11_++) {
				...
				for (int i_15_ = 0; (0 != i_13_ && i_15_ < (class365_sub1_sub1_sub2.aClass438_Sub2_Sub1Array10112).length); i_13_ >>>= 1) {
					if ((i_13_ & 0x1) == 0) {
						...
						AnimationConfig class391 = Class501.aClass395_6122.method4903(i_12_, (byte) -80);
						...
						if (null != class438_sub2_sub1 && class438_sub2_sub1.method5819((byte) -110)) {
							...
							} else if (-1445588039 * class391.priority >= ((class438_sub2_sub1.method5820(595695662).priority) * -1445588039)) {
								class365_sub1_sub1_sub2.aClass438_Sub2_Sub1Array10112[i_15_] = null;
								class438_sub2_sub1 = null;
							}
						}
