...
public class Class507 {
	...
	public NPCConfig method6269(int i, int i_0_) {
		try {
			i = Settings.ENABLE_OSRS_NPCS ? CustomNPCs.getOldLookNPC(i) : i;
			NPCConfig class503;
			synchronized (((Class507) this).aClass348_6206) {
				class503 = (NPCConfig) ((Class507) this).aClass348_6206.get((long) i);
			}
			if (null != class503)
				return class503;
			byte[] is;
			synchronized (((Class507) this).aClass243_6207) {
				is = (((Class507) this).aClass243_6207.getFileFromArchive(ConfigFile.aClass120_1410.method1307(i, -790155853), ConfigFile.aClass120_1410.method1305(i, -576275965), (byte) -76));
			}
			class503 = new NPCConfig();
			class503.id = -1840892671 * i;
			((NPCConfig) class503).aClass507_6125 = this;
			class503.actions = (String[]) ((Class507) this).aStringArray6213.clone();
			if (is != null)
				class503.method6235(new RsByteBuffer(is), -975728899);
			class503.method6243(1323410423);
			CustomNPCs.modify(class503);
			synchronized (((Class507) this).aClass348_6206) {
	...
	public Class507(Class411 class411, Class429 class429, boolean bool, CacheIndex class243, CacheIndex class243_3_) {
		...
		if (((Class507) this).aClass243_6207 != null) {
			...
			ConfigFile.aClass120_1410.method1306((short) 12429);
	...
	static final void method6277(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_4_, (byte) -51);
