...
public class Class365_Sub1_Sub1_Sub1 extends Class365_Sub1_Sub1 {
	...
	public final void method4405(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		try {
			...
			if (!((Class365_Sub1_Sub1_Sub1) this).aBoolean10052) {
				float f = (float) i - class217.x;
				float f_4_ = (float) i_0_ - class217.y;
				float f_5_ = (float) Math.sqrt((double) (f_4_ * f_4_ + f * f));
				if (0.0F != f_5_) {
					class217.x += (float) (732601943 * (((Class365_Sub1_Sub1_Sub1) this).anInt10054)) * f / f_5_;
					class217.y += (float) (732601943 * (((Class365_Sub1_Sub1_Sub1) this).anInt10054)) * f_4_ / f_5_;
				}
				if (((Class365_Sub1_Sub1_Sub1) this).aBoolean10051)
					class217.aFloat2455 = (float) (Class356.getPlayerHeight((int) (class217.x), (int) (class217.y), plane, -1463922586) - (((Class365_Sub1_Sub1_Sub1) this).anInt10042) * 1403412253);
				setPosition(class217);
			}
			double d = (double) (anInt10049 * -1349988959 + 1 - i_2_);
			((Class365_Sub1_Sub1_Sub1) this).aDouble10053 = (double) ((float) i - class217.x) / d;
			((Class365_Sub1_Sub1_Sub1) this).aDouble10050 = (double) ((float) i_0_ - class217.y) / d;
			...
			if (!((Class365_Sub1_Sub1_Sub1) this).aBoolean10052) {
				if (0 != (((Class365_Sub1_Sub1_Sub1) this).anInt10043 * 132125965)) {
					...
					if (client.anInt8724 * 1596783995 == 0)
						...
						ObjectValue class298_sub29 = ((ObjectValue) client.aClass437_8696.method5812((long) i_7_));
					...
					if (class365_sub1_sub1_sub2 != null) {
						...
						method4341(class217.x, (float) ((Class356.getPlayerHeight((int) class217.x, (int) class217.y, plane, -1098231500)) - (1403412253 * ((Class365_Sub1_Sub1_Sub1) this).anInt10042)), class217.y);
						if ((((Class365_Sub1_Sub1_Sub1) this).anInt10041 * -1955698847) >= 0) {
							StanceConfig class350 = class365_sub1_sub1_sub2.getStanceConfig(399670605);
							int i_8_ = 0;
							int i_9_ = 0;
							...
							if (i_8_ != 0 || 0 != i_9_) {
								...
								class217_16_.y += (float) i_9_;
								setPosition(class217_16_);
	...
	public final void method4407(int i, byte i_19_) {
		try {
			...
			class235.aClass217_2599.x += ((Class365_Sub1_Sub1_Sub1) this).aDouble10053 * (double) i;
			class235.aClass217_2599.y += ((Class365_Sub1_Sub1_Sub1) this).aDouble10050 * (double) i;
			if (((Class365_Sub1_Sub1_Sub1) this).aBoolean10051)
				class235.aClass217_2599.aFloat2455 = (float) (Class356.getPlayerHeight((int) (class235.aClass217_2599.x), (int) (class235.aClass217_2599.y), plane, -1903626222) - 1403412253 * (((Class365_Sub1_Sub1_Sub1) this).anInt10042));
	...
	void method4404(int i) {
		try {
			...
			aShort9795 = aShort9797 = (short) (int) (class217.y / 512.0F);
		} catch (RuntimeException runtimeexception) {
	...
	Class387 method4410(GraphicsToolkit class_ra, int i, int i_30_) {
		try {
			GraphicsConfig class398 = (Class158_Sub1.aClass389_8568.method4857(1528803725 * ((Class365_Sub1_Sub1_Sub1) this).anInt10046, -1880515681));
	...
	public Class365_Sub1_Sub1_Sub1(Class331 class331, int i, int i_31_, int i_32_, int i_33_, int i_34_, int i_35_, int i_36_, int i_37_, int i_38_, int i_39_, int i_40_, int i_41_, int i_42_, boolean bool, int i_43_) {
		super(class331, i_31_, i_32_, i_33_, Class356.getPlayerHeight(i_33_, i_34_, i_31_, -1556375135) - i_35_, i_34_, i_33_ >> 9, i_33_ >> 9, i_34_ >> 9, i_34_ >> 9, false, (byte) 0);
		...
		int i_44_ = (Class158_Sub1.aClass389_8568.method4857(((Class365_Sub1_Sub1_Sub1) this).anInt10046 * 1528803725, -1811500435).animation) * 1505778629;
