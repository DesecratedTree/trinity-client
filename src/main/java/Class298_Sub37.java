...
public class Class298_Sub37 extends Class298 {
	...
	public static int calculateRoute(int startX, int startY, int size, Class336 class336, Class289 planeClipData, boolean alternativeRoute, int[] calculatedPositionXsArray, int[] calculatedPositionYsArray) {
		try {
			...
			int i_10_ = 1111664165 * Class163.anInt1684;
			if (!bool_6_) {
				if (alternativeRoute) {
	...
	static final void method3404(ClientScript2 class403, byte i) {
		try {
			...
			WorldMapArea class298_sub37_sub13 = WorldMap.method3705(i_29_);
			if (class298_sub37_sub13 == null) {
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
			} else {
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = (-2052483955 * class298_sub37_sub13.toX - class298_sub37_sub13.fromX * 1364716801);
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = (929385381 * class298_sub37_sub13.toY - class298_sub37_sub13.fromY * 1345239131);
			}
		} catch (RuntimeException runtimeexception) {
