...
public abstract class Class291 extends GameClient implements Interface14, Runnable, FocusListener, WindowListener {
	...
	static JagexFile cacheidx255;
	protected static JagexFile cachedat2;
	...
	static JagexFile aClass484_6499;
	...
	final void method2751(Class311 class311, String string, String string_0_, int i, int i_1_, int i_2_, int i_3_, boolean bool, byte i_4_) {
		try {
			try {
				...
				Class78.anInt733 = ((Class462.screenWidth = class311.method3811((byte) -35) * -2010408377) * 1228593773);
				anInt6472 = ((Class298_Sub40_Sub9.screenHeight = class311.method3815(2024501789) * 1445266787) * 1864178979);
				anInt6473 = 0;
				anInt6474 = 0;
				if (Class389.method4865((byte) 35) == Class292.aClass292_3164) {
					...
					makeFrame(class311.method3814(1376340372), -260131528);
				}
	...
	final void method2752(String string, String string_5_, int i, int i_6_, int i_7_, int i_8_, byte i_9_) throws Exception {
		try {
			...
			StanceConfig.aString3759 = "Unknown";
			ConfigFile.aString1462 = "1.1";
			try {
				StanceConfig.aString3759 = System.getProperty("java.vendor");
				ConfigFile.aString1462 = System.getProperty("java.version");
				if (ConfigFile.aString1462.startsWith("9") || ConfigFile.aString1462.startsWith("10")) // due to client limitation
					ConfigFile.aString1462 = "1.9";
			...
			Class68.aStringArray679 = (new String[] { new StringBuilder().append(Settings.CACHE_SUB_NAME).append(Class139.anInt1548 * -518493991).toString(), new StringBuilder().append(".file_store_").append(-518493991 * Class139.anInt1548).toString() });
			while_73_: for (int i_10_ = 0; i_10_ < 4; i_10_++) {
				aFile6500 = method2783(string, string_5_, i_10_, (short) 8683);
				if (!aFile6500.exists())
					aFile6500.mkdirs();
				System.out.println(aFile6500);
			...
			cachedat2 = (new JagexFile(new JagexFile2(Class482.method6118("main_file_cache.dat2", (byte) -19), "rw", 1048576000L), 5200, 0));
			cacheidx255 = (new JagexFile(new JagexFile2(Class482.method6118("main_file_cache.idx255", (byte) -21), "rw", 1048576L), 6000, 0));
			Class497.aClass484Array6106 = new JagexFile[Class310.anInt6512 * 1210163253];
			for (int i_13_ = 0; i_13_ < 1210163253 * Class310.anInt6512; i_13_++)
				Class497.aClass484Array6106[i_13_] = new JagexFile(new JagexFile2((Class482.method6118(new StringBuilder().append("main_file_cache.idx").append(i_13_).toString(), (byte) -49)), "rw", 1048576L), 6000, 0);
			try {
				Class389.aClass457_4164 = new Class457();
			} catch (Exception exception) {
				Class452.fullScreen = false;
			}
	...
	void method2755(File file, File file_18_, int i) {
		try {
			try {
				JagexFile2 class476 = new JagexFile2(Class180.aFile6528, "rw", 10000L);
	...
	void method2759(byte i) {
		client.currentThread = Thread.currentThread();
		try {
			if (null != StanceConfig.aString3759) {
				String string = StanceConfig.aString3759.toLowerCase();
				if (string.indexOf("sun") != -1 || string.indexOf("apple") != -1) {
					String string_19_ = ConfigFile.aString1462;
			...
			Thread.currentThread().setPriority(Thread.MAX_PRIORITY); //main thread, if this laggs fps drops
			while (0L == 2916456661870185289L * aLong6496 || (Class122.method1319((byte) 1) < aLong6496 * 2916456661870185289L)) {
				
				try {
					RuntimeException_Sub1.processCyclesCount = (aClass309_6492.method3787(aLong6484 * -4639622049358970979L) * -2090388391);
					for (int i_22_ = 0; i_22_ < RuntimeException_Sub1.processCyclesCount * -1597189143; i_22_++) {
						method2764((byte) 1);
					}
	...
	void method2760(int i) {
		try {
			long currentFrame = Class122.method1319((byte) 1);
			long lastFrame = aLongArray6486[-1371443851 * Class272.anInt2903];
			aLongArray6486[-1371443851 * Class272.anInt2903] = currentFrame;
			Class272.anInt2903 = 1423456989 * (-1371443851 * Class272.anInt2903 + 1 & 0x1f);
			if (lastFrame != 0L && currentFrame > lastFrame) {
				int i_24_ = (int) (currentFrame - lastFrame);
				anInt6467 = ((i_24_ >> 1) + 32000) / i_24_ * -863758789;
			}
			if ((anInt6477 += -2020246835) * 698024453 - 1 > 50) {
				anInt6477 -= 2066873354;
				aBoolean6471 = true;
				Class52_Sub2_Sub1.aCanvas9079.setSize(Class462.screenWidth * -2110394505, Class298_Sub40_Sub9.screenHeight * -1111710645);
				Class52_Sub2_Sub1.aCanvas9079.setVisible(true);
				if (null != Class298_Sub36.frame && Class231.fullScreenFrame == null) {
	...
	final void method2776(boolean bool, byte i) {
		try {
			...
			if (Class298_Sub36.frame != null) {
				Class298_Sub36.frame.setVisible(false);
				Class298_Sub36.frame.dispose();
				Class298_Sub36.frame = null;
			}
		} catch (RuntimeException runtimeexception) {
	...
	void method2777(Container container, int i) {
		try {
			...
			Class52_Sub2_Sub1.aCanvas9079.setSize(-2110394505 * Class462.screenWidth, -1111710645 * Class298_Sub40_Sub9.screenHeight);
			Class52_Sub2_Sub1.aCanvas9079.setVisible(true);
	...
	synchronized void makeFrame(String string, int i) {
		try {
			
			Class298_Sub36.frame = new Frame();
			Class298_Sub36.frame.setTitle(string);
			Class298_Sub36.frame.setResizable(true);
			Class298_Sub36.frame.addWindowListener(this);
			Class298_Sub36.frame.setBackground(Color.black);
			
			Class298_Sub36.frame.setVisible(true);
			Class298_Sub36.frame.toFront();
			Insets insets = Class298_Sub36.frame.getInsets();
			Class298_Sub36.frame.setSize((insets.right + (Class78.anInt733 * -639974669 + insets.left)), (anInt6472 * 1282634425 + insets.top + insets.bottom));
		} catch (RuntimeException runtimeexception) {
	...
	File method2783(String string, String string_27_, int i, short i_28_) {
		try {
			...
			Class180.aFile6528 = new File(Class83.aString765, new StringBuilder().append(Settings.ABSOLOUTE_CACHE_NAME_1).append(string).append("_").append(string_27_).append(string_29_).append(".dat").toString());
			...
			if (string_30_ == null && 0 == i) {
				while_74_: for (int i_34_ = 0; i_34_ < Class68.aStringArray679.length; i_34_++) {
					for (int i_35_ = 0; i_35_ < Class216.aStringArray6657.length; i_35_++) {
						...
						if (file.exists() && method2753(new File(file, "Matrix.dat"), true, -1984790861)) {
			...
			if (string_30_ == null) {
				string_30_ = new StringBuilder().append(Class83.aString765).append(File.separatorChar).append(Settings.CACHE_NAME).append(string_29_).append(File.separatorChar).append(string).append(File.separatorChar).append(string_27_).append(File.separatorChar).toString();
				bool = true;
			}
			if (null != string_31_) {
	...
	static final void method2787(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			class105.borderType = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) * 1158843261;
	...
	static void method2791(int i, String string, String string_44_, int i_45_) {
		try {
			if (null != client.aClass25_8711) {
				...
				class298_sub36.aClass298_Sub53_Sub2_7396.writeShort((1 + ConfigFile.method1310(string, (byte) -1) + ConfigFile.method1310(string_44_, (byte) -1)), 16711935);
