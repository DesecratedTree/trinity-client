...
public final class Class298_Sub43 extends Class298 implements Interface16 {
	...
	static final void method3526(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_1_, (byte) -13);
	...
	static final void method3527(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
			class105.fontID = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) * -2074006897;
			Tradution.method6054(class105, -542693615);
			if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403)
				Class82_Sub20.method934(class105.uid * -440872681, (byte) 7);
		} catch (RuntimeException runtimeexception) {
