...
public class Class82_Sub13 extends Class82 {
	...
	public static final int method910(boolean osrs, Class433 class433, byte[] is, int i, int i_0_, int i_1_, int i_2_, byte i_3_) {
		try {
			int i_4_ = 0;
				...
				for (;;) {
					if (bool) {
						...
						if (i_13_ > 0 && i_14_ > 0 && i_13_ < i_1_ - 1 && i_14_ < i_2_ - 1) {
							ObjectConfig class432 = class433.getObjectDefinitions(i_5_ + (osrs ? Settings.OSRS_OBJECT_OFFSET : 0));
							if ((-1976050083 * Class424.aClass424_6610.anInt6613) == i_12_ && Class422_Sub25.preferences.aClass422_Sub2_7547.method5629(-1915667162) == 0 && 0 == 1532834983 * class432.optionType && -2144543407 * class432.cliped != 1 && !class432.notDecoration) {
								if (i_3_ == 3) {
									/* empty */
								}
							} else {
