...
public class ConfigDefinitionLoader {
	...
	public ConfigDefinitionLoader(Class411 class411, Class429 class429, CacheIndex class243) {
		...
		if (index22 != null) {
			...
			ConfigFile.aClass120_1406.method1306((short) 7909);
	...
	public ConfigDefinitions getConfigDefinitions(int fileId, int i_2_) {
		try {
			...
			synchronized (index22) {
				data = (index22.getFileFromArchive(ConfigFile.aClass120_1406.method1307(fileId, -1343831720), ConfigFile.aClass120_1406.method1305(fileId, 39933071), (byte) 14));
			}
	...
	static final void method3829(ClientScript2 class403, short i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_3_, (byte) -48);
	...
	static final void method3832(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_8_, (byte) -74);
