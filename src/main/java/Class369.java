...
public class Class369 {
	...
	LinkedArrayList aClass437_4018;
		...
		try {
			if (1 == i)
				...
				if (((Class369) this).aClass437_4018 == null) {
					...
					((Class369) this).aClass437_4018 = new LinkedArrayList(i_17_);
				}
				for (int i_18_ = 0; i_18_ < i_16_; i_18_++) {
					...
					Class298 class298;
					if (bool)
						class298 = new ObjectValue(class298_sub53.readString(-1573991402));
					else
						class298 = new IntegerValue(class298_sub53.readInt((byte) -24));
	...
	public int method4568(int i, int i_36_, byte i_37_) {
		try {
			if (null == ((Class369) this).aClass437_4018)
				return i_36_;
			IntegerValue class298_sub35 = ((IntegerValue) ((Class369) this).aClass437_4018.method5812((long) i));
	...
	public String method4570(int i, String string, int i_38_) {
		try {
			if (null == ((Class369) this).aClass437_4018)
				return string;
			ObjectValue class298_sub29 = ((ObjectValue) ((Class369) this).aClass437_4018.method5812((long) i));
