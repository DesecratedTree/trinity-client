...
final class Class93 implements Interface23 {
	public int method254(int i) {
		IntegerValue class298_sub35 = (IntegerValue) Class87.aClass437_793.method5812((long) i);
	...
	public int method250(int i, byte i_1_) {
		try {
			IntegerValue class298_sub35 = ((IntegerValue) Class87.aClass437_793.method5812(0x100000000L | (long) i));
			if (class298_sub35 == null)
	...
	public int getBitconfigState(int i) {
		IntegerValue class298_sub35 = ((IntegerValue) Class87.aClass437_793.method5812(0x100000000L | (long) i));
		if (class298_sub35 == null)
	...
	public static boolean enableIcmpService(int i) {
		try {
			do {
				boolean bool;
				try {
					if (!Settings.DISABLE_ICMP && IcmpService_Sub1.available())
						break;
					bool = false;
