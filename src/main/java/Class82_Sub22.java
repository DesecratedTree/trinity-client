...
public class Class82_Sub22 extends Class82 {
	...
	boolean method939() {
		GraphicsConfig class398 = (Class158_Sub1.aClass389_8568.method4857(1632084697 * ((Class82_Sub22) this).anInt6908, -1743709088));
		boolean bool = class398.method4919((byte) 119);
		AnimationConfig class391 = Class501.aClass395_6122.method4903(class398.animation * 1505778629, (byte) -66);
	...
	boolean method870(int i) {
		try {
			GraphicsConfig class398 = Class158_Sub1.aClass389_8568.method4857((1632084697 * ((Class82_Sub22) this).anInt6908), -1845152840);
			boolean bool = class398.method4919((byte) 118);
			AnimationConfig class391 = Class501.aClass395_6122.method4903(class398.animation * 1505778629, (byte) -64);
	...
	public void method868() {
		...
		client.projectiles.add(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1), 1292621740);
	}
	...
	public void method869() {
		...
		client.projectiles.add(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1), 489461607);
	}
	...
	public void method866(int i) {
		try {
			...
			client.projectiles.add(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1), -428713736);
		} catch (RuntimeException runtimeexception) {
