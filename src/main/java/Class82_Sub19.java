...
public abstract class Class82_Sub19 extends Class82 {
	...
	boolean method870(int i) {
		try {
			GraphicsConfig class398 = Class158_Sub1.aClass389_8568.method4857((720810617 * ((Class82_Sub19) this).anInt6895), -2111155708);
			boolean bool = class398.method4919((byte) 51);
			AnimationConfig class391 = Class501.aClass395_6122.method4903(1505778629 * class398.animation, (byte) 13);
	...
	boolean method924() {
		GraphicsConfig class398 = (Class158_Sub1.aClass389_8568.method4857(720810617 * ((Class82_Sub19) this).anInt6895, -1729093071));
		boolean bool = class398.method4919((byte) 82);
		AnimationConfig class391 = Class501.aClass395_6122.method4903(1505778629 * class398.animation, (byte) -7);
		bool &= class391.method4880(2049469908);
		return bool;
	}

	static final void method925(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			class105.flippedVertically = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) == 1;
	...
	static final void method929(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_2_, (byte) -23);
