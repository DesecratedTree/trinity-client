...
public class Class229 implements Interface12 {
	...
	static CachingHashMap aClass348_6452;
	...
	public void method150(int i) {
		try {
			if (((Class229) this).aClass_ra6456 != FloorOverlay.graphics) {
				((Class229) this).aClass_ra6456 = FloorOverlay.graphics;
	...
	static {
		aClass348_6452 = new CachingHashMap(128, 4);
	}
	...
	public static void method2124(byte i) {
		try {
			synchronized (Atmosphere.aClient4141) {
				if (null != Class231.fullScreenFrame) {
					...
					if (container == null) {
						...
						if (Class190.getDisplayMode((byte) -55) != 1)
							GrabFolder.method2283((byte) 3);
						else {
							Class462.screenWidth = client.WIDTH * -1494558011;
							client.anInt6473 = ((-639974669 * Class78.anInt733 - 775068819 * client.WIDTH) / 2 * -753018213);
						...
						if (null != FloorOverlay.graphics)
							FloorOverlay.graphics.method5173(Class52_Sub2_Sub1.aCanvas9079, Class462.screenWidth * -2110394505, -1111710645 * Class298_Sub40_Sub9.screenHeight, (byte) 20);
