...
public class Class475 {
	...
	public Class475(Class411 class411, Class429 class429, CacheIndex class243) {
		...
		if (null != ((Class475) this).aClass243_5981) {
			...
			ConfigFile.aClass120_1413.method1306((short) 19923);
	...
	public ClientScriptMap getClientScriptMap(int id, int i_0_) {
		try {
			...
			synchronized (((Class475) this).aClass348_5982) {
				class483 = (ClientScriptMap) ((Class475) this).aClass348_5982.get((long) id);
			}
			if (null != class483)
				return class483;
			byte[] is = (((Class475) this).aClass243_5981.getFileFromArchive(ConfigFile.aClass120_1413.method1307(id, -1240874866), ConfigFile.aClass120_1413.method1305(id, -2003896976), (byte) -65));
			class483 = new ClientScriptMap();
			class483.id = id;
			if (null != is)
				class483.method6123(new RsByteBuffer(is), 592135620);
			ClientScriptMap.modify(class483, id);
			synchronized (((Class475) this).aClass348_5982) {
	...
	public static final void method6075(short i) {
		try {
			int i_1_ = Class422_Sub25.preferences.aClass422_Sub17_7565.method5689(-2013953489);
			if (i_1_ == 0) {
