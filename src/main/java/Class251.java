...
public class Class251 {
	...
	static final void method2405(ClientScript2 class403, int i) {
		try {
			...
			client.anInt8768 = 1723181617 * i_0_;
			int i_1_ = (((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239 + 1]);
			if (i_1_ + 1 >= (client.anIntArrayArrayArray8767[-591434031 * client.anInt8768]).length >> 1)
				throw new RuntimeException();
			client.anInt8770 = i_1_ * -2146952741;
			client.anInt8857 = 0;
			client.anInt8852 = ((((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239 + 2]) * -2045228877);
			client.anInt8774 = (-546154255 * (((ClientScript2) class403).anIntArray5244[3 + 681479919 * ((ClientScript2) class403).anInt5239]));
			int i_2_ = (((ClientScript2) class403).anIntArray5244[4 + 681479919 * ((ClientScript2) class403).anInt5239]);
			if (i_2_ >= 2)
				throw new RuntimeException();
			client.anInt8769 = -2694169 * i_2_;
			int i_3_ = (((ClientScript2) class403).anIntArray5244[5 + 681479919 * ((ClientScript2) class403).anInt5239]);
			if (1 + i_3_ >= (client.anIntArrayArrayArray8767[-839811113 * client.anInt8769]).length >> 1)
				throw new RuntimeException();
			client.anInt8771 = i_3_ * -274142709;
			Class298_Sub1.cameraType = -734758223;
	...
	static final void method2406(int i, int i_4_, int i_5_, int i_6_, int i_7_) {
		try {
			...
			if (1 == client.anInt8748 * -392325587) {
				...
				class57.drawSprite(i_8_ - 8, i_9_ - 8);
			}
	...
	static final void method2407(ClientScript2 class403, byte i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub16_7557.method5612(i_10_, 1352882135);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("km.aor(").append(')').toString());
		}
	}

	static final void method2408(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anInt5239 -= -783761378;
			Class344.method4165((((ClientScript2) class403).anIntArray5244[(681479919 * ((ClientScript2) class403).anInt5239)]), (((ClientScript2) class403).anIntArray5244[1 + (681479919 * ((ClientScript2) class403).anInt5239)]), 0, -1721946915);
		} catch (RuntimeException runtimeexception) {
