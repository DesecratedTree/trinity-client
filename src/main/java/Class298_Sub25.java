...
public class Class298_Sub25 extends Class298 {
	...
	static final void method3102(ClientScript2 class403, int i) {
		try {
			WorldMapArea area = WorldMap.method3705(((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]);
			if (area == null || null == area.arenaName)
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
			else
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = area.arenaName;
		} catch (RuntimeException runtimeexception) {
