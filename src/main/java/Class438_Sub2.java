...
public class Class438_Sub2 extends Class438 {
	...
	void method5848(AnimationConfig class391, int i) {
		Class209.method1938(class391, i, ((Class438_Sub2) this).aClass365_Sub1_8440, -463239640);
	}

	void method5837(AnimationConfig class391, int i, byte i_0_) {
		try {
	...
	static boolean method5849(Interface3 interface3, byte i) {
		try {
			ObjectConfig class432 = client.aClass283_8716.method2641(1998541007).getObjectDefinitions(interface3.method32((byte) 21));
			if (-1 == -1204256389 * class432.objectIconID)
				return true;
			Class496 class496 = ConfigFile.aClass487_1463.method6159((class432.objectIconID * -1204256389), -2130110173);
