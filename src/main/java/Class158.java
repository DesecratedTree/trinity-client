...
public class Class158 implements Interface5 {
	...
	static final void method1699(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
	...
	static final void method1700(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_2_, (byte) 76);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.textColor * 1045422783;
		} catch (RuntimeException runtimeexception) {
