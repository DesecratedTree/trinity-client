...
public class Class68 {
	...
	static void method777(boolean bool, Class298_Sub19_Sub1 class298_sub19_sub1, int i) {
		try {
			...
			if (bool)
				Class445.method5897(Class114.aClass243_1381, Class439.MUSIC_EFFECT_INDEX, Class52.aClass243_507, class298_sub19_sub1, Class300.aClass284_3212, (byte) -102);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("ct.p(").append(')').toString());
		}
	}

	static final void method778(ClientScript2 class403, int i) {
		try {
			int i_2_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_2_, (byte) 16);
	...
	static final void method779(ClientScript2 class403, int i) {
		try {
			Class_na.method3478(-2146138663);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("ct.agt(").append(')').toString());
		}
	}

	static final void method780(ClientScript2 class403, int i) {
		try {
	...
	static final void method782(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static final void method786(ClientScript2 class403, byte i) {
		try {
			int i_9_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_9_, (byte) 31);
