...
public class Class422_Sub10 extends Preference {
	static int anInt8391 = 2;
	static int anInt8392 = 0;

	public Class422_Sub10(Preferences class298_sub48) {
	...
	public Class422_Sub10(int i, Preferences class298_sub48) {
	...
	static void method5662(GraphicsToolkit class_ra, int i, int i_2_, WidgetConfig class105, Class_ta class_ta, int i_3_, int i_4_, int i_5_) {
		try {
			for (int i_6_ = 0; i_6_ < client.anInt8703 * -1230451913; i_6_++) {
				ObjectValue class298_sub29 = ((ObjectValue) client.aClass437_8696.method5812((long) client.anIntArray8699[i_6_]));
					...
					if (class365_sub1_sub1_sub2_sub1.method4457(1140952765) && ((Class287.myPlayer.plane) == class365_sub1_sub1_sub2_sub1.plane)) {
						...
						if (null != class503 && class503.visibleOnMap && class503.hasOptions) {
							...
							if (-1 != -1362115471 * class503.anInt6186)
								...
								FloorUnderlay.method5883(class105, class_ta, i_3_, i_4_, i_7_, i_8_, (SubIncommingPacket.aClass57Array2349[1]), (byte) -17);
						}
					}
				}
			}
	...
	public static Class57 method5663(CacheIndex index, int id, byte i_9_) {
		try {
			Class57 class57 = (Class57) Class229.aClass348_6452.get((long) id);
			if (null == class57) {
				if (Class230.useJagexFormatSprites) {
					class57 = (FloorOverlay.graphics.method5125(Class89.getSprite(index, id), true));
				} else
					class57 = Class223.method2081(index.method2294(id, (byte) 15), -161656424);
				Class229.aClass348_6452.method4194(class57, (long) id);
			}
			return class57;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("adl.f(").append(')').toString());
	...
	static final void method5664(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
