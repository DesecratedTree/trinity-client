...
public class Class266 {
	...
	public static Class266 LOAD_MAP_SCENE_BG = new Class266(false, false);
	...
	public static Class128 method2524(RsByteBuffer class298_sub53, byte i) {
		try {
			Class128 class128 = RSGraphics.method608(class298_sub53, -2082890426);
		...
		try {
			...
			if (class365_sub1_sub1_sub2.anInt10090 * 1433412323 != -1) {
				...
				if (class365_sub1_sub1_sub2.anInt10090 * 1433412323 < 32768) {
					ObjectValue class298_sub29 = ((ObjectValue) (client.aClass437_8696.method5812((long) (1433412323 * class365_sub1_sub1_sub2.anInt10090))));
					if (class298_sub29 != null)
						class365_sub1_sub1_sub2_7_ = ((Entity) class298_sub29.value);
			...
			if (class365_sub1_sub1_sub2 instanceof Player) {
				...
				if (-1 != class365_sub1_sub1_sub2_sub1.anInt10179 * 579792529 && ((class365_sub1_sub1_sub2_sub1.anInt10120 * 2050671733 == 0) || (-1531994851 * class365_sub1_sub1_sub2_sub1.anInt10124) > 0)) {
					...
					int i_10_ = ((int) class217.x - ((class365_sub1_sub1_sub2_sub1.anInt10179 * -1896967936) - 263081728 * class341.gameSceneBaseX - 263081728 * class341.gameSceneBaseX));
					int i_11_ = ((int) class217.y - ((893346048 * class365_sub1_sub1_sub2_sub1.anInt10180) - class341.gameSceneBaseY * -434703616 - class341.gameSceneBaseY * -434703616));
					if (0 != i_10_ || i_11_ != 0)
	...
	static void method2526(GraphicsToolkit class_ra, Class453 class453, int i, int i_12_, int i_13_) {
		try {
			JagexFile2.aClass453_5986.clear((byte) 1);
			if (!Class301_Sub1.aBoolean7635) {
				for (Class298_Sub52 class298_sub52 = (Class298_Sub52) class453.method5939(1766612795); class298_sub52 != null; class298_sub52 = (Class298_Sub52) class453.method5944(49146)) {
					Class352 class352 = (Class301_Sub1.aClass339_3251.method4116(-530122905 * class298_sub52.mapAreaID, -1838109089));
