...
public class Class496 {
	...
	public Class57 method6198(GraphicsToolkit class_ra, int i, boolean bool, byte i_1_) {
		try {
			...
			if (!((Class487) ((Class496) this).aClass487_6095).aClass243_6068.method2310(anInt6097 * 1690480405, -457216440))
				return null;
			Class89 class89 = Class89.getSprite((((Class487) (((Class496) this).aClass487_6095)).aClass243_6068), 1690480405 * anInt6097, 0);
			if (null != class89) {
	...
	static final void method6200(ClientScript2 class403, int i) {
		try {
			...
			if (null != Class301_Sub1.aClass437_7636) {
				Class298 class298 = Class301_Sub1.aClass437_7636.method5812((long) i_7_);
	...
	static final void method6201(ClientScript2 class403, int i) {
		try {
			...
			if (i_8_ >= 1 && i_8_ <= 2) {
				Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.displayMode, i_8_, 708632362);
				Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub12_7574, i_8_, 837898760);
	...
	static void method6202(double d) {
		try {
			if (TextureData.aDouble9587 != d) {
				for (int i = 0; i < 256; i++) {
					int i_9_ = (int) (Math.pow((double) i / 255.0, d) * 255.0);
					TextureData.anIntArray9586[i] = i_9_ > 255 ? 255 : i_9_;
				}
				TextureData.aDouble9587 = d;
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method6203(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_10_, (byte) -20);
			int i_11_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			i_11_--;
			if (class105.options == null || i_11_ >= class105.options.length || class105.options[i_11_] == null)
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
			else
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = class105.options[i_11_];
		} catch (RuntimeException runtimeexception) {
