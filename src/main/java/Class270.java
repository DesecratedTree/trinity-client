...
public class Class270 {
	...
	static final void method2536(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anInt5239 -= -783761378;
			class105.anInt1166 = -970389233 * (((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239]);
			if (class105.anInt1166 * 684246511 > (1867913305 * class105.scrollWidth - class105.anInt1156 * -2093041337))
				class105.anInt1166 = (1227329079 * class105.scrollWidth - class105.anInt1156 * 2072992297);
			...
			if (-1424956747 * class105.anInt1167 > (class105.scrollHeight * 2053897963 - 457937409 * class105.anInt1162))
				class105.anInt1167 = (2097037087 * class105.scrollHeight - -900266595 * class105.anInt1162);
			...
			if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403)
				Class422_Sub14.method5682(class105.uid * -440872681, -754597349);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2540(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub8_7566.method5612(i_42_, 1352882135);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2541(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub4_7563.method5638((byte) 78) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
