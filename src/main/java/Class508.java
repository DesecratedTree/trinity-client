...
public class Class508 {
	...
	public Class508(Class411 class411, Class429 class429, CacheIndex class243) {
		...
		anInt6214 = (((Class508) this).aClass243_6215.method2316((-1006924897 * (ConfigFile.aClass120_1420.anInt1460)), -2127064505) * 809853823);
	}
	...
	static final void method6279(boolean bool, int i) {
		try {
			...
			for (;;) {
				if (stream.method3660((-866602563 * (((Class25) client.aClass25_8711).anInt336)), (byte) -70) < 15) {
					if (i != 596994841)
						break;
					return;
				}
				...
				ObjectValue class298_sub29 = ((ObjectValue) client.aClass437_8696.method5812((long) i_3_));
				if (class298_sub29 == null) {
					...
					class298_sub29 = new ObjectValue(class365_sub1_sub1_sub2_sub1);
					client.aClass437_8696.method5817(class298_sub29, (long) i_3_);
					client.npcs[(client.npcCount += -118843751) * 1962237353 - 1] = class298_sub29;
					bool_4_ = true;
				}
				...
				if (null != class365_sub1_sub1_sub2_sub1.config && class365_sub1_sub1_sub2_sub1.config.method6242((byte) 88))
				...
				class365_sub1_sub1_sub2_sub1.setConfig((Class15.aClass507_224.method6269(stream.readBits(15), 229452067)), 1407104224);
				int i_7_;
				if (bool) {
				...
				class365_sub1_sub1_sub2_sub1.method4421(-2095128707 * (class365_sub1_sub1_sub2_sub1.config.anInt6187), -1253182390);
				class365_sub1_sub1_sub2_sub1.anInt10115 = (-1186616623 * (-1927065533 * (class365_sub1_sub1_sub2_sub1.config.opcode103V) << 3));
				if (bool_4_)
				...
				if (class365_sub1_sub1_sub2_sub1.config.method6242((byte) -9))
					AnimationConfig.method4884(class365_sub1_sub1_sub2_sub1.plane, (class365_sub1_sub1_sub2_sub1.scenePositionXQueue[0]), (class365_sub1_sub1_sub2_sub1.scenePositionYQueue[0]), 0, null, class365_sub1_sub1_sub2_sub1, null, (byte) -66);
			}
