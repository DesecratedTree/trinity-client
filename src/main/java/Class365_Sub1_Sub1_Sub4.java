...
public class Class365_Sub1_Sub1_Sub4 extends Class365_Sub1_Sub1 {
	...
	void method4355(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_2_, int i_3_, boolean bool, int i_4_) {
		try {
			/* empty */
		} catch (RuntimeException runtimeexception) {
	...
	Class335 method4370(GraphicsToolkit class_ra) {
		...
		if (null != ((Class365_Sub1_Sub1_Sub4) this).aClass387_10141) {
			...
			((Class365_Sub1_Sub1_Sub4) this).aClass387_10141.drawModel(class222, null, 0);
		}
		return null;
	}
	...
	void method4375(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_13_, int i_14_, boolean bool) {
		/* empty */
	}

	void method4388(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_15_, int i_16_, boolean bool) {
		/* empty */
	}
