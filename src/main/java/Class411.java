...
public class Class411 {
	...
	public static Class411 aClass411_5320 = new Class411(Settings.ABSOLOUTE_CACHE_NAME_2, Settings.CACHE_SUB_NAME, 0);
	...
	static void method5576(int i, int i_4_, int i_5_, Class298_Sub12 class298_sub12, int i_6_) {
		try {
			...
			GroundTile class298_sub2 = (GroundTile) client.groundTiles.method5812(l);
			if (class298_sub2 == null) {
				class298_sub2 = new GroundTile();
				client.groundTiles.method5817(class298_sub2, l);
				class298_sub2.groundItems.add(class298_sub12, 1567854006);
			} else {
				ItemConfig class468 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(1768239597 * class298_sub12.id));
				int i_7_ = 785788887 * class468.value;
				if (789409129 * class468.stackable == 1)
					i_7_ *= 1 + 567630807 * (((Class298_Sub12) class298_sub12).anInt7256);
				for (Class298_Sub12 class298_sub12_8_ = (Class298_Sub12) class298_sub2.groundItems.method5939(1766612795); null != class298_sub12_8_; class298_sub12_8_ = ((Class298_Sub12) class298_sub2.groundItems.method5944(49146))) {
					class468 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(class298_sub12_8_.id * 1768239597));
					int i_9_ = 785788887 * class468.value;
					if (1 == 789409129 * class468.stackable)
				...
				class298_sub2.groundItems.add(class298_sub12, 1066004680);
			}
		} catch (RuntimeException runtimeexception) {
	...
	static void method5577(WidgetConfig class105, int i) {
		try {
			if (5 == -1215239439 * class105.type && -1 != class105.anInt1280 * -1232467723)
				Class230.method2125(FloorOverlay.graphics, class105, -1423422969);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("rb.lz(").append(')').toString());
		}
	}

	static final void method5578(WidgetConfig[] class105s, int i, byte i_10_) {
		try {
			for (int i_11_ = 0; i_11_ < class105s.length; i_11_++) {
				WidgetConfig class105 = class105s[i_11_];
				if (null == class105) {
					if (i_10_ != 1) {
						/* empty */
					}
				} else if (i != class105.parentUID * 1573706803) {
					if (i_10_ != 1) {
						/* empty */
					}
					...
					if (0 == -1215239439 * class105.type) {
						method5578(class105s, class105.uid * -440872681, (byte) 1);
						if (class105.aClass105Array1293 != null)
							method5578(class105.aClass105Array1293, class105.uid * -440872681, (byte) 1);
						Interface class298_sub51 = ((Interface) (client.aClass437_8841.method5812((long) (class105.uid * -440872681))));
						if (class298_sub51 != null)
							FloorUnderlay.method5884((-1617025021 * class298_sub51.interfaceId), 587240851);
					}
	...
	static void method5579(int i) {
		try {
			...
			for (int i_12_ = 0; i_12_ < client.hintIcons.length; i_12_++)
				client.hintIcons[i_12_] = null;
			...
			client.anInt8703 = 0;
			client.npcCount = 0;
			client.aClass437_8696.clear((byte) -7);
			client.projectiles.clear((byte) 1);
			client.groundGfxs.clear((byte) -106);
			client.groundMessages.clear(585418023);
			client.groundTiles.clear((byte) -42);
			...
			client.aClass437_8841 = new LinkedArrayList(8);
			...
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub17_7565, Class422_Sub25.preferences.aClass422_Sub17_7564.method5689(-2013953489), 185315871);
			client.anInt8713 = 0;
