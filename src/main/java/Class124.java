...
public class Class124 implements Runnable {
	...
	static void method1386(byte i) {
		try {
			...
			Class460.method5981((-1L == 122690138525332847L * Class360.usernameL), true, "", "", Class360.usernameL * 122690138525332847L);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1389(Entity class365_sub1_sub1_sub2, int i) {
		try {
			...
			class365_sub1_sub1_sub2.method4341((float) ((i_6_ - (int) class217.x) / i_5_ + (int) class217.x), (float) (int) class217.aFloat2455, (float) ((int) class217.y + (i_7_ - (int) class217.y) / i_5_));
