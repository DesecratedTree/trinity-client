...
final class Class393 implements Runnable {
	...
	static final void method4890(ClientScript2 class403, int i) {
		try {
	...
	static final void method4891(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
			...
			if (class105.anInt1154 * -1309843523 == -1 && !class119.aBoolean1403)
				Preference.method5623(class105.uid * -440872681, 2026838544);
		} catch (RuntimeException runtimeexception) {
	...
	static synchronized GraphicsToolkit method4892(int i, Canvas canvas, Interface_ma interface_ma, CacheIndex class243, int i_0_, int i_1_, int i_2_, int i_3_) {
		try {
			if (i == 0)
				return Class141.getSafeTK(canvas, interface_ma, i_1_, i_2_, (byte) 88);
			if (i == 2)
				return Class273.getSoftwareTK(canvas, interface_ma, i_1_, i_2_, (byte) -28);
			if (5 == i || (i == 1 && Settings.ENABLE_MODERN_OPENGL)) {//uses opengl legacy if fails gltk
				try {
					return Class259.getOpenGLTK(canvas, interface_ma, class243, i_0_);
				} catch (Throwable e) {
					Settings.ENABLE_MODERN_OPENGL = false;
					return Class59.getOpenGLLegacyTK(canvas, interface_ma, i_0_);
				}
			}
			if (1 == i)
				return Class59.getOpenGLLegacyTK(canvas, interface_ma, i_0_);
			if (3 == i)
				return Class204.getDirectXTK(canvas, interface_ma, class243, i_0_);
	...
	static final void method4893(ClientScript2 class403, byte i) {
		try {
	...
	static final void method4894(ClientScript2 class403, int i) {
		try {
			...
			if (0 == i_4_)
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = (int) Math.pow((double) i_4_, (double) i_5_);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("qg.zb(").append(')').toString());
		}
	}

	static final void method4895(ClientScript2 class403, int i) {
		try {
			int i_6_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_6_, (byte) -21);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = 684246511 * class105.anInt1166;
		} catch (RuntimeException runtimeexception) {
