...
public class Class128_Sub1 extends Class128 {
	...
	static int method1439(int mode, int benchmark, int i_10_) {
		try {
			int i_11_;
			if (benchmark > 80296) {
				Class116.setVeryHighPreferences(774098447);
				i_11_ = 4; //custom
			}else if (benchmark > 20074) {
				Class116.setHighPreferences(774098447);
				i_11_ = 4;
			} else if (benchmark > 10033) {
				Class302_Sub3.setMidPreferences((short) 24043);
				i_11_ = 3;
			} else if (benchmark > 5030) {
				Class320.setLowPreferences(-793746149);
				i_11_ = 2;
			} else {
				Class69.setMinPreferences(true, -1704666042);
				i_11_ = 1;
			}
			i_11_ = 1;
			
			if (Class422_Sub25.preferences.graphicsMode.method5677(-1134958501) != mode) {
				Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub14_7570, mode, -1879623145);
				Class370.method4578(mode, false, 622850291);
			} else
				Class422_Sub25.preferences.method3539(Class422_Sub25.preferences.graphicsMode, true, -2138702215);
