...
public class Class127_Sub2 extends Class127 {
	...
	void method1414(boolean bool, int i, int i_0_) {
		...
		FloorOverlay.graphics.r(i, i_0_ + 2, i + i_1_, (((Class127_Sub2) this).aClass128_6375.anInt6330) * -1387457793 + i_0_);
	...
	void method1411(boolean bool, int i, int i_2_, int i_3_) {
		try {
			...
			int[] is = new int[4];
			FloorOverlay.graphics.qa(is);
			FloorOverlay.graphics.r(i, i_2_ + 2, i + i_4_, (((Class127_Sub2) this).aClass128_6375.anInt6330) * -1387457793 + i_2_);
	...
	void method1409(boolean bool, int i, int i_6_) {
		FloorOverlay.graphics.method5019(i - 2, i_6_, ((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 4, 2 + ((Class127_Sub2) this).aClass128_6375.anInt6330 * -1387457793, (((Class128_Sub1) ((Class127_Sub2) this).aClass128_6375).anInt8554 * 1514768717), 0);
		FloorOverlay.graphics.method5019(i - 1, i_6_ + 1, ((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 2, -1387457793 * ((Class127_Sub2) this).aClass128_6375.anInt6330, 0, 0);
	}
	...
	void method1412(boolean bool, int i, int i_7_, int i_8_) {
		try {
			FloorOverlay.graphics.method5019(i - 2, i_7_, (((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 4), 2 + (((Class127_Sub2) this).aClass128_6375.anInt6330 * -1387457793), (((Class128_Sub1) ((Class127_Sub2) this).aClass128_6375).anInt8554) * 1514768717, 0);
			FloorOverlay.graphics.method5019(i - 1, i_7_ + 1, (((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 2), -1387457793 * ((Class127_Sub2) this).aClass128_6375.anInt6330, 0, 0);
		} catch (RuntimeException runtimeexception) {
	...
	void method1413(boolean bool, int i, int i_9_) {
		...
		int[] is = new int[4];
		FloorOverlay.graphics.qa(is);
		FloorOverlay.graphics.r(i, i_9_ + 2, i + i_10_, (((Class127_Sub2) this).aClass128_6375.anInt6330) * -1387457793 + i_9_);
	...
	void method1415(boolean bool, int i, int i_11_) {
		...
		int[] is = new int[4];
		FloorOverlay.graphics.qa(is);
		FloorOverlay.graphics.r(i, i_11_ + 2, i + i_12_, (((Class127_Sub2) this).aClass128_6375.anInt6330) * -1387457793 + i_11_);
	...
	void method1416(boolean bool, int i, int i_13_) {
		...
		int[] is = new int[4];
		FloorOverlay.graphics.qa(is);
		FloorOverlay.graphics.r(i, i_13_ + 2, i + i_14_, (((Class127_Sub2) this).aClass128_6375.anInt6330) * -1387457793 + i_13_);
	...
	void method1410(boolean bool, int i, int i_15_) {
		FloorOverlay.graphics.method5019(i - 2, i_15_, ((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 4, 2 + ((Class127_Sub2) this).aClass128_6375.anInt6330 * -1387457793, (((Class128_Sub1) ((Class127_Sub2) this).aClass128_6375).anInt8554 * 1514768717), 0);
		FloorOverlay.graphics.method5019(i - 1, i_15_ + 1, ((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 2, -1387457793 * ((Class127_Sub2) this).aClass128_6375.anInt6330, 0, 0);
	}
	...
	void method1417(boolean bool, int i, int i_16_) {
		FloorOverlay.graphics.method5019(i - 2, i_16_, ((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 4, 2 + ((Class127_Sub2) this).aClass128_6375.anInt6330 * -1387457793, (((Class128_Sub1) ((Class127_Sub2) this).aClass128_6375).anInt8554 * 1514768717), 0);
		FloorOverlay.graphics.method5019(i - 1, i_16_ + 1, ((Class127_Sub2) this).aClass128_6375.anInt6326 * -944287579 + 2, -1387457793 * ((Class127_Sub2) this).aClass128_6375.anInt6330, 0, 0);
	}
}
