...
public final class Class406 {
	...
	static final void method4961(ClientScript2 class403, int i) {
		try {
			...
			if (null == Class389.aClass119Array4165[i_1_])
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = (Class389.aClass119Array4165[i_1_].components[i_2_].anInt1141) * -914988669;
		} catch (RuntimeException runtimeexception) {
	...
	static final void decodeNPCUpdate(boolean largeView, int i) {
		try {
			...
			for (int i_4_ = 0; i_4_ < client.anInt8708 * -1508392173; i_4_++) {
				...
				ObjectValue class298_sub29 = ((ObjectValue) client.aClass437_8696.method5812((long) i_5_));
				...
				if (-1402769421 * class365_sub1_sub1_sub2_sub1.anInt10075 != client.anInt8707 * 440189755) {
					...
					if (class365_sub1_sub1_sub2_sub1.config.method6242((byte) 32))
						Class244.method2330(class365_sub1_sub1_sub2_sub1, (byte) 35);
					class365_sub1_sub1_sub2_sub1.setConfig(null, 1734282756);
					class298_sub29.remove(-1460969981);
					bool_3_ = true;
				}
			}
			if (bool_3_) {
				int i_6_ = 1962237353 * client.npcCount;
				client.npcCount = (client.aClass437_8696.method5814(1946710966) * -118843751);
				int i_7_ = 0;
				Iterator<?> iterator = client.aClass437_8696.iterator();
				while (iterator.hasNext()) {
					ObjectValue class298_sub29 = (ObjectValue) iterator.next();
					client.npcs[i_7_++] = class298_sub29;
				}
				for (int i_8_ = client.npcCount * 1962237353; i_8_ < i_6_; i_8_++)
					client.npcs[i_8_] = null;
			}
			if (385051775 * (((Class25) client.aClass25_8711).aClass298_Sub53_Sub2_333.index) != ((Class25) client.aClass25_8711).anInt336 * -866602563) {
			}
			for (int i_9_ = 0; i_9_ < -1230451913 * client.anInt8703; i_9_++) {
				if (client.aClass437_8696.method5812((long) client.anIntArray8699[i_9_]) == null) {
				}
			}
			if (0 != (client.npcCount * 1962237353 - -1230451913 * client.anInt8703)) {
			}
			for (int i_10_ = 0; i_10_ < client.npcCount * 1962237353; i_10_++) {
				if (-1402769421 * ((Entity) (client.npcs[i_10_].value)).anInt10075 != 440189755 * client.anInt8707) {
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	public static final void drawLoadingBar(Image background, int i, String string, Color color, Color color_11_, Color color_12_, byte i_13_) {
		try {
			do {
				try {
					...
					try {
						if (Class298_Sub32_Sub22.anImage9468 == null)
							Class298_Sub32_Sub22.anImage9468 = (Class52_Sub2_Sub1.aCanvas9079.createImage(-2110394505 * Class462.screenWidth, (Class298_Sub40_Sub9.screenHeight * -1111710645)));
						Graphics graphics_14_ = Class298_Sub32_Sub22.anImage9468.getGraphics();
			
						graphics_14_.setColor(Color.black);
						graphics_14_.fillRect(0, 0, -2110394505 * Class462.screenWidth, (Class298_Sub40_Sub9.screenHeight * -1111710645));
						
						
						if (background != null)
							graphics_14_.drawImage(background, -2110394505 * Class462.screenWidth / 2 - 956/2, Class298_Sub40_Sub9.screenHeight * -1111710645 / 2 - 503/2, null);

					//	Class224.time = 0;
						color = new Color(148,0,211, 128);
						color_11_ = color;
						Color black = new Color(0, 0,0, 128);//Color.black;
						if ( System.currentTimeMillis() >= Class224.time) {
							int i_15_ = Class462.screenWidth * -2110394505 / 2 - 152;
							int i_16_ = (-1111710645 * Class298_Sub40_Sub9.screenHeight / 2 - 18);
							...
							if (Class291.aString6485 != null) {
								graphics_14_.setFont(Class285.aFont3082);
								graphics_14_.setColor(color_12_);
								graphics_14_.drawString(Class291.aString6485, (-2110394505 * Class462.screenWidth / 2 - Class291.aString6485.length() * 6 / 2), (Class298_Sub40_Sub9.screenHeight * -1111710645 / 2) - 26);
							}
						}
						graphics.drawImage(Class298_Sub32_Sub22.anImage9468, 0, 0, null);
					} catch (Exception exception) {
						graphics.setColor(Color.black);
						graphics.fillRect(0, 0, -2110394505 * Class462.screenWidth, (Class298_Sub40_Sub9.screenHeight * -1111710645));
						int i_17_ = -2110394505 * Class462.screenWidth / 2 - 152;
						int i_18_ = (Class298_Sub40_Sub9.screenHeight * -1111710645 / 2 - 18);
						...
						if (null != Class291.aString6485) {
							graphics.setFont(Class285.aFont3082);
							graphics.setColor(color_12_);
							graphics.drawString(Class291.aString6485, ((Class462.screenWidth * -2110394505 / 2) - Class291.aString6485.length() * 6 / 2), (Class298_Sub40_Sub9.screenHeight * -1111710645 / 2) - 26);
						}
