...
public class Class298_Sub34 extends Class298 {
	byte[] aByteArray7386;
	...
	Class298_Sub34(byte[] is) {
		...
		for (int i_5_ = 0; i_5_ < i; i_5_++)
			is_4_[i_5_] = class298_sub53.readByte();
		...
		for (int i_9_ = 0; i_9_ < i_7_; i_9_++)
			is_8_[i_9_] = class298_sub53.readByte();
		class298_sub53.index += 116413311;
		i_7_++;
		...
		for (int i_13_ = 0; i_13_ < i_11_; i_13_++)
			is_12_[i_13_] = class298_sub53.readByte();
		class298_sub53.index += 116413311;
		...
		for (int i_26_ = 0; i_26_ < i_24_; i_26_++)
			is_25_[i_26_] = class298_sub53.readByte();
		class298_sub53.index += 116413311;
		i_24_++;
		int i_27_ = 0;
		...
		for (int i_33_ = 0; i_33_ < 128; i_33_++) {
			if (i_30_ == 0) {
				if (i_31_ < is_25_.length)
					...
					i_30_ = -1;
				i_32_ = class298_sub53.readV(1692297361);
			}
