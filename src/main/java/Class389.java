...
public class Class389 {
	CacheIndex aClass243_4159;
	CacheIndex aClass243_4160;
	...
	public GraphicsConfig method4857(int i, int i_0_) {
		try {
			GraphicsConfig class398;
			synchronized (((Class389) this).aClass348_4161) {
				class398 = (GraphicsConfig) ((Class389) this).aClass348_4161.get((long) i);
			}
			if (class398 != null)
				return class398;
			byte[] is;
			synchronized (((Class389) this).aClass243_4159) {
				is = (((Class389) this).aClass243_4159.getFileFromArchive(ConfigFile.aClass120_1449.method1307(i, -880627246), ConfigFile.aClass120_1449.method1305(i, -2138953670), (byte) -76));
			}
			class398 = new GraphicsConfig();
			((GraphicsConfig) class398).aClass389_5210 = this;
			((GraphicsConfig) class398).id = i * 1757755963;
			if (is != null)
	...
	public Class389(Class411 class411, Class429 class429, CacheIndex class243, CacheIndex class243_3_) {
		...
		ConfigFile.aClass120_1449.method1306((short) 3745);
	...
	static final void method4862(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			class105.noClickThrough = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) == 1;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4863(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub11_7558.method5667(-369768513);
		} catch (RuntimeException runtimeexception) {
