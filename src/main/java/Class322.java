...
public class Class322 {
	...
	static final void draw(long l) {
		try {
			if (client.aClass283_8716.method2675(-1611682495) != null) {
				if (4 == -863531439 * Class298_Sub1.cameraType || 5 == Class298_Sub1.cameraType * -863531439)
					Class491.method6175(l);
				else if (Class298_Sub1.cameraType * -863531439 == 2)
					ClientScript2.method4944(l);
			}
			Class152.method1652(FloorOverlay.graphics, (long) (443738891 * client.anInt8884));
			if (-1 != -257444687 * client.WINDOW_PANE_ID)
				FloorUnderlay.method5884(-257444687 * client.WINDOW_PANE_ID, -333860368);
			...
			if (client.WINDOW_PANE_ID * -257444687 != -1) {
				client.anInt8686 = 0;
				Class104.drawInterfaces(1847385357);
			//	Hitbox.draw();
			}
			FloorOverlay.graphics.L();
			Class463.drawMenu(FloorOverlay.graphics, (byte) 38);
			...
			Map.method4144((Class287.myPlayer.plane), i_3_ + (int) class217.x, (int) class217.y + i_3_, client.anInt8961 * 614680345, (short) 8192);
			client.anInt8961 = 0;
		} catch (RuntimeException runtimeexception) {
