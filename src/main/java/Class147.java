...
public class Class147 {
	...
	static Class147 aClass147_1579 = new Class147(0, 4 + Settings.EXTRA_DRAW_DISTANCE);
	int anInt1580;
	...
	Class147(int i, int i_0_) {
		...
		renderDistance = -1628605819 * i_0_;
	}

	public static void method1600(WidgetConfig class105, int i, int i_1_, int i_2_) {
		try {
			if (null != class105) {
				if (null != class105.anObjectArray1249) {
					Class298_Sub46 class298_sub46 = new Class298_Sub46();
					class298_sub46.aClass105_7525 = class105;
					class298_sub46.anObjectArray7530 = class105.anObjectArray1249;
					Class444.method5889(class298_sub46, (byte) -26);
				}
				client.aBoolean8835 = true;
				Class379.anInt4099 = class105.uid * 1167811111;
	...
	static void method1601(byte i) {
		try {
			if (client.aByteArray8843 != null)
				ConfigFile.method1311(-1491321338);
