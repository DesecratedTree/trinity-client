	...
	public static void method2573(int i) {
		try {
			...
			if (Class288_Sub1.aClass219_7147 != null) {
				...
				if (null != Class230.loadingInterfaces) {
					for (int i_4_ = 1 + -1936794913 * Class230.anInt2563; i_4_ < Class230.loadingInterfaces.length; i_4_++) {
						if (Class230.loadingInterfaces[i_4_].method159((byte) 31) >= 100 && -1936794913 * Class230.anInt2563 == i_4_ - 1 && 12 != -1233866115 * client.anInt8752 && Class288_Sub1.aClass219_7147.method2035(-1321940215)) {
							try {
								Class230.loadingInterfaces[i_4_].method150(-1481032979);
							} catch (Exception exception) {
								Class230.loadingInterfaces = null;
								break;
							}
							//set login interface
							//Class288_Sub1.aClass219_7147.method2036(Class230.loadingInterfaces[i_4_], -847859584);
						/*	Class230.anInt2563 += 64708895;
							if ((Class230.anInt2563 * -1936794913 >= Class230.loadingInterfaces.length - 1) && Class230.loadingInterfaces.length > 1)
								Class230.anInt2563 = (Class420.gameTips.method6296((byte) 7) ? 0 : -1) * 64708895;
						*/}
					}
				}
			}
