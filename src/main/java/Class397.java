...
public class Class397 {
	...
	public static int anInt5201 = -1;//TODO hihihi
	...
	static void method4914(WidgetConfig class105, Class117 class117, int i, int i_23_, int i_24_, int i_25_, int i_26_, long l) {
		try {
