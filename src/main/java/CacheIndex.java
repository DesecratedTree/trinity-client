...
public final class CacheIndex {
	...
	synchronized boolean method2284(int i) {
		try {
			if (aClass226_2713 == null) {
				aClass226_2713 = aClass242_2720.method2250(2102263091);
				if (aClass226_2713 == null) {
					return false;
				}
				anObjectArray2717 = new Object[-1583970959 * ((aClass226_2713).anInt2521)];
				anObjectArrayArray2718 = new Object[-1583970959 * ((aClass226_2713).anInt2521)][];
			}
			return true;
	...
	public int method2285(byte i) {
		try {
			...
			return (aClass226_2713.anInt2513 * 1600327191);
		} catch (RuntimeException runtimeexception) {
	...
	synchronized boolean method2286(int i, int i_0_, byte i_1_) {
		try {
			...
			if (i < 0 || i_0_ < 0 || i >= (aClass226_2713.anIntArray2517).length || i_0_ >= (aClass226_2713.anIntArray2517[i])) {
				if (aBoolean2721) {
	...
	synchronized void method2287(int i, byte i_2_) {
		try {
			if (aBoolean2715) {
				anObjectArray2717[i] = aClass242_2720.method2251(i, (byte) -83);
			} else {
				anObjectArray2717[i] = Class158.method1702(aClass242_2720.method2251(i, (byte) -115), false, (short) -5444);
			}
		} catch (RuntimeException runtimeexception) {
	...
	void method2288(int i, byte i_3_) {
		try {
			aClass242_2720.method2256(i, (short) -11867);
		} catch (RuntimeException runtimeexception) {
	...
	public synchronized byte[] method2289(int i, int i_4_, int[] is, int i_5_) {
		try {
			...
			byte[] is_6_ = null;
			if (null == anObjectArrayArray2718[i] || null == anObjectArrayArray2718[i][i_4_]) {
			...
			if (null == anObjectArrayArray2718[i]) {
				throw new RuntimeException("");
			}
			if (anObjectArrayArray2718[i][i_4_] == null) {
				if (i_5_ >= -969677092) {
					/* empty */
				}
			} else {
				is_6_ = Class338.method4114((anObjectArrayArray2718[i][i_4_]), false, -390800011);
				if (is_6_ == null) {
					throw new RuntimeException("");
				}
			}
			if (null != is_6_) {
				if (anInt2719 * -1870742467 == 1) {
					anObjectArrayArray2718[i][i_4_] = null;
					if (1 == (aClass226_2713.anIntArray2517[i])) {
						anObjectArrayArray2718[i] = null;
					}
				} else if (anInt2719 * -1870742467 == 2) {
					anObjectArrayArray2718[i] = null;
				}
			}
			return is_6_;
	...
	public synchronized boolean method2290(int i, int i_7_, int i_8_) {
		try {
			...
			if (anObjectArrayArray2718[i] != null && anObjectArrayArray2718[i][i_7_] != null) {
				return true;
			}
			if (anObjectArray2717[i] != null) {
				return true;
			}
			method2287(i, (byte) 102);
			if (null != anObjectArray2717[i]) {
				return true;
			}
			return false;
		} catch (RuntimeException runtimeexception) {
	...
	public synchronized boolean method2292(int i) {
		try {
			...
			boolean bool = true;
			for (int i_10_ = 0; i_10_ < (aClass226_2713.anIntArray2518).length; i_10_++) {
				int i_11_ = (aClass226_2713.anIntArray2518[i_10_]);
				if (anObjectArray2717[i_11_] == null) {
					method2287(i_11_, (byte) 10);
					if (null == anObjectArray2717[i_11_]) {
						bool = false;
					}
				}
			}
	...
	public synchronized int method2293(byte i) {
		try {
			...
			int i_12_ = 0;
			int i_13_ = 0;
			for (int i_14_ = 0; i_14_ < anObjectArray2717.length; i_14_++) {
				if ((aClass226_2713.anIntArray2525[i_14_]) > 0) {
					i_12_ += 100;
	...
	public synchronized byte[] method2294(int i, byte i_16_) {
		try {
			...
			if ((aClass226_2713.anIntArray2517).length == 1) {
				return getFileFromArchive(0, i, (byte) -42);
			}
			if (!method2309(i, (byte) 1)) {
				return null;
			}
			if (aClass226_2713.anIntArray2517[i] == 1) {
				return getFileFromArchive(i, 0, (byte) -48);
			}
			throw new RuntimeException();
		} catch (RuntimeException runtimeexception) {
	...
	public boolean method2295(String string, int i) {
		try {
			...
			int i_17_ = (aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -1973803814), 867865737));
			if (i_17_ < 0) {
				return false;
			}
			return true;
	...
	public int method2296(int i) {
		try {
			...
			return (aClass226_2713.anIntArray2517).length;
		} catch (RuntimeException runtimeexception) {
	...
	public synchronized void method2297(int i, int i_18_) {
		try {
			if (method2309(i, (byte) 1)) {
				if (anObjectArrayArray2718 != null) {
					anObjectArrayArray2718[i] = null;
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	public void method2298(boolean bool, boolean bool_19_, int i) {
		try {
			if (method2284(843198070)) {
				if (bool) {
					aClass226_2713.anIntArray2519 = null;
					aClass226_2713.aClass112_2520 = null;
				}
				if (bool_19_) {
					aClass226_2713.anIntArrayArray2523 = null;
					aClass226_2713.aClass112Array2528 = null;
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	public CacheIndex(Class242 class242, boolean bool, int i) {
		...
		aClass242_2720 = class242;
		aBoolean2715 = bool;
		anInt2719 = -98387179 * i;
	}
	...
	public int method2299(int i, int i_20_) {
		try {
			...
			int i_21_ = aClass226_2713.aClass112_2520.method1239(i, 1079998267);
	...
	public boolean method2300(String string, String string_22_, byte i) {
		try {
			...
			int i_23_ = (aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -1984349791), 728033014));
			if (i_23_ < 0) {
				return false;
			}
			int i_24_ = (aClass226_2713.aClass112Array2528[i_23_].method1239(Class244.method2328(string_22_, -2081152646), 2090644563));
			if (i_24_ < 0) {
				return false;
			}
			return true;
	...
	public synchronized byte[] method2301(String string, String string_25_, int i) {
		try {
			...
			int i_26_ = (aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -1961901970), 1404802795));
			if (!method2309(i_26_, (byte) 1)) {
				return null;
			}
			int i_27_ = (aClass226_2713.aClass112Array2528[i_26_].method1239(Class244.method2328(string_25_, -2059879258), 838109915));
			return getFileFromArchive(i_26_, i_27_, (byte) -34);
		} catch (RuntimeException runtimeexception) {
	...
	boolean method2302(String string, String string_28_, int i) {
		try {
			...
			int i_29_ = (aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -2027002851), 906979105));
			if (!method2309(i_29_, (byte) 1)) {
				return false;
			}
			int i_30_ = (aClass226_2713.aClass112Array2528[i_29_].method1239(Class244.method2328(string_28_, -2028561031), 2121455333));
	...
	synchronized int method2303(int i, byte i_31_) {
		try {
			...
			return aClass242_2720.method2253(i, 65535);
		} catch (RuntimeException runtimeexception) {
	...
	public void method2304(String string, int i) {
		try {
			if (method2284(1339347995)) {
				string = string.toLowerCase();
				int i_32_ = (aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -2097971535), 1493933726));
	...
	public int method2305(String string, int i) {
		try {
			...
			string = string.toLowerCase();
			int i_33_ = (aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -2069451291), 96817353));
	...
	synchronized boolean method2306(int i, int i_34_, int[] is, byte i_35_) {
		try {
			...
			int i_36_ = (aClass226_2713.anIntArray2525[i]);
			int[] is_37_ = (aClass226_2713.anIntArrayArray2526[i]);
			if (null == anObjectArrayArray2718[i]) {
				anObjectArrayArray2718[i] = new Object[(aClass226_2713.anIntArray2517[i])];
			}
			Object[] objects = anObjectArrayArray2718[i];
			boolean bool = true;
			...
			if (null != is && (0 != is[0] || is[1] != 0 || is[2] != 0 || 0 != is[3])) {
				is_40_ = Class338.method4114((anObjectArray2717[i]), true, -858479492);
	...
	public synchronized int[] getFileIds(int i, int i_71_) {
		try {
			if (!method2309(i, (byte) 1)) {
				return null;
			}
			int[] is = (aClass226_2713.anIntArrayArray2526[i]);
			if (is == null) {
				is = new int[(aClass226_2713.anIntArray2525[i])];
	...
	synchronized boolean method2308(int i, int i_73_, int[] is) {
		...
		int i_74_ = aClass226_2713.anIntArray2525[i];
		int[] is_75_ = (aClass226_2713.anIntArrayArray2526[i]);
		if (null == anObjectArrayArray2718[i]) {
			anObjectArrayArray2718[i] = new Object[(aClass226_2713.anIntArray2517[i])];
		}
		Object[] objects = anObjectArrayArray2718[i];
		...
		byte[] is_78_;
		if (null != is && (0 != is[0] || is[1] != 0 || is[2] != 0 || 0 != is[3])) {
			is_78_ = Class338.method4114(anObjectArray2717[i], true, -1017882504);
			...
			is_78_ = Class338.method4114(anObjectArray2717[i], false, 959051680);
		}
		byte[] is_79_;
		try {
	...
	synchronized boolean method2309(int i, byte i_109_) {
		try {
			...
			if (i < 0 || i >= (aClass226_2713.anIntArray2517).length || 0 == (aClass226_2713.anIntArray2517[i])) {
				if (aBoolean2721) {
	...
	public synchronized boolean method2310(int i, int i_110_) {
		try {
			...
			if (1 == (aClass226_2713.anIntArray2517).length) {
	...
	public int getArchiveIdByName(String string, int i) {
		try {
			...
			string = string.toLowerCase();
			int i_111_ = (aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -2067562497), 403552753));
	...
	public boolean method2312(String string, int i) {
		try {
			...
			string = string.toLowerCase();
			int i_112_ = (aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -2120237955), 187766103));
	...
	synchronized boolean method2314(int i, int i_114_, int[] is) {
		...
		int i_115_ = aClass226_2713.anIntArray2525[i];
		int[] is_116_ = (aClass226_2713.anIntArrayArray2526[i]);
		if (null == anObjectArrayArray2718[i]) {
			anObjectArrayArray2718[i] = new Object[(aClass226_2713.anIntArray2517[i])];
		}
		Object[] objects = anObjectArrayArray2718[i];
		...
		byte[] is_119_;
		if (null != is && (0 != is[0] || is[1] != 0 || is[2] != 0 || 0 != is[3])) {
			is_119_ = Class338.method4114(anObjectArray2717[i], true, 1730830793);
			...
			is_119_ = Class338.method4114(anObjectArray2717[i], false, 235085962);
		}
		byte[] is_120_;
		try {
	...
	public byte[] getFileFromArchive(int i, int i_150_, byte i_151_) {
		try {
	...
	public int method2316(int i, int i_152_) {
		try {
			...
			return (aClass226_2713.anIntArray2517[i]);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("ke.h(").append(')').toString());
		}
	}

	static final void method2317(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static final void method2318(ClientScript2 class403, int i) {
		try {
			class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) (Class122.method1319((byte) 1) / 86400000L) - 11745;
		} catch (RuntimeException runtimeexception) {
