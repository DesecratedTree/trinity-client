...
public class Class298_Sub27 extends Class298 {
	int anInt7363;
	int anInt7364;
	...
	public static void method3105(short i) {
		try {
			Class344.aClass437_3684 = new LinkedArrayList(8);
	...
	static final void method3106(ClientScript2 class403, short i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_1_, (byte) -1);
