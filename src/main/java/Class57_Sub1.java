...
public abstract class Class57_Sub1 extends Class57 {
	...
	SafemodeToolkit aClass_ra_Sub1_9006;
	...
	Class57_Sub1(SafemodeToolkit class_ra_sub1, int i, int i_0_) {
	...
	public abstract void drawSprite(int i, int i_5_, int i_6_, int i_7_, int i_8_);
	...
	boolean method679(float f, float f_43_, float f_44_, float f_45_, float f_46_, float f_47_) {
		...
		if (f_62_ > f_66_)
			f_66_ = f_62_;
		if (f_63_ < (float) (((SafemodeToolkit) (((Class57_Sub1) this).aClass_ra_Sub1_9006)).anInt7974 * -912871679))
			f_63_ = (float) (((SafemodeToolkit) (((Class57_Sub1) this).aClass_ra_Sub1_9006)).anInt7974 * -912871679);
		if (f_64_ > (float) (((SafemodeToolkit) (((Class57_Sub1) this).aClass_ra_Sub1_9006)).anInt7991 * -1416794725))
			f_64_ = (float) (((SafemodeToolkit) (((Class57_Sub1) this).aClass_ra_Sub1_9006)).anInt7991 * -1416794725);
		if (f_65_ < (float) (((SafemodeToolkit) (((Class57_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805))
			f_65_ = (float) (((SafemodeToolkit) (((Class57_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805);
		if (f_66_ > (float) (((SafemodeToolkit) (((Class57_Sub1) this).aClass_ra_Sub1_9006)).anInt7977 * 63686679))
			f_66_ = (float) (((SafemodeToolkit) (((Class57_Sub1) this).aClass_ra_Sub1_9006)).anInt7977 * 63686679);
		f_64_ = f_63_ - f_64_;
		if (f_64_ >= 0.0F)
			return false;
		f_66_ = f_65_ - f_66_;
		if (f_66_ >= 0.0F)
			return false;
		anInt9020 = (((SafemodeToolkit) ((Class57_Sub1) this).aClass_ra_Sub1_9006).anInt7971) * 692106883;
	...
	public void method660(int i, int i_150_, int i_151_, int i_152_, int i_153_, int i_154_, int i_155_) {
		...
		((Class57_Sub1) this).aClass_ra_Sub1_9006.o((((SafemodeToolkit) ((Class57_Sub1) this).aClass_ra_Sub1_9006).anInt7974) * -912871679, (((SafemodeToolkit) ((Class57_Sub1) this).aClass_ra_Sub1_9006).anInt7976) * -1278653805, i + i_151_, i_150_ + i_152_);
		...
		for (int i_160_ = 0; i_160_ < i_159_; i_160_++) {
			...
			for (int i_162_ = 0; i_162_ < i_158_; i_162_++)
				drawSprite(i + i_162_ * i_156_, i_150_ + i_161_, i_153_, i_154_, i_155_);
		}
	...
	public void method661(int i, int i_163_, int i_164_, int i_165_, int i_166_, int i_167_, int i_168_) {
		...
		if (((Class57_Sub1) this).anIntArray9017 == null)
			((Class57_Sub1) this).anIntArray9017 = new int[4];
		((Class57_Sub1) this).aClass_ra_Sub1_9006.qa(((Class57_Sub1) this).anIntArray9017);
		((Class57_Sub1) this).aClass_ra_Sub1_9006.o((((SafemodeToolkit) ((Class57_Sub1) this).aClass_ra_Sub1_9006).anInt7974) * -912871679, (((SafemodeToolkit) ((Class57_Sub1) this).aClass_ra_Sub1_9006).anInt7976) * -1278653805, i + i_164_, i_163_ + i_165_);
		...
		for (int i_173_ = 0; i_173_ < i_172_; i_173_++) {
			...
			for (int i_175_ = 0; i_175_ < i_171_; i_175_++)
				drawSprite(i + i_175_ * i_169_, i_163_ + i_174_, i_166_, i_167_, i_168_);
		}
		((Class57_Sub1) this).aClass_ra_Sub1_9006.r(((Class57_Sub1) this).anIntArray9017[0], ((Class57_Sub1) this).anIntArray9017[1], ((Class57_Sub1) this).anIntArray9017[2], ((Class57_Sub1) this).anIntArray9017[3]);
	}
	...
	public void method662(int i, int i_228_, int i_229_, int i_230_, int i_231_, int i_232_, int i_233_) {
		...
		if (((Class57_Sub1) this).anIntArray9017 == null)
			((Class57_Sub1) this).anIntArray9017 = new int[4];
		((Class57_Sub1) this).aClass_ra_Sub1_9006.qa(((Class57_Sub1) this).anIntArray9017);
		((Class57_Sub1) this).aClass_ra_Sub1_9006.o((((SafemodeToolkit) ((Class57_Sub1) this).aClass_ra_Sub1_9006).anInt7974) * -912871679, (((SafemodeToolkit) ((Class57_Sub1) this).aClass_ra_Sub1_9006).anInt7976) * -1278653805, i + i_229_, i_228_ + i_230_);
		...
		for (int i_238_ = 0; i_238_ < i_237_; i_238_++) {
			...
			for (int i_240_ = 0; i_240_ < i_236_; i_240_++)
				drawSprite(i + i_240_ * i_234_, i_228_ + i_239_, i_231_, i_232_, i_233_);
		}
		((Class57_Sub1) this).aClass_ra_Sub1_9006.r(((Class57_Sub1) this).anIntArray9017[0], ((Class57_Sub1) this).anIntArray9017[1], ((Class57_Sub1) this).anIntArray9017[2], ((Class57_Sub1) this).anIntArray9017[3]);
	}
