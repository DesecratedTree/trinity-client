...
public class Class145 implements Interface5 {
	...
	static final void method1589(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.anInt8844 * 827374123;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("fw.ug(").append(')').toString());
		}
	}

	static final void method1590(ClientScript2 class403, int i) {
		try {
			if (client.anInt8942 * 1131012101 == 0)
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = -548972447 * client.anInt8952;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("fw.wl(").append(')').toString());
		}
	}

	static final void method1591(ClientScript2 class403, int i) {
		try {
			int i_0_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (((ClientScript2) class403).aClass298_Sub25_5237.aClass163Array7359[i_0_].anInt1682) * -1333059205;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("fw.yb(").append(')').toString());
		}
	}

	static final void method1592(ClientScript2 class403, byte i) {
		try {
			int i_1_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) (Math.random() * (double) (i_1_ + 1));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("fw.yg(").append(')').toString());
		}
	}

	static final void method1593(ClientScript2 class403, byte i) {
		try {
			...
			if (class298_sub37_sub8.anIntArray9598 == null)
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = class298_sub37_sub8.anIntArray9598.length;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("fw.acm(").append(')').toString());
		}
	}

	static final void method1594(ClientScript2 class403, byte i) {
		try {
			Class390 class390 = (((ClientScript2) class403).aBoolean5261 ? ((ClientScript2) class403).aClass390_5247 : ((ClientScript2) class403).aClass390_5246);
			WidgetConfig class105 = ((Class390) class390).aClass105_4168;
			Class119 class119 = ((Class390) class390).aClass119_4167;
			FloorOverlay.method4606(class105, class119, class403, -919451749);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("fw.ej(").append(')').toString());
		}
	}

	static final void method1595(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static final void method1596(ClientScript2 class403, int i) {
		try {
			Class390 class390 = (((ClientScript2) class403).aBoolean5261 ? ((ClientScript2) class403).aClass390_5247 : ((ClientScript2) class403).aClass390_5246);
			WidgetConfig class105 = ((Class390) class390).aClass105_4168;
			Class119 class119 = ((Class390) class390).aClass119_4167;
	...
	static boolean method1597(GraphicsToolkit class_ra, int i, int i_3_) {
		try {
			...
			for (int i_20_ = i_7_; i_20_ < i_4_ + i_7_; i_20_ += i_6_) {
				for (int i_21_ = i_8_; i_21_ < i_5_ + i_8_; i_21_ += i_6_) {
					...
					if (!Class3.aBoolean55) {
						...
						if (Class3.aBoolean64) {
							Class384.aClass57_4127.drawSprite(256, 0);
							try {
								class_ra.swapBuffers((byte) -97);
			...
			Class3.anInt67 = 0;
			Class3.aClass453_61.clear((byte) 1);
			if (!Class3.aBoolean65) {
					...
					for (int i_43_ = i_8_; i_43_ < i_5_ + i_8_; i_43_++) {
						for (int i_44_ = i; i_44_ <= 1 + i && i_44_ <= 3; i_44_++) {
							if (class244.method2321(i, i_44_, i_42_, i_43_, (byte) -65)) {
								...
								if (interface3 == null)
									interface3 = ((Interface3) (class331.method4035(i_44_, i_42_, i_43_, client.anInterface17_8960, -858481229)));
								if (interface3 == null)
								...
								if (interface3 != null) {
									ObjectConfig class432 = (class433.getObjectDefinitions(interface3.method32((byte) -27)));
									if (class432.aBoolean5434 && !client.isMemberWorld) {
										if (i_3_ != 1177065502) {
											/* empty */
										}
									} else {
										int mapIconID = -1422593103 * class432.mapIconID;
										if (null != class432.toObjectIDs) {
											for (int i_46_ = 0; (i_46_ < (class432.toObjectIDs).length); i_46_++) {
												if ((class432.toObjectIDs[i_46_]) != -1) {
													ObjectConfig class432_47_ = (class433.getObjectDefinitions((class432.toObjectIDs[i_46_])));
													if ((class432_47_.mapIconID * -1422593103) >= 0)
														mapIconID = (-1422593103 * (class432_47_.mapIconID));
												}
											}
										}
										if (mapIconID >= 0) {
											...
											if (mapIconID >= 0) {
												Class352 class352 = (Class363.aClass339_3931.method4116(mapIconID, -718907138));
				...
				if (null != class296) {
					...
					for (int i_56_ = 0; i_56_ < class296.anInt3169 * -1407078377; i_56_++) {
						...
						if ((Class287.myPlayer.plane) == i_57_ >> 28) {
							int i_58_ = ((i_57_ >> 14 & 0x3fff) - class341.gameSceneBaseX * -1760580017);
							int i_59_ = ((i_57_ & 0x3fff) - class341.gameSceneBaseY * 283514611);
							if (i_58_ >= 0 && i_58_ < i_4_ && i_59_ >= 0 && i_59_ < i_5_)
								Class3.aClass453_61.add(new IntegerValue(i_56_), 1131322080);
							else {
								Class352 class352 = (Class363.aClass339_3931.method4116(class296.anIntArray3170[i_56_], -1340224758));
								if (null != class352.anIntArray3803 && (i_58_ + 968926443 * class352.anInt3793 >= 0)) {
									if (i_58_ + 1281846757 * class352.anInt3804 >= i_4_) {
										...
										if (i_59_ + (class352.anInt3805 * -1901940595) >= i_5_) {
											...
											Class3.aClass453_61.add(new IntegerValue(i_56_), 1459840700);
									}
								}
							}
						}
