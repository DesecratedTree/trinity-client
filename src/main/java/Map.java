...
public class Map {
	...
	public Map(int i, int i_0_, int i_1_) {
	...
	static final void method4137(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_2_, (byte) -13);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = -749038817 * class105.yOnScreen;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4138(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_3_, (byte) -35);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.opacity * -1993792969;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4141(Entity class365_sub1_sub1_sub2, boolean bool, int i) {
		try {
			StanceConfig class350 = class365_sub1_sub1_sub2.getStanceConfig(1203863612);
			if (2050671733 * class365_sub1_sub1_sub2.anInt10120 == 0) {
				...
				if (class365_sub1_sub1_sub2.aClass438_10078.method5819((byte) -91) && !class365_sub1_sub1_sub2.aClass438_10078.method5826(-65534)) {
					AnimationConfig class391 = class365_sub1_sub1_sub2.aClass438_10078.method5820(295193907);
					...
					if (1888275831 * class365_sub1_sub1_sub2.anInt10125 <= 0 && 0 == class391.resetOnMovement * -882531177) {
						class365_sub1_sub1_sub2.anInt10124 += -248378059;
				...
				for (int i_6_ = 0; i_6_ < class365_sub1_sub1_sub2.currentGraphics.length; i_6_++) {
					if ((class365_sub1_sub1_sub2.currentGraphics[i_6_].id) * -967533709 != -1 && class365_sub1_sub1_sub2.currentGraphics[i_6_].aClass438_569.method5826(-65534)) {
						GraphicsConfig class398 = (Class158_Sub1.aClass389_8568.method4857((class365_sub1_sub1_sub2.currentGraphics[i_6_].id) * -967533709, -1879864965));
						if (class398.aBoolean5215 && class398.animation * 1505778629 != -1) {
							AnimationConfig class391 = (Class501.aClass395_6122.method4903(1505778629 * class398.animation, (byte) -112));
							...
							if ((class365_sub1_sub1_sub2.anInt10125 * 1888275831) <= 0 && 0 == class391.resetOnMovement * -882531177) {
								class365_sub1_sub1_sub2.anInt10124 += -248378059;
								Class331.anInt3565 = (Class282.aClass282_6543.aByte6542 * -2059464589);
								Class431.anInt6504 = 0;
								return;
				...
				if (!bool && (i_9_ - i_7_ > 1024 || i_9_ - i_7_ < -1024 || i_10_ - i_8_ > 1024 || i_10_ - i_8_ < -1024)) {
					...
					if (class365_sub1_sub1_sub2 instanceof NPC)
						bool_13_ = (((NPC) class365_sub1_sub1_sub2).config.opcode109V);
					if (bool_13_) {
					...
					if (i_9_ != i_7_ || i_10_ != i_8_) {
						...
						if (i_8_ < i_10_) {
							class217.y += (float) i_12_;
							Class431.anInt6504 = 1633205647 * (236175727 * Class431.anInt6504 | 0x1);
							if (class217.y > (float) i_10_)
								class217.y = (float) i_10_;
						} else if (i_8_ > i_10_) {
							class217.y -= (float) i_12_;
						...
						class365_sub1_sub1_sub2.setPosition(class217);
						if (i_12_ >= 32)
						...
						Class331.anInt3565 = Class282.aClass282_6543.aByte6542 * -2059464589;
					if ((int) class217.x == i_9_ && (int) class217.y == i_10_) {
						class365_sub1_sub1_sub2.anInt10120 -= -1013322787;
						if (1888275831 * class365_sub1_sub1_sub2.anInt10125 > 0)
							class365_sub1_sub1_sub2.anInt10125 -= -1479140281;
					}
	...
	static void method4142(int i, int i_21_, WidgetConfig class105, int i_22_) {
		try {
			...
			if (client.displayFPS) {
				...
				i_24_ += 15;
				long l_28_ = ((Class25) client.aClass25_8711).aClass124_340.method1384(1026179047);
				String string = "N/A";
				if (-1L != l_28_) {
				...
				Class343.aClass264_3673.method2474(new StringBuilder().append("Game: In:").append(-1705791507 * ((Class25) client.aClass25_8711).anInt343).append("B/s ").append("Out:").append(((Class25) client.aClass25_8711).anInt327 * 1114720205).append("B/s ").append("Ping:").append(string).toString(), i_23_, i_24_, -256, -1, (byte) -47);
				i_24_ += 15;
				long l_29_ = ((Class25) client.aClass25_8693).aClass124_340.method1384(529918549);
				...
				Class343.aClass264_3673.method2474(new StringBuilder().append("Lobby: In:").append(((Class25) client.aClass25_8693).anInt343 * -1705791507).append("B/s ").append("Out:").append(1114720205 * ((Class25) client.aClass25_8693).anInt327).append("B/s ").append("Ping:").append(string_30_).toString(), i_23_, i_24_, -256, -1, (byte) -30);
				i_24_ += 15;
				int i_31_ = FloorOverlay.graphics.za() / 1024;
				...
				long i_33_ = 0;
				long i_34_ = 0;
				for (int i_35_ = 0; i_35_ < FloorOverlay.aClass242_Sub1Array4072.length; i_35_++) {
					if (FloorOverlay.aClass242_Sub1Array4072[i_35_] == null) {
						if (i_22_ == -1583970959)
							return;
					} else {
						i_32_ += FloorOverlay.aClass242_Sub1Array4072[i_35_].method2279(-2104328128);
						i_33_ += FloorOverlay.aClass242_Sub1Array4072[i_35_].method2274((byte) 1);
						i_34_ += FloorOverlay.aClass242_Sub1Array4072[i_35_].method2275(-856500842);
					}
				}
				long i_36_ = i_34_ * 100 / i_32_;
				long i_37_ = 10000 * i_33_ / i_32_;
				...
				Class298_Sub46.aClass264_7534.method2474(string_38_, i_23_, i_24_, -256, -1, (byte) -26);
				i_24_ += 12;
			}
		} catch (RuntimeException runtimeexception) {
	...
	public static void method4144(int i, int i_43_, int i_44_, int i_45_, short i_46_) {
		try {
			...
			for (Class298_Sub41 class298_sub41 = ((Class298_Sub41) Class298_Sub41.aClass453_7455.method5939(1766612795)); null != class298_sub41; class298_sub41 = ((Class298_Sub41) Class298_Sub41.aClass453_7455.method5944(49146))) {
				int i_47_ = 1;
				StanceConfig class350 = ((Class298_Sub41) class298_sub41).aClass365_Sub1_Sub1_Sub2_Sub1_7433.getStanceConfig(-1185806146);
				...
				if (-1 == i_48_ || (((Class298_Sub41) class298_sub41).aClass365_Sub1_Sub1_Sub2_Sub1_7433.aBoolean10094))
					i_47_ = 0;
				else if (230243963 * class350.runAnimation == i_48_ || class350.anInt3749 * 491753731 == i_48_ || -783166629 * class350.anInt3724 == i_48_ || i_48_ == class350.anInt3746 * -2054940183)
					i_47_ = 2;
				...
				if (i_47_ != (974385733 * ((Class298_Sub41) class298_sub41).anInt7439)) {
					...
					NPCConfig class503 = (((Class298_Sub41) class298_sub41).aClass365_Sub1_Sub1_Sub2_Sub1_7433.config);
				...
				((Class298_Sub41) class298_sub41).anInt7425 = -7217919 * (int) class217.x;
				((Class298_Sub41) class298_sub41).anInt7427 = ((int) class217.x + (((Class298_Sub41) class298_sub41).aClass365_Sub1_Sub1_Sub2_Sub1_7433.getSize() << 8)) * 305826635;
				((Class298_Sub41) class298_sub41).anInt7423 = 584186023 * (int) class217.y;
				((Class298_Sub41) class298_sub41).anInt7428 = ((int) class217.y + (((Class298_Sub41) class298_sub41).aClass365_Sub1_Sub1_Sub2_Sub1_7433.getSize() << 8)) * -1647445571;
			...
			for (Class298_Sub41 class298_sub41 = ((Class298_Sub41) Class298_Sub41.aClass437_7440.method5816(2005558160)); class298_sub41 != null; class298_sub41 = (Class298_Sub41) Class298_Sub41.aClass437_7440.method5815((byte) -39)) {
				int i_50_ = 1;
				StanceConfig class350 = ((Class298_Sub41) class298_sub41).aClass365_Sub1_Sub1_Sub2_Sub2_7434.getStanceConfig(1149258153);
				...
				if (-1 == i_51_ || (((Class298_Sub41) class298_sub41).aClass365_Sub1_Sub1_Sub2_Sub2_7434.aBoolean10094))
					i_50_ = 0;
				else if (i_51_ == 230243963 * class350.runAnimation || i_51_ == 491753731 * class350.anInt3749 || i_51_ == class350.anInt3724 * -783166629 || i_51_ == -2054940183 * class350.anInt3746)
					i_50_ = 2;
				...
				if (i_50_ != (((Class298_Sub41) class298_sub41).anInt7439 * 974385733)) {
					...
					if (i_52_ != (((Class298_Sub41) class298_sub41).anInt7443 * 391847895) || (((Class298_Sub41) class298_sub41).aBoolean7444 != (((Class298_Sub41) class298_sub41).aClass365_Sub1_Sub1_Sub2_Sub2_7434.aBoolean10196))) {
						boolean bool = false;
						if ((((Class298_Sub41) class298_sub41).aClass298_Sub19_Sub2_7447) != null) {
							((Class298_Sub41) class298_sub41).anInt7449 -= 584623616;
							if ((43235291 * ((Class298_Sub41) class298_sub41).anInt7449) <= 0) {
						...
						if (bool) {
							...
							((Class298_Sub41) class298_sub41).aBoolean7444 = (((Class298_Sub41) class298_sub41).aClass365_Sub1_Sub1_Sub2_Sub2_7434.aBoolean10196);
				...
				((Class298_Sub41) class298_sub41).anInt7425 = -7217919 * (int) class217.x;
				((Class298_Sub41) class298_sub41).anInt7427 = ((int) class217.x + (((Class298_Sub41) class298_sub41).aClass365_Sub1_Sub1_Sub2_Sub2_7434.getSize() << 8)) * 305826635;
				((Class298_Sub41) class298_sub41).anInt7423 = 584186023 * (int) class217.y;
				((Class298_Sub41) class298_sub41).anInt7428 = ((int) class217.y + (((Class298_Sub41) class298_sub41).aClass365_Sub1_Sub1_Sub2_Sub2_7434.getSize() << 8)) * -1647445571;
