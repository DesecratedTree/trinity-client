...
public class Class376 {
	...
	void method4656(RsByteBuffer class298_sub53, int i, int i_1_) {
		try {
			if (i == 1)
				aChar4085 = Class493.method6190(class298_sub53.readByte(), 2024016549);
			else if (i == 2) {
	...
	static final void method4658(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub2_7547.method5629(-460328639) == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
	...
	public static void method4659(int i, int i_4_) {
		try {
			if (Class400.method4931((byte) 56)) {
				...
				client.aClass25_8693.method384((byte) 49);
