...
public class Class66_Sub1_Sub1 extends Class66_Sub1 {
	...
	int anInt9090;
	int anInt9091;
	OpenGLLegacyToolkit aClass_ra_Sub2_9092;
	int anInt9093;
	int anInt9094;
	int anInt9095;
		...
		if (((Class66_Sub1_Sub1) this).aClass30_Sub1_9089 == null) {
			...
			for (int i_0_ = 0; i_0_ < 6; i_0_++) {
				if (!interface_ma.method170(anIntArray9096[i_0_], (short) 19541))
					return null;
				TextureConfig class53 = interface_ma.method174(anIntArray9096[i_0_], 179143971);
				int i_1_ = class53.largeTexture ? 64 : 128;
				if (i_1_ > i)
					i = i_1_;
				if (class53.alpha > 0)
					bool = true;
	...
	Class66_Sub1_Sub1(OpenGLLegacyToolkit class_ra_sub2, int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
		...
		if (((Class66_Sub1_Sub1) this).aClass30_Sub1_9089 == null) {
			...
			for (int i_8_ = 0; i_8_ < 6; i_8_++) {
				if (!interface_ma.method170(anIntArray9096[i_8_], (short) 24122))
					return null;
				TextureConfig class53 = interface_ma.method174(anIntArray9096[i_8_], 730950560);
				int i_9_ = class53.largeTexture ? 64 : 128;
				if (i_9_ > i)
					i = i_9_;
				if (class53.alpha > 0)
					bool = true;
