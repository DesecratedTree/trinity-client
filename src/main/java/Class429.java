...
public class Class429 implements Interface21 {
	...
	static final void method5757(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub2_7547.method5628((byte) 103) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("rt.ans(").append(')').toString());
		}
	}

	static final void method5758(WidgetConfig class105, ClientScript2 class403, int i) {
		try {
			if (client.method2801(class105).method3492((byte) -12) && null == client.aClass105_8652) {
				Class117.method1280(class105.uid * -440872681, class105.anInt1154 * -1309843523, 1723723267);
				client.aClass105_8652 = Class140.method1558(-440872681 * class105.uid, class105.anInt1154 * -1309843523, -156511736);
	...
	public static Class25 method5760(short i) {
		try {
			if (Class299.method3682(-1233866115 * client.anInt8752, 1765230881))
				return client.aClass25_8693;
			return client.aClass25_8711;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method5761(GraphicsToolkit class_ra, Interface_ma interface_ma, byte i) {
		try {
			if (null != Class301_Sub1.currentArea) {
				Class122.method1319((byte) 1);
				Class122.method1319((byte) 1);
				if (Class301_Sub1.anInt7624 * -1289394455 < 10) {
					if (!Class301_Sub1.worldMapIndex.method2312(Class301_Sub1.currentArea.fileName, -2140139718)) {
						Class301_Sub1.anInt7624 = (Class_v.index_23_worldMap.method2305((Class301_Sub1.currentArea.fileName), -1210672889)) / 10 * 1078186329;
						return;
					}
				...
				if (10 == Class301_Sub1.anInt7624 * -1289394455) {
					Class301_Sub1.baseX = (Class301_Sub1.currentArea.fromX * 1364716801) >> 6 << 6;
					Class301_Sub1.baseY = (1345239131 * (Class301_Sub1.currentArea.fromY) >> 6 << 6);
					Class301_Sub1.mapWidth = ((Class301_Sub1.currentArea.toX * -2052483955) >> 6 << 6) - Class301_Sub1.baseX + 64;
					Class301_Sub1.mapHeight = 64 + (((Class301_Sub1.currentArea.toY) * 929385381 >> 6 << 6) - Class301_Sub1.baseY);
					int[] is = new int[3];
					int i_7_ = -1;
					int i_8_ = -1;
					...
					if (Class301_Sub1.currentArea.method3453(Class287.myPlayer.plane, (((int) class217.x >> 9) + -1760580017 * class341.gameSceneBaseX), (283514611 * class341.gameSceneBaseY + ((int) class217.y >> 9)), is, 46106083)) {
						i_7_ = is[1] - Class301_Sub1.baseX;
						i_8_ = is[2] - Class301_Sub1.baseY;
					}
					if (!Class301_Sub1.aBoolean7631 && i_7_ >= 0 && i_7_ < Class301_Sub1.mapWidth && i_8_ >= 0 && i_8_ < Class301_Sub1.mapHeight) {
						...
						Class301_Sub1.currentArea.method3452(1646852571 * Class301_Sub1.anInt7629, Class301_Sub1.anInt7623 * 679054909, is, -1594439812);
						if (null != is) {
							Class82_Sub14.anInt6875 = -2076584633 * (is[1] - Class301_Sub1.baseX);
							Class376.anInt4090 = ((is[2] - Class301_Sub1.baseY) * -435591305);
						}
						Class301_Sub1.anInt7623 = 1505298155;
						Class301_Sub1.anInt7629 = 1801430445;
						Class301_Sub1.aBoolean7631 = false;
					} else {
						Class301_Sub1.currentArea.method3452((Class301_Sub1.currentArea.anInt9644) * -1973484731 >> 14 & 0x3fff, -1973484731 * (Class301_Sub1.currentArea.anInt9644) & 0x3fff, is, -1810513482);
						Class82_Sub14.anInt6875 = (is[1] - Class301_Sub1.baseX) * -2076584633;
						Class376.anInt4090 = (is[2] - Class301_Sub1.baseY) * -435591305;
					}
					if ((1110271707 * Class301_Sub1.currentArea.anInt9645) == 37) {
						Class301_Sub1.aFloat3233 = 3.0F;
						Class301_Sub1.aFloat3234 = 3.0F;
					} else if ((Class301_Sub1.currentArea.anInt9645) * 1110271707 == 50) {
						Class301_Sub1.aFloat3233 = 4.0F;
						Class301_Sub1.aFloat3234 = 4.0F;
					} else if ((Class301_Sub1.currentArea.anInt9645) * 1110271707 == 75) {
						Class301_Sub1.aFloat3233 = 6.0F;
						Class301_Sub1.aFloat3234 = 6.0F;
					} else if (1110271707 * (Class301_Sub1.currentArea.anInt9645) == 100) {
						Class301_Sub1.aFloat3233 = 8.0F;
						Class301_Sub1.aFloat3234 = 8.0F;
					} else if (1110271707 * (Class301_Sub1.currentArea.anInt9645) == 200) {
					...
					JagexFile2.aClass453_5986 = new Class453();
					...
					if (Class301_Sub1.decodeArea(class_ra, Class301_Sub1.anInt3227, Class301_Sub1.anInt3228)) {
					...
					if (Class301_Sub1.worldMapIndex.method2295(new StringBuilder().append(Class301_Sub1.currentArea.fileName).append("_staticelements").toString(), -400372089)) {
						if (!Class301_Sub1.worldMapIndex.method2312(new StringBuilder().append(Class301_Sub1.currentArea.fileName).append("_staticelements").toString(), -2145213052))
							return;
						Class301_Sub1.aClass296_3235 = (Class237.method2192(Class301_Sub1.worldMapIndex, new StringBuilder().append(Class301_Sub1.currentArea.fileName).append("_staticelements").toString(), client.isMemberWorld, 565671699));
					} else
					...
					Shortcut.aClass4_6525 = new Class4(class_ra, 19, true, Class52_Sub2_Sub1.aCanvas9079);
