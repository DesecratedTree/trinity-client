...
final class Class97_Sub1 extends Class97 {
	...
	public static final void method1043(int moveLocalX, int moveLocalY, int moveZ, int speed2, int speed1, boolean bool) {
		try {
			...
			if (bool && Class21.anInt276 * 1534163843 >= 100) {
				...
				Class110.anInt6403 = (Class356.getPlayerHeight(-1740717447 * Class367.anInt4000, Class146.anInt1575 * -299812095, 1855729883 * Class99.anInt952, -2087363822) - -1439836243 * Class98_Sub3.anInt6938) * 1078403147;
			}
	...
	public static void method1044(Class298 class298, Class298 class298_5_, int i) {
		try {
			...
			class298.first = class298_5_.first;
			class298.last = class298_5_;
	...
	static Class298_Sub37_Sub12 method1045(byte i) {
		try {
			...
			if (class298_sub37_sub12 == null) {
				...
				class298_sub37_sub12.remove(-1460969981);
