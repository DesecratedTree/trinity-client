...
public class Class365_Sub1_Sub5_Sub2 extends Class365_Sub1_Sub5 implements Interface3 {
	...
	Class335 method4370(GraphicsToolkit class_ra) {
		...
		int i_0_ = (int) class235.aClass217_2599.y >> 9;
		...
		if (null == ((Class365_Sub1_Sub5_Sub2) this).aClass334_9934)
			((Class365_Sub1_Sub5_Sub2) this).aClass334_9934 = Class472.method6063((int) class235.aClass217_2599.x, (int) class235.aClass217_2599.aFloat2455, (int) class235.aClass217_2599.y, class387, 2146599220);
		else
			Class264_Sub2.method2507((((Class365_Sub1_Sub5_Sub2) this).aClass334_9934), (int) class235.aClass217_2599.x, (int) class235.aClass217_2599.aFloat2455, (int) class235.aClass217_2599.y, class387, (byte) 1);
		return class335;
	}
	...
	Class335 drawFloor(GraphicsToolkit class_ra, int i) {
		try {
			...
			int i_1_ = (int) class235.aClass217_2599.x >> 9;
			int i_2_ = (int) class235.aClass217_2599.y >> 9;
			...
			((Class365_Sub1_Sub5_Sub2) this).aBoolean9939 = (class387.i() || null != ((Class60) aClass60_9935).aClass351_602);
			if (null == ((Class365_Sub1_Sub5_Sub2) this).aClass334_9934)
				((Class365_Sub1_Sub5_Sub2) this).aClass334_9934 = Class472.method6063((int) (class235.aClass217_2599.x), (int) (class235.aClass217_2599.aFloat2455), (int) (class235.aClass217_2599.y), class387, 1999876467);
			else
				Class264_Sub2.method2507(((Class365_Sub1_Sub5_Sub2) this).aClass334_9934, (int) class235.aClass217_2599.x, (int) class235.aClass217_2599.aFloat2455, (int) class235.aClass217_2599.y, class387, (byte) 127);
			return class335;
		} catch (RuntimeException runtimeexception) {
	...
	void method4357(GraphicsToolkit class_ra, int i) {
		try {
			...
			if (class387 != null) {
				Class222 class222 = method4347();
				Class235 class235 = method4337();
				int i_3_ = (int) class235.aClass217_2599.x >> 9;
	...
	void method4373(GraphicsToolkit class_ra) {
		...
		if (class387 != null) {
			...
			Class235 class235 = method4337();
			int i = (int) class235.aClass217_2599.x >> 9;
			int i_10_ = (int) class235.aClass217_2599.y >> 9;
	...
	public Class365_Sub1_Sub5_Sub2(Class331 class331, GraphicsToolkit class_ra, Class433 class433, ObjectConfig class432, int i, int i_11_, int i_12_, int i_13_, int i_14_, boolean bool, int i_15_, int i_16_, int i_17_) {
		super(class331, i_12_, i_13_, i_14_, i, i_11_, Shortcut.method4263(i_15_, i_16_, (byte) -51));
		aClass60_9935 = new Class60(class_ra, class433, class432, i_15_, i_16_, plane, i_11_, this, bool, i_17_);
		((Class365_Sub1_Sub5_Sub2) this).aBoolean9936 = 0 != 1532834983 * class432.optionType && !bool;
	...
	public static void method4533(int i, String string, boolean bool, short i_26_) {
		try {
			while_108_: do {
				if (i == 0) {
					if (FloorOverlay.graphics != null)
						FloorOverlay.graphics.dispose(0);
					FloorOverlay.graphics = Class523.method6334(0, Class52_Sub2_Sub1.aCanvas9079, Class253.anInterface_ma2785, Class82_Sub6.aClass243_6844, Class422_Sub25.preferences.antialiasing.method5675(-497177413) * 2, -659449737);
					if (null != string) {
						FloorOverlay.graphics.ba(1, 0);
						Class505 class505 = Class322.method3931(Class173.aClass243_1758, (Class74.anInt690 * 1178461027), 0, (byte) 84);
						Class264 class264 = (FloorOverlay.graphics.method5092(class505, Class89.getSprites(Class158.aClass243_6364, (1178461027 * Class74.anInt690), 0), true));
						Class148.method1614((byte) 42);
						Class139.drawText(string, true, FloorOverlay.graphics, class264, class505, (byte) -38);
					}
				} else {
					...
					if (null != string) {
						...
						Class264 class264 = (class_ra.method5092(class505, Class89.getSprites(Class158.aClass243_6364, (Class74.anInt690 * 1178461027), 0), true));
						Class148.method1614((byte) 9);
						Class139.drawText(string, true, class_ra, class264, class505, (byte) 53);
					}
					do {
						try {
							try {
								if (FloorOverlay.graphics != null)
									FloorOverlay.graphics.dispose(0);
								FloorOverlay.graphics = (Class523.method6334(i, Class52_Sub2_Sub1.aCanvas9079, Class253.anInterface_ma2785, Class82_Sub6.aClass243_6844, Class422_Sub25.preferences.antialiasing.method5675(-1644099824) * 2, 1353555803));
								if (string != null) {
									class_ra.ba(1, 0);
									...
									Class139.drawText(string, true, class_ra, class264, class505, (byte) -21);
								}
								if (FloorOverlay.graphics.method5001()) {
									...
									Class_v class_v;
									if (bool_27_)
										class_v = FloorOverlay.graphics.method5026(146800640);
									else
										class_v = FloorOverlay.graphics.method5026(104857600);
									FloorOverlay.graphics.method5027(class_v);
								}
							} catch (Throwable throwable) {
								int i_28_ = Class422_Sub25.preferences.graphicsMode.method5677(-1530002941);
								if (i_28_ == 2)
									client.aBoolean8662 = true;
								Class422_Sub25.preferences.method3540((Class422_Sub25.preferences.graphicsMode), 0, -1712068885);
			...
			if (bool)
				Class422_Sub25.preferences.method3539(Class422_Sub25.preferences.graphicsMode, !bool, -1907250649);
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.graphicsMode, i, -1004506906);
			if (!bool)
				Class422_Sub25.preferences.method3539(Class422_Sub25.preferences.graphicsMode, !bool, -1748771368);
			Class513.method6293(-707841245);
			FloorOverlay.graphics.method5169(10000);
			FloorOverlay.graphics.J(32);
			client.aClass283_8716.method2648(-818859939);
			FloorOverlay.graphics.method5047(false);
			if (FloorOverlay.graphics.method5050())
				Class365_Sub1_Sub5_Sub1.method4525(Class422_Sub25.preferences.aClass422_Sub6_7551.method5647(-1411340111) == 1, -1054485931);
			...
			FloorOverlay.graphics.GA(0.0F, 1.0F);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4534(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub5_7572.method5641(-1981564122) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4535(ClientScript2 class403, int i) {
		try {
			...
			if (Class301_Sub1.aClass437_7636 != null) {
				Class298 class298 = Class301_Sub1.aClass437_7636.method5812((long) i_29_);
			...
			//	if (0 == (Class10.aByteArray131[i_32_] & 0x1)) {
				...
				//		Class10.aByteArray131[i_32_] |= 0x2;
					...
					//		Class10.aByteArray131[i_32_] |= 0x2;
							...
							ClientScriptEnums.method6221(class298_sub53_sub2, i_32_, -1265435014);
					}
				//}
			}
				...
				if (0 != (Class10.aByteArray131[i_35_] & 0x1)) {
					if (i_30_ > 0) {
						...
						if (i_36_ == 0) {
							...
							ClientScriptEnums.method6221(class298_sub53_sub2, i_35_, -1556347349);
					}
				}
			}
