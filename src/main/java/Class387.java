...
public abstract class Class387 {
	...
	public final void method4735(Class298_Sub37_Sub4 class298_sub37_sub4, int i, Class298_Sub37_Sub4 class298_sub37_sub4_70_, int i_71_, int i_72_, int i_73_, int i_74_, boolean bool) {
		if (i != -1) {
			...
			if (!ea())
				...
				AnimationFrame class96 = (((Class298_Sub37_Sub4) class298_sub37_sub4).aClass96Array9579[i]);
				AnimationFrameBase class298_sub15 = ((AnimationFrame) class96).base;
				...
				if (class298_sub37_sub4_70_ != null) {
					...
					if (((AnimationFrame) class96_75_).base != class298_sub15)
						class96_75_ = null;
				}
			...
			if (bools == null || i_86_ == -1)
				...
				if (!ea())
					...
					if (class298_sub37_sub4_81_ != null) {
						...
						if (((AnimationFrame) class96_91_).base != class298_sub15)
							class96_91_ = null;
					}
					method4767(class298_sub15, class96, class96_91_, i_83_, i_84_, 0, bools, false, bool, 65535, null);
					AnimationFrame class96_92_ = (((Class298_Sub37_Sub4) class298_sub37_sub4_85_).aClass96Array9579[i_86_]);
					...
					if (class298_sub37_sub4_87_ != null) {
						...
						if (((AnimationFrame) class96_93_).base != class298_sub15)
							class96_93_ = null;
					}
					method4738(0, new int[0], 0, 0, 0, 0, bool);
					method4767(((AnimationFrame) class96_92_).base, class96_92_, class96_93_, i_89_, i_90_, 0, bools, true, bool, 65535, null);
					ka();
					method4734();
				}
			}
	...
	public final void method4737(Class298_Sub37_Sub4 class298_sub37_sub4, int i) {
		if (i != -1) {
			...
			if (!ea())
				...
				AnimationFrame class96 = (((Class298_Sub37_Sub4) class298_sub37_sub4).aClass96Array9579[i]);
				AnimationFrameBase class298_sub15 = ((AnimationFrame) class96).base;
				for (int i_94_ = 0; i_94_ < ((AnimationFrame) class96).anInt925; i_94_++) {
					short i_95_ = ((AnimationFrame) class96).aShortArray933[i_94_];
					if (((AnimationFrameBase) class298_sub15).aBooleanArray7275[i_95_]) {
						if (((AnimationFrame) class96).skippedA[i_94_] != -1)
							w(0, 0, 0, 0);
						w((((AnimationFrameBase) class298_sub15).transformationTypes[i_95_]), ((AnimationFrame) class96).aShortArray934[i_94_], ((AnimationFrame) class96).bufferYA[i_94_], ((AnimationFrame) class96).aShortArray936[i_94_]);
					}
				}
				ka();
				method4734();
	...
	public abstract void drawModel(Class222 class222, Class302_Sub1 class302_sub1, int i);
		...
		if (i != -1) {
			...
			if (!ea())
				...
				if (class298_sub37_sub4_191_ != null) {
					...
					if (((AnimationFrame) class96_197_).base != class298_sub15)
						class96_197_ = null;
				}
	...
	void method4766(int type, int[] indices, int i_198_, int i_199_, int i_200_, int i_201_, boolean bool, int i_202_, int[] is_203_) {
		if (i_201_ == 1) {
			if (type == 0 || type == 1) {
				int i_204_ = -i_198_;
				i_198_ = i_200_;
		...
		if (i_202_ != 65535)
			e(type, indices, i_198_, i_199_, i_200_, bool, i_202_, is_203_);
		else
			method4738(type, indices, i_198_, i_199_, i_200_, i_201_, bool);
	}

	void method4767(AnimationFrameBase class298_sub15, AnimationFrame class96, AnimationFrame class96_210_, int i, int i_211_, int i_212_, boolean[] bools, boolean bool, boolean bool_213_, int i_214_, int[] is) {
		if (class96_210_ == null || i == 0) {
			for (int i_215_ = 0; i_215_ < ((AnimationFrame) class96).anInt925; i_215_++) {
				short i_216_ = ((AnimationFrame) class96).aShortArray933[i_215_];
				if (bools == null || bools[i_216_] == bool || (((AnimationFrameBase) class298_sub15).transformationTypes[i_216_]) == 0) {
					short skipV = ((AnimationFrame) class96).skippedA[i_215_];
					if (skipV != -1)
						method4766(0, (((AnimationFrameBase) class298_sub15).anIntArrayArray7279[skipV]), 0, 0, 0, i_212_, bool_213_, i_214_ & (((AnimationFrameBase) class298_sub15).anIntArray7280[skipV]), is);
					method4766((((AnimationFrameBase) class298_sub15).transformationTypes[i_216_]), (((AnimationFrameBase) class298_sub15).anIntArrayArray7279[i_216_]), ((AnimationFrame) class96).aShortArray934[i_215_], ((AnimationFrame) class96).bufferYA[i_215_], ((AnimationFrame) class96).aShortArray936[i_215_], i_212_, bool_213_, i_214_ & (((AnimationFrameBase) class298_sub15).anIntArray7280[i_216_]), is);
				}
			}
		} else {
			int i_218_ = 0;
			int i_219_ = 0;
			for (int i_220_ = 0; (i_220_ < ((AnimationFrameBase) class298_sub15).count * 92429039); i_220_++) {
				boolean bool_221_ = false;
				if (i_218_ < ((AnimationFrame) class96).anInt925 && ((AnimationFrame) class96).aShortArray933[i_218_] == i_220_)
					bool_221_ = true;
				boolean bool_222_ = false;
				if (i_219_ < ((AnimationFrame) class96_210_).anInt925 && (((AnimationFrame) class96_210_).aShortArray933[i_219_] == i_220_))
					bool_222_ = true;
				if (bool_221_ || bool_222_) {
					if (bools != null && bools[i_220_] != bool && (((AnimationFrameBase) class298_sub15).transformationTypes[i_220_]) != 0) {
						if (bool_221_)
							i_218_++;
						if (bool_222_)
							i_219_++;
						...
						int i_223_ = 0;
						int i_224_ = (((AnimationFrameBase) class298_sub15).transformationTypes[i_220_]);
						...
						byte i_229_;
						if (bool_221_) {
							i_225_ = ((AnimationFrame) class96).aShortArray934[i_218_];
							i_226_ = ((AnimationFrame) class96).bufferYA[i_218_];
							i_227_ = ((AnimationFrame) class96).aShortArray936[i_218_];
							i_228_ = ((AnimationFrame) class96).skippedA[i_218_];
							i_229_ = ((AnimationFrame) class96).aByteArray938[i_218_];
							i_218_++;
						} else {
							i_225_ = i_223_;
							i_226_ = i_223_;
						...
						byte i_234_;
						if (bool_222_) {
							i_230_ = (((AnimationFrame) class96_210_).aShortArray934[i_219_]);
							i_231_ = (((AnimationFrame) class96_210_).bufferYA[i_219_]);
							i_232_ = (((AnimationFrame) class96_210_).aShortArray936[i_219_]);
							i_233_ = (((AnimationFrame) class96_210_).skippedA[i_219_]);
							i_234_ = (((AnimationFrame) class96_210_).aByteArray938[i_219_]);
							i_219_++;
						} else {
							i_230_ = i_223_;
							i_231_ = i_223_;
						...
						if (i_228_ != -1)
							method4766(0, (((AnimationFrameBase) class298_sub15).anIntArrayArray7279[i_228_]), 0, 0, 0, i_212_, bool_213_, (i_214_ & (((AnimationFrameBase) class298_sub15).anIntArray7280[i_228_])), is);
						else if (i_233_ != -1)
							method4766(0, (((AnimationFrameBase) class298_sub15).anIntArrayArray7279[i_233_]), 0, 0, 0, i_212_, bool_213_, (i_214_ & (((AnimationFrameBase) class298_sub15).anIntArray7280[i_233_])), is);
						method4766(i_224_, (((AnimationFrameBase) class298_sub15).anIntArrayArray7279[i_220_]), i_235_, i_236_, i_237_, i_212_, bool_213_, i_214_ & (((AnimationFrameBase) class298_sub15).anIntArray7280[i_220_]), is);
					}
				}
			}
		}
	...
	Class76 method4785(Model class64, int[] is, int i) {
		int[] is_276_ = null;
		int[] is_277_ = null;
		int[] is_278_ = null;
		float[][] fs = null;
		if (class64.faces_mapping != null) {
			int i_279_ = class64.num_textures;
			...
			for (int i_287_ = 0; i_287_ < i; i_287_++) {
				...
				if (class64.faces_mapping[i_288_] != -1) {
					int i_289_ = class64.faces_mapping[i_288_] & 0xff;
					for (int i_290_ = 0; i_290_ < 3; i_290_++) {
						short i_291_;
						if (i_290_ == 0)
							i_291_ = class64.faces_a[i_288_];
						else if (i_290_ == 1)
							i_291_ = class64.faces_b[i_288_];
						else
							i_291_ = class64.faces_c[i_288_];
						int i_292_ = class64.vertices_x[i_291_];
						int i_293_ = class64.vertices_y[i_291_];
						int i_294_ = class64.vertices_z[i_291_];
			...
			for (int i_295_ = 0; i_295_ < i_279_; i_295_++) {
				byte i_296_ = class64.textures_mapping[i_295_];
				if (i_296_ > 0) {
					...
					fs[i_295_] = method4731(class64.textures_mapping_p[i_295_], class64.textures_mapping_m[i_295_], class64.textures_mapping_n[i_295_], class64.aByteArray645[i_295_] & 0xff, f, f_297_, f_298_);
				}
			}
		}
