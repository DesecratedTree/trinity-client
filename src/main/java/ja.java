...
public class ja extends GraphicsToolkit implements Interface25 {
	...
	ba aBa6682;
	Matrix aClass233_6683;
	boolean aBoolean6684 = false;
	int anInt6685;
	Matrix aClass233_6686;
	float aFloat6687;
	Class222 aClass222_6688;
	Matrix aClass233_6689;
	Matrix aClass233_6690;
	float aFloat6691;
	int anInt6692;
	...
	void method5068() {
		if (!((ja) this).aBoolean6684) {
			...
			for (ba var_ba = (ba) ((ja) this).aClass453_6680.method5939(1766612795); var_ba != null; var_ba = (ba) ((ja) this).aClass453_6680.method5944(49146))
				var_ba.ha();
			((ja) this).aClass453_6680.clear((byte) 1);
			da();
	...
	public Class_v method5026(int i) {
		...
		((ja) this).aClass453_6680.add(var_ba, 1259364637);
		return var_ba;
	}
	...
	public Class387 method5037(Model class64, int i, int i_194_, int i_195_, int i_196_) {
		return new h(this, ((ja) this).aBa6682, class64, i, i_194_, i_195_, i_196_);
	}
	...
	void swapBuffers(int i, int i_221_) throws Exception_Sub1 {
	...
	public ja(Canvas canvas, Interface_ma interface_ma, int i, int i_238_) {
		...
		try {
			...
			((ja) this).aClass233_6686 = new Matrix();
			new SceneObjectPosition();
			((ja) this).aClass222_6696 = new Class222();
			new Class218();
			((ja) this).aClass233_6689 = new Matrix();
			((ja) this).aClass233_6690 = new Matrix();
			((ja) this).aClass233_6683 = new Matrix();
			method5043(new Class222());
			method5182(new Matrix());
			method5569(1);
			method5570(0);
			if (canvas != null) {
			...
			for (short i_240_ = 0; i_240_ < i_239_; i_240_++) {
				TextureConfig class53 = anInterface_ma5299.method174(i_240_, 1423908475);
				if (class53 != null)
					V(i_240_, class53.aShort532, class53.anInt528 * -2138060883, class53.aByte529, class53.aByte536, class53.anInt531 * 1616831825, class53.largeTexture, class53.aByte533, class53.aByte534, class53.aByte535, class53.aByte509, class53.aBoolean524, class53.aBoolean538, class53.aBoolean527, class53.aBoolean540, class53.aBoolean541, class53.alpha, class53.aBoolean543, class53.aBoolean544, class53.anInt519 * -490972023);
			}
	...
	public Class_v method5102(int i) {
		ba var_ba = new ba(this, i);
		((ja) this).aClass453_6680.add(var_ba, 472280132);
		return var_ba;
	}
	...
	boolean SA(short i) {
		synchronized (anInterface_ma5299) {
			TextureConfig class_cc = anInterface_ma5299.method174(i, 1155250631);
			if (class_cc == null) {
				boolean bool = false;
				return bool;
			}
			...
			F(i, is, class_cc.aShort532, class_cc.anInt528 * -2138060883, class_cc.aByte529, class_cc.aByte536, class_cc.anInt531 * 1616831825, class_cc.largeTexture, class_cc.aByte533, class_cc.aByte534, class_cc.aByte535, class_cc.aByte509, class_cc.aBoolean524, class_cc.aBoolean538, class_cc.aBoolean527, class_cc.aBoolean540, class_cc.aBoolean541, class_cc.alpha, class_cc.aBoolean543, class_cc.aBoolean544, class_cc.anInt519 * -490972023);
		}
		return true;
	}
	...
	public Class387 method5116(Model class64, int i, int i_608_, int i_609_, int i_610_) {
		return new h(this, ((ja) this).aBa6682, class64, i, i_608_, i_609_, i_610_);
	}
