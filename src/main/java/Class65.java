...
public class Class65 {
	...
	public static void method761(Class119 class119, WidgetConfig class105, boolean bool, int i) {
		try {
			Class117.method1282(class119.components, class105, bool, (short) -2046);
		} catch (RuntimeException runtimeexception) {
