...
public class Class441 {
	...
	final boolean method5863(Class395 class395, AnimationConfig class391, int i, int i_0_, int[] is, byte i_1_) {
		try {
	...
	static final void method5865(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
