...
public class Class182 {
	static CachingHashMap aClass348_1815 = new CachingHashMap(64);
	...
	void method1844(RsByteBuffer class298_sub53, int i, short i_1_) {
		try {
			if (1 == i) {
				...
				anInt1847 = class298_sub53.readByte() * -1070610169;
			} else if (5 == i) //intensity
				...
				anInt1850 = class298_sub53.readByte() * 1700476293;
			else if (i == 13)
				anInt1851 = class298_sub53.readByte() * -1620099691;
			else if (14 == i)
				anInt1852 = class298_sub53.readUnsignedShort() * -629947759;
			else if (15 == i) //particle count
		...
		try {
			if (client.anInt8724 * 1596783995 == 3) {
				...
				for (int i_22_ = 0; i_22_ < -1230451913 * client.anInt8703; i_22_++) {
					...
					ObjectValue class298_sub29 = ((ObjectValue) client.aClass437_8696.method5812((long) i_23_));
					if (class298_sub29 != null)
						((Entity) class298_sub29.value).method4441(i, i_13_, i_14_, i_15_, i_16_, i_17_, i_18_, (byte) 12);
				}
			}
		} catch (RuntimeException runtimeexception) {
