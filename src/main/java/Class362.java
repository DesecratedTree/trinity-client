...
public class Class362 {
	...
	public Class369 method4307(int i, int i_0_) {
		try {
			return i >= aClass369Array3915.length ? aClass369Array3915[0] : ((Class362) this).aClass369Array3915[i];
	...
	public Class362(Class411 class411, Class429 class429, CacheIndex class243, boolean bool) {
		...
		if (((Class362) this).aClass243_3917 != null)
			((Class362) this).anInt3916 = (((Class362) this).aClass243_3917.method2316(-1006924897 * ConfigFile.aClass120_1440.anInt1460, -941078932)) * 70760625;
		else
		...
		if (bool) {
			...
			for (int i = 0; i < ((Class362) this).anInt3916 * 1223397457; i++) {
				...
				synchronized (((Class362) this).aClass243_3917) {
					is = (((Class362) this).aClass243_3917.getFileFromArchive(ConfigFile.aClass120_1440.anInt1460 * -1006924897, i, (byte) -67));
				}
