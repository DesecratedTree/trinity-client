...
public class Class356 {
	...
	static final void method4266(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_0_, (byte) 2);
	...
	public static int method4268(int i) {
		try {
			if (588194557 * CacheIndexIndicator.anInt1367 == -1) {
				CacheIndexIndicator[] class111s = Class125.method1399((byte) -111);
				for (int i_1_ = 0; i_1_ < class111s.length; i_1_++) {
					CacheIndexIndicator class111 = class111s[i_1_];
					if (((CacheIndexIndicator) class111).anInt1366 * -1047699439 > 588194557 * CacheIndexIndicator.anInt1367)
						CacheIndexIndicator.anInt1367 = 510332837 * ((CacheIndexIndicator) class111).anInt1366;
				}
				CacheIndexIndicator.anInt1367 += -1700689323;
			}
			return 588194557 * CacheIndexIndicator.anInt1367;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4269(ClientScript2 class403, int i) {
		try {
			...
			int i_2_ = -1;
			int i_3_ = -1;
			Class117 class117 = class105.method1116(FloorOverlay.graphics, 193353438);
			if (class117 != null) {
	...
	static final void method4270(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	public static final int getPlayerHeight(int i, int i_4_, int i_5_, int i_6_) {
		try {
			...
			if (i_7_ < 0 || i_8_ < 0 || i_7_ > client.aClass283_8716.method2629(-1956967905) - 1 || i_8_ > client.aClass283_8716.method2630(1920772834) - 1)
				return 0;
			int i_9_ = i_5_;
			if (i_9_ < 3 && ((client.aClass283_8716.method2654(2001279106).terrainSettings[1][i_7_][i_8_]) & 0x2) != 0)
				i_9_++;
	...
	static final void method4272(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_10_, (byte) 0);
	...
	static final void method4273(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8643 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
