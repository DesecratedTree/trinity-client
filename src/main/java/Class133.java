...
public class Class133 {
	...
	public int method1482(int i, int i_0_, int i_1_) {
		try {
			int i_2_ = (Class298_Sub40_Sub9.screenHeight * -1111710645 > i_0_ ? -1111710645 * Class298_Sub40_Sub9.screenHeight : i_0_);
	...
	static final void method1486(ClientScript2 class403, byte i) {
		try {
			...
			Class298_Sub1.cameraType = -1469516446;
