...
public class Player extends Entity {
	...
	public int combatLevelWithSummoning;
	...
	public Player(Class331 class331, int i) {
		...
		anInt10206 = 0;
		combatLevel = 0;
		combatLevelWithSummoning = 1031683529;
		anInt10205 = 0;
	...
	public final void sendAppearence(RsByteBuffer stream, byte i) {
		try {
			...
			class217.x += (float) (getSize() - i_2_ << 8);
			class217.y += (float) (getSize() - i_2_ << 8);
			setPosition(class217);
			class217.method2006();
			if (bool_3_)
				((Player) this).aString10199 = stream.readJagString(681479919);
			else
				((Player) this).aString10199 = null;
			if (bool_4_)
				((Player) this).aString10197 = stream.readJagString(681479919);
			else
				((Player) this).aString10197 = null;
			anInt10202 = stream.readByte() * 1944760989;
			anInt10201 = stream.readByte() * 218110545;
			hidden = stream.readByte() == 1;
			//before, admin accs could see hidden players, now same as everyone else
		/*	if (Class242.aClass401_2708 == Class401.aClass401_6557 && 1806357379 * client.playerRights >= 2)
			...
			ItemConfig[] class468s = (new ItemConfig[Class82_Sub18.aClass405_6892.anIntArray5267.length]);
			for (int i_6_ = 0; i_6_ < Class82_Sub18.aClass405_6892.anIntArray5267.length; i_6_++) {
				if (1 != Class82_Sub18.aClass405_6892.anIntArray5267[i_6_]) {
					int i_7_ = stream.readInt((byte) 0);//stream.readUnsignedByte();
					if (0 == i_7_)
						is[i_6_] = 0;
					else {
					...
					//	int i_9_ = (i_7_ << 8) + i_8_;
						int i_9_ = i_7_;
						if (i_6_ == 0 && /*65535*/-1 == i_9_) {
							npcID = stream.readBigSmart(1235052657);
							anInt10208 = (stream.readUnsignedByte() * 1076333291);
							break;
						}
						if (i_9_ >= /*32768*/16384) {
							i_9_ = i_9_ - 16384;//Class519.anIntArray6274[i_9_ - 32768];
							is[i_6_] = i_9_ | 0x40000000;
							class468s[i_6_] = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_9_);
							int i_10_ = class468s[i_6_].team * 1832088845;
							if (0 != i_10_)
			...
			if (-1 == npcID) {
				...
				for (int i_13_ = 0; (i_13_ < Class82_Sub18.aClass405_6892.anIntArray5267.length); i_13_++) {
					if (0 != (Class82_Sub18.aClass405_6892.anIntArray5267[i_13_])) {
						...
						if ((i_11_ & 1 << i_12_) != 0)
							class464s[i_13_] = Class401.method4937(class468s[i_13_], stream, (byte) 15);
						i_12_++;
					}
				}
			}
			...
			for (int i_15_ = 0; i_15_ < 10; i_15_++) {
				...
				if (Class22.appearenceColors.length < 1 || color < 0 || (color >= Class22.appearenceColors[i_15_][0].length))
					color = 0;
				colors[i_15_] = color;
			}
			...
			if (bool_1_) {
				...
				combatLevel = anInt10206 * -1911826885;
				combatLevelWithSummoning = 1031683529;
			} else {
				anInt10205 = 0;
				combatLevel = stream.readUnsignedByte() * 1144472333;
				combatLevelWithSummoning = stream.readUnsignedByte() * -1031683529;
				if (255 == combatLevelWithSummoning * 1792775047)
					combatLevelWithSummoning = 1031683529;
			}
			...
			if (0 != 780357347 * anInt10214) {
				...
				if (aBoolean10196 != bool || anInt10214 * 780357347 != i_17_ || 1728220219 * anInt10194 != i_18_ || -1304250511 * anInt10210 != i_19_ || i_20_ != anInt10211 * 1899133595 || i_21_ != -978842273 * anInt10212 || anInt10215 * 933675083 != i_22_)
			...
			aClass366_10209.method4546(getStanceID(-1515602233), is, class464s, colors, 1 == aByte10220, npcID, 775068819);
			if (i_23_ != npcID) {
				class217 = SceneObjectPosition.method2005(method4337().aClass217_2599);
				class217.x = (float) ((scenePositionXQueue[0] << 9) + (getSize() << 8));
				class217.y = (float) ((scenePositionYQueue[0] << 9) + (getSize() << 8));
				setPosition(class217);
				class217.method2006();
			}
			if (client.playerIndex * -442628795 == anInt10064 * 1888274983 && null != is_24_) {
				for (int i_25_ = 0; i_25_ < colors.length; i_25_++) {
					if (is_24_[i_25_] != colors[i_25_]) {
			...
			if (aClass438_10077.method5819((byte) -68) && aBoolean10094) {
				StanceConfig class350 = getStanceConfig(-244281365);
	...
	Class335 drawFloor(GraphicsToolkit class_ra, int i) {
		try {
			...
			if (Class422_Sub25.preferences.aClass422_Sub18_7561.method5693(-591782935) == 1) {
				StanceConfig class350 = getStanceConfig(-97958061);
				if (class350.aBoolean3756 && (164936249 * aClass366_10209.anInt3974 == -1 || (Class15.aClass507_224.method6269(aClass366_10209.anInt3974 * 164936249, -465726953).opcode111V))) {
					...
					if (null != class387) {
						...
						class_ra.RA(false);
						class387.drawModel(class222, (aClass302_Sub1Array7726[aClass387Array10082.length]), 0);
						class_ra.RA(true);
					}
				}
			}
			if (this == Class287.myPlayer) {
				for (int i_30_ = client.hintIcons.length - 1; i_30_ >= 0; i_30_--) {
					HintIcon class19 = client.hintIcons[i_30_];
					if (null != class19 && class19.anInt263 * 408071539 != -1) {
						if (958933333 * class19.anInt266 == 1) {
							ObjectValue class298_sub29 = ((ObjectValue) (client.aClass437_8696.method5812((long) (-841622081 * class19.anInt256))));
						...
						if (2 == class19.anInt266 * 958933333) {
							...
							long l = (long) (-1338192389 * class19.x - (int) class217.x);
							long l_33_ = (long) (class19.y * 1018128075 - (int) class217.y);
			...
			for (int i_38_ = 0; i_38_ < aClass387Array10082.length; i_38_++) {
				if (aClass387Array10082[i_38_] != null)
					aClass387Array10082[i_38_].drawModel(class222, aClass302_Sub1Array7726[i_38_], (this == Class287.myPlayer ? 1 : 0));
			}
	...
	void method4468(GraphicsToolkit class_ra, Class222 class222, Class387 class387, long l, long l_40_, int i, long l_41_) {
		try {
			...
			if (l_42_ >= 262144L && l_42_ <= l_41_) {
				...
				if (class387_44_ != null) {
					class_ra.RA(false);
					class387_44_.drawModel(class222, null, 0);
					class_ra.RA(true);
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	boolean method4469(GraphicsToolkit class_ra, int i, byte i_45_) {
		try {
			int i_46_ = i;
			StanceConfig class350 = getStanceConfig(1841046440);
	...
	public String method4470(boolean bool, int i) {
		try {
			...
			if (bool)
				string = new StringBuilder().append(string).append(aString10200).toString();
			else
				string = new StringBuilder().append(string).append(aString10195).toString();
			if (null != ((Player) this).aString10197)
				string = new StringBuilder().append(string).append(((Player) this).aString10197).toString();
			return string;
		} catch (RuntimeException runtimeexception) {
	...
	public final void method4471(int i, int i_53_, byte i_54_, int i_55_) {
		try {
			if (aClass438_10078.method5819((byte) -119) && (aClass438_10078.method5820(1546485881).resetOnMovement * -882531177) == 1) {
			...
			for (int i_56_ = 0; i_56_ < currentGraphics.length; i_56_++) {
				if (-1 != currentGraphics[i_56_].id * -967533709) {
					GraphicsConfig class398 = (Class158_Sub1.aClass389_8568.method4857(-967533709 * currentGraphics[i_56_].id, -1891757366));
					if (class398.aBoolean5215 && 1505778629 * class398.animation != -1 && (Class501.aClass395_6122.method4903(class398.animation * 1505778629, (byte) 83).resetOnMovement) * -882531177 == 1) {
	...
	public void method4472(int i, int i_57_, int i_58_) {
		try {
			...
			class217.y = (float) (i_59_ * 256 + scenePositionYQueue[0] * 512);
			setPosition(class217);
			class217.method2006();
			if (this == Class287.myPlayer)
	...
	public void method4474(String string, int i, int i_66_, int i_67_) {
		try {
			method4430(string, i, i_66_, (Class82_Sub5.method883((byte) 6) * (453178367 * LinkedArrayList.WIDGET_DETAILS.anInt4037)), (byte) -79);
		} catch (RuntimeException runtimeexception) {
	...
	public boolean method4429(byte i) {
		try {
			return LinkedArrayList.WIDGET_DETAILS.aBoolean4043;
		} catch (RuntimeException runtimeexception) {
	...
	Class335 method4370(GraphicsToolkit class_ra) {
		...
		Class335 class335 = null;
		((Player) this).aBoolean10129 = false;
		if (Class422_Sub25.preferences.aClass422_Sub18_7561.method5693(-1650118723) == 1) {
			StanceConfig class350 = getStanceConfig(-231420914);
			if (class350.aBoolean3756 && (164936249 * aClass366_10209.anInt3974 == -1 || (Class15.aClass507_224.method6269(aClass366_10209.anInt3974 * 164936249, -824172978).opcode111V))) {
		...
		if (this == Class287.myPlayer) {
			for (int i_77_ = client.hintIcons.length - 1; i_77_ >= 0; i_77_--) {
				HintIcon class19 = client.hintIcons[i_77_];
				if (null != class19 && class19.anInt263 * 408071539 != -1) {
					if (958933333 * class19.anInt266 == 1) {
						ObjectValue class298_sub29 = ((ObjectValue) (client.aClass437_8696.method5812((long) (-841622081 * class19.anInt256))));
						if (null != class298_sub29) {
							NPC class365_sub1_sub1_sub2_sub1 = ((NPC) class298_sub29.value);
							SceneObjectPosition class217 = (SceneObjectPosition.method2011((class365_sub1_sub1_sub2_sub1.method4337().aClass217_2599), Class287.myPlayer.method4337().aClass217_2599));
							int i_78_ = (int) class217.x;
							int i_79_ = (int) class217.y;
					...
					if (2 == class19.anInt266 * 958933333) {
						SceneObjectPosition class217 = (Class287.myPlayer.method4337().aClass217_2599);
						long l = (long) (-1338192389 * class19.x - (int) class217.x);
						long l_80_ = (long) (class19.y * 1018128075 - (int) class217.y);
					...
					if (10 == class19.anInt266 * 958933333 && -841622081 * class19.anInt256 >= 0 && (-841622081 * class19.anInt256 < (client.players).length)) {
						...
						if (class365_sub1_sub1_sub2_sub2_82_ != null) {
							...
							int i_83_ = (int) class217.x;
							int i_84_ = (int) class217.y;
		...
		for (int i_85_ = 0; i_85_ < aClass387Array10082.length; i_85_++) {
			if (aClass387Array10082[i_85_] != null)
				aClass387Array10082[i_85_].drawModel(class222, aClass302_Sub1Array7726[i_85_], (this == Class287.myPlayer ? 1 : 0));
		}
		if (null != ((Player) this).aClass351_10067) {
			Class69 class69 = ((Player) this).aClass351_10067.method4229();
			class_ra.method5042(class69);
		...
		try {
			if (null != ((Player) this).aClass62_10118) {
				if (null == ((Class62) (((Player) this).aClass62_10118)).aString608)
					return null;
				if (0 == client.anInt8837 * -1168328513 || -1168328513 * client.anInt8837 == 3 || (client.anInt8837 * -1168328513 == 1 && Class494.method6192(aString10195, -1511804216)))
	...
	public Class62 method4443() {
		if (null != ((Player) this).aClass62_10118) {
			if (null == ((Class62) (((Player) this).aClass62_10118)).aString608)
				return null;
			if (0 == client.anInt8837 * -1168328513 || -1168328513 * client.anInt8837 == 3 || (client.anInt8837 * -1168328513 == 1 && Class494.method6192(aString10195, -1800657283)))
				return ((Player) this).aClass62_10118;
		}
		return null;
	}
