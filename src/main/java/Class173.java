...
public class Class173 {
	...
	static CachingHashMap aClass348_1749 = new CachingHashMap(64);
	...
	static CacheIndex aClass243_1756;
	public boolean aBoolean1757;
	public static CacheIndex aClass243_1758;
		...
		try {
			...
			if (client.aClass283_8716.method2675(-1611682495) != null && (client.aClass283_8716.method2674(-257896295) != Class266.aClass266_2846) && i_5_ >= 0 && i_6_ >= 0 && i_5_ < client.aClass283_8716.method2629(-1890552944) && i_6_ < client.aClass283_8716.method2630(-1685955624)) {
				...
				if (class298_sub2 == null)
					...
					Class298_Sub12 class298_sub12 = (Class298_Sub12) class298_sub2.groundItems.method5939(1766612795);
					if (class298_sub12 == null)
						...
						class365_sub1_sub4_sub1.anInt10152 = 397105967 * class298_sub12.id;
						class365_sub1_sub4_sub1.anInt10143 = (-2063762687 * ((Class298_Sub12) class298_sub12).anInt7256);
						while_66_: do {
							Class298_Sub12 class298_sub12_11_;
							while_65_: do {
								do {
									class298_sub12_11_ = ((Class298_Sub12) class298_sub2.groundItems.method5944(49146));
									if (class298_sub12_11_ == null) {
										if (i_7_ <= -111188266)
											throw new IllegalStateException();
										break while_66_;
									}
									if ((1768239597 * class298_sub12_11_.id) != (-441234013 * (class365_sub1_sub4_sub1.anInt10152)))
										break while_65_;
								} while (i_7_ > -111188266);
								return;
							} while (false);
							class365_sub1_sub4_sub1.anInt10150 = 1259142109 * class298_sub12_11_.id;
							class365_sub1_sub4_sub1.anInt10145 = -1936319903 * ((Class298_Sub12) class298_sub12_11_).anInt7256;
							for (;;) {
								Class298_Sub12 class298_sub12_12_ = ((Class298_Sub12) class298_sub2.groundItems.method5944(49146));
								if (null == class298_sub12_12_) {
									if (i_7_ > -111188266)
										break;
									return;
								}
								if (class298_sub12_12_.id * 1768239597 != -441234013 * (class365_sub1_sub4_sub1.anInt10152)) {
									if ((class298_sub12_12_.id * 1768239597) == (class365_sub1_sub4_sub1.anInt10150 * -909380271)) {
										if (i_7_ <= -111188266) {
											/* empty */
										}
									} else {
										class365_sub1_sub4_sub1.anInt10146 = (-843548765 * class298_sub12_12_.id);
										class365_sub1_sub4_sub1.anInt10147 = (((Class298_Sub12) class298_sub12_12_).anInt7256 * -597974721);
									}
								}
							}
						} while (false);
						int i_13_ = Class356.getPlayerHeight(256 + (i_5_ << 9), 256 + (i_6_ << 9), i, -859881334);
	...
	public static final void method1821(Interface class298_sub51, boolean bool, boolean bool_14_, int i) {
		try {
			...
			GrabFolder.method2280(i_15_, (byte) -97);
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_16_, (byte) 18);
			if (null != class105)
	...
	public static final void method1822(int viewLocalX, int viewLocalY, int viewZ, int speed1, int speed2, byte i_23_) {
		try {
			...
			if (Class427.anInt5362 * 1179258959 >= 100) {
				...
				int i_26_ = (Class356.getPlayerHeight(i_24_, i_25_, Class99.anInt952 * 1855729883, -1477224800) - Class18.anInt255 * 771695069);
			...
			Class298_Sub1.cameraType = 2090692627;
