...
public abstract class Class308 {
	...
	LinkedArrayList aClass437_3279;
	...
	Class298_Sub24 method3774(byte i) throws IOException {
		try {
			...
			Class298_Sub24 class298_sub24 = ((Class298_Sub24) ((Class308) this).aClass437_3279.method5812((long) i_2_));
			...
			if (!((Class308) this).aBoolean3282) {
				while_77_: for (/**/; !((Class308) this).aBoolean3276; ((Class308) this).aBoolean3281 = false) {
					...
					if (!((Class308) this).aBoolean3281) {
						...
						class298_sub24 = ((Class298_Sub24) (((Class308) this).aClass437_3279.method5812((long) ((Class308) this).anOggPage3271.getSerialNumber())));
	...
	Class308(int i) {
		...
		((Class308) this).aClass437_3279 = new LinkedArrayList(8);
	}
	...
	static final void method3781(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_6_, (byte) 10);
