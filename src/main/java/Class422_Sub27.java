...
public class Class422_Sub27 extends Preference {
	public static int anInt8431 = 1;
	public static int anInt8432 = 0;

	public Class422_Sub27(int i, Preferences class298_sub48) {
		super(i, class298_sub48);
	}

	public Class422_Sub27(Preferences class298_sub48) {
	...
	static final void method5722(WidgetConfig class105, ClientScript2 class403, int i) {
		try {
			...
			if (class105.anObjectArray1164 != null) {
				...
				((Class298_Sub46) class298_sub46).anInt7524 = (1954090355 * ((ClientScript2) class403).anInt5254 + -171453569);
				client.aClass453_8893.add(class298_sub46, -201281014);
			}
		} catch (RuntimeException runtimeexception) {
