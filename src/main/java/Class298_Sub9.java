...
public class Class298_Sub9 extends Class298 {
	static CachingHashMap aClass348_7223;
	static LinkedArrayList aClass437_7224 = new LinkedArrayList(32);
	...
	static {
		aClass348_7223 = new CachingHashMap(10);
	}
	...
	final Class387 method2891(GraphicsToolkit class_ra, int i, Class438 class438, int i_0_, boolean bool, Class366 class366, byte i_1_) {
		try {
			...
			if (aClass348_7223 != null)
				class387 = (Class387) aClass348_7223.get(l);
			if (null == class387 || class_ra.method5017(class387.m(), i_2_) != 0) {
				...
				for (int i_8_ = 0; i_8_ < is.length; i_8_++) {
					if (is[i_8_] == -1) {
						...
						class64s[i_8_] = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(is[i_8_]).getWearModel(bool, null, i_8_);
				}
				if (class350 != null && null != class350.anIntArrayArray3710) {
					for (int slot = 0; slot < class350.anIntArrayArray3710.length; slot++) {
						if (class350.anIntArrayArray3710[slot] != null) {
							if (null == class64s[slot]) {
								if (i_1_ != 1)
									throw new IllegalStateException();
							} else {
								int i_10_ = class350.anIntArrayArray3710[slot][0];
								int i_11_ = class350.anIntArrayArray3710[slot][1];
								int i_12_ = class350.anIntArrayArray3710[slot][2];
								int i_13_ = class350.anIntArrayArray3710[slot][3];
								int i_14_ = class350.anIntArrayArray3710[slot][4];
								int i_15_ = class350.anIntArrayArray3710[slot][5];
								if (i_13_ != 0 || i_14_ != 0 || i_15_ != 0)
									class64s[slot].method754(i_13_, i_14_, i_15_);
								if (i_10_ != 0 || 0 != i_11_ || 0 != i_12_)
									class64s[slot].translate(i_10_, i_11_, i_12_);
							}
						}
					}
				}
				...
				if (null != class366)
					i_5_ |= 0x4000;
				class387 = class_ra.method5037(class64, i_5_, anInt7225 * 1310831989, 66, 850);
				if (class366 != null) {
					for (int i_16_ = 0; i_16_ < 10; i_16_++) {
						for (int i_17_ = 0; (i_17_ < Class366.aShortArrayArray3970[i_16_].length); i_17_++) {
							if (class366.anIntArray3973[i_16_] < (Class22.appearenceColors[i_16_][i_17_]).length)
								class387.X((Class366.aShortArrayArray3970[i_16_][i_17_]), (Class22.appearenceColors[i_16_][i_17_][class366.anIntArray3973[i_16_]]));
						}
					}
				}
