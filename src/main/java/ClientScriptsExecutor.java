...
public class ClientScriptsExecutor {
	...
	static {
		...
		aQueue4124 = new LinkedList<Object>();
	}
			...
			try {
				try {
					...
					for (;;) {
						...
						if (-560594807 * Class388.anInt4152 > /*i*/2000000)
							throw new RuntimeException("");
						class394 = (((ClientScript2) class403).aClass394Array5258[(((ClientScript2) class403).integerPos += 286750741) * 1883543357]);
						if (Class388.aBoolean4154 && (null == Class388.aString4155 || (null != (((ClientScript2) class403).aClass298_Sub37_Sub17_5260.name) && (((ClientScript2) class403).aClass298_Sub37_Sub17_5260.name.indexOf(Class388.aString4155) != -1))))
							System.out.println(new StringBuilder().append(((ClientScript2) class403).aClass298_Sub37_Sub17_5260.name).append(": ").append(class394).toString());
						...
						TextureLoader.method2392(class394, class403, (byte) 11);
					}
				} catch (Exception exception) {
					StringBuilder stringbuilder = new StringBuilder(30);
					stringbuilder.append("").append(7051297995265073167L * (((ClientScript2) class403).aClass298_Sub37_Sub17_5260.aLong3188)).append(" ");
					for (int i_1_ = (((ClientScript2) class403).anInt5250 * -932179775) - 1; i_1_ >= 0; i_1_--)
						stringbuilder.append("").append(7051297995265073167L * (((Class402) (((ClientScript2) class403).aClass402Array5249[i_1_])).aClass298_Sub37_Sub17_5229.aLong3188)).append(" ");
					stringbuilder.append("").append(Integer.valueOf(-2008816077 * class394.anInt5187));
					IPAddress.method6062(stringbuilder.toString(), exception, (short) -1126);
	...
	static void method4693(int i) {
		try {
			if (Class151.method1646(client.anInt8752 * -1233866115, -1337586273)) {
				if (client.aClass25_8693.method387(537308016) == null)
