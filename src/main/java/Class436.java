...
public class Class436 {
	...
	static LinkedArrayList aClass437_5470;
	...
	public static boolean aBoolean5478 = false;
	...
	static WidgetConfig aClass105_5486;
	...
	static Matrix aClass233_5493;
	static Matrix aClass233_5494;
	static Class222 aClass222_5495;
	...
	static {
		...
		aClass437_5470 = new LinkedArrayList(16);
		...
		anInt5492 = 0;
		aClass233_5493 = null;
		aClass233_5494 = new Matrix();
		aClass222_5495 = new Class222();
		aBoolean5496 = false;
		anInt5498 = 0;
		anInt5499 = -985311877;
	...
	static final void method5805(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("s.mk(").append(')').toString());
		}
	}
	...
	static final void method5806(ClientScript2 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("s.yv(").append(')').toString());
		}
	}
	...
	static final void method5807(ClientScript2 script, int i) {
		try {
			...
			if (i_0_ != Class422_Sub25.preferences.aClass422_Sub20_7578.method5700(-1514807660)) {
				Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub20_7578, i_0_, -1997480653);
				Class3.savePreferences(656179282);
				client.sentPreferences = false;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("s.ajv(").append(')').toString());
		}
	}

	static String method5808(RsByteBuffer class298_sub53, int i, int i_1_) {
		try {
			String string;
			try {
				int i_2_ = class298_sub53.readUnsignedSmart(1723054621);
				if (i_2_ > i) {
					i_2_ = i;
				}
				byte[] is = new byte[i_2_];
				class298_sub53.index += (Class106.aClass113_1308.method1245(class298_sub53.buffer, class298_sub53.index * 385051775, is, 0, i_2_, 200493148)) * 116413311;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("s.p(").append(')').toString());
		}
	}

	static final void method5809(ClientScript2 class403, byte i) {
		try {
			class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8807 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("s.uw(").append(')').toString());
		}
	}
	...
	public static int method5810(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("s.z(").append(')').toString());
		}
	}
}
