		...
		try {
			...
			if (Class301_Sub1.anInt7624 * -1289394455 >= 100) {
				...
				if (Class274.aClass57_6539 == null || Class274.aClass57_6539.method623() != i_10_ || Class274.aClass57_6539.method625() != i_11_) {
					Class301_Sub1.method3709(Class301_Sub1.baseX, (Class301_Sub1.baseY + Class301_Sub1.mapHeight), (Class301_Sub1.baseX + Class301_Sub1.mapWidth), Class301_Sub1.baseY, i, i_9_, i_13_ + i, i_14_ + i_9_);
					Class301_Sub1.method3698(class_ra);
					Class274.aClass57_6539 = class_ra.method5033(i, i_9_, i_13_, i_14_, false);
				}
				Class274.aClass57_6539.drawSprite(i, i_9_);
				int i_15_ = (i_13_ * (1484045541 * Class301_Sub1.anInt7625) / Class301_Sub1.mapWidth);
				int i_16_ = (1464638883 * Class413.anInt6590 * i_14_ / Class301_Sub1.mapHeight);
				int i_17_ = i + (i_13_ * (Class402.anInt5232 * 331474003) / Class301_Sub1.mapWidth);
				int i_18_ = i_14_ + i_9_ - (1786832569 * Class261.anInt2825 * i_14_ / Class301_Sub1.mapHeight) - i_16_;
				...
				if (Class137_Sub1.anInt6991 * -1983068885 > 0) {
					...
					for (Class298_Sub52 class298_sub52 = (Class298_Sub52) Class301_Sub1.aClass453_3236.method5939(1766612795); null != class298_sub52; class298_sub52 = (Class298_Sub52) Class301_Sub1.aClass453_3236.method5944(49146)) {
						Class352 class352 = (Class301_Sub1.aClass339_3251.method4116(-530122905 * class298_sub52.mapAreaID, -1892291274));
						if (!Class422_Sub29.method5728(class352, 1502593597)) {
							if (i_12_ <= 46531020) {
								/* empty */
							}
						} else if (Class301_Sub1.anInt7633 * -271159611 == class298_sub52.mapAreaID * -530122905) {
							int i_21_ = ((i_13_ * (2122110429 * class298_sub52.x) / Class301_Sub1.mapWidth) + i);
							int i_22_ = (i_9_ + ((Class301_Sub1.mapHeight - class298_sub52.y * -372920341) * i_14_ / Class301_Sub1.mapHeight));
							...
							int i_23_ = i + (2122110429 * class298_sub52.x * i_13_ / Class301_Sub1.mapWidth);
							int i_24_ = ((i_14_ * (Class301_Sub1.mapHeight - class298_sub52.y * -372920341) / Class301_Sub1.mapHeight) + i_9_);
