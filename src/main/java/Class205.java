...
public class Class205 {
	...
	public Class207 method1914(int i, int i_0_) {
		try {
			...
			synchronized (((Class205) this).aClass348_2340) {
				class207 = (Class207) ((Class205) this).aClass348_2340.get((long) i);
			}
			if (null != class207)
				return class207;
			byte[] is;
			synchronized (((Class205) this).aClass243_2338) {
				is = (((Class205) this).aClass243_2338.getFileFromArchive(-1006924897 * ConfigFile.aClass120_1421.anInt1460, i, (byte) -4));
			}
	...
	public Class205(Class411 class411, Class429 class429, CacheIndex class243) {
		...
		if (null != ((Class205) this).aClass243_2338)
			anInt2339 = (((Class205) this).aClass243_2338.method2316(ConfigFile.aClass120_1421.anInt1460 * -1006924897, 487068051)) * 1946957321;
		else
			anInt2339 = 0;
	}
