...
public abstract class Class298_Sub32 extends Class298 {
	...
	final int[] method3129(int i, int i_0_, int i_1_) {
		try {
			if (!((Class298_Sub32) this).textureDataConfig[i].aBoolean7382)
				return (((Class298_Sub32) this).textureDataConfig[i].getPixels(i_0_, (byte) -85)[0]);
			return ((Class298_Sub32) this).textureDataConfig[i].method3131(i_0_, 891860141);
		} catch (RuntimeException runtimeexception) {
	...
	final int[][] method3134(int i, int i_7_, byte i_8_) {
		try {
			if (((Class298_Sub32) this).textureDataConfig[i].aBoolean7382) {
				int[] is = ((Class298_Sub32) this).textureDataConfig[i].method3131(i_7_, 1101139178);
				int[][] is_9_ = new int[3][];
				is_9_[0] = is;
				is_9_[1] = is;
				is_9_[2] = is;
			...
			return ((Class298_Sub32) this).textureDataConfig[i].getPixels(i_7_, (byte) -94);
		} catch (RuntimeException runtimeexception) {
	...
	Class298_Sub32(int i, boolean bool) {
		aBoolean7382 = bool;
		((Class298_Sub32) this).textureDataConfig = new Class298_Sub32[i];
	}
