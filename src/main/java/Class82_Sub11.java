...
public class Class82_Sub11 extends Class82 {
	...
	static void method907(GraphicsToolkit class_ra, int i) {
		try {
			...
			int i_2_ = GroundMessage.anInt7658 * 1089948687;
			...
			if (null == Class65.aClass264_664 || null == Class211.aClass505_2420) {
				...
				if (Class65.aClass264_664 != null && Class211.aClass505_2420 != null) {
					...
					if (i_3_ + i_6_ > Class462.screenWidth * -2110394505)
						i_6_ = Class462.screenWidth * -2110394505 - i_3_;
					if (i_6_ < 0)
						i_6_ = 0;
					Class110.method1226(i_6_, GroundMessage.anInt7658 * 1089948687, (byte) 34);
					return;
				}
			}
			Class264 class264;
			...
			Class319.method3900(class_ra, Class88.anInt806 * -1347746885, 1089948687 * GroundMessage.anInt7658, 608683427 * Class134.anInt6343, Class448.anInt5619 * 1396607435, i_5_, class264, class505, Tradution.aClass470_5907.method6049(Class321.aClass429_3357, -875414210), 1493499179);
			int i_7_ = (255 - Class436.anInt5484 * 597392981 - 1868123923 * Class436.anInt5498);
			if (i_7_ < 0)
				i_7_ = 0;
			int i_8_ = Class165.aClass319_6366.method3894((byte) -89);
			int i_9_ = Class165.aClass319_6366.method3883((byte) 17);
			...
			Class247.method2372(class_ra, -1347746885 * Class88.anInt806, GroundMessage.anInt7658 * 1089948687, 608683427 * Class134.anInt6343, 1396607435 * Class448.anInt5619, i_5_, 2136796856);
			if (!Class436.aBoolean5471) {
				int i_15_ = 0;
				for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) Class436.aClass453_5480.method5939(1766612795)); class298_sub37_sub15 != null; class298_sub37_sub15 = ((Class298_Sub37_Sub15) Class436.aClass453_5480.method5944(49146))) {
				...
				for (Class298_Sub37_Sub5 class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482.method5984(-476899641)); null != class298_sub37_sub5; class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482.method5985(81519453))) {
					int i_18_ = (-411680299 * Class436.anInt5467 * i_17_ + (1 + (i_5_ + 1089948687 * GroundMessage.anInt7658 + 1110385787 * class505.anInt6202)));
					if ((((Class298_Sub37_Sub5) class298_sub37_sub5).anInt9583 * -628325139) == 1)
						GraphicsToolkit.method5192(i_8_, i_9_, Class88.anInt806 * -1347746885, GroundMessage.anInt7658 * 1089948687, Class134.anInt6343 * 608683427, Class448.anInt5619 * 1396607435, i_18_, ((Class298_Sub37_Sub15) (((Class298_Sub37_Sub5) class298_sub37_sub5).aClass461_9584.aClass298_Sub37_5679.aClass298_Sub37_7405)), class264, class505, Class343.anInt3674 * -1067973831 | ~0xffffff, (Class298_Sub40_Sub2.anInt9693 * 1697857463 | ~0xffffff), 579895839);
					else
						Class66.method763(i_8_, i_9_, Class88.anInt806 * -1347746885, 1089948687 * GroundMessage.anInt7658, 608683427 * Class134.anInt6343, 1396607435 * Class448.anInt5619, i_18_, class298_sub37_sub5, class264, class505, -1067973831 * Class343.anInt3674 | ~0xffffff, (1697857463 * Class298_Sub40_Sub2.anInt9693 | ~0xffffff), (byte) -36);
					i_17_++;
				}
				if (Class436.aClass298_Sub37_Sub5_5472 != null) {
					i_17_ = 0;
	...
	static final void method908(ClientScript2 class403, byte i) {
		try {
			WidgetConfig.method1135((((ClientScript2) class403).aClass365_Sub1_Sub4_Sub1_5253), class403, -1596344570);
		} catch (RuntimeException runtimeexception) {
