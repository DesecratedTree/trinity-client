...
public class Class240_Sub1 extends Class240 {
	...
	void method2234(GraphicsToolkit class_ra, int i, int i_0_, int i_1_, int i_2_, Class289 class289, int i_3_) {
		try {
			...
			if (null != interface3) {
				ObjectConfig class432 = (((Class240_Sub1) this).aClass433_7072.getObjectDefinitions(interface3.method32((byte) 80)));
				...
				if (i_0_ == 0) {
					...
					if (0 != class432.cliped * -2144543407)
						class289.method2743(i_1_, i_2_, i_4_, i_5_, class432.solid, !class432.ignoreClipOnAlternativeRoute, (byte) 108);
					if (-1508517619 * class432.opcode23V == 1) {
						if (0 == i_5_)
					...
					if (0 != class432.cliped * -2144543407 && (-1125834887 * class432.sizeX + i_1_ < anInt2627 * -954368823) && (-1125834887 * class432.sizeX + i_2_ < anInt2628 * 181474463) && (-565161399 * class432.sizeY + i_1_ < anInt2627 * -954368823) && (-565161399 * class432.sizeY + i_2_ < 181474463 * anInt2628))
						class289.method2736(i_1_, i_2_, class432.sizeX * -1125834887, -565161399 * class432.sizeY, i_5_, class432.solid, !class432.ignoreClipOnAlternativeRoute, (byte) 38);
					...
					if (class432.cliped * -2144543407 == 1)
	...
	public final void method2235(int mapID, boolean osrs, GraphicsToolkit class_ra, RsByteBuffer class298_sub53, int i, int i_6_, byte i_7_) {
		try {
			if (!aBoolean2629) {
				boolean bool = false;
				...
				while_0_: do {
					for (;;) {
						...
						if (i_8_ == 0) {
							if (class385 == null)
								class385 = new Atmosphere(class298_sub53, (((Class240_Sub1) this).aClass364_7080));
							else
								class385.decodeGeneric(class298_sub53, (((Class240_Sub1) this).aClass364_7080), (short) 1342);
						} else if (1 == i_8_) {
								...
								for (int i_10_ = 0; i_10_ < i_9_; i_10_++) {
									...
									if (class_ra.method5048() > 0) {
										...
										if (i_13_ >= 0 && i_14_ >= 0 && i_13_ < -954368823 * anInt2627 && i_14_ < 181474463 * anInt2628) {
											class298_sub10.method2899(i_11_, ((terrainHeight[(class321.anInt3345 * -1565952249)][i_13_][i_14_]) - (class298_sub10.method2894(1382635254))), i_12_, (byte) 37);
							...
							for (int i_15_ = 0; i_15_ < 4; i_15_++) {
								byte i_16_ = class298_sub53.readByte();
								if (i_16_ == 0 && (null != aByteArrayArrayArray2631[i_15_])) {
									...
									for (int i_21_ = 0; i_21_ < 64; i_21_ += 4) {
										for (int i_22_ = 0; i_22_ < 64; i_22_ += 4) {
											byte i_23_ = class298_sub53.readByte();
			...
			/*	if (class385 != null) {
					System.out.println("a "+class385.skyColor);
					System.out.println(class385.anInt4135);
				}*/
				if (osrs && class385 == null) {
					class385 = new Atmosphere();
					class385.setOSRSAtmosphere(mapID);
				}else if (class385 != null) {
					System.out.println("map "+mapID);
					System.out.println("skyColor = "+class385.skyColor);
					System.out.println("anInt4135 = "+class385.anInt4135);
					System.out.println("sunColor = "+class385.sunColor);
					System.out.println("sunY = "+class385.sunY);
					System.out.println("sunX = "+class385.sunX);
					System.out.println("sunShineness = "+class385.sunShineness);
					System.out.println("anInt4135 = "+class385.anInt4135);
				}
	...
	public final void decodeScene(boolean osrs, int mapID, GraphicsToolkit class_ra, RsByteBuffer class298_sub53, int i, int i_39_, int i_40_, int i_41_, int i_42_, int i_43_, int i_44_, int i_45_) {
		try {
			if (!aBoolean2629) {
				boolean bool = false;
				Atmosphere class385 = null;
					...
					for (;;) {
						...
						if (0 == i_48_) {
							if (null == class385)
								...
								class385.decodeGeneric(class298_sub53, (((Class240_Sub1) this).aClass364_7080), (short) 1534);
						} else if (1 == i_48_) {
									...
									if (class_ra.method5048() > 0) {
										...
										if (i_41_ == (class321.anInt3345 * -1565952249) && i_51_ >= i_46_ && i_51_ < i_46_ + 8 && i_52_ >= i_47_ && i_52_ < i_47_ + 8) {
											...
											if (i_51_ >= 0 && i_52_ >= 0 && (i_51_ < anInt2627 * -954368823) && (i_52_ < anInt2628 * 181474463)) {
												class298_sub10.method2899(i_53_, ((terrainHeight[i_41_][i_51_][i_52_]) - (class298_sub10.method2894(-2061162182))), i_54_, (byte) -72);
				...
				if (osrs && class385 == null) {
					...
					System.out.println("map "+mapID);
					System.out.println("class385.skyColor = "+class385.skyColor);
					System.out.println("class385.anInt4135 = "+class385.anInt4135);
					System.out.println("class385.sunColor = "+class385.sunColor);
					System.out.println("class385.sunY = "+class385.sunY);
					System.out.println("class385.sunX = "+class385.sunX);
					System.out.println("class385.sunShineness = "+class385.sunShineness);
					System.out.println("class385.anInt4135 = "+class385.anInt4135);
				}
	...
	public final void method2237(boolean osrs, GraphicsToolkit class_ra, byte[] data, int i, int i_72_, Class289[] class289s, int i_73_) {
		try {
			...
			for (;;) {
				...
				for (;;) {
					...
					int x = i_79_ + i;
					int y = i_78_ + i_72_;
					if (x > 0 && y > 0 && x < -954368823 * anInt2627 - 1 && y < anInt2628 * 181474463 - 1) {
						Class289 class289 = null;

						int id = objectID + (osrs ? Settings.OSRS_OBJECT_OFFSET : 0);
						/*if (id == 125296)
							continue;*/
						if (!aBoolean2629) {
							int realPlane = plane;
							if (2 == ((aClass244_2635.terrainSettings[1][x][y]) & 0x2))
								realPlane--;
							if (realPlane >= 0) {
								class289 = class289s[realPlane];
							}
						}
						method2243(class_ra, plane, plane, x, y, id, i_83_, i_82_, class289, -1, 1769761748);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	public final void method2238(boolean osrs, GraphicsToolkit class_ra, byte[] is, int i, int i_87_, int i_88_, int i_89_, int i_90_, int i_91_, int i_92_, Class289[] class289s, int i_93_) {
		try {
			...
			for (;;) {
				...
				for (;;) {
					...
					if (i_89_ == i_100_ && i_99_ >= i_90_ && i_99_ < 8 + i_90_ && i_98_ >= i_91_ && i_98_ < 8 + i_91_) {
						...
						ObjectConfig class432 = ((Class240_Sub1) this).aClass433_7072.getObjectDefinitions(id);
						...
						if (i_104_ > 0 && i_105_ > 0 && i_104_ < -954368823 * anInt2627 - 1 && i_105_ < 181474463 * anInt2628 - 1) {
							...
							if (!aBoolean2629) {
								int i_106_ = i;
								if (2 == ((aClass244_2635.terrainSettings[1][i_104_][i_105_]) & 0x2))
									i_106_--;
								if (i_106_ >= 0)
									class289 = class289s[i_106_];
							}
							method2243(class_ra, i, i, i_104_, i_105_, id, i_92_ + i_103_ & 0x3, i_102_, class289, -1, 2074281649);
						}
					}
				}
			}
	...
	boolean method2239(GraphicsToolkit class_ra, int i, int i_107_, boolean bool, ObjectConfig class432, int i_108_, int i_109_, int i_110_, int i_111_, int i_112_, int i_113_, int i_114_, int i_115_, boolean bool_116_, Class_xa class_xa, Class289 class289, int i_117_, int i_118_, byte i_119_) {
		try {
			if (-1976050083 * Class424.aClass424_6614.anInt6613 == i) {
				int i_120_ = class432.opcode23V * -1508517619;
				if (aBoolean7073 && -1 == -1508517619 * class432.opcode23V)
					i_120_ = 1;
				...
				if (0 == i_107_) {
					if (aBoolean2632 && class432.hasShadow) {
				...
				if (0 != -2144543407 * class432.cliped && class289 != null)
					class289.method2732(i_114_, i_115_, i, i_107_, class432.solid, !class432.ignoreClipOnAlternativeRoute, (byte) 0);
				if (-448694871 * class432.opcode28V != 64)
					aClass331_2619.method4023(i_109_, i_114_, i_115_, class432.opcode28V * -448694871, (byte) -54);
				return true;
			}
			if (i == -1976050083 * Class424.aClass424_6592.anInt6613) {
				...
				if (class432.hasShadow && aBoolean2632) {
					if (i_107_ == 0)
						class_xa.LA(i_114_, i_115_ + 1, 50);
					else if (1 == i_107_)
				...
				if (-2144543407 * class432.cliped != 0 && null != class289)
					class289.method2732(i_114_, i_115_, i, i_107_, class432.solid, !class432.ignoreClipOnAlternativeRoute, (byte) 0);
				return true;
			}
			if (i == -1976050083 * Class424.aClass424_6593.anInt6613) {
				...
				if ((class432.opcode23V * -1508517619 == 1 || aBoolean7073 && -1 == -1508517619 * class432.opcode23V) && !aBoolean2629) {
					if (0 == i_107_) {
				...
				if (0 != -2144543407 * class432.cliped && class289 != null)
					class289.method2732(i_114_, i_115_, i, i_107_, class432.solid, !class432.ignoreClipOnAlternativeRoute, (byte) 0);
				if (class432.opcode28V * -448694871 != 64)
					aClass331_2619.method4023(i_109_, i_114_, i_115_, -448694871 * class432.opcode28V, (byte) 12);
				return true;
			}
			if (i == -1976050083 * Class424.aClass424_6594.anInt6613) {
				...
				if (class432.cliped * -2144543407 != 0 && class289 != null)
					class289.method2732(i_114_, i_115_, i, i_107_, class432.solid, !class432.ignoreClipOnAlternativeRoute, (byte) 0);
				return true;
			}
			if (i == -1976050083 * Class424.aClass424_6595.anInt6613) {
				...
				if (1 == class432.opcode23V * -1508517619 && !aBoolean2629) {
					int i_124_;
					if ((i_107_ & 0x1) == 0)
						i_124_ = 8;
					else
				...
				if (class432.cliped * -2144543407 != 0 && null != class289)
					class289.method2741(i_114_, i_115_, i_117_, i_118_, class432.solid, !class432.ignoreClipOnAlternativeRoute, (byte) 2);
				if (class432.opcode28V * -448694871 != 64)
					aClass331_2619.method4023(i_109_, i_114_, i_115_, class432.opcode28V * -448694871, (byte) 23);
				return true;
			}
			return false;
		} catch (RuntimeException runtimeexception) {
	...
	boolean method2240(GraphicsToolkit class_ra, int i, int i_125_, boolean bool, ObjectConfig class432, int i_126_, int i_127_, int i_128_, int i_129_, int i_130_, int i_131_, int i_132_, int i_133_, int i_134_) {
		try {
			...
			if (i == Class424.aClass424_6601.anInt6613 * -1976050083) {
				...
				if (null != interface3)
					i_135_ = (((Class240_Sub1) this).aClass433_7072.getObjectDefinitions(interface3.method32((byte) 27)).opcode28V) * -448694871 + 1;
				Class365_Sub1_Sub3 class365_sub1_sub3;
				if (bool) {
			...
			if (-1976050083 * Class424.aClass424_6598.anInt6613 == i) {
				...
				if (interface3 != null)
					i_136_ = (((Class240_Sub1) this).aClass433_7072.getObjectDefinitions(interface3.method32((byte) 14)).opcode28V) * -448694871 / 2 + 1;
				Class365_Sub1_Sub3 class365_sub1_sub3;
				if (bool) {
			...
			if (Class424.aClass424_6600.anInt6613 * -1976050083 == i) {
				...
				if (null != interface3)
					i_139_ = (((Class240_Sub1) this).aClass433_7072.getObjectDefinitions(interface3.method32((byte) 14)).opcode28V) * -448694871 / 2 + 1;
				Class365_Sub1_Sub3 class365_sub1_sub3;
						...
						for (int i_151_ = 0; i_151_ <= anInt2627 * -954368823; i_151_++) {
							if (((aByteArrayArrayArray2637[i_149_][i_151_][i_150_]) & 0x4) != 0) {
								...
								if ((1 + (i_155_ - i_154_)) * (i_153_ - i_152_ + 1) >= 4) {
									int i_158_ = (terrainHeight[i_149_][i_152_][i_154_]);
	...
	final void method2243(GraphicsToolkit class_ra, int i, int i_161_, int i_162_, int i_163_, int id, int rotation, int type, Class289 class289, int i_167_, int i_168_) {
		try {
			if (i_161_ < -1281303921 * ((Class240_Sub1) this).anInt7082)
				((Class240_Sub1) this).anInt7082 = 272172143 * i_161_;
			ObjectConfig class432 = ((Class240_Sub1) this).aClass433_7072.getObjectDefinitions(id);
			if (Class422_Sub25.preferences.aClass422_Sub16_7557.method5687(1871358652) != 0 || !class432.aBoolean5432) {
				int i_169_;
				int i_170_;
				...
				boolean bool = aBoolean2632 && !aBoolean2629 && class432.updateFaces;
				if (class432.method5784(-1167401239))
					AnimationConfig.method4884(i_161_, i_162_, i_163_, rotation, class432, null, null, (byte) 37);
				boolean bool_178_ = (-1 == i_167_ && !class432.method5779(934270378) && class432.toObjectIDs == null && !class432.aBoolean5381 && !class432.aBoolean5389);
				if (!aBoolean7084 || ((!Class82_Sub9.method900(type, (byte) 13) || class432.opcode23V * -1508517619 == 1) && (!CacheIndexIndicator.method1236(type, 1378507148) || 0 != -1508517619 * class432.opcode23V))) {
					if (type == -1976050083 * Class424.aClass424_6610.anInt6613) {
						if ((Class422_Sub25.preferences.aClass422_Sub2_7547.method5629(-807116560) != 0) || class432.optionType * 1532834983 != 0 || -2144543407 * class432.cliped == 1 || class432.notDecoration) {
							Class365_Sub1_Sub2 class365_sub1_sub2;
							if (bool_178_) {
								Class365_Sub1_Sub2_Sub2 class365_sub1_sub2_sub2 = (new Class365_Sub1_Sub2_Sub2(aClass331_2619, class_ra, ((Class240_Sub1) this).aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, rotation, bool));
								...
								class365_sub1_sub2 = (new Class365_Sub1_Sub2_Sub1(aClass331_2619, class_ra, ((Class240_Sub1) this).aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, rotation, i_167_));
							aClass331_2619.method4057(i_161_, i_162_, i_163_, class365_sub1_sub2, 1853221006);
							if (1 == class432.cliped * -2144543407 && null != class289)
								class289.method2734(i_162_, i_163_, (byte) 2);
						}
					} else if ((-1976050083 * Class424.aClass424_6611.anInt6613 == type) || type == -1976050083 * (Class424.aClass424_6604.anInt6613)) {
						Class365_Sub1_Sub1_Sub6 class365_sub1_sub1_sub6 = null;
						Class365_Sub1_Sub1 class365_sub1_sub1;
						int i_179_;
						if (bool_178_) {
							Class365_Sub1_Sub1_Sub6 class365_sub1_sub1_sub6_180_ = (new Class365_Sub1_Sub1_Sub6(aClass331_2619, class_ra, ((Class240_Sub1) this).aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, i_162_, i_162_ + i_169_ - 1, i_163_, i_170_ + i_163_ - 1, type, rotation, bool));
							...
							class365_sub1_sub1 = (new Class365_Sub1_Sub1_Sub5(aClass331_2619, class_ra, ((Class240_Sub1) this).aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, i_162_, i_162_ + i_169_ - 1, i_163_, i_163_ + i_170_ - 1, type, rotation, i_167_));
							i_179_ = 15;
						}
						...
						if (class432.cliped * -2144543407 != 0 && null != class289)
							class289.method2741(i_162_, i_163_, i_169_, i_170_, class432.solid, !class432.ignoreClipOnAlternativeRoute, (byte) 15);
					} else if (CacheIndexIndicator.method1236(type, -865214392) || Class207.method1930(type, (byte) -21)) {
						Class365_Sub1_Sub1 class365_sub1_sub1;
						if (bool_178_) {
							Class365_Sub1_Sub1_Sub6 class365_sub1_sub1_sub6 = (new Class365_Sub1_Sub1_Sub6(aClass331_2619, class_ra, ((Class240_Sub1) this).aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, i_162_, i_169_ + i_162_ - 1, i_163_, i_170_ + i_163_ - 1, type, rotation, bool));
							...
							class365_sub1_sub1 = (new Class365_Sub1_Sub1_Sub5(aClass331_2619, class_ra, ((Class240_Sub1) this).aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, i_162_, i_162_ + i_169_ - 1, i_163_, i_163_ + i_170_ - 1, type, rotation, i_167_));
						aClass331_2619.method4022(class365_sub1_sub1, false, (byte) 0);
						if (aBoolean2632 && !aBoolean2629 && CacheIndexIndicator.method1236(type, 1932287279) && (-1976050083 * Class424.aClass424_6602.anInt6613 != type) && i_161_ > 0 && class432.opcode23V * -1508517619 != 0)
							aByteArrayArrayArray2637[i_161_][i_162_][i_163_] |= 0x4;
						if (0 != class432.cliped * -2144543407 && null != class289)
							class289.method2741(i_162_, i_163_, i_169_, i_170_, class432.solid, !class432.ignoreClipOnAlternativeRoute, (byte) 4);
					} else if (method2239(class_ra, type, rotation, bool_178_, class432, i_167_, i_161_, i, i_176_, i_175_, i_177_, i_162_, i_163_, bool, class_xa, class289, i_169_, i_170_, (byte) -37) || method2240(class_ra, type, rotation, bool_178_, class432, i_167_, i_161_, i, i_176_, i_175_, i_177_, i_162_, i_163_, -1189422227)) {
						/* empty */
					}
				}
			}
	...
	static final void method2244(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
