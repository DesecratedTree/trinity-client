...
public final class Class118 {
	...
	static final void method1286(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anInt5239 -= -783761378;
			if ((((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239]) < (((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239 + 1]))
	...
	static final void method1287(ClientScript2 class403, int i) {
		try {
	...
	static final void method1288(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static final void method1289(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anInt5239 -= -783761378;
	...
	static final void method1290(ClientScript2 class403, byte i) {
		try {
			int i_2_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_2_).anInt5735) * 1671807857;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1291(ClientScript2 class403, byte i) {
		try {
			Class343_Sub1 class343_sub1 = Atmosphere.method4716((byte) 21);
			if (class343_sub1 != null) {
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 1675394033 * class353.anInt3820;
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = class343_sub1.anInt7720 * 512449113;
	...
	static final void method1292(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (((ClientScript2) class403).aClass162_5252.method1751((String) (((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 -= 969361751) * -203050393)]), 131072));
		} catch (RuntimeException runtimeexception) {
	...
	public static void method1293(int i, int i_3_, int i_4_) {
		try {
			Class301_Sub1.anInt7632 = (i - Class301_Sub1.baseX) * -433609607;
			Class301_Sub1.anInt7627 = (i_3_ - Class301_Sub1.baseY) * -789877945;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("eu.ct(").append(')').toString());
		}
	}

	static final void method1294(ClientScript2 class403, int i) {
		try {
			Class390 class390 = (((ClientScript2) class403).aBoolean5261 ? ((ClientScript2) class403).aClass390_5247 : ((ClientScript2) class403).aClass390_5246);
			WidgetConfig class105 = ((Class390) class390).aClass105_4168;
			Class119 class119 = ((Class390) class390).aClass119_4167;
