...
public class Class326 {
	...
	static final void method3971(ClientScript2 class403, short i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub5_7572.method5612(i_22_, 1352882135);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method3972(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_23_, (byte) 24);
	...
	static void method3974(int i) {
		try {
			...
			class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(Class190.getDisplayMode((byte) -123));
			class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(Class422_Sub25.preferences.graphicsMode.method5677(-1547826526));
			class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(Class462.screenWidth * -2110394505, 16711935);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(Class298_Sub40_Sub9.screenHeight * -1111710645, 16711935);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(Class422_Sub25.preferences.antialiasing.method5675(-196354448));
