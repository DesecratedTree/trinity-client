...
public class IPAddress {
	...
	public Socket method6056(int i) throws IOException {
		try {
			return Loader.method6056(i);//new Socket(InetAddress.getByName(Settings.IP), 43594);
	...
	public IPAddress() {
		((IPAddress) this).aBoolean5952 = false;
	}

	public void method6058(int i) {
		try {
			if (!((IPAddress) this).aBoolean5956) {
				((IPAddress) this).aBoolean5956 = true;
				((IPAddress) this).aBoolean5952 = true;
			} else if (((IPAddress) this).aBoolean5952)
				((IPAddress) this).aBoolean5952 = false;
			else
				((IPAddress) this).aBoolean5956 = false;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method6059(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_1_).value) * 785788887;
		} catch (RuntimeException runtimeexception) {
