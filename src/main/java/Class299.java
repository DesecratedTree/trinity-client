...
public class Class299 {
	...
	LinkedList<Class365_Sub1_Sub1_Sub4> aLinkedList3198;
	...
	public void method3676(Class331 class331, int i) {
		try {
			if (null != class331 && ((Class299) this).anInt3193 * -755722761 > 0) {
				...
				Iterator<Class365_Sub1_Sub1_Sub4> iterator = ((Class299) this).aLinkedList3198.iterator();
	...
	void method3678(Class331 class331, int i) {
		try {
			((Class299) this).aLinkedList3198 = new LinkedList<Class365_Sub1_Sub1_Sub4>();
			Class244 class244 = client.aClass283_8716.method2654(1102233653);
			Map class341 = client.aClass283_8716.method2628(681479919);
			Map class341_3_ = new Map(1855729883 * Class99.anInt952, ((Class299) this).anIntArray3194[0], ((Class299) this).anIntArray3196[0]);
			for (int i_4_ = 1; i_4_ < ((Class299) this).anInt3193 * -755722761; i_4_++) {
				Map class341_5_ = new Map(1855729883 * Class99.anInt952, ((Class299) this).anIntArray3194[i_4_], ((Class299) this).anIntArray3196[i_4_]);
				while ((class341_3_.gameSceneBaseX * -1760580017 != class341_5_.gameSceneBaseX * -1760580017) || (class341_5_.gameSceneBaseY * 283514611 != 283514611 * class341_3_.gameSceneBaseY)) {
					...
					if (i_7_ >= 0 && i_7_ < class331.anInt3514 * 1988988347 && i_8_ >= 0 && i_8_ < class331.anInt3549 * 1340714547) {
						...
						if (class244.method2320(i_7_, i_8_, 1621681169))
							i_6_++;
						((Class299) this).aLinkedList3198.add(new Class365_Sub1_Sub1_Sub4(class331, this, Class99.anInt952 * 1855729883, i_6_, i_9_, Class356.getPlayerHeight(i_9_, i_10_, (1855729883 * Class99.anInt952), -969266952), i_10_));
					}
				}
	...
	Class387 method3679(GraphicsToolkit class_ra, int i) {
		try {
			Model class64 = Model.loadModel(Map.aClass243_3646, -1002982425 * ((Class299) this).anInt3195, 0);
			if (class64 == null)
				return null;
	...
	static final void method3681(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_11_, (byte) 16);
