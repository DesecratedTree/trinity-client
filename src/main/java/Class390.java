...
public class Class390 {
	...
	WidgetConfig aClass105_4168;

	boolean method4866(Class119 class119, int i, int i_0_, int i_1_) {
		try {
			if (class119 != null) {
				WidgetConfig class105 = class119.method1297(i, (short) 15753);
				if (null != class105) {
	...
	boolean method4867(int i, int i_2_, int i_3_) {
		try {
			WidgetConfig class105 = Class140.method1558(i, i_2_, -156511736);
			if (class105 != null) {
	...
	WidgetConfig method4868(int i) {
		try {
			return (((Class390) this).aClass119_4167.method1297(((Class390) this).aClass105_4168.uid * -440872681, (short) 10433));
		} catch (RuntimeException runtimeexception) {
