...
public class Class61 {
	...
	OpenGLLegacyToolkit aClass_ra_Sub2_606;
	...
	Class30_Sub2 method716(int i, int i_0_) {
		Object object = ((Class61) this).aClass348_605.get((long) i);
		if (object != null)
			return (Class30_Sub2) object;
		if (!((Class61) this).anInterface_ma604.method170(i, (short) 25920))
			return null;
		TextureConfig class53 = ((Class61) this).anInterface_ma604.method174(i, 107897040);
		if (i_0_ == -1)
			i_0_ = (class53.largeTexture ? 64 : (((OpenGLLegacyToolkit) ((Class61) this).aClass_ra_Sub2_606).anInt8118));
		...
		if (!class53.aBoolean543 || !((Class61) this).aClass_ra_Sub2_606.method5054()) {
			...
			class30_sub2 = new Class30_Sub2(((Class61) this).aClass_ra_Sub2_606, 3553, i_0_, i_0_, class53.alpha != 0, is, 0, 0, false);
		} else {
			float[] fs = ((Class61) this).anInterface_ma604.method181(i, 0.7F, i_0_, i_0_, false, (byte) -119);
			class30_sub2 = new Class30_Sub2(((Class61) this).aClass_ra_Sub2_606, 3553, Class55.aClass55_557, Class77.aClass77_714, i_0_, i_0_, class53.alpha != 0, fs, Class55.aClass55_557);
		}
	...
	Class61(OpenGLLegacyToolkit class_ra_sub2, Interface_ma interface_ma) {
