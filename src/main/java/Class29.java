...
public class Class29 {
	int anInt365;
	OpenGLLegacyToolkit aClass_ra_Sub2_366;
	static int[] anIntArray367 = new int[2];

	static Class29 method406(OpenGLLegacyToolkit class_ra_sub2, Class48[] class48s) {
	...
	Class29(OpenGLLegacyToolkit class_ra_sub2, int i, Class48[] class48s) {
