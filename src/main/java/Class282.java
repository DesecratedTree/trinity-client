...
public class Class282 implements Interface21 {
	...
	static void method2618(Class298_Sub37_Sub15 option, int i) {
		try {
			if (option != null) {
				Class436.aClass453_5480.add(option, 2096333345);
				Class436.anInt5506 += -970198067;
				Class298_Sub37_Sub5 class298_sub37_sub5;
				if (!((Class298_Sub37_Sub15) option).aBoolean9668 && !"".equals(((Class298_Sub37_Sub15) option).aString9657)) {
					long l = ((((Class298_Sub37_Sub15) option).aLong9666) * 6619564980435866523L);
					for (class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass437_5470.method5812(l)); class298_sub37_sub5 != null; class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass437_5470.method5813(-1492262664))) {
						if (((Class298_Sub37_Sub5) class298_sub37_sub5).aString9585.equals(((Class298_Sub37_Sub15) option).aString9657)) {
							if (i <= 1583252452)
					...
					if (class298_sub37_sub5 == null) {
						class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass348_5464.get(l));
						if (class298_sub37_sub5 != null && !(((Class298_Sub37_Sub5) class298_sub37_sub5).aString9585.equals(((Class298_Sub37_Sub15) option).aString9657)))
							class298_sub37_sub5 = null;
						if (class298_sub37_sub5 == null)
							class298_sub37_sub5 = (new Class298_Sub37_Sub5(((Class298_Sub37_Sub15) option).aString9657));
				...
				if (class298_sub37_sub5.method3416(option, -1961303764))
	...
	public static Class336 method2619(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		try {
	...
	static void method2620(ClientScript2 class403, byte i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (class369.anIntArray4023 == null ? 0 : class369.anIntArray4023.length);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("ls.g(").append(')').toString());
		}
	}

	static final void method2621(ClientScript2 class403, int i) {
		try {
			String string = (ClientScriptsExecutor.aStringArray4126[(((ClientScript2) class403).integerstack[((ClientScript2) class403).integerPos * 1883543357])]);
			if (null == string)
				string = "";
	...
	public static void method2622(int i) {
		try {
			WidgetConfig.aClass348_1135.method4189();
			WidgetConfig.aClass348_1138.method4189();
			WidgetConfig.aClass348_1136.method4189();
			WidgetConfig.aClass348_1296.method4189();
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2623(int i, int i_4_, int i_5_, int i_6_, int i_7_) {
		try {
			if (i >= -1424479739 * Class372_Sub2.anInt4051 && i <= 1135094847 * Class372_Sub2.anInt4048) {
				i_4_ = Class463.method6012(i_4_, 1155384281 * Class372_Sub2.anInt4049, (Class372_Sub2.anInt4050 * -1062447355), -1212608691);
				i_5_ = Class463.method6012(i_5_, 1155384281 * Class372_Sub2.anInt4049, (-1062447355 * Class372_Sub2.anInt4050), -1212608691);
	...
	static void method2625(int i) {
		try {
			...
			Class460.method5981((122690138525332847L * Class360.usernameL == -1L), true, "", "", Class360.usernameL * 122690138525332847L);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("ls.v(").append(')').toString());
		}
	}

	static final void method2626(ClientScript2 class403, int i) {
		try {
			int i_8_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_8_, (byte) -41);
			Class119 class119 = Class389.aClass119Array4165[i_8_ >> 16];
			WidgetDetails.method4582(class105, class119, class403, -1887827595);
		} catch (RuntimeException runtimeexception) {
