...
public class Class463 {
	...
	public static CacheIndex MIDI_INDEX;
	...
	static final void method6010(ClientScript2 class403, int i) {
		try {
			int i_4_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_4_, (byte) -30);
	...
	static void method6011(GraphicsToolkit class_ra, int i) {
		try {
	...
	static void drawMenu(GraphicsToolkit class_ra, byte i) {
		try {
