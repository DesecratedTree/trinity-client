...
public class Class409 {
	...
	public Class409(Map class341, int i, int i_0_, int i_1_) {
	...
	static final void method4973(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
	...
	static final void method4975(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(-192114923);
		} catch (RuntimeException runtimeexception) {
	...
	public static Frame method4976(Class457 class457, int i, int i_5_, int i_6_, int i_7_, int i_8_) {
		try {
			if (0 == i_6_) {
				Class456[] class456s = CacheIndexIndicator.method1238(class457, (short) 486);
				if (class456s == null)
					return null;
				boolean bool = false;
	...
	static final void method4977(ClientScript2 class403, int i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub11_7558, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]), 417121289);
