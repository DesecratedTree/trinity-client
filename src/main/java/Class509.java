...
public class Class509 {
	...
	Interface5 method6284(RsByteBuffer class298_sub53, Class146 class146, int i) {
		try {
			...
			if (class146 == Class146.aClass146_1565)
				return NPCConfig.method6247(class298_sub53, 1486124265);
	...
	static final void method6285(ClientScript2 class403, byte i) {
		try {
			...
			if (i_2_ >= 1 && i_2_ <= 5 && class468.groundOptions[i_2_ - 1] != null)
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = class468.groundOptions[i_2_ - 1];
			else
