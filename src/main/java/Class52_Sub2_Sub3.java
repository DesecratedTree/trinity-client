...
public class Class52_Sub2_Sub3 extends Class52_Sub2 {
	OpenGLLegacyToolkit aClass_ra_Sub2_9081;
	Canvas aCanvas9082;
	OpenGL anOpenGL9083;
	long aLong9084;
	int anInt9085;
	...
	boolean method136() {
		if (((Class52_Sub2_Sub3) this).released)
	...
	public int method552() {
		return (int) (((Class52_Sub2_Sub3) this).anInt9086 );
	}
	...
	Class52_Sub2_Sub3(OpenGLLegacyToolkit class_ra_sub2, Canvas canvas) {
		this(class_ra_sub2, canvas, ((OpenGLLegacyToolkit) class_ra_sub2).anOpenGL8116.prepareSurface(canvas));
	}
	...
	public void method138() {
		...
		((Class52_Sub2_Sub3) this).released = true;
	}
	...
	Class52_Sub2_Sub3(OpenGLLegacyToolkit class_ra_sub2, Canvas canvas, long l) {
		((Class52_Sub2_Sub3) this).aClass_ra_Sub2_9081 = class_ra_sub2;
		((Class52_Sub2_Sub3) this).aCanvas9082 = canvas;
		((Class52_Sub2_Sub3) this).anOpenGL9083 = ((OpenGLLegacyToolkit) class_ra_sub2).anOpenGL8116;
