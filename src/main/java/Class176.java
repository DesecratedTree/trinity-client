...
public class Class176 {
	...
	void method1827(ModernToolkit class_ra_sub3) {
	...
	void method1829(ModernToolkit class_ra_sub3, Class69 class69) {
		...
		Class130 class130 = ((ModernToolkit) class_ra_sub3).aClass130_8249;
		class130.method1452(Matrix.aClass233_2595);
		...
		while (class302_sub3_9_ != class302_sub3) {
			...
			class130.anInterface9_Impl2_1492 = ((ModernToolkit) class_ra_sub3).aClass157_8351.method1698(i_10_ >= 0 ? i_10_ : -1);
	...
	void method1830(ModernToolkit class_ra_sub3, int i) {
		int i_15_ = 0;
		Matrix class233 = class_ra_sub3.aClass233_8230;
		...
		for (int i_30_ = i - 1; i_30_ >= 0; i_30_--) {
			...
			if (i_31_ > 0) {
				for (int i_32_ = i_31_ - 1; i_32_ >= 0; i_32_--) {
					...
					int i_33_ = class302_sub3_sub1.anInt9792;
					...
					if (((ModernToolkit) class_ra_sub3).anInt8346 == 0) {
				...
				if (((Class176) this).anIntArray1781[i_30_] > 64) {
					...
					for (int i_43_ = ((Class176) this).anIntArray1782[i_42_] - 1; i_43_ >= 0; i_43_--) {
						...
						int i_44_ = class302_sub3_sub1.anInt9792;
	...
	Class176(ModernToolkit class_ra_sub3) {
