...
public class Class347 {
	...
	public Class358 method4176(int i, int i_0_) {
		try {
			...
			synchronized (((Class347) this).aClass243_3698) {
				is = (((Class347) this).aClass243_3698.getFileFromArchive(-1006924897 * ConfigFile.aClass120_1451.anInt1460, i, (byte) -66));
			}
	...
	public Class347(Class411 class411, Class429 class429, CacheIndex class243, CacheIndex class243_2_) {
		...
		((Class347) this).aClass243_3698.method2316((ConfigFile.aClass120_1451.anInt1460) * -1006924897, -790264977);
	}
	...
	static final void method4181(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_3_, (byte) -22);
