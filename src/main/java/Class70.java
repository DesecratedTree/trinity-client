...
public final class Class70 {
	...
	public int method798(int i, int i_0_) {
		try {
			IntegerValue class298_sub35 = ((IntegerValue) ((Class70) this).aClass437_683.method5812((long) i));
	...
	public int method799(int i, int i_1_) {
		try {
			...
			return ((method798(i_2_, 1116679673) & i_3_) >>> -1528472107 * class327.startinBit);
		} catch (RuntimeException runtimeexception) {
	...
	public void method800(int i, int i_4_, byte i_5_) {
		try {
			if (((Class70) this).aClass437_683 == null)
				((Class70) this).aClass437_683 = new LinkedArrayList(1793476641 * ((Class70) this).anInt682);
			IntegerValue class298_sub35 = ((IntegerValue) ((Class70) this).aClass437_683.method5812((long) i));
			if (null != class298_sub35)
				class298_sub35.intValue = i_4_ * -898670337;
			else {
				class298_sub35 = new IntegerValue(i_4_);
	...
	static void method802(GraphicsToolkit class_ra, int i, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_) {
		try {
			...
			if (null != interface3) {
				ObjectConfig class432 = (client.aClass283_8716.method2641(-1178105216).getObjectDefinitions(interface3.method32((byte) 20)));
				int i_14_ = interface3.method30((short) 12592) & 0x3;
				int i_15_ = interface3.method29(726839210);
				if (-1 != -1204256389 * class432.objectIconID)
					Class82.method871(class_ra, class432, i_14_, i_9_, i_10_, (byte) 112);
				else {
					int i_16_ = i_11_;
					if (1532834983 * class432.optionType > 0)
						i_16_ = i_12_;
			...
			if (null != interface3) {
				ObjectConfig class432 = (client.aClass283_8716.method2641(-258471564).getObjectDefinitions(interface3.method32((byte) -26)));
				int i_17_ = interface3.method30((short) 29260) & 0x3;
				int i_18_ = interface3.method29(726839210);
				if (-1204256389 * class432.objectIconID != -1)
			...
			if (null != interface3) {
				ObjectConfig class432 = (client.aClass283_8716.method2641(541526744).getObjectDefinitions(interface3.method32((byte) 49)));
	...
	public static void method803(int i, String string, int i_21_, int i_22_) {
		try {
			...
			if (class298_sub37_sub17 != null) {
				...
				((ClientScript2) class403).stringstack = new String[class298_sub37_sub17.anInt9680 * 1787035509];
				((ClientScript2) class403).stringstack[0] = string;
		...
		try {
			...
			if (i_29_ < 3) {
				...
				if (i_31_ < 1 || i_32_ < 1 || (i_31_ > client.aClass283_8716.method2629(-1988640932) - 1) || (i_32_ > client.aClass283_8716.method2630(-694658273) - 1))
					return 0;
				boolean bool = 0 != ((class244.terrainSettings[1][i >> 9][i_26_ >> 9]) & 0x2);
				if ((i & 0x1ff) == 0) {
					boolean bool_33_ = (((class244.terrainSettings[1][i_31_ - 1][i_26_ >> 9]) & 0x2) != 0);
					boolean bool_34_ = 0 != ((class244.terrainSettings[1][i_31_][i_26_ >> 9]) & 0x2);
					if (bool_34_ != bool_33_)
						bool = 0 != ((class244.terrainSettings[1][i_27_][i_28_]) & 0x2);
				}
				if ((i_26_ & 0x1ff) == 0) {
					boolean bool_35_ = (((class244.terrainSettings[1][i >> 9][i_32_ - 1]) & 0x2) != 0);
					boolean bool_36_ = ((class244.terrainSettings[1][i >> 9][i_32_] & 0x2) != 0);
					if (bool_36_ != bool_35_)
						bool = ((class244.terrainSettings[1][i_27_][i_28_]) & 0x2) != 0;
				}
				if (bool)
					i_29_++;
			}
