...
public abstract class Class309 {
	final int method3787(long l) {
		try {
			long l_0_ = method3789(-2070209737); //caps fps
			if (l_0_ > 0L)
	...
	static final void method3800(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anInt5239 -= -783761378;
			int i_1_ = (((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239]);
			int i_2_ = (((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239 + 1]);
	...
	static final void method3801(ClientScript2 class403, int i) {
		try {
	...
	static final void method3802(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anInt5239 -= -783761378;
			class105.scrollWidth = (-1609060375 * (((ClientScript2) class403).anIntArray5244[((ClientScript2) class403).anInt5239 * 681479919]));
			class105.scrollHeight = (-1638942269 * (((ClientScript2) class403).anIntArray5244[1 + 681479919 * ((ClientScript2) class403).anInt5239]));
	...
	static final void method3803(ClientScript2 class403, int i) {
		try {
			Class390 class390 = (((ClientScript2) class403).aBoolean5261 ? ((ClientScript2) class403).aClass390_5247 : ((ClientScript2) class403).aClass390_5246);
			WidgetConfig class105 = ((Class390) class390).aClass105_4168;
	...
	static boolean method3804(int i) {
		try {
			...
			if (null == Class98_Sub2.aClass89_6932) {
				if (Class158.aClass243_6364.method2310((Class410.anInt5290 * 2131310071), -457216440))
					Class98_Sub2.aClass89_6932 = Class89.getSprite(Class158.aClass243_6364, Class410.anInt5290 * 2131310071);
				else
					bool = false;
			}
			if (Class422_Sub30.aClass89_8437 == null) {
				if (Class158.aClass243_6364.method2310(1636425877 * Class14.anInt174, -457216440))
					Class422_Sub30.aClass89_8437 = Class89.getSprite(Class158.aClass243_6364, 1636425877 * Class14.anInt174);
				else
					bool = false;
			}
			if (null == Atmosphere.aClass89_4142) {
				if (Class158.aClass243_6364.method2310((1475733439 * Class318.anInt3323), -457216440))
					Atmosphere.aClass89_4142 = Class89.getSprite(Class158.aClass243_6364, Class318.anInt3323 * 1475733439);
				else
					bool = false;
			}
			...
			if (Class14.aClass89Array169 == null) {
				if (Class158.aClass243_6364.method2310(-227610265 * Class14.anInt168, -457216440))
					Class14.aClass89Array169 = Class89.method981(Class158.aClass243_6364, -227610265 * Class14.anInt168);
				else
					bool = false;
			}
			return bool;
