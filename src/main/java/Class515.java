...
public class Class515 {
	CacheIndex gameTipsFolder;
	Class521[] aClass521Array6230;
	static int anInt6231 = 0;
	int anInt6232;
	static long aLong6233;

	public Class510[] loadGameTip(int i, int i_0_) {
		try {
			if (i < 0 || i >= ((Class515) this).aClass521Array6230.length) //disables load
	...
	public Class509 method6295(int i, byte i_4_) {
		try {
			byte[] is = ((Class515) this).gameTipsFolder.getFileFromArchive(i, 0, (byte) -111);
	...
	public Class515(Class411 class411, Class429 class429, CacheIndex class243) {
		((Class515) this).gameTipsFolder = class243;
		RsByteBuffer class298_sub53 = new RsByteBuffer(((Class515) this).gameTipsFolder.getFileFromArchive(0, 0, (byte) -99));
