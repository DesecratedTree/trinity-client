...
public class Class365_Sub1_Sub1_Sub6 extends Class365_Sub1_Sub1 implements Interface3 {
	...
	public void method40(GraphicsToolkit class_ra) {
		...
		if (class_na != null)
			aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 612367667);
	}
	...
	public Class334 method4358(GraphicsToolkit class_ra, byte i) {
		try {
			...
			if (((Class365_Sub1_Sub1_Sub6) this).aClass334_9882 == null)
				((Class365_Sub1_Sub1_Sub6) this).aClass334_9882 = Class472.method6063((int) class217.x, (int) class217.aFloat2455, (int) class217.y, method4491(class_ra, 0, 720922451), 2111696382);
	...
	public void method28(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (null != class_na)
			aClass331_7722.method4055(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 1156448479);
	}
	...
	public void method44(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (class_na != null)
			aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 1005842960);
	}
	...
	Class335 drawFloor(GraphicsToolkit class_ra, int i) {
		try {
			...
			((Class365_Sub1_Sub1_Sub6) this).aClass387_9879.drawModel(class222, aClass302_Sub1Array7726[0], 0);
			return class335;
		} catch (RuntimeException runtimeexception) {
	...
	public void method43(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (class_na != null)
			aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 2123208646);
	}

	public Class365_Sub1_Sub1_Sub6(Class331 class331, GraphicsToolkit class_ra, Class433 class433, ObjectConfig class432, int i, int i_7_, int i_8_, int i_9_, int i_10_, boolean bool, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_, boolean bool_17_) {
		super(class331, i, i_7_, i_8_, i_9_, i_10_, i_11_, i_12_, i_13_, i_14_, 512737201 * class432.opcode75V == 1, Class79.method848(i_15_, i_16_, (byte) 27));
		((Class365_Sub1_Sub1_Sub6) this).aClass433_9884 = class433;
		((Class365_Sub1_Sub1_Sub6) this).anInt9883 = class432.id * 1514496897;
		aByte7724 = (byte) i_7_;
		...
		((Class365_Sub1_Sub1_Sub6) this).aBoolean9888 = 0 != 1532834983 * class432.optionType && !bool;
		((Class365_Sub1_Sub1_Sub6) this).aBoolean9889 = bool_17_;
		((Class365_Sub1_Sub1_Sub6) this).aBoolean9887 = (class_ra.method5082() && class432.scenaryShadows && !((Class365_Sub1_Sub1_Sub6) this).aBoolean9886 && Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(3122198) != 0);
		int i_18_ = 2048;
	...
	public Class334 method4367(GraphicsToolkit class_ra) {
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (((Class365_Sub1_Sub1_Sub6) this).aClass334_9882 == null)
			((Class365_Sub1_Sub1_Sub6) this).aClass334_9882 = Class472.method6063((int) class217.x, (int) class217.aFloat2455, (int) class217.y, method4491(class_ra, 0, 489982768), 2048305004);
		return ((Class365_Sub1_Sub1_Sub6) this).aClass334_9882;
	}
	...
	public Class334 method4368(GraphicsToolkit class_ra) {
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (((Class365_Sub1_Sub1_Sub6) this).aClass334_9882 == null)
			((Class365_Sub1_Sub1_Sub6) this).aClass334_9882 = Class472.method6063((int) class217.x, (int) class217.aFloat2455, (int) class217.y, method4491(class_ra, 0, 2128967957), 2011596409);
		return ((Class365_Sub1_Sub1_Sub6) this).aClass334_9882;
	}

	Class454 method4492(GraphicsToolkit class_ra, int i, boolean bool, int i_19_) {
		try {
			ObjectConfig class432 = (((Class365_Sub1_Sub1_Sub6) this).aClass433_9884.getObjectDefinitions(((Class365_Sub1_Sub1_Sub6) this).anInt9883 * 614847827));
			Class_xa class_xa;
	...
	public void method37(GraphicsToolkit class_ra, int i) {
		try {
			...
			SceneObjectPosition class217 = method4337().aClass217_2599;
			if (class_na != null)
				aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 1871597287);
		} catch (RuntimeException runtimeexception) {
	...
	public void method33(GraphicsToolkit class_ra, int i) {
		try {
			...
			SceneObjectPosition class217 = method4337().aClass217_2599;
			if (null != class_na)
				aClass331_7722.method4055(class_na, aByte7724, (int) class217.x, (int) class217.y, null, -808327981);
		} catch (RuntimeException runtimeexception) {
