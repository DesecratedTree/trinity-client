...
public class SubIncommingPacket {
	...
	static void method1919(int i) {
		try {
			JagexFile2 class476 = null;
			try {
				class476 = Class86.getPreferences("2", client.aClass411_8944.aString5317, false, -1804643872);
	...
	static final void method1921(byte i) {
		try {
			Class365_Sub1_Sub1_Sub6.method4494(FloorOverlay.graphics, 556951212);
	...
	static final void method1923(int i) {
		try {
			if (Class299.method3682(-1233866115 * client.anInt8752, 1765230881) || Class413.method5584(-1233866115 * client.anInt8752, 1927636725))
				...
				Class422_Sub21.aClass318_8414 = client.aClass25_8711.method387(537308016);
				client.aClass25_8711.method385(865497912);
	...
	static void method1925(Class502 class502, int i, int i_6_, ClientScript2 class403, int i_7_) {
		try {
			...
			if (null == class298_sub37_sub17)
				...
				class403.scriptID = class298_sub37_sub17.id;
				((ClientScript2) class403).anIntArray5248 = new int[class298_sub37_sub17.anInt9679 * -1516159487];
				((ClientScript2) class403).stringstack = new Object[1787035509 * class298_sub37_sub17.anInt9680];
				if ((class298_sub37_sub17.aClass502_9678 == Class502.aClass502_6727) || (Class502.aClass502_6721 == class298_sub37_sub17.aClass502_9678) || (Class502.aClass502_6718 == class298_sub37_sub17.aClass502_9678)) {
					...
					if (Class113.aClass105_1373 != null) {
						i_8_ = 1354508417 * Class113.aClass105_1373.xOnScreen;
						i_9_ = Class113.aClass105_1373.yOnScreen * -749038817;
					}
					((ClientScript2) class403).anIntArray5248[0] = (Class165.aClass319_6366.method3894((byte) -93) - i_8_);
					((ClientScript2) class403).anIntArray5248[1] = (Class165.aClass319_6366.method3883((byte) -71) - i_9_);
