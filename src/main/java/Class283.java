...
public class Class283 {
	...
	int anInt3015;
	int anInt3016;
	WorldMapArea aClass298_Sub37_Sub13_3017;
	...
	void decode(Class240_Sub1 class240_sub1, byte[][] data, byte[][] mapData, byte i) {
		try {
			for (int i_0_ = 0; i_0_ < 1551623871 * class240_sub1.planeCount; i_0_++) {
				if (!aBoolean3018) {
					...
					for (int i_2_ = 0; i_2_ < anInt3011 * -1456212765 >> 3; i_2_++) {
						...
						if (-1 != i_3_) {
							...
							if (!class240_sub1.aBoolean2629 || i_4_ == 0) {
								...
								for (int i_9_ = 0; i_9_ < (mapIDs).length; i_9_++) {
									boolean osrs = Settings.isOSRSMap((mapIDs[i_9_]));
									byte[] byteData = osrs ? mapData[i_9_] : data[i_9_];
									
									if (i_8_ == (mapIDs[i_9_]) && null != byteData) {
										RsByteBuffer class298_sub53 = new RsByteBuffer(byteData);
										class240_sub1.decode(osrs, class298_sub53, i_0_, i_1_ * 8, i_2_ * 8, i_4_, i_6_, i_7_, i_5_, (SCENE_CLIP_DATA_PLANES), -828677341);
										class240_sub1.decodeScene(osrs, mapIDs[i_9_], FloorOverlay.graphics, class298_sub53, i_0_, 8 * i_1_, 8 * i_2_, i_4_, i_6_, i_7_, i_5_, -2145736118);
										break;
									}
								}
							}
			...
			for (int i_10_ = 0; i_10_ < 1551623871 * class240_sub1.planeCount; i_10_++) {
				if (!aBoolean3018) {
	...
	public void method2647(int i) {
		try {
			aClass364_3013 = new Class364(FloorOverlay.graphics, -991330803 * anInt3039 >> 3, anInt3011 * -1456212765 >> 3);
		} catch (RuntimeException runtimeexception) {
	...
	public void method2648(int i) {
		try {
			...
			if (FloorOverlay.graphics.method4998()) {
				anInt3016 += 109412864;
				anInt3016 += Settings.EXTRA_DRAW_DISTANCE * 109412864;
			}
		} catch (RuntimeException runtimeexception) {
		...
		try {
			if (aClass266_3001 != Class266.aClass266_2846 && (Class266.aClass266_2846 != aClass266_3004)) {
				if (aClass266_3001 == Class266.LOAD_MAP_SCENE_DYNAMIC || (aClass266_3001 == Class266.aClass266_2845) || ((aClass266_3004 != aClass266_3001) && ((Class266.LOAD_MAP_SCENE_NORMAL == aClass266_3001) || (aClass266_3004 == Class266.LOAD_MAP_SCENE_NORMAL)))) {
					client.anInt8703 = 0;
					client.npcCount = 0;
					client.aClass437_8696.clear((byte) -6);
				}
	...
	public void sendMapScene(Class267 class267, int i) {
		try {
			...
			if (aClass266_3001 == Class266.LOAD_MAP_SCENE_BG) {
				loadMapSceneBackground(-1676557011);
	...
	void loadMapSceneBackground(int i) {
		try {
			method2655(Class94.method1020(Class422_Sub25.preferences.aClass422_Sub11_7558.method5667(-369768513), 2010588610), 226677224);
		...
		try {
			...
			if (bool || anInt3030 * 19679283 != i || i_57_ != anInt3009 * 306966675) {
				...
				if (!aBoolean3018) {
					...
					Class139.drawText(Tradution.aClass470_5874.method6049(Class321.aClass429_3357, -875414210), true, FloorOverlay.graphics, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) 103);
				}
				if (aClass341_3006 != null) {
					aClass341_3007 = aClass341_3006;
				} else {
					aClass341_3007 = new Map(0, 0, 0);
				}
				aClass341_3006 = new Map(0, 8 * (anInt3030 * 19679283 - ((-991330803 * anInt3039) >> 4)), 8 * (306966675 * anInt3009 - ((anInt3011 * -1456212765) >> 4)));
				...
				if (Class422_Sub25.preferences.aClass422_Sub14_7570.method5677(-1847672596) == 1 && FloorOverlay.graphics.za() > 100663296) //too much memmory
	...
	void decodeStatic(Class240_Sub1 class240_sub1, byte[][] is, byte[][] mapData, short i) {
		try {
			int i_61_ = is.length;
			for (int i_62_ = 0; i_62_ < i_61_; i_62_++) {
				boolean osrs = Settings.isOSRSMap(mapIDs[i_62_]);
				byte[] is_63_ = osrs ? mapData[i_62_] : is[i_62_];
				if (null != is_63_) {
					RsByteBuffer class298_sub53 = new RsByteBuffer(is_63_);
					int i_64_ = mapIDs[i_62_] >> 8;
					int i_65_ = mapIDs[i_62_] & 0xff;
					...
					class240_sub1.decodeTileTerrain(mapIDs[i_62_], osrs, class298_sub53, i_66_, i_67_, -1760580017 * (aClass341_3006.gameSceneBaseX), (aClass341_3006.gameSceneBaseY) * 283514611, (SCENE_CLIP_DATA_PLANES), -391880689);
					class240_sub1.method2235(mapIDs[i_62_], osrs, FloorOverlay.graphics, class298_sub53, i_66_, i_67_, (byte) -72);
				}
			}
			for (int i_68_ = 0; i_68_ < i_61_; i_68_++) {
				int i_69_ = ((mapIDs[i_68_] >> 8) * 64 - (aClass341_3006.gameSceneBaseX * -1760580017));
				int i_70_ = ((mapIDs[i_68_] & 0xff) * 64 - (aClass341_3006.gameSceneBaseY * 283514611));
				boolean osrs = Settings.isOSRSMap(mapIDs[i_68_]);
				byte[] is_71_ = osrs ? mapData[i_68_] : is[i_68_];
	...
	void method2660(Class240_Sub1 class240_sub1, byte[][] is, byte i) {
		try {
			int i_72_ = mapData.length;
			for (int i_73_ = 0; i_73_ < i_72_; i_73_++) {
				byte[] is_74_ = is[i_73_];
				if (is_74_ != null) {
					int i_75_ = (64 * (mapIDs[i_73_] >> 8) - (-1760580017 * aClass341_3006.gameSceneBaseX));
					int i_76_ = ((mapIDs[i_73_] & 0xff) * 64 - 283514611 * (aClass341_3006.gameSceneBaseY));
					boolean osrs = Settings.isOSRSMap(mapIDs[i_73_]);
					if (!aBoolean3018) {
						Class247.method2365(-802890876);
					}
					class240_sub1.method2237(osrs, FloorOverlay.graphics, is_74_, i_75_, i_76_, (SCENE_CLIP_DATA_PLANES), 1861855341);
					if (aBoolean3018) {
			...
			for (int i_78_ = 0; i_78_ < i_77_; i_78_++) {
				if (aByteArrayArray3044[i_78_] == null) {
					...
					for (int i_80_ = 0; i_80_ < client.anInt8721 * -160072615; i_80_++) {
						if (mapIDs[i_78_] == client.anIntArray8751[i_80_]) {
							i_79_ = i_80_;
							break;
						}
					}
					if (i_79_ == -1) {
						client.anIntArray8751[client.anInt8721 * -160072615] = mapIDs[i_78_];
					...
					while ((385051775 * class298_sub53.index < (aByteArrayArray3044[i_78_]).length) && i_81_ < 511) {
						...
						int i_87_ = (64 * (mapIDs[i_78_] >> 8) - (aClass341_3006.gameSceneBaseX * -1760580017) + i_85_);
						int i_88_ = (i_86_ + (64 * (mapIDs[i_78_] & 0xff) - (aClass341_3006.gameSceneBaseY * 283514611)));
						NPCConfig class503 = (Class15.aClass507_224.method6269(class298_sub53.readUnsignedShort(), -806262033));
						ObjectValue class298_sub29 = ((ObjectValue) client.aClass437_8696.method5812(i_82_));
						if (class298_sub29 == null && (class503.movementCapabilities & 0x1) > 0 && i_87_ >= 0 && (-2095128707 * class503.anInt6187 + i_87_ < -991330803 * anInt3039) && i_88_ >= 0 && (i_88_ + class503.anInt6187 * -2095128707 < anInt3011 * -1456212765)) {
							NPC class365_sub1_sub1_sub2_sub1 = (new NPC(aClass331_3037));
							class365_sub1_sub1_sub2_sub1.anInt10064 = i_82_ * 1714292119;
							ObjectValue class298_sub29_89_ = (new ObjectValue(class365_sub1_sub1_sub2_sub1));
							client.aClass437_8696.method5817(class298_sub29_89_, i_82_);
							client.npcs[((client.npcCount += -118843751) * 1962237353) - 1] = class298_sub29_89_;
							...
							class365_sub1_sub1_sub2_sub1.setConfig(class503, 1908625985);
							class365_sub1_sub1_sub2_sub1.method4421((class365_sub1_sub1_sub2_sub1.config.anInt6187) * -2095128707, -948262466);
							class365_sub1_sub1_sub2_sub1.anInt10115 = (-1927065533 * (class365_sub1_sub1_sub2_sub1.config.opcode103V) << 3) * -1186616623;
							class365_sub1_sub1_sub2_sub1.method4415((class365_sub1_sub1_sub2_sub1.config.aClass274_6183.method2567((byte) 73).method242(694163818) << 11 & 0x3fff), true, 822135678);
	...
	void method2663(int i, int i_90_) {
		try {
			...
			if (17 == i) {
				for (int i_93_ = 0; i_93_ < 1962237353 * client.npcCount; i_93_++) {
					ObjectValue class298_sub29 = client.npcs[i_93_];
					if (null != class298_sub29) {
						...
						class217.x -= 512 * i_91_;
						class217.y -= i_92_ * 512;
						class365_sub1_sub1_sub2_sub1.setPosition(class217);
						class217.method2006();
					}
				}
			} else {
				...
				for (int i_97_ = 0; i_97_ < client.npcCount * 1962237353; i_97_++) {
					ObjectValue node = client.npcs[i_97_];
					if (null != node) {
						NPC npc = ((NPC) node.value);
						SceneObjectPosition class217 = SceneObjectPosition.method2005(npc.method4337().aClass217_2599);
						class217.x -= 512 * i_91_;
						class217.y -= 512 * i_92_;
						npc.setPosition(class217);
						if ((int) class217.x < 0 || (int) class217.x > i_95_ || (int) class217.y < 0 || (int) class217.y > i_96_) {
							npc.setConfig(null, 1741344135);
							node.remove(-1460969981);
							trim = true;
						} else {
							boolean bool_98_ = true;
							for (int i_99_ = 0; i_99_ < (npc.scenePositionXQueue).length; i_99_++) {
								npc.scenePositionXQueue[i_99_] -= i_91_;
								npc.scenePositionYQueue[i_99_] -= i_92_;
								if ((npc.scenePositionXQueue[i_99_]) < 0 || ((npc.scenePositionXQueue[i_99_]) >= (anInt3039 * -991330803)) || (npc.scenePositionYQueue[i_99_]) < 0 || ((npc.scenePositionYQueue[i_99_]) >= (anInt3011 * -1456212765))) {
									bool_98_ = false;
								}
							}
							if (bool_98_) {
								client.anIntArray8699[((client.anInt8703 += -409937273) * -1230451913) - 1] = (npc.anInt10064 * 1888274983);
							} else {
								npc.setConfig(null, 2025506166);
								node.remove(-1460969981);
								trim = true;
							}
						}
				...
				if (trim) {
					client.npcCount = (client.aClass437_8696.method5814(2145683355) * -118843751);
					int i_100_ = 0;
					Iterator<?> iterator = client.aClass437_8696.iterator();
					while (iterator.hasNext()) {
						ObjectValue class298_sub29 = (ObjectValue) iterator.next();
						client.npcs[i_100_++] = class298_sub29;
					}
				}
			}
			for (int i_101_ = 0; i_101_ < 2048; i_101_++) {
				Player player = client.players[i_101_];
				if (player != null) {
					...
					SceneObjectPosition class217 = SceneObjectPosition.method2005(player.method4337().aClass217_2599);
					class217.x -= 512 * i_91_;
					class217.y -= i_92_ * 512;
					player.setPosition(class217);
					class217.method2006();
				}
			}
			HintIcon[] class19s = client.hintIcons;
			for (int i_103_ = 0; i_103_ < class19s.length; i_103_++) {
				HintIcon class19 = class19s[i_103_];
				if (class19 != null) {
					class19.x -= i_91_ * -1268095488;
					class19.y -= i_92_ * 1688061440;
				}
			}
			...
			for (GroundTile class298_sub2 = ((GroundTile) client.groundTiles.method5816(1670233657)); null != class298_sub2; class298_sub2 = (GroundTile) client.groundTiles.method5815((byte) -33)) {
				...
				if (null != aClass331_3037) {
					if (i_106_ < 0 || i_108_ < 0 || i_106_ >= -991330803 * anInt3039 || i_108_ >= anInt3011 * -1456212765 || i_106_ >= (aClass331_3037.anInt3514) * 1988988347 || i_108_ >= 1340714547 * (aClass331_3037.anInt3549)) {
						if (aClass266_3001 != Class266.aClass266_2850) {
							class298_sub2.remove(-1460969981);
						}
			...
			if (2076926079 * Class3.flagX != 0) {
				Class3.flagX -= i_91_ * -1129029761;
				Class3.flagY -= -1835291189 * i_92_;
			}
			...
			if (17 == i) {
				...
				if (2 != -863531439 * Class298_Sub1.cameraType) {
					Class298_Sub1.cameraType = 1355934404;
			...
			client.groundGfxs.clear((byte) -16);
			client.projectiles.clear((byte) 1);
			client.groundMessages.clear(268098313);
	...
	void method2671(Class240_Sub1 class240_sub1, byte[][] is, int i) {
		try {
			for (int i_143_ = 0; i_143_ < class240_sub1.planeCount * 1551623871; i_143_++) {
				if (!aBoolean3018) {
					...
					for (int i_145_ = 0; (i_145_ < -1456212765 * anInt3011 >> 3); i_145_++) {
						...
						if (-1 != i_146_) {
							...
							if (!class240_sub1.aBoolean2629 || 0 == i_147_) {
								...
								for (int i_152_ = 0; i_152_ < (mapIDs).length; i_152_++) {
									if ((mapIDs[i_152_]) == i_151_ && null != is[i_152_]) {
										boolean osrs = Settings.isOSRSMap(i_151_);
										class240_sub1.method2238(osrs, FloorOverlay.graphics, is[i_152_], i_143_, 8 * i_144_, i_145_ * 8, i_147_, 8 * (i_149_ & 0x7), (i_150_ & 0x7) * 8, i_148_, (SCENE_CLIP_DATA_PLANES), -174685332);
										break;
									}
								}
							}
	...
	public boolean method2672(int i) {
		try { //mem leak here
			...
			anInt3027 = 0;
			for (int i_153_ = 0; i_153_ < mapData.length; i_153_++) {
				if (-1 != anIntArray3010[i_153_] && mapData[i_153_] == null) {
					mapData[i_153_] = Class65.aClass243_665.getFileFromArchive((anIntArray3010[i_153_]), 0, (byte) -67);
					if (null == mapData[i_153_]) {
						anInt3027 += -427342251;
					}
				}
				...
				if (anIntArray3035[i_153_] != -1 && null == waterData[i_153_]) {
					waterData[i_153_] = Class65.aClass243_665.getFileFromArchive((anIntArray3035[i_153_]), 0, (byte) -60);
					if (waterData[i_153_] == null) {
						anInt3027 += -427342251;
					}
				}
			...
			if (aClass296_3005 == null) {
				if (null != aClass298_Sub37_Sub13_3017 && (Class_v.index_23_worldMap.method2295(new StringBuilder().append(aClass298_Sub37_Sub13_3017.fileName).append("_staticelements").toString(), -400372089))) {
					if (!Class_v.index_23_worldMap.method2312(new StringBuilder().append(aClass298_Sub37_Sub13_3017.fileName).append("_staticelements").toString(), -2144896080)) {
						anInt3027 += -427342251;
					} else {
						aClass296_3005 = (Class237.method2192(Class_v.index_23_worldMap, new StringBuilder().append(aClass298_Sub37_Sub13_3017.fileName).append("_staticelements").toString(), client.isMemberWorld, 565671699));
					}
				} else {
			...
			anInt3021 = 0;
			for (int i_154_ = 0; i_154_ < mapData.length; i_154_++) {
				byte[] is = aByteArrayArray3014[i_154_];
				if (is != null) {
					int i_155_ = ((mapIDs[i_154_] >> 8) * 64 - (-1760580017 * aClass341_3006.gameSceneBaseX));
					int i_156_ = ((mapIDs[i_154_] & 0xff) * 64 - (aClass341_3006.gameSceneBaseY * 283514611));
					if (aClass266_3001.allowDynamicMapScene(-1692375482)) {
						i_155_ = 10;
						i_156_ = 10;
					}
					int i_157_ = (Class82_Sub13.method910(Settings.isOSRSMap(mapIDs[i_154_]), aClass433_3040, is, i_155_, i_156_, anInt3039 * -991330803, -1456212765 * anInt3011, (byte) -75));
					if (i_157_ > 0) {
				...
				if (is != null) {
					int i_158_ = (64 * (mapIDs[i_154_] >> 8) - (aClass341_3006.gameSceneBaseX * -1760580017));
					int i_159_ = (64 * (mapIDs[i_154_] & 0xff) - (aClass341_3006.gameSceneBaseY * 283514611));
					if (aClass266_3001.allowDynamicMapScene(-105390577)) {
						i_158_ = 10;
						i_159_ = 10;
					}
					int i_160_ = (Class82_Sub13.method910(Settings.isOSRSMap(mapIDs[i_154_]), aClass433_3040, is, i_158_, i_159_, anInt3039 * -991330803, -1456212765 * anInt3011, (byte) 54));
					if (i_160_ > 0) {
			...
			if (!aBoolean3018 && aClass273_3025 != Class273.aClass273_2905) {
				Class139.drawText(new StringBuilder().append(Tradution.aClass470_5874.method6049(Class321.aClass429_3357, -875414210)).append(Class26.aString350).append("(100%)").toString(), true, FloorOverlay.graphics, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) -16);
			}
			...
			if (!aBoolean3018) {
				for (int i_161_ = 0; i_161_ < 2048; i_161_++) {
					Player class365_sub1_sub1_sub2_sub2 = (client.players[i_161_]);
					if (class365_sub1_sub1_sub2_sub2 != null) {
						class365_sub1_sub1_sub2_sub2.aClass331_7722 = null;
					}
				}
				for (int i_162_ = 0; i_162_ < client.npcs.length; i_162_++) {
					ObjectValue class298_sub29 = client.npcs[i_162_];
					if (class298_sub29 != null) {
						((Class365_Sub1) class298_sub29.value).aClass331_7722 = null;
					}
				}
			}
			if (!aBoolean3018) {
			...
			boolean hasWaterPlane = false;
			boolean hdWater = Class422_Sub25.preferences.aClass422_Sub5_7572.method5642(-1598768408) == 2;
			boolean scenaryShadows = true;
			if (hdWater) {
				int graphicMode = Class422_Sub25.preferences.graphicsMode.method5677(-1598768408);
				for (int i_163_ = 0; i_163_ < mapData.length; i_163_++) {
					if (aByteArrayArray3002[i_163_] != null || (waterData[i_163_] != null) || Settings.isOSRSMap(mapIDs[i_163_])) {
						hasWaterPlane = true;
						//break;
					}
					if (Settings.isOSRSMap(mapIDs[i_163_])) {
						if (graphicMode == 1) {
							hdWater = false;
							hasWaterPlane = false;
						}
						if (mapIDs[i_163_] == 13125) //tob map2
			...
			int i_164_ = (Class69.method787(Class422_Sub25.preferences.aClass422_Sub24_7554.method5713((byte) 73), (byte) 16).renderDistance * 2098573928);
			if (FloorOverlay.graphics.method4998()) {
				i_164_++;
			}
			method2648(-1878791507);
			method2664((byte) 12);
			aClass331_3037 = new Class331(FloorOverlay.graphics, 9, 4, anInt3039 * -991330803, anInt3011 * -1456212765, i_164_, hasWaterPlane, FloorOverlay.graphics.method5048() > 0);
			...
			aClass240_Sub1_3029.sceneryShadows = !scenaryShadows ? 0 : Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(-809818345) * 275039235;
			aClass240_Sub1_3029.highDetailWater = hdWater;
			aClass240_Sub1_3029.aBoolean2697 = Class422_Sub25.preferences.aClass422_Sub15_7560.method5684(-2037839529) == 1;
			aClass240_Sub1_3029.groundBlending = Class422_Sub25.preferences.aClass422_Sub28_7573.method5724(1917266854) == 1;
			aClass240_Sub1_3029.aBoolean2625 = Class422_Sub25.preferences.aClass422_Sub16_7557.method5687(1803060969) == 1;
			if (!aClass266_3001.allowDynamicMapScene(338257036)) {
				decodeStatic(aClass240_Sub1_3029, mapData, mapData, (short) 821);
			} else {
				decode(aClass240_Sub1_3029, mapData, mapData, (byte) 53);
			}
			if (aBoolean3018) {
			...
			if (hasWaterPlane) {
				...
				waterPlane = new Class240_Sub1(aClass331_3037, aClass433_3040, 1, (-991330803 * anInt3039), (-1456212765 * anInt3011), true, aClass244_3012, aClass364_3013);
				waterPlane.method2212(-1978540544);
				waterPlane.sceneryShadows = !scenaryShadows ? 0 : Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(-15786995) * 275039235;
				waterPlane.highDetailWater = hdWater;
				waterPlane.aBoolean2697 = Class422_Sub25.preferences.aClass422_Sub15_7560.method5684(-1853244696) == 1;
				waterPlane.groundBlending = Class422_Sub25.preferences.aClass422_Sub28_7573.method5724(281198825) == 1;
				waterPlane.aBoolean2625 = Class422_Sub25.preferences.aClass422_Sub16_7557.method5687(2103749887) == 1;
				
				if (!aClass266_3001.allowDynamicMapScene(1753743768)) {
					decodeStatic(waterPlane, waterData, mapData, (short) 5882);
					if (!aBoolean3018) {
						Class517.method6310(true, 1696867322);
					}
				} else {
					decode(waterPlane, waterData, mapData, (byte) 95);
					if (!aBoolean3018) {
						Class517.method6310(true, -428383733);
					}
				}
				waterPlane.method2211(0, (aClass240_Sub1_3029.terrainHeight[0]), -1177013471);
				waterPlane.method2218(FloorOverlay.graphics, null, null, (byte) -27);
				aClass331_3037.method4052(false, -740850409);
				if (aBoolean3018) {
					method2658(50, (byte) 33);
				}
			}
			aClass240_Sub1_3029.method2218(FloorOverlay.graphics, hasWaterPlane ? (waterPlane.terrainHeight) : null, SCENE_CLIP_DATA_PLANES, (byte) 23);
			...
			aClass240_Sub1_3029.renderMapFloor(FloorOverlay.graphics, (hasWaterPlane ? aClass331_3037.aClass_xaArray3521[0] : null), null, (byte) -119);
			if (aBoolean3018) {
				method2658(75, (byte) 18);
			}
			aClass240_Sub1_3029.method2242(FloorOverlay.graphics, false, 1773155741);
			if (aBoolean3018) {
			...
			if (hasWaterPlane) {
				...
				if (!aClass266_3001.allowDynamicMapScene(423424816)) {
					method2660(waterPlane, aByteArrayArray3002, (byte) -36);
				} else {
					method2671(waterPlane, aByteArrayArray3002, -957252436);
				}
				if (!aBoolean3018) {
					Class517.method6310(true, 1319323091);
				}
				waterPlane.renderMapFloor(FloorOverlay.graphics, null, aClass331_3037.aClass_xaArray3519[0], (byte) 43);
				waterPlane.method2242(FloorOverlay.graphics, true, 1773155741);
				if (!aBoolean3018) {
			...
			if (waterPlane != null) {
				waterPlane.method2217(-702552699);
			}
			aClass331_3037.method4050(-1802988635);
			if (aBoolean3018) {
				Class122.method1319((byte) 1);
				while (!FloorOverlay.graphics.method5041(2085922748)) {
					method2658(1, (byte) -1);
				}
			}
	...
	static final void method2676(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_177_, (byte) -54);
	...
	static final void method2677(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
