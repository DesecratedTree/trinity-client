...
public final class Class501 {
	...
	ReferenceQueue<?> aReferenceQueue6120 = new ReferenceQueue<Object>();
	...
	public ArrayList<Object> method6224(int i) {
		try {
			method6223(-93976926);
			ArrayList<Object> arraylist = new ArrayList<Object>(((Class501) this).anInt6118 * 2061425537);
	...
	public static void method6227(boolean bool, int i) {
		try {
			if (bool) {
				...
				client.WINDOW_PANE_ID = 62030331 * LinkedArrayList.WIDGET_DETAILS.loginWidgetID;
	...
	static final void method6228(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_13_, (byte) -38);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1354508417 * class105.xOnScreen;
		} catch (RuntimeException runtimeexception) {
