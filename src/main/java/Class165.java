...
public class Class165 implements Interface5 {
	...
	public static Class319 aClass319_6366;
	...
	static final void method1781(WidgetConfig class105, Class119 class119, ClientScript2 class403, short i) {
		try {
			...
			if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403)
				Class302_Sub2.method3720(-440872681 * class105.uid, (byte) 12);
		} catch (RuntimeException runtimeexception) {
	...
	static void generateEquipIDs(int i) {
		try {
			...
			for (int i_10_ = 0; i_10_ < (-888767613 * Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength); i_10_++) {
				ItemConfig class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_10_, true);
				if (1343198193 * class468.maleModel1 >= 0 || 1585491093 * class468.femaleModel1 >= 0)
					is[i_9_++] = i_10_;
			}
			Class519.ITEM_EQUIP_IDS = new int[i_9_];
			for (int i_11_ = 0; i_11_ < i_9_; i_11_++)
				Class519.ITEM_EQUIP_IDS[i_11_] = is[i_11_];
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1784(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_12_, (byte) -27);
			int i_13_ = -1;
			int i_14_ = -1;
			Class117 class117 = class105.method1116(FloorOverlay.graphics, 1559428350);
			if (null != class117) {
