...
public class Class298_Sub52 extends Class298 {
	...
	public static void method3581(int i, byte i_0_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("act.r(").append(')').toString());
		}
	}
	...
	public static void method3582(int i, int i_1_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("act.aa(").append(')').toString());
		}
	}
	...
	static final void method3583(ClientScript2 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("act.tl(").append(')').toString());
		}
	}
}
