...
public class Class25 {
	...
	final void method383(short i) {
		try {
			((Class25) this).aClass453_329.clear((byte) 1);
			((Class25) this).anInt346 = 0;
	...
	void method384(byte i) {
		try {
			if (((Class25) this).aClass318_328 != null) {
				((Class25) this).aClass318_328.method3860(-2071805238);
				((Class25) this).aClass318_328 = null;
			}
			((Class25) this).aClass124_340.method1381(null, -2060987245);
		} catch (RuntimeException runtimeexception) {
	...
	Class25() {
		((Class25) this).aClass298_Sub53_331 = new RsByteBuffer(1500);
		((Class25) this).aClass298_Sub53_Sub2_333 = new RsBitsBuffer(15000);
		((Class25) this).INCOMMING_PACKET = null;
		((Class25) this).anInt336 = 0;
		((Class25) this).aBoolean337 = true;
		((Class25) this).anInt338 = 0;
		anInt339 = 0;
		aBoolean347 = false;
		((Class25) this).aClass124_340 = new Class124();
		Thread thread = new Thread(((Class25) this).aClass124_340);
	...
	void method385(int i) {
		try {
			((Class25) this).aClass318_328 = null;
			((Class25) this).aClass124_340.method1381(null, -2119645240);
		} catch (RuntimeException runtimeexception) {
	...
	public final void method386(int i) throws IOException {
		try {
			if (((Class25) this).aClass318_328 != null && 500279933 * ((Class25) this).anInt346 > 0) {
				((Class25) this).aClass298_Sub53_331.index = 0;
				for (;;) {
					Class298_Sub36 class298_sub36 = (Class298_Sub36) ((Class25) this).aClass453_329.method5939(1766612795);
					if (null == class298_sub36) {
						if (i < -876809530)
							break;
						return;
					}
					if (58571303 * class298_sub36.anInt7399 > ((((Class25) this).aClass298_Sub53_331.buffer).length - (((Class25) this).aClass298_Sub53_331.index * 385051775))) {
						if (i < -876809530)
							break;
						return;
					}
					((Class25) this).aClass298_Sub53_331.writeBytes((class298_sub36.aClass298_Sub53_Sub2_7396.buffer), 0, class298_sub36.anInt7399 * 58571303, (short) -5547);
					((Class25) this).anInt346 -= class298_sub36.anInt7399 * 20706419;
					class298_sub36.remove(-1460969981);
					class298_sub36.aClass298_Sub53_Sub2_7396.method3650(-2079366553);
					class298_sub36.method3400(939112928);
				}
				((Class25) this).aClass318_328.method3868(((Class25) this).aClass298_Sub53_331.buffer, 0, (385051775 * ((Class25) this).aClass298_Sub53_331.index), 1953252448);
				((Class25) this).anInt342 += (211924279 * ((Class25) this).aClass298_Sub53_331.index);
				anInt339 = 0;
			}
		} catch (RuntimeException runtimeexception) {
	...
	public Class318 method387(int i) {
		try {
			return ((Class25) this).aClass318_328;
		} catch (RuntimeException runtimeexception) {
	...
	void method388(byte i) {
		try {
			if (client.anInt8884 * 443738891 % 50 == 0) {
				((Class25) this).anInt327 = -514533411 * ((Class25) this).anInt342;
				((Class25) this).anInt342 = 0;
				((Class25) this).anInt343 = ((Class25) this).anInt341 * 65385213;
				((Class25) this).anInt341 = 0;
			}
		} catch (RuntimeException runtimeexception) {
	...
	void method389(Class318 class318, String string, byte i) {
		try {
			((Class25) this).aClass318_328 = class318;
			((Class25) this).aClass124_340.method1381(string, -2024607091);
		} catch (RuntimeException runtimeexception) {
	...
	public final void method390(Class298_Sub36 class298_sub36, byte i) {
		try {
			((Class25) this).aClass453_329.add(class298_sub36, 1630737890);
	...
	static final void method391(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_0_, (byte) -78);
	...
	public static void method393(int i, int i_20_, String string, String string_21_, String string_22_, String string_23_, String string_24_, int i_25_, int i_26_) {
		try {
			Class102 class102 = Class107.chatMessages[Class107.chatMessages.length - 1];
			for (int i_27_ = Class107.chatMessages.length - 1; i_27_ > 0; i_27_--)
				Class107.chatMessages[i_27_] = Class107.chatMessages[i_27_ - 1];
			if (class102 == null)
			...
			Class107.chatMessages[0] = class102;
	...
	static final void method395(ClientScript2 class403, int i) {
		try {
			int i_28_ = (((ClientScript2) class403).integerstack[1883543357 * ((ClientScript2) class403).integerPos]);
