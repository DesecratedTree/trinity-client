...
public class Class135 implements Interface6 {
	...
	public void method58(boolean bool, byte i) {
		try {
			if (bool) {
				int i_0_ = ((Class462.screenWidth * -2110394505 > client.WIDTH * 775068819) ? Class462.screenWidth * -2110394505 : 775068819 * client.WIDTH);
				int i_1_ = ((Class298_Sub40_Sub9.screenHeight * -1111710645 > -791746413 * client.HEIGHT) ? Class298_Sub40_Sub9.screenHeight * -1111710645 : client.HEIGHT * -791746413);
	...
	public void method56(boolean bool) {
		if (bool) {
			int i = ((Class462.screenWidth * -2110394505 > client.WIDTH * 775068819) ? Class462.screenWidth * -2110394505 : 775068819 * client.WIDTH);
			int i_8_ = ((Class298_Sub40_Sub9.screenHeight * -1111710645 > -791746413 * client.HEIGHT) ? Class298_Sub40_Sub9.screenHeight * -1111710645 : client.HEIGHT * -791746413);
	...
	static final void method1490(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static final void method1491(WidgetConfig class105, ClientScript2 class403, int i) {
		try {
			...
			NPCConfig class503 = Class15.aClass507_224.method6269(572201537 * class105.anInt1151, -1577596397);
			...
			if (i_16_ < 0 || i_16_ >= class503.models.length)
	...
	static final void processEntity(Entity class365_sub1_sub1_sub2, boolean bool, int i) {
		try {
			...
			if (-412225079 * class365_sub1_sub1_sub2.anInt10095 > client.anInt8884 * 443738891)
				...
				Map.method4141(class365_sub1_sub1_sub2, bool, 365613015);
			...
			if ((int) class217.x < 512 || (int) class217.y < 512 || ((int) class217.x >= ((client.aClass283_8716.method2629(-2045914503) - 1) * 512)) || ((int) class217.y >= ((client.aClass283_8716.method2630(2070989013) - 1) * 512))) {
			...
			if ((Class287.myPlayer == class365_sub1_sub1_sub2) && ((int) class217.x < 6144 || (int) class217.y < 6144 || ((int) class217.x >= (client.aClass283_8716.method2629(-2000317727) - 12) * 512) || ((int) class217.y >= ((client.aClass283_8716.method2630(52673101) - 12) * 512)))) {
