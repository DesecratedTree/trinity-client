...
public class Class404 implements Runnable {
	...
	Queue<Object> aQueue5265 = new LinkedList<Object>();
	...
	static final void method4950(ClientScript2 class403, byte i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_1_).equipSlot) * -906758929;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4951(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub14_7570.method5677(-1832021198);
		} catch (RuntimeException runtimeexception) {
