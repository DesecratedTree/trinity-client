	...
	public static int method878(int i, int i_0_, boolean bool, int i_1_) {
		try {
			...
			if (i_0_ < 0 || i_0_ >= (((Class298_Sub9) class298_sub9).anIntArray7227).length)
				return 0;
			if (i == 95 || i == 1000) { //bank & collector log
				/*if (((Class298_Sub9) class298_sub9).anIntArray7226[i_0_] > 0)
					return ((Class298_Sub9) class298_sub9).anIntArray7227[i_0_];*/
				if (((Class298_Sub9) class298_sub9).anIntArray7226[i_0_] > 0 &&  ((Class298_Sub9) class298_sub9).anIntArray7227[i_0_] == 0)
					return -2;
			}
			return ((Class298_Sub9) class298_sub9).anIntArray7227[i_0_];
		} catch (RuntimeException runtimeexception) {
