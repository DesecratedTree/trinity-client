...
public class Class239 {
				...
				if (((Class239) this).anInt2609 * -431482401 != 1) {
					...
					if (class298_sub27 == null) {
						...
						if (((Class239) this).anInt2612 * -1543676323 >= ((Class239) this).anInt2609 * -431482401) {
							...
							class298_sub27_5_.remove(-1460969981);
						} else {
	...
	static final void method2209(WidgetConfig class105, ClientScript2 class403, byte i) {
		try {
			...
			Point point = class505.method6263(class105.text, class105.anInt1156 * -2093041337, class105.lineHeight * 418216501, i_12_, Class130_Sub2.aClass57Array6959, 946663112);
	...
	public static Class297 method2210(int i, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_) {
		try {
			if (Class422_Sub25.preferences.aClass422_Sub29_7553.method5726(-2141800162) != 0 && i_13_ != 0 && Class300.anInt3213 * -991384187 < 50 && -1 != i) {
