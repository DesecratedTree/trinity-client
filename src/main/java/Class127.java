...
public abstract class Class127 implements Interface6 {
	...
	long aLong6376;
	public static CacheIndex TEXTURES_INDEX;
	...
	public void method58(boolean bool, byte i) {
		try {
			int i_4_ = ((((Class127) this).aClass128_6375.aClass139_6322.method1545(-944287579 * ((Class127) this).aClass128_6375.anInt6326, client.WIDTH * 775068819, -2137791831)) + ((Class127) this).aClass128_6375.anInt6327 * -39975161);
			int i_5_ = ((((Class127) this).aClass128_6375.aClass133_6323.method1482(-1387457793 * ((Class127) this).aClass128_6375.anInt6330, -791746413 * client.HEIGHT, -1715218341)) + ((Class127) this).aClass128_6375.anInt6325 * 1886882435);
			...
			if ((Class122.method1319((byte) 1) - ((Class127) this).aLong6376 * 109366757865047727L) > 10000L)
				string = new StringBuilder().append(string).append(" (").append((Class288_Sub1.aClass219_7147.method2034(-1233866115).folder) * -861845079).append(")").toString();
	...
	public void method56(boolean bool) {
		int i = ((((Class127) this).aClass128_6375.aClass139_6322.method1545(-944287579 * ((Class127) this).aClass128_6375.anInt6326, client.WIDTH * 775068819, -1925244247)) + ((Class127) this).aClass128_6375.anInt6327 * -39975161);
		int i_8_ = ((((Class127) this).aClass128_6375.aClass133_6323.method1482(-1387457793 * ((Class127) this).aClass128_6375.anInt6330, -791746413 * client.HEIGHT, -1769429058)) + ((Class127) this).aClass128_6375.anInt6325 * 1886882435);
	...
	public void method55() {
		...
		((Class127) this).aClass264_6373 = (FloorOverlay.graphics.method5092(class505, Class89.method981(((Class127) this).aClass243_6372, 955568089 * (((Class127) this).aClass128_6375.anInt6329)), true));
	}
	...
	static final void method1419(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static final void method1420(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub28_7573.method5724(1673845033) == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1423(WidgetConfig class105, int i, int i_24_, int i_25_, ClientScript2 class403, int i_26_) {
		try {
			if (null == class105.acceptableInputs) {
				if (0 != i_24_) {
					class105.acceptableInputs = new byte[11];
					class105.aByteArray1222 = new byte[11];
					class105.anIntArray1276 = new int[11];
				} else
					return;
			}
			class105.acceptableInputs[i] = (byte) i_24_;
			if (0 != i_24_)
				class105.aBoolean1220 = true;
			else {
				class105.aBoolean1220 = false;
				for (int i_27_ = 0; i_27_ < class105.acceptableInputs.length; i_27_++) {
					if (class105.acceptableInputs[i_27_] != 0) {
						class105.aBoolean1220 = true;
						break;
					}
				}
