...
public class Class365_Sub1_Sub5_Sub1 extends Class365_Sub1_Sub5 implements Interface3 {
	...
	Class454 method4524(GraphicsToolkit class_ra, int i, boolean bool, byte i_1_) {
		try {
			ObjectConfig class432 = (((Class365_Sub1_Sub5_Sub1) this).aClass433_9898.getObjectDefinitions(1940788231 * ((Class365_Sub1_Sub5_Sub1) this).anInt9896));
			Class_xa class_xa;
			...
			return (class432.method5785(class_ra, i, ((Class365_Sub1_Sub5_Sub1) this).aByte9899, ((Class365_Sub1_Sub5_Sub1) this).aByte9897, class_xa, class_xa_2_, (int) class217.x, (int) class217.aFloat2455, (int) class217.y, bool, null, 566759128));
		} catch (RuntimeException runtimeexception) {
	...
	Class335 drawFloor(GraphicsToolkit class_ra, int i) {
		try {
			...
			((Class365_Sub1_Sub5_Sub1) this).aClass387_9893.drawModel(class222, aClass302_Sub1Array7726[0], 0);
			return class335;
		} catch (RuntimeException runtimeexception) {
	...
	public void method40(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (null != class_na)
			aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 1555439691);
	}
	...
	public Class334 method4367(GraphicsToolkit class_ra) {
		...
		if (null == ((Class365_Sub1_Sub5_Sub1) this).aClass334_9895)
			((Class365_Sub1_Sub5_Sub1) this).aClass334_9895 = Class472.method6063((int) class217.x, (int) class217.aFloat2455, (int) class217.y, method4523(class_ra, 0, -541574626), 2030586614);
	...
	public void method28(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (null != class_na)
			aClass331_7722.method4055(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 932138106);
	}
	...
	public void method44(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (null != class_na)
			aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 1480402841);
	}

	public Class334 method4368(GraphicsToolkit class_ra) {
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (null == ((Class365_Sub1_Sub5_Sub1) this).aClass334_9895)
			((Class365_Sub1_Sub5_Sub1) this).aClass334_9895 = Class472.method6063((int) class217.x, (int) class217.aFloat2455, (int) class217.y, method4523(class_ra, 0, -2141517966), 2144329713);
		return ((Class365_Sub1_Sub5_Sub1) this).aClass334_9895;
	}
	...
	public Class365_Sub1_Sub5_Sub1(Class331 class331, GraphicsToolkit class_ra, Class433 class433, ObjectConfig class432, int i, int i_9_, int i_10_, int i_11_, int i_12_, boolean bool, int i_13_, int i_14_, boolean bool_15_) {
		...
		((Class365_Sub1_Sub5_Sub1) this).aBoolean9900 = 0 != 1532834983 * class432.optionType && !bool;
		((Class365_Sub1_Sub5_Sub1) this).aBoolean9892 = bool_15_;
		((Class365_Sub1_Sub5_Sub1) this).aBoolean9902 = (class_ra.method5082() && class432.scenaryShadows && !((Class365_Sub1_Sub5_Sub1) this).aBoolean9901 && Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(57385915) != 0);
		int i_16_ = 2048;
	...
	public void method37(GraphicsToolkit class_ra, int i) {
		try {
			...
			SceneObjectPosition class217 = method4337().aClass217_2599;
			if (null != class_na)
				aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 580390895);
		} catch (RuntimeException runtimeexception) {
	...
	public void method33(GraphicsToolkit class_ra, int i) {
		try {
			...
			SceneObjectPosition class217 = method4337().aClass217_2599;
			if (null != class_na)
				aClass331_7722.method4055(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 2001227588);
		} catch (RuntimeException runtimeexception) {
	...
	public Class334 method4358(GraphicsToolkit class_ra, byte i) {
		try {
			SceneObjectPosition class217 = method4337().aClass217_2599;
			if (null == ((Class365_Sub1_Sub5_Sub1) this).aClass334_9895)
				((Class365_Sub1_Sub5_Sub1) this).aClass334_9895 = Class472.method6063((int) class217.x, (int) class217.aFloat2455, (int) class217.y, method4523(class_ra, 0, -187426704), 2051250714);
			return ((Class365_Sub1_Sub5_Sub1) this).aClass334_9895;
		} catch (RuntimeException runtimeexception) {
	...
	public void method43(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (null != class_na)
			aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 310306064);
	}
	...
	public static boolean method4525(boolean bool, int i) {
		try {
			boolean bool_26_ = FloorOverlay.graphics.method5054();
			if (bool != bool_26_) {
				if (bool) {
					if (!FloorOverlay.graphics.method5052())
						bool = false;
				} else
					FloorOverlay.graphics.method5053();
				if (bool != bool_26_) {
					Class422_Sub25.preferences.method3540((Class422_Sub25.preferences.aClass422_Sub6_7551), bool ? 1 : 0, -1863602535);
