...
public class Class296 {
	...
	static final void method2831(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub18_7561.method5693(-919235605) == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2832(ClientScript2 class403, byte i) {
		try {
			int i_7_ = (((ClientScript2) class403).integerstack[((ClientScript2) class403).integerPos * 1883543357]);
