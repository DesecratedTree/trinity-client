	...
	static void method5920(int i) {
		try {
			try {
				...
				if (file.exists())
					Class291.aClass484_6499 = new JagexFile(new JagexFile2(file, "rw", 25L), 24, 0);
				else {
					while_104_: for (int i_16_ = 0; i_16_ < Class68.aStringArray679.length; i_16_++) {
						for (int i_17_ = 0; i_17_ < Class216.aStringArray6657.length; i_17_++) {
							...
							if (file_18_.exists()) {
								Class291.aClass484_6499 = new JagexFile(new JagexFile2(file_18_, "rw", 25L), 24, 0);
								break while_104_;
							}
						}
					}
