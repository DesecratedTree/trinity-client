...
public class RSGraphics {
	...
	RSGraphics(Entity class365_sub1_sub1_sub2) {
	...
	public static final void method609(short i) {
		try {
					...
					if (-99363405 * ((Class297) class297).anInt3177 >= (class297.method2835((byte) -38) ? -1500 : -10)) {
						if (((Class297) class297).aByte3176 == 1 && ((Class297) class297).aClass278_3181 == null) {
							...
							if (((Class297) class297).aClass298_Sub23_3186 == null)
								((Class297) class297).aClass298_Sub23_3186 = (Class298_Sub23.method3066(Class439.MUSIC_EFFECT_INDEX, (((Class297) class297).anInt3175 * -320389285)));
							if (((Class297) class297).aClass298_Sub23_3186 == null) {
								if (i >= 16385)
									throw new IllegalStateException();
								continue;
						...
						if (-99363405 * ((Class297) class297).anInt3177 < 0) {
							...
							if (0 != (((Class297) class297).anInt3178 * 758600991)) {
								...
								if (i_10_ == (Class287.myPlayer.plane)) {
									...
									int i_16_ = ((i_15_ << 9) + 256 - (int) class217.y + i_12_);
									...
									if (i_17_ < 0)
										i_17_ = 0;
									i_9_ = ((i_11_ - i_17_) * Class422_Sub25.preferences.aClass422_Sub29_7582.method5726(-2145949986) * (((Class297) class297).anInt3182 * -1716484165) / i_11_) >> 2;
								...
								i_9_ = ((((Class297) class297).anInt3182 * -1716484165 * (3 == ((Class297) class297).aByte3176 ? Class422_Sub25.preferences.aClass422_Sub29_7583.method5726(-2143768151) : Class422_Sub25.preferences.aClass422_Sub29_7553.method5726(-2142178675))) >> 2);
							if (i_9_ > 0) {
			...
			if (Class300.aBoolean3208 && !Class68.method781(1966738730)) {
				if (Class422_Sub25.preferences.aClass422_Sub29_7584.method5726(-2143085623) != 0 && Class300.musicID * -1256171511 != -1) {
					if (null != GroundTile.aClass298_Sub19_Sub1_7167)
						Class21.method364(Class374_Sub1.MUSIC, -1256171511 * Class300.musicID, 0, Class422_Sub25.preferences.aClass422_Sub29_7584.method5726(-2142931520), false, (GroundTile.aClass298_Sub19_Sub1_7167), 1987085103);
					else
						Class477.method6096(Class374_Sub1.MUSIC, Class300.musicID * -1256171511, 0, Class422_Sub25.preferences.aClass422_Sub29_7584.method5726(-2147082244), false, -2064254563);
				}
				Class300.aBoolean3208 = false;
				GroundTile.aClass298_Sub19_Sub1_7167 = null;
			} else if (Class422_Sub25.preferences.aClass422_Sub29_7584.method5726(-2142436770) != 0 && -1 != -1256171511 * Class300.musicID && !Class68.method781(1908541019)) {
				Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2032, client.aClass25_8711.aClass449_330, (byte) 26);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(-1256171511 * Class300.musicID, -1115837876);
				client.aClass25_8711.method390(class298_sub36, (byte) -48);
				Class300.musicID = 184109511;
			}
		} catch (RuntimeException runtimeexception) {
		...
		try {
			if (client.anInt8870 * 577335585 < 0) {
				...
				if (!Class436.aBoolean5478)
					Class436.aBoolean5471 = ((Class436.anInt5499 * -1914913203 != -1 && (Class436.anInt5506 * -278777595 >= -1914913203 * Class436.anInt5499)) || (((Class436.aBoolean5496 ? 26 : 22) + (-278777595 * Class436.anInt5506 * (Class436.anInt5467 * -411680299))) > -1111710645 * Class298_Sub40_Sub9.screenHeight));
				Class436.aClass453_5511.clear((byte) 1);
				Class436.aClass453_5505.clear((byte) 1);
				...
				for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) Class436.aClass453_5480.method5939(1766612795)); class298_sub37_sub15 != null; class298_sub37_sub15 = ((Class298_Sub37_Sub15) Class436.aClass453_5480.method5944(49146))) {
					...
					if (i_21_ < 1000) {
						class298_sub37_sub15.remove(-1460969981);
						if (59 == i_21_ || i_21_ == 2 || 8 == i_21_ || i_21_ == 17 || i_21_ == 15 || 16 == i_21_ || i_21_ == 58)
							Class436.aClass453_5505.add(class298_sub37_sub15, 892677220);
						else
							Class436.aClass453_5511.add(class298_sub37_sub15, 281584970);
					}
				}
				...
				if (Class436.anInt5506 * -278777595 > 1) {
					if (Class117.method1275((byte) 41) && -278777595 * Class436.anInt5506 > 2)
						Class298_Sub45.aClass298_Sub37_Sub15_7522 = ((Class298_Sub37_Sub15) (Class436.aClass453_5480.aClass298_5643.first.first));
					else
						Class298_Sub45.aClass298_Sub37_Sub15_7522 = (Class298_Sub37_Sub15) (Class436.aClass453_5480.aClass298_5643.first);
					Class436.aClass298_Sub37_Sub15_5477 = (Class298_Sub37_Sub15) (Class436.aClass453_5480.aClass298_5643.first);
			
					if (-278777595 * Class436.anInt5506 > 2)
						Class318.aClass298_Sub37_Sub15_3322 = ((Class298_Sub37_Sub15) (Class436.aClass298_Sub37_Sub15_5477.first));
					else
				...
				boolean shiftDrop = Class492.hasPressed(Class87.SHIFT_CLICK, 1089632340);
				
				if (shiftDrop) {
					for (Object object : Class436.aClass453_5480) {
						Class298_Sub37_Sub15 option = (Class298_Sub37_Sub15) object;
						long index =  (option.aLong9661 * 2236412381003659263L);
						if (index == 8 && option.option.equals("Drop") || option.option.equals("Destroy") || option.option.equals("Release")) {
							Class298_Sub45.aClass298_Sub37_Sub15_7522 = option;
							break;
						}
					}
				}
				...
				if (null != class298_sub50) {
					...
					i_22_ = Class165.aClass319_6366.method3894((byte) -80);
					i_23_ = Class165.aClass319_6366.method3883((byte) -10);
				}
				if (Class436.aBoolean5478) {
					if (Class170.method1814((Class144.aClass381_1563.anInterface19_4112), class298_sub50, (byte) -119)) {
						...
						} else if (i_22_ >= Class88.anInt806 * -1347746885 && (i_22_ <= (608683427 * Class134.anInt6343 + Class88.anInt806 * -1347746885)) && (i_23_ >= GroundMessage.anInt7658 * 1089948687) && i_23_ <= (Class448.anInt5619 * 1396607435 + (GroundMessage.anInt7658 * 1089948687))) {
							if (!Class436.aBoolean5471) {
								int i_29_ = -1;
								for (int i_30_ = 0; i_30_ < -278777595 * Class436.anInt5506; i_30_++) {
									if (Class436.aBoolean5496) {
										int i_31_ = ((Class436.anInt5467 * -411680299 * ((-278777595 * Class436.anInt5506) - 1 - i_30_)) + (1 + ((class505.anInt6202 * 1110385787) + (20 + ((GroundMessage.anInt7658) * 1089948687)))));
										if (i_23_ > i_31_ - (class505.anInt6202 * 1110385787) - 1 && i_23_ < ((-1883958527 * class505.anInt6197) + i_31_))
											i_29_ = i_30_;
									} else {
										int i_32_ = ((-411680299 * Class436.anInt5467 * ((Class436.anInt5506 * -278777595) - 1 - i_30_)) + ((GroundMessage.anInt7658 * 1089948687) + 31));
								...
								for (int i_35_ = 0; i_35_ < 1592446965 * Class436.anInt5479; i_35_++) {
									if (Class436.aBoolean5496) {
										int i_36_ = ((Class436.anInt5467 * -411680299 * i_35_) + (1 + (20 + (GroundMessage.anInt7658 * 1089948687) + (class505.anInt6202 * 1110385787))));
										if (i_23_ > (i_36_ - (1110385787 * class505.anInt6202) - 1) && i_23_ < ((class505.anInt6197 * -1883958527) + i_36_)) {
											i_34_ = i_35_;
											break;
										}
									} else {
										int i_37_ = ((Class436.anInt5467 * -411680299 * i_35_) + ((1089948687 * GroundMessage.anInt7658) + 31));
						...
						if (!bool) {
							if (i_22_ < -1347746885 * Class88.anInt806 - 10 || (i_22_ > 10 + (Class88.anInt806 * -1347746885 + Class134.anInt6343 * 608683427)) || i_23_ < (GroundMessage.anInt7658 * 1089948687) - 10 || (i_23_ > (1396607435 * Class448.anInt5619 + 1089948687 * GroundMessage.anInt7658 + 10)))
								Class194.method1868(2025307040);
								...
								for (int i_41_ = 0; i_41_ < 1592446965 * Class436.anInt5479; i_41_++) {
									if (Class436.aBoolean5496) {
										int i_42_ = (20 + (GroundMessage.anInt7658 * 1089948687) + (1110385787 * class505.anInt6202) + 1 + (i_41_ * (-411680299 * Class436.anInt5467)));
										...
										int i_43_ = (31 + (GroundMessage.anInt7658 * 1089948687) + (Class436.anInt5467 * -411680299 * i_41_));
	...
	static final void method613(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static final void method615(ClientScript2 class403, int i) {
		try {
			Class390 class390 = (((ClientScript2) class403).aBoolean5261 ? ((ClientScript2) class403).aClass390_5247 : ((ClientScript2) class403).aClass390_5246);
			WidgetConfig class105 = ((Class390) class390).aClass105_4168;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.parentUID * 1573706803;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method617(ClientScript2 class403, int i) {
		try {
			...
			ItemConfig class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_54_);
			int i_55_;
