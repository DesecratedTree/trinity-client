...
public class Class344 {
	...
	static {
		...
		anInt3682 = 0;
		anInt3677 = 0;
		aClass437_3684 = new LinkedArrayList(8);
		anInt3685 = 0;
	...
	static final void method4164(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_0_, (byte) 9);
			Class119 class119 = Class389.aClass119Array4165[i_0_ >> 16];
			Class389.method4862(class105, class119, class403, -2144331170);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("oi.cu(").append(')').toString());
		}
	}
	...
	public static void method4165(int i, int i_1_, int i_2_, int i_3_) {
		try {
			...
			i_1_ <<= 3;
			i_2_ <<= 3;
			client.aFloat8757 = (float) i;
			client.aFloat8949 = (float) i_1_;
			if (Class298_Sub1.cameraType * -863531439 == 3) {
				client.anInt8756 = -648269561 * i;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("oi.hh(").append(')').toString());
		}
	}
}
