...
public class FloorUnderlay {
	...
	void method5881(RsByteBuffer class298_sub53, int i, int i_8_) {
		try {
			if (1 == i) {
				((FloorUnderlay) this).color = class298_sub53.read24BitUnsignedInteger((byte) -8) * -1369220863;
				method5880(2106435329 * ((FloorUnderlay) this).color, (byte) -123);
			} else if (2 == i) {
	...
	static void method5883(WidgetConfig class105, Class_ta class_ta, int i, int i_10_, int i_11_, int i_12_, Class57 class57, byte i_13_) {
		try {
			if (null != class57) {
				int i_14_;
	...
	static final void method5884(int i, int i_21_) {
		try {
			if (Class378.method4671(i, null, -1926955800))
				Class411.method5578((Class389.aClass119Array4165[i].components), -1, (byte) 1);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method5887(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
