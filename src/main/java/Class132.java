...
public class Class132 {
	...
	public Model method1474(byte i) { //player models
		try {
			...
			synchronized (((Class144) ((Class132) this).aClass144_1500).aClass243_1560) {
				for (int i_8_ = 0; i_8_ < ((Class132) this).anIntArray1507.length; i_8_++)
					class64s[i_8_] = Model.loadModel((((Class144) ((Class132) this).aClass144_1500).aClass243_1560), (((Class132) this).anIntArray1507[i_8_] + (Class477.OLD_ITEMS ? Settings._685_MODEL_OFFSET : 0)), 0);
			}
			for (int i_9_ = 0; i_9_ < ((Class132) this).anIntArray1507.length; i_9_++) {
				if (class64s[i_9_].protocol < 13)
					class64s[i_9_].resize(2);
			}
			Model class64;
			...
			if (((Class132) this).aShortArray1501 != null) {
				for (int i_10_ = 0; i_10_ < ((Class132) this).aShortArray1501.length; i_10_++)
					class64.recolor(((Class132) this).aShortArray1501[i_10_], (((Class132) this).aShortArray1502[i_10_]));
			}
			if (((Class132) this).aShortArray1503 != null) {
				for (int i_11_ = 0; i_11_ < ((Class132) this).aShortArray1503.length; i_11_++)
					class64.retexture(((Class132) this).aShortArray1503[i_11_], (((Class132) this).aShortArray1504[i_11_]));
			}
			return class64;
		} catch (RuntimeException runtimeexception) {
			...
			synchronized (((Class144) ((Class132) this).aClass144_1500).aClass243_1560) {
				for (int i_14_ = 0; i_14_ < 5; i_14_++) {
					if (((Class132) this).anIntArray1505[i_14_] != -1)
						class64s[i_13_++] = Model.loadModel((((Class144) (((Class132) this).aClass144_1500)).aClass243_1560), (((Class132) this).anIntArray1505[i_14_]), 0);
				}
			}
			for (int i_15_ = 0; i_15_ < 5; i_15_++) {
				if (null != class64s[i_15_] && class64s[i_15_].protocol < 13)
					class64s[i_15_].resize(2);
			}
			Model class64 = new Model(class64s, i_13_);
			if (null != ((Class132) this).aShortArray1501) {
				for (int i_16_ = 0; i_16_ < ((Class132) this).aShortArray1501.length; i_16_++)
					class64.recolor(((Class132) this).aShortArray1501[i_16_], (((Class132) this).aShortArray1502[i_16_]));
			}
			if (null != ((Class132) this).aShortArray1503) {
				for (int i_17_ = 0; i_17_ < ((Class132) this).aShortArray1503.length; i_17_++)
					class64.retexture(((Class132) this).aShortArray1503[i_17_], (((Class132) this).aShortArray1504[i_17_]));
			}
			return class64;
		} catch (RuntimeException runtimeexception) {
		...
		try {
			...
			synchronized (((Class144) ((Class132) this).aClass144_1500).aClass243_1560) {
				for (int i_18_ = 0; i_18_ < ((Class132) this).anIntArray1507.length; i_18_++) {
					if (!((Class144) ((Class132) this).aClass144_1500).aClass243_1560.method2290(((Class132) this).anIntArray1507[i_18_] + (Class477.OLD_ITEMS ? Settings._685_MODEL_OFFSET : 0), 0, -1755601406))
						bool = false;
				}
			}
			return bool;
	...
	static final void method1478(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_19_, (byte) 36);
	...
	static final void method1479(ClientScript2 class403, byte i) {
		try {
			...
			if (Class389.aClass119Array4165[i_20_] == null)
				...
				String string = (Class389.aClass119Array4165[i_20_].components[0].name);
				if (null == string)
					((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
				else
