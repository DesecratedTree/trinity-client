...
public abstract class Preference {
	protected Preferences aClass298_Sub48_5346;
	...
	Preference(Preferences class298_sub48) {
		aClass298_Sub48_5346 = class298_sub48;
		anInt5350 = method5611(-1613011239) * 1886334997;
	}

	Preference(int i, Preferences class298_sub48) {
	...
	static final void method5618(ClientScript2 class403, int i) {
		try {
			Class116.setHighPreferences(327778485);
	...
	static final boolean method5621(char c, int i) {
		try {
			if (Character.isISOControl(c))
				return false;
			if (ObjectConfig.method5788(c, (short) 160))
				return true;
