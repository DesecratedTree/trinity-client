...
public class Class290 {
	...
	static final void method2747(ClientScript2 class403, int i) {
		try {
			WidgetConfig class105 = Class50.getIComponentDefinitions((((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]), (byte) -49);
