...
public class Class50 {
	...
	//login
	static BigInteger MODULUS = new BigInteger("", 16);
	...
	static {
		...
		//update server
		UPDATE_SERVER_MODULUS = new BigInteger("", 16);
	...
	public static WidgetConfig getIComponentDefinitions(int parentHash, byte dummyValue) {
		try {
	...
	public static void method530(int i, int i_2_) {
		try {
			...
			ItemContainerConfig.aClass95_9602 = new Class95(Class374_Sub1.MUSIC, i);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method535(int i, byte i_12_) {
		try {
			...
			if (i_13_ >= 100) {
				...
				Class482.setCameraPos(1103750049 * Class75.anInt708, Class356.getPlayerHeight((int) class217.x, (int) class217.y, 1855729883 * Class99.anInt952, -1800819540) - 200, 1346160791 * Class106.anInt1309, i_14_, i_15_, 600 + (i_14_ >> 3) * 3 << 2, i, -1059521295);
