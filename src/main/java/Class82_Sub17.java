...
public class Class82_Sub17 extends Class82 {
	...
	static void method918(WidgetConfig class105, int i, int i_0_, int i_1_) {
		try {
	...
	static final void method919(ClientScript2 class403, int i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub7_7581, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]), -2102625264);
