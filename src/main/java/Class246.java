...
public abstract class Class246 implements Interface7 {
	...
	OpenGLToolkit aClass_ra_Sub3_Sub1_6392;
	int anInt6393;
	int anInt6394;
	int anInt6395 = -1;
	...
	void method2331() {
		if (((Class246) this).anInt6395 < 0) {
			if (((OpenGLToolkit) ((Class246) this).aClass_ra_Sub3_Sub1_6392).aBoolean9825) {
	...
	Class246(OpenGLToolkit class_ra_sub3_sub1, int i, boolean bool) {
