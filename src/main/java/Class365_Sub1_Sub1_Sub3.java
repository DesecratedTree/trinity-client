...
public class Class365_Sub1_Sub1_Sub3 extends Class365_Sub1_Sub1 {
	...
	void method4479(GraphicsToolkit class_ra, Class387 class387, Class222 class222, byte i) {
		try {
	...
	public Class365_Sub1_Sub1_Sub3(Class331 class331, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, boolean bool) {
		...
		GraphicsConfig class398 = (Class158_Sub1.aClass389_8568.method4857(((Class365_Sub1_Sub1_Sub3) this).anInt10135 * -743331725, -2103306753));
		int i_11_ = 1505778629 * class398.animation;
		if (i_11_ != -1) {
	...
	Class387 method4482(GraphicsToolkit class_ra, int i, int i_13_, int i_14_) {
		try {
			GraphicsConfig class398 = Class158_Sub1.aClass389_8568.method4857(i_13_, -1949428738);
			...
			return ((((Class365_Sub1_Sub1_Sub3) this).aClass438_10136 != null && !((Class365_Sub1_Sub1_Sub3) this).aClass438_10136.method5832(1032843646)) ? class398.method4918(class_ra, i, true, class_xa, class_xa_15_, (int) class217.x, (int) class217.aFloat2455, (int) class217.y, (((Class365_Sub1_Sub1_Sub3) this).aClass438_10136), (byte) 2, 345220259) : class398.method4918(class_ra, i, true, class_xa, class_xa_15_, (int) class217.x, (int) class217.aFloat2455, (int) class217.y, null, (byte) 2, -2126228993));
		} catch (RuntimeException runtimeexception) {
