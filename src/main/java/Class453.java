...
public class Class453 implements Iterable<Object>, Collection<Object> {
	public Class298 aClass298_5643 = new Class298();
	Class298 aClass298_5644;

	public void add(Class298 class298, int i) {
		try {
			if (null != class298.first)
				class298.remove(-1460969981);
			class298.first = aClass298_5643.first;
			class298.last = aClass298_5643;
	...
	public Class298 method5936(int i) {
		try {
			Class298 class298 = aClass298_5643.last;
	...
	void method5937(Class453 class453_0_, Class298 class298, byte i) {
		try {
			Class298 class298_1_ = aClass298_5643.first;
			aClass298_5643.first = class298.first;
			class298.first.last = aClass298_5643;
			if (aClass298_5643 != class298) {
				class298.first = class453_0_.aClass298_5643.first;
				class298.first.last = class298;
				class298_1_.last = class453_0_.aClass298_5643;
				class453_0_.aClass298_5643.first = class298_1_;
			}
		} catch (RuntimeException runtimeexception) {
	...
	public void method5938(Class453 class453_2_, int i) {
		try {
			if (aClass298_5643 != aClass298_5643.last)
				method5937(class453_2_, aClass298_5643.last, (byte) -5);
		} catch (RuntimeException runtimeexception) {
	...
	Class298 method5940(Class298 class298, byte i) {
		try {
			...
			if (null == class298)
				class298_3_ = aClass298_5643.first;
			else
			...
			((Class453) this).aClass298_5644 = class298_3_.first;
			return class298_3_;
		} catch (RuntimeException runtimeexception) {
	...
	Class298[] method5941(byte i) {
		try {
			...
			int i_4_ = 0;
			for (Class298 class298 = aClass298_5643.last; class298 != aClass298_5643; class298 = class298.last)
	...
	public void clear(byte i) {
		try {
			while (aClass298_5643.last != aClass298_5643)
				aClass298_5643.last.remove(-1460969981);
		} catch (RuntimeException runtimeexception) {
	...
	public Object[] toArray(Object[] objects) {
		try {
			int i = 0;
			for (Class298 class298 = aClass298_5643.last; aClass298_5643 != class298; class298 = class298.last)
				objects[i++] = class298;
			return objects;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("sr.toArray(").append(')').toString());
	...
	public Class298 method5944(int i) {
		try {
			Class298 class298 = ((Class453) this).aClass298_5644;
			if (aClass298_5643 == class298) {
				((Class453) this).aClass298_5644 = null;
				return null;
			}
			((Class453) this).aClass298_5644 = class298.last;
			return class298;
		} catch (RuntimeException runtimeexception) {
	...
	Class298 method5945(Class298 class298, int i) {
		try {
			...
			if (class298 == null)
				class298_5_ = aClass298_5643.last;
			else
			...
			((Class453) this).aClass298_5644 = class298_5_.last;
			return class298_5_;
		} catch (RuntimeException runtimeexception) {
	...
	public Class453() {
		aClass298_5643.last = aClass298_5643;
		aClass298_5643.first = aClass298_5643;
	}
	...
	public boolean method5946(int i) {
		try {
			return aClass298_5643 == aClass298_5643.last;
		} catch (RuntimeException runtimeexception) {
	...
	public Class298 method5947(int i) {
		try {
			...
			((Class453) this).aClass298_5644 = class298.first;
			return class298;
		} catch (RuntimeException runtimeexception) {
	...
	public static void method5951(int i, int i_7_, int i_8_, ObjectConfig class432, int i_9_) {
		try {
	...
	static final void method5952(ClientScript2 class403, int i) {
		try {
			...
			WidgetDetails.method4582(class105, class119, class403, -638652080);
		} catch (RuntimeException runtimeexception) {
