...
public class Class14 {
	...
	public static void method341(int i, int[] is, int i_0_) {
		try {
			if (i != -1 && Class378.method4671(i, is, -2060750983)) {
				WidgetConfig[] class105s = Class389.aClass119Array4165[i].components;
				RSGraphics.method611(class105s, -1178956884);
			}
	...
	static final void method342(ClientScript2 class403, int i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub30_7575, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]) != 0 ? 1 : 0, -261887884);
	...
	static final void method343(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_1_, (byte) -45);
	...
	static final void method345(ClientScript2 class403, int i) {
		try {
			...
			if (i_2_ == 1 && Settings.ENABLE_MODERN_OPENGL)
				i_2_ = 5;
			if (i_2_ < 0 || i_2_ > 5)
				i_2_ = 2;
	...
	static final void method346(byte i) {
		try {
			for (Class298_Sub37_Sub2 class298_sub37_sub2 = ((Class298_Sub37_Sub2) client.projectiles.method5939(1766612795)); null != class298_sub37_sub2; class298_sub37_sub2 = ((Class298_Sub37_Sub2) client.projectiles.method5944(49146))) {
				...
				if (443738891 * client.anInt8884 > class365_sub1_sub1_sub1.anInt10049 * -1349988959) {
					class298_sub37_sub2.remove(-1460969981);
					...
					if (1894383945 * class365_sub1_sub1_sub1.anInt10058 > 0) {
						if (1596783995 * client.anInt8724 == 0) {
							...
							if (null != class365_sub1_sub1_sub2) {
								...
								if ((int) class217.x >= 0 && ((int) class217.x < client.aClass283_8716.method2629(-1942094391) * 512) && (int) class217.y >= 0 && ((int) class217.y < client.aClass283_8716.method2630(-1804151587) * 512))
									class365_sub1_sub1_sub1.method4405((int) class217.x, (int) class217.y, ((Class356.getPlayerHeight((int) class217.x, (int) class217.y, class365_sub1_sub1_sub2.plane, -1503815167)) - (2134079017 * (class365_sub1_sub1_sub1.anInt10045))), 443738891 * client.anInt8884, 1121215352);
							}
						} else {
							ObjectValue class298_sub29 = ((ObjectValue) (client.aClass437_8696.method5812((long) ((1894383945 * (class365_sub1_sub1_sub1.anInt10058)) - 1))));
							if (class298_sub29 != null) {
								...
								if ((int) class217.x >= 0 && ((int) class217.x < client.aClass283_8716.method2629(-1876273086) * 512) && (int) class217.y >= 0 && ((int) class217.y < client.aClass283_8716.method2630(-203309822) * 512))
									class365_sub1_sub1_sub1.method4405((int) class217.x, (int) class217.y, ((Class356.getPlayerHeight((int) class217.x, (int) class217.y, class365_sub1_sub1_sub1.plane, -1366613250)) - (class365_sub1_sub1_sub1.anInt10045 * 2134079017)), client.anInt8884 * 443738891, 2031199219);
							}
						}
					}
					if (1894383945 * class365_sub1_sub1_sub1.anInt10058 < 0) {
						...
						if (null != class365_sub1_sub1_sub2_sub2) {
							...
							if ((int) class217.x >= 0 && ((int) class217.x < client.aClass283_8716.method2629(-1981087344) * 512) && (int) class217.y >= 0 && ((int) class217.y < client.aClass283_8716.method2630(-1284142631) * 512))
								class365_sub1_sub1_sub1.method4405((int) class217.x, (int) class217.y, ((Class356.getPlayerHeight((int) class217.x, (int) class217.y, class365_sub1_sub1_sub1.plane, -1135065402)) - (class365_sub1_sub1_sub1.anInt10045 * 2134079017)), 443738891 * client.anInt8884, 1831333850);
						}
					}
