...
public class ConfigDefinitions {
	...
	void parseBuffer(RsByteBuffer buffer, int i) {
		try {
			for (;;) {
	...
	void parseOpcode(RsByteBuffer buffer, int opcode) {
		if (opcode == 1) {
	...
	static final void method3978(WidgetConfig interfacedef, Class119 class119, ClientScript2 script, int i) {
		try {
			...
			interfacedef.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
	...
	static Class298_Sub32 method3981(RsByteBuffer buffer, int i) {
		try {
			buffer.readUnsignedByte();
			int i_4_ = buffer.readUnsignedByte();
			Class298_Sub32 textureConfig = Class234.method2182(i_4_, (byte) 11);
			textureConfig.anInt7381 = buffer.readUnsignedByte() * -2127296983;
			int i_5_ = buffer.readUnsignedByte();
			for (int i_6_ = 0; i_6_ < i_5_; i_6_++) {
				int i_7_ = buffer.readUnsignedByte();
				textureConfig.method3137(i_7_, buffer, (byte) 92);
			}
			textureConfig.method3133(-245700254);
	...
	static final void method3984(ClientScript2 class403, int i) {
		try {
			int i_8_ = ((client.anIntArrayArrayArray8767[(class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)])]).length >> 1);
