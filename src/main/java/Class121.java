...
final class Class121 implements Interface4 {
	...
	static final void method1314(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_0_, (byte) -40);
	...
	static Preferences method1315(int i) {
		try {
			JagexFile2 class476 = null;
			Preferences class298_sub48 = new Preferences(client.aClass411_8944, 0);
			try {
				class476 = Class86.getPreferences("", client.aClass411_8944.aString5317, false, -1804643872);
				...
				class298_sub48 = new Preferences(new RsByteBuffer(is), client.aClass411_8944, 0);
