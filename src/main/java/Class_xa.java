...
public abstract class Class_xa {
	...
	public final int method6341(int i, int i_52_, byte i_53_) {
		try {
			if (i >= anIntArrayArray6290.length)
				i = anIntArrayArray6290.length-1;
			if (i_52_ >=  anIntArrayArray6290[i].length)
				i_52_ = anIntArrayArray6290[i].length-1;
	...
	static final void method6360(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_166_, (byte) 109);
	...
	static final void method6361(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_167_, (byte) -33);
	...
	static final void method6363(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class422_Sub25.preferences.aClass422_Sub6_7551.method5646((byte) -74) && FloorOverlay.graphics.method5050()) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
