...
public class Class317 {
	...
	public Class317(Class411 class411, Class429 class429, CacheIndex class243) {
		...
		((Class317) this).aClass243_3319.method2316((-1006924897 * (ConfigFile.aClass120_1434.anInt1460)), -1713499559);
	}
	...
	Class325 method3849(int i, int i_6_) {
		try {
			...
			synchronized (((Class317) this).aClass243_3319) {
				is = (((Class317) this).aClass243_3319.getFileFromArchive(ConfigFile.aClass120_1434.anInt1460 * -1006924897, i, (byte) -79));
			}
	...
	static final void method3850(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			...
			if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403)
				Preference.method5623(class105.uid * -440872681, 1592451280);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method3852(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_7_, (byte) -76);
			Class119 class119 = Class389.aClass119Array4165[i_7_ >>> 16];
			WidgetConfig class105_8_ = Class523.method6331(class119, class105, -635605619);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (class105_8_ == null ? -1 : -440872681 * class105_8_.uid);
		} catch (RuntimeException runtimeexception) {
