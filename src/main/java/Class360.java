...
public class Class360 {
	...
	static {
		...
		usernameL = 2742373017286080113L;
		anInt3896 = -395862839;
		aLong3911 = 0L;
		username = "";
		password = "";
	...
	static final void method4298(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_2_, (byte) 52);
			...
			synchronized (ClientScriptsExecutor.aQueue4124) {
				...
				for (;;) {
					...
					if (point == null || !Class52_Sub2_Sub1.aCanvas9079.isShowing() || !Class422_Sub7.aBoolean8385)
						...
						} else if ((class298_sub50_sub2.method3547((byte) 16) < -2110394505 * Class462.screenWidth) && (class298_sub50_sub2.method3560(-1530423246) < (-1111710645 * Class298_Sub40_Sub9.screenHeight)) && class298_sub50_sub2.method3547((byte) 15) >= 0) {
	...
	public static Class309 method4302(int i) {
		try {
			...
			//return new Class309_Sub1(); //disable jaclib. System.nanoTime seems more efficient.
		} catch (RuntimeException runtimeexception) {
