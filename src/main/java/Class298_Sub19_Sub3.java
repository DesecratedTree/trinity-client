...
public class Class298_Sub19_Sub3 extends Class298_Sub19 {
	...
	synchronized void method3034(Class298_Sub30 class298_sub30, int i) {
		try {
			...
			((Class298_Sub19_Sub3) this).aClass453_9259.add(class298_sub30, -332995145);
	...
	static final void processNPCs(int i) {
		try {
			for (int i_11_ = 0; i_11_ < -1230451913 * client.anInt8703; i_11_++) {
				int i_12_ = client.anIntArray8699[i_11_];
				ObjectValue class298_sub29 = ((ObjectValue) client.aClass437_8696.method5812((long) i_12_));
				if (class298_sub29 != null) {
					NPC class365_sub1_sub1_sub2_sub1 = ((NPC) class298_sub29.value);
					Class135.processEntity(class365_sub1_sub1_sub2_sub1, false, -2088974966);
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	synchronized void method3040(byte i) {
		try {
			...
			if (class298_sub30 != null) {
				class298_sub30.remove(-1460969981);
	...
	public static void method3041(Canvas canvas, short i) {
		try {
			try {
				Class<Canvas> var_class = java.awt.Canvas.class;
