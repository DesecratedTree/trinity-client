...
public abstract class Class365_Sub1_Sub5 extends Class365_Sub1 {
	...
	boolean method4395() {
		...
		return (((Class331) aClass331_7722).aBooleanArrayArray3563[(583010427 * ((Class331) aClass331_7722).renderDistance + (((int) class217.x >> -1688804109 * aClass331_7722.anInt3504) - -804213305 * ((Class331) aClass331_7722).anInt3553))][(((Class331) aClass331_7722).renderDistance * 583010427 + (((int) class217.y >> -1688804109 * aClass331_7722.anInt3504) - ((Class331) aClass331_7722).anInt3513 * 465603579))]);
	}

	int method4354(Class298_Sub10[] class298_sub10s, int i) {
		try {
			SceneObjectPosition class217 = method4337().aClass217_2599;
			int i_0_ = ((int) class217.x >> -1688804109 * aClass331_7722.anInt3504);
			int i_1_ = ((int) class217.y >> -1688804109 * aClass331_7722.anInt3504);
			int i_2_ = 0;
	...
	boolean method4364(GraphicsToolkit class_ra, byte i) {
		try {
			SceneObjectPosition class217 = method4337().aClass217_2599;
			return (aClass331_7722.aClass333_3512.method4072(this, aByte7724, ((int) class217.x >> aClass331_7722.anInt3504 * -1688804109), ((int) class217.y >> -1688804109 * aClass331_7722.anInt3504)));
		} catch (RuntimeException runtimeexception) {
	...
	int method4390(Class298_Sub10[] class298_sub10s) {
		SceneObjectPosition class217 = method4337().aClass217_2599;
		int i = ((int) class217.x >> -1688804109 * aClass331_7722.anInt3504);
		int i_4_ = ((int) class217.y >> -1688804109 * aClass331_7722.anInt3504);
		int i_5_ = 0;
	...
	Class365_Sub1_Sub5(Class331 class331, int i, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_) {
		...
		setPosition(new SceneObjectPosition((float) i, (float) i_7_, (float) i_8_));
	}
	...
	static final void method4522(ClientScript2 class403, int i) {
		try {
			...
			WorldMapArea class298_sub37_sub13 = WorldMap.method3705(i_12_);
