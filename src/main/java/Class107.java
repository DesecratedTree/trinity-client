...
public class Class107 {
	...
	static Class102[] chatMessages = new Class102[500]; //100
	...
	static final void method1140(ClientScript2 class403, int i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub25_7569, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]), -2044130238);
	...
	static final void method1141(ClientScript2 class403, short i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_5_, (byte) 78);
