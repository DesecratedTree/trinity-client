...
public class Class292 {
	...
	static final void method2812(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_0_, (byte) -102);
	...
	static void method2816(WidgetConfig class105, int i, int i_6_, byte i_7_) {
		try {
			if (class105.xPositionMode == 0)
				class105.xOnScreen = -1672688609 * class105.x;
			else if (class105.xPositionMode == 1)
				class105.xOnScreen = (-1014229119 * (class105.x * 1499181983 + (i - -2093041337 * class105.anInt1156) / 2));
			else if (2 == class105.xPositionMode)
				class105.xOnScreen = -1014229119 * (i - class105.anInt1156 * -2093041337 - 1499181983 * class105.x);
			else if (class105.xPositionMode == 3)
				class105.xOnScreen = (i * (1499181983 * class105.x) >> 14) * -1014229119;
			else if (4 == class105.xPositionMode)
				class105.xOnScreen = -1014229119 * ((i - -2093041337 * class105.anInt1156) / 2 + (i * (1499181983 * class105.x) >> 14));
			else
				class105.xOnScreen = (i - -2093041337 * class105.anInt1156 - (1499181983 * class105.x * i >> 14)) * -1014229119;
			if (class105.yPositionMode == 0)
				class105.yOnScreen = 705123139 * class105.y;
			else if (class105.yPositionMode == 1)
				class105.yOnScreen = ((class105.y * -901738979 + (i_6_ - 457937409 * class105.anInt1162) / 2) * 1145252063);
			else if (class105.yPositionMode == 2)
				class105.yOnScreen = (i_6_ - 457937409 * class105.anInt1162 - -901738979 * class105.y) * 1145252063;
			else if (3 == class105.yPositionMode)
				class105.yOnScreen = 1145252063 * (class105.y * -901738979 * i_6_ >> 14);
			else if (class105.yPositionMode == 4)
				class105.yOnScreen = (((-901738979 * class105.y * i_6_ >> 14) + (i_6_ - 457937409 * class105.anInt1162) / 2) * 1145252063);
			else
				class105.yOnScreen = 1145252063 * (i_6_ - class105.anInt1162 * 457937409 - (class105.y * -901738979 * i_6_ >> 14));
			if (client.SHOW_HIDDEN_OPTIONS && (client.method2801(class105).anInt7416 * -1266165749 != 0 || 0 == class105.type * -1215239439)) {
				if (class105.xOnScreen * 1354508417 < 0)
					class105.xOnScreen = 0;
				else if ((class105.xOnScreen * 1354508417 + -2093041337 * class105.anInt1156) > i)
					class105.xOnScreen = -1014229119 * (i - -2093041337 * class105.anInt1156);
				if (class105.yOnScreen * -749038817 < 0)
					class105.yOnScreen = 0;
				else if ((class105.yOnScreen * -749038817 + 457937409 * class105.anInt1162) > i_6_)
					class105.yOnScreen = 1145252063 * (i_6_ - 457937409 * class105.anInt1162);
			}
		} catch (RuntimeException runtimeexception) {
