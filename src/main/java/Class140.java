...
public class Class140 implements Runnable {
	...
	public static Class190 method1554(int i, int i_2_) {
		try {
			...
			if (2 == class190.anInt1940 * -1955592777 && Class190.aClass437_1928.method5812((long) i) == null) {
				Class190.aClass437_1928.method5817(new IntegerValue(Class190.anInt1932 * 1105746915), (long) i);
	...
	static void method1555(NPC class365_sub1_sub1_sub2_sub1, boolean bool, byte i) {
		try {
			if (Class436.anInt5506 * -278777595 < 410) {
				...
				if (class503.hasOptions) {
					if (1817570317 * class365_sub1_sub1_sub2_sub1.combatLevel != 0) {
						...
						string = new StringBuilder().append(string).append(Class18.method358(1817570317 * (class365_sub1_sub1_sub2_sub1.combatLevel), (Class287.myPlayer.anInt10206) * 696798311, (byte) 4)).append(Class26.aString349).append(string_3_).append(1817570317 * class365_sub1_sub1_sub2_sub1.combatLevel).append(Class26.aString352).toString();
					}
					...
					if (!bool) {
						String[] strings = class503.actions;
						if (client.aBoolean8922)
							strings = Class519.method6319(strings, -1228297238);
						
						boolean hidePetOptions = class503.isPet();
						if (null != strings) {
							for (int i_4_ = strings.length - 1; i_4_ >= 0; i_4_--) {
								if (strings[i_4_] != null && (/*0 == class503.showOptionsFirst || */(!(strings[i_4_].equalsIgnoreCase(Tradution.aClass470_5906.method6049(Class321.aClass429_3357, -875414210))) && !(!hidePetOptions && strings[i_4_].equalsIgnoreCase(Tradution.aClass470_5905.method6049(Class321.aClass429_3357, -875414210)))))) {
									int i_5_ = 0;
									...
									if (i_4_ == 5)
										i_5_ = 1003;
									//TODO set pet hidden
									if (0 != i_5_ /* (i_4_ == 0 || i_4_ == 2)*/ && hidePetOptions)
										i_5_ += 2000;
							...
							if (class503.showOptionsFirst == 1 || true) {
								for (int i_7_ = 0; i_7_ < strings.length; i_7_++) {
									if (strings[i_7_] != null && ((strings[i_7_].equalsIgnoreCase(Tradution.aClass470_5906.method6049(Class321.aClass429_3357, -875414210))) || (!hidePetOptions && strings[i_7_].equalsIgnoreCase(Tradution.aClass470_5905.method6049(Class321.aClass429_3357, -875414210))))) {
										short i_8_ = 0;
										if (/*(1817570317 * (class365_sub1_sub1_sub2_sub1.combatLevel)) > (Class287.myPlayer.anInt10206) * 696798311*/
												Settings.HIDE_ATTACK_OPTION)
											i_8_ = (short) 2000;
	...
	public static WidgetConfig method1558(int i, int i_15_, int i_16_) {
		try {
			WidgetConfig class105 = Class50.getIComponentDefinitions(i, (byte) -11);
			if (-1 == i_15_)
				return class105;
	...
	static final boolean method1559(Class433 class433, int i, int type, byte i_18_) {
		try {
			ObjectConfig class432 = class433.getObjectDefinitions(i);
			if (11 == type)
				type = 10;
			if (type >= 5 && type <= 8)
				type = 4;
			return class432.method5771(type, (byte) 91);
		} catch (RuntimeException runtimeexception) {
