...
public class Class82_Sub3 extends Class82 {
	int anInt6823;
	int anInt6824;
	static WidgetConfig aClass105_6825;

	Class82_Sub3(RsByteBuffer class298_sub53) {
		super(class298_sub53);
		((Class82_Sub3) this).anInt6824 = class298_sub53.readUnsignedShort() * -40183047;
		((Class82_Sub3) this).anInt6823 = class298_sub53.readBigSmart(1235052657) * -1186011313;
	}

	public void method866(int i) {
		try {
			Class86 class86 = (Class87.aClass86Array798[((Class82_Sub3) this).anInt6824 * -878655671]);
			Tradution.method6055(-637425735 * ((Class86) class86).anInt788, ((Class86) class86).anInt789 * -123379955, ((Class86) class86).anInt790 * 1400706617, (((Class86) class86).aClass424_787.anInt6615 * -6749525), (((Class86) class86).aClass424_787.anInt6613 * -1976050083), 1067426701 * ((Class86) class86).anInt791, ((Class82_Sub3) this).anInt6823 * 1204408239, 55517890);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("xd.f(").append(')').toString());
		}
	}

	boolean method879() {
		AnimationConfig class391 = Class501.aClass395_6122.method4903((((Class82_Sub3) this).anInt6823) * 1204408239, (byte) -25);
		return class391.method4880(509501216);
	}

	boolean method870(int i) {
		try {
			AnimationConfig class391 = Class501.aClass395_6122.method4903((((Class82_Sub3) this).anInt6823) * 1204408239, (byte) -37);
	...
	static final void method880(ClientScript2 class403, int i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub29_7582, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]), -2055385599);
			Class3.savePreferences(656179282);
			client.sentPreferences = false;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("xd.aid(").append(')').toString());
		}
	}

	static long method881(byte i) {
		try {
			return Class291.aClass309_6492.method3794(-489985044);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("xd.aa(").append(')').toString());
		}
	}
}
