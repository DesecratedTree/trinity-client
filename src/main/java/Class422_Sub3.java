...
public class Class422_Sub3 extends Preference {
	public static int anInt8370 = 0;
	public static int anInt8371 = 1;
	static int[] anIntArray8372;

	public Class422_Sub3(int i, Preferences class298_sub48) {
	...
	public Class422_Sub3(Preferences class298_sub48) {
	...
	static final void method5635(int i) {
		try {
			...
			for (int i_3_ = 0; i_3_ < -1230451913 * client.anInt8703; i_3_++) {
				...
				ObjectValue class298_sub29 = (ObjectValue) client.aClass437_8696.method5812(l);
				if (null == class298_sub29) {
					if (i == -1062447355)
						throw new IllegalStateException();
				} else
					((Entity) class298_sub29.value).method4428(1089221669);
			}
