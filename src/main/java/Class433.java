...
public class Class433 {
	...
	public void method5792(int i, byte i_1_) {
		try {
			((Class433) this).aClass348_5449 = new CachingHashMap(i);
		} catch (RuntimeException runtimeexception) {
	...
	public Class433(Class411 class411, Class429 class429, boolean bool, CacheIndex class243, CacheIndex class243_3_) {
		...
		if (null != ((Class433) this).aClass243_5446) {
			...
			ConfigFile.aClass120_1443.method1306((short) 23751);
	...
	public ObjectConfig getObjectDefinitions(int objectId) {
		try {
			ObjectConfig class432;
			synchronized (((Class433) this).aClass348_5449) {
				class432 = (ObjectConfig) ((Class433) this).aClass348_5449.get((long) objectId);
			}
			if (class432 != null)
				return class432;
			byte[] is;
			synchronized (((Class433) this).aClass243_5446) {
				is = (((Class433) this).aClass243_5446.getFileFromArchive(ConfigFile.aClass120_1443.method1307(objectId, -1875026798), ConfigFile.aClass120_1443.method1305(objectId, -1955117131), (byte) -69));
			}
			class432 = new ObjectConfig();
			class432.id = objectId * -950871973;
			((ObjectConfig) class432).aClass433_5403 = this;
			class432.options = (String[]) ((Class433) this).aStringArray5454.clone();
			if (null != is)
				class432.decode(new RsByteBuffer(is), -1780393822);
			class432.method5778(-231037911);
			if (class432.ignoreClipOnAlternativeRoute) {
				class432.cliped = 0;
				class432.solid = false;
			}
			if (!((Class433) this).aBoolean5445 && class432.aBoolean5434) {
				class432.options = null;
				class432.anIntArray5370 = null;
			}
			CustomObjects.modify(class432);
			synchronized (((Class433) this).aClass348_5449) {
	...
	static final void method5798(ClientScript2 class403, short i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_19_, (byte) -1);
