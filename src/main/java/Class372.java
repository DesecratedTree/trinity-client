...
public class Class372 {
	...
	static final void method4588(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub25_7569.method5716((byte) -30);
		} catch (RuntimeException runtimeexception) {
	...
	public static CacheIndex loadIndex(CacheIndexIndicator sprites, boolean bool, int i, boolean bool_5_, int i_6_) {
		try {
			if (null == FloorOverlay.aClass242_Sub1Array4072)
				FloorOverlay.aClass242_Sub1Array4072 = new GrabFolder[Class356.method4268(1608416895)];
			if (Class365_Sub1_Sub3_Sub2.HEADER_PARTITION == null)
				Class365_Sub1_Sub3_Sub2.HEADER_PARTITION =  new Partition(255, client.cachedat2, client.cacheidx255, 15000000);
			Partition class329 = null;
			int id = sprites.method1233(958180062);
			if (null != client.cachedat2) //increased max size by 10x just in case
				class329 = new Partition(id, client.cachedat2, Class497.aClass484Array6106[id], 15000000);
			FloorOverlay.aClass242_Sub1Array4072[id] = Class203.aClass225_2337.method2095(id, class329, (Class365_Sub1_Sub3_Sub2.HEADER_PARTITION), 311001416);
			FloorOverlay.aClass242_Sub1Array4072[id].method2278((byte) 2);
			return new CacheIndex(FloorOverlay.aClass242_Sub1Array4072[id], bool, i);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("pl.fz(").append(')').toString());
		}
	}

	public static void method4591(WidgetConfig[] class105s, int i, int i_8_, int i_9_, boolean bool, short i_10_) {
		try {
			for (int i_11_ = 0; i_11_ < class105s.length; i_11_++) {
				...
				} else if (1573706803 * class105.parentUID != i) {
					if (i_10_ == 255)
						break;
				} else {
					Class82_Sub10.method904(class105, i_8_, i_9_, bool, (byte) 59);
					Class292.method2816(class105, i_8_, i_9_, (byte) -3);
					if (684246511 * class105.anInt1166 > (1867913305 * class105.scrollWidth - -2093041337 * class105.anInt1156))
						class105.anInt1166 = (1227329079 * class105.scrollWidth - 2072992297 * class105.anInt1156);
					if (684246511 * class105.anInt1166 < 0)
						class105.anInt1166 = 0;
					if (-1424956747 * class105.anInt1167 > (2053897963 * class105.scrollHeight - class105.anInt1162 * 457937409))
						class105.anInt1167 = (2097037087 * class105.scrollHeight - class105.anInt1162 * -900266595);
