...
public class Class91 {
	...
	static final void method1000(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_2_, (byte) -34);
	...
	static void method1001(Entity class365_sub1_sub1_sub2, byte i) {
		try {
			if (class365_sub1_sub1_sub2 instanceof NPC) {
				...
				if (class365_sub1_sub1_sub2_sub1.config != null)
	...
	static final void method1002(byte i) {
		try {
			...
			int i_5_ = Class356.getPlayerHeight(Class75.anInt708 * 1103750049, Class106.anInt1309 * 1346160791, Class99.anInt952 * 1855729883, -737895541);
			int i_6_ = 0;
