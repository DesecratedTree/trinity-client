...
public class Class226 {
	...
	static final void method2106(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_36_, (byte) -58);
	...
	static final void method2108(ClientScript2 class403, short i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (null == client.aClass105_8819 ? -1 : -440872681 * client.aClass105_8819.uid);
		} catch (RuntimeException runtimeexception) {
