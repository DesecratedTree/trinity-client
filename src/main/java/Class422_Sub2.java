...
public class Class422_Sub2 extends Preference {
	...
	public Class422_Sub2(Preferences class298_sub48) {
	...
	public Class422_Sub2(int i, Preferences class298_sub48) {
	...
	static final void method5630(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class11.anInt156 = Class422_Sub25.preferences.graphicsMode.method5677(-460463412) * 1970440745) * -1111444967;
