...
public class Class78 {
	...
	static boolean supportPNG(byte i) {
		try {
			boolean bool;
			try {
	...
	static void method845(int i, int i_7_) {
		try {
			if (!Settings.LOBBY_ENABLED || 136 == Class360.anInt3868 * -122629167)
				Class360.anInt3892 = i * -1674285757;
			else if (Settings.LOBBY_ENABLED && 264 == Class360.anInt3868 * -122629167)
