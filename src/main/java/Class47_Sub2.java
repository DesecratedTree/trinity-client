...
public class Class47_Sub2 extends Class47 {
	...
	void method507(boolean bool) {
		...
		if (((Class47_Sub2) this).aBoolean6753 && class30_sub1 != null) {
			float f = (1.0F + (1.0F - Math.abs(((OpenGLLegacyToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).aFloatArray8124[1])) * 2.0F);
			...
			OpenGL.glUniform3f(OpenGL.glGetUniformLocation(i, "sunDir"), -(((OpenGLLegacyToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloatArray8124[0]), -(((OpenGLLegacyToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloatArray8124[1]), -(((OpenGLLegacyToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloatArray8124[2]));
			OpenGL.glUniform4f(OpenGL.glGetUniformLocation(i, "sunColour"), (((OpenGLLegacyToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloat8125) * f, (((OpenGLLegacyToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloat8128) * f, (((OpenGLLegacyToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloat8191) * f, 1.0F);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i, "sunExponent"), 64.0F + Math.abs(((OpenGLLegacyToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).aFloatArray8124[1]) * 928.0F);
	...
	void method516(int i, int i_0_) {
		if (((Class47_Sub2) this).aBoolean6755) {
			...
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_7_, "time"), (float) (i_1_ * ((OpenGLLegacyToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	void method517(int i, int i_8_) {
		if (((Class47_Sub2) this).aBoolean6755) {
			...
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_15_, "time"), (float) (i_9_ * ((OpenGLLegacyToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	void method503(int i, int i_16_) {
		if (((Class47_Sub2) this).aBoolean6755) {
			...
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_23_, "time"), (float) (i_17_ * ((OpenGLLegacyToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	Class47_Sub2(OpenGLLegacyToolkit class_ra_sub2, Class45 class45) {
		super(class_ra_sub2);
		((Class47_Sub2) this).aBoolean6753 = false;
		((Class47_Sub2) this).aClass45_6757 = class45;
		if ((((Class45) ((Class47_Sub2) this).aClass45_6757).aClass30_Sub4_485 != null) && (((OpenGLLegacyToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aBoolean8183) && (((OpenGLLegacyToolkit) ((Class47_Sub2) this).aClass_ra_Sub2_491).aBoolean8093)) {
			Class48 class48 = (Class48.method526(((Class47_Sub2) this).aClass_ra_Sub2_491, 35633, "uniform float time;\nuniform float scale;\nvarying vec3 wvVertex;\nvarying float waterDepth;\nvoid main() {\nwaterDepth = gl_MultiTexCoord0.z;\nvec4 ecVertex = gl_ModelViewMatrix*gl_Vertex;\nwvVertex.x = dot(gl_NormalMatrix[0], ecVertex.xyz);\nwvVertex.y = dot(gl_NormalMatrix[1], ecVertex.xyz);\nwvVertex.z = dot(gl_NormalMatrix[2], ecVertex.xyz);\ngl_TexCoord[0].x = dot(gl_TextureMatrix[0][0], gl_MultiTexCoord0)*scale;\ngl_TexCoord[0].y = dot(gl_TextureMatrix[0][1], gl_MultiTexCoord0)*scale;\ngl_TexCoord[0].z = time;\ngl_TexCoord[0].w = 1.0;\ngl_FogFragCoord = clamp((ecVertex.z-gl_Fog.start)*gl_Fog.scale, 0.0, 1.0);\ngl_Position = ftransform();\n}\n"));
			Class48 class48_24_ = (Class48.method526(((Class47_Sub2) this).aClass_ra_Sub2_491, 35632, "varying vec3 wvVertex;\nvarying float waterDepth;\nuniform vec3 sunDir;\nuniform vec4 sunColour;\nuniform float sunExponent;\nuniform vec2 waveIntensity;\nuniform float waveExponent;\nuniform float breakWaterDepth;\nuniform float breakWaterOffset;\nuniform sampler3D normalSampler;\nuniform samplerCube envMapSampler;\nvoid main() {\nvec4 wnNormal = texture3D(normalSampler, gl_TexCoord[0].xyz).rbga;\nwnNormal.xyz = 2.0*wnNormal.xyz-1.0;\nvec3 wnVector = normalize(wvVertex);\nvec3 wnReflection = reflect(wnVector, wnNormal.xyz);\nvec3 envColour = textureCube(envMapSampler, wnReflection).rgb;\nvec4 specularColour = sunColour*pow(clamp(-dot(sunDir, wnReflection), 0.0, 1.0), sunExponent);\nfloat shoreFactor = clamp(waterDepth/breakWaterDepth-breakWaterOffset*wnNormal.w, 0.0, 1.0);\nfloat waveFactor = pow(1.0-shoreFactor, waveExponent)-0.5;\nwaveFactor = -4.0*waveFactor*waveFactor+1.0;\nfloat ndote = dot(wnVector, wnNormal.xyz);\nfloat fresnel = pow(1.0-abs(ndote), 1.0);\nvec4 surfaceColour = mix(vec4(envColour, fresnel*shoreFactor), (waveIntensity.x*wnNormal.wwww)+waveIntensity.y, waveFactor)+specularColour*shoreFactor;\ngl_FragColor = vec4(mix(surfaceColour.rgb, gl_Fog.color.rgb, gl_FogFragCoord), surfaceColour.a);\n}\n"));
	...
	void method513(int i, int i_25_) {
		if (((Class47_Sub2) this).aBoolean6755) {
			...
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_32_, "time"), (float) (i_26_ * ((OpenGLLegacyToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	void method502(int i, int i_33_) {
		if (((Class47_Sub2) this).aBoolean6755) {
			...
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_40_, "time"), (float) (i_34_ * ((OpenGLLegacyToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	void method515(int i, int i_41_) {
		if (((Class47_Sub2) this).aBoolean6755) {
			...
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_48_, "time"), (float) (i_42_ * ((OpenGLLegacyToolkit) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
