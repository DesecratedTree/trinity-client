...
public abstract class Class40 {
	...
	int anInt436;
	OpenGLLegacyToolkit aClass_ra_Sub2_437;
	boolean aBoolean438;
	boolean aBoolean439 = false;
	static int[] anIntArray440 = new int[1];

	Class40(OpenGLLegacyToolkit class_ra_sub2, int i, Buffer buffer, int i_0_, boolean bool) {
		...
		((OpenGLLegacyToolkit) ((Class40) this).aClass_ra_Sub2_437).anInt8112 += ((Class40) this).anInt432;
	}
	...
	void method479(byte[] is, int i) {
		...
		if (i > ((Class40) this).anInt432) {
			...
			((OpenGLLegacyToolkit) ((Class40) this).aClass_ra_Sub2_437).anInt8112 += i - ((Class40) this).anInt432;
			((Class40) this).anInt432 = i;
		} else
			OpenGL.glBufferSubDataARBub(((Class40) this).anInt433, 0, i, is, 0);
	}

	Class40(OpenGLLegacyToolkit class_ra_sub2, int i, byte[] is, int i_1_, boolean bool) {
		((Class40) this).aClass_ra_Sub2_437 = class_ra_sub2;
		((Class40) this).anInt433 = i;
