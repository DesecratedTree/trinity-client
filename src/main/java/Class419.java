...
public class Class419 {
	...
	static boolean method5603(WidgetConfig class105, int i) {
		try {
	...
	static final void method5604(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3878(1767596149) ? 1 : 0;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3887(1474356836) ? 1 : 0;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3880((byte) -46) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
		...
		try {
			do {
				try {
					...
					} else if (string.equalsIgnoreCase("dumpoverlaydata")) {
						for (int id = 0; id < 174; id++) {
							byte [] data = WorldMap.aClass375_3253.aClass243_4082.getFileFromArchive(ConfigFile.aClass120_1439.anInt1460 * -1006924897, id, (byte) -18);
							System.out.println(data);
							try {
							Files.write(new File("floor/"+id+".dat").toPath(), data, StandardOpenOption.CREATE_NEW);
							} catch (Throwable e) {
								e.printStackTrace();
							}
							}
					} else if (string.equalsIgnoreCase("dumpoverlay")) {
						for (int id = 0; id < 174; id++) {
							FloorOverlay overlay = WorldMap.aClass375_3253.getOverlay(id, 0);
							int textureID = overlay.texture * 324071475;
							if (textureID == -1) 
								continue;
							//method5204(boolean, boolean, boolean, Class302_Sub3_Sub1, int, int, float, int)
							//method 5197
							...
							SafemodeToolkit smt = (SafemodeToolkit) toolkit;
							int[] data = smt.method5197(textureID);
							System.out.println(id+", "+textureID+", "+data.length);
							toolkit.dispose(0);
							try {
								int size = data.length  == 4096 ? 64 : data.length == 16384 ? 128 : -1;
								if (data.length == -1)
									System.out.println("wrong");
							BufferedImage image = new BufferedImage(size, size, BufferedImage.TYPE_INT_ARGB);
							image.setRGB(0, 0, size, size, data, 0, size);
							 ImageIO.write(image, "png", new File("texture/"+textureID+".png"));
							} catch (Throwable e) {
								e.printStackTrace();
							}
						}
					} else if (string.equalsIgnoreCase("dumptexture")) {
						for (int textureID = 0; textureID < 100000; textureID++) {
							//method5204(boolean, boolean, boolean, Class302_Sub3_Sub1, int, int, float, int)
							//method 5197
							Canvas canvas = new Canvas();
							canvas.setSize(512, 512);
					...
					} else if (string.equalsIgnoreCase("dumpitems")) {
						try {
						for (int id = 0; id < 83000; id++) {
							Canvas canvas = new Canvas();
							...
							int[] data = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(id).method6031(toolkit,  FloorOverlay.graphics, -1, 1, -13623264, false, 2, item, null, 1026825677);
							if (data == null)
								continue;
							toolkit.dispose(0);
							BufferedImage image = new BufferedImage(36, 32, BufferedImage.TYPE_INT_ARGB);
							image.setRGB(0, 0, 36, 32, data, 0, 36);
							System.out.println(new File("items/"+id+".png").getAbsolutePath());
							 ImageIO.write(image, "png", new File("items/"+id+".png"));
						} 
						}catch (Throwable e) {
							e.printStackTrace();
						}
					...
					} else if (string.equalsIgnoreCase("examinedn")) {
						client.rightClickHack = !client.rightClickHack;
						Class255.method2435("Right click anything " + client.rightClickHack, 1184714257);
					} else if (string.equalsIgnoreCase("objectdump")) {
						Class255.method2435("Dumping objects to desktop... ", 1184714257);
						CustomObjects.dumpObjects();
						Class255.method2435("Finished ", 1184714257);
					} else if (string.equalsIgnoreCase("itemdump")) {
						Class255.method2435("Dumping items to desktop... ", 1184714257);
						CustomItems.dumpItems();
						Class255.method2435("Finished ", 1184714257);
					} else if (string.equals("renderer")) {
						Class58 class58 = FloorOverlay.graphics.method4987();
						Class255.method2435(new StringBuilder().append("Toolkit ID: ").append(Class422_Sub25.preferences.graphicsMode.method5677(-481266690)).toString(), 1038434697);
			...
			if (Class242.aClass401_2708 != Class401.aClass401_6557 || 1806357379 * client.playerRights >= 0) { //2
				try {
					if (string.equalsIgnoreCase("wm1")) {
						Class357.method4276(1, -1, -1, false, 1791719030);
						if (Class190.getDisplayMode((byte) -15) == 1)
					...
					if (string.equalsIgnoreCase("test")) {
						...
						Class255.method2435("Testing", 1308535348);
						return;
					}
					...
					if (string.equalsIgnoreCase("wm2")) {
						...
						if (Class190.getDisplayMode((byte) -79) == 2)
					...
					if (Class452.fullScreen && string.equalsIgnoreCase("wm3")) {
						Class357.method4276(3, 1024, 768, false, 1894568246);
						if (Class190.getDisplayMode((byte) -25) == 3)
					...
					if (string.equalsIgnoreCase("tk0")) {
						...
						if (Class422_Sub25.preferences.graphicsMode.method5677(-1547826526) == 0) {
							Class255.method2435("Success", 267543271);
							Class422_Sub25.preferences.method3540((Class422_Sub25.preferences.aClass422_Sub14_7570), 0, -458723189);
					...
					if (string.equalsIgnoreCase("tk1")) {
						...
						if (Class422_Sub25.preferences.graphicsMode.method5677(-957568446) == 1) {
							Class255.method2435("Success", 1271200712);
							Class422_Sub25.preferences.method3540((Class422_Sub25.preferences.aClass422_Sub14_7570), 1, -72348841);
							Class3.savePreferences(656179282);
							client.sentPreferences = false;
						} else
					...
					if (string.equalsIgnoreCase("tk2")) {
						...
						if (Class422_Sub25.preferences.graphicsMode.method5677(-565622932) == 2) {
							Class255.method2435("Success", 1728166997);
							Class422_Sub25.preferences.method3540((Class422_Sub25.preferences.aClass422_Sub14_7570), 2, 345084383);
							Class3.savePreferences(656179282);
							client.sentPreferences = false;
						} else
					...
					if (string.equalsIgnoreCase("tk3")) {
						...
						if (Class422_Sub25.preferences.graphicsMode.method5677(-1899485997) == 3) {
							Class255.method2435("Success", 2073339182);
							Class422_Sub25.preferences.method3540((Class422_Sub25.preferences.aClass422_Sub14_7570), 3, 1121469356);
							Class3.savePreferences(656179282);
							client.sentPreferences = false;
						} else
					...
					if (string.equalsIgnoreCase("tk5")) {
						...
						if (Class422_Sub25.preferences.graphicsMode.method5677(-996545824) == 5) {
							Class255.method2435("Success", 892097548);
							Class422_Sub25.preferences.method3540((Class422_Sub25.preferences.aClass422_Sub14_7570), 5, -1087457820);
							Class3.savePreferences(656179282);
							client.sentPreferences = false;
						} else
					...
					if (string.equalsIgnoreCase("breakcon")) {
						Class25[] class25s = client.aClass25Array8679;
						for (int i_10_ = 0; i_10_ < class25s.length; i_10_++) {
							Class25 class25 = class25s[i_10_];
