...
public class Class498 {
	...
	public Class498(NPCConfig class503, boolean bool) {
		if (bool) {
			anIntArray6108 = new int[class503.models.length];
			System.arraycopy(class503.models, 0, anIntArray6108, 0, anIntArray6108.length);
		} else {
			anIntArray6108 = new int[class503.headModels.length];
			System.arraycopy(class503.headModels, 0, anIntArray6108, 0, anIntArray6108.length);
		}
		if (null != class503.modifiedColors) {
			aShortArray6109 = new short[class503.modifiedColors.length];
			System.arraycopy(class503.modifiedColors, 0, aShortArray6109, 0, aShortArray6109.length);
		}
		if (null != class503.modifiedTextures) {
			aShortArray6107 = new short[class503.modifiedTextures.length];
			System.arraycopy(class503.modifiedTextures, 0, aShortArray6107, 0, aShortArray6107.length);
		}
	}
	...
	static final void method6210(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub29_7587.method5726(-2147059683);
		} catch (RuntimeException runtimeexception) {
