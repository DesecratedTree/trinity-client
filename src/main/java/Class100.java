...
public class Class100 {
	...
	static final void method1073(ClientScript2 class403, byte i) {
		try {
			WidgetConfig class105 = Class50.getIComponentDefinitions((((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]), (byte) -124);
	...
	static final void method1074(ClientScript2 class403, int i) {
		try {
			WorldMapArea.method3455((((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]), -1482618001);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1076(ClientScript2 class403, int i) {
		try {
			...
			if (!FloorOverlay.graphics.method5032())
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = 3;
			else
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = Class422_Sub25.preferences.aClass422_Sub13_7549.method5612(i_2_, 1352882135);
		} catch (RuntimeException runtimeexception) {
