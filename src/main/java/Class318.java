...
public abstract class Class318 {
	...
	public abstract int readBytes(byte[] is, int i, int i_1_, byte i_2_) throws IOException;
	...
	public static Container method3874(byte i) {
		try {
			if (null != Class231.fullScreenFrame)
				return Class231.fullScreenFrame;
			if (null != Class298_Sub36.frame)
				return Class298_Sub36.frame;
	...
	static final void method3875(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anInt5239 -= -1567522756;
			class105.width = -478399925 * (((ClientScript2) class403).anIntArray5244[((ClientScript2) class403).anInt5239 * 681479919]);
			class105.height = (-1661995333 * (((ClientScript2) class403).anIntArray5244[1 + 681479919 * ((ClientScript2) class403).anInt5239]));
			...
			if (i_16_ < 0)
				...
				i_16_ = 4;
			class105.widthMode = (byte) i_15_;
			class105.heightMode = (byte) i_16_;
