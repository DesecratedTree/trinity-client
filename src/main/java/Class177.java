...
public class Class177 {
	...
	static final void method1831(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_0_, (byte) 90);
	...
	static final void method1832(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub15_7560.method5684(-1807205533) == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1833(ClientScript2 class403, int i) {
		try {
			...
			if (Class389.aClass119Array4165[i_1_] == null)
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = (Class389.aClass119Array4165[i_1_].components).length;
		} catch (RuntimeException runtimeexception) {
