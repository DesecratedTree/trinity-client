...
public class Class359 implements Interface19 {
	...
	static void method4291(Class119 class119, int i, int i_5_, int i_6_, boolean bool, ClientScript2 class403, int i_7_) {
		try {
			...
			WidgetConfig class105 = class119.components[i];
			if (null == class105.aClass105Array1292) {
				class105.aClass105Array1292 = new WidgetConfig[i_6_ + 1];
			...
			if (class105.aClass105Array1292.length <= i_6_) {
				if (class105.aClass105Array1293 == class105.aClass105Array1292) {
					WidgetConfig[] class105s = new WidgetConfig[1 + i_6_];
					...
					WidgetConfig[] class105s = new WidgetConfig[1 + i_6_];
					WidgetConfig[] class105s_9_ = new WidgetConfig[1 + i_6_];
			...
			WidgetConfig class105_11_ = new WidgetConfig();
			class105_11_.type = i_5_ * -800405999;
			class105_11_.parentUID = (class105_11_.uid = 1 * class105.uid) * -293252211;
	...
	static final void method4292(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
	...
	public static void method4294(int i) {
		try {
			int i_12_ = 0;
			if (Class422_Sub25.preferences.aClass422_Sub15_7560.method5684(-1994790043) == 1) {
				i_12_ |= 0x1;
				i_12_ |= 0x10;
				i_12_ |= 0x20;
				i_12_ |= 0x2;
			...
			if (Class422_Sub25.preferences.aClass422_Sub16_7557.method5687(1870666602) == 0)
				i_12_ |= 0x40;
	...
	static final void method4296(ClientScript2 class403, int i) {
		try {
			...
			if (14 != -1233866115 * client.anInt8752 || Class315.method3837((byte) 23))
				...
				Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2028, client.aClass25_8693.aClass449_330, (byte) 66);
				...
				client.aClass25_8693.method390(class298_sub36, (byte) -40);
			}
		} catch (RuntimeException runtimeexception) {
