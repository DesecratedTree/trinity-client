...
public class OutcommingPacket {
	...
	public static OutcommingPacket aClass198_2006;
	...
	public static OutcommingPacket ITEM_GROUND_OPTION3;
	...
	public static OutcommingPacket aClass198_2032;
	...
	public static OutcommingPacket aClass198_2077;
	...
	public static OutcommingPacket ITEM_GROUND_EXAMINE;
	...
	static {
		...
		aClass198_2006 = new OutcommingPacket(13, 7);
		...
		aClass198_2032 = new OutcommingPacket(39, 4);
		...
		ITEM_GROUND_OPTION3 = new OutcommingPacket(57, 7);
		...
		aClass198_2077 = new OutcommingPacket(65, 3);
		...
		SCREEN_PACKET = new OutcommingPacket(98, 7); //6
		...
		ITEM_GROUND_EXAMINE = new OutcommingPacket(102, 7);
	...
	static final void method1889(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_1_, (byte) 0);
			Class119 class119 = Class389.aClass119Array4165[i_1_ >> 16];
			FloorOverlay.method4606(class105, class119, class403, -1722505013);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("ij.ei(").append(')').toString());
		}
	}

	static final void method1890(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static final void method1893(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
