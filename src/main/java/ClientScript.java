...
public class ClientScript extends Class298_Sub37 {
	...
	public LinkedArrayList[] aClass437Array9685;
	public int id;
	...
	int method3473(RsByteBuffer class298_sub53, int i) {
		try {
			...
			if (i_3_ > 0) {
				aClass437Array9685 = new LinkedArrayList[i_3_];
				for (int i_4_ = 0; i_4_ < i_3_; i_4_++) {
					int i_5_ = class298_sub53.readUnsignedShort();
					LinkedArrayList class437 = new LinkedArrayList(Class416.method5590(i_5_, (byte) 16));
					aClass437Array9685[i_4_] = class437;
					while (i_5_-- > 0) {
						int i_6_ = class298_sub53.readInt((byte) 61);
						int i_7_ = class298_sub53.readInt((byte) -1);
						class437.method5817(new IntegerValue(i_7_), (long) i_6_);
					}
				}
			}
			class298_sub53.index = 0;
			name = class298_sub53.method3652(-517364695);
			data = new Class394[i_2_];
			return i_1_;
	...
	public ClientScript(RsByteBuffer class298_sub53) {
		...
		int i_8_ = 0;
		Class394[] class394s = Class298_Sub46.method3534((byte) -29);
	...
	Class394 method3474(RsByteBuffer class298_sub53, Class394[] class394s, byte i) {
		try {
			...
			if (i_9_ < 0 || i_9_ >= class394s.length)
				throw new RuntimeException("Invalid opcode: " + i_9_);
