...
public class Class513 implements Interface21 {
	...
	public int method244() {
		return 1711922743 * ((Class513) this).anInt6645;
	}

	Class513(int i, int i_0_, String string, String string_1_, boolean bool, Class513[] class513s) {
		((Class513) this).anInt6638 = 1902085065 * i;
		((Class513) this).anInt6645 = -2023606393 * i_0_;
		((Class513) this).aString6646 = string_1_;
	}
	...
	public int method242(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("vg.f(").append(')').toString());
		}
	}

	Class513(int i, int i_2_, String string, String string_3_) {
		((Class513) this).anInt6638 = i * 1902085065;
		((Class513) this).anInt6645 = i_2_ * -2023606393;
		((Class513) this).aString6646 = string_3_;
	}
	...
	public String toString() {
		try {
			return ((Class513) this).aString6646;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("vg.toString(").append(')').toString());
		}
	}
	...
	static final void method6292(ClientScript2 class403, int i) {
		try {
			Class390 class390 = (((ClientScript2) class403).aBoolean5261 ? ((ClientScript2) class403).aClass390_5247 : ((ClientScript2) class403).aClass390_5246);
			WidgetConfig class105 = ((Class390) class390).aClass105_4168;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.yOnScreen * -749038817;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("vg.oh(").append(')').toString());
		}
	}

	static void method6293(int i) {
		try {
			if (Class522.aClass_ra6285 != null) {
				Class522.aClass_ra6285.dispose(1951505274);
				Class522.aClass_ra6285 = null;
				Class522.aClass264_6284 = null;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("vg.b(").append(')').toString());
		}
	}
}
