...
public class Class122 {
	...
	static final void method1320(Entity class365_sub1_sub1_sub2, Entity class365_sub1_sub1_sub2_10_, int i, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_) {
		try {
			...
			if (i_18_ != -1) {
				Class57 class57 = (Class57) client.aClass348_8697.get((long) i_18_);
				if (null == class57) {
					Class89[] class89s = Class89.getSprites(Class158.aClass243_6364, i_18_, 0);
					if (null == class89s)
						return;
					class57 = FloorOverlay.graphics.method5125(class89s[0], true);
				...
				Class125.method1400(class365_sub1_sub1_sub2.plane, (int) class217.x, (int) class217.y, class365_sub1_sub1_sub2.getSize() * 256, 0, false, 2131920659);
				int i_19_ = (int) ((float) i_11_ + client.aFloatArray8891[0] - 18.0F);
				int i_20_ = (int) ((float) i_12_ + client.aFloatArray8891[1] - 16.0F - 54.0F);
				i_19_ += i / 4 * 18;
				i_20_ += 18 * (i % 4);
				class57.drawSprite(i_19_, i_20_);
				if (class365_sub1_sub1_sub2 == class365_sub1_sub1_sub2_10_)
					FloorOverlay.graphics.method5014(i_19_ - 1, i_20_ - 1, 18, 18, -256, -769094548);
	...
	static final void method1321(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub10_7548.method5661((byte) 92);
		} catch (RuntimeException runtimeexception) {
