...
public class Class102 {
	...
	static final void method1083(ClientScript2 class403, byte i) {
		try {
			if (Class452.fullScreen && null != Class231.fullScreenFrame)
				Class357.method4276(Class422_Sub25.preferences.displayMode.get((byte) 92), -1, -1, false, 2006169742);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1085(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			class105.lineWidth = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) * -1041514725;
