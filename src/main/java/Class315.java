	...
	static final void method3834(SubIncommingPacket class206, short i) {
		try {
			...
			if (SubIncommingPacket.aClass206_2347 == class206) {
				...
				ObjectConfig class432 = client.aClass283_8716.method2641(-527347356).getObjectDefinitions(i_21_);
				...
				int i_23_ = 0;
				if (class432.modelTypes != null) {
					int i_24_ = -1;
					for (int i_25_ = 0; i_25_ < class432.modelTypes.length; i_25_++) {
						if (i_16_ == class432.modelTypes[i_25_]) {
							i_24_ = i_25_;
							break;
						}
					}
				...
				int i_26_ = 0;
				if (null != class432.modifiedColors)
					i_26_ = class432.modifiedColors.length;
				int i_27_ = 0;
				if (null != class432.modifiedTextures)
					i_27_ = class432.modifiedTextures.length;
				if (1 == (i_22_ & 0x1))
				...
				int i_43_ = i_41_ + class298_sub53_sub2.readByte();
				int i_44_ = i_42_ + class298_sub53_sub2.readByte();
				int i_45_ = class298_sub53_sub2.readShort(1998351313);
				...
				if (client.aClass283_8716.method2674(-135283377) != Class266.aClass266_2846) {
					if (i_41_ >= 0 && i_42_ >= 0 && (i_41_ < client.aClass283_8716.method2629(-2115187525)) && i_42_ < client.aClass283_8716.method2630(1222512663) && i_43_ >= 0 && i_44_ >= 0 && (i_43_ < client.aClass283_8716.method2629(-2121627992)) && (i_44_ < client.aClass283_8716.method2630(-2081531222)) && i_46_ != 65535) {
						...
						i_48_ <<= 2;
						i_52_ <<= 2;
						Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(client.aClass283_8716.method2675(-1611682495), i_46_, -191892109 * Class375.basePlane, Class375.basePlane * -191892109, i_41_, i_42_, i_47_, i_49_ + client.anInt8884 * 443738891, client.anInt8884 * 443738891 + i_50_, i_51_, i_52_, 0, i_45_, i_48_, bool, -1));
						class365_sub1_sub1_sub1.method4405(i_43_, i_44_, Class356.getPlayerHeight(i_43_, i_44_, (-191892109 * Class375.basePlane), -1671970391) - i_48_, 443738891 * client.anInt8884 + i_49_, -53743739);
						client.projectiles.add(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1), 719403792);
					}
				}
				...
				if (null != client.groundTiles) {
					GroundTile groundItem = ((GroundTile) (client.groundTiles.method5812((long) (-191892109 * Class375.basePlane << 28 | i_64_ << 14 | i_66_))));
					if (groundItem != null) {
						for (Class298_Sub12 class298_sub12 = ((Class298_Sub12) groundItem.groundItems.method5939(1766612795)); null != class298_sub12; class298_sub12 = (Class298_Sub12) groundItem.groundItems.method5944(49146)) {
							if ((class298_sub12.id * 1768239597 == (i_67_ & 0x7fff)) && (567630807 * ((Class298_Sub12) class298_sub12).anInt7256 == i_68_)) {
								class298_sub12.remove(-1460969981);
				...
				int x = (i_70_ >> 4 & 0x7) + Class162.baseTileX * 134435705;
				int y = (i_70_ & 0x7) + -105526719 * Class216.baseTileY;
				int time = class298_sub53_sub2.readUnsignedShort();
				int height = class298_sub53_sub2.readUnsignedByte();
				int color = class298_sub53_sub2.read24BitUnsignedInteger((byte) -11);
				String message = class298_sub53_sub2.readString(-844550451);
				if (client.aClass283_8716.method2674(1533260419) != Class266.aClass266_2846)
					Class300.sendTileMessage(-191892109 * Class375.basePlane, x, y, height, time, color, message, 1332190940);
				...
				int i_98_ = i_93_ + class298_sub53_sub2.readByte();
				int i_99_ = i_94_ + class298_sub53_sub2.readByte();
				...
				if (client.aClass283_8716.method2674(781301439) != Class266.aClass266_2846) {
					if (i_93_ >= 0 && i_94_ >= 0 && i_93_ < client.aClass283_8716.method2629(-2097499815) * 2 && i_94_ < client.aClass283_8716.method2629(-1925634796) * 2 && i_98_ >= 0 && i_99_ >= 0 && i_98_ < client.aClass283_8716.method2630(-2066893296) * 2 && (i_99_ < client.aClass283_8716.method2630(1895360083) * 2) && 65535 != i_102_) {
						...
						i_104_ <<= 2;
						i_108_ <<= 2;
						LinkedArrayList.method5818(i_102_, i_100_, i_101_, i_97_, i_103_, i_104_, i_93_, i_94_, i_98_, i_99_, i_105_, i_106_, i_107_, i_108_, bool, 618819500);
					}
				}
				...
				if (client.aClass283_8716.method2674(1544127575) != Class266.aClass266_2846) {
					if (i_121_ >= 0 && i_122_ >= 0 && (i_121_ < client.aClass283_8716.method2629(-2060803867)) && (i_122_ < client.aClass283_8716.method2630(210266167))) {
						if (-1 == i_123_) {
							Class298_Sub37_Sub3 class298_sub37_sub3 = ((Class298_Sub37_Sub3) (client.groundGfxs.method5812((long) (i_121_ << 16 | i_122_))));
							...
							if (i_129_ < 3 && client.aClass283_8716.method2654(1627070231).method2320(i_121_, i_122_, 575492228))
								i_129_++;
							Class365_Sub1_Sub1_Sub3 class365_sub1_sub1_sub3 = (new Class365_Sub1_Sub1_Sub3(client.aClass283_8716.method2675(-1611682495), i_123_, i_125_, -191892109 * Class375.basePlane, i_129_, i_127_, Class356.getPlayerHeight(i_127_, i_128_, (Class375.basePlane * -191892109), -1861382449) - i_124_, i_128_, i_121_, i_121_, i_122_, i_122_, i_126_, false));
							client.groundGfxs.method5817((new Class298_Sub37_Sub3(class365_sub1_sub1_sub3)), (long) (i_121_ << 16 | i_122_));
						}
					}
				}
				...
				int itemID = class298_sub53_sub2.readUnsignedShortLE((byte) 67);
				...
				GroundTile class298_sub2 = ((GroundTile) (client.groundTiles.method5812((long) (Class375.basePlane * -191892109 << 28 | i_144_ << 14 | i_146_))));
				if (class298_sub2 != null) {
					for (Class298_Sub12 class298_sub12 = (Class298_Sub12) class298_sub2.groundItems.method5939(1766612795); class298_sub12 != null; class298_sub12 = (Class298_Sub12) class298_sub2.groundItems.method5944(49146)) {
						if (/*(*/itemID /*& 0x7fff)*/ == class298_sub12.id * 1768239597) {
							class298_sub12.remove(-1460969981);
							break;
						}
					}
					if (class298_sub2.groundItems.method5946(-1293494081))
				...
				IPAddress.method6062(new StringBuilder().append("").append(class206).toString(), new RuntimeException(), (short) -20731);
