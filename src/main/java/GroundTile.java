...
public class GroundTile extends Class298 {
	static Class395 aClass395_7165;
	public Class453 groundItems = new Class453();
	...
	static final void method2849(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_4_, (byte) -113);
			Class119 class119 = Class389.aClass119Array4165[i_4_ >> 16];
			TextureLoader.method2393(class105, class119, class403, 131231409);
		} catch (RuntimeException runtimeexception) {
