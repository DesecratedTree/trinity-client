...
public class Class273 {
	...
	static final void method2561(ClientScript2 class403, int i) {
		try {
			...
			if (client.aBoolean8638) {
				try {
					Object object = (Class212.aClass212_2426.method1953((new Object[] { Integer.valueOf(Class298_Sub41.anInt7456 * 1914527151), (Boolean.valueOf(1 == (Class287.myPlayer.aByte10220))), Integer.valueOf(((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]) }), -1838433046));
					if (null != object)
	...
	public static GraphicsToolkit getSoftwareTK(Canvas canvas, Interface_ma interface_ma, int i, int i_13_, byte i_14_) {
		try {
			return new SoftwareToolkit(canvas, interface_ma, i, i_13_);
		} catch (RuntimeException runtimeexception) {
	...
	public static void method2566(RsByteBuffer class298_sub53, int i, byte i_18_) {
		try {
			...
			((Class298_Sub47) class298_sub47).anInt7538 = class298_sub53.readUnsignedByte() * -468176359;
			((Class298_Sub47) class298_sub47).anInt7542 = class298_sub53.readInt((byte) 43) * -530104791;
			...
			Class478.aClass453_6002.add(class298_sub47, 512081003);
		} catch (RuntimeException runtimeexception) {
