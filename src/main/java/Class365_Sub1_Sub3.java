...
public abstract class Class365_Sub1_Sub3 extends Class365_Sub1 {
	...
	int method4354(Class298_Sub10[] class298_sub10s, int i) {
		try {
			...
			return method4392(((int) class217.x >> -1688804109 * aClass331_7722.anInt3504), ((int) class217.y >> -1688804109 * aClass331_7722.anInt3504), class298_sub10s, 1820308449);
	...
	final void method4375(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_2_, int i_3_, boolean bool) {
		throw new IllegalStateException();
	}

	int method4390(Class298_Sub10[] class298_sub10s) {
		SceneObjectPosition class217 = method4337().aClass217_2599;
		return method4392(((int) class217.x >> -1688804109 * aClass331_7722.anInt3504), ((int) class217.y >> -1688804109 * aClass331_7722.anInt3504), class298_sub10s, 2077103831);
	}
	...
	Class365_Sub1_Sub3(Class331 class331, int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
		...
		setPosition(new SceneObjectPosition((float) i, (float) i_4_, (float) i_5_));
	}

	boolean method4359(GraphicsToolkit class_ra) {
		SceneObjectPosition class217 = method4337().aClass217_2599;
		return (aClass331_7722.aClass333_3512.method4073(aByte7724, ((int) class217.x >> aClass331_7722.anInt3504 * -1688804109), ((int) class217.y >> aClass331_7722.anInt3504 * -1688804109), method4361(1951240662)));
	}

	final void method4355(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1, int i, int i_10_, int i_11_, boolean bool, int i_12_) {
		try {
			throw new IllegalStateException();
		} catch (RuntimeException runtimeexception) {
	...
	boolean method4397() {
		SceneObjectPosition class217 = method4337().aClass217_2599;
		return (((Class331) aClass331_7722).aBooleanArrayArray3563[(583010427 * ((Class331) aClass331_7722).renderDistance + (((int) class217.x >> -1688804109 * aClass331_7722.anInt3504) - -804213305 * ((Class331) aClass331_7722).anInt3553))][(((int) class217.y >> -1688804109 * aClass331_7722.anInt3504) - ((Class331) aClass331_7722).anInt3513 * 465603579 + 583010427 * ((Class331) aClass331_7722).renderDistance)]);
	}
