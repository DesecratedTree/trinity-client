...
final class Class523 implements Interface17 {
	...
	static final void method6329(WidgetConfig class105, ClientScript2 class403, int i) {
		try {
			...
			NPCConfig class503 = Class15.aClass507_224.method6269(class105.anInt1151 * 572201537, -87546938);
			...
			if (i_1_ < 0 || i_1_ >= class503.headModels.length)
				throw new RuntimeException("");
	...
	public static final void method6330(WidgetConfig class105, int i, int i_2_, int i_3_) {
		try {
	...
	public static final WidgetConfig method6331(Class119 class119, WidgetConfig class105, int i) {
		try {
			if (-1 != 1573706803 * class105.parentUID)
				return class119.method1297(class105.parentUID * 1573706803, (short) 8481);
			if (!class119.aBoolean1403) {
				int i_4_ = class105.uid * -440872681 >>> 16;
	...
	static Class298_Sub50_Sub1 method6333(int i, int i_5_, int i_6_, long l, int i_7_, int i_8_) {
		try {
			synchronized (Class298_Sub50_Sub1.aClass298_Sub50_Sub1Array9735) {
				...
				((Class298_Sub50_Sub1) class298_sub50_sub1).type = -435781441 * i;
