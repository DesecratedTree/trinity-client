...
public abstract class Class110 implements Interface8 {
	...
	abstract void method1159(int i, Matrix class233);
	...
	abstract void method1166(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233);
	...
	abstract void method1171(int i, Matrix class233);

	abstract void method1172(int i, Matrix class233);

	abstract void method1173(int i, Matrix class233);

	abstract void method1174(int i, int i_16_, Interface9 interface9);

	abstract void method1175(int i, Matrix class233);
	...
	abstract void method1187(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233);
	...
	abstract void method1192(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233);
	...
	abstract void method1197(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233);

	abstract void method1198(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233);

	abstract void method1199(int i, int i_40_, Interface9 interface9);

	abstract void method1200(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233);

	Class110() {
		/* empty */
	}

	abstract void method1201(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233);

	abstract void method1202(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233);

	abstract void method1203(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233);

	abstract void method1204(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233);
	...
	abstract void method1215(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233);

	abstract void method1216(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233);

	abstract void method1217(int i, Matrix class233);
	...
	public static void method1223(int i) {
		try {
			Class390.method4876(22050, Class422_Sub25.preferences.aClass422_Sub22_7586.method5706((byte) -26) == 1, 2, 1957376607);
			Class300.aClass284_3212 = Class75.method834(Class52_Sub2_Sub1.aCanvas9079, 0, 22050, -1310188777);
			Class68.method777(true, Class8.method318(null, -1887308031), 1581194982);
	...
	static final void method1224(ClientScript2 class403, int i) {
		try {
	...
	static final void method1225(ClientScript2 class403, int i) {
		try {
			int i_60_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393 - 1)] = Class447.aClass469_5618.method6045(i_60_, (short) -5435).method3462((byte) -114);
		} catch (RuntimeException runtimeexception) {
	...
	static void method1226(int i, int i_61_, byte i_62_) {
		try {
			if (LinkedArrayList.WIDGET_DETAILS.aBoolean4038 || (Class436.anInt5506 * -278777595 != 1 && (!Class396.aBoolean5196 || 2 != -278777595 * Class436.anInt5506 || !(((Class298_Sub37_Sub15) Class436.aClass298_Sub37_Sub15_5477).option.equals(Tradution.aClass470_5910.method6049(Class321.aClass429_3357, -875414210)))))) {
				...
				if (!Class436.aBoolean5471) {
					...
					for (Class298_Sub37_Sub5 class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482.method5984(-1195719541)); null != class298_sub37_sub5; class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482.method5985(1977524177))) {
						int i_66_;
				...
				i_63_ += 10;
				int i_67_ = i - i_63_ / 2;
				if (i_63_ + i_67_ > Class462.screenWidth * -2110394505)
					i_67_ = -2110394505 * Class462.screenWidth - i_63_;
				if (i_67_ < 0)
					i_67_ = 0;
				int i_68_ = i_61_;
				if (i_68_ + i_64_ > -1111710645 * Class298_Sub40_Sub9.screenHeight)
					i_68_ = Class298_Sub40_Sub9.screenHeight * -1111710645 - i_64_;
				if (i_68_ < 0)
					i_68_ = 0;
				Class88.anInt806 = 671566195 * i_67_;
				GroundMessage.anInt7658 = 1083843311 * i_68_;
	...
	static final void method1227(ClientScript2 class403, int i) {
		try {
			Class390 class390 = (((ClientScript2) class403).aBoolean5261 ? ((ClientScript2) class403).aClass390_5247 : ((ClientScript2) class403).aClass390_5246);
			WidgetConfig class105 = ((Class390) class390).aClass105_4168;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.xOnScreen * 1354508417;
		} catch (RuntimeException runtimeexception) {
