...
public abstract class Class264 {
		...
		try {
			try {
				if (string.startsWith("col="))
					anInt2828 = (-882366071 * anInt2828 & ~0xffffff | (GraphicsConfig.method4924(string.substring(4), 16, (byte) -57) & 0xffffff)) * -1158210375;
				...
				if (string.startsWith("argb="))
					anInt2828 = GraphicsConfig.method4924(string.substring(5), 16, (byte) 61) * -1158210375;
				else if (string.equals("/argb"))
					anInt2828 = anInt2826 * -134884105;
				else if (string.startsWith("str="))
					anInt2830 = (anInt2828 * -882366071 & ~0xffffff | GraphicsConfig.method4924(string.substring(4), 16, (byte) -24)) * 2103918561;
				else if (string.equals("str"))
					anInt2830 = (anInt2828 * -882366071 & ~0xffffff | 0x800000) * 2103918561;
				else if (string.equals("/str"))
					anInt2830 = -2103918561;
				else if (string.startsWith("u="))
					anInt2837 = (anInt2828 * -882366071 & ~0xffffff | GraphicsConfig.method4924(string.substring(2), 16, (byte) -57)) * -1869530301;
					...
					anInt2835 = (anInt2828 * -882366071 & ~0xffffff | GraphicsConfig.method4924(string.substring(5), 16, (byte) 67)) * -1352863677;
							...
							if (string_78_.startsWith("img=")) {
								try {
									...
									if ((anInt2828 * -882366071 & ~0xffffff) == -16777216)
										class57.drawSprite(i, (i_70_ + ((((Class264) this).aClass505_2833.anInt6200) * -2028004825) - i_80_), 1, 0, 1);
									else
										class57.drawSprite(i, (((((Class264) this).aClass505_2833.anInt6200) * -2028004825) + i_70_ - i_80_), 0, (((-882366071 * anInt2828) & ~0xffffff) | 0xffffff), 1);
						...
						if (string_117_.equals("lt"))
							...
							if (string_117_.startsWith("img=")) {
								try {
									...
									class57.drawSprite(i + i_118_, (i_108_ + ((((Class264) this).aClass505_2833.anInt6200) * -2028004825) - i_121_ + i_119_), 1, 0, 1);
	...
	public void drawText(String string, int i, int i_125_, int i_126_, int i_127_, int i_128_) {
		try {
			if (null != string) {
	...
	public void method2490(String string, int x, int y, int i_136_, int i_137_, int i_138_) {
		try {
			if (string != null) {
				method2481(i_136_, i_137_, (byte) 14);
				method2484(string, x - ((Class264) this).aClass505_2833.method6264(string, 1243151471) / 2, y, null, null, null, 0, 0, 2121400127);
			}
		} catch (RuntimeException runtimeexception) {
	...
	public static void method2492(int i, String string, byte i_140_) {
		try {
			GrabFolder.method2282(i, 0, "", "", "", string, -781451735);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("l.b(").append(')').toString());
		}
	}
	...
	static final void method2494(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (((ClientScript2) class403).aClass298_Sub25_5237.aClass163Array7359[i_143_].aByte1683);
		} catch (RuntimeException runtimeexception) {
