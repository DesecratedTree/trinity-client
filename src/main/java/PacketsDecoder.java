		...
		try {
			...
			if (IncommingPacket.MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (i_80_ == 99)
					...
					GrabFolder.method2282(i_80_, i_81_, string, string_83_, string, string_84_, -1468983571);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.GRAPHICS_PACKET) {
				...
				if (targetHash >> 30 != 0) {
					...
					if (i_102_ >= 0 && i_103_ >= 0 && (i_102_ < client.aClass283_8716.method2629(-1990296889)) && (i_103_ < client.aClass283_8716.method2630(-1604198619))) {
						if (graphicsId == -1) {
							Class298_Sub37_Sub3 class298_sub37_sub3 = ((Class298_Sub37_Sub3) (client.groundGfxs.method5812((long) (i_102_ << 16 | i_103_))));
							if (class298_sub37_sub3 != null) {
								((Class298_Sub37_Sub3) class298_sub37_sub3).aClass365_Sub1_Sub1_Sub3_9578.method4480((byte) 12);
								class298_sub37_sub3.remove(-1460969981);
							}
						} else {
							...
							if (i_106_ < 3 && (client.aClass283_8716.method2654(651162634).method2320(i_102_, i_103_, -2025869337)))
								i_106_++;
							Class365_Sub1_Sub1_Sub3 class365_sub1_sub1_sub3 = (new Class365_Sub1_Sub1_Sub3(client.aClass283_8716.method2675(-1611682495), graphicsId, speed, i_101_, i_106_, i_104_, Class356.getPlayerHeight(i_104_, i_105_, i_101_, -1215922012) - graphicsHeight, i_105_, i_102_, i_102_, i_103_, i_103_, i_99_, bool));
							client.groundGfxs.method5817((new Class298_Sub37_Sub3(class365_sub1_sub1_sub3)), (long) (i_102_ << 16 | i_103_));
						}
					}
				} else if (targetHash >> 29 != 0) {
					int i_107_ = targetHash & 0xffff;
					ObjectValue class298_sub29 = ((ObjectValue) client.aClass437_8696.method5812((long) i_107_));
					if (null != class298_sub29) {
						NPC class365_sub1_sub1_sub2_sub1 = ((NPC) class298_sub29.value);
						RSGraphics class56 = (class365_sub1_sub1_sub2_sub1.currentGraphics[slotId]);
						if (graphicsId == 65535)
							graphicsId = -1;
						...
						if (-1 != graphicsId && i_109_ != -1) {
							if (graphicsId == i_109_) {
								GraphicsConfig class398 = Class158_Sub1.aClass389_8568.method4857(graphicsId, -2138799623);
								if (class398.aBoolean5215 && -1 != class398.animation * 1505778629) {
									AnimationConfig class391 = (Class501.aClass395_6122.method4903(class398.animation * 1505778629, (byte) -71));
								...
								GraphicsConfig class398 = Class158_Sub1.aClass389_8568.method4857(graphicsId, -1997923010);
								GraphicsConfig class398_111_ = Class158_Sub1.aClass389_8568.method4857(i_109_, -1881939747);
								if (class398.animation * 1505778629 != -1 && (class398_111_.animation * 1505778629 != -1)) {
									AnimationConfig class391 = (Class501.aClass395_6122.method4903(class398.animation * 1505778629, (byte) 83));
									AnimationConfig class391_112_ = (Class501.aClass395_6122.method4903((1505778629 * class398_111_.animation), (byte) -25));
									if (-1445588039 * class391.priority < (-1445588039 * class391_112_.priority))
										bool_108_ = false;
								}
							}
						}
						if (bool_108_) {
							...
							if (-1 != graphicsId) {
								GraphicsConfig class398 = Class158_Sub1.aClass389_8568.method4857(graphicsId, -1696520605);
								int i_113_ = class398.aBoolean5215 ? 0 : 2;
								if (bool)
									i_113_ = 1;
								class56.aClass438_569.method5824(1505778629 * class398.animation, speed, i_113_, false, (byte) 0);
							} else
					...
					if (class365_sub1_sub1_sub2_sub2 != null) {
						RSGraphics class56 = (class365_sub1_sub1_sub2_sub2.currentGraphics[slotId]);
						if (65535 == graphicsId)
							graphicsId = -1;
						...
						if (graphicsId != -1 && -1 != i_116_) {
							if (graphicsId == i_116_) {
								GraphicsConfig class398 = Class158_Sub1.aClass389_8568.method4857(graphicsId, -1990411818);
								if (class398.aBoolean5215 && class398.animation * 1505778629 != -1) {
									AnimationConfig class391 = (Class501.aClass395_6122.method4903(class398.animation * 1505778629, (byte) -15));
								...
								GraphicsConfig class398 = Class158_Sub1.aClass389_8568.method4857(graphicsId, -1975194771);
								GraphicsConfig class398_118_ = Class158_Sub1.aClass389_8568.method4857(i_116_, -1893234855);
								if (-1 != class398.animation * 1505778629 && -1 != (1505778629 * class398_118_.animation)) {
									AnimationConfig class391 = (Class501.aClass395_6122.method4903(1505778629 * class398.animation, (byte) -1));
									AnimationConfig class391_119_ = (Class501.aClass395_6122.method4903((class398_118_.animation * 1505778629), (byte) -13));
						...
						if (bool_115_) {
							...
							if (graphicsId != -1) {
								GraphicsConfig class398 = Class158_Sub1.aClass389_8568.method4857(graphicsId, -2053481236);
								int i_120_ = class398.aBoolean5215 ? 0 : 2;
								if (bool)
									i_120_ = 1;
								class56.aClass438_569.method5824(1505778629 * class398.animation, speed, i_120_, false, (byte) 0);
							} else
			...
			if (IncommingPacket.OPEN_INTERFACE_OBJECT == ((Class25) class25).INCOMMING_PACKET) {
				...
				Map coordinateHash = new Map(stream.readInt((byte) -80));
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2245) {
				...
				if (((Class25) class25).anInt336 * -866602563 == 1) {
					if (bool)
						StanceConfig.aClass298_Sub25_3757 = null;
					else
				...
				if (bool)
					StanceConfig.aClass298_Sub25_3757 = new Class298_Sub25(stream);
				else
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2236) {
				...
				if (i_157_ != -1) {
					client.aClass299Array8671[i_156_] = new Class299(FloorOverlay.graphics, stream, i_157_);
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2177) {
				...
				if (stream.method3615((byte) 83))
					TextureLoader.method2391(stream, (385051775 * stream.index) - 28, (byte) 2);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2160 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Map class341 = new Map(stream.readInt((byte) 122));
			...
			if (IncommingPacket.aClass202_2153 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class298_Sub25 class298_sub25 = (bool ? StanceConfig.aClass298_Sub25_3757 : Class375.aClass298_Sub25_4084);
				while_86_: do {
			...
			if (IncommingPacket.ICOMPONENT_SETTINGS_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				for (int slot = fromSlot; slot <= toSlot; slot++) {
					...
					Class298_Sub38 class298_sub38 = (Class298_Sub38) client.settings.method5812(l);
					...
					if (class298_sub38 == null) {
						...
						class298_sub38.remove(-1460969981);
					}
					client.settings.method5817(class298_sub38_178_, l);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2298) {
				if (Class452.fullScreen && Class231.fullScreenFrame != null)
					Class357.method4276(Class422_Sub25.preferences.displayMode.get((byte) 92), -1, -1, false, 1686359227);
				...
				if (!client.aBoolean8638 || !Class65.method762(string, 1, string_204_, -2024310199))
					Class273.method2559(string, true, Class422_Sub25.preferences.graphicsMode.method5677(-446024577) == 5, string_204_, client.aBoolean8867, client.aBoolean8651, -1865929375);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.HIDE_ICOMPONENT_PACKET) {
				...
				Class491.hideWidget(i_207_, i_208_, -109953213);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.RUN_SCRIPT_PACKET) {
				...
				if (scriptID == -2) {
					Settings.ENABLE_VIRTUAL_LEVELS = (int)objects[1] == 1;
				} else if (scriptID == -3) {
					Hitbox.maxHP = (int)objects[1];
					if (Hitbox.maxHP > 0) 
						Hitbox.currentHP = (int)objects[2];
					else {
						Hitbox.currentHP = 0;
						Hitbox.name = null;
					}
				} else if (scriptID == -4) {
					Hitbox.name = (String)objects[1];
				} if (scriptID == -5) {
						Settings.ENABLE_X1_HITS = (int)objects[1] == 1;
						client.anIntArray8833[(client.anInt8875 += 1972492301) * -1048955195 - 1 & 0x1f] = 3;
						client.anIntArray8833[(client.anInt8875 += 1972492301) * -1048955195 - 1 & 0x1f] = 5;
				} else if (scriptID == -6) {
					WidgetConfig.setSize((int)objects[3], (int)objects[2], (int)objects[1]);
				} else if (scriptID == -7) {
					Timers.add((int)objects[3], (int)objects[2], (int)objects[1]);
				} else if (scriptID == -8) {
					Timers.logout();
				} else if (scriptID == -9) {
					CustomItems.clearCustomShopPrices();
					for (int i2 = 1; i2 < objects.length; i2 += 2) {
						int amt =  (int) objects[i2];
						int id = (int) objects[i2+1];
						CustomItems.customShopPrices.put(id, amt);
					}
				} else if (scriptID == -10) {
					Class25.method393(5, 0, "Matrix", "matrix", "Matrix",  "<col=ffff00>Broadcast: "+objects[1].toString(), null, 0, 1446000206);
				//	Class25.method393(5, 0, "Onyx", "onyx", "Onyx",  "<col=ff6600>["+objects[2].toString().toUpperCase()+"] <col=ffff00>"+objects[1].toString(), null, 0, 1446000206);
				} else if (scriptID == -11) {
					Settings.HIDE_ATTACK_OPTION = (int)objects[1] == 1;
				} else if (scriptID == -12) {
					Settings.ENABLE_GROUND_ITEM_NAMES = (int)objects[1] == 1;
				} else if (scriptID == -13) {
					ObjectConfig.osrsVars.put((int)objects[2], (int)objects[1]);
				} else if (scriptID == -14) {
					Settings.ENABLE_OSRS_GAMEFRAME =  (int)objects[1] == 1;
				} else if (scriptID == -15) {
					Class8.method319(1407497429); //removes sprites.
				} else if (scriptID == -16) {
					Class82_Sub8.method893(548, 0);
					Class82_Sub8.method893(746, 0);
					Class82_Sub8.method893(751, 0);
					Class82_Sub8.method893(752, 0);
					//Class82_Sub8.method893(137, 0); 
					Class82_Sub8.method893(747, 0);
					Class82_Sub8.method893(748, 0);
					Class82_Sub8.method893(749, 0);
					Class82_Sub8.method893(750, 0);
				} else if (scriptID == -17) {
					Keybinds.update(objects);
					Keybinds.setTab = false;
				} else if (scriptID == -18) {
					Keybinds.setTab = (int)objects[1] == 1;
				} else if (scriptID == -19) {
					Settings.ENABLE_OSRS_NPCS = (int)objects[1] == 1;
				} else if (scriptID == -20) { //reset npcs
					client.anInt8703 = 0;
					client.npcCount = 0;
					client.aClass437_8696.clear((byte) -6);
				} else if (scriptID == -21) {
					Class384.searchSpawn = true;
				} else if (scriptID == -22) {
					Class384.searchSpawn = false;
				} else {
			...
			if (IncommingPacket.LOAD_MAP_SCENE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (Class422_Sub25.preferences.aClass422_Sub21_7580.method5703((byte) -123) == 1)
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2234) {
				...
				if (bool)
					class298_sub25 = StanceConfig.aClass298_Sub25_3757;
				else
			...
			if (IncommingPacket.RECEIVE_PRIVATE_QUICK_CHAT_MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (!bool_238_) {
					client.aLongArray8915[client.anInt8916 * 1594173071] = uid;
					client.anInt8916 = 1356544111 * ((1594173071 * client.anInt8916 + 1) % 100);
					String text = Class447.aClass469_5618.method6045(i_236_, (short) -8978).method3459(stream, -734708119);
					if (2 == rights)
						Class25.method393(18, 0, new StringBuilder().append(Class247.method2368(1, -278777595)).append(string).toString(), new StringBuilder().append(Class247.method2368(1, -278777595)).append(string_233_).toString(), string, text, null, i_236_, 1446000206);
					else if (rights == 1)
						Class25.method393(18, 0, new StringBuilder().append(Class247.method2368(0, -278777595)).append(string).toString(), new StringBuilder().append(Class247.method2368(0, -278777595)).append(string_233_).toString(), string, text, null, i_236_, 1446000206);
					else if (rights != 0)
						Class25.method393(18, 0, "<img=" + rights + ">" + string, "<img=" + rights + ">" + string_233_, string, text, null, i_236_, 1446000206);
					else
						Class25.method393(18, 0, string, string_233_, string, text, null, i_236_, 1446000206);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2249 == ((Class25) class25).INCOMMING_PACKET) {
				...
				for (int i_248_ = fromSlot; i_248_ <= i_247_; i_248_++) {
					...
					client.settings.method5817(class298_sub38_249_, l);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.FRIENDS_PACKET) {
				while (stream.index * 385051775 < ((Class25) class25).anInt336 * -866602563) {
					...
					if (string != null && client.anInt8941 * -1054937867 < 500) {
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.SEND_PRIVATE_MESSAGE_PACKET) {
				...
				GrabFolder.method2282(6, 0, string, string, string, string_305_, -109686251);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2185) {
				...
				for (int i_314_ = 0; i_314_ < client.npcCount * 1962237353; i_314_++) {
					((Entity) client.npcs[i_314_].value).anIntArray10093 = null;
					((Entity) client.npcs[i_314_].value).aClass438_10078.method5821(-1, -2064932982);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2251) {
				...
				if (class298_sub51 != null) {
					class298_sub51.remove(-1460969981);
					client.aClass437_8841.method5817(class298_sub51, (long) i_316_);
				}
				WidgetConfig class105 = Class50.getIComponentDefinitions(i_315_, (byte) -52);
				if (class105 != null)
				...
				if (class105 != null) {
					...
					Class65.method761((Class389.aClass119Array4165[(-440872681 * class105.uid >>> 16)]), class105, true, 112223880);
				}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2172) {
				...
				Shortcut.method4265(i_344_, i_347_, i_345_, i_346_, -1411433618);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2290 == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (i_364_ >= 0 && i_365_ >= 0 && (i_364_ < client.aClass283_8716.method2629(-1911669738) * 2) && (i_365_ < client.aClass283_8716.method2629(-1992464171) * 2) && i_351_ >= 0 && i_361_ >= 0 && (i_351_ < client.aClass283_8716.method2630(-2022476058) * 2) && (i_361_ < client.aClass283_8716.method2630(1563119067) * 2) && 65535 != i_348_) {
					...
					i_355_ <<= 2;
					i_350_ <<= 2;
					LinkedArrayList.method5818(i_348_, i_349_, i_353_, i_363_, i_358_, i_355_, i_364_, i_365_, i_351_, i_361_, i_360_, i_359_, i_352_, i_350_, bool, 2141342802);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.RESET_SOUNDS_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				Preference.method5617((byte) -98);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2297 == ((Class25) class25).INCOMMING_PACKET) {
				client.attackOptionSecond = stream.readUnsignedByteC((short) -6905) == 1;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.ITEM_ON_ICOMPONENT_PACKET) {
				...
				ItemConfig class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_386_);
				Shortcut.method4265(i_388_, 330519029 * class468.modelPitch, -3355859 * class468.modelRoll, class468.modelScale * 1396167403, -1121225747);
				Class253.method2422(i_388_, 252709809 * class468.modelTranslateX, -1811316489 * class468.modelTranslateY, class468.offsetX * -1368639199, 499708204);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.ICOMPONENT_TEXT_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class98.setWidgetText(i_393_, string, (byte) 66);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2154) {// emote
				...
				ObjectValue class298_sub29 = ((ObjectValue) client.aClass437_8696.method5812((long) i_425_));
				if (class298_sub29 != null)
					Class431.method5768(((Entity) class298_sub29.value), is, i_424_, true, (byte) -7);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2220 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Map class341 = client.aClass283_8716.method2628(681479919);
				for (GroundTile class298_sub2 = ((GroundTile) client.groundTiles.method5816(1564654282)); class298_sub2 != null; class298_sub2 = ((GroundTile) client.groundTiles.method5815((byte) 10))) {
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2227) {
				...
				if (Class389.aClass119Array4165[i_432_] != null) {
					for (int i_435_ = i_433_; i_435_ < i_434_; i_435_++) {
						...
						if (i_435_ < (Class389.aClass119Array4165[i_432_].components).length && (Class389.aClass119Array4165[i_432_].components[i_435_]) != null)
							Class389.aClass119Array4165[i_432_].components[i_435_].anInt1141 = i_436_ * -177949397;
					}
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.SKILL_LEVEL_PACKET) {
				...
				int i_443_ = (Settings.ENABLE_VIRTUAL_LEVELS ? Class368.anIntArray4003.length : Class368.anIntArray4002[skillId]) - 1;
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.FRIENDS_CHAT_CHANNEL_PACKET) {
				...
				Class514.aByte6228 = stream.readByte();
				...
				for (int i_446_ = 0; i_446_ < Class489.anInt6071 * -1801543887; i_446_++) {
					...
					class7s[i_446_].aByte97 = stream.readByte();
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.HINT_ICON_PACKET) {
				...
				if (0 == i_452_) {
					client.hintIcons[i_451_] = null;
					((Class25) class25).INCOMMING_PACKET = null;
					return true;
				}
				HintIcon class19 = new HintIcon();
				class19.anInt266 = 1231457277 * i_452_;
				((HintIcon) class19).anInt258 = stream.readUnsignedByte() * -1078964265;
				if (((HintIcon) class19).anInt258 * -92466201 >= 0 && (((HintIcon) class19).anInt258 * -92466201 < Class128_Sub2.aClass57Array8560.length)) {
					if (class19.anInt266 * 958933333 == 1 || 10 == class19.anInt266 * 958933333) {
						class19.anInt256 = (stream.readUnsignedShort() * 1626935871);
						((HintIcon) class19).anInt265 = (stream.readUnsignedShort() * -571637617);
						stream.index += 465653244;
					} else if (class19.anInt266 * 958933333 >= 2 && class19.anInt266 * 958933333 <= 6) {
						if (958933333 * class19.anInt266 == 2) {
							class19.x = 1513435904;
							class19.y = -1303452928;
						}
						...
						if (class19.anInt266 * 958933333 == 6) {
							class19.x = 1513435904;
							class19.y = 1688061440;
						}
						class19.anInt266 = -1832052742;
						((HintIcon) class19).anInt259 = (stream.readUnsignedByte() * -1962848411);
						Map class341 = client.aClass283_8716.method2628(681479919);
						class19.x += ((stream.readUnsignedShort() - -1760580017 * class341.gameSceneBaseX) << 9) * 962213171;
						class19.y += ((stream.readUnsignedShort() - class341.gameSceneBaseY * 283514611) << 9) * 313675491;
						((HintIcon) class19).anInt262 = ((stream.readUnsignedByte() << 2) * -2098711205);
						class19.anInt257 = (stream.readUnsignedShort() * -1670140163);
					}
					class19.anInt263 = (stream.readInt((byte) -34) * -698073157);
					client.hintIcons[i_451_] = class19;
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.LOAD_MAP_SCENE_DYNAMIC_PACKET) {
				...
				if (Class422_Sub25.preferences.aClass422_Sub21_7580.method5703((byte) -70) == 1)
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.OPEN_URL_PACKET) {
				if (Class452.fullScreen && Class231.fullScreenFrame != null)
					Class357.method4276(Class422_Sub25.preferences.displayMode.get((byte) 42), -1, -1, false, -1432148158);
				...
				if (bool) {
					...
					if (!client.aBoolean8638 || Class82_Sub8.aString6856.startsWith("mac") || !Class65.method762(string, 1, Class212.aClass212_2424.method1951(-1209858466), -1999887910))
						Class346.method4172(string_466_, true, Class422_Sub25.preferences.graphicsMode.method5677(-2008340671) == 5, client.aBoolean8867, client.aBoolean8651, (byte) 13);
				} else
					Class346.method4172(string, true, Class422_Sub25.preferences.graphicsMode.method5677(-389602471) == 5, client.aBoolean8867, client.aBoolean8651, (byte) 54);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
