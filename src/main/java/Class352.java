...
public class Class352 {
	...
	LinkedArrayList aClass437_3811;
	...
	void method4235(RsByteBuffer class298_sub53, int i, short i_1_) {
		try {
			if (1 == i)
				...
				areaName = class298_sub53.readString(-730966089);
			else if (4 == i)
				...
				for (int i_7_ = 0; i_7_ < i_3_; i_7_++)
					aByteArray3777[i_7_] = class298_sub53.readByte();
			} else if (i == 16)
				aBoolean3816 = false;
			else if (17 == i)
				...
				if (((Class352) this).aClass437_3811 == null) {
					...
					((Class352) this).aClass437_3811 = new LinkedArrayList(i_9_);
				}
				for (int i_10_ = 0; i_10_ < i_8_; i_10_++) {
					...
					Class298 class298;
					if (bool)
						class298 = new ObjectValue(class298_sub53.readString(-826702559));
					else
						class298 = new IntegerValue(class298_sub53.readInt((byte) 97));
	...
	public Class57 method4238(GraphicsToolkit class_ra, boolean bool, int i) {
		try {
			...
			if (!((Class339) ((Class352) this).aClass339_3776).aClass243_3638.method2310(i_15_, -457216440))
				return null;
			Class89 class89 = Class89.getSprite((((Class339) (((Class352) this).aClass339_3776)).aClass243_3638), i_15_, 0);
			if (class89 != null) {
	...
	public String method4239(int i, String string, byte i_17_) {
		try {
			if (null == ((Class352) this).aClass437_3811)
				return string;
			ObjectValue class298_sub29 = ((ObjectValue) ((Class352) this).aClass437_3811.method5812((long) i));
	...
	public Class57 method4240(GraphicsToolkit class_ra, int i) {
		try {
			...
			Class89 class89 = Class89.getSprite((((Class339) ((Class352) this).aClass339_3776).aClass243_3638), ((Class352) this).anInt3794 * 1027948663, 0);
			if (class89 != null) {
				class57 = class_ra.method5125(class89, true);
	...
	public int method4241(int i, int i_18_, int i_19_) {
		try {
			if (((Class352) this).aClass437_3811 == null)
				return i_18_;
			IntegerValue class298_sub35 = ((IntegerValue) ((Class352) this).aClass437_3811.method5812((long) i));
	...
	static final void method4243(ClientScript2 class403, byte i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class300.aClass518_3217.method6311(i_20_, 614874976).length) * 1317156085;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4248(ClientScript2 class403, byte i) {
		try {
			...
			((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_24_).name);
		} catch (RuntimeException runtimeexception) {
