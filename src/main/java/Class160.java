...
public class Class160 {
	...
	void method1708(RsByteBuffer stream, short i) {
		try {
			...
			for (int i_0_ = stream.readUnsignedByte(); 0 != i_0_; i_0_ = stream.readUnsignedByte()) {
				...
				((Class160) this).aClass453_1632.add(class298_sub40, 843424958);
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1709(ClientScript2 class403, int i) {
		try {
			...
			if (i_2_ >= 1 && i_2_ <= 5 && null != class468.inventoryOptions[i_2_ - 1])
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = class468.inventoryOptions[i_2_ - 1];
			else
	...
	static final void method1711(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class140.method1558(i_3_ << 16 | i_4_, i_5_, -156511736);
