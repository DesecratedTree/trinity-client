...
public class Class277 {
		...
		try {
			try {
				...
				if (bool) {
					...
					Model class64 = Model.loadModel(Class465.aClass243_6520, (((Class277) this).anInt2956 * -680590445), 0);
	...
	void method2592(GraphicsToolkit class_ra, int i, int i_32_, int i_33_, int i_34_, int i_35_) {
		try {
			...
			((Class277) this).aClass387_2941.drawModel(class222_37_, null, 0);
		...
		try {
			...
			if (((Class277) this).aClass387_2941 == null) {
				...
				if (((Class277) this).anInt2940 * 1461948177 != -1 && ((Class277) this).anInt2946 * -1994130525 != 0) {
					TextureConfig class53 = anInterface_ma2955.method174(((((Class277) this).anInt2940) * 1461948177), 434799685);
				...
				Matrix class233_56_ = class_ra.method5045();
	...
	static final void method2594(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			class105.textureID = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) * -216431639;
	...
	static final void method2595(ClientScript2 class403, byte i) {
		try {
			...
			RSGraphics.method613(class105, class119, class403, 1469378212);
		} catch (RuntimeException runtimeexception) {
	...
	static Class298_Sub36 createWalkPacket(int localX, int localY, int type) {
		try {
			...
			Class3.flagX = localY * -1129029761;
			Class3.flagY = localX * -1835291189;
			Class3.aBoolean63 = false;
