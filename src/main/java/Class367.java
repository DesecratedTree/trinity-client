...
public class Class367 {
	...
	static void method4551(WidgetConfig class105, int i, int i_5_, int i_6_) {
		try {
			Class117 class117 = class105.method1116(FloorOverlay.graphics, 1629882987);
			if (null != class117) {
				FloorOverlay.graphics.r(i, i_5_, -2093041337 * class105.anInt1156 + i, (i_5_ + class105.anInt1162 * 457937409));
				if (Class3.anInt56 * -64305285 < 3) {
					...
					FloorOverlay.graphics.DA(-16777216, class117.aClass_ta1397, i, i_5_);
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4552(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_8_, (byte) -5);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.hidden ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
