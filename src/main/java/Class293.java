...
public class Class293 {
	...
	static final void method2819(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = CachingHashMap.method4197(i_0_, i_1_, true, (byte) 12);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2822(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub19_7567.method5612(i_2_, 1352882135);
		} catch (RuntimeException runtimeexception) {
