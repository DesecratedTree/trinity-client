...
public class Class302_Sub3_Sub1_Sub1 extends Class302_Sub3_Sub1 {
	...
	Class302_Sub3_Sub1_Sub1(Class342 class342, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, boolean bool, boolean bool_10_) {
		((Class302_Sub3_Sub1_Sub1) this).aClass342_10037 = class342;
		anInt9785 = i << 12;
		anInt9789 = i_0_ << 12;
		anInt9790 = i_1_ << 12;
		anInt9792 = i_7_;
		((Class302_Sub3_Sub1_Sub1) this).aShort10034 = ((Class302_Sub3_Sub1_Sub1) this).aShort10035 = (short) i_6_;
		anInt9791 = i_8_;
		anInt9794 = i_9_;
		aBoolean9787 = bool_10_;
		((Class302_Sub3_Sub1_Sub1) this).aShort10036 = (short) i_2_;
		((Class302_Sub3_Sub1_Sub1) this).aShort10039 = (short) i_3_;
		((Class302_Sub3_Sub1_Sub1) this).aShort10038 = (short) i_4_;
		((Class302_Sub3_Sub1_Sub1) this).anInt10032 = i_5_;
		aByte9793 = (((Class342) ((Class302_Sub3_Sub1_Sub1) this).aClass342_10037).aClass85_3662.aByte780);
		method3725();
	}
	...
	void method3724(Class342 class342, int i, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, boolean bool, boolean bool_21_) {
		...
		anInt9790 = i_12_ << 12;
		anInt9792 = i_18_;
		((Class302_Sub3_Sub1_Sub1) this).aShort10034 = ((Class302_Sub3_Sub1_Sub1) this).aShort10035 = (short) i_17_;
		anInt9791 = i_19_;
		anInt9794 = i_20_;
		aBoolean9787 = bool_21_;
		((Class302_Sub3_Sub1_Sub1) this).aShort10036 = (short) i_13_;
		((Class302_Sub3_Sub1_Sub1) this).aShort10039 = (short) i_14_;
		((Class302_Sub3_Sub1_Sub1) this).aShort10038 = (short) i_15_;
		((Class302_Sub3_Sub1_Sub1) this).anInt10032 = i_16_;
		aByte9793 = (((Class342) ((Class302_Sub3_Sub1_Sub1) this).aClass342_10037).aClass85_3662.aByte780);
		method3725();
	}

	void method3725() {
		int i = (((Class351) ((Class342) (((Class302_Sub3_Sub1_Sub1) this).aClass342_10037)).aClass351_3649).anInt3763);
		if ((((Class351) ((Class342) (((Class302_Sub3_Sub1_Sub1) this).aClass342_10037)).aClass351_3649).aClass302_Sub3_Sub1_Sub1Array3762[i]) != null)
			((Class351) ((Class342) (((Class302_Sub3_Sub1_Sub1) this).aClass342_10037)).aClass351_3649).aClass302_Sub3_Sub1_Sub1Array3762[i].method3726();
		((Class351) (((Class342) ((Class302_Sub3_Sub1_Sub1) this).aClass342_10037).aClass351_3649)).aClass302_Sub3_Sub1_Sub1Array3762[i] = this;
		((Class302_Sub3_Sub1_Sub1) this).aShort10033 = (short) ((Class351) (((Class342) ((Class302_Sub3_Sub1_Sub1) this).aClass342_10037).aClass351_3649)).anInt3763;
		((Class351) ((Class342) (((Class302_Sub3_Sub1_Sub1) this).aClass342_10037)).aClass351_3649).anInt3763 = i + 1 & 0x1fff;
		((Class342) ((Class302_Sub3_Sub1_Sub1) this).aClass342_10037).aClass442_3648.method5870(this, -1945856763);
	}

	void method3726() {
		((Class351) ((Class342) (((Class302_Sub3_Sub1_Sub1) this).aClass342_10037)).aClass351_3649).aClass302_Sub3_Sub1_Sub1Array3762[((Class302_Sub3_Sub1_Sub1) this).aShort10033] = null;
	...
	void method3727(Class331 class331, GraphicsToolkit class_ra, long l) {
		...
		if (i_23_ > 0 || i_23_ < -262144 || i < 0 || i >= class331.anInt3514 * 1988988347 || i_22_ < 0 || i_22_ >= class331.anInt3549 * 1340714547)
			...
			Class351 class351 = (((Class342) (((Class302_Sub3_Sub1_Sub1) this).aClass342_10037)).aClass351_3649);
			Class182 class182 = (((Class342) (((Class302_Sub3_Sub1_Sub1) this).aClass342_10037)).aClass182_3656);
	...
	void method3728(long l, int i) {
		((Class302_Sub3_Sub1_Sub1) this).aShort10035 -= i;
		if (((Class302_Sub3_Sub1_Sub1) this).aShort10035 <= 0)
			method3726();
		else {
			...
			if (class182.anInt1837 * 1558182711 != 0) {
				if ((((Class302_Sub3_Sub1_Sub1) this).aShort10034 - ((Class302_Sub3_Sub1_Sub1) this).aShort10035) <= class182.anInt1886 * -1703669099) {
					int i_34_ = ((anInt9792 >> 8 & 0xff00) + (((Class302_Sub3_Sub1_Sub1) this).anInt10040 >> 16 & 0xff) + class182.anInt1879 * -1778169623 * i);
					int i_35_ = ((anInt9792 & 0xff00) + (((Class302_Sub3_Sub1_Sub1) this).anInt10040 >> 8 & 0xff) + class182.anInt1880 * 936719777 * i);
					int i_36_ = ((anInt9792 << 8 & 0xff00) + (((Class302_Sub3_Sub1_Sub1) this).anInt10040 & 0xff) + class182.anInt1881 * 1137945971 * i);
					if (i_34_ < 0)
						i_34_ = 0;
					else if (i_34_ > 65535)
						i_34_ = 65535;
					...
					if (i_36_ < 0)
						...
						i_36_ = 65535;
					anInt9792 &= ~0xffffff;
					anInt9792 |= (((i_34_ & 0xff00) << 8) + (i_35_ & 0xff00) + ((i_36_ & 0xff00) >> 8));
					((Class302_Sub3_Sub1_Sub1) this).anInt10040 &= ~0xffffff;
					((Class302_Sub3_Sub1_Sub1) this).anInt10040 |= (((i_34_ & 0xff) << 16) + ((i_35_ & 0xff) << 8) + (i_36_ & 0xff));
				}
				if ((((Class302_Sub3_Sub1_Sub1) this).aShort10034 - ((Class302_Sub3_Sub1_Sub1) this).aShort10035) <= class182.anInt1845 * -966201447) {
					int i_37_ = ((anInt9792 >> 16 & 0xff00) + (((Class302_Sub3_Sub1_Sub1) this).anInt10040 >> 24 & 0xff) + class182.anInt1882 * 825667009 * i);
					if (i_37_ < 0)
						i_37_ = 0;
					else if (i_37_ > 65535)
						i_37_ = 65535;
					anInt9792 &= 0xffffff;
					anInt9792 |= (i_37_ & 0xff00) << 16;
					((Class302_Sub3_Sub1_Sub1) this).anInt10040 &= 0xffffff;
					((Class302_Sub3_Sub1_Sub1) this).anInt10040 |= (i_37_ & 0xff) << 24;
				}
			}
			if (class182.anInt1828 * 799607235 != -1 && ((((Class302_Sub3_Sub1_Sub1) this).aShort10034 - ((Class302_Sub3_Sub1_Sub1) this).aShort10035) <= class182.anInt1883 * -1035489121))
				((Class302_Sub3_Sub1_Sub1) this).anInt10032 += class182.anInt1884 * 1185897849 * i;
			if (class182.anInt1832 * -1628433875 != -1 && ((((Class302_Sub3_Sub1_Sub1) this).aShort10034 - ((Class302_Sub3_Sub1_Sub1) this).aShort10035) <= class182.anInt1885 * -1648307777))
				anInt9791 += class182.anInt1878 * 308094979 * i;
			double d = (double) ((Class302_Sub3_Sub1_Sub1) this).aShort10036;
			double d_38_ = (double) ((Class302_Sub3_Sub1_Sub1) this).aShort10039;
			double d_39_ = (double) ((Class302_Sub3_Sub1_Sub1) this).aShort10038;
			boolean bool = false;
			if (class182.anInt1819 * 166927215 == 1) {
				int i_40_ = (i_31_ - ((Class363) (((Class342) ((Class302_Sub3_Sub1_Sub1) this).aClass342_10037).aClass363_3655)).anInt3926 * 60582813);
				int i_41_ = (i_32_ - ((Class363) (((Class342) ((Class302_Sub3_Sub1_Sub1) this).aClass342_10037).aClass363_3655)).anInt3929 * 915630045);
				int i_42_ = i_33_ - (((Class363) ((Class342) (((Class302_Sub3_Sub1_Sub1) this).aClass342_10037)).aClass363_3655).anInt3919) * -1989166667;
				...
				((Class302_Sub3_Sub1_Sub1) this).anInt10032 -= ((long) ((Class302_Sub3_Sub1_Sub1) this).anInt10032 * l_44_) >> 18;
			} else if (class182.anInt1819 * 166927215 == 2) {
				int i_45_ = (i_31_ - ((Class363) (((Class342) ((Class302_Sub3_Sub1_Sub1) this).aClass342_10037).aClass363_3655)).anInt3926 * 60582813);
				int i_46_ = (i_32_ - ((Class363) (((Class342) ((Class302_Sub3_Sub1_Sub1) this).aClass342_10037).aClass363_3655)).anInt3929 * 915630045);
				int i_47_ = i_33_ - (((Class363) ((Class342) (((Class302_Sub3_Sub1_Sub1) this).aClass342_10037)).aClass363_3655).anInt3919) * -1989166667;
				int i_48_ = i_45_ * i_45_ + i_46_ * i_46_ + i_47_ * i_47_;
				long l_49_ = (long) (class182.anInt1847 * 1305957559 * i_48_ * i);
				((Class302_Sub3_Sub1_Sub1) this).anInt10032 -= ((long) ((Class302_Sub3_Sub1_Sub1) this).anInt10032 * l_49_) >> 28;
			}
			...
			if (class182.anIntArray1846 != null) {
				for (int i_62_ = 0; i_62_ < class182.anIntArray1846.length; i_62_++) {
					Class298_Sub45 class298_sub45 = ((Class298_Sub45) (Class344.aClass437_3684.method5812((long) class182.anIntArray1846[i_62_])));
					while (class298_sub45 != null) {
						...
						if (d_66_ > (double) (class190.aLong1931 * 6688605316592129449L))
							class298_sub45 = ((Class298_Sub45) Class344.aClass437_3684.method5813(-2145025597));
						else {
							...
							if (d_68_ < (double) (class190.anInt1943 * -1188833415))
								class298_sub45 = ((Class298_Sub45) Class344.aClass437_3684.method5813(-1619963382));
							else {
								double d_69_ = 0.0;
								if (class190.anInt1936 * -1660029223 == 1)
								...
								class298_sub45 = ((Class298_Sub45) Class344.aClass437_3684.method5813(-1920939025));
							}
						}
					}
				}
			...
			if (class182.anIntArray1829 != null) {
				if (class182.anIntArray1848 == null) {
					...
					for (int i_73_ = 0; i_73_ < class182.anIntArray1829.length; i_73_++) {
						...
						class182.anIntArray1848[i_73_] = (((IntegerValue) (Class190.aClass437_1928.method5812((long) class182.anIntArray1829[i_73_]))).intValue) * -774922497;
					}
				}
			...
			if (bool) {
				while (d > 32767.0 || d_38_ > 32767.0 || d_39_ > 32767.0 || d < -32767.0 || d_38_ < -32767.0 || d_39_ < -32767.0) {
					...
					d_38_ /= 2.0;
					d_39_ /= 2.0;
					((Class302_Sub3_Sub1_Sub1) this).anInt10032 <<= 1;
				}
				((Class302_Sub3_Sub1_Sub1) this).aShort10036 = (short) (int) d;
				((Class302_Sub3_Sub1_Sub1) this).aShort10039 = (short) (int) d_38_;
				((Class302_Sub3_Sub1_Sub1) this).aShort10038 = (short) (int) d_39_;
			}
			anInt9785 += (((long) ((Class302_Sub3_Sub1_Sub1) this).aShort10036 * (long) (((Class302_Sub3_Sub1_Sub1) this).anInt10032 << 2)) >> 23) * (long) i;
			anInt9789 += (((long) ((Class302_Sub3_Sub1_Sub1) this).aShort10039 * (long) (((Class302_Sub3_Sub1_Sub1) this).anInt10032 << 2)) >> 23) * (long) i;
			anInt9790 += (((long) ((Class302_Sub3_Sub1_Sub1) this).aShort10038 * (long) (((Class302_Sub3_Sub1_Sub1) this).anInt10032 << 2)) >> 23) * (long) i;
		}
	}
}
