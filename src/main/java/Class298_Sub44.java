...
public class Class298_Sub44 extends Class298 {
	...
	public void writeMachineInformation(RsByteBuffer buffer, int i) {
		try {
			...
			buffer.writeByte((((Class298_Sub44) this).anInt7471 * -1570985485)); // OS
																					// type.
			buffer.writeByte((((Class298_Sub44) this).x64Arch ? 1 : 0)); // 64-bit
	...
	public int method3530(int i) {
		try {
			int i_1_ = 38;
			i_1_ += ConfigFile.method1310(((Class298_Sub44) this).aString7502, (byte) -1);
			i_1_ += ConfigFile.method1310(((Class298_Sub44) this).aString7503, (byte) -1);
			i_1_ += ConfigFile.method1310(((Class298_Sub44) this).aString7482, (byte) -1);
			i_1_ += ConfigFile.method1310(((Class298_Sub44) this).aString7505, (byte) -1);
			i_1_ += ConfigFile.method1310(((Class298_Sub44) this).aString7496, (byte) -1);
			i_1_ += ConfigFile.method1310(((Class298_Sub44) this).aString7511, (byte) -1);
			return i_1_;
		} catch (RuntimeException runtimeexception) {
	...
	public Class298_Sub44(boolean bool) {
		if (bool) {
			...
			if (!System.getProperty("java.home").contains("(x86)") && (Class344.aString3687.startsWith("amd64") || Class344.aString3687.startsWith("x86_64"))) {
				((Class298_Sub44) this).x64Arch = true;
			} else {
				((Class298_Sub44) this).x64Arch = false;
				Settings.ENABLE_MODERN_OPENGL = false; //just in case to prevent mixed libs from crashing
			}
			...
			if (StanceConfig.aString3759.toLowerCase().indexOf("sun") != -1)
				((Class298_Sub44) this).anInt7491 = 953745309;
			else if (StanceConfig.aString3759.toLowerCase().indexOf("microsoft") != -1)
				((Class298_Sub44) this).anInt7491 = 1907490618;
			else if (StanceConfig.aString3759.toLowerCase().indexOf("apple") != -1)
			...
			int i_2_ = 0;
			try {
				for (/**/; i < ConfigFile.aString1462.length(); i++) {
					int i_3_ = ConfigFile.aString1462.charAt(i);
					if (i_3_ < 48 || i_3_ > 57)
						break;
			...
			i = ConfigFile.aString1462.indexOf('.', 2) + 1;
			i_2_ = 0;
			try {
				for (/**/; i < ConfigFile.aString1462.length(); i++) {
					int i_4_ = ConfigFile.aString1462.charAt(i);
					if (i_4_ < 48 || i_4_ > 57)
						break;
			...
			i = ConfigFile.aString1462.indexOf('_', 4) + 1;
			i_2_ = 0;
			try {
				for (/**/; i < ConfigFile.aString1462.length(); i++) {
					int i_5_ = ConfigFile.aString1462.charAt(i);
					if (i_5_ < 48 || i_5_ > 57)
						break;
			...
			try {
				...
				if (is_6_ != null && is_6_.length % 5 == 0) {
					HashMap<Integer, Class472> hashmap = new HashMap<Integer, Class472>();
				...
				//disabled, pointless and makes client load much faster
				String[][] strings = null; //HardwareInfo.getDXDiagDisplayDevicesProps();
				...
				//disabled, pointless and makes client load much faster
				String[] strings_21_ = null;//HardwareInfo.getDXDiagSystemProps();
				if (strings_21_ != null) {
					String string = "";
					String string_22_ = "";
					String string_23_ = "";
