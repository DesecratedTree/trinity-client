...
public abstract class Class263 implements Interface9 {
	...
	public void method123() {
		...
		if (i_0_ != ((Class263) this).anInt6415) {
			...
			((OpenGLToolkit) ((Class263) this).aClass_ra_Sub3_Sub1_6422).anIntArray9831[i] = ((Class263) this).anInt6415;
		}
	...
	public void method128() {
		int i = ((Class263) this).aClass_ra_Sub3_Sub1_6422.method5386();
		int i_1_ = (((OpenGLToolkit) ((Class263) this).aClass_ra_Sub3_Sub1_6422).anIntArray9831[i]);
	...
	void method2468(int i, int i_2_, int i_3_, int[] is) {
		...
		for (;;) {
			OpenGL.glTexImage2Di(i, i_4_, OpenGLToolkit.method5533(((Class263) this).aClass55_6419, (((Class263) this).aClass77_6420)), i_2_, i_3_, 0, 32993, ((OpenGLToolkit) ((Class263) this).aClass_ra_Sub3_Sub1_6422).anInt9841, is_8_, 0);
			if (i_5_ <= 1)
				break;
			int i_10_ = 0;
			int i_11_ = 0;
	...
	void method2469(int i, int i_24_, int i_25_, float[] fs) {
		...
		for (;;) {
			OpenGL.glTexImage2Df(i, i_27_, OpenGLToolkit.method5533(((Class263) this).aClass55_6419, (((Class263) this).aClass77_6420)), i_24_, i_25_, 0, OpenGLToolkit.method5532(((Class263) this).aClass55_6419), 5126, fs_31_, 0);
			if (i_28_ <= 1)
				break;
	...
	public void method125() {
		int i = ((Class263) this).aClass_ra_Sub3_Sub1_6422.method5386();
		int i_41_ = (((OpenGLToolkit) ((Class263) this).aClass_ra_Sub3_Sub1_6422).anIntArray9831[i]);
	...
	public void method126() {
		int i = ((Class263) this).aClass_ra_Sub3_Sub1_6422.method5386();
		int i_42_ = (((OpenGLToolkit) ((Class263) this).aClass_ra_Sub3_Sub1_6422).anIntArray9831[i]);
	...
	void method2472(int i, int i_43_, int i_44_, byte[] is) {
		...
		for (;;) {
			OpenGL.glTexImage2Dub(i, i_46_, OpenGLToolkit.method5533(((Class263) this).aClass55_6419, (((Class263) this).aClass77_6420)), i_43_, i_44_, 0, OpenGLToolkit.method5532(((Class263) this).aClass55_6419), 5121, is_50_, 0);
			if (i_47_ <= 1)
				break;
	...
	Class263(OpenGLToolkit class_ra_sub3_sub1, int i, Class55 class55, Class77 class77, int i_61_, boolean bool) {
