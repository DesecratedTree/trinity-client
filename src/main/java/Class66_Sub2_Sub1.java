...
public class Class66_Sub2_Sub1 extends Class66_Sub2 {
	...
	int anInt9104;
	int anInt9105;
	ModernToolkit aClass_ra_Sub3_9106;
	int anInt9107;
	int anInt9108;
		...
		if (((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102 == null) {
			...
			for (int i_0_ = 0; i_0_ < 6; i_0_++) {
				if (!interface_ma.method170(anIntArray9109[i_0_], (short) 4664))
					return null;
				TextureConfig class53 = interface_ma.method174(anIntArray9109[i_0_], 1025120075);
	...
	Class66_Sub2_Sub1(ModernToolkit class_ra_sub3, int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
		...
		if (((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102 == null) {
			...
			for (int i_8_ = 0; i_8_ < 6; i_8_++) {
				if (!interface_ma.method170(anIntArray9109[i_8_], (short) 30897))
					return null;
				TextureConfig class53 = interface_ma.method174(anIntArray9109[i_8_], 548251560);
