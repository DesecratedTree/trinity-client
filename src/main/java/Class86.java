...
public class Class86 {
	...
	boolean method960(byte i) {
		try {
			if (766413265 * ((Class86) this).anInt786 >= 0) {
				ObjectConfig class432 = Class463.aClass433_5689.getObjectDefinitions(((((Class86) this).anInt786) * 766413265));
	...
	public static JagexFile2 getPreferences(String string, String string_7_, boolean bool, int i) {
		try {
			...
			do {
				if (file.exists()) {
					JagexFile2 class476;
					try {
						JagexFile2 class476_8_ = new JagexFile2(file, "rw", 10000L);
			...
			if (33 == Class139.anInt1548 * -518493991)
				...
				string_9_ = "_wip";
			File file_10_ = new File(Class83.aString765, new StringBuilder().append(string_7_).append("_preferences").append(string).append(string_9_).append(".dat").toString());
			do {
				if (!bool && file_10_.exists()) {
					JagexFile2 class476;
					try {
						JagexFile2 class476_11_ = new JagexFile2(file_10_, "rw", 10000L);
			...
			JagexFile2 class476;
			try {
				JagexFile2 class476_12_ = new JagexFile2(file, "rw", 10000L);
	...
	public static void method967(int i, int i_28_, int i_29_, int i_30_) {
		try {
			if (ItemContainerConfig.aClass95_9602 != null && ItemContainerConfig.aClass95_9602.method1029((byte) 74) && (ItemContainerConfig.aClass95_9602.anInt921 * 1941368041 == i)) {
				Class116.method1268(ItemContainerConfig.aClass95_9602, i_28_, (byte) 20);
				Class300.musicID = -184109511 * i;
				ItemContainerConfig.aClass95_9602 = null;
				...
				i_28_ = i_28_ * Class422_Sub25.preferences.aClass422_Sub29_7584.method5726(-2143915756) >> 8;
				if (i == -1 && !Class300.aBoolean3208)
					Class134.method1489((byte) -85);
				else if (-1 != i && (-1256171511 * Class300.musicID != i || !Class68.method781(-861777344)) && i_28_ != 0 && !Class300.aBoolean3208) {
					Class170.method1811(i_29_, Class374_Sub1.MUSIC, i, 0, i_28_, false, new Class97_Sub1(), (byte) -36);
					Class14.method344(-1484268589);
				}
				if (Class300.musicID * -1256171511 != i)
					GroundTile.aClass298_Sub19_Sub1_7167 = null;
				Class300.musicID = -184109511 * i;
