...
public class Class304 {
	...
	static final void method3738(ClientScript2 class403, int i) {
		try {
			...
			JagexFile.method6142(class105, class119, class403, -721593745);
	...
	static final void method3739(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_1_, (byte) 99);
	...
	public static Class128 method3741(RsByteBuffer class298_sub53, int i) {
		try {
			Class128 class128 = RSGraphics.method608(class298_sub53, -2147461076);
