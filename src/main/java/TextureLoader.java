...
public class TextureLoader implements Interface_ma {
	CacheIndex spritesIndex;
	CacheIndex texturesIndex;
	TextureConfig[] textureConfigs;
	int textureCount;
	...
	public int[] method173(int i, float f, int i_0_, int i_1_, boolean bool) {
		int[] is = (getTextureData(i, 354542821).method3421(((TextureLoader) this).spritesIndex, this, (double) f, i_0_, i_1_, ((TextureLoader) this).textureConfigs[i].aBoolean544, 795191351));
		return is;
	}

	public int method177(int i) {
		try {
			return ((TextureLoader) this).textureCount * -1882566529;
	...
	public TextureConfig method174(int i, int i_2_) {
		try {
			if (i >= textureConfigs.length || textureConfigs[i] == null) {
				System.out.println("Missing texture: "+i);
				return textureConfigs[0];
			}
			return ((TextureLoader) this).textureConfigs[i];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("kk.k(").append(')').toString());
		}
	}

	public TextureLoader(CacheIndex textureConfig, CacheIndex class243_3_, CacheIndex class243_4_) {
		((TextureLoader) this).texturesIndex = class243_3_;
		((TextureLoader) this).spritesIndex = class243_4_;
		RsByteBuffer buffer = new RsByteBuffer(textureConfig.getFileFromArchive(0, 0, (byte) -117));
		((TextureLoader) this).textureCount = buffer.readUnsignedShort() * 12939135;
		((TextureLoader) this).textureConfigs = new TextureConfig[((TextureLoader) this).textureCount * -1882566529];
		for (int i = 0; i < -1882566529 * ((TextureLoader) this).textureCount; i++) {
			if (buffer.readUnsignedByte() == 1)
				((TextureLoader) this).textureConfigs[i] = new TextureConfig();
		}
		for (int i = 0; i < ((TextureLoader) this).textureCount * -1882566529; i++) {
			if (((TextureLoader) this).textureConfigs[i] != null)
				((TextureLoader) this).textureConfigs[i].aBoolean524 = buffer.readUnsignedByte() == 0;
		}
		for (int i = 0; i < -1882566529 * ((TextureLoader) this).textureCount; i++) {
			if (((TextureLoader) this).textureConfigs[i] != null)
				((TextureLoader) this).textureConfigs[i].largeTexture = buffer.readUnsignedByte() == 1;
		}
		for (int i = 0; i < ((TextureLoader) this).textureCount * -1882566529; i++) {
			if (null != ((TextureLoader) this).textureConfigs[i])
				((TextureLoader) this).textureConfigs[i].aBoolean538 = buffer.readUnsignedByte() == 1;
		}
		for (int i = 0; i < ((TextureLoader) this).textureCount * -1882566529; i++) {
			if (null != ((TextureLoader) this).textureConfigs[i])
				((TextureLoader) this).textureConfigs[i].aByte534 = buffer.readByte();
		}
		for (int i = 0; i < ((TextureLoader) this).textureCount * -1882566529; i++) {
			if (((TextureLoader) this).textureConfigs[i] != null)
				((TextureLoader) this).textureConfigs[i].aByte533 = buffer.readByte();
		}
		for (int i = 0; i < ((TextureLoader) this).textureCount * -1882566529; i++) {
			if (null != ((TextureLoader) this).textureConfigs[i])
				((TextureLoader) this).textureConfigs[i].aByte529 = buffer.readByte();
		}
		for (int i = 0; i < -1882566529 * ((TextureLoader) this).textureCount; i++) {
			if (null != ((TextureLoader) this).textureConfigs[i])
				((TextureLoader) this).textureConfigs[i].aByte536 = buffer.readByte();
		}
		for (int i = 0; i < ((TextureLoader) this).textureCount * -1882566529; i++) {
			if (null != ((TextureLoader) this).textureConfigs[i])
				((TextureLoader) this).textureConfigs[i].aShort532 = (short) buffer.readUnsignedShort();
		}
		for (int i = 0; i < ((TextureLoader) this).textureCount * -1882566529; i++) {
			if (((TextureLoader) this).textureConfigs[i] != null)
				((TextureLoader) this).textureConfigs[i].aByte535 = buffer.readByte();
		}
		for (int i = 0; i < ((TextureLoader) this).textureCount * -1882566529; i++) {
			if (null != ((TextureLoader) this).textureConfigs[i])
				((TextureLoader) this).textureConfigs[i].aByte509 = buffer.readByte();
		}
		for (int i = 0; i < -1882566529 * ((TextureLoader) this).textureCount; i++) {
			if (((TextureLoader) this).textureConfigs[i] != null)
				((TextureLoader) this).textureConfigs[i].aBoolean527 = buffer.readUnsignedByte() == 1;
		}
		for (int i = 0; i < -1882566529 * ((TextureLoader) this).textureCount; i++) {
			if (((TextureLoader) this).textureConfigs[i] != null)
				((TextureLoader) this).textureConfigs[i].aBoolean544 = buffer.readUnsignedByte() == 1;
		}
		for (int i = 0; i < -1882566529 * ((TextureLoader) this).textureCount; i++) {
			if (null != ((TextureLoader) this).textureConfigs[i])
				((TextureLoader) this).textureConfigs[i].alpha = buffer.readByte();
		}
		for (int i = 0; i < ((TextureLoader) this).textureCount * -1882566529; i++) {
			if (null != ((TextureLoader) this).textureConfigs[i])
				((TextureLoader) this).textureConfigs[i].aBoolean540 = buffer.readUnsignedByte() == 1;
		}
		for (int i = 0; i < ((TextureLoader) this).textureCount * -1882566529; i++) {
			if (null != ((TextureLoader) this).textureConfigs[i])
				((TextureLoader) this).textureConfigs[i].aBoolean541 = buffer.readUnsignedByte() == 1;
		}
		for (int i = 0; i < -1882566529 * ((TextureLoader) this).textureCount; i++) {
			if (((TextureLoader) this).textureConfigs[i] != null)
				((TextureLoader) this).textureConfigs[i].aBoolean543 = buffer.readUnsignedByte() == 1;
		}
		for (int i = 0; i < ((TextureLoader) this).textureCount * -1882566529; i++) {
			if (null != ((TextureLoader) this).textureConfigs[i])
				((TextureLoader) this).textureConfigs[i].anInt519 = buffer.readUnsignedByte() * -39200327;
		}
		for (int i = 0; i < ((TextureLoader) this).textureCount * -1882566529; i++) {
			if (((TextureLoader) this).textureConfigs[i] != null)
				((TextureLoader) this).textureConfigs[i].anInt531 = buffer.readInt((byte) -86) * -946109519;
		}
		for (int i = 0; i < -1882566529 * ((TextureLoader) this).textureCount; i++) {
			if (((TextureLoader) this).textureConfigs[i] != null)
				((TextureLoader) this).textureConfigs[i].anInt528 = buffer.readUnsignedByte() * 980235301;
		}
	/*	int equal = 56;
		textureConfigs = Arrays.copyOf(textureConfigs, Settings.OSRS_TEXTURE_OFFSET+equal+1);
		for (int i = 0; i <= equal; i++) 
			clone(textureConfigs[i], textureConfigs[i+Settings.OSRS_TEXTURE_OFFSET] = new TextureConfig());*/
		
		textureConfigs = Arrays.copyOf(textureConfigs, Settings.OSRS_TEXTURE_OFFSET+60);
		textureConfigs[Settings.OSRS_TEXTURE_OFFSET + 59] = textureConfigs[40];//inferno cape same as fire cape config
		((TextureLoader) this).textureCount = textureConfigs.length * 12939135;
	}

	public static  void clone(TextureConfig from, TextureConfig to) {
		to.aBoolean524 = from.aBoolean524;
		to.largeTexture = from.largeTexture;
		to.aBoolean538 = from.aBoolean538;
		to.aByte534 = from.aByte534;
		to.aByte533 = from.aByte533;
		to.aByte529 = from.aByte529;
		to.aByte536 = from.aByte536;
		to.aShort532 = from.aShort532;
		to.aByte535 = from.aByte535;
		to.aByte509 = from.aByte509;
		to.aBoolean527 = from.aBoolean527;
		to.aBoolean544 = from.aBoolean544;
		to.alpha = from.alpha;
		to.aBoolean540 = from.aBoolean540;
		to.aBoolean541 = from.aBoolean541;
		to.aBoolean543 = from.aBoolean543;
		to.anInt519 = from.anInt519;
		to.anInt531 = from.anInt531;
		to.anInt528 = from.anInt528;
	}
	public int[] method171(int i, float f, int i_5_, int i_6_, boolean bool, int i_7_) {
		try {
			int[] is = (getTextureData(i, 1119072054).method3423(((TextureLoader) this).spritesIndex, this, (double) f, i_5_, i_6_, bool, ((TextureLoader) this).textureConfigs[i].aBoolean544, -1817838295));
			return is;
		} catch (RuntimeException runtimeexception) {
	...
	public int[] method172(int i, float f, int i_8_, int i_9_, boolean bool, byte i_10_) {
		try {
			...
			int[] is = (getTextureData(i, 1019997631).method3421(((TextureLoader) this).spritesIndex, this, (double) f, i_8_, i_9_, ((TextureLoader) this).textureConfigs[i].aBoolean544, -524170328));
			return is;
		} catch (RuntimeException runtimeexception) {
	...
	TextureData getTextureData(int textureID, int i_11_) {
		try {
			Class298_Sub37 class298_sub37 = ((TextureLoader) this).aClass354_6464.method4253((long) textureID);
			if (class298_sub37 != null)
				return (TextureData) class298_sub37;
			byte[] is = ((TextureLoader) this).texturesIndex.method2294(textureID, (byte) 51);
			if (null == is) {
				if (textureID ==  Settings.OSRS_TEXTURE_OFFSET + 59) { //exeption for infernal cape
					is = ((TextureLoader) this).texturesIndex.method2294(40, (byte) 51);
					if (is == null)
						return null;
				}else
					return null;
			}
			TextureData textureData = new TextureData(new RsByteBuffer(is), textureID);
			
			
			((TextureLoader) this).aClass354_6464.method4255(textureData, (long) textureID);
			return textureData;
		} catch (RuntimeException runtimeexception) {
	...
	public int[] method183(int i, float f, int i_12_, int i_13_, boolean bool) {
		int[] is = (getTextureData(i, 526499029).method3421(((TextureLoader) this).spritesIndex, this, (double) f, i_12_, i_13_, ((TextureLoader) this).textureConfigs[i].aBoolean544, -1650198196));
		return is;
	}
	...
	public boolean method170(int i, short i_14_) {
		try {
			TextureData class298_sub37_sub6 = getTextureData(i, 709398631);
			return (class298_sub37_sub6 != null && class298_sub37_sub6.method3420((((TextureLoader) this).spritesIndex), this, (byte) -26));
		} catch (RuntimeException runtimeexception) {
	...
	public boolean method180(int i) {
		TextureData class298_sub37_sub6 = getTextureData(i, 942144985);
		return (class298_sub37_sub6 != null && class298_sub37_sub6.method3420((((TextureLoader) this).spritesIndex), this, (byte) 78));
	}

	public int[] method178(int i, float f, int i_15_, int i_16_, boolean bool) {
		int[] is = (getTextureData(i, -345886802).method3421(((TextureLoader) this).spritesIndex, this, (double) f, i_15_, i_16_, ((TextureLoader) this).textureConfigs[i].aBoolean544, -1164110413));
		return is;
	}

	public int[] method182(int i, float f, int i_17_, int i_18_, boolean bool) {
		int[] is = (getTextureData(i, -1131324471).method3421(((TextureLoader) this).spritesIndex, this, (double) f, i_17_, i_18_, ((TextureLoader) this).textureConfigs[i].aBoolean544, -876617633));
		return is;
	}
	...
	public float[] method181(int i, float f, int i_19_, int i_20_, boolean bool, byte i_21_) {
		...
		//	System.out.println("called2: "+i);
			float[] fs = (getTextureData(i, -1967108124).method3422(((TextureLoader) this).spritesIndex, this, i_19_, i_20_, ((TextureLoader) this).textureConfigs[i].aBoolean544, -1481337578));
			return fs;
		} catch (RuntimeException runtimeexception) {
	...
	public float[] method179(int i, float f, int i_22_, int i_23_, boolean bool) {
		float[] fs = (getTextureData(i, 2055609416).method3422(((TextureLoader) this).spritesIndex, this, i_22_, i_23_, ((TextureLoader) this).textureConfigs[i].aBoolean544, -415868966));
		return fs;
	}

	public float[] method184(int i, float f, int i_24_, int i_25_, boolean bool) {
		float[] fs = (getTextureData(i, -1813054507).method3422(((TextureLoader) this).spritesIndex, this, i_24_, i_25_, ((TextureLoader) this).textureConfigs[i].aBoolean544, -1304965359));
		return fs;
	}

	public TextureConfig method187(int i) {
		return ((TextureLoader) this).textureConfigs[i];
	}

	public TextureConfig method188(int i) {
		return ((TextureLoader) this).textureConfigs[i];
	}
	...
	public int[] method190(int i, float f, int i_26_, int i_27_, boolean bool) {
		int[] is = (getTextureData(i, -212514005).method3423(((TextureLoader) this).spritesIndex, this, (double) f, i_26_, i_27_, bool, ((TextureLoader) this).textureConfigs[i].aBoolean544, -1817838295));
		return is;
	}
	...
	static final void method2392(Class394 class394, ClientScript2 class403, byte i) {
		try {
			...
			case 916:
				...
				break;
			case 941:
				GroundTile.method2849(class403, 1843731564);
				break;
			case 485:
			...
			case 694:
				...
				break;
			case 903:
				Map.method4137(class403, 1719357541);
				break;
			case 592:
			...
			case 199:
				...
				break;
			case 667:
				ConfigDefinitionLoader.method3832(class403, -405876281);
				break;
			case 49:
			...
			case 712:
				...
				break;
			case 385:
				DisplayModePreference.method5671(class403, -53605842);
				break;
			case 881:
				Class23.method375(class403, 1885494312);
				break;
			case 52:
				Class298.method2841(class403, 2042171286);
				break;
			case 536:
			...
			case 50:
				...
				break;
			case 39:
				RSGraphics.method614(class403, -228970027);
				break;
			case 432:
				RSGraphics.method618(class403, 1680245596);
				break;
			case 612:
			...
			case 445:
				...
				break;
			case 26:
				Map.method4138(class403, -482311284);
				break;
			case 845:
			...
			case 581:
				...
				break;
			case 278:
				StanceConfig.method4216(class403, 358767270);
				break;
			case 178:
			...
			case 921:
				...
				break;
			case 463:
				IntegerValue.method3399(class403, (byte) 0);
				break;
			case 908:
				Class123.method1379(class403, (byte) 0);
				break;
			case 707:
				AnimationConfig.method4883(class403, 285928237);
				break;
			case 331:
			...
			case 647:
				...
				break;
			case 603:
				IPAddress.method6061(class403, (byte) 2);
				break;
			case 449:
			...
			case 90:
				...
				break;
			case 444:
				FloorOverlay.method4609(class403, -2139639407);
				break;
			case 553:
			...
			case 101:
				...
				break;
			case 202:
				Map.method4140(class403, -977446922);
				break;
			case 184:
			...
			case 718:
				...
				break;
			case 474:
				WidgetConfig.method1134(class403, -1301901080);
				break;
			case 366:
				StanceConfig.method4217(class403, -562613117);
				break;
			case 397:
			...
			case 228:
				...
				break;
			case 234:
				Class298_Sub38.method3501(class403, (short) -32045);
				break;
			case 251:
			...
			case 382:
				...
				break;
			case 539:
				Map.method4139(class403, -1169366763);
				break;
			case 137:
			...
			case 857:
				...
				break;
			case 195:
				GroundTile.method2850(class403, 714261686);
				break;
			case 224:
			...
			case 860:
				...
				break;
			case 531:
				CachingHashMap.method4195(class403, -1833396945);
				break;
			case 113:
			...
			case 993:
				...
				break;
			case 920:
				Partition.method3995(class403, (byte) 16);
				break;
			case 227:
			...
			case 644:
				...
				break;
			case 149:
				FloorOverlay.method4607(class403, (byte) -28);
				break;
			case 576:
				TextureConfig.method600(class403, (byte) -100);
				break;
			case 957:
			...
			case 60:
				...
				break;
			case 459:
				FloorUnderlay.method5886(class403, (short) 107);
				break;
			case 769:
			...
			case 710:
				...
				break;
			case 428:
				GroundTile.method2848(class403, -80531025);
				break;
			case 220:
			...
			case 481:
				...
				break;
			case 507:
				WidgetDetails.method4585(class403, 1473056296);
				break;
			case 704:
				Partition.method3996(class403, 606359910);
				break;
			case 476:
			...
			case 306:
				...
				break;
			case 486:
				Atmosphere.method4713(class403, -1987644438);
				break;
			case 979:
			...
			case 773:
				...
				break;
			case 561:
				Class25.method395(class403, -20883238);
				break;
			case 229:
			...
			case 674:
				...
				break;
			case 141:
				AnimationConfig.method4885(class403, (byte) 94);
				break;
			case 632:
			...
			case 424:
				...
				break;
			case 865:
				Class163.method1774(class403, -865836133);
				break;
			case 799:
				Class50.method537(class403, (byte) -123);
				break;
			case 929:
				WidgetConfig.method1131(class403, (short) -3148);
				break;
			case 180:
				Class377.method4668(class403, (byte) 0);
				break;
			case 221:
				GrabFolder.method2281(class403, (short) 12012);
				break;
			case 811:
			...
			case 284:
				...
				break;
			case 466:
				Atmosphere.method4715(class403, -1070853222);
				break;
			case 726:
			...
			case 569:
				...
				break;
			case 66:
				RSGraphics.method619(class403, -1073260406);
				break;
			case 225:
			...
			case 894:
				...
				break;
			case 965:
				StanceConfig.method4213(class403, 1204781466);
				break;
			case 37:
			...
			case 138:
				...
				break;
			case 824:
				Class25.method391(class403, 949483828);
				break;
			case 325:
			...
			case 210:
				...
				break;
			case 32:
				ObjectConfig.method5787(class403, 2030703145);
				break;
			case 337:
			...
			case 264:
				...
				break;
			case 420:
				Partition.method3997(class403, 1665047418);
				break;
			case 980:
				ConfigDefinitionLoader.method3830(class403, 1815292651);
				break;
			case 446:
			...
			case 900:
				...
				break;
			case 44:
				FloorOverlay.method4611(class403, -1861936891);
				break;
			case 547:
			...
			case 308:
				...
				break;
			case 421:
				CacheIndexIndicator.method1234(class403, -1413098683);
				break;
			case 189:
			...
			case 28:
				...
				break;
			case 809:
				WidgetDetails.method4586(class403, (byte) 100);
				break;
			case 976:
			...
			case 299:
				...
				break;
			case 192:
				GraphicsConfig.method4925(class403, 1249914677);
				break;
			case 108:
			...
			case 176:
				...
				break;
			case 318:
				IPAddress.method6059(class403, 1508830307);
				break;
			case 752:
			...
			case 433:
				...
				break;
			case 194:
				Class298_Sub38.method3499(class403, 226567906);
				break;
			case 540:
			...
			case 78:
				...
				break;
			case 740:
				FloorOverlay.method4608(class403, -1666187924);
				break;
			case 715:
			...
			case 390:
				...
				break;
			case 937:
				WidgetDetails.method4583(class403, -743929031);
				break;
			case 172:
			...
			case 437:
				...
				break;
			case 991:
				ConfigDefinitionLoader.method3828(class403, (byte) 71);
				break;
			case 938:
			...
			case 734:
				...
				break;
			case 611:
				Class25.method394(class403, 2066622299);
				break;
			case 650:
			...
			case 400:
				...
				break;
			case 502:
				Class163.method1777(class403, -787313655);
				break;
			case 591:
			...
			case 434:
				...
				break;
			case 340:
				WidgetDetails.method4581(class403, (short) 255);
				break;
			case 633:
			...
			case 200:
				...
				break;
			case 179:
				DisplayModePreference.method5672(class403, 790586565);
				break;
			case 346:
			...
			case 370:
				...
				break;
			case 339:
				Class163.method1776(true, class403, (byte) 32);
				break;
			case 722:
				Class303.method3736(class403, (byte) 100);
				break;
			case 853:
				RSGraphics.method612(class403, (byte) -73);
				break;
			case 289:
				Class354.method4258(class403, 468134532);
				break;
			case 832:
				ConfigFile.method1313(class403, -847776836);
				break;
			case 123:
			...
			case 100:
				...
				break;
			case 691:
				ClientScriptEnum.method3429(class403, 1331175254);
				break;
			case 623:
			...
			case 615:
				...
				break;
			case 765:
				Class464.method6016(class403, -1319700500);
				break;
			case 880:
			...
			case 955:
				...
				break;
			case 51:
				Preference.method5620(class403, 2109866215);
				break;
			case 958:
			...
			case 671:
				...
				break;
			case 129:
				WidgetConfig.method1133(class403, (short) -13358);
				break;
			case 323:
			...
			case 436:
				...
				break;
			case 159:
				Class219.getWidgetText(class403, (byte) 12);
				break;
			case 555:
				Class88.method974(class403, -1371982645);
				break;
			case 637:
				HintIcon.method363(class403, (byte) 25);
				break;
			case 375:
				ObjectValue.method3111(class403, (byte) 0);
				break;
			case 904:
				Class221.method2051(class403, 1844978034);
				break;
			case 9:
				AnimationFrameBase.method2909(class403, -1591618981);
				break;
			case 111:
			...
			case 112:
				...
				break;
			case 24:
				RSGraphics.method617(class403, -222608844);
				break;
			case 616:
			...
			case 335:
				...
				break;
			case 405:
				WidgetConfig.method1132(class403, 1496269925);
				break;
			case 477:
			...
			case 396:
				...
				break;
			case 902:
				Class98_Sub3.cs2SetBitconfigValue(class403, (byte) 121);
				break;
			case 215:
			...
			case 821:
				...
				break;
			case 94:
				TextureConfig.method601(class403, 1329583265);
				break;
			case 80:
			...
			case 786:
				...
				break;
			case 617:
				ConfigDefinitionLoader.method3829(class403, (short) 6900);
				break;
			case 723:
			...
			case 499:
				...
				break;
			case 624:
				Class298.method2843(class403, (byte) 3);
				break;
			case 479:
			...
			case 850:
				...
				break;
			case 743:
				Preference.method5618(class403, 1968907370);
				break;
			case 797:
			...
			case 130:
				...
				break;
			case 930:
				Map.method4145(class403, 1971452733);
				break;
			case 165:
			...
			case 570:
				...
				break;
			case 798:
				Class116.getWidgetText(class403, 1800478518);
				break;
			case 116:
				Class408.method4968(class403, 446965448);
				break;
			case 98:
				Class127_Sub1.setInterface(class403, (byte) 115);
				break;
			case 63:
			...
			case 549:
				...
				break;
			case 374:
				Class298.method2842(class403, 16711680);
				break;
			case 457:
			...
			case 142:
				...
				break;
			case 47:
				GroundMessage.method3729(class403, -108666201);
				break;
			case 589:
			...
			case 604:
				...
				break;
			case 226:
				Class298_Sub25.method3101(class403, 2147483647);
				break;
			case 944:
			...
			case 778:
				...
				break;
			case 923:
				FloorUnderlay.method5885(class403, 1438080396);
				break;
			case 975:
			...
			case 877:
				...
				break;
			case 952:
				Class69.sendLogin(class403, -2088416900);
				break;
			case 862:
			...
			case 747:
				...
				break;
			case 643:
				JagexFile2.method6082(class403, (byte) 54);
				break;
			case 3:
			...
			case 412:
				...
				break;
			case 653:
				CacheIndexIndicator.method1237(class403, -2115838866);
				break;
			case 458:
			...
			case 496:
				...
				break;
			case 495:
				GroundMessage.method3730(class403, 569527875);
				break;
			case 406:
				StanceConfig.method4212(class403, (short) -27108);
				break;
			case 395:
			...
			case 274:
				...
				break;
			case 731:
				Shortcut.method4264(class403, (short) 30667);
				break;
			case 565:
			...
			case 886:
				...
				break;
			case 947:
				WidgetConfig.method1130(class403, 2069476162);
				break;
			case 584:
			...
			case 230:
				...
				break;
			case 719:
				Class163.method1776(false, class403, (byte) 32);
				break;
			case 590:
			...
			case 833:
				...
				break;
			case 822:
				RSGraphics.method615(class403, 1178461027);
				break;
			case 203:
			...
			case 626:
				...
				break;
			case 823:
				Preference.method5622(class403, (short) -6564);
				break;
			case 808:
			...
			case 269:
				...
				break;
			case 263:
				SpriteTextureConfig.method3208(class403, 1456302474);
				break;
			case 163:
			...
			case 368:
				...
				break;
			case 882:
				Class298_Sub25.method3103(class403, -973474154);
				break;
			case 475:
	...
	static final void method2393(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			...
			if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403)
				Preference.method5623(-440872681 * class105.uid, 1872852053);
		} catch (RuntimeException runtimeexception) {
	...
	static int replaceTexture(int id) {
		//2609 -> tree, 2661 tree top now
		if (id == 2661)  //trees new
			return 8; //2609 
		if (id == Settings.OSRS_TEXTURE_OFFSET + 59)  //fire
			return id; 
		if (id == 2658)
			return 42;
		if (id >= Settings.OSRS_TEXTURE_OFFSET)
			id -= Settings.OSRS_TEXTURE_OFFSET;
		return id;
	}
}
