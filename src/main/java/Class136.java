...
public class Class136 implements Interface6 {
	...
	public void method58(boolean bool, byte i) {
		try {
			if (bool) {
				int i_0_ = ((((Class136) this).aClass158_6386.aClass139_6360.method1545(((Class136) this).aClass57_6385.method271(), client.WIDTH * 775068819, -2059315000)) + (-245579987 * ((Class136) this).aClass158_6386.anInt6362));
				int i_1_ = ((((Class136) this).aClass158_6386.aClass133_6363.method1482(((Class136) this).aClass57_6385.method626(), client.HEIGHT * -791746413, -1363619703)) + (((Class136) this).aClass158_6386.anInt6359 * -1426302101));
				((Class136) this).aClass57_6385.drawSprite(i_0_, i_1_);
			}
		} catch (RuntimeException runtimeexception) {
	...
	public void method56(boolean bool) {
		if (bool) {
			int i = ((((Class136) this).aClass158_6386.aClass139_6360.method1545(((Class136) this).aClass57_6385.method271(), client.WIDTH * 775068819, -2133654536)) + -245579987 * ((Class136) this).aClass158_6386.anInt6362);
			int i_2_ = ((((Class136) this).aClass158_6386.aClass133_6363.method1482(((Class136) this).aClass57_6385.method626(), client.HEIGHT * -791746413, -1742244574)) + ((Class136) this).aClass158_6386.anInt6359 * -1426302101);
			((Class136) this).aClass57_6385.drawSprite(i, i_2_);
		}
	}
	...
	public static void method1495(int i, int i_3_, int i_4_, int i_5_) {
		try {
			i_4_ = (i_4_ * Class422_Sub25.preferences.aClass422_Sub29_7584.method5726(-2142096131) >> 8);
			if (0 != i_4_ && i != -1) {
				if (!Class300.aBoolean3208 && -1256171511 * Class300.musicID != -1 && Class68.method781(87442639) && !Class82_Sub9.method899((byte) 9)) {
					GroundTile.aClass298_Sub19_Sub1_7167 = Class173.method1819(34386078);
					Class368.method4555((short) 1644);
					Class298_Sub19_Sub1 class298_sub19_sub1 = Class8.method318((GroundTile.aClass298_Sub19_Sub1_7167), -1213425929);
					Class68.method777(true, class298_sub19_sub1, 1899476415);
				}
				Class477.method6096(Class463.MIDI_INDEX, i, 0, i_4_, false, -1993911100);
	...
	static final void method1501(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = ItemConfig.method6043(Class422_Sub25.preferences.graphicsMode.method5677(-1033655497), 200, -564822941);
		} catch (RuntimeException runtimeexception) {
