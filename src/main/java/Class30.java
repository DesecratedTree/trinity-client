...
public abstract class Class30 {
	...
	boolean aBoolean379;
	int anInt380;
	OpenGLLegacyToolkit aClass_ra_Sub2_381;
	static int[] anIntArray382 = new int[1];

	Class30(OpenGLLegacyToolkit class_ra_sub2, int i, Class55 class55, Class77 class77, int i_0_, boolean bool) {
	...
	void method408() {
		if (((Class30) this).anInt376 > 0) {
			((OpenGLLegacyToolkit) ((Class30) this).aClass_ra_Sub2_381).anInt8175 -= method416();
			int[] is = new int[1];
	...
	void method409(int i) {
		((OpenGLLegacyToolkit) ((Class30) this).aClass_ra_Sub2_381).anInt8175 -= i;
		((OpenGLLegacyToolkit) ((Class30) this).aClass_ra_Sub2_381).anInt8175 += method416();
	}
	...
	static void method412(int i, int i_26_, int i_27_, int i_28_, Class55 class55, byte[] is) {
		...
		for (;;) {
			OpenGL.glTexImage2Dub(i, i_30_, i_26_, i_27_, i_28_, 0, OpenGLLegacyToolkit.method5228(class55), 5121, is_34_, 0);
			if (i_31_ <= 1)
				break;
	...
	boolean method413() {
		if (((OpenGLLegacyToolkit) ((Class30) this).aClass_ra_Sub2_381).aBoolean8170) {
			int i = method416();
			((Class30) this).aClass_ra_Sub2_381.method5256(this);
	...
	static void method415(int i, int i_45_, int i_46_, int i_47_, Class55 class55, float[] fs) {
		...
		for (;;) {
			OpenGL.glTexImage2Df(i, i_49_, i_45_, i_46_, i_47_, 0, OpenGLLegacyToolkit.method5228(class55), 5126, fs_53_, 0);
			if (i_50_ <= 1)
				break;
