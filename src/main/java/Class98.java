...
public abstract class Class98 {
	...
	static void method1055(GraphicsToolkit class_ra, int i, int i_14_, int i_15_) {
		try {
			if (i >= 0 && i_14_ >= 0 && null != Class436.aClass233_5493) {
				...
				Matrix class233 = class_ra.method5036();
				...
				if (client.aClass283_8716.method2675(-1611682495) != null && (!client.aBoolean8835 || (-112110875 * Class298.anInt3192 & 0x40) != 0)) {
					...
					float f_27_ = ConfigFile.method1312(f_21_, f_22_, f_23_, f_24_, f_25_, f_26_, 4, 1869450178);
					if (f_27_ > 0.0F) {
						...
						if (i_32_ < 3 && ((client.aClass283_8716.method2654(-86337284).terrainSettings[1][i_30_ >> 9][i_31_ >> 9]) & 0x2) != 0)
							i_32_++;
					}
					if (-1 != i_18_ && -1 != i_19_) {
						if (client.aBoolean8835 && (-112110875 * Class298.anInt3192 & 0x40) != 0) {
							WidgetConfig class105 = Class140.method1558((Class379.anInt4099 * 1262526353), (392084321 * client.anInt8836), -156511736);
							if (class105 != null)
				...
				while (iterator.hasNext()) {
					...
					if (!client.aBoolean8674 && ((Class287.myPlayer.plane) != class335.aClass365_Sub1_3616.plane)) {
						...
						if (class335.aClass365_Sub1_3616 instanceof Player) {
							...
							if ((0 == (i_38_ & 0x1) && 0 == ((int) class217.x & 0x1ff) && ((int) class217.y & 0x1ff) == 0) || ((i_38_ & 0x1) == 1 && (((int) class217.x & 0x1ff) == 256) && 256 == ((int) class217.y & 0x1ff))) {
								int i_39_ = ((int) class217.x - (class365_sub1_sub1_sub2_sub2.getSize() - 1 << 8));
								int i_40_ = ((int) class217.y - (class365_sub1_sub1_sub2_sub2.getSize() - 1 << 8));
								for (int i_41_ = 0; i_41_ < -1230451913 * client.anInt8703; i_41_++) {
									ObjectValue class298_sub29 = ((ObjectValue) (client.aClass437_8696.method5812((long) client.anIntArray8699[i_41_])));
									if (null == class298_sub29) {
										...
										if (443738891 * client.anInt8884 != (class365_sub1_sub1_sub2_sub1.anInt10070) * 335731285) {
											if (!class365_sub1_sub1_sub2_sub1.aBoolean10123) {
												...
												int i_43_ = ((int) (class217_42_.x) - (((class365_sub1_sub1_sub2_sub1.config.anInt6187) * -2095128707) - 1 << 8));
												int i_44_ = ((int) (class217_42_.y) - ((-2095128707 * (class365_sub1_sub1_sub2_sub1.config.anInt6187)) - 1 << 8));
												if (i_43_ >= i_39_ && (((class365_sub1_sub1_sub2_sub1.config.anInt6187) * -2095128707) <= ((class365_sub1_sub1_sub2_sub2.getSize()) - (i_43_ - i_39_ >> 9))) && i_44_ >= i_40_ && (((class365_sub1_sub1_sub2_sub1.config.anInt6187) * -2095128707) <= ((class365_sub1_sub1_sub2_sub2.getSize()) - (i_44_ - i_40_ >> 9)))) {
								...
								for (int i_46_ = 0; i_46_ < i_45_; i_46_++) {
									Player class365_sub1_sub1_sub2_sub2_47_ = (client.players[is[i_46_]]);
									if ((null != class365_sub1_sub1_sub2_sub2_47_) && (443738891 * client.anInt8884 != (335731285 * (class365_sub1_sub1_sub2_sub2_47_.anInt10070))) && (class365_sub1_sub1_sub2_sub2 != class365_sub1_sub1_sub2_sub2_47_)) {
										if (!class365_sub1_sub1_sub2_sub2_47_.aBoolean10123) {
											...
											int i_50_ = ((int) (class217_48_.y) - ((class365_sub1_sub1_sub2_sub2_47_.getSize()) - 1 << 8));
						...
						if (class335.aClass365_Sub1_3616 instanceof NPC) {
							...
							if (null != (class365_sub1_sub1_sub2_sub1.config)) {
								SceneObjectPosition class217 = (class365_sub1_sub1_sub2_sub1.method4337().aClass217_2599);
								if ((0 == ((-2095128707 * (class365_sub1_sub1_sub2_sub1.config.anInt6187)) & 0x1) && 0 == ((int) class217.x & 0x1ff) && (((int) class217.y & 0x1ff) == 0)) || (((-2095128707 * (class365_sub1_sub1_sub2_sub1.config.anInt6187)) & 0x1) == 1 && (((int) class217.x & 0x1ff) == 256) && (((int) class217.y & 0x1ff) == 256))) {
									int i_51_ = ((int) class217.x - (((-2095128707 * (class365_sub1_sub1_sub2_sub1.config.anInt6187)) - 1) << 8));
									int i_52_ = ((int) class217.y - (((class365_sub1_sub1_sub2_sub1.config.anInt6187) * -2095128707) - 1 << 8));
									for (int i_53_ = 0; (i_53_ < client.anInt8703 * -1230451913); i_53_++) {
										ObjectValue class298_sub29 = ((ObjectValue) (client.aClass437_8696.method5812((long) client.anIntArray8699[i_53_])));
										if (class298_sub29 == null) {
											if (i_15_ == 202437353) {
												/* empty */
											}
										} else {
											NPC class365_sub1_sub1_sub2_sub1_54_ = ((NPC) (class298_sub29.value));
											if (((335731285 * (class365_sub1_sub1_sub2_sub1_54_.anInt10070)) != (client.anInt8884 * 443738891)) && (class365_sub1_sub1_sub2_sub1_54_ != class365_sub1_sub1_sub2_sub1)) {
												if (!class365_sub1_sub1_sub2_sub1_54_.aBoolean10123) {
													...
													int i_56_ = ((int) (class217_55_.x) - (((class365_sub1_sub1_sub2_sub1_54_.config.anInt6187) * -2095128707) - 1 << 8));
													int i_57_ = ((int) (class217_55_.y) - (((-2095128707 * (class365_sub1_sub1_sub2_sub1_54_.config.anInt6187)) - 1) << 8));
													if (i_56_ >= i_51_ && ((-2095128707 * (class365_sub1_sub1_sub2_sub1_54_.config.anInt6187)) <= (((class365_sub1_sub1_sub2_sub1.config.anInt6187) * -2095128707) - ((i_56_ - i_51_) >> 9))) && i_57_ >= i_52_ && ((-2095128707 * (class365_sub1_sub1_sub2_sub1_54_.config.anInt6187)) <= ((-2095128707 * (class365_sub1_sub1_sub2_sub1.config.anInt6187)) - ((i_57_ - i_52_) >> 9)))) {
									...
									for (int i_59_ = 0; i_59_ < i_58_; i_59_++) {
										Player class365_sub1_sub1_sub2_sub2 = (client.players[is[i_59_]]);
										if ((null != class365_sub1_sub1_sub2_sub2) && ((335731285 * (class365_sub1_sub1_sub2_sub2.anInt10070)) != (client.anInt8884 * 443738891))) {
											if (!class365_sub1_sub1_sub2_sub2.aBoolean10123) {
												...
												int i_61_ = ((int) (class217_60_.x) - ((class365_sub1_sub1_sub2_sub2.getSize()) - 1 << 8));
												int i_62_ = ((int) (class217_60_.y) - ((class365_sub1_sub1_sub2_sub2.getSize()) - 1 << 8));
												if (i_61_ >= i_51_ && ((class365_sub1_sub1_sub2_sub2.getSize()) <= (((class365_sub1_sub1_sub2_sub1.config.anInt6187) * -2095128707) - (i_61_ - i_51_ >> 9))) && i_62_ >= i_52_ && ((class365_sub1_sub1_sub2_sub2.getSize()) <= ((-2095128707 * (class365_sub1_sub1_sub2_sub1.config.anInt6187)) - (i_62_ - i_52_ >> 9)))) {
						...
						if (class335.aClass365_Sub1_3616 instanceof Class365_Sub1_Sub4_Sub1) {
							...
							GroundTile class298_sub2 = ((GroundTile) (client.groundTiles.method5812((long) ((class335.aClass365_Sub1_3616.plane) << 28 | i_64_ << 14 | i_63_))));
							if (null != class298_sub2) {
								int i_65_ = 0;
								Class298_Sub12 class298_sub12 = ((Class298_Sub12) class298_sub2.groundItems.method5942(-1921101370));
								while (class298_sub12 != null) {
									ItemConfig class468 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions((1768239597 * class298_sub12.id)));
									int i_66_;
									...
									if (client.aBoolean8835 && ((class335.aClass365_Sub1_3616.plane) == (Class287.myPlayer.plane))) {
										...
										if (0 != ((Class298.anInt3192 * -112110875) & 0x1) && (null == class497 || ((class468.method6037((831522399 * Class132.anInt1508), (-388931549 * class497.anInt6100), -2028636758)) != (-388931549 * (class497.anInt6100)))))
											Class234.method2174(client.aString8838, new StringBuilder().append(client.aString8754).append(" ").append(Class26.aString351).append(" ").append(Class285.method2709(i_66_, -1803338083)).append(class468.name).toString(), (Class240.anInt2704 * 697885143), 17, -1, (long) ((class298_sub12.id) * 1768239597), i_36_, i_37_, true, false, (long) i_65_, false, -1282887596);
									}
									if (class335.aClass365_Sub1_3616.plane == (Class287.myPlayer.plane)) {
										String[] strings = class468.groundOptions;
										for (int i_67_ = strings.length - 1; i_67_ >= 0; i_67_--) {
											if (null != strings[i_67_]) {
												...
												Class234.method2174(strings[i_67_], new StringBuilder().append(Class285.method2709(i_66_, -1300852022)).append(class468.name).toString(), i_69_, i_68_, -1, (long) ((class298_sub12.id) * 1768239597), i_36_, i_37_, true, false, (long) i_65_, false, -1707817875);
											}
										}
									}
									class298_sub12 = ((Class298_Sub12) class298_sub2.groundItems.method5947(293661745));
									i_65_++;
								}
							}
						}
						if (class335.aClass365_Sub1_3616 instanceof Interface3) {
							...
							ObjectConfig class432 = (client.aClass283_8716.method2641(-151154213).getObjectDefinitions(interface3.method32((byte) 32)));
							...
							if (class432 == null) {
								...
								if (class335.aClass365_Sub1_3616.plane == (Class287.myPlayer.plane)) {
									String[] strings = class432.options;
									if (strings != null) {
	...
	static void setWidgetText(int i, String string, byte i_79_) {
		try {
