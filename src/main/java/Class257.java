...
public class Class257 {
				...
				if (((Class257) this).anInt2804 * -1845310689 != 1) {
					...
					if (class298_sub39 == null) {
						...
						if (((Class257) this).anInt2808 * 851327335 >= -1845310689 * ((Class257) this).anInt2804) {
							...
							class298_sub39_2_.remove(-1460969981);
						} else {
	...
	static void method2450(ClientScript2 class403, short i) {
		try {
			((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393 - 1)] = (Class316.aClass362_3318.method4307((((ClientScript2) class403).anIntArray5244[((ClientScript2) class403).anInt5239 * 681479919 - 2]), 245040087).aStringArray4026[(((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239 - 1])]);
	...
	static final void method2451(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static final void method2452(ClientScript2 class403, int i) {
		try {
			int i_6_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			ItemConfig class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_6_);
			if (-1673957995 * class468.certTemplate >= 0 && 809765849 * class468.cert >= 0)
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = class468.cert * 809765849;
			else
	...
	static final void method2453(boolean bool, byte i) {
		try {
			Class95.method1033(client.WINDOW_PANE_ID * -257444687, -2110394505 * Class462.screenWidth, Class298_Sub40_Sub9.screenHeight * -1111710645, bool, 1828905535);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("kt.kg(").append(')').toString());
		}
	}

	static final void method2454(ClientScript2 class403, int i) {
		try {
			int i_7_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			WorldMapArea class298_sub37_sub13 = Class298_Sub7.method2864(-1164141102);
