...
public class ClientScriptEnums {
	CacheIndex index2;
	int csEnumsCount;
	ClientScriptEnum[] aClass298_Sub37_Sub7Array6116;
	public static Class347 aClass347_6117;

	public ClientScriptEnums(Class411 class411, Class429 class429, CacheIndex class243, boolean bool) {
		index2 = class243;
		csEnumsCount = (index2.method2316((-1006924897 * (ConfigFile.aClass120_1431.anInt1460)), -1837337583) * 1005943745);
		if (bool) {
			aClass298_Sub37_Sub7Array6116 = (new ClientScriptEnum[csEnumsCount * 589337665]);
			for (int i = 0; i < csEnumsCount * 589337665; i++) {
				byte[] is;
				synchronized (index2) {
					is = (index2.getFileFromArchive(-1006924897 * ConfigFile.aClass120_1431.anInt1460, i, (byte) -117));
				}
				ClientScriptEnum class298_sub37_sub7 = new ClientScriptEnum(i);
				if (null != is) {
					class298_sub37_sub7.method3424(new RsByteBuffer(is), -2124220647);
				}
				ClientScriptEnum.modify(class298_sub37_sub7);
				aClass298_Sub37_Sub7Array6116[i] = class298_sub37_sub7;
			}
		}
	}

	public ClientScriptEnum method6219(int i, int i_0_) {
		try {
			if (i < 0) {
				return new ClientScriptEnum();
			}
		...
		try {
			...
			if (0 == i_2_) {
				if (bool) {
					...
					class410.anInt5288 = (1896571807 * (((class365_sub1_sub1_sub2_sub2.scenePositionYQueue[0] + class341.gameSceneBaseY * 283514611) >> 6) + ((class365_sub1_sub1_sub2_sub2.plane << 28) + ((-1760580017 * class341.gameSceneBaseX + (class365_sub1_sub1_sub2_sub2.scenePositionXQueue[0])) >> 6 << 14))));
					if (-1 != (class365_sub1_sub1_sub2_sub2.anInt10221 * 1208589843)) {
						class410.anInt5286 = (class365_sub1_sub1_sub2_sub2.anInt10221 * 1714576017);
					} else {
						class410.anInt5286 = class365_sub1_sub1_sub2_sub2.aClass386_10084.method4719((byte) 0) * 481306955;
					}
					class410.anInt5285 = class365_sub1_sub1_sub2_sub2.anInt10090 * 1969382475;
					class410.aBoolean5287 = class365_sub1_sub1_sub2_sub2.aBoolean10203;
