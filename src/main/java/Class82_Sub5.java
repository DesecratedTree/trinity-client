	...
	public static int method882(int i, boolean bool, byte i_0_) {
		try {
			...
			if (null == class298_sub9)
				return ((Class300.aClass518_3217.method6311(i, 211542342).length) * 1317156085);
			int i_1_ = 0;
			...
			i_1_ += ((Class300.aClass518_3217.method6311(i, 138660103).length * 1317156085) - ((Class298_Sub9) class298_sub9).anIntArray7226.length);
			return i_1_;
		} catch (RuntimeException runtimeexception) {
