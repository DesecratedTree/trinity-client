...
public class Class298_Sub8_Sub1 extends Class298_Sub8 {
	...
	boolean method2869() {
		if ((((OpenGLLegacyToolkit) ((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222).aBoolean8170) && ((OpenGLLegacyToolkit) ((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222).aBoolean8093 && ((OpenGLLegacyToolkit) (((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222)).aBoolean8133) {
			...
			((Class298_Sub8_Sub1) this).aClass29_9175 = (Class29.method406(((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") })));
			...
			((Class298_Sub8_Sub1) this).aClass29_9183 = (Class29.method406(((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = sceneCol*(postLum/preLum)+bloomCol*params.x;\n}\n") })));
			((Class298_Sub8_Sub1) this).aClass29_9187 = (Class29.method406(((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222, 35632, "uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n") })));
	...
	void method2878(int i, Class30_Sub2 class30_sub2, Class30_Sub2 class30_sub2_14_) {
		...
		if (((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190 != null) {
			...
			while (i_15_ > 256 || i_16_ > 256) {
				OpenGLLegacyToolkit.glViewport(0, 0, i_15_, i_16_);
			...
			((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9179.method572(0);
			OpenGLLegacyToolkit.glViewport(0, 0, 256, 256);
	...
	void method2877(int i, Class30_Sub2 class30_sub2, Class30_Sub2 class30_sub2_22_) {
		...
		if (((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190 != null) {
			...
			while (i_23_ > 256 || i_24_ > 256) {
				OpenGLLegacyToolkit.glViewport(0, 0, i_23_, i_24_);
	...
	void method2872(int i, Class30_Sub2 class30_sub2, Class30_Sub2 class30_sub2_30_) {
		...
		if (((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190 != null) {
			...
			while (i_31_ > 256 || i_32_ > 256) {
				OpenGLLegacyToolkit.glViewport(0, 0, i_31_, i_32_);
	...
	Class298_Sub8_Sub1(OpenGLLegacyToolkit class_ra_sub2) {
		super(class_ra_sub2);
	}
	...
	boolean method2890() {
		return (((OpenGLLegacyToolkit) ((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222).aBoolean8170 && ((OpenGLLegacyToolkit) (((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222)).aBoolean8093 && ((OpenGLLegacyToolkit) (((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222)).aBoolean8133);
	}
}
