...
public class Class272 {
	...
	Class298_Sub26_Sub1 method2550(int i, int i_3_, int[] is, int i_4_) {
		try {
			...
			if (null == class298_sub26_sub1)
				return null;
			class298_sub23.remove(-1460969981);
			((Class272) this).aClass440_2902.method5858(class298_sub26_sub1, l);
			return class298_sub26_sub1;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2553(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_9_, (byte) 22);
	...
	static final void method2556(ClientScript2 class403, int i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub2_7547, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, 1031457025);
