...
public class Class_ta_Sub3 extends Class_ta {
	...
	Class_ta_Sub3(ModernToolkit class_ra_sub3, int i, int i_0_, int[] is) {
	...
	static Class_ta_Sub3 method6007(ModernToolkit class_ra_sub3, int i, int i_1_, int[] is, int[] is_2_) {
	...
	Class_ta_Sub3(ModernToolkit class_ra_sub3, int i, int i_11_, byte[] is) {
