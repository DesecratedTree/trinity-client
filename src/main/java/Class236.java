...
public class Class236 {
	...
	static WidgetConfig aClass105_2606;
	...
	static final byte[] method2188(byte[] is, int i) {
		try {
			...
			if (Settings.DISABLE_XTEA_CRASH)
				return new byte[100];
			else
	...
	public static Class298_Sub52 method2190(int i) {
		try {
			...
			if (class298_sub52 == null)
				return null;
			Class352 class352 = Class301_Sub1.aClass339_3251.method4116((-530122905 * (class298_sub52.mapAreaID)), -113320818);
