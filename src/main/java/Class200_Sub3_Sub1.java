...
public class Class200_Sub3_Sub1 extends Class200_Sub3 implements Interface9_Impl2_Impl1 {
	...
	public void method83(int i, int i_0_, int i_1_, int i_2_, int[] is, int i_3_) {
		...
		long l_4_ = IDirect3DDevice.CreateRenderTarget((((DirectXToolkit) (((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410)).deviceContext), i_1_, i_2_, 21, 0, 0, true);
		if (jagdx.a.f(IDirect3DDevice.StretchRect((((DirectXToolkit) ((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410).deviceContext), l, i, i_0_, i_1_, i_2_, l_4_, 0, 0, i_1_, i_2_, 1))) {
	...
	public void method107(int i, int i_20_, int i_21_, int i_22_, int[] is, int i_23_) {
		long l = IDirect3DTexture.GetSurfaceLevel(((Class200_Sub3_Sub1) this).aLong6407, 0);
		long l_24_ = IDirect3DDevice.CreateRenderTarget((((DirectXToolkit) (((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410)).deviceContext), i_21_, i_22_, 21, 0, 0, true);
		if (jagdx.a.f(IDirect3DDevice.StretchRect((((DirectXToolkit) ((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410).deviceContext), l, i, i_20_, i_21_, i_22_, l_24_, 0, 0, i_21_, i_22_, 1))) {
	...
	public void method93(int i, int i_41_, int i_42_, int i_43_, int[] is, int i_44_) {
		long l = IDirect3DTexture.GetSurfaceLevel(((Class200_Sub3_Sub1) this).aLong6407, 0);
		long l_45_ = IDirect3DDevice.CreateRenderTarget((((DirectXToolkit) (((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410)).deviceContext), i_42_, i_43_, 21, 0, 0, true);
		if (jagdx.a.f(IDirect3DDevice.StretchRect((((DirectXToolkit) ((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410).deviceContext), l, i, i_41_, i_42_, i_43_, l_45_, 0, 0, i_42_, i_43_, 1))) {
	...
	Class200_Sub3_Sub1(DirectXToolkit class_ra_sub3_sub2, Class55 class55, Class77 class77, int i, int i_56_) {
