				...
				try {
					...
					if (Class486.aClass486_6061 == Class525.aClass486_6298) {
						if (client.aClass25_8693.method387(537308016).isAvailable(1, (byte) -109)) {
							client.aClass25_8693.method387(537308016).readBytes((((Class25) client.aClass25_8693).aClass298_Sub53_Sub2_333.buffer), 0, 1, (byte) -97);
							Class525.aClass412_6299 = ((Class412) (Class422_Sub20.method5701(Class400.method4928((short) 4505), (((Class25) client.aClass25_8693).aClass298_Sub53_Sub2_333.buffer[0]) & 0xff, (byte) 2)));
							if (Class525.aClass412_6299 == Class412.aClass412_6569) {
								...
								((Class25) client.aClass25_8693).aClass449_334 = new IsaacCipher(is);
								new IsaacCipher(is);
								((Class25) client.aClass25_8693).aClass298_Sub53_Sub2_333.method3665((((Class25) client.aClass25_8693).aClass449_334), (byte) 81);
								Class439.method5851(8, 1887293413);
								client.aClass25_8693.method383((short) 8191);
								((Class25) client.aClass25_8693).aClass298_Sub53_Sub2_333.index = 0;
								((Class25) client.aClass25_8693).aClass202_344 = null;
								((Class25) client.aClass25_8693).aClass202_345 = null;
								((Class25) client.aClass25_8693).aClass202_348 = null;
								((Class25) client.aClass25_8693).anInt338 = 0;
							} else
								client.aClass25_8693.method384((byte) 83);
							((Class25) client.aClass25_8693).INCOMMING_PACKET = null;
