...
public class Class148 implements Interface23 {
	LinkedArrayList aClass437_6647 = new LinkedArrayList(128);
	...
	int[] anIntArray6652 = new int[Math.max(Settings.VARS_COUNT, -1085917127 * Class440.aClass205_5582.anInt2339)];
	static long aLong6653 = 1L;
	public int[] configs = new int[Math.max(Settings.VARS_COUNT, -1085917127 * Class440.aClass205_5582.anInt2339)];
	...
	void setConfigByFileValue(int configId, int i_1_, int i_2_) {
		try {
			ConfigDefinitions class327 = Class472.configLoader.getConfigDefinitions(configId, -781710328);
			int i_3_ = class327.realConfigId * -50358139;
			int i_4_ = class327.startinBit * -1528472107;
			int i_5_ = 1394539663 * class327.endingBit;
	...
	void method1603(int i) {
		try {
			for (int i_7_ = 0; i_7_ < /*Class440.aClass205_5582.anInt2339 * -1085917127*/configs.length; i_7_++) {
				((Class148) this).anIntArray6652[i_7_] = 0;
				configs[i_7_] = 0;
			}
			((Class148) this).aClass437_6647 = new LinkedArrayList(128);
		} catch (RuntimeException runtimeexception) {
	...
	void method1605(int i, int i_10_, byte i_11_) {
		try {
			...
			if (i == 1174 || i == 300 || i == 301) {
				WidgetConfig.setOrbSpecial();
				Class298_Sub46 class298_sub46 = new Class298_Sub46();
				class298_sub46.anObjectArray7530 = new Object[] {1364};
	...
	public void setBitconfigValue(int i, int i_12_, int i_13_) {
		try {
			ConfigDefinitions config = Class472.configLoader.getConfigDefinitions(i, -781710328);
			int realConfig = config.realConfigId * -50358139;
			int startingBit = config.startinBit * -1528472107;
			int endingBit = 1394539663 * config.endingBit;
			int i_17_ = anIntArray6650[endingBit - startingBit];
			if (i_12_ < 0 || i_12_ > i_17_)
				i_12_ = 0;
			i_17_ <<= startingBit;
			method1604(realConfig, (configs[realConfig] & (i_17_ ^ 0xffffffff) | i_12_ << startingBit & i_17_), 681479919);
		} catch (RuntimeException runtimeexception) {
	...
	public int method250(int i, byte i_18_) {
		try {
			ConfigDefinitions class327 = Class472.configLoader.getConfigDefinitions(i, -781710328);
			int i_19_ = class327.realConfigId * -50358139;
			int i_20_ = -1528472107 * class327.startinBit;
			int i_21_ = class327.endingBit * 1394539663;
			int i_22_ = anIntArray6650[i_21_ - i_20_];
			int v =  configs[i_19_] >> i_20_ & i_22_;
			/*if ((i == 9816 || i == 7198) && Settings.ENABLE_X1_HITS)
				v /= 10;*/
			return v;
		} catch (RuntimeException runtimeexception) {
			...
			for (Class298_Sub33 class298_sub33 = (Class298_Sub33) (bool ? ((Class148) this).aClass437_6647.method5816(1646690306) : ((Class148) this).aClass437_6647.method5815((byte) 18)); class298_sub33 != null; class298_sub33 = (Class298_Sub33) ((Class148) this).aClass437_6647.method5815((byte) -66)) {
				if ((class298_sub33.aLong7385 * -959724544626478745L & 0x3fffffffffffffffL) < l) {
					if ((-959724544626478745L * class298_sub33.aLong7385 & 0x4000000000000000L) != 0L) {
						...
						configs[i_24_] = ((Class148) this).anIntArray6652[i_24_];
						class298_sub33.remove(-1460969981);
						return i_24_;
					}
					class298_sub33.remove(-1460969981);
				}
	...
	public int getBitconfigState(int bitfileid) {
		ConfigDefinitions def = Class472.configLoader.getConfigDefinitions(bitfileid, -781710328);
		int realId = def.realConfigId * -50358139;
		int startingBit = -1528472107 * def.startinBit;
		int endingBit = def.endingBit * 1394539663;
		int bitOffsetValues = anIntArray6650[endingBit - startingBit];
		int v = configs[realId] >> startingBit & bitOffsetValues;
		return v;
	}
	...
	static final void method1608(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_29_, (byte) -44);
	...
	static final void method1609(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_30_, (byte) 31);
	...
	public static void method1614(byte i) {
		try {
			if (null == Class231.fullScreenFrame) {
				...
				int i_36_ = (Class78.anInt733 * -639974669 - Class462.screenWidth * -2110394505 - i_34_);
				int i_37_ = (1282634425 * client.anInt6472 - -1111710645 * Class298_Sub40_Sub9.screenHeight - i_35_);
	...
	static final void method1615(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_40_, (byte) 62);
	...
	static final void method1616(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			...
			if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403)
				Class509.method6286(class105.uid * -440872681, -1977969421);
		} catch (RuntimeException runtimeexception) {
