...
public class Class162 {
	...
	long[] aLongArray1662;
	long aLong1663;
	LinkedArrayList aClass437_1664;
	int[] anIntArray1665;
	...
	public Integer method1753(int i, byte i_7_) {
		try {
			if (null == ((Class162) this).aClass437_1664)
				return null;
			Class298 class298 = ((Class162) this).aClass437_1664.method5812((long) i);
			if (null == class298 || !(class298 instanceof IntegerValue))
				return null;
			return new Integer(((IntegerValue) class298).intValue * -774922497);
		} catch (RuntimeException runtimeexception) {
	...
	public Integer method1754(int i, int i_8_, int i_9_, int i_10_) {
		try {
			...
			return new Integer(((((IntegerValue) class298).intValue * -774922497) & i_11_) >>> i_8_);
		} catch (RuntimeException runtimeexception) {
	...
	public String method1755(int i, int i_12_) {
		try {
			if (null == ((Class162) this).aClass437_1664)
				return null;
			Class298 class298 = ((Class162) this).aClass437_1664.method5812((long) i);
			if (class298 == null || !(class298 instanceof ObjectValue))
				return null;
			return (String) ((ObjectValue) class298).value;
		} catch (RuntimeException runtimeexception) {
	...
	boolean method1760(int i, String string, byte i_18_) {
		try {
			...
			if (((Class162) this).aClass437_1664 != null) {
				Class298 class298 = ((Class162) this).aClass437_1664.method5812((long) i);
				if (class298 != null) {
					if (class298 instanceof ObjectValue) {
						ObjectValue class298_sub29 = (ObjectValue) class298;
						if (class298_sub29.value instanceof String) {
							if (string.equals(class298_sub29.value))
								return false;
							class298_sub29.remove(-1460969981);
							class298_sub29.remove(-1460969981);
							((Class162) this).aClass437_1664.method5817(new ObjectValue(string), (7051297995265073167L * class298_sub29.aLong3188));
							return true;
						}
					}
				...
				((Class162) this).aClass437_1664 = new LinkedArrayList(4);
			((Class162) this).aClass437_1664.method5817(new ObjectValue(string), (long) i);
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	boolean method1761(int i, int i_19_, byte i_20_) {
		try {
			if (((Class162) this).aClass437_1664 != null) {
				Class298 class298 = ((Class162) this).aClass437_1664.method5812((long) i);
				if (class298 != null) {
					if (class298 instanceof IntegerValue) {
						IntegerValue class298_sub35 = (IntegerValue) class298;
						if (i_19_ == class298_sub35.intValue * -774922497)
							return false;
						class298_sub35.intValue = i_19_ * -898670337;
						return true;
					}
					class298.remove(-1460969981);
				}
				...
				((Class162) this).aClass437_1664 = new LinkedArrayList(4);
			((Class162) this).aClass437_1664.method5817(new IntegerValue(i_19_), (long) i);
			return true;
		} catch (RuntimeException runtimeexception) {
		...
		try {
			...
			if (((Class162) this).aClass437_1664 != null) {
				...
				if (class298 != null) {
					if (class298 instanceof IntegerValue) {
						IntegerValue class298_sub35 = (IntegerValue) class298;
						if (i_21_ == (class298_sub35.intValue * -774922497 & i_27_))
							return false;
						IntegerValue class298_sub35_28_ = class298_sub35;
						(class298_sub35_28_ = class298_sub35).intValue = (-774922497 * class298_sub35_28_.intValue & (i_27_ ^ 0xffffffff)) * -898670337;
						IntegerValue class298_sub35_29_ = class298_sub35;
						(class298_sub35_29_ = class298_sub35).intValue = (-898670337 * (-774922497 * class298_sub35_29_.intValue | i_21_));
						return true;
					}
					class298.remove(-1460969981);
				}
				...
				((Class162) this).aClass437_1664 = new LinkedArrayList(4);
			((Class162) this).aClass437_1664.method5817(new IntegerValue(i_21_), (long) i);
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	void method1764(RsByteBuffer class298_sub53, byte i) {
		try {
			...
			if (i_30_ >= 3) {
				...
				if (i_34_ > 0) {
					((Class162) this).aClass437_1664 = new LinkedArrayList(i_34_ < 16 ? Class416.method5590(i_34_, (byte) 16) : 16);
					while (i_34_-- > 0) {
						...
						if (0 == i_37_) {
							...
							((Class162) this).aClass437_1664.method5817(new IntegerValue(i_38_), (long) i_36_);
						} else if (i_37_ == 1) {
							...
							((Class162) this).aClass437_1664.method5817(new ObjectValue(string), (long) i_36_);
						}
					}
				}
			}
	...
	static final void processPlayers(int i) {
		try {
			...
			for (int i_53_ = 0; i_53_ < i_52_; i_53_++) {
				...
				if (null != class365_sub1_sub1_sub2_sub2)
					Class135.processEntity(class365_sub1_sub1_sub2_sub2, false, -1941477240);
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1772(ClientScript2 class403, int i) {
		try {
			...
			Class_na.method3479((StanceConfig.aClass298_Sub25_3757 == (((ClientScript2) class403).aClass298_Sub25_5237)), i_54_, (byte) 1);
		} catch (RuntimeException runtimeexception) {
