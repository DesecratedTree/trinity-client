...
public final class Class73 {
	...
	public void method814(int i, int i_0_, int i_1_) {
		try {
			if (null == ((Class73) this).aClass437_687)
				((Class73) this).aClass437_687 = new LinkedArrayList(-1623767683 * ((Class73) this).anInt688);
			IntegerValue class298_sub35 = ((IntegerValue) ((Class73) this).aClass437_687.method5812((long) i));
			if (null != class298_sub35)
				class298_sub35.intValue = -898670337 * i_0_;
			else {
				class298_sub35 = new IntegerValue(i_0_);
	...
	static final void method819(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_7_, (byte) 73);
	...
	static final void method820(ClientScript2 class403, byte i) {
		try {
			...
			AnimationConfig.method4887(class105, class119, class403, (byte) -38);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("cz.dd(").append(')').toString());
		}
	}

	static final void method821(WidgetConfig class105, Class119 class119, ClientScript2 class403, short i) {
		try {
			...
			if (-1 == -1309843523 * class105.anInt1154 && !class119.aBoolean1403)
				Class365_Sub1_Sub1_Sub5.method4490(-440872681 * class105.uid, -1349352488);
		} catch (RuntimeException runtimeexception) {
