...
public class Class492 {
	...
	public synchronized Class89 method6181(int i) {
		try {
			...
			if (class89 != null)
				return class89;
			class89 = Class89.getSprite((((Class491) ((Class492) this).aClass491_6082).aClass243_6077), 1338052859 * ((Class492) this).anInt6083, 0);
			if (class89 != null)
	...
	static final void method6182(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
		try {
			...
			for (int i_8_ = 0; i_8_ < class19s.length; i_8_++) {
				HintIcon class19 = class19s[i_8_];
				if (class19 != null) {
					if (class19.anInt266 * 958933333 != 2) {
						if (i_7_ != 996259282)
							break;
					} else {
						Class139.tileTo2DCoords((((HintIcon) class19).anInt259 * -458864019), -1338192389 * class19.x, 1018128075 * class19.y, (((HintIcon) class19).anInt262 * 143254950), -549885479);
	...
	static boolean hasPressed(Shortcut class355, int i) {
		try {
