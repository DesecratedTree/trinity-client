...
public class Class401 implements Interface21 {
	...
	public static Class464 method4937(ItemConfig class468, RsByteBuffer class298_sub53, byte i) {
		try {
			...
			if (bool) {
				...
				if (-1 != 34210967 * ((ItemConfig) class468).maleModel2 || -1 != -1284247975 * ((ItemConfig) class468).femaleModel2) {
				...
				if (((ItemConfig) class468).maleModel3 * 1313278521 != -1 || -1767718263 * ((ItemConfig) class468).femaleModel3 != -1) {
			...
			if (bool_5_) {
				...
				if (86274879 * ((ItemConfig) class468).maleHeadModel2 != -1 || ((ItemConfig) class468).femaleHeadModel2 * 1578724433 != -1) {
			...
			if (null != class298_sub37_sub15 && (Class436.aClass453_5480.aClass298_5643 != class298_sub37_sub15)) {
				...
				if (23 == i_34_) {
					if (1806357379 * client.playerRights > 0 && Class434.method5802(1267311211))
						JagexFile2.method6083((Class287.myPlayer.plane), i_32_ + -1760580017 * class341.gameSceneBaseX, i_33_ + class341.gameSceneBaseY * 283514611, 2043472934);
					else {
						Class277.sendWalkPacket(i_35_, StanceConfig.method4214(i_32_, i_33_, (short) 808));
						if (i_35_ == 0) {
						...
						Class82_Sub21.method938(i_32_, i_33_, true, StanceConfig.method4214(i_32_, i_33_, (short) 808), -1776617382);
				...
				if (i_34_ == 18)
					...
					class198 = OutcommingPacket.ITEM_GROUND_OPTION3;
				else if (21 == i_34_)
					class198 = OutcommingPacket.aClass198_2055;
				else if (22 == i_34_)
					class198 = OutcommingPacket.aClass198_2038;
				else if (1004 == i_34_)
					class198 = OutcommingPacket.ITEM_GROUND_EXAMINE;
				if (class198 != null) {
					if (class198 != OutcommingPacket.ITEM_GROUND_EXAMINE)
				...
				if (59 == i_34_) {
					...
					Class82_Sub21.method938(i_32_, i_33_, true, StanceConfig.method4214(i_32_, i_33_, (short) 808), -1460658515);
				}
				...
				if (class198_36_ != null) {
					Player player = client.players[i_35_];
					if (null != player) {
				...
				if (58 == i_34_) {
					WidgetConfig class105 = Class140.method1558(i_33_, i_32_, -156511736);
					if (class105 != null)
				...
				if (null != class198_37_) {
					ObjectValue class298_sub29 = ((ObjectValue) client.aClass437_8696.method5812((long) i_35_));
				...
				if (25 == i_34_) {
					...
					if (i_34_ == 60) {
						if (client.playerRights * 1806357379 > 0 && Class434.method5802(838408640))
							JagexFile2.method6083((Class287.myPlayer.plane), class341.gameSceneBaseX * -1760580017 + i_32_, 283514611 * class341.gameSceneBaseY + i_33_, 1886787992);
						else {
							client.anInt8784 = i * 143636043;
							client.anInt8785 = 381532777 * i_30_;
							client.anInt8748 = 277162405;
