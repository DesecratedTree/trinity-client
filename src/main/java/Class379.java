...
public class Class379 {
	...
	static final void method4672(ClientScript2 class403, byte i) {
		try {
	...
	public static void method4673(CacheIndex class243, int i) {
		try {
			...
			Class74.nameIcons = class243.getArchiveIdByName("name_icons", -946611786) * 1606490933;
	...
	static final void method4675(ClientScript2 class403, byte i) {
		try {
			Class390 class390 = (((ClientScript2) class403).aBoolean5261 ? ((ClientScript2) class403).aClass390_5247 : ((ClientScript2) class403).aClass390_5246);
			WidgetConfig class105 = ((Class390) class390).aClass105_4168;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = 2053897963 * class105.scrollHeight;
		} catch (RuntimeException runtimeexception) {
