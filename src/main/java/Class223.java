...
public class Class223 implements Interface24 {
	...
	static final void method2078(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_0_, (byte) -35);
	...
	static final void method2079(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_1_, (byte) 14);
	...
	static Class57 getSpriteFromImage(String path) {
		try {
			Class57 class57;
			for (;;) {
				try {
					InputStream inputstream = ClientScriptMap.anApplet6044.getClass().getClassLoader().getResourceAsStream(path);
				...
				/*	if (mediatracker.isErrorAny() || i_2_ < 0 || i_3_ < 0)
						throw new RuntimeException(i_2_+", "+i_3_);*/
					int[] is_4_ = new int[i_3_ * i_2_];
					PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, i_2_, i_3_, is_4_, 0, i_2_);
					pixelgrabber.grabPixels();
					class57 = FloorOverlay.graphics.method5031(is_4_, 0, i_2_, i_2_, i_3_, 708696378);
					break;
	...
	public static final void method2082(boolean lobby, int i) {
		try {
			if (!lobby) {
				...
				ConfigFile.aClass487_1463.method6161((byte) 115);
			...
			Shortcut.method4262(1675886592);
			Class513.method6293(-707841245);
			System.gc();
			System.runFinalization();
			CustomItems.settedNotes = false;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method2084(int i, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_) {
		try {
			for (GroundMessage class302_sub4 = ((GroundMessage) client.groundMessages.method5868(-16777216)); null != class302_sub4; class302_sub4 = (GroundMessage) client.groundMessages.method5872(1278684124)) {
				if (client.anInt8884 * 443738891 >= 591467947 * ((GroundMessage) class302_sub4).time)
					class302_sub4.method3714(1699061251);
				else {
					Class139.tileTo2DCoords((((GroundMessage) class302_sub4).level * 1759796085), 256 + ((((GroundMessage) class302_sub4).x * 1495033107) << 9), 256 + ((-1852462101 * ((GroundMessage) class302_sub4).y) << 9), 587842750 * ((GroundMessage) class302_sub4).height, -549885479);
					Class101.aClass264_1084.method2490(((GroundMessage) class302_sub4).message, (int) ((float) i + client.aFloatArray8891[0]), (int) (client.aFloatArray8891[1] + (float) i_6_), ~0xffffff | 1160845051 * ((GroundMessage) class302_sub4).color, 0, 8619684);
				}
			}
		} catch (RuntimeException runtimeexception) {
