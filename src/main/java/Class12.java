...
public class Class12 implements Interface8_Impl1_Impl2 {
	...
	public void b() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("am.b(").append(')').toString());
		}
	}
	...
	public int f() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("am.f(").append(')').toString());
		}
	}
	...
	public int a() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("am.a(").append(')').toString());
		}
	}
	...
	static void method332(GraphicsToolkit class_ra, int i, int i_1_, WidgetConfig class105, int i_2_) {
		try {
			int i_3_ = 63;
			int i_4_ = 7;
			for (int i_5_ = 63; i_5_ >= 0; i_5_--) {
				...
				class_ra.B(i, ((63 - i_5_) * (class105.anInt1162 * 457937409) >> 6) + i_1_, -2093041337 * class105.anInt1156, 1 + (class105.anInt1162 * 457937409 >> 6), i_7_, 0);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("am.a(").append(')').toString());
		}
	...
	static final void method333(ClientScript2 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("am.qz(").append(')').toString());
		}
	}
	...
	static final void method334(ClientScript2 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.FRIEND_CHAT_QUICK_CHAT_MESSAGE, class25.aClass449_330, (byte) 21);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(0);
			int i_8_ = (class298_sub36.aClass298_Sub53_Sub2_7396.index * 385051775);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(3);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(((ClientScript2) class403).aClass177_5243.anInt1787 * -2034569943, 16711935);
			((ClientScript2) class403).aClass177_5243.aClass298_Sub37_Sub14_1788.method3464(class298_sub36.aClass298_Sub53_Sub2_7396, ((ClientScript2) class403).aClass177_5243.anIntArray1789, 1205733536);
			class298_sub36.aClass298_Sub53_Sub2_7396.method3649((class298_sub36.aClass298_Sub53_Sub2_7396.index * 385051775) - i_8_, (byte) -42);
			class25.method390(class298_sub36, (byte) -84);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("am.adu(").append(')').toString());
		}
	}
	...
	static final void method335(ClientScript2 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("am.amr(").append(')').toString());
		}
	}

	static final void method336(ClientScript2 class403, int i) {
		try {
			Class302_Sub3.setMidPreferences((short) 31086);
			client.aClass283_8716.method2667(1321707085);
			Class3.savePreferences(656179282);
			client.sentPreferences = false;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("am.amb(").append(')').toString());
		}
	}

	static final void method337(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
			int i_9_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			
			if (-440872681 * class105.uid == (747 << 16 | 2) && WidgetConfig.setOrbSpecial()) 
				return;
			
			if (-440872681 * class105.uid == (548 << 16 | 76) || -440872681 * class105.uid == (746 << 16 | 66))  { //squeal
				if (i_9_ == 10247)
					i_9_ = 323;
			}
			...
			if (Settings.ENABLE_OSRS_GAMEFRAME && Class190.getDisplayMode((byte) -125) >= 2
					&& i_9_ == 8558
					&& class105.getComponentID() == 15) 
				i_9_ = 1024;
			...
			if (class105.anInt1154 * -1309843523 == -1 && !class119.aBoolean1403)
				Class325.method3966(-440872681 * class105.uid, 1038434674);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("am.da(").append(')').toString());
		}
	}
				...
				if (client.anInt8952 * -548972447 >= 100)
					...
					if (null != string_10_) {
						...
						if (Class173.method1824((Class287.myPlayer.aString10195), 675816100).equals(string_10_))
							...
							class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(Class58.method693(string, 1022662846) + 1);
							class298_sub36.aClass298_Sub53_Sub2_7396.writeString(string, 2142299789);
							class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(bool ? 1 : 0);
							class25.method390(class298_sub36, (byte) -1);
						}
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("am.mt(").append(')').toString());
		}
	}
	...
	static final void method339(ClientScript2 class403, int i) {
		try {
			...
			Class472.method6065(class105, class119, class403, -653692022);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("am.nz(").append(')').toString());
		}
	}

	static final void method340(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8835 ? 1 : 0;
			((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393 - 1)] = client.aString8754 == null ? "" : client.aString8754;
			((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393 - 1)] = client.aString8838 == null ? "" : client.aString8838;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("am.vt(").append(')').toString());
		}
	}
}
