...
public class Class422_Sub30 extends Preference {
	...
	public Class422_Sub30(Preferences class298_sub48) {
	...
	public Class422_Sub30(int i, Preferences class298_sub48) {
		super(class298_sub48);
	}

	static final void method5732(int i) {
		try {
			Iterator<?> iterator = client.groundGfxs.iterator();
