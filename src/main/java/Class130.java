...
public abstract class Class130 {
	...
	public Matrix aClass233_1494 = new Matrix();
	protected ModernToolkit aClass_ra_Sub3_1495;

	public abstract void method1448(Matrix class233);
	...
	public abstract void method1452(Matrix class233);

	public abstract void method1453(int i);

	public abstract void method1454(Matrix class233);

	public abstract void method1455(Matrix class233);

	public abstract void method1456(int i);

	public abstract void method1457(int i);

	public abstract void method1458(Matrix class233);

	Class130(ModernToolkit class_ra_sub3) {
