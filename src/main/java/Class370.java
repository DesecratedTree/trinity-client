...
public class Class370 {
	...
	public Class376 method4576(int i, int i_1_) {
		try {
			Class376 class376;
			synchronized (((Class370) this).aClass348_4029) {
				class376 = (Class376) ((Class370) this).aClass348_4029.get((long) i);
			}
			if (null != class376)
				return class376;
			byte[] is;
			synchronized (((Class370) this).aClass243_4030) {
				is = (((Class370) this).aClass243_4030.getFileFromArchive(ConfigFile.aClass120_1414.anInt1460 * -1006924897, i, (byte) -90));
			}
	...
	public Class370(Class411 class411, Class429 class429, CacheIndex class243) {
		((Class370) this).aClass243_4030 = class243;
		if (null != ((Class370) this).aClass243_4030)
			((Class370) this).aClass243_4030.method2316(-1006924897 * ConfigFile.aClass120_1414.anInt1460, -279300149);
	}
	...
	public static void method4578(int i, boolean bool, int i_2_) {
		try {
			WidgetDetails.method4584(i, Tradution.aClass470_5874.method6049(Class321.aClass429_3357, -875414210), bool, (byte) 31);
		} catch (RuntimeException runtimeexception) {
	...
	static void method4579(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, Class435 class435, byte i_8_) {
		try {
			...
			if (null == class298_sub1) {
				...
				Class298_Sub1.aClass453_7162.add(class298_sub1, 1693481470);
			}
