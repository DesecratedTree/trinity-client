...
public class Class11 {
	...
	public static boolean triedSoftware = false;
	public static boolean triedLegacyOpenGL = false;
	public static boolean triedModernOpenGL = false;
	public static boolean triedDX = false;
	...
	static final void method326(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_0_, (byte) -80);
	...
	static final void method330(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (null != WorldMap.currentArea ? -947282109 * WorldMap.currentArea.id : -1);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method331(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) ((Class247.aLong2748 * -536549149186981023L - Class122.method1319((byte) 1) - IntegerValue.aLong7395 * -7323824110069770829L) / 60000L);
