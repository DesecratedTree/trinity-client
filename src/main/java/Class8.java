...
public class Class8 {
		...
		try {
			if ((((Class298_Sub37_Sub15) class298_sub37_sub15).aString9669 == null) || ((Class298_Sub37_Sub15) class298_sub37_sub15).aString9669.length() == 0) {
				if (null != (((Class298_Sub37_Sub15) class298_sub37_sub15).aString9657) && ((Class298_Sub37_Sub15) class298_sub37_sub15).aString9657.length() > 0)
					return new StringBuilder().append(((Class298_Sub37_Sub15) class298_sub37_sub15).option).append(Tradution.aClass470_5916.method6049(Class321.aClass429_3357, -875414210)).append(((Class298_Sub37_Sub15) class298_sub37_sub15).aString9657).toString();
				return (((Class298_Sub37_Sub15) class298_sub37_sub15).option);
			}
			if ((null != ((Class298_Sub37_Sub15) class298_sub37_sub15).aString9657) && ((Class298_Sub37_Sub15) class298_sub37_sub15).aString9657.length() > 0)
				return new StringBuilder().append(((Class298_Sub37_Sub15) class298_sub37_sub15).option).append(Tradution.aClass470_5916.method6049(Class321.aClass429_3357, -875414210)).append(((Class298_Sub37_Sub15) class298_sub37_sub15).aString9657).append(Tradution.aClass470_5916.method6049(Class321.aClass429_3357, -875414210)).append(((Class298_Sub37_Sub15) class298_sub37_sub15).aString9669).toString();
			return new StringBuilder().append(((Class298_Sub37_Sub15) class298_sub37_sub15).option).append(Tradution.aClass470_5916.method6049(Class321.aClass429_3357, -875414210)).append(((Class298_Sub37_Sub15) class298_sub37_sub15).aString9669).toString();
	...
	public static void method319(int i) {
		try {
			WidgetConfig.aClass348_1135.method4187();
			WidgetConfig.aClass348_1138.method4187();
			WidgetConfig.aClass348_1136.method4187();
			WidgetConfig.aClass348_1296.method4187();
		} catch (RuntimeException runtimeexception) {
		...
		try {
			if (Class378.method4671(i, keys, -1347754722)) {
				...
				for (int i_2_ = 0; i_2_ < class105s.length; i_2_++) {
					WidgetConfig class105 = class105s[i_2_];
