...
public class Class346 {
	...
	static final void method4170(ClientScript2 class403, short i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub16_7557.method5686(-550588042) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw method4175(runtimeexception, new StringBuilder().append("ol.anh(").append(')').toString());
		}
	}

	static void method4171(int i, int i_0_, WidgetConfig class105, Class_ta class_ta, int i_1_, int i_2_, int i_3_) {
		try {
			int i_4_ = Class10.anInt129 * 1168366243;
			int[] is = Class10.anIntArray135;
			for (int i_5_ = 0; i_5_ < i_4_; i_5_++) {
				Player class365_sub1_sub1_sub2_sub2 = client.players[is[i_5_]];
				if (null != class365_sub1_sub1_sub2_sub2 && class365_sub1_sub1_sub2_sub2.method4477(526198823) && !class365_sub1_sub1_sub2_sub2.hidden && (class365_sub1_sub1_sub2_sub2 != Class287.myPlayer) && (class365_sub1_sub1_sub2_sub2.plane == (Class287.myPlayer.plane))) {
					...
					int i_7_ = (int) class217.y / 128 - i_0_ / 128;
					boolean bool = false;
					...
					if (class365_sub1_sub1_sub2_sub2.aBoolean10203)
						FloorUnderlay.method5883(class105, class_ta, i_1_, i_2_, i_6_, i_7_, SubIncommingPacket.aClass57Array2349[6], (byte) 52);
					else if (bool_11_)
						FloorUnderlay.method5883(class105, class_ta, i_1_, i_2_, i_6_, i_7_, SubIncommingPacket.aClass57Array2349[4], (byte) -19);
					else if (class365_sub1_sub1_sub2_sub2.aBoolean10222)
						FloorUnderlay.method5883(class105, class_ta, i_1_, i_2_, i_6_, i_7_, SubIncommingPacket.aClass57Array2349[7], (byte) -81);
					else if (bool)
						FloorUnderlay.method5883(class105, class_ta, i_1_, i_2_, i_6_, i_7_, SubIncommingPacket.aClass57Array2349[3], (byte) 25);
					else if (bool_9_)
						FloorUnderlay.method5883(class105, class_ta, i_1_, i_2_, i_6_, i_7_, SubIncommingPacket.aClass57Array2349[5], (byte) -50);
					else
						FloorUnderlay.method5883(class105, class_ta, i_1_, i_2_, i_6_, i_7_, SubIncommingPacket.aClass57Array2349[2], (byte) -40);
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	public static void method4172(String string, boolean bool, boolean bool_12_, 
			boolean bool_13_, boolean bool_14_, byte i) {
		try {
			Class273.method2559(string, bool, bool_12_, "openjs", bool_13_,
					bool_14_, -1892115895);
		} catch (RuntimeException runtimeexception) {
	...
	public static void method4173(GraphicsToolkit class_ra, CacheIndex class243, int i) {
		try {
			Class89[] class89s = Class89.getSprites(class243, Class74.anInt692 * -1217066055, 0);
			Class160.defaultHPBar = new Class57[class89s.length];
			for (int i_15_ = 0; i_15_ < class89s.length; i_15_++)
				Class160.defaultHPBar[i_15_] = class_ra.method5125(class89s[i_15_], true);
			class89s = Class89.getSprites(class243, -355151363 * Class74.anInt694, 0);
			...
			class89s = Class89.getSprites(class243, 1838189665 * Class143.anInt1558, 0);
			...
			class89s = Class89.getSprites(class243, Class400.anInt5223 * 1862609057, 0);
			Preference.aClass57Array5351 = new Class57[class89s.length];
			for (int i_18_ = 0; i_18_ < class89s.length; i_18_++)
				Preference.aClass57Array5351[i_18_] = class_ra.method5125(class89s[i_18_], true);
			class89s = Class89.getSprites(class243, -81301735 * Class74.anInt693, 0);
			...
			class89s = Class89.getSprites(class243, Class74.anInt696 * -2088314757, 0);
			...
			class89s = Class89.getSprites(class243, Class298_Sub36.anInt7398 * -1199789537, 0);
			...
			class89s = Class89.getSprites(class243, Class82_Sub6.anInt6842 * -2107184677, 0);
			...
			class89s = Class89.getSprites(class243, Class494.anInt6092 * -1624054445, 0);
			...
			class89s = Class89.getSprites(class243, Class74.nameIcons * 1200791325, 0);
			Class130_Sub2.aClass57Array6959 = new Class57[class89s.length];
			i_21_ = 12;
			System.out.println(class89s.length);
			...
			Class144.aClass57_1562 = class_ra.method5125(Class89.getSprite(class243, (Class237.anInt6667 * 1359711467), 0), true);
			RSGraphics.aClass57_573 = class_ra.method5125(Class89.getSprite(class243, ((Class128_Sub1.anInt8557) * -1848350339), 0), true);
			class89s = Class89.getSprites(class243, Class298_Sub24_Sub1.anInt9281 * -328242359, 0);
	...
	public static RuntimeException_Sub2 method4175(Throwable throwable, String string) {
		try {
			...
			runtimeexception_sub2.printStackTrace();
