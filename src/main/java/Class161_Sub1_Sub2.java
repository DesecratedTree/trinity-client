...
public class Class161_Sub1_Sub2 extends Class161_Sub1 {
	...
	public SceneObjectPosition aClass217_9139;
	public Matrix aClass233_9140 = new Matrix();
	Class298_Sub31_Sub1 aClass298_Sub31_Sub1_9141;
	public Matrix aClass233_9142 = new Matrix();
	Class298_Sub31_Sub1 aClass298_Sub31_Sub1_9143;
	public SceneObjectPosition aClass217_9144 = new SceneObjectPosition();
	...
	public SceneObjectPosition aClass217_9149;
	...
	void method1741(Matrix class233) {
		Matrix class233_0_ = new Matrix();
	...
	void method1727(Matrix class233) {
		try {
			Matrix class233_2_ = new Matrix();
	...
	void method1744(Matrix class233) {
		Matrix class233_8_ = new Matrix();
	...
	void method1745(Matrix class233) {
		Matrix class233_9_ = new Matrix();
	...
	public Class161_Sub1_Sub2(ModernToolkit class_ra_sub3, Class159 class159, boolean bool) throws Exception_Sub2 {
		super(class_ra_sub3);
		...
		aClass217_9149 = new SceneObjectPosition();
		aClass232_9157 = new Class232();
		aClass217_9139 = new SceneObjectPosition();
	...
	public void method1748(int i) {
		try {
			...
			aClass123_7033.method1366((((Class161_Sub1_Sub2) this).aClass298_Sub31_Sub1_9143), aClass217_9144.x, aClass217_9144.aFloat2455, aClass217_9144.y, (float) (i_12_ * aClass_ra_Sub3_1648.anInt8342 % 40000) / 40000.0F, 2032048310);
