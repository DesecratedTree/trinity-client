...
public class CacheIndexIndicator {
	...
	public static CacheIndexIndicator CONFIG;
	...
	public static CacheIndexIndicator MUSIC;
	public static CacheIndexIndicator aClass111_1336;
	public static CacheIndexIndicator CUTSCENES;
	public static CacheIndexIndicator TEXTURES;
	public static CacheIndexIndicator SKELETONS = new CacheIndexIndicator(0);
	public static CacheIndexIndicator MIDI;
	public static CacheIndexIndicator SKINS = new CacheIndexIndicator(1);
	public static CacheIndexIndicator FONTS;
	public static CacheIndexIndicator MUSIC_EFFECT;
	public static CacheIndexIndicator aClass111_1344;
	public static CacheIndexIndicator BILLBOARDS;
	...
	public static CacheIndexIndicator SHADERS;
	...
	public static CacheIndexIndicator DETAILS;
	public static CacheIndexIndicator NATIVE_LIBS;
	public static CacheIndexIndicator aClass111_1359;
	public static CacheIndexIndicator aClass111_1360;
	public static CacheIndexIndicator LOADING_IMAGES;
	public static CacheIndexIndicator GAME_TIPS;
	public static CacheIndexIndicator LOADING_SPRITES;
	...
	static {
		...
		DETAILS = new CacheIndexIndicator(28);
		BILLBOARDS = new CacheIndexIndicator(29);
		NATIVE_LIBS = new CacheIndexIndicator(30);
		SHADERS = new CacheIndexIndicator(31);
		LOADING_IMAGES = new CacheIndexIndicator(32);
		GAME_TIPS = new CacheIndexIndicator(33);
		LOADING_SPRITES = new CacheIndexIndicator(34);
		CUTSCENES = new CacheIndexIndicator(35);
	...
	static final void method1235(WidgetConfig class105, ClientScript2 class403, byte i) {
		try {
			...
			int i_4_ = class505.method6261(class105.text, class105.anInt1156 * -2093041337, class105.lineHeight * 418216501, i_3_, i_2_, Class130_Sub2.aClass57Array6959, (byte) -62);
	...
	static final void method1237(ClientScript2 class403, int i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub13_7549, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]), -800925761);
