...
public class Class44 {
	...
	byte[] aByteArray471;
	OpenGLLegacyToolkit aClass_ra_Sub2_472;
	int anInt473;
	int anInt474;
	...
	void method490(int i, int i_1_, int i_2_, boolean[][] bools, boolean bool) {
		...
		float f = 1.0F / (float) (((OpenGLLegacyToolkit) ((Class44) this).aClass_ra_Sub2_472).anInt8063 * 128);
		if (bool) {
			...
			for (int i_11_ = 0; i_11_ < ((Class44) this).anInt473; i_11_++) {
				...
				for (int i_14_ = 0; i_14_ < ((Class44) this).anInt468; i_14_++) {
					...
					RsFloatBuffer class298_sub53_sub1 = (((OpenGLLegacyToolkit) ((Class44) this).aClass_ra_Sub2_472).aClass298_Sub53_Sub1_8197);
						...
						if (i_18_ - i_1_ >= -i_2_ && i_18_ - i_1_ <= i_2_) {
							...
							for (int i_20_ = i_16_; i_20_ < i_17_; i_20_++) {
								if (i_20_ - i >= -i_2_ && i_20_ - i <= i_2_ && (bools[i_20_ - i + i_2_][i_18_ - i_1_ + i_2_])) {
									...
									if (is != null) {
										if (((OpenGLLegacyToolkit) (((Class44) this).aClass_ra_Sub2_472)).aBoolean8143) {
	...
	Class44(OpenGLLegacyToolkit class_ra_sub2, Class_xa_Sub3 class_xa_sub3) {
		((Class44) this).aClass_ra_Sub2_472 = class_ra_sub2;
		((Class44) this).aClass_xa_Sub3_470 = class_xa_sub3;
		((Class44) this).anInt469 = 2 + ((((Class44) this).aClass_xa_Sub3_470.anInt6287 * -506105871 * (((Class44) this).aClass_xa_Sub3_470.anInt6288 * -1212653763)) >> (((OpenGLLegacyToolkit) ((Class44) this).aClass_ra_Sub2_472).anInt8064));
		((Class44) this).anInt467 = 2 + ((((Class44) this).aClass_xa_Sub3_470.anInt6286 * -1148794921 * (((Class44) this).aClass_xa_Sub3_470.anInt6288 * -1212653763)) >> (((OpenGLLegacyToolkit) ((Class44) this).aClass_ra_Sub2_472).anInt8064));
		((Class44) this).aByteArray471 = new byte[((Class44) this).anInt469 * ((Class44) this).anInt467];
		((Class44) this).anInt474 = (7 + (((OpenGLLegacyToolkit) ((Class44) this).aClass_ra_Sub2_472).anInt8064) - ((Class44) this).aClass_xa_Sub3_470.anInt6289 * -2137349879);
