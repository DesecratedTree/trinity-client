...
public final class Class138_Sub1 extends Class138 {
	...
	public Class138_Sub1(ModernToolkit class_ra_sub3) throws Exception_Sub2 {
		super(class_ra_sub3);
	...
	static final void method1541(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub28_7573.method5612(i_11_, 1352882135);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1542(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_12_, (byte) -15);
