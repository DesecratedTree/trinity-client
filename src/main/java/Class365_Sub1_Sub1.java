...
public abstract class Class365_Sub1_Sub1 extends Class365_Sub1 {
	...
	Class365_Sub1_Sub1(Class331 class331, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, boolean bool, byte i_8_) {
		...
		plane = (byte) i;
		aByte7724 = (byte) i_0_;
		setPosition(new SceneObjectPosition((float) i_1_, (float) i_2_, (float) i_3_));
		...
		try {
			for (int i_24_ = aShort9798; i_24_ <= aShort9796; i_24_++) {
				for (int i_25_ = aShort9795; i_25_ <= aShort9797; i_25_++) {
					int i_26_ = (((Class331) aClass331_7722).renderDistance * 583010427 + (i_24_ - (((Class331) aClass331_7722).anInt3553 * -804213305)));
					if (i_26_ >= 0) {
						if (i_26_ >= (((Class331) aClass331_7722).aBooleanArrayArray3563).length) {
							...
							int i_27_ = (i_25_ - (465603579 * ((Class331) aClass331_7722).anInt3513) + (((Class331) aClass331_7722).renderDistance * 583010427));
							if (i_27_ >= 0) {
	...
	boolean method4395() {
		for (int i = aShort9798; i <= aShort9796; i++) {
			for (int i_42_ = aShort9795; i_42_ <= aShort9797; i_42_++) {
				int i_43_ = (((Class331) aClass331_7722).renderDistance * 583010427 + (i - (((Class331) aClass331_7722).anInt3553 * -804213305)));
				if (i_43_ >= 0 && i_43_ < (((Class331) aClass331_7722).aBooleanArrayArray3563).length) {
					int i_44_ = (i_42_ - 465603579 * ((Class331) aClass331_7722).anInt3513 + (((Class331) aClass331_7722).renderDistance * 583010427));
	...
	boolean method4396() {
		for (int i = aShort9798; i <= aShort9796; i++) {
			for (int i_45_ = aShort9795; i_45_ <= aShort9797; i_45_++) {
				int i_46_ = (((Class331) aClass331_7722).renderDistance * 583010427 + (i - (((Class331) aClass331_7722).anInt3553 * -804213305)));
				if (i_46_ >= 0 && i_46_ < (((Class331) aClass331_7722).aBooleanArrayArray3563).length) {
					int i_47_ = (i_45_ - 465603579 * ((Class331) aClass331_7722).anInt3513 + (((Class331) aClass331_7722).renderDistance * 583010427));
	...
	boolean method4397() {
		for (int i = aShort9798; i <= aShort9796; i++) {
			for (int i_48_ = aShort9795; i_48_ <= aShort9797; i_48_++) {
				int i_49_ = (((Class331) aClass331_7722).renderDistance * 583010427 + (i - (((Class331) aClass331_7722).anInt3553 * -804213305)));
				if (i_49_ >= 0 && i_49_ < (((Class331) aClass331_7722).aBooleanArrayArray3563).length) {
					int i_50_ = (i_48_ - 465603579 * ((Class331) aClass331_7722).anInt3513 + (((Class331) aClass331_7722).renderDistance * 583010427));
