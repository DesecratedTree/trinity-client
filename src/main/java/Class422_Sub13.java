...
public class Class422_Sub13 extends Preference {
	public static int anInt8396 = 0;
	static int anInt8397 = 2;

	public Class422_Sub13(int i, Preferences class298_sub48) {
		super(i, class298_sub48);
	}

	public void method5673(byte i) {
		try {
			if (aClass298_Sub48_5346.graphicsMode.method5679(16711680) && !Class261.method2465(aClass298_Sub48_5346.graphicsMode.method5677(-1298559578), 1142209695))
				anInt5350 = 0;
	...
	public Class422_Sub13(Preferences class298_sub48) {
		super(class298_sub48);
	}

	public boolean method5674(int i) {
		try {
			if (!Class261.method2465(aClass298_Sub48_5346.graphicsMode.method5677(-541516290), 718607573))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	public int method5616(int i) {
		if (!Class261.method2465(aClass298_Sub48_5346.graphicsMode.method5677(-2048845946), -31427967))
			return 3;
		return 1;
	}
	...
	public int method5612(int i, int i_1_) {
		try {
			if (!Class261.method2465(aClass298_Sub48_5346.graphicsMode.method5677(-1771476690), -1583872086))
				return 3;
			return 1;
		} catch (RuntimeException runtimeexception) {
