...
public class Class82_Sub6 extends Class82 {
	...
	public void method866(int i) {
		try {
			...
			if (0 == 237701933 * ((Class82_Sub6) this).anInt6838)
				...
				ClientScriptEnum.method3428(class365_sub1_sub1_sub2, (new int[] { ((Class82_Sub6) this).anInt6839 * 2090514815 }), new int[] { 0 }, new int[] { ((Class82_Sub6) this).anInt6838 * 237701933 }, 1644064563);
	...
	boolean method870(int i) {
		try {
			AnimationConfig class391 = Class501.aClass395_6122.method4903((2090514815 * (((Class82_Sub6) this).anInt6839)), (byte) 111);
	...
	boolean method884() {
		AnimationConfig class391 = Class501.aClass395_6122.method4903(2090514815 * ((Class82_Sub6) this).anInt6839, (byte) 25);
	...
	public static Class298_Sub36 method885(int i) {
		try {
			Class298_Sub36 class298_sub36 = ClientScriptEnums.method6220((byte) -12);
