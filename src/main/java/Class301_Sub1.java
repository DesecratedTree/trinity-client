...
public class Class301_Sub1 extends WorldMap {
	...
	public static LinkedArrayList aClass437_7636;
	public static LinkedArrayList aClass437_7637;
	...
	static {
		...
		aBoolean7635 = false;
		aClass437_7636 = new LinkedArrayList(8);
		aClass437_7637 = new LinkedArrayList(8);
		aClass446_7634 = new Class446(new Class453());
	}

	static final void method3712(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
			...
			Tradution.method6054(class105, 648135865);
			if (class105.anInt1154 * -1309843523 == -1 && !class119.aBoolean1403)
				Preference.method5623(class105.uid * -440872681, 1575385059);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("acu.dr(").append(')').toString());
		}
	}
	...
	public static void method3713(int i, int i_0_, int i_1_, String string, int i_2_) {
		try {
			...
			WidgetConfig class105 = Class140.method1558(i_0_, i_1_, -156511736);
			if (class105 != null) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("acu.kp(").append(')').toString());
		}
	}
}
