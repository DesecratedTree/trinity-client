...
public final class Class439 {
	...
	int anInt5574;
	public static CacheIndex MUSIC_EFFECT_INDEX;
	...
	public static final void method5850(String string, int i) {
		try {
			if (null != string) {
				if ((-1054937867 * client.anInt8941 >= 500 && !client.aBoolean8807) || -1054937867 * client.anInt8941 >= 500)
	...
	public static void method5851(int i, int i_7_) {
		try {
			if (i != client.anInt8752 * -1233866115) {
				...
				if (19 == i)
					Class501.method6227((8 == -1233866115 * client.anInt8752 || -1233866115 * client.anInt8752 == 2 || (747461259 * (LinkedArrayList.WIDGET_DETAILS.loginWidgetID) != (client.WINDOW_PANE_ID * -257444687))), -1608675861);
				if (i == 14)
					IcmpService_Sub1.method6382((client.WINDOW_PANE_ID * -257444687 != (LinkedArrayList.WIDGET_DETAILS.lobbyWidgetID) * 1349088077), -687019075);
				if (i == 4 || 6 == i)
				...
				if (bool != bool_8_) {
					if (bool) {
						Class300.musicID = Class300.LOGIN_MUSIC * 1701432991;
						if (Class422_Sub25.preferences.aClass422_Sub29_7587.method5726(-2145576299) != 0) {
							Class431.method5767(2, Class374_Sub1.MUSIC, 782166935 * Class300.LOGIN_MUSIC, 0, Class422_Sub25.preferences.aClass422_Sub29_7587.method5726(-2142499578), false, 1118626209);
				...
				if (Class358.method4287(i, 299941911) || i == 5 || 13 == i) 
					FloorOverlay.graphics.method5176();
				client.anInt8752 = -705702187 * i; //mem leak from here
			}
		} catch (RuntimeException runtimeexception) {
