...
public class StanceConfig {
	...
	public int standAnimation = 512849763;
	...
	void method4206(RsByteBuffer class298_sub53, int i, int i_0_) {
		try {
			if (1 == i) {
				standAnimation = class298_sub53.readBigSmart(1235052657) * -512849763;
				walkAnimation = class298_sub53.readBigSmart(1235052657) * -1216995793;
			} else if (2 == i)
				...
				runAnimation = class298_sub53.readBigSmart(1235052657) * -1261244237;
			else if (i == 7)
				...
				if (anIntArrayArray3710 == null)
					anIntArrayArray3710 = (new int[(((Class349) ((StanceConfig) this).loader).aClass405_3707.anIntArray5267).length][]);
				...
				hitbarSpriteID = class298_sub53.readBigSmart(1235052657) * 697230329;
			else if (44 == i)
				...
				for (int i_6_ = 0; i_6_ < i_5_; i_6_++) {
					...
					((StanceConfig) this).anInt3714 += i_7_ * 81529747;
				}
			} else if (i == 53)
				aBoolean3756 = false;
			else if (i == 54) {
				...
				if (anIntArray3742 == null)
					anIntArray3742 = (new int[(((Class349) ((StanceConfig) this).loader).aClass405_3707.anIntArray5267).length]);
				int i_8_ = class298_sub53.readUnsignedByte();
				anIntArray3742[i_8_] = class298_sub53.readUnsignedShort();
			} else if (i == 56) {
				if (null == anIntArrayArray3753)
					anIntArrayArray3753 = (new int[(((Class349) ((StanceConfig) this).loader).aClass405_3707.anIntArray5267).length][]);
	...
	public Class222[] method4207(byte i) {
		try {
			if (((StanceConfig) this).aClass222Array3718 != null)
				return ((StanceConfig) this).aClass222Array3718;
			if (null == anIntArrayArray3710)
				return null;
			((StanceConfig) this).aClass222Array3718 = new Class222[anIntArrayArray3710.length];
			for (int i_11_ = 0; i_11_ < anIntArrayArray3710.length; i_11_++) {
				...
				if (i_12_ == 0 && 0 == i_13_ && 0 == i_14_ && 0 == i_15_ && 0 == i_16_ && i_17_ == 0) {
					...
					Class222 class222 = (((StanceConfig) this).aClass222Array3718[i_11_] = new Class222());
					if (0 != i_17_)
	...
	StanceConfig() {
		walkAnimation = 1216995793;
		anInt3741 = -564296781;
		anInt3719 = 1440097851;
		anInt3723 = -1270333873;
		runAnimation = 1261244237;
		...
		hitbarSpriteID = -697230329;
		anInt3754 = 853635893;
		anInt3716 = 928434405;
		aBoolean3756 = true;
	}

	public int getStandAnimation(int i) {
		try {
			if (standAnimation * -809747019 != -1)
				return standAnimation * -809747019;
			if (null != anIntArray3712) {
				int i_18_ = (int) (Math.random() * (double) (-5125477 * ((StanceConfig) this).anInt3714));
				int i_19_;
	...
	public int[] method4210(int i) {
		try {
			LinkedArrayList class437 = new LinkedArrayList(16);
			Class316.method3844(-809747019 * standAnimation, class437, -518506092);
			if (null != anIntArray3712) {
			...
			Class316.method3844(-129111857 * walkAnimation, class437, -1080833419);
			...
			Class316.method3844(230243963 * runAnimation, class437, -1811756409);
	...
	static final void method4216(ClientScript2 class403, int i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub23_7576, 0, -1906997591);
	...
	static final void method4217(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub2_7547.method5612(i_32_, 1352882135);
		} catch (RuntimeException runtimeexception) {
	...
	static void method4218(int i) {
		try {
			...
			if (0 != 1170859143 * client.wheelScroll) {
				Class8.anInt103 -= client.wheelScroll * 1787831191;
			...
			for (int i_35_ = 0; i_35_ < 1351936279 * client.anInt8894; i_35_++) {
				...
				if (i_36_ == 80)
					...
					Class8.anInt99 = Class8.aString101.length() * 1914783065;
				} else if (ObjectConfig.method5788(c, (short) 160) || "\\/.:, _-+[]~@".indexOf(c) != -1) {
