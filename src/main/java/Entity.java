...
public abstract class Entity extends Class365_Sub1_Sub1 {
	...
	public RSGraphics[] currentGraphics;
	public Class438 aClass438_10077;
	public Class438 aClass438_10078;
	public int[] hitmarkDamage;
	public int[] hitmarkCycle;
	public int[] hitHP;
	...
	public void method4414(int i, byte i_8_) {
		try {
			StanceConfig class350 = getStanceConfig(654212117);
	...
	public void method4415(int i, boolean bool, int i_10_) {
		try {
			StanceConfig class350 = getStanceConfig(-124866780);
	...
	public boolean method4417(int i, int i_11_, byte i_12_) {
		try {
			...
			StanceConfig class350 = getStanceConfig(-401641714);
			int i_14_ = 256;
	...
	public final void sendGraphics(int graphicId, int positioning, int rotation, int i_23_, boolean bool, int graphicIndex, int i_25_) {
		try {
			RSGraphics graphics = currentGraphics[graphicIndex];
			int i_26_ = -967533709 * graphics.id;
			if (graphicId != -1 && i_26_ != -1) {
				if (i_26_ == graphicId) {
					GraphicsConfig class398 = Class158_Sub1.aClass389_8568.method4857(graphicId, -1791372939);
					if (class398.aBoolean5215 && 1505778629 * class398.animation != -1) {
						AnimationConfig class391 = (Class501.aClass395_6122.method4903(class398.animation * 1505778629, (byte) -43));
					...
					GraphicsConfig class398 = Class158_Sub1.aClass389_8568.method4857(graphicId, -1699460112);
					GraphicsConfig class398_28_ = Class158_Sub1.aClass389_8568.method4857(i_26_, -1865033182);
					if (1505778629 * class398.animation != -1 && 1505778629 * class398_28_.animation != -1) {
						AnimationConfig class391 = (Class501.aClass395_6122.method4903(1505778629 * class398.animation, (byte) 50));
						AnimationConfig class391_29_ = (Class501.aClass395_6122.method4903(1505778629 * class398_28_.animation, (byte) -13));
			...
			graphics.aClass438_569.method5824((-1 != graphicId ? ((Class158_Sub1.aClass389_8568.method4857(graphicId, -2144045629).animation) * 1505778629) : -1), positioning & 0xffff, i_30_, false, (byte) 0);
		} catch (RuntimeException runtimeexception) {
	...
	public final void method4420(int i, int damage, int i_32_, int soakingDamage, int cycle, int i_35_, int i_36_, byte i_37_) {
		try {
			
			
			if (Settings.ENABLE_X1_HITS && damage > 0)
				damage = damage < 10 ? 1 : (int) Math.floor((double)damage/10d);
			if (Settings.ENABLE_X1_HITS && soakingDamage > 0)
				soakingDamage = soakingDamage < 10 ? 1 : (int) Math.floor((double)soakingDamage/10d);
			boolean bool = true;
			boolean bool_38_ = true;
			for (int i_39_ = 0; i_39_ < (Settings.ENABLE_OSRS_HITS ? 4 : (LinkedArrayList.WIDGET_DETAILS.maxHitmarkCount * -942466371)); i_39_++) {
				if (hitmarkCycle[i_39_] > cycle)
					bool = false;
				else
					bool_38_ = false;
			}
			...
			int lowestHitIndexIndex = -1;
			int i_41_ = -1;
			int i_42_ = 0;
			if (i >= 0) {
				Class358 class358 = ClientScriptEnums.aClass347_6117.method4176(i, -1682094753);
				i_41_ = class358.anInt3863 * 100473069;
				i_42_ = -169339039 * class358.anInt3854;
				//System.out.println(i_41_+", "+i_42_);
			...
			if (bool_38_) {
				if (i_41_ == -1)
					return;
				lowestHitIndexIndex = 0;
				int lowestHit = 0;
				if (i_41_ == 0)
					lowestHit = hitmarkCycle[0];
				else if (i_41_ == 1)
					lowestHit = hitmarkDamage[0];
				for (int i_44_ = 1; i_44_ < (Settings.ENABLE_OSRS_HITS ? 4 : (-942466371 * LinkedArrayList.WIDGET_DETAILS.maxHitmarkCount)); i_44_++) {
					if (i_41_ == 0) {
						if (hitmarkCycle[i_44_] < lowestHit) {
							lowestHitIndexIndex = i_44_;
							lowestHit = hitmarkCycle[i_44_];
						}
					} else if (1 == i_41_ && hitmarkDamage[i_44_] < lowestHit) {
						lowestHitIndexIndex = i_44_;
						lowestHit = hitmarkDamage[i_44_];
					}
				}
				if (i_41_ == 1 && lowestHit >= damage)
					return;
			} else {
				if (bool)
					((Entity) this).aByte10133 = (byte) 0;
				for (int i_45_ = 0; i_45_ < (Settings.ENABLE_OSRS_HITS ? 4 : (LinkedArrayList.WIDGET_DETAILS.maxHitmarkCount * -942466371)); i_45_++) {
					int i_46_ = ((Entity) this).aByte10133;
					((Entity) this).aByte10133 = (byte) ((((Entity) this).aByte10133 + 1) % (Settings.ENABLE_OSRS_HITS ? 4 : (-942466371 * LinkedArrayList.WIDGET_DETAILS.maxHitmarkCount)));
					if (hitmarkCycle[i_46_] <= cycle) {
						lowestHitIndexIndex = i_46_;
						break;
					}
				}
			}
			if (lowestHitIndexIndex >= 0) {
				hitmarkType[lowestHitIndexIndex] = i;
				hitmarkDamage[lowestHitIndexIndex] = damage;
				anIntArray10127[lowestHitIndexIndex] = i_32_;
				anIntArray10083[lowestHitIndexIndex] = soakingDamage;
				hitmarkCycle[lowestHitIndexIndex] = i_35_ + (cycle + i_42_);
				hitHP[lowestHitIndexIndex] = i_36_;
			}
		} catch (RuntimeException runtimeexception) {
	...
	public int method4363(byte i) {
		try {
			StanceConfig class350 = getStanceConfig(219719478);
			int i_47_;
			...
			int i_48_ = (int) class235.aClass217_2599.x >> 9;
			int i_49_ = (int) class235.aClass217_2599.y >> 9;
	...
	public void method4404(int i) {
		try {
			...
			aShort9795 = (short) ((int) class217.y - i_51_ >> 9);
			aShort9796 = (short) ((int) class217.x + i_51_ >> 9);
			aShort9797 = (short) ((int) class217.y + i_51_ >> 9);
		} catch (RuntimeException runtimeexception) {
	...
	void method4424(GraphicsToolkit class_ra, StanceConfig class350, int i, int i_55_, int i_56_, int i_57_, int i_58_) {
		try {
			for (int i_59_ = 0; i_59_ < currentGraphics.length; i_59_++) {
				...
				if (0 == i_59_)
					...
					i_60_ = (byte) 7;
				RSGraphics class56 = currentGraphics[i_59_];
				if (-1 != class56.id * -967533709 && !class56.aClass438_569.method5826(-65534)) {
					GraphicsConfig class398 = (Class158_Sub1.aClass389_8568.method4857(class56.id * -967533709, -2040253952));
	...
	void method4425(int i, int i_70_, int i_71_, int i_72_, int i_73_, int i_74_) {
		try {
			...
			int i_83_ = Class70.method807(i_81_ + (int) class217.x, (int) class217.y + i_82_, i_75_, i_76_, plane, (byte) 13);
			int i_84_ = i_70_ / 2;
			int i_85_ = -i_71_ / 2;
			int i_86_ = i_84_ * i_78_ + i_77_ * i_85_ >> 14;
			int i_87_ = i_85_ * i_78_ - i_84_ * i_77_ >> 14;
			int i_88_ = Class70.method807(i_86_ + (int) class217.x, (int) class217.y + i_87_, i_75_, i_76_, plane, (byte) -9);
			int i_89_ = -i_70_ / 2;
			int i_90_ = i_71_ / 2;
			int i_91_ = i_89_ * i_78_ + i_90_ * i_77_ >> 14;
			int i_92_ = i_78_ * i_90_ - i_77_ * i_89_ >> 14;
			int i_93_ = Class70.method807((int) class217.x + i_91_, i_92_ + (int) class217.y, i_75_, i_76_, plane, (byte) 105);
			int i_94_ = i_70_ / 2;
			int i_95_ = i_71_ / 2;
			int i_96_ = i_78_ * i_94_ + i_77_ * i_95_ >> 14;
			int i_97_ = i_95_ * i_78_ - i_77_ * i_94_ >> 14;
			int i_98_ = Class70.method807(i_96_ + (int) class217.x, i_97_ + (int) class217.y, i_75_, i_76_, plane, (byte) 97);
	...
	public StanceConfig getStanceConfig(int i) {
		try {
			int i_105_ = getStanceID(-40678538);
			if (-1 == i_105_) {
	...
	abstract int getStanceID(int i);
	...
	boolean method4433(int i, int i_110_) {
		try {
			...
			RSGraphics.method611(aClass119_10131.components, -1178956884);
			return true;
		} catch (RuntimeException runtimeexception) {
	...
	public void method4434() {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		aShort9798 = (short) ((int) class217.x - i >> 9);
		aShort9795 = (short) ((int) class217.y - i >> 9);
		aShort9796 = (short) ((int) class217.x + i >> 9);
		aShort9797 = (short) ((int) class217.y + i >> 9);
	}
	...
	public int method4435() {
		StanceConfig class350 = getStanceConfig(1643711288);
		int i;
		if (1638157075 * class350.anInt3716 != -1)
		...
		Class235 class235 = method4337();
		int i_111_ = (int) class235.aClass217_2599.x >> 9;
		int i_112_ = (int) class235.aClass217_2599.y >> 9;
	...
	public int method4436() {
		StanceConfig class350 = getStanceConfig(1920081667);
		int i;
		if (1638157075 * class350.anInt3716 != -1)
			i = class350.anInt3716 * 1638157075;
		else if (-32768 == ((Entity) this).anInt10089 * 1507955715)
			...
			i = -(1507955715 * ((Entity) this).anInt10089);
		Class235 class235 = method4337();
		int i_113_ = (int) class235.aClass217_2599.x >> 9;
		int i_114_ = (int) class235.aClass217_2599.y >> 9;
	...
	public void method4442(int i, int i_123_, boolean bool, int i_124_) {
		try {
			if (method4439(-551216163))
				Class372.method4591(aClass119_10131.components, -1, i, i_123_, bool, (short) -1055);
		} catch (RuntimeException runtimeexception) {
	...
	Entity(Class331 class331, int i) {
		...
		((Entity) this).aByte10133 = (byte) 0;
		hitmarkType = new int[-942466371 * LinkedArrayList.WIDGET_DETAILS.maxHitmarkCount];
		hitmarkDamage = new int[-942466371 * LinkedArrayList.WIDGET_DETAILS.maxHitmarkCount];
		hitmarkCycle = new int[-942466371 * LinkedArrayList.WIDGET_DETAILS.maxHitmarkCount];
		hitHP = new int[LinkedArrayList.WIDGET_DETAILS.maxHitmarkCount * -942466371];
		anIntArray10127 = new int[LinkedArrayList.WIDGET_DETAILS.maxHitmarkCount * -942466371];
		anIntArray10083 = new int[LinkedArrayList.WIDGET_DETAILS.maxHitmarkCount * -942466371];
		refreshHpbar = 1208121000;
		...
		currentGraphics = new RSGraphics[4];
		for (int i_125_ = 0; i_125_ < 4; i_125_++)
			currentGraphics[i_125_] = new RSGraphics(this);
		aClass438_Sub2_Sub1Array10112 = (new Class438_Sub2_Sub1[Class82_Sub18.aClass405_6892.anIntArray5267.length]);
	}

	void method4445(GraphicsToolkit class_ra, Class387[] class387s, Class222 class222, boolean bool, int i) {
		try {
			if (!bool) {
				int i_126_ = 0;
				int i_127_ = 0;
	...
	public int method4450(short i) {
		try {
			StanceConfig class350 = getStanceConfig(80856829);
