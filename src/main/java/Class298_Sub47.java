...
public class Class298_Sub47 extends Class298 {
	int[] anIntArray7535;
	int[] anIntArray7536;
	int[] anIntArray7537;
	int anInt7538;
			...
			if (-278777595 * Class436.anInt5506 < 410) {
				if (class365_sub1_sub1_sub2_sub2 == Class287.myPlayer) {
					...
					if (class365_sub1_sub1_sub2_sub2.anInt10205 * 242930343 == 0) {
						...
						if (-1 != (Class287.myPlayer.combatLevelWithSummoning) * 1792775047 && -1 != 1792775047 * (class365_sub1_sub1_sub2_sub2.combatLevelWithSummoning)) {
							int i_1_ = (((1792775047 * (Class287.myPlayer.combatLevelWithSummoning)) < (class365_sub1_sub1_sub2_sub2.combatLevelWithSummoning * 1792775047)) ? (1792775047 * (Class287.myPlayer.combatLevelWithSummoning)) : (class365_sub1_sub1_sub2_sub2.combatLevelWithSummoning * 1792775047));
						...
						if (class365_sub1_sub1_sub2_sub2.anInt10206 * 696798311 >= (class365_sub1_sub1_sub2_sub2.combatLevel * 1868645317))
						...
						for (int i_4_ = 7; i_4_ >= 0; i_4_--) {
							if (client.aStringArray8820[i_4_] != null) {
								...
								if ((client.aClass411_8944 == Class411.aClass411_5320) && (client.aStringArray8820[i_4_].equalsIgnoreCase(Tradution.aClass470_5906.method6049(Class321.aClass429_3357, -875414210)))) {
									if (client.attackOptionSecond && ((class365_sub1_sub1_sub2_sub2.anInt10206) * 696798311 > (Class287.myPlayer.anInt10206) * 696798311))
										i_5_ = (short) 2000;
