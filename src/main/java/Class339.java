...
public class Class339 {
	...
	public Class352 method4116(int i, int i_0_) {
		try {
			...
			if (i == 5000)
				class352.areaName = "Kingdom of<br>Great Kourend";
			else if (i == 5001)
				class352.areaName = "Zeah";
			else if (i == 5002)
				class352.areaName = "Wintertodt";
			else if (i == 5003)
				class352.areaName = "Kebos<br>Lowlands";
			else if (i == 6000)
				class352.areaName = "Lovakengj<br>House";
			else if (i == 6001)
				class352.areaName = "Arceuus<br>House";
			else if (i == 6002)
				class352.areaName = "Piscariius<br>House";
			else if (i == 6003)
				class352.areaName = "Hosidius House";
			else if (i == 6004)
				class352.areaName = "Shayzien<br>House";
			else if (i == 6005)
				class352.areaName = "Kourend<br>Woodland";
			else if (i == 6006)
				class352.areaName = "Mount<br>Quidamortem";
			else if (i == 6007)
				class352.areaName = "Fossil Island";
			else if (i == 6008)
				class352.areaName = "Myths' Guild";
			else if (i == 6009)
				class352.areaName = "Corsair Cove";
			else if (i == 6010)
				class352.areaName = "Lithkren";
			else if (i == 6011)
				class352.areaName = "Molch";
			else if (i == 6012)
				class352.areaName = "Mount<br>Karuulm";
			else if (i == 6013)
				class352.areaName = "Woodcutting<br>guild";
			else if (i == 6014)
				class352.areaName = "Farming guild";
			else if (i == 6015)
				class352.areaName = "Kebos Swamp";

			if (class352.areaName != null)
				class352.areaName = class352.areaName.replace("Red Dragon", "Lava Dragon");
	...
	public void method4119(int i, int i_2_, int i_3_) {
		try {
			((Class339) this).aClass348_3633 = new CachingHashMap(i);
			((Class339) this).aClass348_3635 = new CachingHashMap(i_2_);
		} catch (RuntimeException runtimeexception) {
	...
	public Class339(Class411 class411, Class429 class429, CacheIndex class243, CacheIndex class243_4_) {
		((Class339) this).aClass243_3634 = class243;
		((Class339) this).aClass243_3638 = class243_4_;
		((Class339) this).aClass243_3634.method2316((-1006924897 * (ConfigFile.aClass120_1441.anInt1460)), -1187243048);
	}

	static final void method4121(ClientScript2 class403, int i) {
		try {
			int i_5_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689)
					* 681479919)]);
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_5_, (byte) 40);
	...
	static final void method4122(ClientScript2 class403, byte i) {
		try {
			Class390 class390 = (((ClientScript2) class403).aBoolean5261 ? ((ClientScript2) class403).aClass390_5247
					: ((ClientScript2) class403).aClass390_5246);
	...
	static final void method4123(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919
					- 1)] = Class165.aClass319_6366.method3883((byte) -67);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4124(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919
					- 1)] = Class82_Sub14.anInt6875 * 1196508279 + WorldMap.baseX;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919
					- 1)] = 1882038855 * Class376.anInt4090 + WorldMap.baseY;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4126(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).aClass177_5243.anInt1787 = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689)
					* 681479919)]) * -1496580327;
			((ClientScript2) class403).aClass177_5243.aClass298_Sub37_Sub14_1788 = Class447.aClass469_5618
					.method6045((-2034569943 * (((ClientScript2) class403).aClass177_5243.anInt1787)), (short) -31803);
			((ClientScript2) class403).aClass177_5243.anIntArray1789 = new int[((ClientScript2) class403).aClass177_5243.aClass298_Sub37_Sub14_1788
					.method3461((short) -407)];
		} catch (RuntimeException runtimeexception) {
