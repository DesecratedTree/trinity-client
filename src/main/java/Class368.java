...
public class Class368 {
	...
	public static int[] anIntArray4003 = new int[150]; //120
	...
	static {
		/*int i = 0;
		for (int i_0_ = 0; i_0_ < 150; i_0_++) {
			int i_1_ = i_0_ + 1;
			int i_2_ = (int) ((double) i_1_ + 300.0 * Math.pow(2.0, (double) i_1_ / 7.0));
			i += i_2_;
			anIntArray4003[i_0_] = i / 4;
			System.out.println(i_0_+", "+anIntArray4003[i_0_]);
		}*/
	    long points = 0;
	    for (int i = 0; i < anIntArray4003.length; i++) {
	        int l = i + 1;
	        long step = (int) (l + 300D * Math.pow(2D, l / 7D));
	        points += step;
	        anIntArray4003[i] = (int) (points / 4);
	    }
		if(anIntArray4003.length >= 150)
	    	anIntArray4003[149] = Integer.MAX_VALUE;
	}
	...
	static void method4555(short i) {
		try {
			if (Class300.aClass303_3202 != null) {
				...
				WidgetConfig.method1136(256, 497351807);
			}
		} catch (RuntimeException runtimeexception) {
		...
		try {
			...
			if (class57 != null) {
				...
				if (null != class352.areaName) {
					i_9_ = Class74.aClass505_695.method6257((class352.areaName), null, (Class301_Sub1.aStringArray7638), null, (byte) 37);
				...
				if (-1 != class352.anInt3785 * 715019623 || class352.areaName != null) {
					...
					JagexFile2.aClass453_5986.add(class298_sub6, 2005332883);
				}
			}
		} catch (RuntimeException runtimeexception) {
