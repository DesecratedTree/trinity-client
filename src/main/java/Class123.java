...
public abstract class Class123 {
	...
	Class123(ModernToolkit class_ra_sub3, Class109 class109) {
	...
	abstract Class110 method1326(ModernToolkit class_ra_sub3, Class108 class108);
	...
	public final void method1336(int i, Matrix class233, byte i_7_) {
		try {
	...
	public final void method1337(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233, byte i) {
		try {
	...
	public final void method1338(Class298_Sub31_Sub1 class298_sub31_sub1, SceneObjectPosition class217, int i) {
		try {
			((Class123) this).aClass110Array1469[-33664303 * anInt1475].method1162(class298_sub31_sub1, class217.x, class217.aFloat2455, class217.y);
		} catch (RuntimeException runtimeexception) {
	...
	public final void method1343(int i, SceneObjectPosition class217, int i_13_) {
		try {
			((Class123) this).aClass110Array1469[anInt1475 * -33664303].method1168(i, class217.x, class217.aFloat2455, class217.y);
		} catch (RuntimeException runtimeexception) {
	...
	public final void method1345(int i, Matrix class233, byte i_16_) {
		try {
	...
	public final void method1346(int i, Matrix class233, int i_17_) {
		try {
	...
	abstract Class110 method1361(ModernToolkit class_ra_sub3, Class108 class108);

	abstract Class110 method1362(ModernToolkit class_ra_sub3, Class108 class108);
	...
	public final void method1368(Class298_Sub31_Sub1 class298_sub31_sub1, Matrix class233, int i) {
		try {
	...
	static final void method1377(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_33_, (byte) 75);
	...
	static final void method1379(ClientScript2 class403, byte i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_42_).stackable) * 789409129 == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
