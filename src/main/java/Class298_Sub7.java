...
public class Class298_Sub7 extends Class298 {
	...
	public static WorldMapArea method2864(int i) {
		try {
			return Class301_Sub1.currentArea;
	...
	static final void method2865(ClientScript2 class403, int i) {
		try {
			WidgetConfig class105 = Class50.getIComponentDefinitions((((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]), (byte) 45);
