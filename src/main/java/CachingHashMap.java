 ...
 */
public final class CachingHashMap {

	LinkedArrayList objectMap;
	...
	void method4182(Class298_Sub37_Sub9 class298_sub37_sub9, int i) {
		try {
			if (null != class298_sub37_sub9) {
				class298_sub37_sub9.remove(-1460969981);
	...
	public int method4183(byte i) {
		try {
			int i_0_ = 0;
			for (Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) aClass461_3703.method5984(1659179977); class298_sub37_sub9 != null; class298_sub37_sub9 = (Class298_Sub37_Sub9) aClass461_3703.method5985(1776119940)) {
	...
	public Object get(long key) {
		try {
			Class298_Sub37_Sub9 class298_sub37_sub9 = ((Class298_Sub37_Sub9) objectMap.method5812(key));
			if (null == class298_sub37_sub9) {
				return null;
			}
			...
			if (class298_sub37_sub9.method3438(-1388215910)) {
				...
				objectMap.method5817(class298_sub37_sub9_sub1, class298_sub37_sub9.aLong3188 * 7051297995265073167L);
				aClass461_3703.method5982(class298_sub37_sub9_sub1, (byte) -4);
				class298_sub37_sub9_sub1.aLong7406 = 0L;
				class298_sub37_sub9.remove(-1460969981);
				class298_sub37_sub9.method3402(1072331765);
			} else {
				aClass461_3703.method5982(class298_sub37_sub9, (byte) -40);
	...
	public void method4185(Object object, long l, int i, byte i_1_) {
		try {
			if (i > maxSize * 2087531591) {
				throw new IllegalStateException();
			}
			method4193(l);
			capacity -= -1846372093 * i;
			while (1177262507 * capacity < 0) {
				Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) aClass461_3703.method5983(-2130209329);
			...
			objectMap.method5817(class298_sub37_sub9_sub1, l);
			aClass461_3703.method5982(class298_sub37_sub9_sub1, (byte) -108);
			class298_sub37_sub9_sub1.aLong7406 = 0L;
		} catch (RuntimeException runtimeexception) {
	...
	public void method4186(int i, int i_2_) {
		try {
			for (Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) aClass461_3703.method5984(-1737359401); class298_sub37_sub9 != null; class298_sub37_sub9 = (Class298_Sub37_Sub9) aClass461_3703.method5985(1372068776)) {
				if (class298_sub37_sub9.method3438(504566053)) {
				...
				} else if ((class298_sub37_sub9.aLong7406 += 1476940603538232441L) * -5533549728640346679L > i) {
					...
					objectMap.method5817(class298_sub37_sub9_sub2, 7051297995265073167L * class298_sub37_sub9.aLong3188);
	...
	public void method4187() {
		try {
			aClass461_3703.method5988(1649887220);
			objectMap.clear((byte) -88);
			capacity = 1537477589 * maxSize;
		} catch (RuntimeException runtimeexception) {
	...
	public int method4188(int i) {
		try {
			return maxSize * 2087531591;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("on.u(").append(')').toString());
		}
	}

	public CachingHashMap(int i) {
		/*if (i < 10000)  //fix mem leak, may need to increase further
			i *= 3;*/
		this((i < 10000 ? i * 3 : i), (i < 10000 ? i * 3 : i));
		//i before
	}

	public void method4189() {
		try {
			for (Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) aClass461_3703.method5984(-1664121892); null != class298_sub37_sub9; class298_sub37_sub9 = (Class298_Sub37_Sub9) aClass461_3703.method5985(-1665993458)) {
	...
	public Object method4190(int i) {
		try {
			Class298_Sub37_Sub9 class298_sub37_sub9 = ((Class298_Sub37_Sub9) objectMap.method5816(2018189704));
			while_82_: do {
				Object object;
				for (;;) {
					if (null == class298_sub37_sub9) {
					...
					class298_sub37_sub9 = (Class298_Sub37_Sub9) objectMap.method5815((byte) 18);
					class298_sub37_sub9_3_.remove(-1460969981);
	...
	public Object method4191(int i) {
		try {
			Class298_Sub37_Sub9 class298_sub37_sub9 = ((Class298_Sub37_Sub9) objectMap.method5815((byte) 37));
			while_83_: do {
				Object object;
				for (;;) {
					if (null == class298_sub37_sub9) {
					...
					class298_sub37_sub9 = (Class298_Sub37_Sub9) objectMap.method5815((byte) 35);
					class298_sub37_sub9_4_.remove(-1460969981);
	...
	public void method4193(long l) {
		try {
			Class298_Sub37_Sub9 class298_sub37_sub9 = ((Class298_Sub37_Sub9) objectMap.method5812(l));
	...
	public CachingHashMap(int i, int i_5_) {
		maxSize = i * -1371130505;
		capacity = -1846372093 * i;
		
		int listSize;
		for (listSize = 1; listSize + listSize < i && listSize < i_5_; listSize += listSize);
		
		objectMap = new LinkedArrayList(listSize);
	}
	...
	static final void method4195(ClientScript2 class403, int i) {
		try {
			...
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub1_7552, i_7_, 1144244334);
	...
	public static int method4197(int i, int i_8_, boolean bool, byte i_9_) {
		try {
			...
			int i_10_ = 0;
			for (int i_11_ = 0; i_11_ < class298_sub9.anIntArray7227.length; i_11_++) {
				if (i_8_ == class298_sub9.anIntArray7226[i_11_]) {
					i_10_ += (class298_sub9.anIntArray7227[i_11_]);
				}
			}
			return i_10_;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4198(ClientScript2 class403, int i) {
		try {
			int i_12_ = (class403.integerstack[class403.integerPos * 1883543357]);
			class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = ((NPC) class403.aClass365_Sub1_Sub1_Sub2_5242).aClass73_10187.method817(i_12_, -966489489);
		} catch (RuntimeException runtimeexception) {
