...
public class Class494 {
	...
	public Class494(Class411 class411, Class429 class429, CacheIndex class243) {
		...
		anInt6090 = (((Class494) this).aClass243_6091.method2316((-1006924897 * (ConfigFile.aClass120_1424.anInt1460)), -1214131434) * 1832969825);
	}
	...
	public Class473 method6191(int i, byte i_0_) {
		try {
			...
			synchronized (((Class494) this).aClass348_6089) {
				class473 = (Class473) ((Class494) this).aClass348_6089.get((long) i);
			}
			if (class473 != null)
				return class473;
			byte[] is;
			synchronized (((Class494) this).aClass243_6091) {
				is = (((Class494) this).aClass243_6091.getFileFromArchive(ConfigFile.aClass120_1424.anInt1460 * -1006924897, i, (byte) -73));
			}
