...
public class Class335 {
	...
	static void method4086(int i) {
		try {
			if (FloorOverlay.graphics.method5051()) {
				FloorOverlay.graphics.method5002(Class52_Sub2_Sub1.aCanvas9079, 1231237984);
				Class267.method2528(600492820);
				Dimension dimension = Class52_Sub2_Sub1.aCanvas9079.getSize();
				FloorOverlay.graphics.method5163((Class52_Sub2_Sub1.aCanvas9079), dimension.width, dimension.height, 900330778);
				FloorOverlay.graphics.method5003(Class52_Sub2_Sub1.aCanvas9079, (byte) -92);
			} else
				Class370.method4578(Class422_Sub25.preferences.graphicsMode.method5677(-644336063), false, 622850291);
