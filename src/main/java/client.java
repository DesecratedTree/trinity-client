...
public final class client extends Class291 {
    public static boolean rightClickHack;
	...
	public static Class442 groundMessages;
	public static boolean aBoolean8651;
	public static WidgetConfig aClass105_8652;
	...
	static int wheelScroll;
	static boolean widgetScrolled;
	static int anInt8683 = 128;
	static boolean[] aBooleanArray8684;
	public static LinkedArrayList groundTiles;
	...
	public static LinkedArrayList aClass437_8696;
	...
	static WidgetConfig aClass105_8712;
	...
	static boolean attackOptionSecond;
	public static ObjectValue[] npcs;
	static int anInt8817;
	static short[] aShortArray8818;
	public static WidgetConfig aClass105_8819;
	static String[] aStringArray8820;
	static boolean[] aBooleanArray8821;
	static int anInt8822;
	static int[] anIntArray8823;
	public static Class453 projectiles;
	public static LinkedArrayList groundGfxs;
	...
	static LinkedArrayList settings;
	...
	static int[] anIntArray8977;
	 public static Class411 gametype = null;
	...
	public final void init() {
		try {
			if (method2758(1161676873)) {
				...
				for (int i = 0; i < class209s.length; i++) {
					...
					if (string != null) {
						...
						case 13:
							...
							break;
						case 5:
							StanceConfig.anInt3758 = Integer.parseInt(string) * -339928991;
							break;
						case 32:
				...
				if (aString8927 == null)
					aString8927 = "";
				Class311 class311 = new Class311(775068819 * WIDTH, -791746413 * HEIGHT, 351263031 * anInt8727, anInt8910 * -510898275, aClass411_8944.aString5322);
				Atmosphere.aClient4141 = this;
				method2751(class311, aClass411_8944.aString5317, Class510.aClass444_6221.aString5607, 32 + 1286017487 * Class510.aClass444_6221.anInt5608, Class356.method4268(-369062280), 718, 1, useFrame, (byte) 23);
			}
	...
	final void method2763(byte i) {
		try {
			...
			frame.pack();
			frame.dispose();
			Class82_Sub3.aClass105_6825 = new WidgetConfig();
			...
			SceneObjectPosition.method2017(100);
			...
			Class422_Sub25.preferences = Class121.method1315(815058743);
			if (Class422_Sub25.preferences.aClass422_Sub21_7580.method5703((byte) -54) == 1)
			...
			if (aClass411_8944 == Class411.aClass411_5320)
				aBoolean8674 = false;
			Class107.aShortArray1315 = ObjectConfig.aShortArray5423 = NPCConfig.aShortArray6182 = ItemConfig.aShortArray5757 = new short[256];
			try {
	...
	final void method2773(byte i) {
		try {
			if (Class422_Sub25.preferences.graphicsMode.method5677(-497578575) == 2) {
				try {
					method2806((byte) 0);
				} catch (ThreadDeath threaddeath) {
					throw threaddeath;
				} catch (Throwable throwable) {
					IPAddress.method6062(new StringBuilder().append(throwable.getMessage()).append(" ").append(method2761((byte) 53)).toString(), throwable, (short) -28836);
					aBoolean8662 = true;
	...
	final void method2774(int i) {
		try {
			if (Class422_Sub25.preferences.graphicsMode.method5677(-1358011800) == 2) {
				try {
					method2792((byte) 0);
				} catch (ThreadDeath threaddeath) {
					throw threaddeath;
				} catch (Throwable throwable) {
					IPAddress.method6062(new StringBuilder().append(throwable.getMessage()).append(" ").append(method2761((byte) 17)).toString(), throwable, (short) 1591);
					aBoolean8662 = true;
					Class370.method4578(0, false, 622850291);
				}
			} else
			...
			if (-1233866115 * anInt8752 != 10) {
				...
				if (Class319.method3902(-1233866115 * anInt8752, 476312339)) {
					if (0L != aLong8798 * -7612703297707729209L && (Class122.method1319((byte) 1) > -7612703297707729209L * aLong8798))
						Class357.method4276(Class190.getDisplayMode((byte) -69), -1, -1, false, 243122933);
					else if (!FloorOverlay.graphics.method5074() && aBoolean6478)
				...
				if (null == Class231.fullScreenFrame) {
					...
					if (container == Class298_Sub36.frame) {
					...
					if (Class78.anInt733 * -639974669 != i_2_ || i_3_ != 1282634425 * anInt6472 || aBoolean8676) {
						if (null == FloorOverlay.graphics || FloorOverlay.graphics.method4995())
				...
				if (Class452.fullScreen && null != Class231.fullScreenFrame && !Class422_Sub7.aBoolean8385 && Class319.method3902(-1233866115 * anInt8752, 476312339))
					Class357.method4276(Class422_Sub25.preferences.displayMode.get((byte) 34), -1, -1, false, 1694372474);
				...
				if ((FloorOverlay.graphics != null && FloorOverlay.graphics.method5074()) || Class190.getDisplayMode((byte) -122) != 1)
				...
				if (Class88.method976(-1233866115 * anInt8752, -1448819665))
					...
					if (aClass283_8716.method2627((byte) 103) == Class273.aClass273_2906) {
						...
						Class139.drawText(new StringBuilder().append(Tradution.aClass470_5874.method6049(Class321.aClass429_3357, -875414210)).append(Class26.aString350).append("(").append(i_5_).append("%)").toString(), true, FloorOverlay.graphics, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) 20);
					} else if (aClass283_8716.method2627((byte) 65) == Class273.aClass273_2904) {
						int i_6_ = 50 + aClass283_8716.method2670((byte) -20) / 2;
						Class139.drawText(new StringBuilder().append(Tradution.aClass470_5874.method6049(Class321.aClass429_3357, -875414210)).append(Class26.aString350).append("(").append(i_6_).append("%)").toString(), true, FloorOverlay.graphics, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) 38);
					} else
						Class139.drawText((Tradution.aClass470_5874.method6049(Class321.aClass429_3357, -875414210)), true, FloorOverlay.graphics, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) 64);
				} else if (-1233866115 * anInt8752 == 0)
					Class322.draw(l);
				else if (5 == -1233866115 * anInt8752)
					Class139.drawText(new StringBuilder().append(Tradution.aClass470_5876.method6049(Class321.aClass429_3357, -875414210)).append(Class26.aString350).append(Tradution.aClass470_5794.method6049(Class321.aClass429_3357, -875414210)).toString(), false, FloorOverlay.graphics, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) -78);
				else if (-1233866115 * anInt8752 == 13)
					Class139.drawText(Tradution.aClass470_5788.method6049(Class321.aClass429_3357, -875414210), false, FloorOverlay.graphics, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) -34);
				if (anInt8956 * 2067224717 == 3) {
					for (int i_7_ = 0; i_7_ < -112139815 * anInt8686; i_7_++) {
						...
						if (aBooleanArray8901[i_7_])
							FloorOverlay.graphics.method5014(rectangle.x, rectangle.y, rectangle.width, rectangle.height, -65281, -1154135078);
						else
							FloorOverlay.graphics.method5014(rectangle.x, rectangle.y, rectangle.width, rectangle.height, -16711936, -2005947871);
					}
				}
				if (Class423.method5734(-268540899))
					Class445.method5895(FloorOverlay.graphics, (byte) 127);
				if (!Class88.method976(anInt8752 * -1233866115, 797947023) && !Class358.method4287(-1233866115 * anInt8752, 1114719498) && -1 != WINDOW_PANE_ID * -257444687) {
					try {
						FloorOverlay.graphics.swapBuffers((byte) -94);
					} catch (Exception_Sub1 exception_sub1) {
						IPAddress.method6062(new StringBuilder().append(exception_sub1.getMessage()).append(" ").append(method2761((byte) 3)).toString(), exception_sub1, (short) -15479);
						Class370.method4578(0, false, 622850291);
					}
				}
				Class292.method2817(-1025699241);
				int i_8_ = Class422_Sub25.preferences.aClass422_Sub26_7577.method5717((byte) 1);
				if (0 == i_8_)
				...
				if (Class422_Sub25.preferences.aClass422_Sub27_7579.method5720((byte) -31) == 1 && 19 == -1233866115 * anInt8752 && -257444687 * WINDOW_PANE_ID != -1) {
					Class422_Sub25.preferences.method3540((Class422_Sub25.preferences.aClass422_Sub27_7579), 0, 1020440405);
	...
	final void method2765(int i) {
		try {
			...
			if (null != FloorOverlay.graphics)
				FloorOverlay.graphics.dispose(1233420487);
			if (Class452.fullScreen && Class231.fullScreenFrame != null) {
				Class93.method1010(Class389.aClass457_4164, Class231.fullScreenFrame, -784023783);
	...
	static final void method2795() {
		...
		int i_10_ = Class422_Sub25.preferences.aClass422_Sub25_7569.method5716((byte) -15);
		boolean bool = i_10_ == 1 && i > 200 || i_10_ == 0 && i > 50;
		for (int i_11_ = 0; i_11_ < i; i_11_++) {
			Player class365_sub1_sub1_sub2_sub2 = players[is[i_11_]];
			if (!class365_sub1_sub1_sub2_sub2.method4477(526198823))
				...
				if (class365_sub1_sub1_sub2_sub2.aShort9798 < 0 || class365_sub1_sub1_sub2_sub2.aShort9795 < 0 || (class365_sub1_sub1_sub2_sub2.aShort9796 >= aClass283_8716.method2629(-1927739596)) || (class365_sub1_sub1_sub2_sub2.aShort9797 >= aClass283_8716.method2630(2032357288)))
					class365_sub1_sub1_sub2_sub2.anInt10071 = 689024993;
				else {
					...
					if (Class287.myPlayer == class365_sub1_sub1_sub2_sub2)
						...
						if (!class365_sub1_sub1_sub2_sub2.aBoolean10123)
							i_12_++;
						if ((class365_sub1_sub1_sub2_sub2.refreshHpbar * -1472450313) > anInt8884 * 443738891)
							i_12_ += 2;
		...
		for (int i_13_ = 0; i_13_ < -1230451913 * anInt8703; i_13_++) {
			NPC class365_sub1_sub1_sub2_sub1 = ((NPC) (((ObjectValue) aClass437_8696.method5812((long) anIntArray8699[i_13_])).value));
			if (!class365_sub1_sub1_sub2_sub1.method4457(819293556) || !class365_sub1_sub1_sub2_sub1.config.method6241(Class128.aClass148_6331, 922180251))
				class365_sub1_sub1_sub2_sub1.anInt10071 = 689024993;
			else {
				class365_sub1_sub1_sub2_sub1.method4404(449273804);
				if (class365_sub1_sub1_sub2_sub1.aShort9798 < 0 || class365_sub1_sub1_sub2_sub1.aShort9795 < 0 || (class365_sub1_sub1_sub2_sub1.aShort9796 >= aClass283_8716.method2629(-1937230343)) || (class365_sub1_sub1_sub2_sub1.aShort9797 >= aClass283_8716.method2630(1822473503)))
					class365_sub1_sub1_sub2_sub1.anInt10071 = 689024993;
				else {
					int i_14_ = 0;
					if (!class365_sub1_sub1_sub2_sub1.aBoolean10123)
						i_14_++;
					if (-1472450313 * class365_sub1_sub1_sub2_sub1.refreshHpbar > 443738891 * anInt8884)
						i_14_ += 2;
					i_14_ += 5 - class365_sub1_sub1_sub2_sub1.getSize() << 2;
					if (0 == anInt8903 * 198119493) {
						if (class365_sub1_sub1_sub2_sub1.config.aBoolean6173)
							i_14_ += 64;
						else
							i_14_ += 128;
					...
					if (class365_sub1_sub1_sub2_sub1.config.priority)
						i_14_ += 1024;
					else if (!class365_sub1_sub1_sub2_sub1.config.aBoolean6155)
						i_14_ += 256;
		...
		for (int i_15_ = 0; i_15_ < hintIcons.length; i_15_++) {
			HintIcon class19 = hintIcons[i_15_];
			if (null != class19) {
				if (958933333 * class19.anInt266 == 1) {
					ObjectValue class298_sub29 = ((ObjectValue) aClass437_8696.method5812((long) (class19.anInt256 * -841622081)));
					if (class298_sub29 != null) {
						NPC class365_sub1_sub1_sub2_sub1 = ((NPC) class298_sub29.value);
					...
					Player class365_sub1_sub1_sub2_sub2 = (players[-841622081 * class19.anInt256]);
		...
		for (int i_20_ = 0; i_20_ < i_19_; i_20_++) {
			...
			if (0 == 1596783995 * anInt8724) {
				...
				if (i_20_ < i_16_)
					...
					class365_sub1_sub1_sub2 = ((Entity) (((ObjectValue) aClass437_8696.method5812((long) anIntArray8699[i_20_ - i_16_])).value));
			...
			if ((i_21_ & 0x1) == 0) {
				if (((int) class217.x & 0x1ff) != 0 || 0 != ((int) class217.y & 0x1ff))
					continue;
			} else if (((int) class217.x & 0x1ff) != 256 || 256 != ((int) class217.y & 0x1ff))
				continue;
			if (i_21_ == 1) {
				int i_22_ = (int) class217.x >> 9;
				int i_23_ = (int) class217.y >> 9;
				...
				int i_26_ = (int) class217.y - i_24_ >> 9;
				int i_27_ = (int) class217.x + i_24_ >> 9;
				int i_28_ = i_24_ + (int) class217.y >> 9;
		...
		for (int i_35_ = 0; i_35_ < i_34_; i_35_++) {
			...
			if (anInt8724 * 1596783995 == 0) {
				...
				if (i_35_ < i_31_)
					...
					class365_sub1_sub1_sub2 = ((Entity) (((ObjectValue) aClass437_8696.method5812((long) anIntArray8699[i_35_ - i_31_])).value));
			...
			SceneObjectPosition class217 = class365_sub1_sub1_sub2.method4337().aClass217_2599;
			if ((i_36_ & 0x1) == 0) {
				if (0 != ((int) class217.x & 0x1ff) || ((int) class217.y & 0x1ff) != 0) {
					class365_sub1_sub1_sub2.aBoolean10123 = false;
					continue;
				}
			} else if (((int) class217.x & 0x1ff) != 256 || 256 != ((int) class217.y & 0x1ff)) {
			...
			class365_sub1_sub1_sub2.aBoolean10123 = false;
			class365_sub1_sub1_sub2.method4341(class217.x, (float) Class356.getPlayerHeight((int) class217.x, (int) class217.y, class365_sub1_sub1_sub2.plane, -1247004114), class217.y);
	...
	static final void method2798() {
		...
		for (int i = 0; i < -1230451913 * anInt8703; i++) {
			NPC class365_sub1_sub1_sub2_sub1 = ((NPC) (((ObjectValue) aClass437_8696.method5812((long) anIntArray8699[i])).value));
			if (class365_sub1_sub1_sub2_sub1.aBoolean10123 && class365_sub1_sub1_sub2_sub1.method4427((byte) 1) != -1) {
				...
				int i_48_ = (int) class217.y - i_46_ >> 9;
				Entity class365_sub1_sub1_sub2 = AnimationConfig.method4886((class365_sub1_sub1_sub2_sub1.plane), i_47_, i_48_, (byte) 88);
		...
		for (int i_51_ = 0; i_51_ < i_50_; i_51_++) {
			...
			if (0 == 1596783995 * anInt8724) {
				...
				if (i_51_ < i)
					...
					class365_sub1_sub1_sub2 = ((Entity) (((ObjectValue) aClass437_8696.method5812((long) anIntArray8699[i_51_ - i])).value));
				if (648883167 * class365_sub1_sub1_sub2.anInt10071 < 0)
					continue;
			}
			...
			if (0 == (i_52_ & 0x1)) {
				...
				continue;
			class365_sub1_sub1_sub2.method4341(class217.x, (float) Class356.getPlayerHeight((int) class217.x, (int) class217.y, class365_sub1_sub1_sub2.plane, -1692137069), class217.y);
			aClass283_8716.method2675(-1611682495).method4022(class365_sub1_sub1_sub2, true, (byte) 0);
		}
	}

	public static final void method2800(Class119 class119, WidgetConfig[] class105s, int i, int i_53_, int i_54_, int i_55_, int i_56_, int i_57_, int i_58_, int i_59_, int i_60_) {
		for (int i_61_ = 0; i_61_ < class105s.length; i_61_++) {
			WidgetConfig widget = class105s[i_61_];
			if (widget != null && 1573706803 * widget.parentUID == i) {
				int i_62_ = 1354508417 * widget.xOnScreen + i_57_;
				int i_63_ = -749038817 * widget.yOnScreen + i_58_;
				int i_64_;
				int i_65_;
				int i_66_;
				int i_67_;
				if (2 == -1215239439 * widget.type) {
					i_64_ = i_53_;
					i_65_ = i_54_;
					i_66_ = i_55_;
					i_67_ = i_56_;
				} else {
					int i_68_ = -2093041337 * widget.anInt1156 + i_62_;
					int i_69_ = widget.anInt1162 * 457937409 + i_63_;
					if (-1215239439 * widget.type == 9) {
						i_68_++;
						i_69_++;
					}
				...
				if (0 != -1215239439 * widget.type && !widget.aBoolean1238 && method2801(widget).anInt7416 * -1266165749 == 0 && aClass105_8712 != widget && (907611645 * widget.anInt1145 != WidgetConfig.anInt1265 * 310968271) && (405143323 * WidgetConfig.anInt1129 != 907611645 * widget.anInt1145) && (-451364727 * WidgetConfig.anInt1269 != 907611645 * widget.anInt1145) && (907611645 * widget.anInt1145 != -1997023283 * WidgetConfig.anInt1123)) {
					if (i_64_ < i_66_ && i_65_ < i_67_)
						Class411.method5577(widget, -1954843749);
				} else if (!method2802(widget)) {
					if (aClass105_8850 == widget && Class419.method5603(aClass105_8850, 1205106518)) {
						aBoolean8938 = true;
						anInt8861 = i_62_ * -1501079155;
						anInt8862 = -1873720993 * i_63_;
					}
					if (widget.aBoolean1220 || i_64_ < i_66_ && i_65_ < i_67_) {
						if (widget.noClickThrough && i_59_ >= i_64_ && i_60_ >= i_65_ && i_59_ < i_66_ && i_60_ < i_67_) {
							for (Class298_Sub46 class298_sub46 = ((Class298_Sub46) aClass453_8893.method5939(1766612795)); class298_sub46 != null; class298_sub46 = ((Class298_Sub46) aClass453_8893.method5944(49146))) {
								if (class298_sub46.aBoolean7533) {
									class298_sub46.remove(-1460969981);
						...
						boolean bool = (widget.aBoolean1183 && 5 == -1215239439 * widget.type && widget.opacity * -1993792969 == 0 && widget.anInt1283 * 925824753 < 0 && -1232467723 * widget.anInt1280 == -1 && -1 == widget.anInt1289 * -324971993 && !widget.aBoolean1196 && 840270937 * widget.textureID == 0);
						boolean bool_70_ = false;
						if ((Class165.aClass319_6366.method3894((byte) -29) >= i_64_) && (Class165.aClass319_6366.method3883((byte) -71) >= i_65_) && (Class165.aClass319_6366.method3894((byte) 22) < i_66_) && (Class165.aClass319_6366.method3883((byte) 45) < i_67_)) {
							if (bool) {
								Class117 class117 = widget.method1116((FloorOverlay.graphics), 1065695472);
								if (class117 == null || (widget.anInt1156 * -2093041337 != class117.anInt1393 * 1633695381) || (class117.anInt1394 * -60174999 != 457937409 * widget.anInt1162))
									bool_70_ = true;
								else {
									int i_71_ = (Class165.aClass319_6366.method3894((byte) 110) - i_62_);
									int i_72_ = (Class165.aClass319_6366.method3883((byte) -27) - i_63_);
						...
						if (!aBoolean8835 && bool_70_) {
							if (widget.anInt1272 * -1200030067 >= 0)
								anInt8937 = widget.anInt1272 * -133568665;
							else if (widget.noClickThrough)
								anInt8937 = 280458557;
						}
						if (!Class436.aBoolean5478 && bool_70_ && !class119.aBoolean1403)
							Class87.method971(widget, i_59_ - i_62_, i_60_ - i_63_, -1958017189);
						boolean bool_74_ = false;
						if (Class165.aClass319_6366.method3878(-591622557) && bool_70_)
							bool_74_ = true;
						...
						if (null != class298_sub50 && class298_sub50.method3546(-1372966703) == 0 && class298_sub50.method3547((byte) -35) >= i_64_ && class298_sub50.method3560(-2145889865) >= i_65_ && class298_sub50.method3547((byte) 43) < i_66_ && (class298_sub50.method3560(-2006325499) < i_67_)) {
							if (bool) {
								Class117 class117 = widget.method1116((FloorOverlay.graphics), 1959642657);
								if (class117 == null || (-2093041337 * widget.anInt1156 != 1633695381 * class117.anInt1393) || (class117.anInt1394 * -60174999 != widget.anInt1162 * 457937409))
									clicked = true;
								else {
					...
					/*	//custom here
						if ( widget.uid * -440872681 == 39059515)
							continue;*/
						if (clicked) {
							int uid = widget.uid * -440872681;
							//System.out.println("clicked "+uid+", "+(uid & 0xffff));
							if (uid == 39059550) {
								Loader.openURL("https://matrixrsps.io/forum/");
								clicked = false; 
							} else if (uid == 39059551) {
								Loader.openURL("https://discord.gg/7fhC7948kN");
								clicked = false; 
							} else if (uid == 39059552) {
								Loader.openURL("https://matrixrsps.io/vote/");
								clicked = false; 
							} else if (uid == 39059553) {
								Loader.openURL("https://matrixrsps.io/forums/store/");
								clicked = false; 
							} else if (uid == 39059549) {
								Preferences.rememberUsername = Preferences.rememberUsername == 2 ? 1 : 2;
								Class491.hideWidget(39059544, Preferences.rememberUsername == 2 ? 0 : 1, -109953213);
								Class3.savePreferences(656179282);
								clicked = false; 
							}
						}
						if (widget.acceptableInputs != null && !Class423.method5734(-1797996523)) {
							for (int i_79_ = 0; i_79_ < widget.acceptableInputs.length; i_79_++) {
								if (!Class372.aClass323_4052.method3936(widget.acceptableInputs[i_79_], 2064123957)) {
									if (widget.anIntArray1305 != null)
										widget.anIntArray1305[i_79_] = 0;
								} else if (widget.anIntArray1305 == null || (443738891 * anInt8884 >= (widget.anIntArray1305[i_79_]))) {
									byte i_80_ = widget.aByteArray1222[i_79_];
									if (0 == i_80_ || (((i_80_ & 0x8) == 0 || (!(Class372.aClass323_4052.method3936(86, -229313729)) && !(Class372.aClass323_4052.method3936(82, 328550876)) && !(Class372.aClass323_4052.method3936(81, 1628571302)))) && ((i_80_ & 0x2) == 0 || (Class372.aClass323_4052.method3936(86, -1332099546))) && (0 == (i_80_ & 0x1) || (Class372.aClass323_4052.method3936(82, 343135989))) && ((i_80_ & 0x4) == 0 || (Class372.aClass323_4052.method3936(81, 883110115))))) {
										if (i_79_ < 10)
											Class301_Sub1.method3713(i_79_ + 1, (-440872681 * widget.uid), (widget.anInt1154 * -1309843523), "", -1542002795);
										else if (10 == i_79_) {
											Class144.method1587((byte) 4);
											Class298_Sub38 class298_sub38 = method2801(widget);
											Class147.method1600(widget, class298_sub38.method3497((byte) -4), (class298_sub38.anInt7410 * -1133219011), 1387537939);
											aString8838 = (Class88.method977(widget, -1213150980));
											if (aString8838 == null)
												aString8838 = "Null";
											aString8754 = new StringBuilder().append(widget.aString1228).append(Class285.method2709(16777215, -1325844551)).toString();
										}
										int i_81_ = widget.anIntArray1276[i_79_];
										if (widget.anIntArray1305 == null)
											widget.anIntArray1305 = (new int[(widget.acceptableInputs).length]);
										if (0 != i_81_)
											widget.anIntArray1305[i_79_] = (i_81_ + 443738891 * anInt8884);
										else
											widget.anIntArray1305[i_79_] = 2147483647;
									}
								}
							}
						}
						if (clicked) 
							Class523.method6330(widget, class298_sub50.method3547((byte) 0) - i_62_, class298_sub50.method3560(-779478067) - i_63_, 1509566402);
						
							if (aClass105_8850 != null && widget != aClass105_8850 && bool_70_ && method2801(widget).method3494(230946951))
							aClass105_8854 = widget;
						if (aClass105_8712 == widget) {
							aBoolean8855 = true;
						...
						if (widget.aBoolean1238 || 0 != widget.anInt1145 * 907611645) {
							if (bool_70_ && 0 != wheelScroll * 1170859143 && widget.anObjectArray1229 != null) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								class298_sub46.aBoolean7533 = true;
								class298_sub46.aClass105_7525 = widget;
								class298_sub46.anInt7527 = -1937115609 * wheelScroll;
								class298_sub46.anObjectArray7530 = widget.anObjectArray1229;
								aClass453_8893.add(class298_sub46, 1704998047);
							//	wheelScroll = 0;
								client.widgetScrolled = true;
							}
							if (null != aClass105_8850) {
								clicked = false;
								bool_74_ = false;
							} else if (Class436.aBoolean5478 || ((907611645 * widget.anInt1145 != 826979979 * WidgetConfig.anInt1126) && anInt8864 * -651858367 > 0)) {
								clicked = false;
								bool_74_ = false;
								bool_70_ = false;
							}
							if (widget.anInt1145 * 907611645 != 0) {
								if ((-451364727 * WidgetConfig.anInt1269 == 907611645 * widget.anInt1145) || (907611645 * widget.anInt1145 == WidgetConfig.anInt1123 * -1997023283)) {
									aClass105_8819 = widget;
									Atmosphere class385 = aClass283_8716.method2640((byte) -11).method4316((byte) -85);
									if ((class385.method4710((byte) -111) != null) && !Class62.aClass248_612.method2380(16777472))
										class385.method4710((byte) -126).method2588(FloorOverlay.graphics, widget.anInt1162 * 457937409, Class422_Sub25.preferences.aClass422_Sub19_7567.method5695(-1741518508), 1359487645);
									if ((WidgetConfig.anInt1269 * -451364727 == widget.anInt1145 * 907611645) && !Class436.aBoolean5478 && i_59_ >= i_64_ && i_60_ >= i_65_ && i_59_ < i_66_ && i_60_ < i_67_) {
										Class98.method1055((FloorOverlay.graphics), i_59_, i_60_, 132816560);
										for (Class302_Sub5 class302_sub5 = ((Class302_Sub5) (aClass442_8781.method5868(-16777216))); null != class302_sub5; class302_sub5 = ((Class302_Sub5) (aClass442_8781.method5872(266564001)))) {
											if (i_59_ >= (-1082644483 * (((Class302_Sub5) class302_sub5).anInt7659)) && i_59_ < (-989655965 * (((Class302_Sub5) class302_sub5).anInt7664)) && i_60_ >= ((((Class302_Sub5) class302_sub5).anInt7663) * 614770279) && i_60_ < (-252204233 * (((Class302_Sub5) class302_sub5).anInt7665))) {
									...
									for (int i_83_ = 0; i_83_ < i_82_; i_83_++) {
										...
										if (null != class365_sub1_sub1_sub2_sub2) {
											...
											class365_sub1_sub1_sub2_sub2.method4413(i_64_, i_65_, i_66_, i_67_, i_62_ - (widget.anInt1166 * 684246511), i_63_ - (widget.anInt1167 * -1424956747), i_59_, i_60_, 744800283);
										}
									}
									for (int i_84_ = 0; i_84_ < -1230451913 * anInt8703; i_84_++) {
										int i_85_ = anIntArray8699[i_84_];
										ObjectValue class298_sub29 = ((ObjectValue) aClass437_8696.method5812((long) i_85_));
										if (null != class298_sub29) {
											Class62.method729(Class502.aClass502_6720, (-407713023 * (((NPC) (class298_sub29.value)).config.id)), -1, ((Entity) class298_sub29.value), i_85_, (byte) -73);
											((Entity) class298_sub29.value).method4413(i_64_, i_65_, i_66_, i_67_, i_62_ - (widget.anInt1166 * 684246511), i_63_ - (widget.anInt1167 * -1424956747), i_59_, i_60_, 744800283);
										}
									}
									continue;
								}
								if (310968271 * WidgetConfig.anInt1265 == 907611645 * widget.anInt1145) {
									Class117 class117 = widget.method1116((FloorOverlay.graphics), 842748651);
									if (class117 != null && (0 == -64305285 * Class3.anInt56 || Class3.anInt56 * -64305285 == 3) && !Class436.aBoolean5478 && i_59_ >= i_64_ && i_60_ >= i_65_ && i_59_ < i_66_ && i_60_ < i_67_) {
										...
										if (i_87_ >= class117.anIntArray1396.length) //TODO fix properly map
											continue;
										int i_88_ = class117.anIntArray1396[i_87_];
										if (i_86_ >= i_88_ && i_86_ <= (class117.anIntArray1395[i_87_]) + i_88_) {
											i_86_ -= (widget.anInt1156 * -2093041337 / 2);
											i_87_ -= (457937409 * widget.anInt1162 / 2);
											int i_89_;
											if (2 == (-863531439 * Class298_Sub1.cameraType))
											...
											if ((Class298_Sub1.cameraType * -863531439) != 2) {
											...
											if (2 == -863531439 * (Class298_Sub1.cameraType)) {
												...
												i_94_ = ((i_92_ >> 2) + (((int) (class217.x) - i_96_) >> 9));
												i_95_ = (((int) (class217.y) - i_96_) >> 9) - (i_93_ >> 2);
											}
											if (aBoolean8835 && ((-112110875 * Class298.anInt3192) & 0x40) != 0) {
												WidgetConfig class105_97_ = (Class140.method1558((1262526353 * Class379.anInt4099), 392084321 * anInt8836, -156511736));
												if (class105_97_ != null)
													Class234.method2174(aString8838, new StringBuilder().append(" ").append(Class26.aString351).toString(), (697885143 * (Class240.anInt2704)), 59, (-1232467723 * (widget.anInt1280)), 1L, i_94_, i_95_, true, false, (long) (((-1309843523 * (widget.anInt1154)) << 32) | ((widget.uid) * -440872681)), true, -1552213884);
												else
													Class144.method1587((byte) 4);
											} else {
								...
								if (widget.anInt1145 * 907611645 == 826979979 * WidgetConfig.anInt1126) {
									Class113.aClass105_1373 = widget;
									if (bool_70_)
										Class301_Sub1.aBoolean7628 = true;
									if (clicked) {
										int i_98_ = (int) ((double) ((class298_sub50.method3547((byte) -16)) - i_62_ - (-2093041337 * (widget.anInt1156) / 2)) * 2.0 / (double) (WorldMap.aFloat3233));
										int i_99_ = (int) -((double) ((class298_sub50.method3560(-890591574)) - i_63_ - (457937409 * (widget.anInt1162) / 2)) * 2.0 / (double) (WorldMap.aFloat3233));
										int i_100_ = (i_98_ + (Class82_Sub14.anInt6875 * 1196508279) + WorldMap.baseX);
										int i_101_ = (WorldMap.baseY + (i_99_ + (Class376.anInt4090 * 1882038855)));
										WorldMapArea class298_sub37_sub13 = Class298_Sub7.method2864(-360398838);
										if (null != class298_sub37_sub13) {
											...
											if (null != is) {
												if ((Class372.aClass323_4052.method3936(82, 1232426176)) && (1806357379 * playerRights > 0)) {
													JagexFile2.method6083(is[0], is[1], is[2], 1774070906);
													continue;
												}
												aBoolean8866 = true;
											...
											anInt8864 = 640786881;
											aBoolean8865 = false;
											anInt8734 = (Class165.aClass319_6366.method3894((byte) 32) * -344812543);
											anInt8853 = (Class165.aClass319_6366.method3883((byte) 45) * -1376922141);
										}
									} else if (bool_74_ && anInt8864 * -651858367 > 0) {
										if (1 == anInt8864 * -651858367 && ((-98735103 * anInt8734 != (Class165.aClass319_6366.method3894((byte) -21))) || (-938469429 * anInt8853 != (Class165.aClass319_6366.method3883((byte) 40))))) {
										...
										if (2 == -651858367 * anInt8864) {
											aBoolean8865 = true;
											Class77.method842(((Class401.anInt6562 * 100354019) + (int) ((double) ((-98735103 * anInt8734) - (Class165.aClass319_6366.method3894((byte) 13))) * 2.0 / (double) (WorldMap.aFloat3234))), (short) 1347);
											Class352.method4246(((-1026644091 * Class441.anInt5589) - (int) ((double) ((-938469429 * anInt8853) - (Class165.aClass319_6366.method3883((byte) -70))) * 2.0 / (double) (WorldMap.aFloat3234))), (byte) 44);
										}
									} else {
								...
								if (WidgetConfig.anInt1127 * -283863983 == widget.anInt1145 * 907611645) {
									if (bool_74_)
										Class74.method831((Class165.aClass319_6366.method3894((byte) -30) - i_62_), (Class165.aClass319_6366.method3883((byte) 50) - i_63_), -2093041337 * widget.anInt1156, 457937409 * widget.anInt1162, -2108838735);
									continue;
								}
								if (907611645 * widget.anInt1145 == 405143323 * WidgetConfig.anInt1129) {
									Class82_Sub17.method918(widget, i_62_, i_63_, -462358504);
									continue;
								}
							}
							if (!widget.aBoolean1295 && clicked) {
								widget.aBoolean1295 = true;
								if (widget.anObjectArray1240 != null) {
									Class298_Sub46 class298_sub46 = new Class298_Sub46();
									class298_sub46.aBoolean7533 = true;
									class298_sub46.aClass105_7525 = widget;
									...
									class298_sub46.anObjectArray7530 = widget.anObjectArray1240;
									aClass453_8893.add(class298_sub46, 1397555107);
								}
							}
							if (widget.aBoolean1295 && bool_74_ && widget.anObjectArray1263 != null) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								class298_sub46.aBoolean7533 = true;
								class298_sub46.aClass105_7525 = widget;
								class298_sub46.anInt7526 = (Class165.aClass319_6366.method3894((byte) -5) - i_62_) * 622624491;
								class298_sub46.anInt7527 = (Class165.aClass319_6366.method3883((byte) 20) - i_63_) * 335112545;
								class298_sub46.anObjectArray7530 = widget.anObjectArray1263;
								aClass453_8893.add(class298_sub46, 521504192);
							}
							if (widget.aBoolean1295 && !bool_74_) {
								widget.aBoolean1295 = false;
								if (null != widget.anObjectArray1150) {
									Class298_Sub46 class298_sub46 = new Class298_Sub46();
									class298_sub46.aBoolean7533 = true;
									class298_sub46.aClass105_7525 = widget;
									class298_sub46.anInt7526 = (Class165.aClass319_6366.method3894((byte) -46) - i_62_) * 622624491;
									class298_sub46.anInt7527 = (Class165.aClass319_6366.method3883((byte) -116) - i_63_) * 335112545;
									class298_sub46.anObjectArray7530 = widget.anObjectArray1150;
									aClass453_8895.add(class298_sub46, 544676739);
								}
							}
							if (bool_74_ && null != widget.anObjectArray1243) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								class298_sub46.aBoolean7533 = true;
								class298_sub46.aClass105_7525 = widget;
								class298_sub46.anInt7526 = (Class165.aClass319_6366.method3894((byte) 84) - i_62_) * 622624491;
								class298_sub46.anInt7527 = (Class165.aClass319_6366.method3883((byte) 88) - i_63_) * 335112545;
								class298_sub46.anObjectArray7530 = widget.anObjectArray1243;
								aClass453_8893.add(class298_sub46, 1121649679);
							}
							if (!widget.aBoolean1294 && bool_70_) {
								widget.aBoolean1294 = true;
								if (widget.anObjectArray1244 != null) {
									Class298_Sub46 class298_sub46 = new Class298_Sub46();
									class298_sub46.aBoolean7533 = true;
									class298_sub46.aClass105_7525 = widget;
									class298_sub46.anInt7526 = (Class165.aClass319_6366.method3894((byte) 77) - i_62_) * 622624491;
									class298_sub46.anInt7527 = (Class165.aClass319_6366.method3883((byte) 43) - i_63_) * 335112545;
									class298_sub46.anObjectArray7530 = widget.anObjectArray1244;
									aClass453_8893.add(class298_sub46, -424737725);
								}
							}
							if (((widget.aBoolean1294 && bool_70_) ||
									(widget.getID() == 548 && widget.getComponentID() == 5)
									|| (widget.getID() == 746 && widget.getComponentID() == 52))
									
									&& null != widget.anObjectArray1245) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								if (!(widget.getID() == 548 && widget.getComponentID() == 5) &&
										!(widget.getID() == 746 && widget.getComponentID() == 52))
										class298_sub46.aBoolean7533 = true;//dispose
								class298_sub46.aClass105_7525 = widget;
								...
								class298_sub46.anObjectArray7530 = widget.anObjectArray1245;
								aClass453_8893.add(class298_sub46, 1191346239);
							}
							if (widget.aBoolean1294 && !bool_70_) {
								widget.aBoolean1294 = false;
								if (null != widget.anObjectArray1122) {
									Class298_Sub46 class298_sub46 = new Class298_Sub46();
									class298_sub46.aBoolean7533 = true;
									class298_sub46.aClass105_7525 = widget;
									class298_sub46.anInt7526 = (Class165.aClass319_6366.method3894((byte) 44) - i_62_) * 622624491;
									class298_sub46.anInt7527 = (Class165.aClass319_6366.method3883((byte) 29) - i_63_) * 335112545;
									class298_sub46.anObjectArray7530 = widget.anObjectArray1122;
									aClass453_8895.add(class298_sub46, 1896898026);
								}
							}
							if (null != widget.anObjectArray1209) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								class298_sub46.aClass105_7525 = widget;
								class298_sub46.anObjectArray7530 = widget.anObjectArray1209;
								aClass453_8660.add(class298_sub46, 1662348001);
							}
							if (widget.anObjectArray1200 != null && (116700579 * anInt8877 > -1690676599 * widget.anInt1300)) {
								if (null == widget.anIntArray1258 || ((116700579 * anInt8877 - -1690676599 * widget.anInt1300) > 32)) {
									Class298_Sub46 class298_sub46 = new Class298_Sub46();
									class298_sub46.aClass105_7525 = widget;
									class298_sub46.anObjectArray7530 = widget.anObjectArray1200;
									aClass453_8893.add(class298_sub46, 502102502);
								} else {
									while_122_: for (int i_102_ = (-1690676599 * widget.anInt1300); i_102_ < anInt8877 * 116700579; i_102_++) {
										int i_103_ = anIntArray8876[i_102_ & 0x1f];
										for (int i_104_ = 0; i_104_ < (widget.anIntArray1258).length; i_104_++) {
											if (i_103_ == (widget.anIntArray1258[i_104_])) {
												Class298_Sub46 class298_sub46 = new Class298_Sub46();
												class298_sub46.aClass105_7525 = widget;
												class298_sub46.anObjectArray7530 = (widget.anObjectArray1200);
												aClass453_8893.add(class298_sub46, 1623160189);
												break while_122_;
											}
										}
									}
								}
								widget.anInt1300 = -1610191925 * anInt8877;
							}
							if (null != widget.anObjectArray1157 && (-466597939 * anInt8879 > -954704559 * widget.anInt1301)) {
								if (null == widget.anIntArray1260 || ((-466597939 * anInt8879 - widget.anInt1301 * -954704559) > 32)) {
									Class298_Sub46 class298_sub46 = new Class298_Sub46();
									class298_sub46.aClass105_7525 = widget;
									class298_sub46.anObjectArray7530 = widget.anObjectArray1157;
									aClass453_8893.add(class298_sub46, 1651648237);
								} else {
									while_123_: for (int i_105_ = -954704559 * widget.anInt1301; i_105_ < anInt8879 * -466597939; i_105_++) {
										int i_106_ = anIntArray8787[i_105_ & 0x1f];
										for (int i_107_ = 0; i_107_ < (widget.anIntArray1260).length; i_107_++) {
											if (widget.anIntArray1260[i_107_] == i_106_) {
												Class298_Sub46 class298_sub46 = new Class298_Sub46();
												class298_sub46.aClass105_7525 = widget;
												class298_sub46.anObjectArray7530 = (widget.anObjectArray1157);
												aClass453_8893.add(class298_sub46, 1953578472);
												break while_123_;
											}
										}
									}
								}
								widget.anInt1301 = anInt8879 * -1362594883;
							}
							if (null != widget.anObjectArray1177 && (anInt8783 * -1667357449 > 942876795 * widget.anInt1288)) {
								if (null == widget.anIntArray1188 || ((anInt8783 * -1667357449 - widget.anInt1288 * 942876795) > 32)) {
									Class298_Sub46 class298_sub46 = new Class298_Sub46();
									class298_sub46.aClass105_7525 = widget;
									class298_sub46.anObjectArray7530 = widget.anObjectArray1177;
									aClass453_8893.add(class298_sub46, 2005476208);
								} else {
									while_124_: for (int i_108_ = 942876795 * widget.anInt1288; i_108_ < anInt8783 * -1667357449; i_108_++) {
										int i_109_ = anIntArray8874[i_108_ & 0x1f];
										for (int i_110_ = 0; i_110_ < (widget.anIntArray1188).length; i_110_++) {
											if (i_109_ == (widget.anIntArray1188[i_110_])) {
												Class298_Sub46 class298_sub46 = new Class298_Sub46();
												class298_sub46.aClass105_7525 = widget;
												class298_sub46.anObjectArray7530 = (widget.anObjectArray1177);
												aClass453_8893.add(class298_sub46, 1394697778);
												break while_124_;
											}
										}
									}
								}
								widget.anInt1288 = 1037546165 * anInt8783;
							}
							if (widget.anObjectArray1172 != null && (1610062389 * anInt8873 > -745327741 * widget.anInt1298)) {
								if (null == widget.anIntArray1254 || ((anInt8873 * 1610062389 - -745327741 * widget.anInt1298) > 32)) {
									Class298_Sub46 class298_sub46 = new Class298_Sub46();
									class298_sub46.aClass105_7525 = widget;
									class298_sub46.anObjectArray7530 = widget.anObjectArray1172;
									aClass453_8893.add(class298_sub46, 1555874647);
								} else {
									while_125_: for (int i_111_ = widget.anInt1298 * -745327741; i_111_ < anInt8873 * 1610062389; i_111_++) {
										int i_112_ = anIntArray8823[i_111_ & 0x1f];
										for (int i_113_ = 0; i_113_ < (widget.anIntArray1254).length; i_113_++) {
											if (widget.anIntArray1254[i_113_] == i_112_) {
												Class298_Sub46 class298_sub46 = new Class298_Sub46();
												class298_sub46.aClass105_7525 = widget;
												class298_sub46.anObjectArray7530 = (widget.anObjectArray1172);
												aClass453_8893.add(class298_sub46, -117285712);
												break while_125_;
											}
										}
									}
								}
								widget.anInt1298 = anInt8873 * 914240999;
							}
							if (widget.anObjectArray1255 != null && (-1048955195 * anInt8875 > -670133479 * widget.anInt1299)) {
								if (widget.anIntArray1256 == null || ((anInt8875 * -1048955195 - -670133479 * widget.anInt1299) > 32)) {
									Class298_Sub46 class298_sub46 = new Class298_Sub46();
									class298_sub46.aClass105_7525 = widget;
									class298_sub46.anObjectArray7530 = widget.anObjectArray1255;
									aClass453_8893.add(class298_sub46, 1231950426);
								} else {
									while_126_: for (int i_114_ = -670133479 * widget.anInt1299; i_114_ < anInt8875 * -1048955195; i_114_++) {
										int i_115_ = anIntArray8833[i_114_ & 0x1f];
										for (int i_116_ = 0; i_116_ < (widget.anIntArray1256).length; i_116_++) {
											if (widget.anIntArray1256[i_116_] == i_115_
													&& ((widget.uid * -440872681 >> 16) != 747 || WidgetConfig.summoningEnabled())) {
												Class298_Sub46 class298_sub46 = new Class298_Sub46();
												class298_sub46.aClass105_7525 = widget;
												class298_sub46.anObjectArray7530 = (widget.anObjectArray1255);
												aClass453_8893.add(class298_sub46, 1221126976);
												break while_126_;
											}
										}
									}
								}
								widget.anInt1299 = anInt8875 * -715849075;
							}
							if (widget.anObjectArray1261 != null && (-1653538697 * anInt8881 > 1544416945 * widget.anInt1302)) {
								if (null == widget.anIntArray1189 || ((anInt8881 * -1653538697 - widget.anInt1302 * 1544416945) > 32)) {
									Class298_Sub46 class298_sub46 = new Class298_Sub46();
									class298_sub46.aClass105_7525 = widget;
									class298_sub46.anObjectArray7530 = widget.anObjectArray1261;
									aClass453_8893.add(class298_sub46, -118981685);
								} else {
									while_127_: for (int i_117_ = 1544416945 * widget.anInt1302; i_117_ < -1653538697 * anInt8881; i_117_++) {
										int i_118_ = anIntArray8880[i_117_ & 0x1f];
										for (int i_119_ = 0; i_119_ < (widget.anIntArray1189).length; i_119_++) {
											if (i_118_ == (widget.anIntArray1189[i_119_])) {
												Class298_Sub46 class298_sub46 = new Class298_Sub46();
												class298_sub46.aClass105_7525 = widget;
												class298_sub46.anObjectArray7530 = (widget.anObjectArray1261);
												aClass453_8893.add(class298_sub46, 337274912);
												break while_127_;
											}
										}
									}
								}
								widget.anInt1302 = -1196442713 * anInt8881;
							}
							if ((538810253 * anInt8882 > 1916751821 * widget.anInt1215) && null != widget.anObjectArray1267) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								class298_sub46.aClass105_7525 = widget;
								class298_sub46.anObjectArray7530 = widget.anObjectArray1267;
								aClass453_8893.add(class298_sub46, 873474299);
							}
							if ((605488971 * anInt8883 > widget.anInt1215 * 1916751821) && null != widget.anObjectArray1285) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								class298_sub46.aClass105_7525 = widget;
								class298_sub46.anObjectArray7530 = widget.anObjectArray1285;
								aClass453_8893.add(class298_sub46, 1133301081);
							}
							if ((anInt8912 * -2049433257 > widget.anInt1215 * 1916751821) && null != widget.anObjectArray1270) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								class298_sub46.aClass105_7525 = widget;
								class298_sub46.anObjectArray7530 = widget.anObjectArray1270;
								aClass453_8893.add(class298_sub46, 2128380863);
							}
							if ((anInt8885 * -570891387 > widget.anInt1215 * 1916751821) && null != widget.anObjectArray1271) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								class298_sub46.aClass105_7525 = widget;
								class298_sub46.anObjectArray7530 = widget.anObjectArray1271;
								aClass453_8893.add(class298_sub46, 967792354);
							}
							if ((-707528081 * anInt8886 > widget.anInt1215 * 1916751821) && widget.anObjectArray1287 != null) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								class298_sub46.aClass105_7525 = widget;
								class298_sub46.anObjectArray7530 = widget.anObjectArray1287;
								aClass453_8893.add(class298_sub46, 1183468985);
							}
							if ((-53597277 * anInt8796 > widget.anInt1215 * 1916751821) && null != widget.anObjectArray1274) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								class298_sub46.aClass105_7525 = widget;
								class298_sub46.anObjectArray7530 = widget.anObjectArray1274;
								aClass453_8893.add(class298_sub46, 1170867246);
							}
							if ((anInt8888 * -1961929885 > 1916751821 * widget.anInt1215) && null != widget.anObjectArray1273) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								class298_sub46.aClass105_7525 = widget;
								class298_sub46.anObjectArray7530 = widget.anObjectArray1273;
								aClass453_8893.add(class298_sub46, 1238026704);
							}
							widget.anInt1215 = anInt8933 * -1380945021;
							if (null != widget.anObjectArray1268) {
								for (int i_120_ = 0; i_120_ < 1351936279 * anInt8894; i_120_++) {
									...
									class298_sub46.anObjectArray7530 = widget.anObjectArray1268;
									aClass453_8893.add(class298_sub46, 1490051014);
								}
							}
							if (aBoolean8775 && null != widget.anObjectArray1277) {
								Class298_Sub46 class298_sub46 = new Class298_Sub46();
								class298_sub46.aClass105_7525 = widget;
								class298_sub46.anObjectArray7530 = widget.anObjectArray1277;
								aClass453_8893.add(class298_sub46, 693108400);
							}
						}
						if (widget.type * -1215239439 == 5 && -1 != 925824753 * widget.anInt1283)
							widget.method1121(ConfigDefinitions.aClass317_3472, Class138_Sub1.aClass131_7010, 1204090508).method2588(FloorOverlay.graphics, widget.anInt1162 * 457937409, Class422_Sub25.preferences.aClass422_Sub19_7567.method5695(-1741518508), 961658636);
						Class411.method5577(widget, -1825904339);
						if (widget.type * -1215239439 == 0) {
							method2800(class119, class105s, widget.uid * -440872681, i_64_, i_65_, i_66_, i_67_, i_62_ - widget.anInt1166 * 684246511, (i_63_ - -1424956747 * widget.anInt1167), i_59_, i_60_);
							if (null != widget.aClass105Array1293)
								method2800(class119, widget.aClass105Array1293, -440872681 * widget.uid, i_64_, i_65_, i_66_, i_67_, (i_62_ - widget.anInt1166 * 684246511), i_63_ - (-1424956747 * widget.anInt1167), i_59_, i_60_);
							Interface class298_sub51 = (Interface) (aClass437_8841.method5812((long) (widget.uid * -440872681)));
							if (class298_sub51 != null) {
								if (aClass411_8944 == Class411.aClass411_5320 && 0 == 27137839 * class298_sub51.clipped && !Class436.aBoolean5478 && bool_70_ && !SHOW_HIDDEN_OPTIONS)
	...
	public static Class298_Sub38 method2801(WidgetConfig class105) {
		Class298_Sub38 class298_sub38 = ((Class298_Sub38) settings.method5812((long) (-1309843523 * class105.anInt1154) + ((long) (class105.uid * -440872681) << 32)));
		return (null != class298_sub38 ? class298_sub38 : class105.aClass298_Sub38_1219);
	}

	static boolean method2802(WidgetConfig class105) {
	...
	static {
		...
		aClass437_8696 = new LinkedArrayList(64);
		npcs = new ObjectValue[1024];
		npcCount = 0;
		anInt8703 = 0;
		...
		WIDTH = 1384393775;
		HEIGHT = -2122509427; //-1146614829;
		
		
		players = new Player[2048];
		playerIndex = -1448461709;
		aBoolean8807 = false;
		isMemberWorld = true; //on by default
		playerRights = 0;
		anInt8932 = 0;
		aBoolean8811 = false;
		aBoolean8812 = false;
		...
		anInt8822 = -812630591;
		groundTiles = new LinkedArrayList(64);
		projectiles = new Class453();
		groundGfxs = new LinkedArrayList(16);
		groundMessages = new Class442();
		...
		aClass437_8841 = new LinkedArrayList(8);
		anInt8842 = 0;
		aClass105_8652 = null;
		anInt8844 = 0;
		anInt8845 = 0;
		...
		settings = new LinkedArrayList(512);
		anInt8686 = 0;
		anInt8832 = 870349622;
		...
		anInt8941 = 0;
		anInt8942 = 0;
		aStringArray8704 = new String[500];
		aStringArray8945 = new String[500];
		anIntArray8946 = new int[500];
		aStringArray8947 = new String[500];
		anIntArray8705 = new int[500];
		aBooleanArray8722 = new boolean[500];
		aBooleanArray8950 = new boolean[500];
	...
	public final void method205() {
		if (method2758(-60994638)) {
			...
			Class311 class311 = new Class311(775068819 * WIDTH, -791746413 * HEIGHT, 351263031 * anInt8727, anInt8910 * -510898275, aClass411_8944.aString5322);
			Atmosphere.aClient4141 = this;
			method2751(class311, aClass411_8944.aString5317, Class510.aClass444_6221.aString5607, 32 + 1286017487 * Class510.aClass444_6221.anInt5608, Class356.method4268(-1723932293), 718, 1, useFrame, (byte) -31);
		}
	}
	...
	final void method2770() {
		...
		if (Class401.aClass401_6557 != Class242.aClass401_2708)
			Class98.aByteArrayArray949 = new byte[50][];
		Class422_Sub25.preferences = Class121.method1315(1281460883);
		if (Class422_Sub25.preferences.aClass422_Sub21_7580.method5703((byte) -114) == 1)
			Class331.aBoolean3540 = false;
		if (Class401.aClass401_6557 == Class242.aClass401_2708)
			Class474.aClass471_5976.address = ClientScriptMap.anApplet6044.getCodeBase().getHost();
	...
	public final void method210() {
		if (method2758(555346996)) {
			...
			Class311 class311 = new Class311(775068819 * WIDTH, -791746413 * HEIGHT, 351263031 * anInt8727, anInt8910 * -510898275, aClass411_8944.aString5322);
			Atmosphere.aClient4141 = this;
			method2751(class311, aClass411_8944.aString5317, Class510.aClass444_6221.aString5607, 32 + 1286017487 * Class510.aClass444_6221.anInt5608, Class356.method4268(-586316395), 718, 1, useFrame, (byte) 80);
		}
	}
	...
	final void method2768() {
		...
		if (Class401.aClass401_6557 != Class242.aClass401_2708)
			Class98.aByteArrayArray949 = new byte[50][];
		Class422_Sub25.preferences = Class121.method1315(1110000568);
		if (Class422_Sub25.preferences.aClass422_Sub21_7580.method5703((byte) -45) == 1)
			Class331.aBoolean3540 = false;
		if (Class401.aClass401_6557 == Class242.aClass401_2708)
			Class474.aClass471_5976.address = ClientScriptMap.anApplet6044.getCodeBase().getHost();
	...
	final void method2775() {
		...
		if (Class401.aClass401_6557 != Class242.aClass401_2708)
			Class98.aByteArrayArray949 = new byte[50][];
		Class422_Sub25.preferences = Class121.method1315(719994704);
		if (Class422_Sub25.preferences.aClass422_Sub21_7580.method5703((byte) -48) == 1)
			Class331.aBoolean3540 = false;
		if (Class401.aClass401_6557 == Class242.aClass401_2708)
			Class474.aClass471_5976.address = ClientScriptMap.anApplet6044.getCodeBase().getHost();
	...
	public String method2803() {
		String string = " ";
		try {
			Map class341 = aClass283_8716.method2628(681479919);
			...
			if (Class287.myPlayer != null)
				...
				string = new StringBuilder().append(string).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(1855729883 * Class99.anInt952).append(Class26.aString353).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.graphicsMode.method5677(-682947587)).append(" ").append(Class422_Sub25.preferences.aClass422_Sub13_7549.method5675(-723955200)).append(" ").append(Class190.getDisplayMode((byte) -61)).append(" ").append(Class462.screenWidth * -2110394505).append(Class26.aString353).append(Class298_Sub40_Sub9.screenHeight * -1111710645).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub15_7560.method5684(-2018199679)).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(-90347626)).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub5_7572.method5642(-1374891617)).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub16_7557.method5687(1903704462)).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub6_7551.method5647(-917787431)).append(" ").toString();
			...
			try {
				if (Class422_Sub25.preferences.graphicsMode.method5677(-1738416059) == 2) {
	...
	public String method2804() {
		...
		try {
			...
			if (Class287.myPlayer != null)
				...
				string = new StringBuilder().append(string).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(1855729883 * Class99.anInt952).append(Class26.aString353).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.graphicsMode.method5677(-2069894035)).append(" ").append(Class422_Sub25.preferences.aClass422_Sub13_7549.method5675(-980707631)).append(" ").append(Class190.getDisplayMode((byte) -68)).append(" ").append(Class462.screenWidth * -2110394505).append(Class26.aString353).append(Class298_Sub40_Sub9.screenHeight * -1111710645).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub15_7560.method5684(-1869858699)).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(-1501062841)).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub5_7572.method5642(1402925605)).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub16_7557.method5687(2098109554)).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub6_7551.method5647(708887962)).append(" ").toString();
			string = new StringBuilder().append(string).append("0 ").toString();
			string = new StringBuilder().append(string).append(maximumMemory * 1126040225).append(" ").toString();
			string = new StringBuilder().append(string).append(-1233866115 * anInt8752).append(" ").toString();
			if (null != Class12.aClass298_Sub44_9946)
			...
			if (aString8655 != null)
				...
				string = new StringBuilder().append(string).append(Class26.aString353).toString();
			try {
				if (Class422_Sub25.preferences.graphicsMode.method5677(-578216379) == 2) {
					Class<ClassLoader> var_class = java.lang.ClassLoader.class;
					Field field = var_class.getDeclaredField("nativeLibraries");
	...
	public String method2805() {
		...
		try {
			...
			if (Class287.myPlayer != null)
				...
				string = new StringBuilder().append(string).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(1855729883 * Class99.anInt952).append(Class26.aString353).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.graphicsMode.method5677(-361845304)).append(" ").append(Class422_Sub25.preferences.aClass422_Sub13_7549.method5675(-1338991605)).append(" ").append(Class190.getDisplayMode((byte) -87)).append(" ").append(Class462.screenWidth * -2110394505).append(Class26.aString353).append(Class298_Sub40_Sub9.screenHeight * -1111710645).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub15_7560.method5684(-1870553527)).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(-12224060)).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub5_7572.method5642(-149412729)).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub16_7557.method5687(1908877980)).append(" ").toString();
			string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub6_7551.method5647(-1923698698)).append(" ").toString();
			string = new StringBuilder().append(string).append("0 ").toString();
			string = new StringBuilder().append(string).append(maximumMemory * 1126040225).append(" ").toString();
			string = new StringBuilder().append(string).append(-1233866115 * anInt8752).append(" ").toString();
			if (null != Class12.aClass298_Sub44_9946)
			...
			if (aString8655 != null)
				...
				string = new StringBuilder().append(string).append(Class26.aString353).toString();
			try {
				if (Class422_Sub25.preferences.graphicsMode.method5677(-1704140617) == 2) {
					Class<ClassLoader> var_class = java.lang.ClassLoader.class;
					Field field = var_class.getDeclaredField("nativeLibraries");
	...
	void method2806(byte i) {
		try {
			if (10 != -1233866115 * anInt8752) {
				...
				if (FloorOverlay.graphics != null)
					FloorOverlay.graphics.method4993((int) Class122.method1319((byte) 1));
				anInt8894 = 0;
				anInt8687 = 0;
				...
				wheelScroll = 0;
				for (Class298_Sub50 class298_sub50 = Class165.aClass319_6366.method3879(-1183106665); null != class298_sub50; class298_sub50 = Class165.aClass319_6366.method3879(390773081)) {
					int i_137_ = class298_sub50.method3546(-1372966703);
					if (i_137_ == -1)
						Class93.method1012(class298_sub50, -1457107013);
					else if (i_137_ == 6) {
						wheelScroll += (class298_sub50.method3548(2127682803) * 815898935);
						class298_sub50.method3550(1052301405);
					} else if (Class128.method1437(i_137_, 1317289232)) {//left, mid right
						aClass453_8827.add(class298_sub50, 289207550);
				...
				if (Class423.method5734(-2065645422))
					StanceConfig.method4218(2062671792);
				...
				if (Class413.method5584(anInt8752 * -1233866115, 1989496806) && !Class358.method4287(-1233866115 * anInt8752, -1179252225)) {
					...
					Class460.processWorldLogin((byte) 71);
				...
				Class517.method6308(FloorOverlay.graphics, -828057261);
	...
	final void method2771() {
		...
		if (null != FloorOverlay.graphics)
			FloorOverlay.graphics.dispose(295313203);
		if (Class452.fullScreen && Class231.fullScreenFrame != null) {
			Class93.method1010(Class389.aClass457_4164, Class231.fullScreenFrame, -171748881);
			Class231.fullScreenFrame = null;
		}
		...
		try {
			...
			try {
				...
				if (Class287.myPlayer != null)
					...
					string = new StringBuilder().append(string).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(Class99.anInt952 * 1855729883).append(Class26.aString353).append(1855729883 * Class99.anInt952).append(Class26.aString353).append(" ").toString();
				string = new StringBuilder().append(string).append(Class422_Sub25.preferences.graphicsMode.method5677(-719661759)).append(" ").append(Class422_Sub25.preferences.aClass422_Sub13_7549.method5675(-1847382084)).append(" ").append(Class190.getDisplayMode((byte) -120)).append(" ").append(Class462.screenWidth * -2110394505).append(Class26.aString353).append(Class298_Sub40_Sub9.screenHeight * -1111710645).append(" ").toString();
				string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub15_7560.method5684(-2046413432)).append(" ").toString();
				string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(-1774221022)).append(" ").toString();
				string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub5_7572.method5642(-2036567589)).append(" ").toString();
				string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub16_7557.method5687(2062127023)).append(" ").toString();
				string = new StringBuilder().append(string).append(Class422_Sub25.preferences.aClass422_Sub6_7551.method5647(1830613279)).append(" ").toString();
				string = new StringBuilder().append(string).append("0 ").toString();
				string = new StringBuilder().append(string).append(maximumMemory * 1126040225).append(" ").toString();
				string = new StringBuilder().append(string).append(-1233866115 * anInt8752).append(" ").toString();
				if (null != Class12.aClass298_Sub44_9946)
				...
				if (aString8655 != null)
					...
					string = new StringBuilder().append(string).append(Class26.aString353).toString();
				try {
					if (Class422_Sub25.preferences.graphicsMode.method5677(-1809803071) == 2) {
						Class<ClassLoader> var_class = java.lang.ClassLoader.class;
						Field field = var_class.getDeclaredField("nativeLibraries");
	...
	final void method2779() {
		if (Class422_Sub25.preferences.graphicsMode.method5677(-638897214) == 2) {
			try {
				method2792((byte) 0);
			} catch (ThreadDeath threaddeath) {
				throw threaddeath;
			} catch (Throwable throwable) {
				IPAddress.method6062(new StringBuilder().append(throwable.getMessage()).append(" ").append(method2761((byte) 79)).toString(), throwable, (short) -11302);
				aBoolean8662 = true;
				Class370.method4578(0, false, 622850291);
			}
		} else
	...
	final void method2769() {
		...
		if (Class401.aClass401_6557 != Class242.aClass401_2708)
			Class98.aByteArrayArray949 = new byte[50][];
		Class422_Sub25.preferences = Class121.method1315(1638033926);
		if (Class422_Sub25.preferences.aClass422_Sub21_7580.method5703((byte) -41) == 1)
			Class331.aBoolean3540 = false;
		if (Class401.aClass401_6557 == Class242.aClass401_2708)
			Class474.aClass471_5976.address = ClientScriptMap.anApplet6044.getCodeBase().getHost();
	...
	static WidgetConfig method2808(WidgetConfig class105) {
		...
		for (int i_149_ = 0; i_149_ < i; i_149_++) {
			class105 = Class523.method6331(Exception_Sub3.method275(((class105.uid) * -440872681), (byte) 3), class105, -1949792813);
			if (class105 == null)
				return Class82_Sub3.aClass105_6825;
		}
		return class105;
	...
	final void method2809(int i) {
		try {
			...
			anInt8933 += -908761385;
			for (int i_151_ = 0; i_151_ < npcCount * 1962237353; i_151_++) {
				NPC npc = ((NPC) npcs[i_151_].value);
				if (null == npc) {
					if (i >= -1655691580) {
						/* empty */
					}
				} else {
					byte i_152_ = (npc.config.movementCapabilities);
					if (0 == (i_152_ & 0x1)) {
						if (i >= -1655691580)
							return;
					} else {
						...
						if (0 != (i_152_ & 0x2) && 0 == (2050671733 * npc.anInt10120) && Math.random() * 1000.0 < 10.0) {
							...
							if (0 != xDiff || yDiff != 0) {
								...
								int steps = (Class298_Sub37.calculateRoute((npc.scenePositionXQueue[0]), (npc.scenePositionYQueue[0]), size, Class209.setExtraRoutefinderData(toX, toY, size, size, 0), (aClass283_8716.getSceneClipDataPlane((npc.plane))), true, calculatedScenePositionXs, calculatedScenePositionYs));
								if (steps > 0) {
									if (steps > 9)
										steps = 9;
						...
						Map.method4141(npc, true, 2113441601);
			...
			if ((19 == anInt8752 * -1233866115 || 18 == anInt8752 * -1233866115 || anInt8752 * -1233866115 == 14 || anInt8752 * -1233866115 == 8) && (!Class315.method3837((byte) 34) || (anInt8752 * -1233866115 == 18 && -1372893999 * Class360.anInt3871 == 42)) && !Class489.method6167(-391880689)) {
				if (Class298_Sub1.cameraType * -863531439 == 3)
					Class298_Sub39.method3506(-887753775);
				else
					Class397.method4913((byte) 53);
				if (-1740717447 * Class367.anInt4000 >> 9 < 14 || (-1740717447 * Class367.anInt4000 >> 9 >= aClass283_8716.method2629(-2005655322) - 14) || Class146.anInt1575 * -299812095 >> 9 < 14 || (-299812095 * Class146.anInt1575 >> 9 >= aClass283_8716.method2630(-281479847) - 14))
					aClass283_8716.sendMapScene(new Class267((Class266.LOAD_MAP_SCENE_BG), null), -1991819579);
			}
			for (;;) {
				Class298_Sub46 class298_sub46 = (Class298_Sub46) aClass453_8660.method5936(2110977409);
				...
				WidgetConfig class105 = class298_sub46.aClass105_7525;
				if (-1309843523 * class105.anInt1154 >= 0) {
					WidgetConfig class105_161_ = Class50.getIComponentDefinitions(1573706803 * class105.parentUID, (byte) 75);
			...
			for (;;) {
				Class298_Sub46 class298_sub46 = (Class298_Sub46) aClass453_8895.method5936(2104272776);
				if (class298_sub46 == null) {
					if (i < -1655691580)
						break;
					return;
				...
				if (class105.anInt1154 * -1309843523 >= 0) {
					WidgetConfig class105_162_ = Class50.getIComponentDefinitions(1573706803 * class105.parentUID, (byte) 54);
			...
			for (;;) {
				Class298_Sub46 class298_sub46 = (Class298_Sub46) aClass453_8893.method5936(2124467113);
				if (class298_sub46 == null) {
					if (i >= -1655691580) {
						/* empty */
					}
				...
				WidgetConfig class105 = class298_sub46.aClass105_7525;
				if (-1309843523 * class105.anInt1154 >= 0) {
					WidgetConfig class105_163_ = Class50.getIComponentDefinitions(1573706803 * class105.parentUID, (byte) 71);
			...
			if (null != aClass105_8850)
				TextureConfig.method602(-587743288);
			...
			for (Class302_Sub2 class302_sub2 = (Class302_Sub2) aClass442_8951.method5868(-16777216); class302_sub2 != null; class302_sub2 = ((Class302_Sub2) aClass442_8951.method5872(-1698881635))) {
				if ((long) (-1505693583 * ((Class302_Sub2) class302_sub2).anInt7647) < Class122.method1319((byte) 1) / 1000L - 5L) {
					if (((Class302_Sub2) class302_sub2).aShort7646 > 0)
						GrabFolder.method2282(5, 0, "", "", "", new StringBuilder().append(((Class302_Sub2) class302_sub2).aString7648).append(Tradution.aClass470_5901.method6049(Class321.aClass429_3357, -875414210)).toString(), -1638737966);
					if (((Class302_Sub2) class302_sub2).aShort7646 == 0)
						GrabFolder.method2282(5, 0, "", "", "", new StringBuilder().append(((Class302_Sub2) class302_sub2).aString7648).append(Tradution.aClass470_5902.method6049(Class321.aClass429_3357, -875414210)).toString(), 750491919);
			...
			if ((14 == anInt8752 * -1233866115 && !Class315.method3837((byte) -62)) || (-1233866115 * anInt8752 == 18 && -1372893999 * Class360.anInt3871 == 42) || 8 == anInt8752 * -1233866115) {
				if (anInt8752 * -1233866115 != 18 && aClass25_8693.method387(537308016) == null)
					...
					if (aClass25_8693.anInt339 * 2033675053 > 50) {
						Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.PING_PACKET, aClass25_8693.aClass449_330, (byte) 52);
	...
	final void method2772() {
		...
		if (null != FloorOverlay.graphics)
			FloorOverlay.graphics.dispose(1124301967);
		if (Class452.fullScreen && Class231.fullScreenFrame != null) {
			Class93.method1010(Class389.aClass457_4164, Class231.fullScreenFrame, 1636611445);
			Class231.fullScreenFrame = null;
		}
	...
	final void method2782() {
		...
		if (null != FloorOverlay.graphics)
			FloorOverlay.graphics.dispose(761781050);
		if (Class452.fullScreen && Class231.fullScreenFrame != null) {
			Class93.method1010(Class389.aClass457_4164, Class231.fullScreenFrame, -593229897);
			Class231.fullScreenFrame = null;
		}
				...
				try {
					...
					if (2 == -333700189 * anInt8692) {
						if (Class365_Sub1_Sub5_Sub2.aClass318_9940.isAvailable(1, (byte) -6)) {
							byte[] is = new byte[1];
							int i_165_ = Class365_Sub1_Sub5_Sub2.aClass318_9940.readBytes(is, 0, 1, (byte) 29);
							if (is[0] != 0) {
					...
					if (anInt8692 * -333700189 == 3) {
						...
						if (Class365_Sub1_Sub5_Sub2.aClass318_9940.isAvailable(i_166_, (byte) -56)) {
							RsByteBuffer class298_sub53 = new RsByteBuffer(i_166_);
							Class365_Sub1_Sub5_Sub2.aClass318_9940.readBytes(class298_sub53.buffer, 0, class298_sub53.buffer.length, (byte) 28);
							for (int i_167_ = 0; i_167_ < class479s.length; i_167_++)
								class479s[i_167_].method6103(class298_sub53.readInt((byte) 30), 1206092602);
	...
	final void method2784() {
		if (Class422_Sub25.preferences.graphicsMode.method5677(-1278701263) == 2) {
			try {
				method2806((byte) 0);
			} catch (ThreadDeath threaddeath) {
				throw threaddeath;
			} catch (Throwable throwable) {
				IPAddress.method6062(new StringBuilder().append(throwable.getMessage()).append(" ").append(method2761((byte) -30)).toString(), throwable, (short) 876);
				aBoolean8662 = true;
				Class370.method4578(0, false, 622850291);
			}
		} else
	...
	public final void method206() {
		if (method2758(1016289663)) {
			...
			Class311 class311 = new Class311(775068819 * WIDTH, -791746413 * HEIGHT, 351263031 * anInt8727, anInt8910 * -510898275, aClass411_8944.aString5322);
			Atmosphere.aClient4141 = this;
			method2751(class311, aClass411_8944.aString5317, Class510.aClass444_6221.aString5607, 32 + 1286017487 * Class510.aClass444_6221.anInt5608, Class356.method4268(-1477238389), 718, 1, useFrame, (byte) 80);
		}
	}
	...
	public final void method207() {
		if (method2758(-150089276)) {
			...
			Class311 class311 = new Class311(775068819 * WIDTH, -791746413 * HEIGHT, 351263031 * anInt8727, anInt8910 * -510898275, aClass411_8944.aString5322);
			Atmosphere.aClient4141 = this;
			method2751(class311, aClass411_8944.aString5317, Class510.aClass444_6221.aString5607, 32 + 1286017487 * Class510.aClass444_6221.anInt5608, Class356.method4268(1155058529), 718, 1, useFrame, (byte) -51);
		}
	}
	...
	public final void method208() {
		if (method2758(2074155450)) {
			...
			Class311 class311 = new Class311(775068819 * WIDTH, -791746413 * HEIGHT, 351263031 * anInt8727, anInt8910 * -510898275, aClass411_8944.aString5322);
			Atmosphere.aClient4141 = this;
			method2751(class311, aClass411_8944.aString5317, Class510.aClass444_6221.aString5607, 32 + 1286017487 * Class510.aClass444_6221.anInt5608, Class356.method4268(-1507101618), 718, 1, useFrame, (byte) -75);
		}
	}
	...
	public final void method204() {
		if (method2758(1279242864)) {
			...
			Class311 class311 = new Class311(775068819 * WIDTH, -791746413 * HEIGHT, 351263031 * anInt8727, anInt8910 * -510898275, aClass411_8944.aString5322);
			Atmosphere.aClient4141 = this;
			method2751(class311, aClass411_8944.aString5317, Class510.aClass444_6221.aString5607, 32 + 1286017487 * Class510.aClass444_6221.anInt5608, Class356.method4268(1164456300), 718, 1, useFrame, (byte) 22);
		}
	}
	...
	public final void method211() {
		if (method2758(-967809085)) {
			...
			Class311 class311 = new Class311(775068819 * WIDTH, -791746413 * HEIGHT, 351263031 * anInt8727, anInt8910 * -510898275, aClass411_8944.aString5322);
			Atmosphere.aClient4141 = this;
			method2751(class311, aClass411_8944.aString5317, Class510.aClass444_6221.aString5607, 32 + 1286017487 * Class510.aClass444_6221.anInt5608, Class356.method4268(-418428626), 718, 1, useFrame, (byte) 29);
		}
	}

	final void method2781() {
		if (Class422_Sub25.preferences.graphicsMode.method5677(-1480003909) == 2) {
			try {
				method2806((byte) 0);
			} catch (ThreadDeath threaddeath) {
				throw threaddeath;
			} catch (Throwable throwable) {
				IPAddress.method6062(new StringBuilder().append(throwable.getMessage()).append(" ").append(method2761((byte) -19)).toString(), throwable, (short) -2557);
				aBoolean8662 = true;
				Class370.method4578(0, false, 622850291);
			}
		} else
