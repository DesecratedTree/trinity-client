...
public class Class248 implements Runnable {
	...
	LinkedList<Class267> aLinkedList2750 = new LinkedList<Class267>();
	...
	static final void method2386(ClientScript2 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2068, client.aClass25_8693.aClass449_330, (byte) 47);
			...
			client.aClass25_8693.method390(class298_sub36, (byte) -123);
		} catch (RuntimeException runtimeexception) {
	...
	static void method2389(GraphicsToolkit class_ra, Class_ta class_ta, WidgetConfig class105, int i, int i_6_, int i_7_, int i_8_, int i_9_, byte i_10_) {
		try {
			...
			if (class352 != null && class352.aBoolean3780 && class352.method4237(Class128.aClass148_6331, 1844230404)) {
				if (class352.anIntArray3803 != null) {
					...
					for (int i_11_ = 0; i_11_ < is.length / 2; i_11_++) {
						int i_12_;
						if (-863531439 * Class298_Sub1.cameraType == 2)
				...
				if (-1 != class352.anInt3785 * 715019623) {
					...
					if (null != class57)
						FloorUnderlay.method5883(class105, class_ta, i, i_6_, i_7_, i_8_, class57, (byte) -86);
				}
				if (class352.areaName != null) {
					...
					Class358.method4290(class105, class_ta, i, i_6_, i_7_, i_8_, i_31_, class352.areaName, class264, class505, -1836991893 * class352.anInt3781, 1768300509);
				}
			}
		} catch (RuntimeException runtimeexception) {
