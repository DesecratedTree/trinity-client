...
public abstract class Class82 {
	...
	static void method871(GraphicsToolkit class_ra, ObjectConfig class432, int i, int i_0_, int i_1_, byte i_2_) {
		try {
			Class496 class496 = ConfigFile.aClass487_1463.method6159((class432.objectIconID * -1204256389), -2141345299);
	...
	static final void method873(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_8_, (byte) -100);
	...
	static final void method875(ClientScript2 class403, byte i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.antialiasing, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]), -283253928);
			Class370.method4578(Class422_Sub25.preferences.graphicsMode.method5677(-1637975360), false, 622850291);
