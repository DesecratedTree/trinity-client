...
public class WorldMap {
	...
	static void method3689(GraphicsToolkit class_ra, int i, int i_0_, int i_1_, int i_2_) {
		...
		if (anInt3252 < mapWidth)
			i_3_++;
		if (anInt3241 < mapHeight)
			i_4_++;
			...
			if (i_8_ > 0) {
				...
				if (i_9_ < 0 || i_9_ >= mapWidth) {
					for (int i_10_ = 0; i_10_ < i_4_; i_10_++) {
						...
						int i_14_;
						if (((WorldMapArea) currentArea).anInt9639 * -717907215 != -1)
							i_14_ = ~0xffffff | (((WorldMapArea) currentArea).anInt9639) * -717907215;
					...
					for (int i_15_ = 0; i_15_ < i_4_; i_15_++) {
						...
						if (i_18_ > 0) {
							...
							int i_20_ = i_9_ + i_19_ * mapWidth;
							int i_21_ = 0;
							int i_22_ = 0;
							Object object = null;
							if (i_19_ >= 0 && i_19_ < mapHeight) {
								i_21_ = ((mapImageArray[i_20_] & 0xff) << 16 | aShortArray3244[i_20_] & 0xffff);
								if (i_21_ != 0)
									i_21_ |= ~0xffffff;
								i_22_ = overlay[i_20_] & 0xffff;

								object = worldObjects[i_20_];
							}
							if (i_21_ == 0 && i_22_ == 0 && object == null) {
								if ((((WorldMapArea) currentArea).anInt9639 * -717907215) != -1)
									i_21_ = (~0xffffff | (((WorldMapArea) currentArea).anInt9639) * -717907215);
				...
				if (i_27_ >= 0 && i_27_ < mapWidth) {
					for (int i_28_ = -16; i_28_ < i_4_ + 16; i_28_++) {
						...
						if (i_31_ > 0) {
							...
							if (i_32_ >= 0 && i_32_ < mapHeight) {
								Object object = (worldObjects[i_27_ + i_32_ * mapWidth]);
								if (object != null) {
									if (object instanceof Class298_Sub54) {
										Class298_Sub54 class298_sub54 = (Class298_Sub54) object;
										if (class298_sub54 != null)
										...
										Integer integer = (Integer) object;
										anIntArray3231[0] = integer.intValue();
										aByteArray3232[0] = (aByteArray3250[i_27_ + i_32_ * mapWidth]);
		...
		for (int i_37_ = 0; i_37_ < 3; i_37_++) {
			for (int i_38_ = i_33_; i_38_ <= i_35_; i_38_++) {
				for (int i_39_ = i_34_; i_39_ <= i_36_; i_39_++) {
					...
					if (arraylist != null) {
						int i_40_ = (i_38_ + (baseX >> 6)) * 64;
						int i_41_ = (i_39_ + (baseY >> 6)) * 64;
						Iterator<?> iterator = arraylist.iterator();
						while (iterator.hasNext()) {
							Class312 class312 = (Class312) iterator.next();
							int i_42_ = (i_40_ + ((Class312) class312).aByte3292 - baseX - anInt3230);
							int i_43_ = (i_41_ + ((Class312) class312).aByte3293 - baseY - anInt3242);
			...
			for (int i_48_ = i_33_; i_48_ <= i_35_; i_48_++) {
				for (int i_49_ = i_34_; i_49_ <= i_36_; i_49_++) {
					...
					if (arraylist != null) {
						int i_50_ = (i_48_ + (baseX >> 6)) * 64;
						int i_51_ = (i_49_ + (baseY >> 6)) * 64;
						Iterator<?> iterator = arraylist.iterator();
						while (iterator.hasNext()) {
							Class312 class312 = (Class312) iterator.next();
							int i_52_ = (i_50_ + ((Class312) class312).aByte3292 - baseX - anInt3230);
							int i_53_ = (i_51_ + ((Class312) class312).aByte3293 - baseY - anInt3242);
	...
	public static void method3690(CacheIndex worldmapIndex, Class375 class375, Class451 class451, Class433 class433, Class339 class339, Class487 class487, Interface23 interface23) {
		...
		if (files != null) {
			for (int i = 0; i < files.length; i++) {
				WorldMapArea class298_sub37_sub13 = Class469.getWorldMapArea(worldMapIndex, archive, files[i], 1783056581);
				areas.method5817(class298_sub37_sub13, (long) ((class298_sub37_sub13.id) * -947282109));
			}
		}
	...
	static void method3692(int i) {
		currentArea = (WorldMapArea) areas.method5812((long) i);
	}

	public static Class461 method3693(int i, int i_59_) {
		Class461 class461 = new Class461();
		for (WorldMapArea class298_sub37_sub13 = ((WorldMapArea) areas.method5816(1759050770)); class298_sub37_sub13 != null; class298_sub37_sub13 = ((WorldMapArea) areas.method5815((byte) -2))) {
			if (((WorldMapArea) class298_sub37_sub13).display && class298_sub37_sub13.method3450(i, i_59_, (byte) 1))
	...
	static int method3694(Interface_ma interface_ma, int i, int i_60_, int i_61_) {
		FloorOverlay class373 = aClass375_3253.getOverlay(i, -165601895);
		if (class373 == null)
			return 0;
		int i_62_ = class373.texture * 324071475;
		if (i_62_ >= 0 && interface_ma.method174(i_62_, 1570476781).aBoolean524)
			i_62_ = -1;
		int i_63_;
		if (class373.minimapColor * 1728947183 >= 0) {
			int i_64_ = class373.minimapColor * 1728947183;
		...
		else if (class373.color * -45966925 == -1)
			i_63_ = 0;
		else {
			int i_67_ = class373.color * -45966925;
	...
	static void decodeTile(GraphicsToolkit toolkit, RsByteBuffer buffer, int i, int i_70_, int xInMap, int yInMap, int[] is, int[] is_73_, boolean skip) {
		int settings = buffer.readUnsignedByte();
		if ((settings & 0x1) == 0) {
			boolean skipUnderlay = (settings & 0x2) == 0;
			int objectIcon = settings >> 2 & 0x3f;
			if (objectIcon != 62) {
				if (objectIcon == 63)
					objectIcon = buffer.readUnsignedByte();
				else if (skipUnderlay)
					objectIcon = is[objectIcon];
				else
					objectIcon = is_73_[objectIcon];
				
				if (!skip) {
					if (skipUnderlay) {
						underlay[xInMap + yInMap * mapWidth] = (short) (objectIcon & 0xff);
						overlay[xInMap + yInMap * mapWidth] = (byte) 0;
					} else {
						overlay[xInMap + yInMap * mapWidth] = (short) (objectIcon & 0xff);
						aByteArray3246[xInMap + yInMap * mapWidth] = (byte) 0;
						underlay[xInMap + yInMap * mapWidth] = (short) (buffer.readByte() & 0xff);
					}
				} else {
					if (!skipUnderlay)
						buffer.readByte();
			...
			int i_76_ = (settings >> 1 & 0x3) + 1;
			boolean bool = (settings & 0x8) != 0;
			boolean bool_77_ = (settings & 0x10) != 0;
			for (int i_78_ = 0; i_78_ < i_76_; i_78_++) {
				int i_79_ = buffer.readUnsignedByte();
				int i_80_ = 0;
				int i_81_ = 0;
				if (bool) {
					i_80_ = buffer.readUnsignedByte();
					i_81_ = buffer.readUnsignedByte();
				}
				int i_82_ = 0;
				if (bool_77_)
					i_82_ = buffer.readUnsignedByte();
				if (i_78_ == 0) {
					underlay[xInMap + yInMap * mapWidth] = (short) i_79_;
					overlay[xInMap + yInMap * mapWidth] = (short) i_80_;
					aByteArray3246[xInMap + yInMap * mapWidth] = (byte) i_81_;
					if (i_82_ == 1) {
						worldObjects[xInMap + yInMap * mapWidth] = new Integer(buffer.readBigSmart(1235052657));
						aByteArray3250[xInMap + yInMap * mapWidth] = buffer.readByte();

						//System.out.println(aByteArray3250[xInMap + yInMap * mapWidth]);
					} else if (i_82_ > 1) {
						int[] objectIDs = new int[i_82_];
						byte[] is_84_ = new byte[i_82_];
						for (int i_85_ = 0; i_85_ < i_82_; i_85_++) {
							objectIDs[i_85_] = buffer.readBigSmart(1235052657);
							is_84_[i_85_] = buffer.readByte();
						}
						worldObjects[xInMap + yInMap * mapWidth] = new Class298_Sub54(objectIDs, is_84_);
					}
				} else {
					int[] is_86_ = null;
					byte[] is_87_ = null;
					if (i_82_ > 0) {
						...
						for (int i_88_ = 0; i_88_ < i_82_; i_88_++) {
							is_86_[i_88_] = buffer.readBigSmart(1235052657);
							is_87_[i_88_] = buffer.readByte();
						}
					}
					if ((anArrayListArrayArrayArray3249[i_78_ - 1][i - (baseX >> 6)][i_70_ - (baseY >> 6)]) == null)
						anArrayListArrayArrayArray3249[i_78_ - 1][i - (baseX >> 6)][i_70_ - (baseY >> 6)] = new ArrayList<Object>();
					Class312 class312 = new Class312(xInMap & 0x3f, yInMap & 0x3f, i_79_, i_80_, i_81_, is_86_, is_87_);
					anArrayListArrayArrayArray3249[i_78_ - 1][i - (baseX >> 6)][i_70_ - (baseY >> 6)].add(class312);
				}
			}
		}
	}

	WorldMap() throws Throwable {
		throw new Error();
	}

	static void drawMap(short[] is, byte[] is_89_, short[] is_90_, int i, int i_91_) {
		int[] is_92_ = new int[mapHeight];
		int[] is_93_ = new int[mapHeight];
		int[] is_94_ = new int[mapHeight];
		int[] is_95_ = new int[mapHeight];
		int[] is_96_ = new int[mapHeight];
		for (int i_97_ = -5; i_97_ < mapWidth; i_97_++) {
			int i_98_ = i_97_ + 5;
			int i_99_ = i_97_ - 5;
			for (int i_100_ = 0; i_100_ < mapHeight; i_100_++) {
				if (i_98_ < mapWidth) {
					int i_101_ = is[i_98_ + i_100_ * mapWidth] & 0xffff;
					if (i_101_ > 0) {
						FloorUnderlay class443 = aClass451_3219.method5932(i_101_ - 1, (byte) -1);
				...
				if (i_99_ >= 0) {
					int i_102_ = is[i_99_ + i_100_ * mapWidth] & 0xffff;
					if (i_102_ > 0) {
						FloorUnderlay class443 = aClass451_3219.method5932(i_102_ - 1, (byte) -1);
						is_92_[i_100_] -= class443.anInt5598 * 838046775;
						is_93_[i_100_] -= class443.anInt5595 * -620399085;
						is_94_[i_100_] -= class443.anInt5600 * 656695887;
						is_95_[i_100_] -= class443.anInt5601 * -813159285;
			...
			if (i_97_ >= 0) {
				...
				int i_106_ = 0;
				int i_107_ = 0;
				for (int i_108_ = -5; i_108_ < mapHeight; i_108_++) {
					int i_109_ = i_108_ + 5;
					if (i_109_ < mapHeight) {
					...
					if (i_108_ >= 0 && i_107_ > 0) {
						if ((is[i_97_ + i_108_ * mapWidth] & 0xffff) == 0) {
							int i_111_ = i_97_ + i_108_ * mapWidth;
							...
							int i_115_ = i_97_ + i_108_ * mapWidth;
	...
	static void method3697() {
		...
		for (int i = 0; i < aClass296_3235.anInt3169 * -1407078377; i++) {
			boolean bool = (currentArea.method3453(aClass296_3235.anIntArray3168[i] >> 28 & 0x3, aClass296_3235.anIntArray3168[i] >> 14 & 0x3fff, aClass296_3235.anIntArray3168[i] & 0x3fff, is, 1112796822));
			if (bool) {
				Class298_Sub52 class298_sub52 = new Class298_Sub52(aClass296_3235.anIntArray3170[i]);
				class298_sub52.x = (is[1] - baseX) * 898378357;
				class298_sub52.y = (is[2] - baseY) * -1686044477;
				aClass453_3236.add(class298_sub52, 1249081090);
			}
		}
	}
	...
	static void decodeFromMap(RsByteBuffer buffer, int x, int y, int height) {
		do {
			...
			if (mask <= 49) {
				int overlay = buffer.readUnsignedByte();
				if (x + y * mapWidth >= WorldMap.overlay.length
						|| (height > 1 && !((mapSettings[x + y * mapWidth] & 0x1) == 1)))
					continue;
				WorldMap.overlay[x + y * mapWidth] = overlay == 0 ? 0 : (short) (overlay + Settings.OSRS_FLOOR_OFFSET);
			} else if (mask <= 81) {
				if (x + y * mapWidth >= WorldMap.mapSettings.length)
					continue;
				if (height == 0 || (height == 1 && (mapSettings[x + y * mapWidth] & 0x1) == 1))
					mapSettings[x + y * mapWidth] = (byte) (mask - 49);
				else
					mapSettings[x + y * mapWidth] = 0;
			} else {
				int underlay = ((byte) (mask - 81)) & 0xff;
				if (x + y * mapWidth >= WorldMap.overlay.length
						|| (height > 0 && !((mapSettings[x + y * mapWidth] & 0x1) == 1)))
					continue;
				WorldMap.underlay[x + y * mapWidth] = underlay == 0 ? 0 : (short)  (underlay  + Settings.OSRS_FLOOR_OFFSET);
			}
		} while (true);
	}
	
	private static int decodeMap(int fromMapX, int fromMapY, int mapX, int mapY) {
	...
	private static int decodeObjects(int fromMapX, int fromMapY, int mapX, int mapY) {
		int archiveID = (Class65.aClass243_665.getArchiveIdByName(Class62.aClass248_612.aClass283_2751.method2669(false, false, fromMapX, fromMapY, (byte) -113), -317623107));
		if (archiveID == -1)
			return 0;
		if (!Class65.aClass243_665.method2290(archiveID, 0, 0)) 
			return -1;
		...
		int objectID = -1;
		for (;;) {
			int i_75_ = buffer.readSmart((short) 255);
			if (i_75_ == 0) 
				break;
			objectID += i_75_;
			int i_76_ = 0;
			for (;;) {
				int i_77_ = buffer.readUnsignedSmart(1723054621);
				if (i_77_ == 0) 
					break;
				i_76_ += i_77_ - 1;
				int y = i_76_ & 0x3f;
				...
				int type = i_81_ >> 2;
				int rotation = i_81_ & 0x3;
				int id = objectID + Settings.OSRS_OBJECT_OFFSET;
				int xInWorldMap = mapX * 64 + x - baseX;
				int yInWorldMap = mapY * 64 + y - baseY;
				int index = xInWorldMap + yInWorldMap * mapWidth;
				ObjectConfig class432 = aClass433_3220.getObjectDefinitions(id);
				
				if (index >= 0 && index  < WorldMap.overlay.length
						&& (class432.objectIconID * -1204256389 != -1 ||
						-1422593103 * class432.mapIconID  != -1 || type == 0 || type == 1)) {
					

					if ((mapSettings[index] & 2) == 2)
						plane--;
					if (plane > 0)
						continue;
					...
					//3 points
					//9 diagonal
					type = type > 1 ? -1 : rotation == 0 || rotation == 2 ? type == 1 ? 9 : 0 : type == 1 ? 201 : 192;
					if (worldObjects[index] == null) {
						worldObjects[index] = id;
						aByteArray3250[index] = (byte) type;
					} else {
						int[] objects = worldObjects[index] instanceof Integer ? new int[]{(int)worldObjects[index]} 
						: ((Class298_Sub54)worldObjects[index]).anIntArray7621;
						byte[] rotations = worldObjects[index] instanceof Integer ? new byte[]{aByteArray3250[index]} 
						: ((Class298_Sub54)worldObjects[index]).aByteArray7620;
						objects = Arrays.copyOf(objects, objects.length+1);
						objects[objects.length-1] = id;
						rotations = Arrays.copyOf(rotations, rotations.length+1);
						rotations[rotations.length-1] = (byte) type;
						worldObjects[index] = new Class298_Sub54(objects, rotations);
					}
				}
	...
	static boolean decodeArea(GraphicsToolkit class_ra, int i, int i_120_) {
		if (currentArea.fileName.equals("main")) { //gonna make it load from cache maps
			//mapSettings = new byte[overlay.length];
			int fromMapX = baseX/64;
			int fromMapY = baseY/64;
			for (int mapX = fromMapX; mapX <= fromMapX + mapWidth/64; mapX++) {
				for (int mapY = fromMapY; mapY <= fromMapY + mapHeight/64; mapY++) {
					int mapID = (mapX << 8) | mapY;
					int result;
					if (Settings.isOSRSMap(mapID)) {
						result = decodeMap(mapX, mapY, mapX, mapY);
						if (result == 1 && decodeObjects(mapX, mapY, mapX, mapY) == -1)
							return false;
					} else 
						result = decodeMap(29, 52, mapX, mapY);
					if (result == -1)
						return false;
				}
			}			
		...
		//} else {
			RsByteBuffer buffer = new RsByteBuffer(worldMapIndex.method2301(currentArea.fileName, "area", -1304297711));
			int count = buffer.readUnsignedByte();
			int[] data = new int[count];
			for (int pos = 0; pos < count; pos++)
				data[pos] = buffer.readUnsignedByte();
			int count2 = buffer.readUnsignedByte();
			int[] data2 = new int[count2];
			for (int pos = 0; pos < count2; pos++)
				data2[pos] = buffer.readUnsignedByte();
			while (buffer.index * 385051775 < buffer.buffer.length) {
				if (buffer.readUnsignedByte() == 0) { //decodes a map
					int mapX = buffer.readUnsignedByte();
					int mapY = buffer.readUnsignedByte();
					int mapID = (mapX << 8) | mapY;
					boolean skip = currentArea.fileName.equals("main") && Settings.isOSRSMap(mapID);
					for (int x = 0; x < 64; x++) {
						for (int y = 0; y < 64; y++) {
							int xInWorldMap = mapX * 64 + x - baseX;
							int yInWorldMap = mapY * 64 + y - baseY;
							decodeTile(class_ra, buffer, mapX, mapY, xInWorldMap, yInWorldMap, data, data2, skip);
						}
					}
				} else { //decodes a chunk
					int mapX = buffer.readUnsignedByte();
					int mapY = buffer.readUnsignedByte();
					int chunkX = buffer.readUnsignedByte();
					int chunkY = buffer.readUnsignedByte();
					int mapID = (mapX << 8) | mapY;
					boolean skip = currentArea.fileName.equals("main") && Settings.isOSRSMap(mapID);
					for (int x = 0; x < 8; x++) {
						for (int y = 0; y < 8; y++) {
							int localX = mapX * 64 + chunkX * 8 + x - baseX;
							int localY = mapY * 64 + chunkY * 8 + y - baseY;
							decodeTile(class_ra, buffer, mapX, mapY, localX, localY, data, data2, skip);
						}
					}
				}
			}
	//	}
		mapImageArray = new byte[mapWidth * mapHeight];
		aShortArray3244 = new short[mapWidth * mapHeight];
		for (int i_140_ = 0; i_140_ < 3; i_140_++) {
			short[] is_141_ = new short[mapWidth * mapHeight];
			for (int i_142_ = 0; i_142_ < anArrayListArrayArrayArray3249[i_140_].length; i_142_++) {
				for (int i_143_ = 0; i_143_ < anArrayListArrayArrayArray3249[i_140_][0].length; i_143_++) {
					...
					if (arraylist != null) {
						...
						while (iterator.hasNext()) {
							Class312 class312 = (Class312) iterator.next();
							is_141_[(i_142_ * 64 + ((Class312) class312).aByte3292 + ((i_143_ * 64 + ((Class312) class312).aByte3293) * mapWidth))] = (byte) ((Class312) class312).anInt3290;
						}
					}
				}
			}
			drawMap(is_141_, mapImageArray, aShortArray3244, i, i_120_);
			for (int i_144_ = 0; i_144_ < anArrayListArrayArrayArray3249[i_140_].length; i_144_++) {
				for (int i_145_ = 0; i_145_ < anArrayListArrayArrayArray3249[i_140_][0].length; i_145_++) {
					...
					if (arraylist != null) {
						...
						while (iterator.hasNext()) {
							Class312 class312 = (Class312) iterator.next();
							int i_146_ = (i_144_ * 64 + ((Class312) class312).aByte3292 + ((i_145_ * 64 + ((Class312) class312).aByte3293) * mapWidth));
							((Class312) class312).anInt3290 = ((mapImageArray[i_146_] & 0xff) << 16 | aShortArray3244[i_146_] & 0xffff);
		...
		drawMap(underlay, mapImageArray, aShortArray3244, i, i_120_);
		underlay = null;
		drawMapIcons();
		
		if (currentArea.fileName.equals("main")) { 
			//normal size 1067
			Class298_Sub52 class298_sub52 = new Class298_Sub52(5000);
			class298_sub52.x = 510 * 898378357;
			class298_sub52.y = 1205 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(5001);
			class298_sub52.x = 370 * 898378357;
			class298_sub52.y = 1160 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(5002);
			class298_sub52.x = 545 * 898378357;
			class298_sub52.y = 1510 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6000);
			class298_sub52.x = 400 * 898378357;
			class298_sub52.y = 1230 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6001);
			class298_sub52.x = 610 * 898378357;
			class298_sub52.y = 1240 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6002);
			class298_sub52.x = 750 * 898378357;
			class298_sub52.y = 1205 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6003);
			class298_sub52.x = 640 * 898378357;
			class298_sub52.y = 1060 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6004);
			class298_sub52.x = 390 * 898378357;
			class298_sub52.y = 1090 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			
			class298_sub52 = new Class298_Sub52(6005);
			class298_sub52.x = 465 * 898378357;
			class298_sub52.y = 950 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6006);
			class298_sub52.x = 160 * 898378357;
			class298_sub52.y = 1055 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6007);
			class298_sub52.x = 2650 * 898378357;
			class298_sub52.y = 1300 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6008);
			class298_sub52.x = 1250 * 898378357;
			class298_sub52.y = 290 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6009);
			class298_sub52.x = 1350 * 898378357;
			class298_sub52.y = 300 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6010);
			class298_sub52.x = 2480 * 898378357;
			class298_sub52.y = 1510 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(5003);
			class298_sub52.x = 170 * 898378357;
			class298_sub52.y = 1160 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6011);
			class298_sub52.x = 220 * 898378357;
			class298_sub52.y = 1175 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6012);
			class298_sub52.x = 220 * 898378357;
			class298_sub52.y = 1323 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6013);
			class298_sub52.x = 510 * 898378357;
			class298_sub52.y = 990 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6014);
			class298_sub52.x = 160 * 898378357;
			class298_sub52.y = 1245 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
			
			class298_sub52 = new Class298_Sub52(6015);
			class298_sub52.x = 160 * 898378357;
			class298_sub52.y = 1130 * -1686044477;
			aClass453_3236.add(class298_sub52, 2035193574);
		}
		return true;
	}
		...
		if (bool || i_150_ != 0 || i_151_ > 0) {
			if (i_151_ == 0)
				...
				if (i_154_ == 0 || i_148_ <= 1 || i_149_ <= 1) {
					int i_155_ = anIntArray3237[i_151_ >= anIntArray3237.length ? 0 : i_151_];
					if (bool || i_155_ != 0)
						class_ra.B(i, i_147_, i_148_, i_149_, i_155_, 0);
				} else {
					int i_156_ = bool ? 0 : 1;
					Class252.method2409(class_ra, aByteArrayArrayArray3229, anInt3254, i, i_147_, i_150_, anIntArray3237[i_151_ >= anIntArray3237.length ? 0 : i_151_], i_148_, i_149_, i_154_, i_152_ >> 6 & 0x3, i_156_, (byte) 127);
				}
			}
		}
		if (is != null) {
			...
			for (int i_159_ = 0; i_159_ < is.length; i_159_++) {
				...
				if (i_160_ == Class424.aClass424_6614.anInt6613 * -1976050083 || (i_160_ == Class424.aClass424_6593.anInt6613 * -1976050083) || (i_160_ == Class424.aClass424_6594.anInt6613 * -1976050083) || (i_160_ == Class424.aClass424_6595.anInt6613 * -1976050083)) {
					ObjectConfig class432 = aClass433_3220.getObjectDefinitions(is[i_159_]);
					if (class432.objectIconID * -1204256389 == -1) {
						int i_161_ = -3355444;
						if (class432.optionType * 1532834983 == 1)
							i_161_ = -3407872;
	...
	static void method3701(GraphicsToolkit class_ra, int i, int i_165_, int i_166_, int i_167_, int[] is, byte[] is_168_) {
		if (is != null) {
			for (int i_169_ = 0; i_169_ < is.length; i_169_++) {
				ObjectConfig class432 = aClass433_3220.getObjectDefinitions(is[i_169_]);
				int i_170_ = class432.objectIconID * -1204256389;
				if (i_170_ != -1) {
					Class496 class496 = aClass487_3225.method6159(i_170_, -2130050645);
					Class57 class57 = class496.method6198(class_ra, (class432.aBoolean5401 ? is_168_[i_169_] >> 6 & 0x3 : 0), (class432.aBoolean5440 ? class432.reverse : false), (byte) -47);
					if (class57 != null) {
						int i_171_ = i_166_ * class57.method271() >> 2;
						int i_172_ = i_167_ * class57.method626() >> 2;
						if (class496.aBoolean6098) {
							int sizeX = class432.sizeX * -1125834887;
							int sizeY = class432.sizeY * -565161399;
	...
	static void method3704(GraphicsToolkit class_ra, Class298_Sub52 class298_sub52, int i, int i_182_, int i_183_, int i_184_) {
		class298_sub52.anInt7609 = (anInt3221 + (i_183_ + i * (class298_sub52.x * 2122110429 - anInt3230) >> 16)) * -1722635483;
		class298_sub52.anInt7606 = (anInt3257 - (i_184_ + i_182_ * (class298_sub52.y * -372920341 - anInt3242) >> 16)) * -283355805;
	}

	public static WorldMapArea method3705(int i) {
		return (WorldMapArea) areas.method5812((long) i);
	}

	static void method3706() {
		underlay = new short[mapWidth * mapHeight];
		overlay = new short[mapWidth * mapHeight];
		mapSettings = new byte[mapWidth * mapHeight];
		aByteArray3246 = new byte[mapWidth * mapHeight];
		worldObjects = new Object[mapWidth * mapHeight];
		aByteArray3250 = new byte[mapWidth * mapHeight];
		anArrayListArrayArrayArray3249 = new ArrayList[3][mapWidth >> 6][mapHeight >> 6];
		anIntArray3237 = new int[aClass375_3253.anInt4081 * 138682397 + 1 + Settings.OSRS_FLOOR_OFFSET];
	}
	...
	static void method3707(Interface_ma interface_ma, int i, int i_185_) {
		...
		anIntArray3237[1041 + 1] =  method3694(interface_ma, 22, i, i_185_);
	}

	public static WorldMapArea method3708(int i, int i_187_) {
		for (WorldMapArea class298_sub37_sub13 = ((WorldMapArea) areas.method5816(1588897265)); class298_sub37_sub13 != null; class298_sub37_sub13 = ((WorldMapArea) areas.method5815((byte) -24))) {
			if (((WorldMapArea) class298_sub37_sub13).display && class298_sub37_sub13.method3450(i, i_187_, (byte) -105))
	...
	static void method3709(int i, int i_188_, int i_189_, int i_190_, int i_191_, int i_192_, int i_193_, int i_194_) {
		anInt3230 = i - baseX;
		anInt3241 = i_188_ - baseY;
		anInt3252 = i_189_ - baseX;
		anInt3242 = i_190_ - baseY;
		anInt3221 = i_191_;
		anInt3255 = i_192_;
		anInt3256 = i_193_;
		anInt3257 = i_194_;
	...
	static void drawMapIcons() {
		for (int i = 0; i < mapWidth; i++) {
			for (int i_195_ = 0; i_195_ < mapHeight; i_195_++) {
				Object object = worldObjects[i + i_195_ * mapWidth];
				if (object != null) {
					if (object instanceof Class298_Sub54) {
						Class298_Sub54 class298_sub54 = (Class298_Sub54) object;
						if (class298_sub54 != null) {
							for (int i_196_ = 0; i_196_ < (((Class298_Sub54) class298_sub54).anIntArray7621).length; i_196_++) {
								ObjectConfig class432 = (aClass433_3220.getObjectDefinitions((((Class298_Sub54) class298_sub54).anIntArray7621[i_196_])));
								int toID = class432.mapIconID * -1422593103;
								if (class432.toObjectIDs != null) {
									class432 = (class432.method5777(anInterface23_3223, 2117091255));
									if (class432 != null)
										toID = class432.mapIconID * -1422593103;
								}
								if (toID != -1) {
									Class298_Sub52 class298_sub52 = new Class298_Sub52(toID);
									class298_sub52.x = i * 898378357;
									class298_sub52.y = i_195_ * -1686044477;
									aClass453_3236.add(class298_sub52, 2035193574);
								}
							}
						}
						...
						Integer integer = (Integer) object;
						ObjectConfig class432 = aClass433_3220.getObjectDefinitions(integer.intValue());
						int i_198_ = class432.mapIconID * -1422593103;
						if (class432.toObjectIDs != null) {
							class432 = class432.method5777(anInterface23_3223, 1079072044);
							if (class432 != null)
								i_198_ = class432.mapIconID * -1422593103;
						}
						...
						if (i_198_ != -1) {
							...
							class298_sub52.x = i * 898378357;
							class298_sub52.y = i_195_ * -1686044477;
							aClass453_3236.add(class298_sub52, 1393789862);
						}
					}
				}
			}
						...
						while (iterator.hasNext()) {
							...
							if (((Class312) class312).anIntArray3288 != null) {
								for (int i_201_ = 0; i_201_ < (((Class312) class312).anIntArray3288).length; i_201_++) {
									ObjectConfig class432 = (aClass433_3220.getObjectDefinitions((((Class312) class312).anIntArray3288[i_201_])));
									int i_202_ = class432.mapIconID * -1422593103;
									if (class432.toObjectIDs != null) {
										class432 = (class432.method5777(anInterface23_3223, 984911486));
										if (class432 != null)
											i_202_ = (class432.mapIconID * -1422593103);
									}
									if (i_202_ != -1) {
										Class298_Sub52 class298_sub52 = new Class298_Sub52(i_202_);
										class298_sub52.x = ((i_199_ + (baseX >> 6)) * 64 + (((Class312) class312).aByte3292) - baseX) * 898378357;
										class298_sub52.y = ((i_200_ + (baseY >> 6)) * 64 + (((Class312) class312).aByte3293) - baseY) * -1686044477;
										aClass453_3236.add(class298_sub52, 1574718042);
									}
								}
							}
						}
	...
	static void method3711(GraphicsToolkit class_ra, Class298_Sub52 class298_sub52, Class352 class352) {
		if (class352.anIntArray3803 != null) {
			...
			for (int i = 0; i < is.length / 2; i++) {
				int i_203_ = (class352.anIntArray3803[i * 2] + class298_sub52.x * 2122110429);
				int i_204_ = (class352.anIntArray3803[i * 2 + 1] + class298_sub52.y * -372920341);
