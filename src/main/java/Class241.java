...
public class Class241 {
	...
	static final void method2247(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			class105.aBoolean1199 = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) == 1;
			Tradution.method6054(class105, 242919800);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("kc.et(").append(')').toString());
		}
	}

	static final void method2248(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder().append("kc.ki(").append(')').toString());
		}
	}
}
