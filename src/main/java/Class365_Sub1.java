...
public abstract class Class365_Sub1 extends SceneObject {
	...
	abstract Class335 drawFloor(GraphicsToolkit class_ra, int i);
	...
	static final void method4401(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
	...
	static final void method4402(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_24_, (byte) -7);
