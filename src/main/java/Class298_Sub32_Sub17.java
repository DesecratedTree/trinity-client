		...
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				for (int i_4_ = 0; i_4_ < Class250.anInt2755 * -1474554145; i_4_++) {
					JagexFile.anInt6057 = 1648440697;
					...
					for (int i_8_ = i_2_ - 1; i_8_ <= i_3_; i_8_++) {
						...
						for (int i_10_ = i_6_ - 1; i_10_ <= i_7_; i_10_++) {
							...
							if (i_14_ < (-1479855355 * Class298_Sub32_Sub23.anInt9477)) {
								JagexFile.anInt6057 = Class358.anInt3865 * 335526737;
							...
							} else if (i_14_ < JagexFile.anInt6057 * -1065886921)
								JagexFile.anInt6057 = i_14_ * 499042951;
						}
					}
					...
					case 3:
						...
						break;
					case 4:
						is[i_4_] = -1065886921 * JagexFile.anInt6057;
						break;
					case 0:
			...
			for (int i_19_ = 0; i_19_ < Class250.anInt2755 * -1474554145; i_19_++) {
				...
				for (int i_23_ = i_17_ - 1; i_23_ <= i_18_; i_23_++) {
					...
					for (int i_25_ = i_21_ - 1; i_25_ <= i_22_; i_25_++) {
						...
						} else if (i_29_ < JagexFile.anInt6057 * -1065886921)
							JagexFile.anInt6057 = i_29_ * 499042951;
					}
				}
				switch (-94219657 * ((Class298_Sub32_Sub17) this).anInt9430) {
				case 1:
				...
				case 3:
					...
					break;
				case 4:
					is[i_19_] = -1065886921 * JagexFile.anInt6057;
					break;
				case 0:
			...
			for (int i_33_ = 0; i_33_ < Class250.anInt2755 * -1474554145; i_33_++) {
				...
				for (int i_37_ = i_31_ - 1; i_37_ <= i_32_; i_37_++) {
					...
					for (int i_39_ = i_35_ - 1; i_39_ <= i_36_; i_39_++) {
						...
						} else if (i_43_ < JagexFile.anInt6057 * -1065886921)
							JagexFile.anInt6057 = i_43_ * 499042951;
					}
				}
				switch (-94219657 * ((Class298_Sub32_Sub17) this).anInt9430) {
				case 1:
				...
				case 3:
					...
					break;
				case 4:
					is[i_33_] = -1065886921 * JagexFile.anInt6057;
					break;
				case 0:
