...
public class Class324 {
	...
	int anInt3447;
	public List<Class335> aList3448 = new LinkedList<Class335>();

	public void method3956(int i) {
		try {
			Iterator<Class335> iterator = aList3448.iterator();
	...
	void method3957(Class335 class335, int i) {
		try {
			...
			if (!bool) {
				...
				ListIterator<Class335> listiterator = aList3448.listIterator();
				while_78_: do {
	...
	static final void method3958(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
