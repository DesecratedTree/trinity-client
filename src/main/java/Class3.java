...
public class Class3 {
	...
	public static void savePreferences(int i) {
		try {
			...
			try {
				class476 = Class86.getPreferences("", client.aClass411_8944.aString5317, true, -1804643872);
				RsByteBuffer class298_sub53 = Class422_Sub25.preferences.encode(-804179286);
	...
	static final void method301(ClientScript2 class403, byte i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub16_7557, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, -223155318);
			savePreferences(656179282);
