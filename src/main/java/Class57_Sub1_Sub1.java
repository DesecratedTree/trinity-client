...
public class Class57_Sub1_Sub1 extends Class57_Sub1 {
	...
	void method684(int[] is, int[] is_0_, int i, int i_1_) {
		int[] is_2_ = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).pixels);
		if (is_2_ != null) {
			if (anInt9004 == 0) {
				if (anInt8991 == 0) {
					int i_3_ = anInt9001;
	...
	Class57_Sub1_Sub1(SafemodeToolkit class_ra_sub1, int[] is, int i, int i_132_, int i_133_, int i_134_, boolean bool) {
	...
	Class57_Sub1_Sub1(SafemodeToolkit class_ra_sub1, int[] is, int i, int i_138_) {
		super(class_ra_sub1, i, i_138_);
		((Class57_Sub1_Sub1) this).anIntArray9965 = is;
	}

	public void method675(int i, int i_139_, int i_140_, int i_141_, int i_142_, int i_143_) {
		int[] is = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).pixels);
		if (is == null)
	...
	public void method632(int i, int i_148_, int i_149_) {
		...
		if (i_149_ == 0) {
			for (int i_150_ = 0; i_150_ < ((Class57_Sub1_Sub1) this).anInt8989; i_150_++) {
				...
				int i_152_ = (((i_148_ + i_150_) * (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883)) + i);
			...
			for (int i_154_ = 0; i_154_ < ((Class57_Sub1_Sub1) this).anInt8989; i_154_++) {
				...
				int i_156_ = (((i_148_ + i_154_) * (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883)) + i);
			...
			for (int i_158_ = 0; i_158_ < ((Class57_Sub1_Sub1) this).anInt8989; i_158_++) {
				...
				int i_160_ = (((i_148_ + i_158_) * (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883)) + i);
			...
			for (int i_162_ = 0; i_162_ < ((Class57_Sub1_Sub1) this).anInt8989; i_162_++) {
				...
				int i_164_ = (((i_148_ + i_162_) * (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883)) + i);
	...
	public void drawSprite(int i, int i_166_, int i_167_, int i_168_, int i_169_) {
		if (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006.method5196())
			throw new IllegalStateException();
		int[] is = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).pixels);
		if (is != null) {
			int i_170_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883);
			...
			int i_176_ = 0;
			if (i_166_ < (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805)) {
				int i_177_ = ((((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_166_);
				i_173_ -= i_177_;
				i_166_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805);
				i_172_ += i_177_ * i_174_;
				i_171_ += i_177_ * i_170_;
			}
			if (i_166_ + i_173_ > (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7977) * 63686679)
				i_173_ -= (i_166_ + i_173_ - (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977) * 63686679);
			if (i < (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
				int i_178_ = ((((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
				i_174_ -= i_178_;
				i = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679);
				i_172_ += i_178_;
				i_171_ += i_178_;
				i_176_ += i_178_;
				i_175_ += i_178_;
			}
			if (i + i_174_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
				int i_179_ = (i + i_174_ - (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7991) * -1416794725);
				i_174_ -= i_179_;
				i_176_ += i_179_;
				i_175_ += i_179_;
			}
	...
	void method678(boolean bool, boolean bool_283_, boolean bool_284_, int i, int i_285_, float f, int i_286_, int i_287_, int i_288_, int i_289_, int i_290_, int i_291_, boolean bool_292_) {
		if (i_286_ > 0 && i_287_ > 0 && (bool || bool_283_)) {
			...
			int i_301_ = i + i_285_ * ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971) * 692106883);
			int i_302_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883) - i_286_);
			if (i_285_ + i_287_ > (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7977) * 63686679)
				i_287_ -= (i_285_ + i_287_ - (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977) * 63686679);
			if (i_285_ < (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805)) {
				int i_303_ = ((((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_285_);
				i_287_ -= i_303_;
				i_301_ += i_303_ * ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971) * 692106883);
				i_294_ += i_298_ * i_303_;
			}
			if (i + i_286_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
				int i_304_ = (i + i_286_ - (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7991) * -1416794725);
				i_286_ -= i_304_;
				i_302_ += i_304_;
			}
			if (i < (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
				int i_305_ = ((((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
				i_286_ -= i_305_;
				i_301_ += i_305_;
				i_293_ += i_297_ * i_305_;
				i_302_ += i_305_;
			}
			float[] fs = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).aFloatArray7973);
			int[] is = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).pixels);
			if (i_290_ == 0) {
				if (i_288_ == 1) {
					int i_306_ = i_293_;
	...
	void method635(int i, int i_435_, int i_436_, int i_437_, int i_438_, int i_439_, int i_440_, int i_441_) {
		...
		if (i_436_ > 0 && i_437_ > 0) {
			...
			if (is != null) {
				int i_442_ = 0;
				int i_443_ = 0;
				int i_444_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883);
				...
				if (i_435_ + i_437_ > (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7977 * 63686679))
					i_437_ -= (i_435_ + i_437_ - (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7977) * 63686679);
				if (i_435_ < (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7976) * -1278653805) {
					int i_453_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976) * -1278653805 - i_435_);
					i_437_ -= i_453_;
					i_451_ += i_453_ * i_444_;
					i_443_ += i_448_ * i_453_;
				}
				if (i + i_436_ > (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7991) * -1416794725) {
					int i_454_ = (i + i_436_ - (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7991) * -1416794725);
					i_436_ -= i_454_;
					i_452_ += i_454_;
				}
				if (i < (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974 * -912871679)) {
					int i_455_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974) * -912871679 - i);
					i_436_ -= i_455_;
					i_451_ += i_455_;
	...
	void method681(int[] is, int[] is_584_, int i, int i_585_) {
		int[] is_586_ = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).pixels);
		if (is_586_ != null) {
			if (anInt9004 == 0) {
				if (anInt8991 == 0) {
	...
	public void method628(int i, int i_716_, int i_717_) {
		...
		if (i_717_ == 0) {
			for (int i_718_ = 0; i_718_ < ((Class57_Sub1_Sub1) this).anInt8989; i_718_++) {
				...
				int i_720_ = (((i_716_ + i_718_) * (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883)) + i);
			...
			for (int i_722_ = 0; i_722_ < ((Class57_Sub1_Sub1) this).anInt8989; i_722_++) {
				...
				int i_724_ = (((i_716_ + i_722_) * (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883)) + i);
			...
			for (int i_726_ = 0; i_726_ < ((Class57_Sub1_Sub1) this).anInt8989; i_726_++) {
				...
				int i_728_ = (((i_716_ + i_726_) * (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883)) + i);
			...
			for (int i_730_ = 0; i_730_ < ((Class57_Sub1_Sub1) this).anInt8989; i_730_++) {
				...
				int i_732_ = (((i_716_ + i_730_) * (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883)) + i);
	...
	Class57_Sub1_Sub1(SafemodeToolkit class_ra_sub1, int i, int i_734_) {
	...
	public void method643(int i, int i_1369_, int i_1370_, int i_1371_, int i_1372_) {
		...
		int[] is = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).pixels);
		if (is != null) {
			int i_1373_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883);
			i += ((Class57_Sub1_Sub1) this).anInt8990;
			...
			int i_1379_ = 0;
			if (i_1369_ < (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805)) {
				int i_1380_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976) * -1278653805 - i_1369_);
				i_1376_ -= i_1380_;
				i_1369_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805);
				i_1375_ += i_1380_ * i_1377_;
				i_1374_ += i_1380_ * i_1373_;
			}
			if (i_1369_ + i_1376_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977 * 63686679))
				i_1376_ -= (i_1369_ + i_1376_ - (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977) * 63686679);
			if (i < (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
				int i_1381_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974) * -912871679 - i);
				i_1377_ -= i_1381_;
				i = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679);
				i_1375_ += i_1381_;
				i_1374_ += i_1381_;
			...
			if (i + i_1377_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
				int i_1382_ = (i + i_1377_ - (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7991) * -1416794725);
				i_1377_ -= i_1382_;
				i_1379_ += i_1382_;
				i_1378_ += i_1382_;
			}
	...
	public void method649(int i, int i_1486_, int i_1487_, int i_1488_, int i_1489_) {
		...
		int[] is = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).pixels);
		if (is != null) {
			int i_1490_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883);
			i += ((Class57_Sub1_Sub1) this).anInt8990;
			...
			int i_1496_ = 0;
			if (i_1486_ < (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805)) {
				int i_1497_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976) * -1278653805 - i_1486_);
				i_1493_ -= i_1497_;
				i_1486_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805);
				i_1492_ += i_1497_ * i_1494_;
				i_1491_ += i_1497_ * i_1490_;
			}
			if (i_1486_ + i_1493_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977 * 63686679))
				i_1493_ -= (i_1486_ + i_1493_ - (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977) * 63686679);
			if (i < (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
				int i_1498_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974) * -912871679 - i);
				i_1494_ -= i_1498_;
				i = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679);
				i_1492_ += i_1498_;
				i_1491_ += i_1498_;
			...
			if (i + i_1494_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
				int i_1499_ = (i + i_1494_ - (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7991) * -1416794725);
				i_1494_ -= i_1499_;
				i_1496_ += i_1499_;
				i_1495_ += i_1499_;
			}
	...
	public void method654(int i, int i_1603_, Class_ta class_ta, int i_1604_, int i_1605_) {
		...
		if (is != null) {
			...
			int i_1606_ = 0;
			int i_1607_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883);
			...
			if (i_1603_ < (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805)) {
				int i_1613_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976) * -1278653805 - i_1603_);
				i_1609_ -= i_1613_;
				i_1603_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805);
				i_1606_ += i_1613_ * i_1608_;
				i_1612_ += i_1613_ * i_1607_;
			}
			if (i_1603_ + i_1609_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977 * 63686679))
				i_1609_ -= (i_1603_ + i_1609_ - (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977) * 63686679);
			if (i < (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
				int i_1614_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974) * -912871679 - i);
				i_1608_ -= i_1614_;
				i = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679);
				i_1606_ += i_1614_;
				i_1612_ += i_1614_;
			...
			if (i + i_1608_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
				int i_1615_ = (i + i_1608_ - (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7991) * -1416794725);
				i_1608_ -= i_1615_;
				i_1611_ += i_1615_;
				i_1610_ += i_1615_;
			}
	...
	public void method674(int i, int i_1632_, int i_1633_, int i_1634_, int i_1635_) {
		...
		int[] is = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).pixels);
		if (is != null) {
			int i_1636_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883);
			i += ((Class57_Sub1_Sub1) this).anInt8990;
			...
			int i_1642_ = 0;
			if (i_1632_ < (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805)) {
				int i_1643_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976) * -1278653805 - i_1632_);
				i_1639_ -= i_1643_;
				i_1632_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805);
				i_1638_ += i_1643_ * i_1640_;
				i_1637_ += i_1643_ * i_1636_;
			}
			if (i_1632_ + i_1639_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977 * 63686679))
				i_1639_ -= (i_1632_ + i_1639_ - (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977) * 63686679);
			if (i < (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
				int i_1644_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974) * -912871679 - i);
				i_1640_ -= i_1644_;
				i = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679);
				i_1638_ += i_1644_;
				i_1637_ += i_1644_;
			...
			if (i + i_1640_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
				int i_1645_ = (i + i_1640_ - (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7991) * -1416794725);
				i_1640_ -= i_1645_;
				i_1642_ += i_1645_;
				i_1641_ += i_1645_;
			}
	...
	public void method650(int i, int i_1749_, Class_ta class_ta, int i_1750_, int i_1751_) {
		...
		if (is != null) {
			...
			int i_1752_ = 0;
			int i_1753_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883);
			...
			if (i_1749_ < (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805)) {
				int i_1759_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976) * -1278653805 - i_1749_);
				i_1755_ -= i_1759_;
				i_1749_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805);
				i_1752_ += i_1759_ * i_1754_;
				i_1758_ += i_1759_ * i_1753_;
			}
			if (i_1749_ + i_1755_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977 * 63686679))
				i_1755_ -= (i_1749_ + i_1755_ - (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977) * 63686679);
			if (i < (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
				int i_1760_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974) * -912871679 - i);
				i_1754_ -= i_1760_;
				i = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679);
				i_1752_ += i_1760_;
				i_1758_ += i_1760_;
			...
			if (i + i_1754_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
				int i_1761_ = (i + i_1754_ - (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7991) * -1416794725);
				i_1754_ -= i_1761_;
				i_1757_ += i_1761_;
				i_1756_ += i_1761_;
			}
	...
	void method652(int i, int i_2412_, int i_2413_, int i_2414_, int i_2415_, int i_2416_, int i_2417_, int i_2418_) {
		...
		if (i_2413_ > 0 && i_2414_ > 0) {
			...
			if (is != null) {
				int i_2419_ = 0;
				int i_2420_ = 0;
				int i_2421_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883);
				...
				if (i_2412_ + i_2414_ > (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7977 * 63686679))
					i_2414_ -= (i_2412_ + i_2414_ - (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7977) * 63686679);
				if (i_2412_ < (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7976) * -1278653805) {
					int i_2430_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976) * -1278653805 - i_2412_;
					i_2414_ -= i_2430_;
					i_2428_ += i_2430_ * i_2421_;
					i_2420_ += i_2425_ * i_2430_;
				}
				if (i + i_2413_ > (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7991) * -1416794725) {
					int i_2431_ = (i + i_2413_ - (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7991) * -1416794725);
					i_2413_ -= i_2431_;
					i_2429_ += i_2431_;
				}
				if (i < (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974 * -912871679)) {
					int i_2432_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974) * -912871679 - i;
					i_2413_ -= i_2432_;
					i_2428_ += i_2432_;
	...
	public void method648(int i, int i_2561_, int i_2562_, int i_2563_, int i_2564_) {
		...
		int[] is = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).pixels);
		if (is != null) {
			int i_2565_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883);
			i += ((Class57_Sub1_Sub1) this).anInt8990;
			...
			int i_2571_ = 0;
			if (i_2561_ < (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805)) {
				int i_2572_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976) * -1278653805 - i_2561_);
				i_2568_ -= i_2572_;
				i_2561_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805);
				i_2567_ += i_2572_ * i_2569_;
				i_2566_ += i_2572_ * i_2565_;
			}
			if (i_2561_ + i_2568_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977 * 63686679))
				i_2568_ -= (i_2561_ + i_2568_ - (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977) * 63686679);
			if (i < (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
				int i_2573_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974) * -912871679 - i);
				i_2569_ -= i_2573_;
				i = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679);
				i_2567_ += i_2573_;
				i_2566_ += i_2573_;
			...
			if (i + i_2569_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
				int i_2574_ = (i + i_2569_ - (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7991) * -1416794725);
				i_2569_ -= i_2574_;
				i_2571_ += i_2574_;
				i_2570_ += i_2574_;
			}
	...
	void method683(int[] is, int[] is_3312_, int i, int i_3313_) {
		int[] is_3314_ = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).pixels);
		if (is_3314_ != null) {
			if (anInt9004 == 0) {
				if (anInt8991 == 0) {
	...
	void method651(int i, int i_3444_, int i_3445_, int i_3446_, int i_3447_, int i_3448_, int i_3449_, int i_3450_) {
		...
		if (i_3445_ > 0 && i_3446_ > 0) {
			...
			if (is != null) {
				int i_3451_ = 0;
				int i_3452_ = 0;
				int i_3453_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883);
				...
				if (i_3444_ + i_3446_ > (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7977 * 63686679))
					i_3446_ -= (i_3444_ + i_3446_ - (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7977) * 63686679);
				if (i_3444_ < (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7976) * -1278653805) {
					int i_3462_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976) * -1278653805 - i_3444_;
					i_3446_ -= i_3462_;
					i_3460_ += i_3462_ * i_3453_;
					i_3452_ += i_3457_ * i_3462_;
				}
				if (i + i_3445_ > (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7991) * -1416794725) {
					int i_3463_ = (i + i_3445_ - (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7991) * -1416794725);
					i_3445_ -= i_3463_;
					i_3461_ += i_3463_;
				}
				if (i < (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974 * -912871679)) {
					int i_3464_ = (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974) * -912871679 - i;
					i_3445_ -= i_3464_;
					i_3460_ += i_3464_;
	...
	void method682(boolean bool, boolean bool_3593_, boolean bool_3594_, int i, int i_3595_, float f, int i_3596_, int i_3597_, int i_3598_, int i_3599_, int i_3600_, int i_3601_, boolean bool_3602_) {
		if (i_3596_ > 0 && i_3597_ > 0 && (bool || bool_3593_)) {
			...
			int i_3611_ = i + i_3595_ * ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971) * 692106883);
			int i_3612_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971 * 692106883) - i_3596_);
			if (i_3595_ + i_3597_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977 * 63686679))
				i_3597_ -= (i_3595_ + i_3597_ - (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7977) * 63686679);
			if (i_3595_ < (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976 * -1278653805)) {
				int i_3613_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7976) * -1278653805 - i_3595_);
				i_3597_ -= i_3613_;
				i_3611_ += i_3613_ * ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7971) * 692106883);
				i_3604_ += i_3608_ * i_3613_;
			}
			if (i + i_3596_ > (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
				int i_3614_ = (i + i_3596_ - (((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7991) * -1416794725);
				i_3596_ -= i_3614_;
				i_3612_ += i_3614_;
			}
			if (i < (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
				int i_3615_ = ((((SafemodeToolkit) (((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006)).anInt7974) * -912871679 - i);
				i_3596_ -= i_3615_;
				i_3611_ += i_3615_;
	...
	void method685(int[] is, int[] is_3745_, int i, int i_3746_) {
		int[] is_3747_ = (((SafemodeToolkit) ((Class57_Sub1_Sub1) this).aClass_ra_Sub1_9006).pixels);
		if (is_3747_ != null) {
			if (anInt9004 == 0) {
				if (anInt8991 == 0) {
