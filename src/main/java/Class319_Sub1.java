...
public class Class319_Sub1 extends Class319 implements MouseListener, MouseMotionListener, MouseWheelListener {
	...
	void method3906(int i) {
		try {
			if (null != ((Class319_Sub1) this).aComponent7702) {
				...
				((Class319_Sub1) this).events = null;
			}
		} catch (RuntimeException runtimeexception) {
	...
	void method3907(int i, int i_0_, int i_1_) {
		try {
			...
			if (((Class319_Sub1) this).aBoolean7703)
				addEvent(-1, i, i_0_, 0, 1553525097);
		} catch (RuntimeException runtimeexception) {
	...
	public synchronized void mousePressed(MouseEvent mouseevent) {
		try {
			...
			if (1 == i)
				addEvent(0, mouseevent.getX(), mouseevent.getY(), mouseevent.getClickCount(), 1989072538);
			else if (i == 4)
				addEvent(2, mouseevent.getX(), mouseevent.getY(), mouseevent.getClickCount(), 1922972976);
			else if (2 == i)
				addEvent(1, mouseevent.getX(), mouseevent.getY(), mouseevent.getClickCount(), 2016030026);
	...
	public synchronized void mouseReleased(MouseEvent mouseevent) {
		try {
			...
			if ((i & 0x1) != 0)
				addEvent(3, mouseevent.getX(), mouseevent.getY(), mouseevent.getClickCount(), 1931509920);
			if ((i & 0x4) != 0)
				addEvent(5, mouseevent.getX(), mouseevent.getY(), mouseevent.getClickCount(), 1062616351);
			if ((i & 0x2) != 0)
				addEvent(4, mouseevent.getX(), mouseevent.getY(), mouseevent.getClickCount(), 1204760399);
	...
	public synchronized void mouseWheelMoved(MouseWheelEvent mousewheelevent) {
		try {
			...
			addEvent(6, i, i_6_, i_7_, 1166829560);
	...
	public synchronized void method3877() {
		...
		((Class319_Sub1) this).aClass453_7697 = ((Class319_Sub1) this).events;
		((Class319_Sub1) this).events = class453;
		((Class319_Sub1) this).events.clear((byte) 1);
	}
