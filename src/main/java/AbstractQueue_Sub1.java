...
public class AbstractQueue_Sub1 extends AbstractQueue<Object> {
	java.util.Map<Object, Class170> aMap6312;
	Class170[] aClass170Array6313;
	int anInt6314;
	Comparator<Object> aComparator6315;
	int anInt6316 = 0;
			...
			for (int i_2_ = (((AbstractQueue_Sub1) this).anInt6314 * -400292665 >>> 1); i < i_2_; i = i_1_) {
				...
				if (((AbstractQueue_Sub1) this).aComparator6315 != null) {
					if ((i_5_ < ((AbstractQueue_Sub1) this).anInt6314 * -400292665) && (((AbstractQueue_Sub1) this).aComparator6315.compare(((Class170) class170_4_).anObject1738, ((Class170) class170_6_).anObject1738)) > 0)
						...
						i_1_ = i_3_;
				} else if (i_5_ < (((AbstractQueue_Sub1) this).anInt6314 * -400292665) && (((Comparable<Object>) ((Class170) class170_4_).anObject1738).compareTo(((Class170) class170_6_).anObject1738)) > 0)
					i_1_ = i_5_;
				else
					i_1_ = i_3_;
				if (((AbstractQueue_Sub1) this).aComparator6315 != null) {
				...
				} else if ((((Comparable<Object>) ((Class170) class170).anObject1738).compareTo(((Class170) (((AbstractQueue_Sub1) this).aClass170Array6313[i_1_])).anObject1738)) <= 0) {
					if (i_0_ <= -2010017327)
						throw new IllegalStateException();
					break;
				}
	...
	AbstractQueue_Sub1(int i, Comparator<Object> comparator) {
		((AbstractQueue_Sub1) this).aClass170Array6313 = new Class170[i];
		((AbstractQueue_Sub1) this).aMap6312 = new HashMap<Object, Class170>();
	...
	void method6384(int i) {
		try {
			...
			((AbstractQueue_Sub1) this).aClass170Array6313 = Arrays.copyOf((((AbstractQueue_Sub1) this).aClass170Array6313), i_7_);
		} catch (RuntimeException runtimeexception) {
	...
	void method6385(int i, int i_8_) {
		try {
			...
			for (/**/; i > 0; i = i_9_) {
				...
				} else if ((((Comparable<Object>) ((Class170) class170).anObject1738).compareTo(((Class170) class170_10_).anObject1738)) >= 0) {
					if (i_8_ >= 802255489)
						throw new IllegalStateException();
					break;
				}
	...
	public boolean remove(Object object) {
		try {
			Class170 class170 = ((AbstractQueue_Sub1) this).aMap6312.remove(object);
			if (null == class170)
				return false;
			((AbstractQueue_Sub1) this).anInt6316 += 1445240763;
			((AbstractQueue_Sub1) this).anInt6314 -= -2003206921;
