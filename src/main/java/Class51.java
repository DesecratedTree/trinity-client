...
public class Class51 {
	...
	static final void method542(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.antialiasing.method5675(-254007730);
		} catch (RuntimeException runtimeexception) {
