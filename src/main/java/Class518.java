...
public class Class518 {
	...
	public Class518(Class411 class411, Class429 class429, CacheIndex class243) {
		...
		((Class518) this).aClass243_6271.method2316((-1006924897 * (ConfigFile.itemContainersConfig.anInt1460)), 689615038);
	}

	public ItemContainerConfig method6311(int i, int i_0_) {
		try {
			ItemContainerConfig class298_sub37_sub10;
			synchronized (((Class518) this).aClass348_6272) {
				class298_sub37_sub10 = ((ItemContainerConfig) ((Class518) this).aClass348_6272.get((long) i));
			}
			if (null != class298_sub37_sub10)
				return class298_sub37_sub10;
			byte[] is;
			synchronized (((Class518) this).aClass243_6271) {
				is = (((Class518) this).aClass243_6271.getFileFromArchive(-1006924897 * ConfigFile.itemContainersConfig.anInt1460, i, (byte) -26));
			}
			class298_sub37_sub10 = new ItemContainerConfig();
			if (null != is)
				class298_sub37_sub10.method3444(new RsByteBuffer(is), (byte) -66);
			CustomItemContainerConfig.modify(i, class298_sub37_sub10);
			synchronized (((Class518) this).aClass348_6272) {
	...
	static void method6314(int i, int i_3_) {
		try {
			if (Class422_Sub25.preferences.aClass422_Sub30_7575.method5730(1899706472) == 0)
				i = -1;
	...
	static final void method6315(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			class105.shadowColor = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) * -1448553585;
	...
	static final void method6316(ClientScript2 class403, int i) {
		try {
			...
			if (!FloorOverlay.graphics.method5050())
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = Class422_Sub25.preferences.aClass422_Sub6_7551.method5612(i_4_, 1352882135);
		} catch (RuntimeException runtimeexception) {
