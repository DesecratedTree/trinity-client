...
public class Class381 {
	...
	public Shortcut aClass355_4114;
	public Shortcut aClass355_4115;
	public Shortcut aClass355_4116;
	...
	void method4683(RsByteBuffer class298_sub53, int i) {
		try {
			for (;;) {
				...
				if (1 == i_0_)
					anInterface19_4113 = ObjectConfig.method5786(class298_sub53, (byte) -24);
				else if (i_0_ == 2)
					anInterface19_4109 = ObjectConfig.method5786(class298_sub53, (byte) 2);
				else if (3 == i_0_)
					anInterface19_4111 = ObjectConfig.method5786(class298_sub53, (byte) -93);
				else if (4 == i_0_)
					anInterface19_4112 = ObjectConfig.method5786(class298_sub53, (byte) -56);
				else if (i_0_ == 5)
					...
					ObjectConfig.method5786(class298_sub53, (byte) -104);
				else if (i_0_ == 9)
					ObjectConfig.method5786(class298_sub53, (byte) -11);
				else if (i_0_ == 10)
					ObjectConfig.method5786(class298_sub53, (byte) -108);
				else if (11 == i_0_)
					aBoolean4118 = true;
				else if (i_0_ == 12)
