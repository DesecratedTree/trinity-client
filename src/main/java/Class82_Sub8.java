...
public class Class82_Sub8 extends Class82 {
	...
	public void method866(int i) {
		try {
			IntegerValue class298_sub35 = ((IntegerValue) Class87.aClass437_793.method5812(8017746467363524815L * (((Class82_Sub8) this).aLong6853)));
			if (class298_sub35 != null)
				class298_sub35.intValue = -1178949921 * ((Class82_Sub8) this).anInt6854;
			else
				Class87.aClass437_793.method5817(new IntegerValue(825940513 * ((Class82_Sub8) this).anInt6854), ((Class82_Sub8) this).aLong6853 * 8017746467363524815L);
	...
	static final void method892(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_0_, (byte) -30);
	...
	static final void method894(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub14_7570.method5612(i_2_, 1352882135);
		} catch (RuntimeException runtimeexception) {
