...
public class Class458 {
	...
	public Class298 method5964(int i) {
		try {
			Class298 class298 = aClass298_5668.first;
			if (class298 == aClass298_5668) {
				((Class458) this).aClass298_5669 = null;
				return null;
			}
			((Class458) this).aClass298_5669 = class298.first;
			return class298;
	...
	public void method5965(Class298 class298, int i) {
		try {
			...
			class298.first = aClass298_5668;
			class298.last = aClass298_5668.last;
	...
	public Class298 method5966(byte i) {
		try {
			Class298 class298 = ((Class458) this).aClass298_5669;
	...
	public Class298 method5967(int i) {
		try {
			Class298 class298 = aClass298_5668.last;
			if (class298 == aClass298_5668) {
				((Class458) this).aClass298_5669 = null;
				return null;
			}
			((Class458) this).aClass298_5669 = class298.last;
			return class298;
		} catch (RuntimeException runtimeexception) {
	...
	public void method5968(Class298 class298, int i) {
		try {
			if (class298.first != null)
				class298.remove(-1460969981);
			class298.first = aClass298_5668.first;
			class298.last = aClass298_5668;
			class298.first.last = class298;
			class298.last.first = class298;
		} catch (RuntimeException runtimeexception) {
	...
	public boolean method5970(byte i) {
		try {
			return aClass298_5668.last == aClass298_5668;
		} catch (RuntimeException runtimeexception) {
	...
	public Class458() {
		aClass298_5668.last = aClass298_5668;
		aClass298_5668.first = aClass298_5668;
	}
	...
	static final void method5974(ClientScript2 class403, byte i) {
		try {
			if (null != Class375.aClass298_Sub25_4084) {
				...
				((ClientScript2) class403).aClass298_Sub25_5237 = Class375.aClass298_Sub25_4084;
			} else
