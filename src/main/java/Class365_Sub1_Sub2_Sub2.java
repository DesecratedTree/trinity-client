...
public class Class365_Sub1_Sub2_Sub2 extends Class365_Sub1_Sub2 implements Interface3 {
	...
	public Class334 method4358(GraphicsToolkit class_ra, byte i) {
		try {
			...
			if (((Class365_Sub1_Sub2_Sub2) this).aClass334_9920 == null)
				((Class365_Sub1_Sub2_Sub2) this).aClass334_9920 = Class472.method6063((int) class217.x, (int) class217.aFloat2455, (int) class217.y, method4501(class_ra, 0, (byte) 68), 2029931481);
	...
	Class454 method4502(GraphicsToolkit class_ra, int i, boolean bool, int i_1_) {
		try {
			ObjectConfig class432 = (((Class365_Sub1_Sub2_Sub2) this).aClass433_9918.getObjectDefinitions(2049836463 * ((Class365_Sub1_Sub2_Sub2) this).anInt9915));
			Class_xa class_xa;
			...
			SceneObjectPosition class217 = method4337().aClass217_2599;
			return (class432.method5785(class_ra, i, Class424.aClass424_6610.anInt6613 * -1976050083, ((Class365_Sub1_Sub2_Sub2) this).aByte9917, class_xa, class_xa_2_, (int) class217.x, (int) class217.aFloat2455, (int) class217.y, bool, null, -474476261));
		} catch (RuntimeException runtimeexception) {
	...
	public void method37(GraphicsToolkit class_ra, int i) {
		try {
			...
			SceneObjectPosition class217 = method4337().aClass217_2599;
			if (class_na != null)
				aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 174451452);
		} catch (RuntimeException runtimeexception) {
	...
	public void method28(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (null != class_na)
			aClass331_7722.method4055(class_na, aByte7724, (int) class217.x, (int) class217.y, null, -1115505976);
	}
	...
	public void method43(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (class_na != null)
			aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 1644514804);
	}
	...
	public void method40(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (class_na != null)
			aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 710992193);
	}

	public Class365_Sub1_Sub2_Sub2(Class331 class331, GraphicsToolkit class_ra, Class433 class433, ObjectConfig class432, int i, int i_9_, int i_10_, int i_11_, int i_12_, boolean bool, int i_13_, boolean bool_14_) {
		super(class331, i_10_, i_11_, i_12_, i, i_9_, class432.anInt5418 * -228547261);
		((Class365_Sub1_Sub2_Sub2) this).aClass433_9918 = class433;
		((Class365_Sub1_Sub2_Sub2) this).anInt9915 = 646380829 * class432.id;
		((Class365_Sub1_Sub2_Sub2) this).aBoolean9916 = bool;
		((Class365_Sub1_Sub2_Sub2) this).aByte9917 = (byte) i_13_;
		((Class365_Sub1_Sub2_Sub2) this).aBoolean9919 = class432.optionType * 1532834983 != 0 && !bool;
		((Class365_Sub1_Sub2_Sub2) this).aBoolean9912 = bool_14_;
		((Class365_Sub1_Sub2_Sub2) this).aBoolean9921 = (class_ra.method5082() && class432.scenaryShadows && !((Class365_Sub1_Sub2_Sub2) this).aBoolean9916 && Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(-1930969884) != 0);
		int i_15_ = 2048;
	...
	public Class334 method4367(GraphicsToolkit class_ra) {
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (((Class365_Sub1_Sub2_Sub2) this).aClass334_9920 == null)
			((Class365_Sub1_Sub2_Sub2) this).aClass334_9920 = Class472.method6063((int) class217.x, (int) class217.aFloat2455, (int) class217.y, method4501(class_ra, 0, (byte) 71), 1982463178);
		return ((Class365_Sub1_Sub2_Sub2) this).aClass334_9920;
	}
	...
	public Class334 method4368(GraphicsToolkit class_ra) {
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (((Class365_Sub1_Sub2_Sub2) this).aClass334_9920 == null)
			((Class365_Sub1_Sub2_Sub2) this).aClass334_9920 = Class472.method6063((int) class217.x, (int) class217.aFloat2455, (int) class217.y, method4501(class_ra, 0, (byte) 44), 2033804861);
		return ((Class365_Sub1_Sub2_Sub2) this).aClass334_9920;
	}
	...
	Class335 method4370(GraphicsToolkit class_ra) {
		...
		((Class365_Sub1_Sub2_Sub2) this).aClass387_9913.drawModel(class222, aClass302_Sub1Array7726[0], 0);
		return class335;
	}
	...
	public void method44(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (class_na != null)
			aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 193928700);
	}
	...
	public void method33(GraphicsToolkit class_ra, int i) {
		try {
			...
			SceneObjectPosition class217 = method4337().aClass217_2599;
			if (null != class_na)
				aClass331_7722.method4055(class_na, aByte7724, (int) class217.x, (int) class217.y, null, -412237236);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4503(ClientScript2 class403, int i) {
		try {
			int i_25_ = (((ClientScript2) class403).integerstack[((ClientScript2) class403).integerPos * 1883543357]);
