...
public class Class256 {
	...
	public Class298_Sub37_Sub8 method2441(int i, int i_0_) {
		try {
			Class298_Sub37_Sub8 class298_sub37_sub8 = ((Class298_Sub37_Sub8) ((Class256) this).aClass348_2798.get((long) i));
			if (null != class298_sub37_sub8)
				return class298_sub37_sub8;
			byte[] is;
			if (i >= 32768)
				is = ((Class256) this).aClass243_2797.getFileFromArchive(0, i & 0x7fff, (byte) -102);
			else
				is = ((Class256) this).aClass243_2796.getFileFromArchive(0, i, (byte) -91);
	...
	static final void method2443(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_2_, (byte) 44);
	...
	static final void method2444(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_3_, (byte) -44);
	...
	static int[] method2446(Class298_Sub36 class298_sub36, int i) {
		try {
			...
			class298_sub53.applyRsa(Class50.aBigInteger500, Class50.MODULUS, 1970926718);
