...
public class Class431 implements Interface15 {
	...
	static void method5766(int i) {
		try {
			...
			for (int i_16_ = 0; i_16_ < 1962237353 * client.npcCount; i_16_++) {
				Entity class365_sub1_sub1_sub2 = ((Entity) client.npcs[i_16_].value);
		...
		try {
			if (null != class365_sub1_sub1_sub2.anIntArray10093) {
				...
				if (bool_23_ && class438.method5819((byte) -38)) {
					AnimationConfig class391 = class365_sub1_sub1_sub2.aClass438_10078.method5820(1190945096);
			...
			for (int i_27_ = 0; i_27_ < is.length; i_27_++) {
				if (is[i_27_] != -1)
					bool_26_ = false;
				if (null == class365_sub1_sub1_sub2.anIntArray10093 || -1 == class365_sub1_sub1_sub2.anIntArray10093[i_27_] || ((Class501.aClass395_6122.method4903(is[i_27_], (byte) -62).priority) * -1445588039 >= (Class501.aClass395_6122.method4903(class365_sub1_sub1_sub2.anIntArray10093[i_27_], (byte) -47).priority) * -1445588039)) {
