...
public class Class384 {
	...
	static final void method4695(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_0_, (byte) -36);
	...
	static final void method4696(ClientScript2 class403, int i) {
		...
		/*	if (class483.aChar6042 != i_1_ || class483.aChar6037 != i_2_)
			...
			if (i_2_ == 115)
				...
				if (class483.id == 733) {
					Integer value = CustomItems.customShopPrices.get(i_4_);
					if (value != null) {
						((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = value;
						return;
					}
				}
	...
	static final void method4697(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.displayMode.get((byte) 45);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4698(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub11_7558.method5612(i_5_, 1352882135);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("py.aoj(").append(')').toString());
		}
	}

	public static boolean searchSpawn;
	...
	static void method4699(String string, boolean bool, int i, int i_6_, String string_7_, boolean bool_8_, short i_9_) {
		try {
			...
			for (int i_13_ = 0; i_13_ < (Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength * -888767613); i_13_++) {
				if (i_13_ >= Settings._685_ITEM_OFFSET)
					continue;
				if (searchSpawn  && (i_13_ == 18786 || i_13_ == 6199 || i_13_ == 51284)) //broken ids
					continue;
				if ((i_13_ >= Settings.OSRS_ITEM_OFFSET && i_13_ < 40500)) //osrs repeated
					continue;
				ItemConfig class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_13_, true);
				if (searchSpawn &&
						(i_13_ >= 25354 && i_13_ < Settings.OSRS_ITEM_OFFSET)) { //custom
					continue;
				}
				if (searchSpawn && i_13_ >= 23679 && i_13_ <= 23700) //sof
					continue;
				if (searchSpawn && (i_13_ >= 14122 && i_13_ <= 14432)) //sc items
					continue;
				if (searchSpawn && (i_13_ == 18830 || (i_13_ >= 19653 && i_13_ <= 19668) || i_13_  == 18829 || i_13_ == 21332 || i_13_ >= 15753 && i_13_ <= 18329 || i_13_ >= 20822 && i_13_ <= 20882 || i_13_ >= 18511 && i_13_ <= 18570)) //dung items
					continue;
				if (searchSpawn && -1 != 465190555 * class468.lendTemplate) { //custom
					continue;
				}
				if (searchSpawn && class468.lastManStandingTemplate > 0) { //custom
					continue;
				}
				if (!searchSpawn && -1 != class468.certTemplate * -1673957995) { //show noted items
					continue;
				}
				String completeName = class468.name + (class468.certTemplate * -1673957995 != -1 ? " (Noted)" : "");
				if (searchSpawn && foundNames.contains(completeName))
						continue;
				if (bool && !class468.tradeable && !searchSpawn) {
					if (i_9_ == 8221) {
						/* empty */
					}
				} else if (/*(-1 == class468.certTemplate * -1673957995) &&*/ -1 == 465190555 * class468.lendTemplate && 2083650097 * class468.anInt5770 == -1) {
					if (0 != 935029595 * class468.anInt5765) {
						if (i_9_ == 8221)
							return;
					} else if (class468.name.toLowerCase().indexOf(string) == -1) {
						if (i_9_ == 8221)
			...
			for (int i_16_ = 0; i_16_ < 367592105 * Class344.anInt3688; i_16_++)
				strings[i_16_] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(is[i_16_]).name) + (searchSpawn ? "(id: "+is[i_16_]+")" : "");
	...
	static final void method4702(ClientScript2 class403, int i) {
		try {
			WorldMapArea class298_sub37_sub13 = Class298_Sub7.method2864(-598938437);
			if (class298_sub37_sub13 != null) {
				boolean bool = (class298_sub37_sub13.method3451((WorldMap.baseX + 1196508279 * Class82_Sub14.anInt6875), 1882038855 * Class376.anInt4090 + WorldMap.baseY, Class388.anIntArray4156, -1054516511));
				if (bool) {
