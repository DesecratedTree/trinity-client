...
public class Class164 {
	...
	ModernToolkit aClass_ra_Sub3_1696;
	int anInt1697;
	int anInt1698;
	...
	Class164(ModernToolkit class_ra_sub3, Class169 class169, Class_xa_Sub1 class_xa_sub1, int i, int i_1_, int i_2_, int i_3_, int i_4_) {
