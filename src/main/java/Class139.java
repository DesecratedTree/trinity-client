...
public class Class139 {
	...
	public int method1545(int i, int i_0_, int i_1_) {
		try {
			int i_2_ = (Class462.screenWidth * -2110394505 > i_0_ ? -2110394505 * Class462.screenWidth : i_0_);
	...
	static final void method1547(ClientScript2 class403, byte i) {
		try {
			...
			WorldMapArea class298_sub37_sub13 = WorldMap.method3708(i_4_ >> 14 & 0x3fff, i_4_ & 0x3fff);
			if (class298_sub37_sub13 == null)
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = class298_sub37_sub13.id * -947282109;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("fq.adh(").append(')').toString());
		}
	}

	public static void drawText(String string, boolean bool, GraphicsToolkit class_ra, Class264 class264, Class505 class505, byte i) {
		try { //one of the mem leak
			...
			if (bool_5_) {
				if (Class372_Sub3.aBoolean7730 && bool_5_) {
					...
					int i_10_ = (Class14.aClass139_171.method1545(i_6_, (client.WIDTH * 775068819), -1808907629) + -994816289 * Class14.anInt170);
					int i_11_ = (Class14.aClass133_177.method1482(i_7_, (client.HEIGHT * -791746413), -750031668) + -277668631 * Class14.anInt173);
					class_ra.method5125(Atmosphere.aClass89_4142, false).method662(i_10_ + Class98_Sub2.aClass89_6932.anInt812, Class98_Sub2.aClass89_6932.anInt816 + i_11_, i_6_ - Class98_Sub2.aClass89_6932.anInt812 * 2, i_7_ - 2 * Class98_Sub2.aClass89_6932.anInt816, 1, 0, 0);
					class_ra.method5125(Class98_Sub2.aClass89_6932, true).drawSprite(i_10_, i_11_);
					Class98_Sub2.aClass89_6932.rotateLeft();
					class_ra.method5125(Class98_Sub2.aClass89_6932, true).drawSprite(i_6_ + i_10_ - i_8_, i_11_);
					Class98_Sub2.aClass89_6932.rotateDown();
					class_ra.method5125(Class98_Sub2.aClass89_6932, true).drawSprite(i_6_ + i_10_ - i_8_, i_11_ + i_7_ - i_8_);
					Class98_Sub2.aClass89_6932.rotateLeft();
					class_ra.method5125(Class98_Sub2.aClass89_6932, true).drawSprite(i_10_, i_7_ + i_11_ - i_8_);
					Class98_Sub2.aClass89_6932.rotateDown();
	...
	static final void tileTo2DCoords(int i, int i_17_, int i_18_, int i_19_, int i_20_) {
		try {
	...
	static final void method1550(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_21_, (byte) 74);
