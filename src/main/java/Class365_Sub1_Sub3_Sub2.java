...
public class Class365_Sub1_Sub3_Sub2 extends Class365_Sub1_Sub3 implements Interface3 {
	...
	static Partition HEADER_PARTITION;
	...
	public void method37(GraphicsToolkit class_ra, int i) {
		try {
			...
			if (class_na != null)
				aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 1462465403);
		} catch (RuntimeException runtimeexception) {
	...
	Class335 drawFloor(GraphicsToolkit class_ra, int i) {
		try {
			...
			((Class365_Sub1_Sub3_Sub2) this).aClass387_9925.drawModel(class222, aClass302_Sub1Array7726[0], 0);
			return class335;
		} catch (RuntimeException runtimeexception) {
	...
	public Class334 method4367(GraphicsToolkit class_ra) {
		...
		if (((Class365_Sub1_Sub3_Sub2) this).aClass334_9922 == null)
			((Class365_Sub1_Sub3_Sub2) this).aClass334_9922 = Class472.method6063((int) class217.x, (int) class217.aFloat2455, (int) class217.y, method4510(class_ra, 0, 2120690814), 2092013456);
	...
	public void method33(GraphicsToolkit class_ra, int i) {
		try {
			...
			SceneObjectPosition class217 = method4337().aClass217_2599;
			if (null != class_na)
				aClass331_7722.method4055(class_na, aByte7724, (int) class217.x, (int) class217.y, null, -1121841328);
		} catch (RuntimeException runtimeexception) {
	...
	public void method43(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (class_na != null)
			aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 206431233);
	}
	...
	public void method28(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (null != class_na)
			aClass331_7722.method4055(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 2128182901);
	}

	public Class365_Sub1_Sub3_Sub2(Class331 class331, GraphicsToolkit class_ra, Class433 class433, ObjectConfig class432, int i, int i_3_, int i_4_, int i_5_, int i_6_, boolean bool, int i_7_, int i_8_, int i_9_, int i_10_) {
		...
		((Class365_Sub1_Sub3_Sub2) this).aBoolean9930 = 0 != class432.optionType * 1532834983 && !bool;
		((Class365_Sub1_Sub3_Sub2) this).aBoolean9931 = (class_ra.method5082() && class432.scenaryShadows && !((Class365_Sub1_Sub3_Sub2) this).aBoolean9929 && Class422_Sub25.preferences.aClass422_Sub7_7581.method5650(-208809184) != 0);
		int i_11_ = 2048;
	...
	public void method44(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (class_na != null)
			aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 1342747444);
	}
	...
	public Class334 method4358(GraphicsToolkit class_ra, byte i) {
		try {
			SceneObjectPosition class217 = method4337().aClass217_2599;
			if (((Class365_Sub1_Sub3_Sub2) this).aClass334_9922 == null)
				((Class365_Sub1_Sub3_Sub2) this).aClass334_9922 = Class472.method6063((int) class217.x, (int) class217.aFloat2455, (int) class217.y, method4510(class_ra, 0, 1964135899), 2090651504);
			return ((Class365_Sub1_Sub3_Sub2) this).aClass334_9922;
		} catch (RuntimeException runtimeexception) {
	...
	public void method40(GraphicsToolkit class_ra) {
		...
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (class_na != null)
			aClass331_7722.method4047(class_na, aByte7724, (int) class217.x, (int) class217.y, null, 510453328);
	}

	public Class334 method4368(GraphicsToolkit class_ra) {
		SceneObjectPosition class217 = method4337().aClass217_2599;
		if (((Class365_Sub1_Sub3_Sub2) this).aClass334_9922 == null)
			((Class365_Sub1_Sub3_Sub2) this).aClass334_9922 = Class472.method6063((int) class217.x, (int) class217.aFloat2455, (int) class217.y, method4510(class_ra, 0, 1878583731), 1989490846);
		return ((Class365_Sub1_Sub3_Sub2) this).aClass334_9922;
	}
	...
	Class454 method4511(GraphicsToolkit class_ra, int i, boolean bool, int i_15_) {
		try {
			ObjectConfig class432 = (((Class365_Sub1_Sub3_Sub2) this).aClass433_9923.getObjectDefinitions(2016845759 * ((Class365_Sub1_Sub3_Sub2) this).anInt9926));
			Class_xa class_xa;
			...
			SceneObjectPosition class217 = method4337().aClass217_2599;
			return (class432.method5785(class_ra, i, ((Class365_Sub1_Sub3_Sub2) this).aByte9927, ((Class365_Sub1_Sub3_Sub2) this).aByte9928, class_xa, class_xa_16_, (int) class217.x, (int) class217.aFloat2455, (int) class217.y, bool, null, -911505460));
		} catch (RuntimeException runtimeexception) {
