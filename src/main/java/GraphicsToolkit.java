...
public abstract class GraphicsToolkit {
	...
	protected Hashtable<Canvas, Class52_Sub2> aHashtable5313 = new Hashtable<Canvas, Class52_Sub2>();
	...
	public final void swapBuffers(byte i) throws Exception_Sub1 {
		try {
			swapBuffers(0, 0);
	...
	abstract void swapBuffers(int i, int i_2_) throws Exception_Sub1;
	...
	public abstract Matrix method5036();

	public abstract Class387 method5037(Model class64, int i, int i_136_, int i_137_, int i_138_);
	...
	public abstract Matrix method5045();
	...
	public abstract Matrix method5083();
	...
	public abstract Class387 method5116(Model class64, int i, int i_328_, int i_329_, int i_330_);
	...
	public abstract Matrix method5124();
	...
	public abstract void method5133(Matrix class233);

	public abstract void method5134(Matrix class233);
	...
	public void dispose(int i) {
		try {
			...
			Enumeration<Canvas> enumeration = aHashtable5313.keys();
	...
	public abstract Matrix method5172();
	...
	public abstract void method5182(Matrix class233);
	...
	static void method5191(int i) {
		try {
			if (null != Class82_Sub6.aClass227_6843) {
				...
				if (Class288_Sub1.aClass219_7147 != null) { //fixes flikering
	...
	static void method5192(int i, int i_484_, int i_485_, int i_486_, int i_487_, int i_488_, int i_489_, Class298_Sub37_Sub15 class298_sub37_sub15, Class264 class264, Class505 class505, int i_490_, int i_491_, int i_492_) {
		try {
			...
			if (((Class298_Sub37_Sub15) class298_sub37_sub15).aBoolean9665)
				RSGraphics.aClass57_573.drawSprite(i_485_ + 5 + class505.method6264(string, 1318090489), i_489_ - 1110385787 * class505.anInt6202);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method5193(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_493_, (byte) 22);
			Class119 class119 = Class389.aClass119Array4165[i_493_ >> 16];
			FloorUnderlay.method5887(class105, class119, class403, -2057554129);
		} catch (RuntimeException runtimeexception) {
	...
	static void method5195(GraphicsToolkit class_ra, WidgetConfig class105, int i, int i_496_, byte type) {
		try {
			...
			if (null != class117) {
				...
				if (2 != -64305285 * Class3.anInt56 && 5 != Class3.anInt56 * -64305285 && null != Class384.aClass57_4127) {
					...
					int i_500_;
					int i_501_;
					if (2 == Class298_Sub1.cameraType * -863531439) {
					...
					for (IntegerValue class298_sub35 = ((IntegerValue) Class3.aClass453_61.method5939(1766612795)); class298_sub35 != null; class298_sub35 = ((IntegerValue) Class3.aClass453_61.method5944(49146))) {
						int i_504_ = class298_sub35.intValue * -774922497;
					...
					for (int i_509_ = 0; i_509_ < 1659101557 * Class3.anInt67; i_509_++) {
						...
						ObjectConfig class432 = (client.aClass283_8716.method2641(2011176396).getObjectDefinitions(Class3.anIntArray60[i_509_]));

						if (null != class432.toObjectIDs) {
							class432 = class432.method5777(Class128.aClass148_6331, 1042930561);
							if (null == class432)
								continue;
							if (-1 == class432.mapIconID * -1422593103) {
								if (type < 10)
									continue;
								return;
							}
						}
						Class248.method2389(class_ra, class_ta, class105, i, i_496_, i_510_, i_511_, class432.mapIconID * -1422593103, (byte) 0);
					}
					for (GroundTile class298_sub2 = ((GroundTile) client.groundTiles.method5816(1742338274)); class298_sub2 != null; class298_sub2 = ((GroundTile) client.groundTiles.method5815((byte) 24))) {
						int i_512_ = (int) ((class298_sub2.aLong3188 * 7051297995265073167L) >> 28 & 0x3L);
						if (i_512_ == Class3.anInt57 * -1694437021) {
							int i_513_ = ((int) ((class298_sub2.aLong3188 * 7051297995265073167L) & 0x3fffL) - -1760580017 * class341.gameSceneBaseX);
							...
							FloorUnderlay.method5883(class105, class_ta, i, i_496_, i_515_, i_516_, SubIncommingPacket.aClass57Array2349[0], (byte) 16);
						}
					}
					...
					if (2 != Class298_Sub1.cameraType * -863531439) {
						if (Class3.flagX * 2076926079 != 0) {
							int i_517_ = (-282230276 * Class3.flagX + 2 - i_498_ / 128 + (Class287.myPlayer.getSize() - 1) * 2);
							int i_518_ = (2 + Class3.flagY * -1505214580 - i_499_ / 128 + (Class287.myPlayer.getSize() - 1) * 2);
							FloorUnderlay.method5883(class105, class_ta, i, i_496_, i_517_, i_518_, (Class234.aClass57Array2598[Class3.aBoolean63 ? 1 : 0]), (byte) 23);
						}
