...
public class Class321 {
	...
	static final void method3920(ClientScript2 class403, int i) {
		try {
			...
			GraphicsConfig.method4922(string, 655510254);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method3925(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anInt5239 -= -783761378;
		...
		try {
			...
			try {
				if (i == 1)
					...
					client.groundMessages.clear(355993737);
				else if (16 == i) {
					FloorOverlay.clearMemmory(-851414705);
					...
					FloorOverlay.clearMemmory(1839277481);
					...
					FloorOverlay.clearMemmory(-1340221001);
					...
					Class255.method2435(new StringBuilder().append((int) class217.x >> 9).append(" ").append((int) class217.y >> 9).toString(), 2030018099);
				} else if (i == 7) {
					SceneObjectPosition class217 = (Class287.myPlayer.method4337().aClass217_2599);
					Class255.method2435(new StringBuilder().append("").append(client.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[(Class287.myPlayer.plane)].method6341((int) class217.x >> 9, (int) class217.y >> 9, (byte) -102)).toString(), 417961088);
				} else if (i == 3) {
					Class255.method2435(new StringBuilder().append(WidgetConfig.aClass348_1135.method4192(-262201221)).append(" ").append(WidgetConfig.aClass348_1135.method4188(-480173906)).toString(), 1301637250);
					Class255.method2435(new StringBuilder().append(WidgetConfig.aClass348_1138.method4192(509188014)).append(" ").append(WidgetConfig.aClass348_1138.method4188(2067697941)).toString(), 1826870364);
					...
					FloorOverlay.graphics.method5061(client.aBoolean8668);
