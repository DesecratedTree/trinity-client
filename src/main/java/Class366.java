...
public class Class366 {
	...
	static CachingHashMap aClass348_3979 = new CachingHashMap(260);
	static CachingHashMap aClass348_3980 = new CachingHashMap(5);
	...
	void method4542(int i) {
		try {
			...
			((Class366) this).aLong3975 = (1662367026201571203L * (((Class366) this).aLong3975 * 5093099708756449067L >>> 8 ^ ls[(int) (((((Class366) this).aLong3975 * 5093099708756449067L) ^ (long) ((((Class366) this).stanceID * 767962207) >> 8)) & 0xffL)]));
			((Class366) this).aLong3975 = (1662367026201571203L * (5093099708756449067L * ((Class366) this).aLong3975 >>> 8 ^ ls[(int) (((((Class366) this).aLong3975 * 5093099708756449067L) ^ (long) (((Class366) this).stanceID * 767962207)) & 0xffL)]));
	...
	public Class387 method4543(GraphicsToolkit class_ra, int i, Class144 class144, Class507 class507, Class477 class477, Class395 class395, Interface23 interface23, Class438 class438, int i_15_) {
		try {
			...
			synchronized (aClass348_3980) {
				class387 = (Class387) aClass348_3980.get(5093099708756449067L * (((Class366) this).aLong3975));
			}
			if (class387 == null || class_ra.method5017(class387.m(), i_16_) != 0) {
				...
				for (int i_21_ = 0; i_21_ < ((Class366) this).anIntArray3969.length; i_21_++) {
					...
					if (0 != (i_22_ & 0x40000000)) {
						...
						Model class64 = (class477.getItemDefinitions(i_22_ & 0x3fffffff).method6040(aBoolean3977, class464, 327827223));
						if (class64 != null)
							class64s[i_20_++] = class64;
					} else if ((i_22_ & ~0x7fffffff) != 0) {
						Model class64 = class144.method1579(i_22_ & 0x3fffffff, -276971058).method1476(1209505122);
						if (null != class64)
							class64s[i_20_++] = class64;
					}
				}
				Model class64 = new Model(class64s, i_20_);
				i_17_ |= 0x4000;
				class387 = class_ra.method5037(class64, i_17_, anInt3981 * 1931277641, 64, 768);
				for (int i_23_ = 0; i_23_ < 10; i_23_++) {
					for (int i_24_ = 0; i_24_ < aShortArrayArray3970[i_23_].length; i_24_++) {
						if (anIntArray3973[i_23_] < (Class22.appearenceColors[i_23_][i_24_]).length)
							class387.X(aShortArrayArray3970[i_23_][i_24_], (Class22.appearenceColors[i_23_][i_24_][anIntArray3973[i_23_]]));
					}
				}
				class387.KA(i_16_);
				synchronized (aClass348_3980) {
	...
	public Class387 method4544(GraphicsToolkit class_ra, int i, Class144 class144, Class395 class395, Class438 class438, int i_26_, int i_27_, int i_28_, byte i_29_) {
		try {
			...
			Class387 class387;
			synchronized (aClass348_3980) {
				class387 = (Class387) aClass348_3980.get(l);
			}
			do {
				if (class387 == null || class_ra.method5017(class387.m(), i_30_) != 0) {
					...
					if (class144.method1579(i_26_, -1760783131).method1475(-783889357) && class144.method1579(i_27_, -1162557302).method1475(-783889357) && class144.method1579(i_28_, -839635617).method1475(-783889357)) {
						Model class64 = class144.method1579(i_26_, -156721354).method1476(1042420956);
						if (class64 != null)
							class64s[i_32_++] = class64;
						class64 = class144.method1579(i_27_, 773247218).method1476(74933704);
						if (class64 != null)
							class64s[i_32_++] = class64;
						class64 = class144.method1579(i_28_, 744132841).method1476(552695292);
						if (null != class64)
							class64s[i_32_++] = class64;
						class64 = new Model(class64s, i_32_);
						i_31_ |= 0x4000;
						class387 = class_ra.method5037(class64, i_31_, 1931277641 * anInt3981, 64, 768);
						for (int i_33_ = 0; i_33_ < 10; i_33_++) {
							for (int i_34_ = 0; i_34_ < aShortArrayArray3970[i_33_].length; i_34_++) {
								if (anIntArray3973[i_33_] < (Class22.appearenceColors[i_33_][i_34_]).length)
									class387.X((aShortArrayArray3970[i_33_][i_34_]), (Class22.appearenceColors[i_33_][i_34_][anIntArray3973[i_33_]]));
							}
						}
						class387.KA(i_30_);
						synchronized (aClass348_3980) {
	...
	public Class387 method4545(GraphicsToolkit class_ra, int i, Class349 class349, Class144 class144, Class507 class507, Class477 class477, Class395 class395, Interface23 interface23, Class438 class438, Class438 class438_35_, Class438[] class438s, int[] is, int i_36_, boolean bool, Class405 class405, int i_37_) {
		try {
			...
			if (null != class438) {
				AnimationConfig class391 = class438.method5820(28542107);
				if (null != class391 && (609841829 * class391.rightHandItem >= 0 || 1548903495 * class391.leftHandItem >= 0)) {
					...
					if (class391.rightHandItem * 609841829 >= 0 && -1 != -817429509 * class405.anInt5266) {
						bool_40_ = true;
						if (65535 == class391.rightHandItem * 609841829) {
							...
							is_39_[-817429509 * class405.anInt5266] = 609841829 * class391.rightHandItem | 0x40000000;
					...
					if (1548903495 * class391.leftHandItem >= 0 && -1 != class405.anInt5270 * -2126257265) {
						bool_41_ = true;
						if (class391.leftHandItem * 1548903495 == 65535) {
							...
							is_39_[-2126257265 * class405.anInt5270] = 1548903495 * class391.leftHandItem | 0x40000000;
			...
			StanceConfig class350 = null;
			if (((Class366) this).stanceID * 767962207 != -1)
				class350 = class349.method4202((((Class366) this).stanceID * 767962207), (byte) 29);
			if (null == class387 || class_ra.method5017(class387.m(), i_38_) != 0) {
				...
				if (bool_53_) {
					if (-1L != (4366628042331861927L * ((Class366) this).aLong3966)) {
						synchronized (aClass348_3979) {
							class387 = (Class387) (aClass348_3979.get(4366628042331861927L * ((Class366) this).aLong3966));
						}
					}
					if (null == class387 || class_ra.method5017(class387.m(), i_38_) != 0)
						return null;
					...
					for (int i_59_ = 0; i_59_ < is_39_.length; i_59_++) {
						...
						if (0 != (i_60_ & 0x40000000)) {
							...
							Model class64 = (class477.getItemDefinitions(i_60_ & 0x3fffffff).getWearModel(aBoolean3977, class464, i_59_));
							if (null != class64)
								class64s[i_59_] = class64;
						} else if (0 != (i_60_ & ~0x7fffffff)) {
							Model class64 = class144.method1579(i_60_ & 0x3fffffff, -959041423).method1474((byte) 93);
							if (null != class64)
								class64s[i_59_] = class64;
						}
					}
						...
						for (int i_62_ = 0; i_62_ < class350.anIntArrayArray3710.length; i_62_++) {
							if (class64s[i_62_] == null) {
								...
								if (0 != i_63_ || 0 != i_64_ || i_65_ != 0)
									class64s[i_62_].translate(i_63_, i_64_, i_65_);
							}
						}
					}
					Model class64 = new Model(class64s, class64s.length);
					i_52_ |= 0x4000;
					class387 = class_ra.method5037(class64, i_52_, 1931277641 * anInt3981, 64, 850);
					for (int i_69_ = 0; i_69_ < 10; i_69_++) {
						for (int i_70_ = 0; i_70_ < aShortArrayArray3970[i_69_].length; i_70_++) {
							if (anIntArray3973[i_69_] < (Class22.appearenceColors[i_69_][i_70_]).length)
								class387.X(aShortArrayArray3970[i_69_][i_70_], (Class22.appearenceColors[i_69_][i_70_][anIntArray3973[i_69_]]));
						}
					}
					if (bool) {
						class387.KA(i_38_);
	...
	public void method4546(int i, int[] is, Class464[] class464s, int[] is_75_, boolean bool, int i_76_, int i_77_) {
		try {
			if (i != ((Class366) this).stanceID * 767962207)
				((Class366) this).stanceID = -698667105 * i;
