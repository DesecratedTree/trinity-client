...
public class Class194 {
	...
	static final void method1865(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class298_Sub1.cameraType * -863531439 == 4 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1866(ClientScript2 class403, int i) {
		try {
			...
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub4_7563, i_1_, 965049953);
	...
	public static Class336 method1867(int i, int i_2_, int i_3_, int i_4_, Class424 class424, int i_5_, byte i_6_) {
		try {
			...
			((Class336_Sub2) Class315.aClass336_Sub2_3309).aClass424_7713 = class424;
			((Class336_Sub2) Class315.aClass336_Sub2_3309).anInt7714 = -2142070477 * i_5_;
	...
	public static void method1868(int i) {
		try {
			...
			Class227.method2112(Class88.anInt806 * -1347746885, GroundMessage.anInt7658 * 1089948687, 608683427 * Class134.anInt6343, 1396607435 * Class448.anInt5619, (byte) 2);
	...
	static final void method1869(ClientScript2 class403, byte i) {
		try {
			Class390 class390 = (((ClientScript2) class403).aBoolean5261 ? ((ClientScript2) class403).aClass390_5247 : ((ClientScript2) class403).aClass390_5246);
			WidgetConfig class105 = ((Class390) class390).aClass105_4168;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1166 * 684246511;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("if.pd(").append(')').toString());
		}
	}

	static final void method1870(WidgetConfig class105, Class119 class119, ClientScript2 class403, byte i) {
		try {
			class105.anInt1232 = (((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) * -7527659;
		} catch (RuntimeException runtimeexception) {
