...
public class Class377 {
	...
	void method4661(RsByteBuffer class298_sub53, int i) {
		try {
			for (;;) {
				...
				if (1 == i_0_)
					anInterface19_4091 = ObjectConfig.method5786(class298_sub53, (byte) -47);
			}
	...
	static final void method4662(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_1_, (byte) 58);
	...
	static final void method4663(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub10_7548.method5660(-575221319) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4665(WidgetConfig class105, Class119 class119, ClientScript2 class403, short i) {
		try {
	...
	static final void method4666(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_4_, (byte) -91);
