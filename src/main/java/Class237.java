...
public class Class237 implements Interface24 {
	...
	public static Class296 method2192(CacheIndex class243, String string, boolean bool, int i) {
		try {
			...
			while (i_1_ < class296.anInt3169 * -1407078377) {
				RsByteBuffer class298_sub53 = new RsByteBuffer(class243.getFileFromArchive(i_0_, is[i_2_++], (byte) -34));
	...
	static final void method2193(ClientScript2 class403, int i) {
		try {
			...
			if (class298_sub52 == null) {
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = class298_sub52.mapAreaID * -530122905;
				int i_6_ = (class298_sub52.anInt7605 * -1740053407 << 28 | (WorldMap.baseX + 2122110429 * class298_sub52.x) << 14 | (WorldMap.baseY + class298_sub52.y * -372920341));
	...
	public static void method2196(int i) {
		try {
			...
			Class390.method4876(22050, Class422_Sub25.preferences.aClass422_Sub22_7586.method5706((byte) 39) == 1, 2, 1903660565);
	...
	public static void method2197(int i, byte i_9_) {
		try {
			WidgetConfig.aClass348_1135.method4186(i, -450593639);
			WidgetConfig.aClass348_1138.method4186(i, -631173514);
			WidgetConfig.aClass348_1136.method4186(i, -826447089);
			WidgetConfig.aClass348_1296.method4186(i, -1629354763);
		} catch (RuntimeException runtimeexception) {
