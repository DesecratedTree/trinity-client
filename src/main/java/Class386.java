...
public class Class386 {
	...
	public static IPAddress aClass471_4146;
	...
	static final void method4723(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_10_, (byte) 4);
	...
	static boolean method4726(GraphicsToolkit class_ra, Class298_Sub52 class298_sub52, Class352 class352, int i, int i_13_, int i_14_) {
		try {
			...
			if (null != class352.anIntArray3803) {
				i_15_ = (Class301_Sub1.anInt3221 + ((class298_sub52.x * 2122110429 + class352.anInt3804 * 1281846757 - Class301_Sub1.anInt3230) * (Class301_Sub1.anInt3256 - Class301_Sub1.anInt3221) / (Class301_Sub1.anInt3252 - Class301_Sub1.anInt3230)));
				i_16_ = (((class352.anInt3793 * 968926443 + class298_sub52.x * 2122110429 - Class301_Sub1.anInt3230) * (Class301_Sub1.anInt3256 - Class301_Sub1.anInt3221) / (Class301_Sub1.anInt3252 - Class301_Sub1.anInt3230)) + Class301_Sub1.anInt3221);
				i_18_ = (Class301_Sub1.anInt3257 - ((class352.anInt3805 * -1901940595 + class298_sub52.y * -372920341 - Class301_Sub1.anInt3242) * (Class301_Sub1.anInt3257 - Class301_Sub1.anInt3255) / (Class301_Sub1.anInt3241 - Class301_Sub1.anInt3242)));
				i_17_ = (Class301_Sub1.anInt3257 - ((-1294057761 * class352.anInt3807 + -372920341 * class298_sub52.y - Class301_Sub1.anInt3242) * (Class301_Sub1.anInt3257 - Class301_Sub1.anInt3255) / (Class301_Sub1.anInt3241 - Class301_Sub1.anInt3242)));
			}
			...
			if (class352.areaName != null) {
				...
				if (class4 != null) {
					i_23_ = Class74.aClass505_695.method6257((class352.areaName), null, (Class301_Sub1.aStringArray7638), null, (byte) 20);
			...
			if (null != class57) {
				if (Class137_Sub1.anInt6991 * -1983068885 > 0 && ((-271159611 * Class301_Sub1.anInt7633 != -1 && (Class301_Sub1.anInt7633 * -271159611 == class298_sub52.mapAreaID * -530122905)) || (-484575331 * Class301_Sub1.anInt7630 != -1 && (Class301_Sub1.anInt7630 * -484575331 == class352.anInt3817 * -804513353)))) {
					int i_33_;
				...
				class57.drawSprite((1333098669 * class298_sub52.anInt7609 - (class57.method271() >> 1)), (class298_sub52.anInt7606 * -685779893 - (class57.method626() >> 1)));
			}
			if (class352.areaName != null && class4 != null)
				Class298_Sub39.method3505(class_ra, class298_sub52, class352, i_23_, i_24_, i_25_, i_26_, class4, -1957009990);
			if (-1 != 715019623 * class352.anInt3785 || null != class352.areaName) {
				...
				JagexFile2.aClass453_5986.add(class298_sub6, 267740013);
			}
			return false;
		} catch (RuntimeException runtimeexception) {
