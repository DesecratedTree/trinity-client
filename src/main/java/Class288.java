...
public abstract class Class288 implements Runnable {
	...
	static final void method2724(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_0_, (byte) -16);
	...
	static final void method2726(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_1_, (byte) -42);
	...
	static final void method2728(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			String string = (String) (((ClientScript2) class403).anObjectArray5240[(((ClientScript2) class403).anInt5241 -= 969361751) * -203050393]);
			
			if (-440872681 * class105.uid == (747 << 16 | 7) && WidgetConfig.setOrbSpecial()) 
				return;
			...
			if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403)
				GroundMessage.method3731(-440872681 * class105.uid, (byte) -31);
		} catch (RuntimeException runtimeexception) {
