...
public class Class504 {
	...
	public Class504(Class411 class411, Class429 class429, CacheIndex class243) {
		((Class504) this).aClass243_6194 = class243;
		if (null != ((Class504) this).aClass243_6194)
			((Class504) this).aClass243_6194.method2316(ConfigFile.aClass120_1416.anInt1460 * -1006924897, 1020653544);
	}
	...
	public Class497 method6251(int i, int i_1_) {
		try {
			...
			synchronized (((Class504) this).aClass243_6194) {
				is = (((Class504) this).aClass243_6194.getFileFromArchive(-1006924897 * ConfigFile.aClass120_1416.anInt1460, i, (byte) -62));
			}
