...
public class Class395 {
	...
	public Class395(Class411 class411, Class429 class429, CacheIndex class243, CacheIndex class243_2_, CacheIndex class243_3_) {
		...
		if (null != ((Class395) this).aClass243_5189) {
			...
			ConfigFile.aClass120_1409.method1306((short) 21776);
			((Class395) this).aClass243_5189.method2316(i, -1829120689);
		}
		Class_ta_Sub2.method6006(class243_2_, class243_3_, 2, (byte) 2);
	}

	public AnimationConfig method4903(int i, byte i_4_) {
		try {
			AnimationConfig class391;
			synchronized (((Class395) this).aClass348_5192) {
				class391 = (AnimationConfig) ((Class395) this).aClass348_5192.get((long) i);
			}
			if (null != class391)
				return class391;
			byte[] is;
			synchronized (((Class395) this).aClass243_5189) {
				is = (((Class395) this).aClass243_5189.getFileFromArchive(ConfigFile.aClass120_1409.method1307(i, 180156567), ConfigFile.aClass120_1409.method1305(i, -1217474734), (byte) -6));
			}
			class391 = new AnimationConfig();
			class391.id = i * -523719415;
			((AnimationConfig) class391).aClass395_4170 = this;
			if (is != null)
				class391.method4882(new RsByteBuffer(is), -795902444);
			class391.method4879((byte) -46);
			CustomAnims.modify(class391);
			synchronized (((Class395) this).aClass348_5192) {
