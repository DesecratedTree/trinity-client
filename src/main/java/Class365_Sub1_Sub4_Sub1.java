...
public class Class365_Sub1_Sub4_Sub1 extends Class365_Sub1_Sub4 {
	...
	Class335 drawFloor(GraphicsToolkit class_ra, int i) {
		try {
			...
			Class322 class322 = aClass331_7722.method4036(plane, (int) class217.x >> 9, (int) class217.y >> 9, -583169676);
			Class365_Sub1_Sub2 class365_sub1_sub2 = aClass331_7722.method4058(plane, (int) class217.x >> 9, (int) class217.y >> 9, (byte) 55);
			int i_0_ = 0;
			...
			if (anInt10142 * -1184748693 == 0) {
				...
				int i_5_ = -i_3_ / 2;
				int i_6_ = -i_4_ / 2;
				int i_7_ = class_xa.method6340(i_5_ + (int) class217.x, (int) class217.y + i_6_, -1982900642);
				int i_8_ = i_3_ / 2;
				int i_9_ = -i_4_ / 2;
				int i_10_ = class_xa.method6340((int) class217.x + i_8_, i_9_ + (int) class217.y, -1725399320);
				int i_11_ = -i_3_ / 2;
				int i_12_ = i_4_ / 2;
				int i_13_ = class_xa.method6340((int) class217.x + i_11_, (int) class217.y + i_12_, -1471266970);
				int i_14_ = i_3_ / 2;
				int i_15_ = i_4_ / 2;
				int i_16_ = class_xa.method6340(i_14_ + (int) class217.x, i_15_ + (int) class217.y, -1424760570);
			...
			class222.method2064(class217_24_.x, class217_24_.aFloat2455 - 10.0F, class217_24_.y);
			...
			if (anInt10146 * -1651799761 != -1) {
				...
				if (null != class387) {
					class387.drawModel(class222, aClass302_Sub1Array7726[2], 0);
			...
			if (-1 != -909380271 * anInt10150) {
				...
				if (null != class387) {
					class387.drawModel(class222, aClass302_Sub1Array7726[1], 0);
					((Class365_Sub1_Sub4_Sub1) this).aBoolean10144 |= class387.i();
	...
	void method4516(int i) {
		try {
			...
			if (Class422_Sub25.preferences.aClass422_Sub16_7557.method5687(1941334276) == 1)
	...
	Class335 method4370(GraphicsToolkit class_ra) {
		SceneObjectPosition class217 = SceneObjectPosition.method2005(method4337().aClass217_2599);
		Class322 class322 = aClass331_7722.method4036(plane, (int) class217.x >> 9, (int) class217.y >> 9, 1738520080);
		Class365_Sub1_Sub2 class365_sub1_sub2 = aClass331_7722.method4058(plane, (int) class217.x >> 9, (int) class217.y >> 9, (byte) 15);
		int i = 0;
		if (null != class322 && class322.aClass365_Sub1_Sub1_3359.aBoolean9799)
		...
		if (anInt10142 * -1184748693 == 0) {
			...
			int i_29_ = -i_27_ / 2;
			int i_30_ = -i_28_ / 2;
			int i_31_ = class_xa.method6340(i_29_ + (int) class217.x, (int) class217.y + i_30_, -1545427351);
			int i_32_ = i_27_ / 2;
			int i_33_ = -i_28_ / 2;
			int i_34_ = class_xa.method6340((int) class217.x + i_32_, i_33_ + (int) class217.y, -1284070566);
			int i_35_ = -i_27_ / 2;
			int i_36_ = i_28_ / 2;
			int i_37_ = class_xa.method6340((int) class217.x + i_35_, (int) class217.y + i_36_, -1982262190);
			int i_38_ = i_27_ / 2;
			int i_39_ = i_28_ / 2;
			int i_40_ = class_xa.method6340(i_38_ + (int) class217.x, i_39_ + (int) class217.y, -1609235363);
		...
		class222.method2064(class217_48_.x, class217_48_.aFloat2455 - 10.0F, class217_48_.y);
	...
	int method4519() {
		ItemConfig class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(-441234013 * anInt10152);
		int i = class468.anInt5768 * -427528997;
		if (anInt10150 * -909380271 != -1) {
			ItemConfig class468_53_ = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(anInt10150 * -909380271);
			if (-427528997 * class468_53_.anInt5768 > i)
				i = -427528997 * class468_53_.anInt5768;
		}
		if (-1 != -1651799761 * anInt10146) {
			ItemConfig class468_54_ = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(anInt10146 * -1651799761);
	...
	int method4356(byte i) {
		try {
			...
			if (anInt10150 * -909380271 != -1) {
				ItemConfig class468_56_ = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(anInt10150 * -909380271);
				if (-427528997 * class468_56_.anInt5768 > i_55_)
					i_55_ = -427528997 * class468_56_.anInt5768;
			}
			if (-1 != -1651799761 * anInt10146) {
				ItemConfig class468_57_ = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(anInt10146 * -1651799761);
	...
	int method4520() {
		...
		int i = class468.anInt5768 * -427528997;
		if (anInt10150 * -909380271 != -1) {
			ItemConfig class468_63_ = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(anInt10150 * -909380271);
			if (-427528997 * class468_63_.anInt5768 > i)
				i = -427528997 * class468_63_.anInt5768;
		}
		if (-1 != -1651799761 * anInt10146) {
			ItemConfig class468_64_ = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(anInt10146 * -1651799761);
	...
	int method4521() {
		...
		int i = class468.anInt5768 * -427528997;
		if (anInt10150 * -909380271 != -1) {
			ItemConfig class468_65_ = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(anInt10150 * -909380271);
			if (-427528997 * class468_65_.anInt5768 > i)
				i = -427528997 * class468_65_.anInt5768;
		}
		if (-1 != -1651799761 * anInt10146) {
			ItemConfig class468_66_ = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(anInt10146 * -1651799761);
