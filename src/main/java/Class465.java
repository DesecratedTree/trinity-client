...
public class Class465 implements Interface18 {
	...
	static final void method6018(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static final void method6019(ClientScript2 class403, short i) {
		try {
			...
			StanceConfig class350 = Class94.aClass349_913.method4202(i_9_, (byte) 24);
			if (null != class350.anIntArray3712 && class350.anIntArray3712.length > 0) {
				...
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = -809747019 * class350.standAnimation;
		} catch (RuntimeException runtimeexception) {
