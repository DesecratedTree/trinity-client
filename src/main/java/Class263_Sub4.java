...
public class Class263_Sub4 extends Class263 implements Interface9_Impl2_Impl1 {
	...
	Class263_Sub4(OpenGLToolkit class_ra_sub3_sub1, Class55 class55, int i, int i_0_, byte[] is, int i_1_, int i_2_) {
		...
		OpenGL.glTexImage2Dub(((Class263_Sub4) this).anInt6415, 0, (OpenGLToolkit.method5533(((Class263_Sub4) this).aClass55_6419, ((Class263_Sub4) this).aClass77_6420)), i, i_0_, 0, OpenGLToolkit.method5532(((Class263_Sub4) this).aClass55_6419), 5121, is, i_1_);
		OpenGL.glPixelStorei(3314, 0);
		OpenGL.glPixelStorei(3317, 4);
	}

	Class263_Sub4(OpenGLToolkit class_ra_sub3_sub1, Class55 class55, int i, int i_3_, float[] fs, int i_4_, int i_5_) {
		...
		OpenGL.glTexImage2Df(((Class263_Sub4) this).anInt6415, 0, (OpenGLToolkit.method5533(((Class263_Sub4) this).aClass55_6419, ((Class263_Sub4) this).aClass77_6420)), i, i_3_, 0, OpenGLToolkit.method5532(((Class263_Sub4) this).aClass55_6419), 5126, fs, i_4_ * 4);
		OpenGL.glPixelStorei(3314, 0);
	}
	...
	public void method81(int i, int i_8_, int i_9_, int i_10_, int[] is, int i_11_, int i_12_) {
		...
		OpenGL.glTexSubImage2Di(((Class263_Sub4) this).anInt6415, 0, i, i_8_, i_9_, i_10_, 32993, ((OpenGLToolkit) (((Class263_Sub4) this).aClass_ra_Sub3_Sub1_6422)).anInt9841, is, i_11_);
		if (i_9_ != i_12_)
			OpenGL.glPixelStorei(3314, 0);
	}
	...
	public void method100(int i, int i_19_, int i_20_, int i_21_, byte[] is, Class55 class55, int i_22_, int i_23_) {
		...
		OpenGL.glTexSubImage2Dub(((Class263_Sub4) this).anInt6415, 0, i, i_19_, i_20_, i_21_, OpenGLToolkit.method5532(class55), 5121, is, i_22_);
		if (i_23_ != i_20_)
			OpenGL.glPixelStorei(3314, 0);
		OpenGL.glPixelStorei(3317, 4);
	}
	...
	Class263_Sub4(OpenGLToolkit class_ra_sub3_sub1, Class55 class55, Class77 class77, int i, int i_24_) {
		super(class_ra_sub3_sub1, 34037, class55, class77, i * i_24_, false);
		((Class263_Sub4) this).anInt9954 = i;
		((Class263_Sub4) this).anInt9953 = i_24_;
		((Class263_Sub4) this).aClass_ra_Sub3_Sub1_6422.method5358(this);
		OpenGL.glTexImage2Dub(((Class263_Sub4) this).anInt6415, 0, OpenGLToolkit.method5533((((Class263_Sub4) this).aClass55_6419), (((Class263_Sub4) this).aClass77_6420)), i, i_24_, 0, OpenGLToolkit.method5532(((Class263_Sub4) this).aClass55_6419), OpenGLToolkit.method5537(((Class263_Sub4) this).aClass77_6420), null, 0);
	}
	...
	public void method82(int i, int i_28_, int i_29_, int i_30_, byte[] is, Class55 class55, int i_31_, int i_32_) {
		...
		OpenGL.glTexSubImage2Dub(((Class263_Sub4) this).anInt6415, 0, i, i_28_, i_29_, i_30_, OpenGLToolkit.method5532(class55), 5121, is, i_31_);
		if (i_32_ != i_29_)
			OpenGL.glPixelStorei(3314, 0);
		OpenGL.glPixelStorei(3317, 4);
	}

	Class263_Sub4(OpenGLToolkit class_ra_sub3_sub1, int i, int i_33_, int[] is, int i_34_, int i_35_) {
		...
		OpenGL.glTexImage2Di(((Class263_Sub4) this).anInt6415, 0, 6408, ((Class263_Sub4) this).anInt9954, ((Class263_Sub4) this).anInt9953, 0, 32993, (((OpenGLToolkit) ((Class263_Sub4) this).aClass_ra_Sub3_Sub1_6422).anInt9841), is, i_34_ * 4);
		OpenGL.glPixelStorei(3314, 0);
	}
	...
	public void method101(int i, int i_36_, int i_37_, int i_38_, int[] is, int i_39_, int i_40_) {
		...
		OpenGL.glTexSubImage2Di(((Class263_Sub4) this).anInt6415, 0, i, i_36_, i_37_, i_38_, 32993, ((OpenGLToolkit) (((Class263_Sub4) this).aClass_ra_Sub3_Sub1_6422)).anInt9841, is, i_39_);
		if (i_37_ != i_40_)
			OpenGL.glPixelStorei(3314, 0);
	}
	...
	public void method102(int i, int i_41_, int i_42_, int i_43_, int[] is, int i_44_, int i_45_) {
		...
		OpenGL.glTexSubImage2Di(((Class263_Sub4) this).anInt6415, 0, i, i_41_, i_42_, i_43_, 32993, ((OpenGLToolkit) (((Class263_Sub4) this).aClass_ra_Sub3_Sub1_6422)).anInt9841, is, i_44_);
		if (i_42_ != i_45_)
			OpenGL.glPixelStorei(3314, 0);
	}
	...
	public void method104(int i, int i_46_, int i_47_, int i_48_, byte[] is, Class55 class55, int i_49_, int i_50_) {
		...
		OpenGL.glTexSubImage2Dub(((Class263_Sub4) this).anInt6415, 0, i, i_46_, i_47_, i_48_, OpenGLToolkit.method5532(class55), 5121, is, i_49_);
		if (i_50_ != i_47_)
			OpenGL.glPixelStorei(3314, 0);
		OpenGL.glPixelStorei(3317, 4);
	}
	...
	public void method87(int i, int i_51_, int i_52_, int i_53_, byte[] is, Class55 class55, int i_54_, int i_55_) {
		...
		OpenGL.glTexSubImage2Dub(((Class263_Sub4) this).anInt6415, 0, i, i_51_, i_52_, i_53_, OpenGLToolkit.method5532(class55), 5121, is, i_54_);
		if (i_55_ != i_52_)
			OpenGL.glPixelStorei(3314, 0);
		OpenGL.glPixelStorei(3317, 4);
	}
