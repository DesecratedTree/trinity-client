...
public class Class71 {
		...
		try {
			if (!aBoolean684) {
				if (830010277 * anInt685 > 0) {
					ObjectValue class298_sub29 = new ObjectValue(interface25);
					aClass453_686.add(class298_sub29, -259769992);
				} else
	...
	static synchronized void method810(byte i) {
		try {
			for (;;) {
				ObjectValue class298_sub29 = (ObjectValue) aClass453_686.method5936(2119725533);
				...
				((Interface25) class298_sub29.value).ma(true);
