...
public class Class161_Sub1_Sub1 extends Class161_Sub1 {
	...
	public Class161_Sub1_Sub1(ModernToolkit class_ra_sub3, Class159 class159) throws Exception_Sub2 {
		super(class_ra_sub3);
		aClass233_9121 = new Matrix();
