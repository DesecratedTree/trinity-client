...
public class Class451 {
	...
	public FloorUnderlay method5932(int i, byte i_1_) {
		try {
			//64
			int dataID = i;
	
			if  (dataID >= Settings.OSRS_FLOOR_OFFSET && i != 1026 ) {
			//	System.out.println(i);
				dataID -= Settings.OSRS_FLOOR_OFFSET;
			}
			FloorUnderlay class443;
			synchronized (((Class451) this).aClass348_5640) {
				class443 = (FloorUnderlay) ((Class451) this).aClass348_5640.get((long) i);
			}
			if (class443 != null)
				return class443;
			byte[] is;
			synchronized (((Class451) this).aClass243_5639) {
				is = (((Class451) this).aClass243_5639.getFileFromArchive(-1006924897 * ConfigFile.aClass120_1428.anInt1460, dataID, (byte) -122));
			}
			class443 = new FloorUnderlay();
			if (is != null)
				class443.method5882(new RsByteBuffer(is), (byte) -31);

			boolean osrsSnow = false;
			if (Settings.ENABLE_SNOW && (osrsSnow || (i < Settings.OSRS_FLOOR_OFFSET && (i == 159 || i == 162 || i == 160 || i == 163)))) {
				class443.color = Color.white.getRGB() * -1369220863;
				class443.method5880(2106435329 * class443.color, (byte) -123);
			}/*else if (i < Settings.OSRS_FLOOR_OFFSET)
				System.out.println(i);*/
			synchronized (((Class451) this).aClass348_5640) {
	...
	public Class451(Class411 class411, Class429 class429, CacheIndex class243) {
		...
		((Class451) this).aClass243_5639.method2316((-1006924897 * (ConfigFile.aClass120_1428.anInt1460)), -978414795);
	}
	...
	public static void method5934(Player class365_sub1_sub1_sub2_sub2, byte i) {
		try {
			...
			if (null == class298_sub41)
				AnimationConfig.method4884(class365_sub1_sub1_sub2_sub2.plane, (class365_sub1_sub1_sub2_sub2.scenePositionXQueue[0]), (class365_sub1_sub1_sub2_sub2.scenePositionYQueue[0]), 0, null, null, class365_sub1_sub1_sub2_sub2, (byte) 58);
			else
