...
public class Class497 {
	...
	protected static JagexFile[] aClass484Array6106;
	...
	static final void method6207(ClientScript2 class403, int i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub26_7577, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]), -1529967366);
	...
	static void method6208(String string, String string_2_, int i) {
		try {
			Class360.anInt3868 = Settings.LOBBY_ENABLED ? -1058684408 : 471358088;
			Class360.aClass25_3905 = Settings.LOBBY_ENABLED ? client.aClass25_8693 : client.aClass25_8711;
