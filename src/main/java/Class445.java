...
public class Class445 {
	...
	public Class485 method5892(int i, int i_0_) {
		try {
			...
			if (null != class485)
				return class485;
			byte[] is = ((Class445) this).aClass243_5609.getFileFromArchive(((ConfigFile.aClass120_1411.anInt1460) * -1006924897), i, (byte) -50);
	...
	public Class445(Class411 class411, Class429 class429, CacheIndex class243) {
		...
		if (null != ((Class445) this).aClass243_5609)
			((Class445) this).aClass243_5609.method2316(ConfigFile.aClass120_1411.anInt1460 * -1006924897, 1281975621);
	}

	static void method5895(GraphicsToolkit class_ra, byte i) {
		try {
			class_ra.r(0, 0, -2110394505 * Class462.screenWidth, 350);
			if (Settings.CONSOLE_COLOUR_ENABLED) {
			class_ra.B(0, 0, -2110394505 * Class462.screenWidth, 350, Class8.anInt98 * 256666041 << 24 | Settings.CONSOLE_COLOUR, 1);
			}
			...
			if (Class8.anInt102 * -2035787443 > 0) {
				...
				if (Settings.CONSOLE_SCROLL_BAR_ENABLED) {
				class_ra.B(Class462.screenWidth * -2110394505 - 16, i_5_, 12, i_4_, Class8.anInt98 * 256666041 << 24 
						| Settings.SCROLL_BAR_COLOUR, 2);
				}
				for (int i_6_ = -1731316011 * Class8.anInt103; (i_6_ < -1731316011 * Class8.anInt103 + i_2_ && i_6_ < -2035787443 * Class8.anInt102); i_6_++) {
					...
					int i_7_ = ((-2110394505 * Class462.screenWidth - 8 - 16) / strings.length);
					for (int i_8_ = 0; i_8_ < strings.length; i_8_++) {
						int i_9_ = 8 + i_7_ * i_8_;
						class_ra.r(i_9_, 0, i_9_ + i_7_ - 8, 350);
						Class343.aClass264_3673.drawText(Class117.method1276(strings[i_8_], (byte) 76), i_9_, (350 - Class8.anInt106 * 1194411673 - 2 - (-1883958527 * Class422_Sub2.aClass505_8369.anInt6197) - (376067837 * Class8.anInt110 * (i_6_ - Class8.anInt103 * -1731316011))), -1, -16777216, 2087345638);
					}
				}
			}
			Class298_Sub46.aClass264_7534.method2474("718 1", -2110394505 * Class462.screenWidth - 25, 330, -1, -16777216, (byte) -63);
			class_ra.r(0, 0, Class462.screenWidth * -2110394505, 350);
			class_ra.method4990(0, 350 - Class8.anInt106 * 1194411673, Class462.screenWidth * -2110394505, -1, -2042566638);
			Class101.aClass264_1084.drawText(new StringBuilder().append("--> ").append(Class117.method1276(Class8.aString101, (byte) -1)).toString(), 10, (350 - Class82_Sub19_Sub1.aClass505_9111.anInt6197 * -1883958527 - 1), -1, -16777216, -10016873);
