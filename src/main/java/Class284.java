...
public class Class284 {
	...
	static final void method2694(WidgetConfig class105, ClientScript2 class403, int i) {
		try {
			...
			NPCConfig class503 = Class15.aClass507_224.method6269(class105.anInt1151 * 572201537, 2035169508);
			...
			if (null == class503.modifiedColors || i_24_ < 0 || i_24_ >= class503.modifiedColors.length)
				throw new RuntimeException("");
	...
	static final void method2695(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub6_7551.method5647(207850013) == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("lu.ajo(").append(')').toString());
		}
	}

	static final void method2696(WidgetConfig class105, Class119 class119, ClientScript2 class403, short i) {
		try {
	...
	static final void method2697(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = ObjectConfig.method5788((char) i_27_, (short) 160) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
