...
public class h extends Class387 implements Interface25 {
		...
		if (((h) this).aClass68Array6676 != null) {
			for (int i_1_ = 0; i_1_ < ((h) this).aClass68Array6676.length; i_1_++) {
				...
				if (class68.aClass233_677 == null)
					class68.aClass233_677 = new Matrix();
	...
	public void method4741(Class222 class222, int i, boolean bool) {
		Matrix class233 = ((a) ((h) this).aJa6674.method5571()).aClass233_6673;
	...
	h(ja var_ja, ba var_ba, Model class64, int i, int i_135_, int i_136_, int i_137_) {
		...
		((h) this).aClass85Array6677 = class64.particles;
		((h) this).aClass68Array6676 = class64.aClass68Array613;
		int i_138_ = (class64.particles == null ? 0 : class64.particles.length);
		...
		U(((h) this).aJa6674, ((h) this).aBa6675, class64.num_vertices, class64.highest_used_vertex, class64.vertices_x, class64.vertices_y, class64.vertices_z, class64.vertices_label, class64.aShortArray620, class64.num_faces, class64.faces_a, class64.faces_b, class64.faces_c, class64.faces_type, class64.faces_layer, class64.faces_trans, class64.faces_mapping, class64.faces_colour, class64.faces_material, class64.face_labels, class64.priority, class64.aShortArray615, class64.num_textures, class64.textures_mapping, class64.textures_mapping_p, class64.textures_mapping_m, class64.textures_mapping_n, class64.anIntArray639, class64.anIntArray640, class64.anIntArray641, class64.aByteArray645, class64.aByteArray628, class64.anIntArray637, class64.anIntArray643, class64.anIntArray648, is, i_138_, i_139_, i, i_135_, i_136_, i_137_, is_144_);
	}
