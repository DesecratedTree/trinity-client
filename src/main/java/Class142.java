	...
	static final void method1570(int i, int i_2_, int i_3_, int i_4_, boolean bool, int i_5_) {
		try {
			if (client.aClass283_8716.method2675(-1611682495) == null)
				FloorOverlay.graphics.method5015(i, i_2_, i_3_, i_4_, -16777216, (byte) 7);
			else {
				...
				if (3 != 1596783995 * client.anInt8724) {
					if (!client.aBoolean8725)
						bool_6_ = true;
				} else if ((int) class217.x < 0 || ((int) class217.x >= client.aClass283_8716.method2629(-2116251282) * 512) || (int) class217.y < 0 || ((int) class217.y >= (client.aClass283_8716.method2630(978326552) * 512)))
					bool_6_ = true;
				if (bool_6_)
					FloorOverlay.graphics.method5015(i, i_2_, i_3_, i_4_, -16777216, (byte) 7);
				else {
					client.anInt8777 += 859732235;
					if (null != Class287.myPlayer && ((int) class217.x - (Class287.myPlayer.getSize() - 1) * 256) >> 9 == Class3.flagX * 2076926079 && (((int) class217.y - (Class287.myPlayer.getSize() - 1) * 256) >> 9 == -376303645 * Class3.flagY)) {
						Class3.flagX = 1129029761;
						Class3.flagY = 1835291189;
					...
					if (Class298_Sub1.cameraType * -863531439 == 4) { //default
						...
						Class482.setCameraPos((1103750049 * Class75.anInt708), Class356.getPlayerHeight((int) class217.x, (int) class217.y, Class99.anInt952 * 1855729883, -1979916029) - 200, Class106.anInt1309 * 1346160791, i_7_ , i_8_, (i_7_ >> 3) * 3 + client.zoom << 2, i_4_, -1059521295);
					} else if (2 == -863531439 * Class298_Sub1.cameraType) {
						...
						Class482.setCameraPos(Class75.anInt708 * 1103750049, Class356.getPlayerHeight((-2080858977 * client.anInt8753), 1818837461 * client.anInt8755, 1855729883 * Class99.anInt952, -898849874) - 200, Class106.anInt1309 * 1346160791, i_9_, i_10_, 3 * (i_9_ >> 3) + 600 << 2, i_4_, -1059521295);
					} else if (5 == -863531439 * Class298_Sub1.cameraType)
					...
					FloorOverlay.graphics.method5187(i, i_2_, i_3_, i_4_);
					FloorOverlay.graphics.r(i, i_2_, i + i_3_, i_2_ + i_4_);
					Atmosphere class385 = client.aClass283_8716.method2640((byte) 15).method4316((byte) -16);
					...
					FloorOverlay.graphics.method5182(client.aClass233_8658);
					if (class385.method4710((byte) -25) != null) {
						FloorOverlay.graphics.IA(1.0F);
						FloorOverlay.graphics.m(16777215, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F);
						class385.method4710((byte) -99).method2591(FloorOverlay.graphics, Class163.anInt1685 * -1285178091 << 3, i, i_2_, i_3_, i_4_, client.anInt8756 * -104436553, Class135.anInt6384 * -1847894591, Class229.anInt6458 * -1466297851, i_18_, true, false, (byte) -49);
					} else
						FloorOverlay.graphics.ba(3, i_18_);
					...
					byte i_19_ = (Class422_Sub25.preferences.aClass422_Sub17_7565.method5689(-2013953489) == 2 ? (byte) (-1953789277 * client.anInt8777) : (byte) 1);
					client.aClass283_8716.method2675(-1611682495).method4040(client.anInt8884 * 443738891, Class367.anInt4000 * -1740717447, 1449634147 * Class110.anInt6403, Class146.anInt1575 * -299812095, client.aClass283_8716.method2642(1646760373), client.anIntArray8793, client.anIntArray8670, client.anIntArray8795, client.anIntArray8641, client.anIntArray8797, 1 + (Class287.myPlayer.plane), i_19_, (int) class217.x >> 9, (int) class217.y >> 9, Class422_Sub25.preferences.aClass422_Sub9_7555.method5655(2137164627) == 0, true, 0, true);
					client.anInt8723 += -2109562397;
					Class247.method2365(170542119);
					if (0 == -1233866115 * client.anInt8752) {
						GroundItemNames.draw(i, i_2_);
					...
					if (client.aBoolean8663) {
						FloorOverlay.graphics.method5015(i, i_2_, i_3_, i_4_, -16777216, (byte) 7);
						Class139.drawText((Tradution.aClass470_5874.method6049(Class321.aClass429_3357, -875414210)), false, FloorOverlay.graphics, Class343.aClass264_3673, Class422_Sub2.aClass505_8369, (byte) 34);
					}
