...
public final class Class94 {
		...
		try {
			if (!aBoolean912) {
				...
				if (1762367763 * anInt909 >= 0) {
					...
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.setConfig(Class15.aClass507_224.method6269(anInt909 * 1762367763, 1863267717), 2139515630);
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.method4421(-2095128707 * (((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.config.anInt6187), -1254496694);
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10115 = -1186616623 * (((((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.config.opcode103V) * -1927065533) << 3);
	...
	boolean method1019(int i) {
		try {
			if (anInt909 * 1762367763 >= 0) {
				NPCConfig class503 = Class15.aClass507_224.method6269(1762367763 * anInt909, 2059716043);
				boolean bool = class503.method6238(-1621243143);
				if (((Class94) this).anIntArray907 == null) {
					StanceConfig class350 = aClass349_913.method4202((class503.stanceID * 525312939), (byte) 47);
	...
	static final void method1023(ClientScript2 class403, int i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub15_7560, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, -1851948852);
	...
	static final void method1024(ClientScript2 class403, int i) {
		try {
			WidgetConfig.method1135(((Class365_Sub1) ((ClientScript2) class403).anInterface3_5233), class403, -778688640);
		} catch (RuntimeException runtimeexception) {
