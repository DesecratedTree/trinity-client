...
public class Class2 {
	...
	final void method290(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, int i, int j, int k, int l, float f18, float f19, float f20, int i1) {
		...
		if (i1 != anInt37) {
			...
			if (anIntArray30 == null) {
				...
				method292(true, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, StanceConfig.method4215(k1, l, f18, 0xfd870044), StanceConfig.method4215(k1, l, f19, 0x2e32084c), StanceConfig.method4215(k1, l, f20, 0x9dbcd924));
				return;
			}
	...
	final void method296(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, int i, int j, int k, int l, float f18, float f19, float f20, int i1, float f21, int j1, float f22, int k1, float f23) {
		...
		if (i1 != anInt37) {
			...
			if (anIntArray30 == null) {
				...
				method292(true, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, StanceConfig.method4215(i3, l, f18, 0xaaa0d14), StanceConfig.method4215(i3, l, f19, 0xf7bb874), StanceConfig.method4215(i3, l, f20, 0x6d5bab31));
				return;
			}
			anInt39 = aClass_ra_Sub1_31.method5199(i1) ? 64 : aClass_ra_Sub1_31.anInt8002 * 0x420409cb;
			anInt40 = anInt39 - 1;
		...
		if (j1 != anInt44) {
			...
			if (anIntArray45 == null) {
				...
				method292(true, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, StanceConfig.method4215(j3, l, f18, 0xbf6771d4), StanceConfig.method4215(j3, l, f19, 0x743e4ce9), StanceConfig.method4215(j3, l, f20, 0xadd0746a));
				return;
			}
		...
		if (k1 != anInt49) {
			...
			if (anIntArray50 == null) {
				...
				method292(true, flag1, flag2, (int) f, (int) f1, (int) f2, (int) f3, (int) f4, (int) f5, (int) f6, (int) f7, (int) f8, StanceConfig.method4215(k3, l, f18, 0x8ea57cce), StanceConfig.method4215(k3, l, f19, 0x9d545dce), StanceConfig.method4215(k3, l, f20, 0x5621e01));
				return;
			}
	...
	Class2(SafemodeToolkit class_ra_sub1, Class15 class15) {
		aBoolean36 = false;
		aBoolean16 = true;
		aBoolean48 = false;
		anInt19 = 0;
		...
		anIntArray34 = aClass_ra_Sub1_31.pixels;
	...
	int anInt29;
	int anIntArray30[];
	SafemodeToolkit aClass_ra_Sub1_31;
	float aFloat32;
	int anInt33;
	int anIntArray34[];
	float aFloatArray35[];
