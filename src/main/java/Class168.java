...
public class Class168 {
	...
	Vector<Class150> aVector1715 = new Vector<Class150>();
	Interface8_Impl1_Impl1 anInterface8_Impl1_Impl1_1716;
	ModernToolkit aClass_ra_Sub3_1717;
	...
	Class168(ModernToolkit class_ra_sub3, int i, int i_0_) {
	...
	void method1796() {
		((Class168) this).aClass52_Sub1_1712.release();
	...
	boolean method1798(int i, int i_8_, int i_9_, int i_10_) {
		if (((Class168) this).aVector1715.isEmpty())
			return false;
		if (((Class168) this).anInt1720 != i_9_ || (((Class168) this).anInt1721 != i_10_ && (((Class168) this).aClass_ra_Sub3_1717 instanceof OpenGLToolkit))) {
