...
public class Class82_Sub21 extends Class82 {
	...
	static final void method937(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_5_, (byte) 76);
	...
	static final boolean method938(int i, int i_6_, boolean bool, Class336 class336, int i_7_) {
		try {
			...
			if (i_10_ < 1)
				return false;
			Class3.flagX = client.calculatedScenePositionXs[i_10_ - 1] * -1129029761;
			Class3.flagY = -1835291189 * client.calculatedScenePositionYs[i_10_ - 1];
