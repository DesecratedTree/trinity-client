...
public class Class39 {
	...
	OpenGLLegacyToolkit aClass_ra_Sub2_429;
	int anInt430;
	static int anInt431 = 34336;

	static Class39 method477(OpenGLLegacyToolkit class_ra_sub2, int i, String string) {
	...
	Class39(OpenGLLegacyToolkit class_ra_sub2, int i, int i_1_) {
