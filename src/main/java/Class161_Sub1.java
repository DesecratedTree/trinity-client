...
public abstract class Class161_Sub1 extends Class161 {
	...
	static Matrix aClass233_7056 = new Matrix();
	Matrix[] aClass233Array7057;
	...
	Class161_Sub1(ModernToolkit class_ra_sub3) {
		super(class_ra_sub3);
		new Class222();
		((Class161_Sub1) this).aClass233Array7057 = new Matrix[aClass_ra_Sub3_1648.anInt8347];
		for (int i = 0; i < aClass_ra_Sub3_1648.anInt8347; i++)
			((Class161_Sub1) this).aClass233Array7057[i] = new Matrix();
	}
	...
	void method1731(Class222 class222) {
		Matrix class233 = aClass_ra_Sub3_1648.aClass233_8236;
	...
	void method1737(int i, Class222 class222) {
		if (((Class161_Sub1) this).aClass298_Sub31_Sub1_7039 != null) {
			Matrix class233 = aClass_ra_Sub3_1648.method5329();
