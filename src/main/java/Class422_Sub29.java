...
public class Class422_Sub29 extends Preference {
	static int anInt8435 = 127;
	static int anInt8436 = 0;

	public Class422_Sub29(int i, Preferences class298_sub48) {
		super(i, class298_sub48);
	}

	public Class422_Sub29(Preferences class298_sub48) {
	...
	static boolean method5728(Class352 class352, int i) {
		try {
			...
			if (!class352.method4237(Class301_Sub1.anInterface23_3223, 655699987))
				return false;
			if (Class301_Sub1.aClass437_7636.method5812((long) (-1262065485 * class352.anInt3784)) != null)
				return false;
			if (Class301_Sub1.aClass437_7637.method5812((long) (class352.anInt3817 * -804513353)) != null)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
