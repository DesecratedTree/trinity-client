...
public final class Class170 {
	...
	static final void method1809(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.spriteID * 1411971043;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1812(WidgetConfig[] class105s, int i, byte i_6_) {
		try {
			for (int i_7_ = 0; i_7_ < class105s.length; i_7_++) {
				WidgetConfig class105 = class105s[i_7_];
				if (null == class105) {
					if (i_6_ <= 1)
						break;
				} else {
					...
					if (1 == i && class105.anObjectArray1250 != null) {
						if (class105.anInt1154 * -1309843523 >= 0) {
							WidgetConfig class105_8_ = Class50.getIComponentDefinitions((class105.uid * -440872681), (byte) -12);
