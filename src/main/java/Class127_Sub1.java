...
public class Class127_Sub1 extends Class127 {
	...
	void method1409(boolean bool, int i, int i_0_) {
		if (bool) {
			int[] is = new int[4];
			FloorOverlay.graphics.qa(is);
			FloorOverlay.graphics.r(i, i_0_, (((Class127_Sub1) this).aClass128_6375.anInt6326) * -944287579 + i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_0_);
			...
			((Class127_Sub1) this).aClass57_8571.drawSprite(i, (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793 - i_2_) / 2 + i_0_);
			((Class127_Sub1) this).aClass57_8570.drawSprite(i + (((Class127_Sub1) this).aClass128_6375.anInt6326 * -944287579) - i_3_, (-1387457793 * ((Class127_Sub1) this).aClass128_6375.anInt6330 - i_4_) / 2 + i_0_);
			FloorOverlay.graphics.r(i, i_0_, (-944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326) + i), i_0_ + ((Class127_Sub1) this).aClass57_8573.method626());
			...
			FloorOverlay.graphics.r(i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_0_ - i_5_, i + -944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326), i_0_ + ((((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793));
			...
			FloorOverlay.graphics.r(is[0], is[1], is[2], is[3]);
		}
	}
	...
	void method1412(boolean bool, int i, int i_6_, int i_7_) {
		try {
			if (bool) {
				int[] is = new int[4];
				FloorOverlay.graphics.qa(is);
				FloorOverlay.graphics.r(i, i_6_, (((Class127_Sub1) this).aClass128_6375.anInt6326) * -944287579 + i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_6_);
				...
				((Class127_Sub1) this).aClass57_8571.drawSprite(i, ((((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793) - i_9_) / 2 + i_6_);
				((Class127_Sub1) this).aClass57_8570.drawSprite(i + (((Class127_Sub1) this).aClass128_6375.anInt6326 * -944287579) - i_10_, ((-1387457793 * ((Class127_Sub1) this).aClass128_6375.anInt6330) - i_11_) / 2 + i_6_);
				FloorOverlay.graphics.r(i, i_6_, -944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326) + i, i_6_ + ((Class127_Sub1) this).aClass57_8573.method626());
				...
				FloorOverlay.graphics.r(i, (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793) + i_6_ - i_12_, i + (-944287579 * ((Class127_Sub1) this).aClass128_6375.anInt6326), i_6_ + (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793));
	...
	void method1413(boolean bool, int i, int i_13_) {
		...
		int[] is = new int[4];
		FloorOverlay.graphics.qa(is);
		FloorOverlay.graphics.r(i_14_, i_16_, i_14_ + i_20_, i_17_);
		method1424(i_14_, i_16_, i_18_, i_19_, 1789961003);
		FloorOverlay.graphics.r(i_20_ + i_14_, i_16_, i_15_, i_17_);
	...
	void method1417(boolean bool, int i, int i_25_) {
		if (bool) {
			int[] is = new int[4];
			FloorOverlay.graphics.qa(is);
			FloorOverlay.graphics.r(i, i_25_, (((Class127_Sub1) this).aClass128_6375.anInt6326) * -944287579 + i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_25_);
			...
			((Class127_Sub1) this).aClass57_8571.drawSprite(i, (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793 - i_27_) / 2 + i_25_);
			((Class127_Sub1) this).aClass57_8570.drawSprite(i + (((Class127_Sub1) this).aClass128_6375.anInt6326 * -944287579) - i_28_, (-1387457793 * ((Class127_Sub1) this).aClass128_6375.anInt6330 - i_29_) / 2 + i_25_);
			FloorOverlay.graphics.r(i, i_25_, (-944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326) + i), i_25_ + ((Class127_Sub1) this).aClass57_8573.method626());
			...
			FloorOverlay.graphics.r(i, (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793 + i_25_ - i_30_), i + (-944287579 * ((Class127_Sub1) this).aClass128_6375.anInt6326), i_25_ + (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793));
	...
	void method1411(boolean bool, int i, int i_31_, int i_32_) {
		try {
			...
			int[] is = new int[4];
			FloorOverlay.graphics.qa(is);
			FloorOverlay.graphics.r(i_33_, i_35_, i_33_ + i_39_, i_36_);
			method1424(i_33_, i_35_, i_37_, i_38_, -1231781770);
			FloorOverlay.graphics.r(i_39_ + i_33_, i_35_, i_34_, i_36_);
	...
	void method1414(boolean bool, int i, int i_40_) {
		...
		int[] is = new int[4];
		FloorOverlay.graphics.qa(is);
		FloorOverlay.graphics.r(i_41_, i_43_, i_41_ + i_47_, i_44_);
		method1424(i_41_, i_43_, i_45_, i_46_, -672953345);
		FloorOverlay.graphics.r(i_47_ + i_41_, i_43_, i_42_, i_44_);
	...
	void method1415(boolean bool, int i, int i_48_) {
		...
		int[] is = new int[4];
		FloorOverlay.graphics.qa(is);
		FloorOverlay.graphics.r(i_49_, i_51_, i_49_ + i_55_, i_52_);
		method1424(i_49_, i_51_, i_53_, i_54_, 2053935529);
		FloorOverlay.graphics.r(i_55_ + i_49_, i_51_, i_50_, i_52_);
	...
	void method1416(boolean bool, int i, int i_56_) {
		...
		int[] is = new int[4];
		FloorOverlay.graphics.qa(is);
		FloorOverlay.graphics.r(i_57_, i_59_, i_57_ + i_63_, i_60_);
		method1424(i_57_, i_59_, i_61_, i_62_, 1166821857);
		FloorOverlay.graphics.r(i_63_ + i_57_, i_59_, i_58_, i_60_);
	...
	void method1410(boolean bool, int i, int i_64_) {
		if (bool) {
			int[] is = new int[4];
			FloorOverlay.graphics.qa(is);
			FloorOverlay.graphics.r(i, i_64_, (((Class127_Sub1) this).aClass128_6375.anInt6326) * -944287579 + i, (((Class127_Sub1) this).aClass128_6375.anInt6330) * -1387457793 + i_64_);
			...
			((Class127_Sub1) this).aClass57_8571.drawSprite(i, (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793 - i_66_) / 2 + i_64_);
			((Class127_Sub1) this).aClass57_8570.drawSprite(i + (((Class127_Sub1) this).aClass128_6375.anInt6326 * -944287579) - i_67_, (-1387457793 * ((Class127_Sub1) this).aClass128_6375.anInt6330 - i_68_) / 2 + i_64_);
			FloorOverlay.graphics.r(i, i_64_, (-944287579 * (((Class127_Sub1) this).aClass128_6375.anInt6326) + i), i_64_ + ((Class127_Sub1) this).aClass57_8573.method626());
			...
			FloorOverlay.graphics.r(i, (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793 + i_64_ - i_69_), i + (-944287579 * ((Class127_Sub1) this).aClass128_6375.anInt6326), i_64_ + (((Class127_Sub1) this).aClass128_6375.anInt6330 * -1387457793));
	...
	static int method1425(Class298_Sub37_Sub15 class298_sub37_sub15, Class505 class505, int i) {
		try {
			...
			if (((Class298_Sub37_Sub15) class298_sub37_sub15).aBoolean9665)
				i_71_ += RSGraphics.aClass57_573.method623() + 4;
			return i_71_;
		} catch (RuntimeException runtimeexception) {
	...
	static void method1427(int i) {
		try {
			Class301_Sub1.aClass437_7636.clear((byte) -14);
			Class301_Sub1.aClass437_7637.clear((byte) -2);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("zb.bp(").append(')').toString());
		}
	}

	static final void setInterface(ClientScript2 class403, byte i) {
		try {
			...
			if (i_73_ == 596) {
				Class98.setWidgetText(596 << 16 | 48, "Like us at:", (byte) 66);
				Class98.setWidgetText(596 << 16 | 60, "Login to create account", (byte) 66);
				
	//	Class98.setWidgetText(596 << 16 | 70, "Lest nam", (byte) 66);

			//	System.out.println(-440872681 * class105.uid+", "+(((ClientScript2) class403).anInt5241 * -203050393));
				
				//Class491.hideWidget(596 << 16 | 52, 1, -109953213);
			}
		} catch (RuntimeException runtimeexception) {
