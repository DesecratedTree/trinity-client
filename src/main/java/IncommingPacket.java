...
public class IncommingPacket {
	...
	public static IncommingPacket MODEL_ON_ICOMPONENT_PACKET;
	...
	public static IncommingPacket aClass202_2245;
	...
	public static IncommingPacket aClass202_2271;
	...
	static {
		...
		MODEL_ON_ICOMPONENT_PACKET = new IncommingPacket(31, 8);
		...
		aClass202_2245 = new IncommingPacket(85, -2);
		...
		aClass202_2271 = new IncommingPacket(121, 8);
	...
	static final void method1903(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919
					- 1)] = Class82_Sub6.method886(i_1_, i_2_, false, 1051533242);
	...
	static final void method1904(ClientScript2 class403, byte i) {
		try {
			...
			int i_4_ = (((ClientScript2) class403).anIntArray5244[1
					+ ((ClientScript2) class403).anInt5239 * 681479919]);
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919
					- 1)] = i_4_ + i_3_;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1905(ClientScript2 class403, byte i) {
		try {
			Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub3_7556,
					(((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689)
							* 681479919)]) == 1 ? 1 : 0,
					-802327901);
	...
	static final void method1906(ClientScript2 class403, byte i) {
		try {
			String string = (String) (((ClientScript2) class403).anObjectArray5240[(((ClientScript2) class403).anInt5241 -= 969361751)
					* -203050393]);
			int i_5_ = 0;
			if (Class51.method543(string, 1423765975))
				i_5_ = Class216.method1998(string, (short) 6366);
			Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2074,
					client.aClass25_8711.aClass449_330, (byte) 125);
