...
public class Class522 {
	...
	static int method6324(int i) {
		try {
			int i_0_ = Class82_Sub6.aClass227_6843.folder * -861845079;
	...
	static final void method6326(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			...
			if (-1 == -1309843523 * class105.anInt1154 && !class119.aBoolean1403)
				Preference.method5623(-440872681 * class105.uid, 1613777968);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("w.hw(").append(')').toString());
		}
	}

	static final void method6327(ClientScript2 class403, int i) {
		try {
