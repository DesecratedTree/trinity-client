...
public class Class216 implements Interface24 {
	...
	static ClientScript getClientScript(int i, byte i_0_) {
		try {
			...
			if (class298_sub37_sub17 != null) {
				if (class298_sub37_sub17.id == 2916) {
					class298_sub37_sub17.anIntArray9676[8] = Settings.ENABLE_X1_HITS ? 1 : 10;
					class298_sub37_sub17.anIntArray9676[15] = Settings.ENABLE_X1_HITS ? 1 : 10;
				} else if (class298_sub37_sub17.id == 5255) 
					class298_sub37_sub17.anIntArray9676[4] = Settings.ENABLE_X1_HITS ? 1 : 10;
				 else if (class298_sub37_sub17.id == 1467)
					 class298_sub37_sub17.anIntArray9676[28] = 1000;

				if (class298_sub37_sub17.anIntArray9676 != null) {
					/*for (int i2 = 0; i2 < class298_sub37_sub17.anIntArray9676.length; i2++) {
						int v = class298_sub37_sub17.anIntArray9676[i2];
						if (v == 200) 
							System.out.println(v+", "+i2+", id: "+class298_sub37_sub17.id);
					}*/
				}
			...
			byte[] is = Class377.aClass243_4092.getFileFromArchive(i, 0, (byte) 12);
			if (is == null || is.length <= 1)
				return null;
			try {
				class298_sub37_sub17 = Class163.method1775(is, (byte) 16);
				class298_sub37_sub17.id = i;
				if (i == 2708 && Preferences.rememberUsername == 2) //scriptId
					class298_sub37_sub17.anObjectArray9683[97] = Preferences.username;
				else if (i == 4552)//friend list expansion
					class298_sub37_sub17.anIntArray9676[38] = 500;
				else if (i == 125) //friend list expansion
					class298_sub37_sub17.anIntArray9676[117] = 500;
				else if (i == 84) { //public chat expansion
					class298_sub37_sub17.anIntArray9676[128] = 500;
				} else if (i == 73) { //enable :: admin commands
					class298_sub37_sub17.anObjectArray9683[1768] = ":::";
				}
			} catch (Exception exception) {
				exception.printStackTrace();
				System.err.println("We had a problem finding CS " + i);
				return null;
				// throw new RuntimeException(new
				// StringBuilder().append(exception.getMessage()).append(" ").append(i).toString());
			}
	...
	public static int method1998(CharSequence charsequence, short i) {
		try {
			return Preference.method5619(charsequence, 10, true, -1228221916);
		} catch (RuntimeException runtimeexception) {
		...
		try {
			...
			for (int i_3_ = 0; i_3_ < is.length; i_3_++) {
				...
				if (class369.anInt4028 * 347977109 == -1) {
					...
					Class57 class57 = ((Class57) (Class436.aClass348_5500.get((long) (347977109 * class369.anInt4028))));
					if (class57 == null) {
						Class89 class89 = Class89.getSprite(Class158.aClass243_6364, class369.anInt4028 * 347977109, 0);
						if (class89 != null) {
							class57 = FloorOverlay.graphics.method5125(class89, true);
