...
public class Class477 {
	...
	public static ClientScriptEnums aClass500_6001;

	public ItemConfig getItemDefinitions(int itemId) {
		return getItemDefinitions(itemId, false);
	}

	public static boolean OLD_ITEMS = true; //default true
	...
	public ItemConfig getItemDefinitions(int itemId, boolean forceNew) {
		try {
			ItemConfig itemdefinition;

		//	if (!forceNew) {
				synchronized (((Class477) this).aClass348_5993) {
					itemdefinition = (ItemConfig) ((Class477) this).aClass348_5993.get((long) itemId);
				}
	...
	//		}
			...
			if (is == null) {
				synchronized (((Class477) this).aClass243_5990) {
					is = (((Class477) this).aClass243_5990.getFileFromArchive(ConfigFile.aClass120_1429.method1307(itemId, -100335020), ConfigFile.aClass120_1429.method1305(itemId, -1698958016), (byte) -74));
				}
			}
			itemdefinition = new ItemConfig();
			((ItemConfig) itemdefinition).aClass477_5751 = this;
			((ItemConfig) itemdefinition).itemId = 1824752127 * itemId;
			itemdefinition.groundOptions = (String[]) ((Class477) this).aStringArray5988.clone();
			itemdefinition.inventoryOptions = (String[]) ((Class477) this).aStringArray6000.clone();
			if (null != is)
				itemdefinition.decode(new RsByteBuffer(is), itemId >= Settings._685_ITEM_OFFSET ? 2 : itemId >= Settings.OSRS_ITEM_OFFSET ? 1 : 0);
			itemdefinition.method6025(16711935);
			if (-1 != itemdefinition.certTemplate * -1673957995)
				itemdefinition.method6027(getItemDefinitions((itemdefinition.certTemplate * -1673957995), forceNew), getItemDefinitions(809765849 * itemdefinition.cert, forceNew), 219692629);
			if (itemdefinition.lendTemplate * 465190555 != -1)
				itemdefinition.method6039(getItemDefinitions(itemdefinition.lendTemplate * 465190555, forceNew), getItemDefinitions((-783380935 * (((ItemConfig) itemdefinition).lend)), forceNew), -1676050822);
			if (-1 != 2083650097 * itemdefinition.anInt5770)
				itemdefinition.method6036(getItemDefinitions(itemdefinition.anInt5770 * 2083650097, forceNew), getItemDefinitions((1981372535 * (((ItemConfig) itemdefinition).anInt5769)), forceNew), -1733915014);
			if (!((Class477) this).aBoolean5999 && itemdefinition.aBoolean5731) {
				itemdefinition.team = 0;
				itemdefinition.groundOptions = ((Class477) this).aStringArray5988;
				itemdefinition.inventoryOptions = ((Class477) this).aStringArray6000;
				itemdefinition.tradeable = false;
				itemdefinition.anIntArray5767 = null;
				if (null != ((ItemConfig) itemdefinition).settings) {
					boolean bool = false;
					for (Class298 class298 = ((ItemConfig) itemdefinition).settings.method5816(1739772889); class298 != null; class298 = ((ItemConfig) itemdefinition).settings.method5815((byte) -94)) {
						Class497 class497 = (((Class477) this).aClass504_5989.method6251((int) (class298.aLong3188 * 7051297995265073167L), -1474104007));
					...
					if (!bool)
						((ItemConfig) itemdefinition).settings = null;
				}
			}
			CustomItems.modify(itemdefinition);
			synchronized (((Class477) this).aClass348_5993) {
	...
	public Class57 getSpriteSmall(GraphicsToolkit class_ra, GraphicsToolkit class_ra_6_, int id, int i_7_, int i_8_, int i_9_, boolean bool, boolean bool_10_, int i_11_, Class264 class264, Class366 class366, int i_12_) {
		try { //separates cache in order not to conflcit
			if (!bool_10_) {
				Class57 class57 = method6085(class_ra_6_, (id + 200000), i_7_, i_8_, i_9_, i_11_, class366, 467134725);
				if (null != class57)
					return class57;
			}
			ItemConfig class468 = getItemDefinitions(id);
			if (i_7_ > 1 && ((ItemConfig) class468).stackIDs != null) {
				int i_13_ = -1;
				for (int i_14_ = 0; i_14_ < 10; i_14_++) {
					if (i_7_ >= ((ItemConfig) class468).stackAmounts[i_14_] && 0 != ((ItemConfig) class468).stackAmounts[i_14_])
						i_13_ = ((ItemConfig) class468).stackIDs[i_14_];
				}
				if (i_13_ != -1)
			...
			if (!bool_10_) {
				...
				((Class465) class465).anInt6514 = (id + 200000) * 1541800549;
	...
	public Class57 method6086(GraphicsToolkit class_ra, GraphicsToolkit class_ra_6_, int id, int i_7_, int i_8_, int i_9_, boolean bool, boolean bool_10_, int i_11_, Class264 class264, Class366 class366, int i_12_) {
		try {
			
		/*	int lookID = CustomItems.getOldLookItem(i);
			if (lookID != i) 
				return method6086(class_ra, class_ra_6_, lookID, i_7_, i_8_,i_9_, bool, bool_10_, i_11_, class264, class366, i_12_);
		*/
			
		//	System.out.println(id+", "+i_7_+", "+i_8_+", "+i_9_+", "+i_11_);
			if (!bool_10_) {
				Class57 class57 = method6085(class_ra_6_, id, i_7_, i_8_, i_9_, i_11_, class366, 467134725);
				if (null != class57)
					return class57;
			}
			ItemConfig class468 = getItemDefinitions(id);
			...
			if (!bool_10_) {
				Class465 class465 = new Class465();
				((Class465) class465).anInt6519 = -973477563 * class_ra_6_.anInt5298;
				((Class465) class465).anInt6514 = id * 1541800549;
				((Class465) class465).anInt6515 = i_7_ * -1199949713;
				((Class465) class465).anInt6516 = 29186943 * i_8_;
				((Class465) class465).anInt6518 = i_9_ * 1868109305;
				((Class465) class465).anInt6517 = 958157807 * i_11_;
	...
	public Class477(Class411 class411, Class429 class429, boolean bool, Class504 class504, CacheIndex class243, CacheIndex class243_16_) {
		...
		if (null != ((Class477) this).aClass243_5990) {
			itemDefinitionsLength = Settings._685_ITEM_OFFSET * -1797723349;
		} else
	...
	static final void method6094(int i, byte i_18_) {
		try {
			...
			if (0 != i_19_) {
				int i_20_ = Class128.aClass148_6331.configs[i];
				if (5 == i_19_)
