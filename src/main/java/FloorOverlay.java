...
public class FloorOverlay {
	...
	public static GraphicsToolkit graphics;
	public static GrabFolder[] aClass242_Sub1Array4072;
	...
	void method4603(byte i) {
		try {
			anInt4055 = (2109091647 * anInt4055 << 8 | -692668059 * ((FloorOverlay) this).anInt4053) * 150814911;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("pn.b(").append(')').toString());
		}
	}

	void method4604(boolean osrs, RsByteBuffer class298_sub53, int i, short i_0_) {
		try {
			if (i == 1)
				color = Class112.method1240(class298_sub53.read24BitUnsignedInteger((byte) 45), (byte) 66) * -1294090885;
			else if (i == 2)
				texture = class298_sub53.readUnsignedByte() * 473139963;
			else if (3 == i) {
				int id = class298_sub53.readUnsignedShort();
				if (id == 65535)
					id = -1;
				else if (osrs) {
					id += Settings.OSRS_TEXTURE_OFFSET;
					id = TextureLoader.replaceTexture(id);
				}
				texture = id * 473139963;
			} else if (5 == i)
				occlude = false;
			else if (i == 7) {
				minimapColor = Class112.method1240(class298_sub53.read24BitUnsignedInteger((byte) -44), (byte) 71) * -1749423345;
			}	else if (i == 8)
				((FloorOverlay) this).aClass375_4065.anInt4080 = 1023752851 * ((FloorOverlay) this).anInt4053;
			else if (i == 9)
	...
	void method4605(boolean osrs, RsByteBuffer class298_sub53, int i) {
		try {
			for (;;) {
				...
				method4604(osrs, class298_sub53, i_1_, (short) 8128);
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4606(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anInt5239 -= -1175642067;
			class105.xTextAlignment = ((((ClientScript2) class403).anIntArray5244[((ClientScript2) class403).anInt5239 * 681479919]) * -1733811909);
			class105.yTextAlignment = (210030285 * (((ClientScript2) class403).anIntArray5244[681479919 * ((ClientScript2) class403).anInt5239 + 1]));
			class105.lineHeight = ((((ClientScript2) class403).anIntArray5244[2 + 681479919 * ((ClientScript2) class403).anInt5239]) * 1629063197);
	...
	static final void clearMemmory(int i) {
		try {
			...
			ConfigFile.aClass487_1463.method6162((byte) 81);
			...
			ClientScriptEnums.aClass347_6117.method4179(-1069278127);
