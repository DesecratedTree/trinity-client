...
public class Class298_Sub39 extends Class298 {
	int anInt7418;
	int anInt7419;
	...
	static void method3504(Class298_Sub37_Sub5 class298_sub37_sub5, int i, int i_1_) {
		try {
			if (Class436.aBoolean5478) {
				...
				if (i_5_ + i_2_ > -2110394505 * Class462.screenWidth)
				...
				if (i_7_ + i_4_ > -1111710645 * Class298_Sub40_Sub9.screenHeight)
					i_7_ = Class298_Sub40_Sub9.screenHeight * -1111710645 - i_4_;
				if (i_7_ < 0)
					i_7_ = 0;
	...
	static void method3505(GraphicsToolkit class_ra, Class298_Sub52 class298_sub52, Class352 class352, int i, int x, int y, int i_10_, Class4 class4, int i_11_) {
		try {
			int i_12_ = x - i_10_ / 2 - 5;
			int i_13_ = y + 2;
			if (594838161 * class352.anInt3787 != 0)
				class_ra.method5015(i_12_, i_13_, i_10_ + 10, y + i * class4.method309() - i_13_ + 1, 594838161 * class352.anInt3787, (byte) 7);
			if (0 != class352.anInt3802 * -828737913)
				class_ra.method5014(i_12_, i_13_, i_10_ + 10, y + i * class4.method309() - i_13_ + 1, class352.anInt3802 * -828737913, -1130300720);
			int color = -1836991893 * class352.anInt3781;
			if (class298_sub52.aBoolean7611 && 1364087215 * class352.anInt3782 != -1)
				color = 1364087215 * class352.anInt3782;
			for (int i_15_ = 0; i_15_ < i; i_15_++) {
				String string = Class301_Sub1.aStringArray7638[i_15_];
				if (i_15_ < i - 1)
					string = string.substring(0, string.length() - 4);
				class4.method308(class_ra, string, x, y, color, true);
	...
	static final void method3506(int i) {
		try {
			...
			int i_18_ = (Class356.getPlayerHeight(i_16_, i_17_, 1855729883 * Class99.anInt952, -1586416356) - -1439836243 * Class98_Sub3.anInt6938);
			if (1534163843 * Class21.anInt276 >= 100) {
				...
				Class110.anInt6403 = (Class356.getPlayerHeight(-1740717447 * Class367.anInt4000, -299812095 * Class146.anInt1575, 1855729883 * Class99.anInt952, -1881231282) - -1439836243 * Class98_Sub3.anInt6938) * 1078403147;
			} else {
			...
			i_18_ = (Class356.getPlayerHeight(i_16_, i_17_, 1855729883 * Class99.anInt952, -1098953725) - 771695069 * Class18.anInt255);
	...
	static final void method3507(WidgetConfig class105, Class119 class119, ClientScript2 class403, int i) {
		try {
