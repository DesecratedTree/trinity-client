...
public class Class399 {
	...
	public static CacheIndex DETAILS;
	...
	public static void method4926(int i, int i_0_) {
		try {
			if (8 == client.anInt8752 * -1233866115) {
				Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2021, client.aClass25_8693.aClass449_330, (byte) 103);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(i);
				client.aClass25_8693.method390(class298_sub36, (byte) -112);
			}
