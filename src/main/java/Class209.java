...
public class Class209 {
	...
	public static void method1938(AnimationConfig class391, int i, Class365_Sub1 class365_sub1, int i_1_) {
		try {
			if (-991384187 * Class300.anInt3213 < 50 && (class391 != null && null != class391.anIntArrayArray4187 && i < class391.anIntArrayArray4187.length && class391.anIntArrayArray4187[i] != null)) {
				...
				} else if (Class422_Sub25.preferences.aClass422_Sub29_7582.method5726(-2147180332) != 0) {
					SceneObjectPosition class217 = class365_sub1.method4337().aClass217_2599;
					int i_9_ = (int) class217.x - 256 >> 9;
					int i_10_ = (int) class217.y - 256 >> 9;
