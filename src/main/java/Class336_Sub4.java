...
public class Class336_Sub4 extends Class336 {
	...
	public static Class297 method4103(int i, int i_7_, int i_8_, int i_9_, int i_10_, boolean bool, int i_11_, int i_12_) {
		try {
			if ((bool ? Class422_Sub25.preferences.aClass422_Sub29_7583.method5726(-2143588734) : Class422_Sub25.preferences.aClass422_Sub29_7553.method5726(-2141973598)) != 0 && i_7_ != 0 && -991384187 * Class300.anInt3213 < 50 && i != -1) {
