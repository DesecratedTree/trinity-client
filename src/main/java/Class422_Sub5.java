...
public class Class422_Sub5 extends Preference {
	static int anInt8376 = 1;
	public static int anInt8377 = 2;
	public static int anInt8378 = 0;

	public Class422_Sub5(int i, Preferences class298_sub48) {
	...
	public Class422_Sub5(Preferences class298_sub48) {
	...
	static void method5643(WidgetConfig class105, int i) {
		try {
			if (client.aBoolean8835) {
				if (class105.anObjectArray1247 != null) {
					WidgetConfig class105_2_ = Class140.method1558(Class379.anInt4099 * 1262526353, 392084321 * client.anInt8836, -156511736);
					if (class105_2_ != null) {
						...
						class298_sub46.anObjectArray7530 = class105.anObjectArray1247;
				...
				class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(-440872681 * class105.uid, -1060289644);
		...
		try {
			...
			for (Class298_Sub37_Sub12 class298_sub37_sub12 = Class97_Sub1.method1045((byte) 12); class298_sub37_sub12 != null; class298_sub37_sub12 = Class97_Sub1.method1045((byte) 12)) {
				...
				if (1 == i_4_) {
					...
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) -62);
					if (!((Class298_Sub37_Sub12) class298_sub37_sub12).aString9611.equals(class105.text)) {
						class105.text = (((Class298_Sub37_Sub12) class298_sub37_sub12).aString9611);
						Tradution.method6054(class105, 753227077);
					}
				} else if (i_4_ == 22) {
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) -82);
				...
				} else if (4 == i_4_) {//draw model
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) -20);
					int i_5_ = ((((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610) * 479598359);
					int modelID = ((((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9608) * -1447843633);
					int i_7_ = -1074324071 * ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9609;
					if (class105.anInt1184 * 1548853569 != i_5_ || modelID != class105.anInt1151 * 572201537 || i_7_ != 1148770405 * class105.anInt1140) {
						class105.anInt1184 = i_5_ * -1530138943;
						class105.anInt1151 = modelID * -1825442367;
						class105.anInt1140 = 908204397 * i_7_;
						class105.aClass498_1307 = null;
						Tradution.method6054(class105, 422949042);
					}
				} else if (5 == i_4_) {
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) 56);
					...
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) -37);
					if (i_12_ != class105.textColor * 1045422783) {
						class105.textColor = -695431873 * i_12_;
						Tradution.method6054(class105, -37482416);
					}
				} else if (i_4_ == 7) {
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) -71);
					...
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) 54);
					if ((479598359 * ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610 != class105.anInt1190 * 7329457) || ((((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9608) * -1447843633 != class105.anInt1262 * -1086526073) || (-1074324071 * ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9609 != class105.anInt1284 * -261021353)) {
						...
						if (-1232467723 * class105.anInt1280 != -1) {
							...
							else if (class105.width * 1769572195 > 0)
								class105.anInt1284 = (class105.anInt1284 * 237251296 / (class105.width * 1769572195) * -1066050969);
						}
						Tradution.method6054(class105, -1617809711);
					}
				} else if (i_4_ == 9) {
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) 49);
					...
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) 88);
					...
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) 37);
					class105.xPositionMode = (byte) 0;
					class105.xOnScreen = ((class105.x = 1890691465 * ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610) * -1672688609);
					class105.yPositionMode = (byte) 0;
					class105.yOnScreen = (class105.y = (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9608) * -1822519589) * 705123139;
					Tradution.method6054(class105, -429816482);
				} else if (i_4_ == 12) {
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) 43);
					int i_13_ = 479598359 * ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610;
					if (null != class105 && 0 == class105.type * -1215239439) {
						if (i_13_ > (class105.scrollHeight * 2053897963 - 457937409 * class105.anInt1162))
							i_13_ = (class105.scrollHeight * 2053897963 - 457937409 * class105.anInt1162);
						if (i_13_ < 0)
							i_13_ = 0;
					...
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) 63);
					class105.spriteID = 947110461 * ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610;
				} else if (15 == i_4_) {
					Class3.aBoolean63 = true;
					Class3.flagX = (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610) * 20118889;
					Class3.flagY = (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9608) * 1038073637;
				} else if (i_4_ == 16) {
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) -2);
					class105.fontID = 861383641 * ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610;
				} else if (i_4_ == 20) {
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) -1);
					class105.aBoolean1211 = 1 == (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610) * 479598359;
				} else if (21 == i_4_) {
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) -52);
					...
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) 3);
					int i_14_ = (int) (l >> 32);
					...
					WidgetConfig class105 = Class50.getIComponentDefinitions((int) l, (byte) -87);
					int i_15_ = (int) (l >> 32);
