...
public class Class455 {
	...
	void method5956(byte i) {
		try {
			...
			int i_21_ = 0;
			while (i_20_ < 8) {
				((Class455) this).aLongArray5660[i_20_] = ((long) ((Class455) this).aByteArray5654[i_21_] << 56 ^ ((long) ((Class455) this).aByteArray5654[1 + i_21_] & 0xffL) << 48 ^ ((long) ((Class455) this).aByteArray5654[2 + i_21_] & 0xffL) << 40 ^ ((long) ((Class455) this).aByteArray5654[i_21_ + 3] & 0xffL) << 32 ^ ((long) ((Class455) this).aByteArray5654[4 + i_21_] & 0xffL) << 24 ^ ((long) ((Class455) this).aByteArray5654[5 + i_21_] & 0xffL) << 16 ^ ((long) ((Class455) this).aByteArray5654[6 + i_21_] & 0xffL) << 8 ^ ((long) ((Class455) this).aByteArray5654[7 + i_21_] & 0xffL));
				i_20_++;
				i_21_ += 8;
			}
	...
	static void method5958(GraphicsToolkit class_ra, int i, int i_33_, WidgetConfig class105, int i_34_, int i_35_) {
		try {
