...
public class Class365_Sub1_Sub2_Sub1 extends Class365_Sub1_Sub2 implements Interface3 {
	...
	Class335 drawFloor(GraphicsToolkit class_ra, int i) {
		try {
			...
			if (null != ((Class60) aClass60_9910).aClass351_602) {
				Class69 class69 = ((Class60) aClass60_9910).aClass351_602.method4229();
				class_ra.method5042(class69);
			}
			((Class365_Sub1_Sub2_Sub1) this).aBoolean9907 = (class387.i() || null != ((Class60) aClass60_9910).aClass351_602);
			if (null == ((Class365_Sub1_Sub2_Sub1) this).aClass334_9909)
				((Class365_Sub1_Sub2_Sub1) this).aClass334_9909 = Class472.method6063((int) (class235.aClass217_2599.x), (int) (class235.aClass217_2599.aFloat2455), (int) (class235.aClass217_2599.y), class387, 2034122433);
			else
				Class264_Sub2.method2507(((Class365_Sub1_Sub2_Sub1) this).aClass334_9909, (int) class235.aClass217_2599.x, (int) class235.aClass217_2599.aFloat2455, (int) class235.aClass217_2599.y, class387, (byte) 83);
			return class335;
		} catch (RuntimeException runtimeexception) {
	...
	public Class365_Sub1_Sub2_Sub1(Class331 class331, GraphicsToolkit class_ra, Class433 class433, ObjectConfig class432, int i, int i_5_, int i_6_, int i_7_, int i_8_, boolean bool, int i_9_, int i_10_) {
		...
		((Class365_Sub1_Sub2_Sub1) this).aBoolean9908 = class432.optionType * 1532834983 != 0 && !bool;
	...
	void method4373(GraphicsToolkit class_ra) {
		...
		if (null != class387) {
			...
			int i = (int) class217.x >> 9;
			int i_17_ = (int) class217.y >> 9;
	...
	Class335 method4370(GraphicsToolkit class_ra) {
		...
		int i_24_ = (int) class235.aClass217_2599.y >> 9;
		...
		((Class365_Sub1_Sub2_Sub1) this).aBoolean9907 = class387.i() || null != ((Class60) aClass60_9910).aClass351_602;
		if (null == ((Class365_Sub1_Sub2_Sub1) this).aClass334_9909)
			((Class365_Sub1_Sub2_Sub1) this).aClass334_9909 = Class472.method6063((int) class235.aClass217_2599.x, (int) class235.aClass217_2599.aFloat2455, (int) class235.aClass217_2599.y, class387, 1982662132);
		else
			Class264_Sub2.method2507((((Class365_Sub1_Sub2_Sub1) this).aClass334_9909), (int) class235.aClass217_2599.x, (int) class235.aClass217_2599.aFloat2455, (int) class235.aClass217_2599.y, class387, (byte) 26);
		return class335;
	}
	...
	static final void method4498(ClientScript2 class403, byte i) {
		try {
			...
			((ClientScript2) class403).aClass177_5243.aClass298_Sub37_Sub14_1788.method3464(class298_sub36.aClass298_Sub53_Sub2_7396, ((ClientScript2) class403).aClass177_5243.anIntArray1789, 1820223429);
			class298_sub36.aClass298_Sub53_Sub2_7396.method3649(385051775 * (class298_sub36.aClass298_Sub53_Sub2_7396.index) - i_25_, (byte) -61);
