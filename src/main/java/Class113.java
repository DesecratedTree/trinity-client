...
public class Class113 {
	...
	byte[] aByteArray1371;
	int[] anIntArray1372;
	public static WidgetConfig aClass105_1373;
	...
	public static final void method1247(int i) {
		try {
			...
			RuntimeException_Sub1.processCyclesCount = 0;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1248(ClientScript2 class403, byte i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_38_, (byte) -77);
	...
	static final void method1249(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_39_, (byte) -77);
	...
	static final void method1250(ClientScript2 class403, int i) {
		try {
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(i_40_, (byte) -61);
	...
	static final void method1252(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub20_7578.method5700(-1397951801);
		} catch (RuntimeException runtimeexception) {
	...
	public static final Interface method1254(int parentHash, Interface class298_sub51, int[] is, boolean bool, int i_44_) {
		try {
			Interface class298_sub51_45_ = (Interface) client.aClass437_8841.method5812((long) parentHash);
			...
			WidgetConfig class105 = Class50.getIComponentDefinitions(parentHash, (byte) 49);
			if (class105 != null)
			...
			if (null != class105)
				Class65.method761((Class389.aClass119Array4165[class105.uid * -440872681 >>> 16]), class105, !bool, 112223880);
			if (!bool)
