...
public class Class49 {
	OpenGLLegacyToolkit aClass_ra_Sub2_497;
	...
	boolean method527(Class30_Sub4 class30_sub4, Class30_Sub4 class30_sub4_0_, float f) {
		if (!method528())
			return false;
		Class52_Sub1_Sub2 class52_sub1_sub2 = (((OpenGLLegacyToolkit) ((Class49) this).aClass_ra_Sub2_497).aClass52_Sub1_Sub2_8148);
		...
		if (class52_sub1_sub2.method560()) {
			...
			OpenGLLegacyToolkit.glViewport(0, 0, ((Class30_Sub4) class30_sub4).anInt6750, ((Class30_Sub4) class30_sub4).anInt6751);
	...
	boolean method528() {
		if (((OpenGLLegacyToolkit) ((Class49) this).aClass_ra_Sub2_497).aBoolean8170 && (((OpenGLLegacyToolkit) ((Class49) this).aClass_ra_Sub2_497).aBoolean8093) && ((Class49) this).aClass29_498 == null) {
			Class48 class48 = (Class48.method526(((Class49) this).aClass_ra_Sub2_497, 35632, "uniform float rcpRelief;\nuniform vec2 sampleSize;\nuniform sampler3D heightMap;\nvoid main() {\nfloat dx = texture3D(heightMap, vec3(-sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r;\nfloat dy = texture3D(heightMap, vec3(0.0, -sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(0.0, sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r;\ngl_FragColor = vec4(0.5+normalize(vec3(dx, dy, rcpRelief))*0.5, texture3D(heightMap, gl_TexCoord[0].xyz).r);\n}\n"));
			if (class48 != null)
	...
	Class49(OpenGLLegacyToolkit class_ra_sub2) {
