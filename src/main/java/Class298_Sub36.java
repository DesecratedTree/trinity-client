...
public class Class298_Sub36 extends Class298 {
			...
			if (i_6_ < client.aShort8934) {
				...
				if (i_5_ > client.aShort8743) {
					...
					if (bool) {
						...
						FloorOverlay.graphics.method5015(i, i_0_, i_8_, i_2_, -16777216, (byte) 7);
						FloorOverlay.graphics.method5015(i_1_ + i - i_8_, i_0_, i_8_, i_2_, -16777216, (byte) 7);
					}
					i += i_8_;
					i_1_ -= i_8_ * 2;
				}
				...
				if (i_5_ < client.aShort8839) {
					...
					if (bool) {
						FloorOverlay.graphics.L();
						FloorOverlay.graphics.method5015(i, i_0_, i_1_, i_10_, -16777216, (byte) 7);
						FloorOverlay.graphics.method5015(i, i_0_ + i_2_ - i_10_, i_1_, i_10_, -16777216, (byte) 7);
					}
					i_0_ += i_10_;
					i_2_ -= i_10_ * 2;
				}
