...
public abstract class Class_ta {
	...
	static final void method5994(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub13_7549.method5675(-26344378);
	...
	static final void method5995(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = (-407713023 * (((NPC) ((ClientScript2) class403).aClass365_Sub1_Sub1_Sub2_5242).config.id));
		} catch (RuntimeException runtimeexception) {
	...
	public static void method5998(int i) {
		try {
			for (int i_6_ = 0; i_6_ < Class107.chatMessages.length; i_6_++)
				Class107.chatMessages[i_6_] = null;
