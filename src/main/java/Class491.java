...
public class Class491 {
	...
	public Class492 method6172(int i, int i_0_) {
		try {
			Class492 class492;
			synchronized (((Class491) this).aClass348_6079) {
				class492 = (Class492) ((Class491) this).aClass348_6079.get((long) i);
			}
			if (null != class492)
				return class492;
			byte[] is;
			synchronized (((Class491) this).aClass243_6076) {
				is = (((Class491) this).aClass243_6076.getFileFromArchive(-1006924897 * ConfigFile.aClass120_1438.anInt1460, i, (byte) -68));
			}
	...
	public Class491(Class411 class411, Class429 class429, CacheIndex class243, CacheIndex class243_2_) {
		...
		((Class491) this).aClass243_6076.method2316((ConfigFile.aClass120_1438.anInt1460) * -1006924897, -1015661848);
	}

	static final void method6175(long l) {
		try {
			SceneObjectPosition class217 = (Class287.myPlayer.method4337().aClass217_2599);
			int i = 1734240325 * client.anInt8817 + (int) class217.x;
			int i_3_ = client.anInt8742 * 1874511679 + (int) class217.y;
	...
	static final void method6177(WidgetConfig class105, ClientScript2 class403, int i) {
		try {
			...
			NPCConfig class503 = Class15.aClass507_224.method6269(class105.anInt1151 * 572201537, -834875221);
			...
			if (class503.modifiedTextures == null || i_9_ < 0 || i_9_ >= class503.modifiedTextures.length)
				throw new RuntimeException("");
	...
	static void hideWidget(int i, int i_10_, int i_11_) {
		try {
