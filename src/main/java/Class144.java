...
public class Class144 {
	CacheIndex aClass243_1559;
	CacheIndex aClass243_1560;
	...
	public Class132 method1579(int i, int i_0_) {
		try {
			...
			synchronized (((Class144) this).aClass348_1561) {
				class132 = (Class132) ((Class144) this).aClass348_1561.get((long) i);
			}
			if (class132 != null)
				return class132;
			byte[] is;
			synchronized (((Class144) this).aClass243_1559) {
				is = (((Class144) this).aClass243_1559.getFileFromArchive(ConfigFile.aClass120_1425.anInt1460 * -1006924897, i, (byte) -128));
			}
	...
	public Class144(Class411 class411, Class429 class429, CacheIndex class243, CacheIndex class243_2_) {
		((Class144) this).aClass243_1559 = class243;
		((Class144) this).aClass243_1560 = class243_2_;
		((Class144) this).aClass243_1559.method2316((-1006924897 * (ConfigFile.aClass120_1425.anInt1460)), -2109974583);
	}
	...
	static final void method1585(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.preferences.aClass422_Sub10_7548.method5612(i_3_, 1352882135);
		} catch (RuntimeException runtimeexception) {
