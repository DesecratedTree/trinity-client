...
public class Class490 {
	...
	static String[][] aStringArrayArray6074 = { { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" }, { "Jan", "Feb", "M\u00e4r", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez" }, { "jan", "f\u00e9v", "mars", "avr", "mai", "juin", "juil", "ao\u00fbt", "sept", "oct", "nov", "d\u00e9c" }, { "jan", "fev", "mar", "abr", "mai", "jun", "jul", "ago", "set", "out", "nov", "dez" }, { "jan", "feb", "mrt", "apr", "mei", "jun", "jul", "aug", "sep", "okt", "nov", "dec" } };
	...
	static void method6170(int i) {
		try {
			if (1090452523 * Class291.availableCPU > 1)
				Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub26_7577, 4, 102316213);
			else
				Class422_Sub25.preferences.method3540(Class422_Sub25.preferences.aClass422_Sub26_7577, 2, -437930362);
		} catch (RuntimeException runtimeexception) {
