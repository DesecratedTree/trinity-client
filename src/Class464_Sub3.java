/* Class464_Sub3 - Decompiled by JODE
...
public class Class464_Sub3 extends Class464 {
	...
	void method5722(int i, byte i_0_) {
		try {
			...
			throw Class476.method5964(runtimeexception, new StringBuilder().append("afa.p(").append(')').toString());
		}
	}

	public Class464_Sub3(int i, Class330_Sub50 class330_sub50) {
		super(i, class330_sub50);
	}

	public void method5741(int i) {
		try {
			if (anInt5587 * 295364903 != 0 && aClass330_Sub50_5589.aClass464_Sub27_7881.method5833(16777215) != 1)
				anInt5587 = 0;
			if (anInt5587 * 295364903 != 0 && aClass330_Sub50_5589.aClass464_Sub10_7873.method5772(240448038) == 2)
				anInt5587 = 0;
			if (anInt5587 * 295364903 < 0 || 295364903 * anInt5587 > 1)
				anInt5587 = method5715(1176490384) * 1558443671;
		} catch (RuntimeException runtimeexception) {
			throw Class476.method5964(runtimeexception, new StringBuilder().append("afa.l(").append(')').toString());
		}
	}

	public boolean method5742(int i) {
		try {
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class476.method5964(runtimeexception, new StringBuilder().append("afa.b(").append(')').toString());
		}
	}

	public int method5716(int i, int i_1_) {
		try {
			if (i != 0 && aClass330_Sub50_5589.aClass464_Sub10_7873.method5772(1199105348) == 2)
				return 3;
			if (0 == i || aClass330_Sub50_5589.aClass464_Sub27_7881.method5833(16777215) == 1)
				return 1;
			return 2;
		} catch (RuntimeException runtimeexception) {
			throw Class476.method5964(runtimeexception, new StringBuilder().append("afa.j(").append(')').toString());
		}
	}

	public int method5743(byte i) {
		try {
			return anInt5587 * 295364903;
		} catch (RuntimeException runtimeexception) {
			throw Class476.method5964(runtimeexception, new StringBuilder().append("afa.k(").append(')').toString());
		}
	}
	...
	public int method5714(int i) {
		if (i != 0 && (aClass330_Sub50_5589.aClass464_Sub10_7873.method5772(-95396381) == 2))
			return 3;
		if (0 == i || (aClass330_Sub50_5589.aClass464_Sub27_7881.method5833(16777215) == 1))
			return 1;
		return 2;
	...
	int method5715(int i) {
		try {
			...
			throw Class476.method5964(runtimeexception, new StringBuilder().append("afa.r(").append(')').toString());
		}
	}

	public Class464_Sub3(Class330_Sub50 class330_sub50) {
		super(class330_sub50);
	}

	static void method5744(IComponentDefinitions iComponentDefinitions, Class_ta class_ta, int i, int i_2_, int i_3_, int i_4_, Class61 class61, byte i_5_) {
		try {
			if (null != class61) {
				int i_6_;
				if (-1551406343 * Class147.anInt1621 == 5)
					i_6_ = (int) client.aFloat9141 & 0x3fff;
				else
					i_6_ = (client.anInt9149 * -603680235 + (int) client.aFloat9141) & 0x3fff;
				int i_7_ = (Math.max(-681123409 * iComponentDefinitions.anInt1210 / 2, iComponentDefinitions.anInt1348 * 694142557 / 2) + 10);
				int i_8_ = i_4_ * i_4_ + i_3_ * i_3_;
				if (i_8_ <= i_7_ * i_7_) {
					int i_9_ = Class257.anIntArray2683[i_6_];
					int i_10_ = Class257.anIntArray2684[i_6_];
					if (5 != -1551406343 * Class147.anInt1621) {
						i_9_ = i_9_ * 256 / (256 + 1113850905 * client.anInt9063);
						i_10_ = 256 * i_10_ / (1113850905 * client.anInt9063 + 256);
					}
					int i_11_ = i_9_ * i_4_ + i_10_ * i_3_ >> 14;
					int i_12_ = i_4_ * i_10_ - i_3_ * i_9_ >> 14;
					class61.method689((iComponentDefinitions.anInt1210 * -681123409 / 2 + i + i_11_ - class61.method318() / 2), (694142557 * iComponentDefinitions.anInt1348 / 2 + i_2_ - i_12_ - class61.method683() / 2), class_ta, i, i_2_);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class476.method5964(runtimeexception, new StringBuilder().append("afa.x(").append(')').toString());
		}
	}

	static final void method5745(Class430 class430, int i) {
		try {
			if (null == Class355.aClass496_3639)
				((Class430) class430).anIntArray4387[((((Class430) class430).anInt4376 += -1390004513) * 1632830751) - 1] = -1;
			else
				((Class430) class430).anIntArray4387[((((Class430) class430).anInt4376 += -1390004513) * 1632830751) - 1] = Class355.aClass496_3639.anInt5876 * 353109981;
		} catch (RuntimeException runtimeexception) {
			throw Class476.method5964(runtimeexception, new StringBuilder().append("afa.acd(").append(')').toString());
		}
	}

	static final void method5746(Class430 class430, int i) {
		try {
			((Class430) class430).anInt4376 -= 1514958270;
			int i_13_ = (((Class430) class430).anIntArray4387[1632830751 * ((Class430) class430).anInt4376]);
			int i_14_ = (((Class430) class430).anIntArray4387[1632830751 * ((Class430) class430).anInt4376 + 1]);
			((Class430) class430).anIntArray4387[((((Class430) class430).anInt4376 += -1390004513) * 1632830751 - 1)] = Class99.method1206(i_13_, i_14_, false, (byte) 106);
		} catch (RuntimeException runtimeexception) {
			throw Class476.method5964(runtimeexception, new StringBuilder().append("afa.tq(").append(')').toString());
		}
	}

	static Class109[] method5747(int i) {
		try {
