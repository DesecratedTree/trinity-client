...
public final class IDirect3DDevice extends IUnknown {
	...
	public static int r(long l, int i, float f) {
		return SetRenderStatef(l, i, f);
	}

	public static int j(long l, int i, boolean bool) {
	...
	public static int i(long l, int i, float f) {
		return SetRenderStatef(l, i, f);
	}

	public static int p(long l, int i, float f) {
		return SetRenderStatef(l, i, f);
	}
}
