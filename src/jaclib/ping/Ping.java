...
public class Ping {
	...
	public static int r(byte i, byte i_0_, byte i_1_, byte i_2_, long l) throws Throwable {
	...
	public static int j(byte i, byte i_7_, byte i_8_, byte i_9_, long l) throws Throwable {
	...
	public static int i(byte i, byte i_11_, byte i_12_, byte i_13_, long l) throws Throwable {
